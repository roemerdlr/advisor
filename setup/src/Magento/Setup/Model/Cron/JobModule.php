...
/**
 * Job that handles module commands.
 * E.g. "module:enable", "module:disable"
 */
class JobModule extends AbstractJob {
	 ...
	 * @param array $params        	
	 */
	public function __construct(AbstractSetupCommand $command, ObjectManagerProvider $objectManagerProvider, OutputInterface $output, Status $status, $name, $params = []) {

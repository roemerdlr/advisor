...
abstract class AbstractJob {
	 ...
	 * @param array $params        	
	 */
	public function __construct(\Symfony\Component\Console\Output\OutputInterface $output, \Magento\Setup\Model\Cron\Status $status, \Magento\Setup\Model\ObjectManagerProvider $objectManagerProvider, $name, array $params = []) {
		$this->output = $output;
		$this->status = $status;
		$this->name = $name;
		$this->params = $params;

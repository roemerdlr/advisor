...
class Builder extends AbstractBuilder {
	 ...
	 */
	public function __construct(ParserInterface $dependenciesParser, WriterInterface $reportWriter, ParserInterface $configParser) {
	...
	protected function getAllowedModules() {
		return $this->configParser->parse ( [ 
				'files_for_parse' => $this->options ['parse'] ['config_files'] 
		] );
	}
}

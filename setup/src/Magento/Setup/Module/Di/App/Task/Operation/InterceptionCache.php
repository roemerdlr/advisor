...
class InterceptionCache implements OperationInterface {
	 ...
	 * @param array $data        	
	 */
	public function __construct(\Magento\Framework\Interception\Config\Config $configInterface, \Magento\Setup\Module\Di\Code\Reader\Decorator\Interceptions $interceptionsInstancesNamesList, array $data = []) {

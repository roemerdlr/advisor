...
class DependencyTest extends \PHPUnit_Framework_TestCase {
	 ...
	 *        	One of \Magento\Setup\Module\Dependency\Dependency::TYPE_ const
	...
	protected function createDependency($module, $type = null) {
		...
		return $objectManagerHelper->getObject ( 'Magento\Setup\Module\Dependency\Report\Dependency\Data\Dependency', [ 
				'module' => $module,
				'type' => $type 
		] );
	}

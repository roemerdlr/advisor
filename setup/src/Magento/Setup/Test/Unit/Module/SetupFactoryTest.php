...
class SetupFactoryTest extends \PHPUnit_Framework_TestCase {
	public function testCreate() {
		...
		$objectManager->expects ( $this->once () )->method ( 'get' )->with ( 'Magento\Framework\App\ResourceConnection' )->willReturn ( $this->getMock ( 'Magento\Framework\App\ResourceConnection', [ ], [ ], '', false ) );

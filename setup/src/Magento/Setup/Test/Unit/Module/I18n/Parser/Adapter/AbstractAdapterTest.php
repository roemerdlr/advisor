...
class AbstractAdapterTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_adapterMock = $this->getMockForAbstractClass ( 'Magento\Setup\Module\I18n\Parser\Adapter\AbstractAdapter', [ ], '', false, true, true, [ 
				'_parse' 
		] );
		$this->_adapterReflection = new \ReflectionMethod ( 'Magento\Setup\Module\I18n\Parser\Adapter\AbstractAdapter', '_addPhrase' );

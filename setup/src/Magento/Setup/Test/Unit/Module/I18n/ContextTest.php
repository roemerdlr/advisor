...
class ContextTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetContextByPath($context, $path, $pathValues) {
		$this->componentRegistrar->expects ( $this->any () )->method ( 'getPaths' )->will ( $this->returnValueMap ( $pathValues ) );
				...
				[ 
						...
						[ 
								[ 
										Context::CONTEXT_TYPE_MODULE,
										[ 
												'Magento_Module' => '/app/code/Magento/Module' 
										] 
								],
								[ 
				...
				[ 
						...
						[ 
								...
								[ 
										Context::CONTEXT_TYPE_THEME,
										[ 
												'frontend/Some/theme' => '/app/design/area/theme' 
										] 
								] 
						] 
				],
	...
	public function testBuildPathToLocaleDirectoryByContext($path, $context, $registrar) {
		...
		$this->componentRegistrar->expects ( $this->any () )->method ( 'getPaths' )->with ( ComponentRegistrar::MODULE )->willReturn ( $paths );
	...
	public function testBuildPathToLocaleDirectoryByContextWithInvalidType() {
		$this->componentRegistrar->expects ( $this->any () )->method ( 'getPaths' )->with ( ComponentRegistrar::MODULE )->willReturn ( [ 

...
class GeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_generator = $objectManagerHelper->getObject ( 'Magento\Setup\Module\I18n\Pack\Generator', [ 
	...
	public function testGenerate() {
		...
		$this->dictionaryMock->expects ( $this->once () )->method ( 'getPhrases' )->will ( $this->returnValue ( [ 
				$phrases 
		] ) );
	...
	public function testGenerateWithNotAllowedDuplicatesAndDuplicatesExist() {
		...
		$this->dictionaryMock->expects ( $this->once () )->method ( 'getDuplicates' )->will ( $this->returnValue ( [ 
				[ 
						$phraseFirstMock 
				],
				[ 

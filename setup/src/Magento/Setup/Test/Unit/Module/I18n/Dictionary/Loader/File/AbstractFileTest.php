...
class AbstractFileTest extends \PHPUnit_Framework_TestCase {
	...
	public function testLoadWrongFile() {
		$abstractLoaderMock = $this->getMockForAbstractClass ( 'Magento\Setup\Module\I18n\Dictionary\Loader\File\AbstractFile', [ ], '', false );
	...
	public function testLoad() {
		$abstractLoaderMock = $this->getMockForAbstractClass ( 'Magento\Setup\Module\I18n\Dictionary\Loader\File\AbstractFile', [ 
				$this->_factoryMock 
		], '', true, true, true, [ 
				'_openFile',
				'_readFile',
		...
		$abstractLoaderMock->expects ( $this->at ( 1 ) )->method ( '_readFile' )->will ( $this->returnValue ( [ 
				'phrase1',
				'translation1' 
		] ) );
		$abstractLoaderMock->expects ( $this->at ( 2 ) )->method ( '_readFile' )->will ( $this->returnValue ( [ 
				'phrase2',
				'translation2',
				'context_type2',
				'context_value2' 
		...
		$this->_factoryMock->expects ( $this->at ( 1 ) )->method ( 'createPhrase' )->with ( [ 
				'phrase' => 'phrase1',
				'translation' => 'translation1',
				'context_type' => '',
				'context_value' => '' 
		] )->will ( $this->returnValue ( $phraseFirstMock ) );
		$this->_factoryMock->expects ( $this->at ( 2 ) )->method ( 'createPhrase' )->with ( [ 
				'phrase' => 'phrase2',
				'translation' => 'translation2',
				'context_type' => 'context_type2',
				'context_value' => 'context_value2' 
		] )->will ( $this->returnValue ( $phraseSecondMock ) );

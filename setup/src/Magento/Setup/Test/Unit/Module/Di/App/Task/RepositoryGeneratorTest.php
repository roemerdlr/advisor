...
class RepositoryGeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->classesScannerMock = $this->getMockBuilder ( 'Magento\Setup\Module\Di\Code\Reader\ClassesScanner' )->setMethods ( [ ] )->disableOriginalConstructor ()->getMock ();
	}
	...
	public function testDoOperationEmptyData($wrongData) {
		$model = new RepositoryGenerator ( $this->directoryScannerMock, $this->classesScannerMock, $this->repositoryScannerMock, $wrongData );

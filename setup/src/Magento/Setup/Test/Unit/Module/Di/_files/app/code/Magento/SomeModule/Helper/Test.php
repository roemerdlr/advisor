...
class Test {
	...
	public function __construct(\Magento\SomeModule\Module\Factory $factory, \Magento\SomeModule\Element\Factory $elementFactory, \Magento\SomeModule\ElementFactory $rightElementFactory) {
	...
	public function testHelper(\Magento\SomeModule\ElementFactory $factory, array $data = []) {
		$factory->create ( 'Magento\SomeModule\ElementFactory', [ 
				'data' => $data 
		] );
	}
}

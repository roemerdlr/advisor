...
class InterceptionsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = new \Magento\Setup\Module\Di\Code\Reader\Decorator\Interceptions ( $this->classesScanner, $this->classReaderMock, $this->validatorMock, new \Magento\Framework\Code\Validator\ConstructorIntegrity (), new \Magento\Framework\Code\Validator\ContextAggregation (), $this->logMock );
	}

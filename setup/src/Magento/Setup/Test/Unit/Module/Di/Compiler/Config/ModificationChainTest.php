...
class ModificationChainTest extends \PHPUnit_Framework_TestCase {
	public function testConstructor() {
		$modificationsList = [ ];
		$modificationsList [] = $this->getMockBuilder ( 'Magento\Setup\Module\Di\Compiler\Config\ModificationInterface' )->getMock ();
		$modificationsList [] = $this->getMockBuilder ( 'Magento\Setup\Module\Di\Compiler\Config\ModificationInterface' )->getMock ();
	...
	public function testModify() {
		...
		$modifier1 = $this->getMockBuilder ( 'Magento\Setup\Module\Di\Compiler\Config\ModificationInterface' )->getMock ();
		$modifier2 = $this->getMockBuilder ( 'Magento\Setup\Module\Di\Compiler\Config\ModificationInterface' )->getMock ();

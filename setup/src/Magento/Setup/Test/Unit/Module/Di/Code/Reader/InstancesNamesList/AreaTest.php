...
class AreaTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->classesScannerMock = $this->getMockBuilder ( '\Magento\Setup\Module\Di\Code\Reader\ClassesScanner' )->disableOriginalConstructor ()->setMethods ( [ 
				'getList' 
		] )->getMock ();
		
		$this->classReaderDecoratorMock = $this->getMockBuilder ( '\Magento\Setup\Module\Di\Code\Reader\ClassReaderDecorator' )->disableOriginalConstructor ()->setMethods ( [ 
				'getConstructor' 
		] )->getMock ();
		
		$this->model = new \Magento\Setup\Module\Di\Code\Reader\Decorator\Area ( $this->classesScannerMock, $this->classReaderDecoratorMock );
	}
	public function testGetList() {
		...
		$constructors = [ 
				[ 
						'NameSpace1\ClassName1',
						[ 
								'arg1' => 'NameSpace1\class5',
								'arg2' => 'NameSpace1\ClassName4' 
						] 
				],
				[ 
						'NameSpace1\ClassName2',

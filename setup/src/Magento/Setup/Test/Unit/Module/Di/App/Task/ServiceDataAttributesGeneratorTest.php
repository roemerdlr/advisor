...
class ServiceDataAttributesGeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->directoryScannerMock = $this->getMock ( 'Magento\Setup\Module\Di\Code\Scanner\DirectoryScanner', [ ], [ ], '', false );
		$this->serviceDataAttributesScannerMock = $this->getMock ( 'Magento\Setup\Module\Di\Code\Scanner\ServiceDataAttributesScanner', [ ], [ ], '', false );
	}

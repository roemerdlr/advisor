...
class EnvironmentTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->cronScriptReadinessCheck = $this->getMock ( 'Magento\Setup\Model\CronScriptReadinessCheck', [ ], [ ], '', false );
		$this->phpReadinessCheck = $this->getMock ( 'Magento\Setup\Model\PhpReadinessCheck', [ ], [ ], '', false );
		$this->environment = new Environment ( $this->permissions, $this->filesystem, $this->cronScriptReadinessCheck, $this->phpReadinessCheck );
	}
	...
	public function testCronScriptAction() {
		$this->cronScriptReadinessCheck->expects ( $this->once () )->method ( 'checkSetup' )->willReturn ( [ 
				'success' => true 
		] );
		$this->cronScriptReadinessCheck->expects ( $this->once () )->method ( 'checkUpdater' )->willReturn ( [ 
				'success' => true 
		] );

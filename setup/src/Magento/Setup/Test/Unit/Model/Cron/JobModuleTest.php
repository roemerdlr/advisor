...
class JobModuleTest extends \PHPUnit_Framework_TestCase {
	public function testExecuteModuleDisable() {
		...
		$jobModuleDisable = new JobModule ( $command, $objectManagerProvider, $output, $status, 'setup:module:disable', $params );
	...
	public function testExecuteModuleEnable() {
		...
		$jobModuleEnable = new JobModule ( $command, $objectManagerProvider, $output, $status, 'setup:module:enable', $params );

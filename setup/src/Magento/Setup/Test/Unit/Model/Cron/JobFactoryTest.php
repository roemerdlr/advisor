...
class JobFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$serviceManager->expects ( $this->atLeastOnce () )->method ( 'get' )->will ( $this->returnValueMap ( $returnValueMap ) );
	...
	public function testRollback() {
		...
		$this->assertInstanceOf ( 'Magento\Setup\Model\Cron\AbstractJob', $this->jobFactory->create ( 'setup:rollback', [ ] ) );
	}
	public function testComponentUninstall() {
		...
		$this->objectManager->expects ( $this->any () )->method ( 'get' )->will ( $this->returnValueMap ( $valueMap ) );
		$this->assertInstanceOf ( 'Magento\Setup\Model\Cron\JobComponentUninstall', $this->jobFactory->create ( 'setup:component:uninstall', [ ] ) );
	}

...
class ConfigModelTest extends \PHPUnit_Framework_TestCase {
	...
	public function testValidate() {
		...
		$this->collector->expects ( $this->exactly ( 2 ) )->method ( 'collectOptionsLists' )->will ( $this->returnValue ( [ 
				$configOption 
		] ) );
	...
	public function testProcess() {
		...
		$configOption = $this->configOptionsList;
		$configOption->expects ( $this->once () )->method ( 'createConfig' )->will ( $this->returnValue ( [ 
				$configData1,
				$configData2 
		] ) );

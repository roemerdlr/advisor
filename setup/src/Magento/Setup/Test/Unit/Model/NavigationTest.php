...
class NavigationTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->serviceLocatorMock = $this->getMockForAbstractClass ( 'Zend\ServiceManager\ServiceLocatorInterface', [ 
				'get' 
		] );
		$this->serviceLocatorMock->expects ( $this->exactly ( 2 ) )->method ( 'get' )->with ( 'config' )->will ( $this->returnValue ( [ 
				'navInstallerTitles' => [ 
						'install' => 'SomeTitle' 
				],
				'navInstaller' => [ 
	...
	public function testGetMainItems() {
		...
		], array_values ( $this->navigation->getMainItems () ) );
	}
}

	...
	public function executeDataProvider() {
		return [ 
				[ 
						...
						[ ],
						'Enabled maintenance mode' . PHP_EOL . 'Set exempt IP-addresses: 127.0.0.1, 127.0.0.2' . PHP_EOL 
				],
				[ 
						[ 
								'--ip' => [ 
						...
						[ ],
						'Enabled maintenance mode' . PHP_EOL . 'Set exempt IP-addresses: none' . PHP_EOL 
				],
				[ 
						[ ],
						[ ],

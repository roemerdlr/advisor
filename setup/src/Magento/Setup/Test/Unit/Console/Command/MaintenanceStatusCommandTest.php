	...
	public function executeDataProvider() {
		return [ 
				[ 
						...
						'Status: maintenance mode is active' . PHP_EOL . 'List of exempt IP-addresses: 127.0.0.1, 127.0.0.2' . PHP_EOL 
				],
				[ 
						[ 
								true,
				...
				[ 
						...
						'Status: maintenance mode is not active' . PHP_EOL . 'List of exempt IP-addresses: 127.0.0.1, 127.0.0.2' . PHP_EOL 
				] 
		];
	}
}

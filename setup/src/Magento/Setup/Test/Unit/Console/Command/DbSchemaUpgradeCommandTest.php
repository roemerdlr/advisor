...
class DbSchemaUpgradeCommandTest extends DbDataUpgradeCommandTest {
	public function testExecute() {
		...
		$commandTester = new CommandTester ( new DbSchemaUpgradeCommand ( $this->installerFactory, $this->deploymentConfig ) );
	...
	public function testExecuteNoConfig() {
		...
		$commandTester = new CommandTester ( new DbSchemaUpgradeCommand ( $this->installerFactory, $this->deploymentConfig ) );
		$commandTester->execute ( [ ] );
		$this->assertStringMatchesFormat ( 'No information is available: the Magento application is not installed.%w', $commandTester->getDisplay () );
	}
}

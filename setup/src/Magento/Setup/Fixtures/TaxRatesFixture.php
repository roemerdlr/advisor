...
class TaxRatesFixture extends Fixture {
	...
	public function execute() {
		...
		$collection = $this->fixtureModel->getObjectManager ()->get ( 'Magento\Tax\Model\ResourceModel\Calculation\Rate\Collection' );
		
		/** @var $model Magento\Tax\Model\Calculation\Rate */
		$model = $this->fixtureModel->getObjectManager ()->get ( 'Magento\Tax\Model\Calculation\Rate' );
		...
		$importHandler = $this->fixtureModel->getObjectManager ()->create ( 'Magento\TaxImportExport\Model\Rate\CsvImportHandler' );

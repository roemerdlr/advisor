...
class FixtureModel {
	...
	public function loadFixtures() {
		...
		foreach ( $files as $file ) {
			...
			$fixture = $this->objectManager->create ( 'Magento\Setup\Fixtures' . '\\' . $file, [ 
					'fixtureModel' => $this 
			] );
	...
	public function initObjectManager() {
		$this->getObjectManager ()->configure ( $this->getObjectManager ()->get ( 'Magento\Framework\ObjectManager\ConfigLoaderInterface' )->load ( self::AREA_CODE ) );

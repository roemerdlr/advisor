...
class ConfigsApplyFixture extends Fixture {
	...
	public function execute() {
		...
		foreach ( $configs ['config'] as $config ) {
			$backendModel = isset ( $config ['backend_model'] ) ? $config ['backend_model'] : 'Magento\Framework\App\Config\Value';
			/**
			 *
		...
		$this->fixtureModel->getObjectManager ()->get ( 'Magento\Framework\App\CacheInterface' )->clean ( [ 

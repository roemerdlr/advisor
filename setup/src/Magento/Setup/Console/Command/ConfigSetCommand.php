...
class ConfigSetCommand extends AbstractSetupCommand {
	 ...
	 */
	public function __construct(ConfigModel $configModel, ModuleList $moduleList, DeploymentConfig $deploymentConfig) {
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		$optionsToChange = array_diff ( $optionsToChange, [ 
				ConfigOptionsListConstants::INPUT_KEY_SKIP_DB_VALIDATION 
		] );
		
		$this->configModel->process ( $inputOptions );
		
		$optionsWithDefaultValues = array_diff ( $optionsWithDefaultValues, [ 
				ConfigOptionsListConstants::INPUT_KEY_SKIP_DB_VALIDATION 
		] );

...
class AdminUserCreateCommand extends AbstractSetupCommand {
	...
	protected function configure() {
		$this->setName ( 'admin:user:create' )->setDescription ( 'Creates an administrator' )->setDefinition ( $this->getOptionsList () );
		parent::configure ();
	}
	...
	public function getOptionsList() {
		return [ 
				...
				new InputOption ( AdminAccount::KEY_FIRST_NAME, null, InputOption::VALUE_REQUIRED, '(Required) Admin first name' ),
				new InputOption ( AdminAccount::KEY_LAST_NAME, null, InputOption::VALUE_REQUIRED, '(Required) Admin last name' ) 
		];
	}

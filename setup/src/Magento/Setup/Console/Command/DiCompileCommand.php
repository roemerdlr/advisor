...
class DiCompileCommand extends Command {
	...
	protected function configure() {
		$this->setName ( self::NAME )->setDescription ( 'Generates DI configuration and all non-existing interceptors and factories' );
		parent::configure ();
	}
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		$operations = $this->getOperationsConfiguration ( $compiledPathsList, $dataAttributesIncludePattern );
		...
		try {
			...
			$progressBar = $this->objectManager->create ( 'Symfony\Component\Console\Helper\ProgressBar', [ 
					'output' => $output,
	...
	private function configureObjectManager(OutputInterface $output) {
		$this->objectManager->configure ( [ 
				'preferences' => [ 
						'Magento\Setup\Module\Di\Compiler\Config\WriterInterface' => 'Magento\Setup\Module\Di\Compiler\Config\Writer\Filesystem' 
				],
	 ...
	 * @return array
	 */
	private function getOperationsConfiguration(array $compiledPathsList, array $dataAttributesIncludePattern) {
		$excludePatterns = [ ];

...
class MaintenanceAllowIpsCommand extends AbstractSetupCommand {
	...
	protected function configure() {
		$arguments = [ 
				new InputArgument ( self::INPUT_KEY_IP, InputArgument::OPTIONAL | InputArgument::IS_ARRAY, 'Allowed IP addresses' ) 
		];
		$options = [ 
				new InputOption ( self::INPUT_KEY_NONE, null, InputOption::VALUE_NONE, 'Clear allowed IP addresses' ) 
		];

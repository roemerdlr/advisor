...
class SettingsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_object = new \Magento\TestFramework\Bootstrap\Settings ( $this->_fixtureDir, [ 
	...
	public function getAsConfigFileDataProvider() {
		return [ 
				'config file & dist file' => [ 
						'config_file_with_dist',
						"{$this->_fixtureDir}1.xml" 
				],
				'config file & no dist file' => [ 
						'config_file_no_dist',
						"{$this->_fixtureDir}2.xml" 
				],
				'no config file & dist file' => [ 
						'no_config_file_dist',

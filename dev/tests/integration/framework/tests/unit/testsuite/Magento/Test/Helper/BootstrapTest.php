...
class BootstrapTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_application = $this->getMock ( 'Magento\TestFramework\Application', [ 
				'getTempDir',
				'getInitParams',
				'reinitialize',
				'run' 
	...
	public function testGetAppInitParams() {
		$this->_application->expects ( $this->once () )->method ( 'getInitParams' )->will ( $this->returnValue ( $this->_fixtureInitParams ) );

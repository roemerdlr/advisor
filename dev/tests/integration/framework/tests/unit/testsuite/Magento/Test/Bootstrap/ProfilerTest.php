...
class ProfilerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_driver = $this->getMock ( 'Magento\Framework\Profiler\Driver\Standard', [ 
				'registerOutput' 
		] );
	...
	public function testRegisterFileProfiler() {
		$this->_driver->expects ( $this->once () )->method ( 'registerOutput' )->with ( $this->isInstanceOf ( 'Magento\Framework\Profiler\Driver\Standard\Output\Csvfile' ) );

...
class Eav {
	...
	public static function setIncrementIdPrefix($entityType, $prefix) {
		...
		$entityTypeModel = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Eav\Model\Entity\Type' )->loadByCode ( $entityType );
		/** @var \Magento\Eav\Model\Entity\Store $entityStore */
		$entityStore = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Eav\Model\Entity\Store' )->loadByEntityStore ( $entityTypeModel->getId (), $storeId );

...
abstract class AbstractConfigFiles extends \PHPUnit_Framework_TestCase {
	...
	public function getXmlConfigFiles() {
		...
		return $objectManager->get ( 'Magento\Framework\Config\FileIteratorFactory' )->create ( $moduleDirSearch->collectFiles ( ComponentRegistrar::MODULE, $this->_getConfigFilePathGlob () ) );
	}

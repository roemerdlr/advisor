...
class PhpUnit implements \PHPUnit_Framework_TestListener {
	...
	/**
	 *
	 * {@inheritdoc} @SuppressWarnings(PHPMD.ShortVariable)
	...
	public function endTestSuite(\PHPUnit_Framework_TestSuite $suite) {
		...
		$this->_eventManager->fireEvent ( 'endTestSuite', [ 
				$suite 
		], true );
	}
	...
	public function startTest(\PHPUnit_Framework_Test $test) {
		...
		$this->_eventManager->fireEvent ( 'startTest', [ 
				$test 
		] );
	}
	...
	public function endTest(\PHPUnit_Framework_Test $test, $time) {
		...
		$this->_eventManager->fireEvent ( 'endTest', [ 
				$test 
		], true );
	}
}

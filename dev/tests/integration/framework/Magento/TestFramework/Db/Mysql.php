...
class Mysql extends \Magento\TestFramework\Db\AbstractDb {
	...
	public function cleanup() {
		...
		$this->_shell->execute ( 'mysql --defaults-extra-file=%s --host=%s %s -e %s', [ 
	...
	public function storeDbDump() {
		$this->ensureDefaultsExtraFile ();
		$this->_shell->execute ( 'mysqldump --defaults-extra-file=%s --host=%s  %s > %s', [ 
				$this->_defaultsExtraFile,
				$this->_host,
				$this->_schema,
	...
	public function restoreFromDbDump() {
		...
		$this->_shell->execute ( 'mysql --defaults-extra-file=%s --host=%s %s < %s', [ 
				$this->_defaultsExtraFile,
				$this->_host,
				$this->_schema,
				$this->getSetupDbDumpFilename () 

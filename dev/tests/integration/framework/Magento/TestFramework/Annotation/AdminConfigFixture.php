...
class AdminConfigFixture {
	...
	protected function _getConfigValue($configPath) {
		return \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Backend\App\ConfigInterface' )->getValue ( $configPath );
	}
	...
	protected function _setConfigValue($configPath, $value) {
		\Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Backend\App\ConfigInterface' )->setValue ( $configPath, $value );
	}

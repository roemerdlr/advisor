...
class FixtureModelTest extends \Magento\TestFramework\Indexer\TestCase {
	...
	public static function setUpBeforeClass() {
		...
		copy ( self::$_generatorWorkingDir . '/tax_rates.csv', self::$_generatorWorkingDir . '/tax_rates.csv.bak' );
		copy ( __DIR__ . '/_files/tax_rates.csv', self::$_generatorWorkingDir . '/tax_rates.csv' );
	...
	public static function tearDownAfterClass() {
		...
		rename ( self::$_generatorWorkingDir . '/tax_rates.csv.bak', self::$_generatorWorkingDir . '/tax_rates.csv' );

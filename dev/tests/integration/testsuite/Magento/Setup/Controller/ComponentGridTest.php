...
class ComponentGridTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$objectManager->expects ( $this->exactly ( 4 ) )->method ( 'get' )->willReturnMap ( [ 
				[ 
						'Magento\Framework\Module\PackageInfoFactory',
						$this->packageInfoFactoryMock 
				],
				[ 
	...
	public function testComponentsAction() {
		$this->fullModuleListMock->expects ( $this->once () )->method ( 'getNames' )->willReturn ( [ 

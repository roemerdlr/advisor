...
class GeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGeneration() {
		...
		ComponentRegistrar::register ( ComponentRegistrar::MODULE, 'Magento_FirstModule', BP . '/app/code/Magento/FirstModule' );
		ComponentRegistrar::register ( ComponentRegistrar::MODULE, 'Magento_SecondModule', BP . '/app/code/Magento/SecondModule' );
		ComponentRegistrar::register ( ComponentRegistrar::THEME, 'adminhtml/default', BP . '/app/design/adminhtml/default' );

...
class UpdatePackagesCacheTest extends \PHPUnit_Framework_TestCase {
	...
	private function setupDirectory($composerDir) {
		...
		$this->composerInformation = $this->objectManager->create ( 'Magento\Framework\Composer\ComposerInformation', [ 
	...
	public function testGetPackagesForUpdate() {
		...
		$updatePackagesCache = $this->objectManager->create ( 'Magento\Setup\Model\UpdatePackagesCache', [ 
				'applicationFactory' => new MagentoComposerApplicationFactory ( $this->composerJsonFinder, $this->directoryList ),

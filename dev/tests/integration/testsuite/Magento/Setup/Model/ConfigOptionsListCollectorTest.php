...
class ConfigOptionsListCollectorTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->objectManagerProvider->expects ( $this->any () )->method ( 'get' )->willReturn ( \Magento\TestFramework\Helper\Bootstrap::getObjectManager () );
	}
	public function testCollectOptionsLists() {
		...
		$fullModuleListMock->expects ( $this->once () )->method ( 'getNames' )->willReturn ( [ 
				'Magento_Backend' 
		] );
		...
		$setupOptions = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Setup\Model\ConfigOptionsList', [ 
		...
		$serviceLocator->expects ( $this->once () )->method ( 'get' )->with ( 'Magento\Setup\Model\ConfigOptionsList' )->willReturn ( $setupOptions );
		
		/** @var \Magento\Setup\Model\ConfigOptionsListCollector $object */
		$object = $objectManager->create ( 'Magento\Setup\Model\ConfigOptionsListCollector', [ 

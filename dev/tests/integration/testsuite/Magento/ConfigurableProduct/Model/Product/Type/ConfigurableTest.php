...
class ConfigurableTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSetUsedProductAttributeIds() {
		$testConfigurable = $this->_getAttributeByCode ( 'test_configurable' );
		$this->_model->setUsedProductAttributeIds ( [ 
				$testConfigurable->getId () 
		], $this->_product );
	...
	public function testGetConfigurableAttributes() {
		...
		$this->assertInstanceOf ( 'Magento\ConfigurableProduct\Model\ResourceModel\Product\Type\Configurable\Attribute\Collection', $collection );
		$testConfigurable = $this->_getAttributeByCode ( 'test_configurable' );
	...
	public function testGetUsedProductCollection() {
		$this->assertInstanceOf ( 'Magento\ConfigurableProduct\Model\ResourceModel\Product\Type\Configurable\Product\Collection', $this->_model->getUsedProductCollection ( $this->_product ) );
	}
	public function testBeforeSave() {
		...
		$this->_product->setConfigurableAttributesData ( [ 
				[ 
						'values' => 'not empty' 
				] 
		] );
	...
	public function testGetSelectedAttributesInfo() {
		...
		$this->_product->addCustomOption ( 'attributes', serialize ( [ 
				$attribute ['attribute_id'] => $optionValueId 
		] ) );
	...
	public function testGetSpecifyOptionMessage() {
		$this->assertEquals ( 'You need to choose options for your item.', ( string ) $this->_model->getSpecifyOptionMessage () );
	}
	...
	protected function _getAttributeByCode($code) {
		return \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Eav\Model\Config' )->getAttribute ( 'catalog_product', $code );
	}

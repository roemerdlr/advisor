...
class CartTest extends \Magento\TestFramework\TestCase\AbstractController {
	...
	public function testConfigureActionWithConfigurableProduct() {
		...
		$this->assertSelectCount ( 'button[type="submit"][title="Update Cart"]', 1, $response->getBody (), 'Response for configurable product doesn\'t contain "Update Cart" button' );
		
		$this->assertSelectCount ( 'select.super-attribute-select', 1, $response->getBody (), 'Response for configurable product doesn\'t contain select for super attribute' );
	}

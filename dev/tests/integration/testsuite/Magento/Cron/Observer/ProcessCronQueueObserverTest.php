...
class ProcessCronQueueObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$request->setParams ( [ 
				'group' => 'default',
				'standaloneProcessStarted' => '0' 
		] );
		$this->_model = Bootstrap::getObjectManager ()->create ( 'Magento\Cron\Observer\ProcessCronQueueObserver', [ 
				'request' => $request 
		] );
	...
	public function testDispatchScheduled() {
		$collection = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Cron\Model\ResourceModel\Schedule\Collection' );

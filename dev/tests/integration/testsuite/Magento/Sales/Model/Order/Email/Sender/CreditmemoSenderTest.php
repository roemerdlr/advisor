...
class CreditmemoSenderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSend() {
		...
		$creditmemo = Bootstrap::getObjectManager ()->create ( 'Magento\Sales\Model\Order\Creditmemo' );
		$creditmemo->setOrder ( $order );
		
		$this->assertEmpty ( $creditmemo->getEmailSent () );
		
		$creditmemoSender = Bootstrap::getObjectManager ()->create ( 'Magento\Sales\Model\Order\Email\Sender\CreditmemoSender' );

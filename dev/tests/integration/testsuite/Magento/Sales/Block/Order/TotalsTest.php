...
class TotalsTest extends \PHPUnit_Framework_TestCase {
	public function testToHtmlChildrenInitialized() {
		...
		$block->setOrder ( \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Sales\Model\Order' ) )->setTemplate ( 'order/totals.phtml' );
		
		$context = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\View\Element\Context' );
		$childOne = $this->getMock ( 'Magento\Framework\View\Element\Text', [ 
				'initTotals' 
		], [ 
				$context 
		] );
		...
		$childTwo = $this->getMock ( 'Magento\Framework\View\Element\Text', [ 
				'initTotals' 
		], [ 
				$context 
		] );
		...
		$childThree = $this->getMock ( 'Magento\Framework\View\Element\Text', [ 
				'initTotals' 
		], [ 
				$context 
		] );

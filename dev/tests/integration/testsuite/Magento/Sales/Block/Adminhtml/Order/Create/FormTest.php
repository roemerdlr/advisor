...
class FormTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_orderCreateBlock = $layout->createBlock ( 'Magento\Sales\Block\Adminhtml\Order\Create\Form', 'order_create_block' . rand (), [ 
...
ORDER_DATA_JSON;
	...
	private function setUpMockAddress() {
		...
		$addressData1 = $addressFactory->create ()->setCountryId ( 'US' )->setCustomerId ( 1 )->setIsDefaultBilling ( true )->setIsDefaultShipping ( true )->setPostcode ( '75477' )->setRegion ( $regionFactory->create ()->setRegionCode ( 'AL' )->setRegion ( 'Alabama' )->setRegionId ( 1 ) )->setStreet ( [ 
				'Green str, 67' 
		] )->setTelephone ( '3468676' )->setCity ( 'CityM' )->setFirstname ( 'John' )->setLastname ( 'Smith' );
		
		$addressData2 = $addressFactory->create ()->setCountryId ( 'US' )->setCustomerId ( 1 )->setIsDefaultBilling ( false )->setIsDefaultShipping ( false )->setPostcode ( '47676' )->setRegion ( $regionFactory->create ()->setRegionCode ( 'AL' )->setRegion ( 'Alabama' )->setRegionId ( 1 ) )->setStreet ( [ 
				'Black str, 48' 

...
class AddressTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->addressRepository = $this->getMockForAbstractClass ( 'Magento\Customer\Api\AddressRepositoryInterface', [ ], '', false, true, true, [ 
				'getList' 
		] );
		/** @var \Magento\Framework\View\LayoutInterface $layout */
		$layout = $this->_objectManager->get ( 'Magento\Framework\View\LayoutInterface' );
		$sessionQuoteMock = $this->getMockBuilder ( 'Magento\Backend\Model\Session\Quote' )->disableOriginalConstructor ()->setMethods ( [ 
				'getCustomerId',
				'getStore',
				'getStoreId',
				'getQuote' 
		...
		$this->_addressBlock = $layout->createBlock ( 'Magento\Sales\Block\Adminhtml\Order\Create\Form\Address', 'address_block' . rand (), [ 
	...
	public function testGetAddressCollection() {
		...
		$searchResult = $this->getMockForAbstractClass ( 'Magento\Customer\Api\Data\AddressSearchResultsInterface', [ ], '', false, true, true, [ 
				'getItems' 
		] );
	...
	protected function _getAddresses() {
		...
		$addressData [] = $addressFactory->create ()->setId ( 1 )->setStreet ( [ 
				'Street1' 
		] )->setFirstname ( 'FirstName1' )->setLastname ( 'LastName1' );
		$addressData [] = $addressFactory->create ()->setId ( 2 )->setStreet ( [ 
				'Street2' 
		] )->setFirstname ( 'FirstName2' )->setLastname ( 'LastName2' );
		return $addressData;
	}
}

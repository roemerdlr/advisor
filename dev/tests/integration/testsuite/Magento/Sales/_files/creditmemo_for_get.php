...
$orderItem->setName ( 'Test item' )->setQtyRefunded ( 1 )->setQtyInvoiced ( 10 )->setId ( 1 )->setOriginalPrice ( 20 );
...
$creditItem->setCreditmemo ( $creditmemo )->setOrderItem ( $orderItem )->setName ( 'Creditmemo item' )->setQty ( 1 )->setPrice ( 20 )->save ();

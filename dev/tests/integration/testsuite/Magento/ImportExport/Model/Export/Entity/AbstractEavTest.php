...
class AbstractEavTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @var array
	 */
	protected static $_skippedAttributes = [ 
			'confirmation',
			'lastname' 
	];
	...
	protected function setUp() {
		...
		$customerAttributes = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Customer\Model\ResourceModel\Attribute\Collection' );
		
		$this->_model = $this->getMockForAbstractClass ( 'Magento\ImportExport\Model\Export\Entity\AbstractEav', [ ], '', false );
	...
	public function testGetEntityTypeId() {
		$entityCode = 'customer';
		$entityId = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Eav\Model\Config' )->getEntityType ( $entityCode )->getEntityTypeId ();

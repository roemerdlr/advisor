...
class EntityAbstractTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSaveValidatedBunches() {
		...
		$model = $this->getMockForAbstractClass ( 'Magento\ImportExport\Model\Import\AbstractEntity', [ 
				...
				$objectManager->get ( 'Magento\ImportExport\Model\Import\ErrorProcessing\ProcessingErrorAggregatorInterface' ) 
		], '', true, false, true, [ 

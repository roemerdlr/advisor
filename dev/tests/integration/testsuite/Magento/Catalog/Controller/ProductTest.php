...
class ProductTest extends \Magento\TestFramework\TestCase\AbstractController {
	...
	public function testViewAction() {
		...
		$lastViewedProductId = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Catalog\Model\Session' )->getLastViewedProductId ();
		...
		$this->assertSelectCount ( 'meta[name="description"][content="Simple Product 1 Meta Description"]', 1, $responseBody );
	}

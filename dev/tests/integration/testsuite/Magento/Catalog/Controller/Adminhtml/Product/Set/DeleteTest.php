...
class DeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController {
	...
	protected function getAttributeSetByName($attributeSetName) {
		$attributeSet = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Eav\Model\Entity\Attribute\Set' )->load ( $attributeSetName, 'attribute_set_name' );

...
class ProductTest extends \PHPUnit_Framework_TestCase {
	...
	public static function tearDownAfterClass() {
		...
		$mediaDirectory = $objectManager->get ( 'Magento\Framework\Filesystem' )->getDirectoryWrite ( DirectoryList::MEDIA );
	...
	public function testCleanCache() {
		\Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\App\CacheInterface' )->save ( 'test', 'catalog_product_999', [ 
				'catalog_product_999' 
		] );
	...
	public function testIsProductsHasSku() {
		$this->assertTrue ( $this->_model->isProductsHasSku ( [ 
				10,
				11 
		] ) );
	}

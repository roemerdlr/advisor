...
class CategoryImageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_oldLogActive = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Store\Model\StoreManagerInterface' )->getStore ()->getConfig ( 'dev/log/active' );
		$this->_oldExceptionFile = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Store\Model\StoreManagerInterface' )->getStore ()->getConfig ( 'dev/log/exception_file' );
	}
	protected function tearDown() {
		\Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\App\Config\MutableScopeConfigInterface' )->setValue ( 'dev/log/active', $this->_oldLogActive, \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
		
		$this->_oldLogActive = null;
		
		\Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\App\Config\MutableScopeConfigInterface' )->setValue ( 'dev/log/exception_file', $this->_oldExceptionFile, \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
	...
	public function testSaveCategoryWithoutImage() {
		...
		$category = $objectManager->get ( 'Magento\Framework\Registry' )->registry ( '_fixture/Magento\Catalog\Model\Category' );

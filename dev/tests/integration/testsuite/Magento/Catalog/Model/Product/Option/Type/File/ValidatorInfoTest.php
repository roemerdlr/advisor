...
class ValidatorInfoTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->validateFactoryMock = $this->getMock ( 'Magento\Catalog\Model\Product\Option\Type\File\ValidateFactory', [ 
				'create' 
		] );
	...
	public function testExceptionWithErrors() {
		...
		$validateMock = $this->getMock ( 'Zend_Validate', [ 
				'isValid',
				'getErrors' 
		] );
	...
	public function testExceptionWithoutErrors() {
		$this->setExpectedException ( '\Magento\Framework\Exception\LocalizedException', "Please specify product's required option(s)." );

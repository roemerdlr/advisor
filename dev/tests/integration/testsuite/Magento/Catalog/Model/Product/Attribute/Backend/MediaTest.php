...
class MediaTest extends \PHPUnit_Framework_TestCase {
	...
	public function testUpdateImage() {
		...
		$this->_model->updateImage ( $product, 'magento_image.jpg', [ 
				'label' => 'test label' 
		] );
	...
	public function testClearMediaAttribute() {
		...
		$this->_model->clearMediaAttribute ( $product, [ 
				'test_media2',
				'test_media3' 
		] );
	...
	public function testSetMediaAttribute() {
		...
		$this->_model->setMediaAttribute ( $product, [ 
				'test_media2',
				'test_media3' 
		], 'test' );

...
class FlatTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @var string[]
	 */
	protected static $attributesToExclude = [ 
			'url_path',
			'display_mode' 
	];
	...
	public static function setUpBeforeClass() {
		$category = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Category' )->load ( 2 );
	...
	public function testReindexAll() {
		...
		$indexer = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Indexer\Model\Indexer' );
	...
	public function testCreateCategory() {
		...
		$categoryOne = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Category' );
		...
		$categoryTwo = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Category' );
	...
	public function testFlatAfterCreate() {
		...
		/** @var \Magento\Catalog\Model\Category $categoryOne */
		$categoryOne = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Category' )->load ( self::$categoryOne );
		...
		/** @var \Magento\Catalog\Model\Category $categoryTwo */
		$categoryTwo = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Category' )->load ( self::$categoryTwo );
	...
	protected static function loadAttributeCodes() {
		...
		$catalogConfig = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Config' );

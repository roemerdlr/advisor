...
class AbstractTest extends \PHPUnit_Framework_TestCase {
	...
	public function testLockedAttributeApi() {
		...
		$this->assertEquals ( [ 
				'code' 
		], $this->_model->getLockedAttributes () );
	...
	public function testGetStore() {
		...
		$this->assertSame ( $store, \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Store\Model\StoreManagerInterface' )->getStore () );
	}

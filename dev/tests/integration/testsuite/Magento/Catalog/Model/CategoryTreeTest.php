 ...
 *
 * @see \Magento\Catalog\Model\CategoryTest @magentoDataFixture Magento/Catalog/_files/categories.php
 */
class CategoryTreeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Category' );
	}

 ...
 *
 * @see \Magento\Catalog\Model\CategoryTreeTest @magentoDataFixture Magento/Catalog/_files/categories.php
...
class CategoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetAvailableSortBy() {
		...
		$this->assertEquals ( [ 
				...
				'and',
				'test' 
		], $this->_model->getAvailableSortBy () );
	}

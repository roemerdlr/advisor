 ...
 * @see \Magento\Catalog\Model\ProductPriceTest @magentoDataFixture Magento/Catalog/_files/categories.php
 */
class ProductExternalTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Product' );
	}
	public function testGetStoreId() {
		$this->assertEquals ( \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Store\Model\StoreManagerInterface' )->getStore ()->getId (), $this->_model->getStoreId () );
	...
	public function testGetCategory() {
		...
		/** @var $objectManager \Magento\TestFramework\ObjectManager */
		$objectManager = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ();
		$objectManager->get ( 'Magento\Framework\Registry' )->register ( 'current_category', new \Magento\Framework\DataObject ( [ 
				'id' => 3 
		] ) );
		// fixture
		try {
	...
	public function testGetUrlPath() {
		...
		$urlPathGenerator = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\CatalogUrlRewrite\Model\ProductUrlPathGenerator' );
	...
	public function testOptionApi() {
		...
		$optionId = uniqid ();
		$option = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Product\Option', [ 
				'data' => [ 
						'key' => 'value' 
				] 
		] );
	...
	public function testCustomOptionsApi() {
		...
		$this->assertEquals ( [ 
				'one' => $option 
		], $this->_model->getCustomOptions () );
		$this->assertTrue ( $this->_model->hasCustomOptions () );
		
		$this->_model->setCustomOptions ( [ 
				'test' 
		] );

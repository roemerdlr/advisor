...
class AjaxTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		parent::setUp ();
		$this->_block = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\Catalog\Block\Adminhtml\Product\Options\Ajax' );
	}
	...
	public function testToHtml() {
		...
		$objectManager->get ( 'Magento\Framework\Registry' )->register ( 'import_option_products', [ 
				1 
		] );

...
class ListTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_block = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\Catalog\Block\Product\ListProduct' );
	}
	...
	public function testGetAdditionalHtml() {
		...
		$childBlock = $layout->createBlock ( 'Magento\Framework\View\Element\Text', 'test', [ 
				'data' => [ 
						'text' => 'test' 
				] 
		] );

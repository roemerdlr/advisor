...
class OutputTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_helper = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Catalog\Helper\Output' );
	}
	...
	public function testAddHandlerGetHandlers() {
		...
		$this->assertSame ( [ 
				$objectOne 
		], $this->_helper->getHandlers ( 'valid' ) );
	...
	public function testProductAttribute() {
		$this->_testAttribute ( 'productAttribute', \Magento\Catalog\Model\Product::ENTITY, "&lt;p&gt;line1&lt;/p&gt;<br />\nline2" );
	}
	public function testCategoryAttribute() {
		$this->_testAttribute ( 'categoryAttribute', \Magento\Catalog\Model\Category::ENTITY, "&lt;p&gt;line1&lt;/p&gt;\nline2" );
	}
	 ...
	 * @param mixed $params        	
	 * @return string
	 * @see testProcess() @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	...
	protected function _testAttribute($method, $entityCode, $expectedResult) {
		...
		$attribute = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Eav\Model\Config' )->getAttribute ( $entityCode, $attributeName );
		...
		try {
			$this->assertEquals ( $expectedResult, $this->_helper->{$method} ( uniqid (), "<p>line1</p>\nline2", $attributeName ) );

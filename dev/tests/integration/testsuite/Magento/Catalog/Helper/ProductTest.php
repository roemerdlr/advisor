...
class ProductTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_helper = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Catalog\Helper\Product' );
	}
	...
	public function testGetThumbnailUrl() {
		$this->assertEmpty ( $this->_helper->getThumbnailUrl ( \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Catalog\Model\Product' ) ) );
	}
	...
	public function testInitProduct() {
		\Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Catalog\Model\Session' )->setLastVisitedCategoryId ( 2 );

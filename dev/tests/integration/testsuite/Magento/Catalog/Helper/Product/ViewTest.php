...
class ViewTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->objectManager->get ( 'Magento\Framework\App\Http\Context' )->setValue ( Context::CONTEXT_AUTH, false, false );
		$this->objectManager->get ( 'Magento\Framework\View\DesignInterface' )->setDefaultDesignTheme ();
		...
		$this->_controller = $this->objectManager->create ( 'Magento\Catalog\Helper\Product\Stub\ProductControllerStub', [ 
				'context' => $context 
		] );

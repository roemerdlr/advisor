...
class PageTest extends \PHPUnit_Framework_TestCase {
	...
	public function testRenderPage() {
		...
		$context = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Framework\App\Action\Context', $arguments );
		...
		$result = $pageHelper->prepareResultPage ( \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Framework\App\Test\Unit\Action\Stub\ActionStub', [ 
				'context' => $context 
		] ), $page->getId () );

...
class ImportConfigFilesTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$xmlFiles = $fileIteratorFactory->create ( $moduleDirSearch->collectFiles ( ComponentRegistrar::MODULE, 'etc/{*/import.xml,import.xml}' ) );
		...
		$this->_model = $objectManager->create ( 'Magento\ImportExport\Model\Import\Config\Reader', [ 

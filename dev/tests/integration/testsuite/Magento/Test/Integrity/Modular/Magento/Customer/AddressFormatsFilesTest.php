...
class AddressFormatsFilesTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$schemaLocator = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Customer\Model\Address\Config\SchemaLocator' );
	...
	public function fileFormatDataProvider() {
		return \Magento\Framework\App\Utility\Files::init ()->getConfigFiles ( '{*/address_formats.xml,address_formats.xml}' );
	}
}

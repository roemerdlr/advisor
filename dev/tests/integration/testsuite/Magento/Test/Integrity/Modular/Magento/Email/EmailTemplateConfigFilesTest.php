...
class EmailTemplateConfigFilesTest extends \PHPUnit_Framework_TestCase {
	...
	public function testTemplateReference($templateId) {
		...
		$emailConfig = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Email\Model\Template\Config' );
	...
	public function testMergedFormat() {
		...
		$reader = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Email\Model\Template\Config\Reader', [ 

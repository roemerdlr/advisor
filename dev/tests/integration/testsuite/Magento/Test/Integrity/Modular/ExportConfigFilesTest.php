...
class ExportConfigFilesTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$xmlFiles = $fileIteratorFactory->create ( $moduleDirSearch->collectFiles ( ComponentRegistrar::MODULE, 'etc/{*/export.xml,export.xml}' ) );
		...
		$this->_model = $objectManager->create ( 'Magento\ImportExport\Model\Export\Config\Reader', [ 

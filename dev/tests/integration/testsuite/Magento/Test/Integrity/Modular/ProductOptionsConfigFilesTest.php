...
class ProductOptionsConfigFilesTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$xmlFiles = $fileIteratorFactory->create ( $moduleDirSearch->collectFiles ( ComponentRegistrar::MODULE, 'etc/{*/product_options.xml,product_options.xml}' ) );
		...
		$objectManager = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ();
		$this->_model = $objectManager->create ( 'Magento\Catalog\Model\ProductOptions\Config\Reader', [ 

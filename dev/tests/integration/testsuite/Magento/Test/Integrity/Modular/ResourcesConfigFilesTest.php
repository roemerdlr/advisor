...
class ResourcesConfigFilesTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$xmlFiles = $fileIteratorFactory->create ( $moduleDirSearch->collectFiles ( ComponentRegistrar::MODULE, 'etc/{*/resources.xml,resources.xml}' ) );
		...
		$objectManager = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ();
		$this->_model = $objectManager->create ( 'Magento\Framework\App\ResourceConnection\Config\Reader', [ 

...
class EavAttributesConfigFilesTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$xmlFiles = $fileIteratorFactory->create ( $moduleDirSearch->collectFiles ( ComponentRegistrar::MODULE, 'etc/{*/eav_attributes.xml,eav_attributes.xml}' ) );
		...
		$this->_model = $objectManager->create ( 'Magento\Eav\Model\Entity\Attribute\Config\Reader', [ 

...
class XmlFilesTest extends \PHPUnit_Framework_TestCase {
	...
	public function viewConfigFileDataProvider() {
		...
		$componentDirSearch = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\Component\DirSearch' );
	...
	public function themeConfigFileExistsDataProvider() {
		...
		$componentRegistrar = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( '\Magento\Framework\Component\ComponentRegistrar' );
		foreach ( $componentRegistrar->getPaths ( ComponentRegistrar::THEME ) as $themeDir ) {
			$result [substr ( $themeDir, strlen ( BP ) )] = [ 
					$themeDir 
			];
		}
		return $result;

...
class TemplateFilesTest extends \Magento\TestFramework\TestCase\AbstractIntegrity {
		...
		foreach ( $layoutTemplates as $template ) {
			...
			switch ($attributes ['method']) {
				case 'setTemplate' :
					...
					$block = $layoutXml->xpath ( "//block[@name='{$referenceName}'] | //referenceBlock[@name='{$referenceName}']" );
	 ...
	 *        	Module of a block that will render this template

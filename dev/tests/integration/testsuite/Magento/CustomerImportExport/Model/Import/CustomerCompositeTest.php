...
class CustomerCompositeTest extends \PHPUnit_Framework_TestCase {
	...
	protected $_afterImport = [ 
			...
			'anthonyanealy@magento.com' => [ 
					'addresses' => [ 
							'72701',
							'92664' 
					] 
			],
			'loribbanks@magento.com' => [ 
					'addresses' => [ 
							'98801' 
					] 
			],
			'kellynilson@magento.com' => [ 
					'addresses' => [ ] 
			] 
	];
	protected function setUp() {
		$this->_objectManager = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ();
		$this->_entityAdapter = $this->_objectManager->create ( 'Magento\CustomerImportExport\Model\Import\CustomerComposite' );
	}

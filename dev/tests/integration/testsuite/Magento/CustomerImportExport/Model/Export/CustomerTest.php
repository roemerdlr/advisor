...
class CustomerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\CustomerImportExport\Model\Export\Customer' );
	}
	...
	public function testGetAttributeCollection() {
		$this->assertInstanceOf ( 'Magento\Customer\Model\ResourceModel\Attribute\Collection', $this->_model->getAttributeCollection () );
	}
	...
	public function testFilterEntityCollection() {
		...
		$customers [0]->save ();
		/**
		 * Change type of created_at attribute.
		 * In this case we have possibility to test date rage filter
		 */
		...
		$parameters = [ 
				\Magento\ImportExport\Model\Export::FILTER_ELEMENT_GROUP => [ 
						...
						'store_id' => \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Store\Model\StoreManagerInterface' )->getStore ()->getId () 
				] 
		];
		$this->_model->setParameters ( $parameters );
		/** @var $customers \Magento\Customer\Model\ResourceModel\Customer\Collection */
		$collection = $this->_model->filterEntityCollection ( \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Customer\Model\ResourceModel\Customer\Collection' ) );
		$collection->load ();

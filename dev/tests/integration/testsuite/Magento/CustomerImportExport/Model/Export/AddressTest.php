...
class AddressTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		parent::setUp ();
		$this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\CustomerImportExport\Model\Export\Address' );
		
		$websites = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Store\Model\StoreManagerInterface' )->getWebsites ( true );
	...
	public function testExport() {
		...
		$collection = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Customer\Model\ResourceModel\Address\Attribute\Collection' );
	...
	public function testGetAttributeCollection() {
		$this->assertInstanceOf ( 'Magento\Customer\Model\ResourceModel\Address\Attribute\Collection', $this->_model->getAttributeCollection () );
	}
	 ...
	 * Filename must be set in constructor.
	 */

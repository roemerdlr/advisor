...
class AllowedIpsTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSaveWithEscapeHtml($value, $expected) {
		 ...
		 */
		$model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Developer\Model\Config\Backend\AllowedIps' );
	...
	public function fieldDataProvider() {
		return [ 
				...
				[ 
						'10.64.202.22, <' . 'script>alert(\'XSS\')</script>',
						'10.64.202.22' 
				] 
		];
	}

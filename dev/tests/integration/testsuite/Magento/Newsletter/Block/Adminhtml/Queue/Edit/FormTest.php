...
class FormTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPrepareForm() {
		...
		$objectManager->get ( 'Magento\Framework\Config\ScopeInterface' )->setCurrentScope ( \Magento\Backend\App\Area\FrontNameResolver::AREA_CODE );
		$block = $objectManager->create ( 'Magento\Newsletter\Block\Adminhtml\Queue\Edit\Form', [ 
				'registry' => $registry 
		] );
		$prepareFormMethod = new \ReflectionMethod ( 'Magento\Newsletter\Block\Adminhtml\Queue\Edit\Form', '_prepareForm' );

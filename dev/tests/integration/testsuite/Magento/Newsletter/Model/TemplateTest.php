...
class TemplateTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetProcessedTemplateFrontend($store, $design) {
		...
		$processedTemplate = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\App\State' )->emulateAreaCode ( 'frontend', [ 
				$this->_model,
	...
	public function testGetProcessedTemplateArea($area, $design) {
		...
		$processedTemplate = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\App\State' )->emulateAreaCode ( $area, [ 
				$this->_model,
				'getProcessedTemplate' 
		] );

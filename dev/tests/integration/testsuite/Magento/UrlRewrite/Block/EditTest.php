...
class EditTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPrepareLayout($blockAttributes, $expected) {
		...
		$block = $layout->createBlock ( 'Magento\UrlRewrite\Block\Edit', '', [ 
	...
	private function _checkForm($block, $expected) {
		...
		if ($expected ['form']) {
			$this->assertInstanceOf ( 'Magento\UrlRewrite\Block\Edit\Form', $formBlock, 'Child block with form is invalid' );

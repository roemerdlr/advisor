...
class ConditionsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->block = $this->objectManager->create ( 'Magento\CatalogWidget\Block\Product\Widget\Conditions' )->setArea ( 'adminhtml' );
	}
	public function testRender() {
		...
		$this->assertContains ( 'catalog_widget/product_widget/conditions/form/options_fieldset67a77e971a7c331b6eaefcaf2f596097', $result );

...
class FulltextTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->engine = Bootstrap::getObjectManager ()->get ( 'Magento\CatalogSearch\Model\ResourceModel\Engine' );
		
		$this->resourceFulltext = Bootstrap::getObjectManager ()->get ( 'Magento\CatalogSearch\Model\ResourceModel\Fulltext' );
		
		$this->queryFactory = Bootstrap::getObjectManager ()->get ( 'Magento\Search\Model\QueryFactory' );
		
		$this->dimension = Bootstrap::getObjectManager ()->create ( '\Magento\Framework\Search\Request\Dimension', [ 
				'name' => 'scope',
				'value' => '1' 
		] );
	...
	public function testReindexRowAfterMassAction() {
		...
		$action = Bootstrap::getObjectManager ()->get ( 'Magento\Catalog\Model\Product\Action' );

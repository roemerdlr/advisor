...
class ProfilerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Framework\App\ResourceConnection' );
	}
	...
	protected function _getConnection() {
		...
		return $objectManager->create ( 'Magento\TestFramework\Db\Adapter\Mysql', [ 
	...
	public function profileQueryDataProvider() {
		return [ 
				[ 
						"SELECT * FROM %s",
						\Magento\Framework\DB\Profiler::SELECT 
				],
				[ 
						"INSERT INTO %s (module, schema_version, data_version) " . "VALUES ('" . self::$_testResourceName . "', '1.1', '1.1')",

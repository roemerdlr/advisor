...
class UrlTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetBaseUrlWithTypeRestoring() {
		 ...
		 */
		$mediaUrl = $this->_model->getBaseUrl ( [ 
	...
	public function testGetRouteUrl() {
		...
		$this->assertEquals ( 'http://localhost/index.php/catalog/product/view/id/50/', $this->_model->getRouteUrl ( 'catalog/product/view', [ 
				'id' => 50 
		] ) );
		$this->assertEquals ( 'http://localhost/index.php/fancy_uri', $this->_model->getRouteUrl ( 'core/index/index', [ 
				'_direct' => 'fancy_uri' 
		] ) );
	}
	...
	public function testGetUrl() {
		$result = $this->_model->getUrl ( 'catalog/product/view', [ 
				'_fragment' => 'anchor',
				'_escape' => 1,
				'_query' => 'foo=bar',
				'_nosid' => 1,
	...
	public function testGetDirectUrl() {
		$directUrl = $this->_model->getDirectUrl ( 'fancy_uri', [ 
				'_query' => [ 
						'foo' => 'bar' 
				] 
		] );
	...
	public function testSessionUrlVar() {
		$sessionId = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\Session\Generic' )->getSessionId ();

...
class ReaderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_fileResolverMock = $this->getMockBuilder ( 'Magento\Framework\App\Arguments\FileResolver\Primary' )->disableOriginalConstructor ()->setMethods ( [ 
				'get' 
		] )->getMock ();
		...
		$this->_schemaLocator = new \Magento\Framework\Api\ExtensionAttribute\Config\SchemaLocator ( new \Magento\Framework\Config\Dom\UrnResolver () );
	}
	public function testMerge() {
		$model = new \Magento\Framework\Api\ExtensionAttribute\Config\Reader ( $this->_fileResolverMock, $this->_converter, $this->_schemaLocator, $this->_validationState );

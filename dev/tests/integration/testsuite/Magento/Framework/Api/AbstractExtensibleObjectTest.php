...
class AbstractExtensibleObjectTest extends \PHPUnit_Framework_TestCase {
	...
	public function testExtensionAttributes($expectedDataBefore, $expectedDataAfter) {
		...
		$regionExtension = $regionExtensionFactory->create ( 'Magento\Wonderland\Model\Data\FakeRegion', [ 
		...
		$region->setExtensionAttributes ( $regionExtensionFactory->create ( 'Magento\Wonderland\Model\Data\FakeRegion', [ 

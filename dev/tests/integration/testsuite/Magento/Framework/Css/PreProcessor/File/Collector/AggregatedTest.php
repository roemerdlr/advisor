...
class AggregatedTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$filesystem = $this->objectManager->create ( 'Magento\Framework\Filesystem', [ 
				'directoryList' => $this->objectManager->create ( 'Magento\Framework\App\Filesystem\DirectoryList', [ 
						'root' => BP 
				] ) 
		] );
		
		/** @var \Magento\Framework\View\File\Collector\Base $sourceBase */
		$sourceBase = $this->objectManager->create ( 'Magento\Framework\View\File\Collector\Base', [ 
				'filesystem' => $filesystem,
				'subDir' => 'web' 
		] );
		/** @var \Magento\Framework\View\File\Collector\Base $sourceBase */
		$overriddenBaseFiles = $this->objectManager->create ( 'Magento\Framework\View\File\Collector\Override\Base', [ 
				'filesystem' => $filesystem,
				'subDir' => 'web' 
		] );
		$this->model = $this->objectManager->create ( 'Magento\Framework\Css\PreProcessor\File\Collector\Aggregated', [ 
				'baseFiles' => $sourceBase,
				'overriddenBaseFiles' => $overriddenBaseFiles 
		] );
	}
	...
	public function getFilesDataProvider() {
		...
		return [ 
				'file in theme and parent theme' => [ 
						...
						[ 
								str_replace ( '\\', '/', "$fixtureDir/_files/design/frontend/Test/default/web/1.file" ),
								str_replace ( '\\', '/', "$fixtureDir/_files/design/frontend/Test/parent/MagentoFrameworkCssTest_Second/web/1.file" ),
								str_replace ( '\\', '/', "$fixtureDir/_files/design/frontend/Test/default/MagentoFrameworkCssTest_Module/web/1.file" ) 
						] 
				],
				'file in library' => [ 
						'2.file',
						'FrameworkCssTest/default',
						[ 
								str_replace ( '\\', '/', "$fixtureDir/_files/lib/web/2.file" ) 
						] 
				],
				'non-existing file' => [ 
						'doesNotExist',
				...
				'file in library, module, and theme' => [ 
						...
						'FrameworkCssTest/default',
						[ 
								str_replace ( '\\', '/', "$fixtureDir/_files/lib/web/3.less" ),
								str_replace ( '\\', '/', "$fixtureDir/_files/code/Magento/Other/view/frontend/web/3.less" ),
								str_replace ( '\\', '/', "$fixtureDir/_files/design/frontend/Test/default/MagentoFrameworkCssTest_Third/web/3.less" ) 
						] 
				] 
		];
	}

...
class ManagerTest extends \PHPUnit_Framework_TestCase {
	...
	public function testAddMessage() {
		$errorMessage = $this->objectManager->create ( 'Magento\Framework\Message\Error', [ 
				'text' => 'some text' 
		] );
		$this->model->addMessage ( $errorMessage );
		
		$customGroup = 'custom-group';
		$errorMessageCustom = $this->objectManager->create ( 'Magento\Framework\Message\Error', [ 
	...
	public function testAddMessages() {
		$customGroup = 'custom-group';
		$messages = [ 
				$this->objectManager->create ( 'Magento\Framework\Message\Error', [ 
						'text' => 'some text 1' 
				] ),
				$this->objectManager->create ( 'Magento\Framework\Message\Error', [ 
						'text' => 'some text 2' 
	...
	public function testAddUniqueMessages() {
		$errorMessageFirst = $this->objectManager->create ( 'Magento\Framework\Message\Error', [ 
				'text' => 'some text' 
		] );
		$errorMessageSecond = $this->objectManager->create ( 'Magento\Framework\Message\Error', [ 
				'text' => 'some text' 
		] );

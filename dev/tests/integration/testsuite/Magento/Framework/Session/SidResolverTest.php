...
class SidResolverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->urlBuilder = $this->getMockBuilder ( 'Magento\Framework\Url' )->setMethods ( [ 
				'isOwnOriginUrl' 
		] )->disableOriginalConstructor ()->getMockForAbstractClass ();
		
		$this->request = $objectManager->get ( 'Magento\Framework\App\RequestInterface' );
		
		$this->model = $objectManager->create ( 'Magento\Framework\Session\SidResolver', [ 
				'scopeConfig' => $this->scopeConfig,
				'urlBuilder' => $this->urlBuilder,
				'sidNameMap' => [ 
						$this->customSessionName => $this->customSessionQueryParam 
				],

...
class MongoDbTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		if (empty ( $this->_connectionString ) || ! extension_loaded ( 'mongo' )) {
			$this->markTestSkipped ( "Either 'mongo' extension is not loaded or 'MONGODB_CONNECTION_STRING' constant is not defined" );
		}
	...
	public function touchDataProvider() {
		return [ 
				'not enough extra lifetime' => [ 
						0,
						$this->isFalse () 
				],
				'enough extra lifetime' => [ 
						1000,
	...
	public function loadDataProvider() {
		return [ 
				'infinite lifetime with validity' => [ 
						'test data',
						null,
						false,
						'test data' 
				],
				'infinite lifetime without validity' => [ 
						'test data',
						null,
						true,
						'test data' 
				],
				'zero lifetime with validity' => [ 
						'test data',
						0,
						false,
						false 
				],
				'zero lifetime without validity' => [ 
						'test data',
						0,
						true,
						'test data' 
	...
	protected function _prepareCollection() {
		...
		$this->_model->save ( 'test data 3', 'test3', [ 
				'tag2',
				'tag1' 
		] );
		$this->_model->save ( 'test data 4', 'test4', [ 
				'tag4',
				'tag5' 
		] );

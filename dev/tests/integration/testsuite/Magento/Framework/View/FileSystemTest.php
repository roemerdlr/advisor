...
class FileSystemTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = $objectManager->create ( 'Magento\Framework\View\FileSystem' );
		$objectManager->get ( 'Magento\Framework\View\DesignInterface' )->setDesignTheme ( 'Test_FrameworkThemeTest/default' );
	}
	...
	public function testGetFileNameAccordingToLocale() {
		...
		$actual = $this->_model->getStaticFileName ( 'logo.gif', [ 
				'locale' => 'fr_FR' 
		] );
		$this->_testExpectedVersusActualFilename ( $expected, $actual );
	}
	...
	public function testGetViewFile() {
		...
		$params = [ 
				'theme' => 'Vendor_FrameworkThemeTest/custom_theme' 
		];

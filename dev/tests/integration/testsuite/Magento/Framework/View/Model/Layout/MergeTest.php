...
class MergeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$layoutUpdate1 = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Widget\Model\Layout\Update' );
		...
		$layoutUpdate2 = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Widget\Model\Layout\Update' );

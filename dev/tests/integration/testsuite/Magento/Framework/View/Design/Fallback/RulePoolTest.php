...
class RulePoolTest extends \PHPUnit_Framework_TestCase {
	...
	public function getPatternDirsDataProvider() {
		...
		$componentRegistrar = $objectManager->get ( '\Magento\Framework\Component\ComponentRegistrarInterface' );
		...
		$themeOnePath = BP . '/dev/tests/integration/testsuite/Magento/Framework/View/_files/fallback/design/frontend/' . 'Vendor/custom_theme';
		$themeTwoPath = BP . '/dev/tests/integration/testsuite/Magento/Framework/View/_files/fallback/design/frontend/' . 'Vendor/default';
		$modulePath = BP . '/dev/tests/integration/testsuite/Magento/Framework/View/_files/fallback/app/code/' . 'ViewTest_Module';

...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testValidateWithValidData() {
		...
		$validator = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Framework\View\Design\Theme\Validator' );
	...
	protected function _getThemeModel() {
		return \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Framework\View\Design\ThemeInterface' );
	}

...
class FallbackTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->themeFactory = $objectManager->get ( 'Magento\Framework\View\Design\Theme\FlyweightFactory' );
	}
	...
	public function testGetTemplateFile($file, $themePath, $module, $expectedFilename) {
		...
		$model = Bootstrap::getObjectManager ()->create ( 'Magento\Framework\View\Design\FileResolution\Fallback\TemplateFile' );
	...
	public function getTemplateFileDataProvider() {
		return [ 
				...
				'modular: no fallback to non-modular file' => [ 
						'nonexistent_fixture_script.phtml',

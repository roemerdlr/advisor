...
class TransactionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = $this->objectManager->create ( 'Magento\Framework\DB\Transaction' );
	}
	...
	public function testSaveDelete() {
		/** @var Flag $first */
		$first = $this->objectManager->create ( Flag::class, [ 
				'data' => [ 
						'flag_code' => 'test1' 
				] 
		] );
		$first->setFlagData ( 'test1data' );
		$second = $this->objectManager->create ( Flag::class, [ 
				'data' => [ 
						'flag_code' => 'test2' 
				] 
		] );

...
class NoSuchEntityExceptionTest extends \PHPUnit_Framework_TestCase {
	public function testConstructor() {
		...
		$exception = new NoSuchEntityException ( new Phrase ( NoSuchEntityException::MESSAGE_SINGLE_FIELD, [ 
				'fieldName' => 'field',
				'fieldValue' => 'value' 
		] ) );
		...
		$exception = new NoSuchEntityException ( new Phrase ( NoSuchEntityException::MESSAGE_DOUBLE_FIELDS, [ 
				'fieldName' => 'field1',
				'fieldValue' => 'value1',
				'field2Name' => 'field2',
				'field2Value' => 'value2' 

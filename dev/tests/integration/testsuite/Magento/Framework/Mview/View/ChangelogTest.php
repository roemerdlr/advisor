...
class ChangelogTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->model = $this->objectManager->create ( 'Magento\Framework\Mview\View\Changelog', [ 
	...
	public function testCreateAndDrop() {
		...
		$model = $this->objectManager->create ( 'Magento\Framework\Mview\View\Changelog', [ 
				'resource' => $this->resource 
		] );
	...
	public function testGetVersion() {
		...
		$changelogName = $this->resource->getTableName ( $model->getName () );
		$this->connection->insert ( $changelogName, [ 
				$model->getColumnName () => mt_rand ( 1, 200 ) 
		] );

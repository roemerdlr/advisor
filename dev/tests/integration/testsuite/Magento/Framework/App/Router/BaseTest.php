...
class BaseTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Framework\App\Router\Base', $options );
	}
	...
	public function testGetControllerClassName() {
		$this->assertEquals ( 'Magento\Framework\Controller\Index', $this->_model->getActionClassName ( 'Magento_Framework', 'index' ) );
	}
}

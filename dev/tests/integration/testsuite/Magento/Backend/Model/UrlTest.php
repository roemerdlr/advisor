...
class UrlTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		parent::setUp ();
		$this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Backend\Model\UrlInterface' );
	}
	...
	public function testGetSecretKey($routeName, $controller, $action, $expectedHash) {
		...
		$request->setControllerName ( 'default_controller' )->setActionName ( 'default_action' )->setRouteName ( 'default_router' );

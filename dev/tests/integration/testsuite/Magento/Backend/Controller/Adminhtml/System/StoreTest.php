...
class StoreTest extends \Magento\TestFramework\TestCase\AbstractBackendController {
	...
	public function testSaveActionWithExistCode() {
		...
		$this->assertSessionMessages ( $this->contains ( "Website with the same code already exists." ), \Magento\Framework\Message\MessageInterface::TYPE_ERROR, 'Magento\Framework\Message\ManagerInterface' );
	}
}

...
class ColumnSetTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$context = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Framework\View\Element\Template\Context', [ 
				'layout' => $this->_layoutMock 
		] );
		$this->_block = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\Backend\Block\Widget\Grid\ColumnSet', '', [ 
				'context' => $context 
		] );

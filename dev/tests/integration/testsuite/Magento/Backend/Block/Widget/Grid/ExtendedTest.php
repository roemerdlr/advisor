...
class ExtendedTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$context = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Backend\Block\Template\Context', [ 
				'layout' => $this->_layoutMock 
		] );
		$this->_block = $this->_layoutMock->createBlock ( 'Magento\Backend\Block\Widget\Grid\Extended', 'grid', [ 
				'context' => $context 
		] );
	...
	public function testAddColumnAddsChildToColumnSet() {
		$this->assertInstanceOf ( 'Magento\Backend\Block\Widget\Grid\Column', $this->_block->getColumnSet ()->getChildBlock ( 'column1' ) );

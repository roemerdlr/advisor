...
class GridTest extends \PHPUnit_Framework_TestCase {
	...
	protected function _getColumnSetMock() {
		...
		return $this->getMock ( 'Magento\Backend\Block\Widget\Grid\ColumnSet', [ ], [ 
				$objectManager->create ( 'Magento\Framework\View\Element\Template\Context', [ 
	...
	public function testToHtmlPreparesColumns() {
		...
		$this->_block->setColumnRenderers ( [ 
				'filter' => 'Filter_Class' 
		] );
		$this->_block->setColumnFilters ( [ 
				'filter' => 'Filter_Class' 
		] );

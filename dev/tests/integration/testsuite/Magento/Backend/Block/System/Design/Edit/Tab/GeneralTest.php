...
class GeneralTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPrepareForm() {
		...
		$objectManager->get ( 'Magento\Framework\Registry' )->register ( 'design', $objectManager->create ( 'Magento\Framework\App\DesignInterface' ) );
		...
		$prepareFormMethod = new \ReflectionMethod ( 'Magento\Backend\Block\System\Design\Edit\Tab\General', '_prepareForm' );

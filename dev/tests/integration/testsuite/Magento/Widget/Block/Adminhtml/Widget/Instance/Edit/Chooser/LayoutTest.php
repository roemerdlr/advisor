...
class LayoutTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$config = $this->getMockBuilder ( 'Magento\Framework\View\Layout\PageType\Config' )->setMethods ( [ 
				'getPageTypes' 
		...
		$this->_block = new \Magento\Widget\Block\Adminhtml\Widget\Instance\Edit\Chooser\Layout ( $objectManager->get ( 'Magento\Framework\View\Element\Template\Context' ), $config, [ 
				'name' => 'page_type',

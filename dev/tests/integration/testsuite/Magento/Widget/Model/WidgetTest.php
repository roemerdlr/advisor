...
class WidgetTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Widget\Model\Widget' );
	}
	 ...
	 * @return string @dataProvider getPlaceholderImageUrlDataProvider

...
$theme->setThemePath ( 'test/test' )->setArea ( 'frontend' )->setThemeTitle ( 'Test Theme' )->setType ( \Magento\Framework\View\Design\ThemeInterface::TYPE_VIRTUAL )->save ();
...
$updateNotTemporary->setHandle ( 'test_handle' )->setXml ( 'not_temporary' )->setStoreId ( 0 )->setThemeId ( $theme->getId () )->save ();
...
$updateTemporary->setHandle ( 'test_handle' )->setIsTemporary ( 1 )->setXml ( 'temporary' )->setStoreId ( 0 )->setThemeId ( $theme->getId () )->save ();

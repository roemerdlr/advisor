...
class ReaderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->validationStateMock = $this->getMockBuilder ( 'Magento\Framework\Config\ValidationStateInterface' )->setMethods ( [ 
				'isValidationRequired' 
		] )->getMockForAbstractClass ();
		$this->schemaLocatorMock = $this->getMockBuilder ( 'Magento\Config\Model\Config\SchemaLocator' )->disableOriginalConstructor ()->setMethods ( [ 
				'getPerFileSchema' 
		] )->getMock ();
		...
		$this->reader = $this->objectManager->create ( 'Magento\Paypal\Model\Config\Structure\Reader\ReaderStub', [ 
	...
	public function testXmlConvertedConfigurationAndCompereStructure() {
		$actual = $this->reader->readFiles ( [ 
				'actual' => $this->getActualContent () 
		] );

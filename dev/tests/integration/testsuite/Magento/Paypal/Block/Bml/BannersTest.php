...
class BannersTest extends \PHPUnit_Framework_TestCase {
	 ...
	 */
	public function testToHtml($publisherId, $display, $position, $configPosition, $isEmptyHtml, $methodWppBml, $methodWppPeBml) {
		...
		$paypalConfig->expects ( $this->any () )->method ( 'isMethodAvailable' )->willReturnMap ( [ 
				[ 
						$methodWppBml,
						true 
				],
		...
		$block = $layout->createBlock ( 'Magento\Paypal\Block\Bml\Banners', '', [ 

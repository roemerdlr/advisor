...
class ExceptionsTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 *
	 * @var array $value @expectedException \Magento\Framework\Exception\LocalizedException

...
class RegistrationTest extends \PHPUnit_Framework_TestCase {
	...
	public static function setUpBeforeClass() {
		ComponentRegistrar::register ( ComponentRegistrar::THEME, 'frontend/Test/test_theme', dirname ( __DIR__ ) . '/_files/design/frontend/Test/test_theme' );
	}
	...
	protected function _getTestTheme() {
		$theme = $this->_theme->getCollection ()->getThemeByFullPath ( implode ( \Magento\Framework\View\Design\ThemeInterface::PATH_SEPARATOR, [ 
				'frontend',
				'Test/test_theme' 
		] ) );
	...
	public function testVirtualByVirtualRelation() {
		...
		$subVirtualTheme->setParentId ( $virtualTheme->getId () )->setType ( \Magento\Framework\View\Design\ThemeInterface::TYPE_VIRTUAL )->save ();
	...
	public function testRegister() {
		$this->registerThemes ();
		$themePath = implode ( \Magento\Framework\View\Design\ThemeInterface::PATH_SEPARATOR, [ 
				'frontend',
				'Test/test_theme' 
		] );

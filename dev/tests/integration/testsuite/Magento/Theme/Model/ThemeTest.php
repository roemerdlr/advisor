...
class ThemeTest extends \PHPUnit_Framework_TestCase {
	...
	public function testChildRelation() {
		...
		$theme = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\View\Design\ThemeInterface' );
	...
	public function testGetInheritedThemes() {
		...
		$themeFactory = $objectManager->get ( 'Magento\Framework\View\Design\Theme\FlyweightFactory' );

...
class StoreTest extends \PHPUnit_Framework_TestCase {
	...
	protected function _getStoreModel() {
		...
		return $this->getMock ( 'Magento\Store\Model\Store', [ 
				'getUrl' 
		], $this->modelParams );
	}
	...
	public function testGetBaseUrl($type, $useRewrites, $useStoreCode, $expected) {
		...
		\Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\App\Config\MutableScopeConfigInterface' )->setValue ( Store::XML_PATH_USE_REWRITES, $useRewrites, ScopeInterface::SCOPE_STORE );
	...
	public function getBaseUrlDataProvider() {
		return [ 
				...
				[ 
						...
						false,
						true,
						'http://localhost/index.php/default/' 
				],
				[ 
						UrlInterface::URL_TYPE_LINK,
						true,
	...
	public function testCRUD() {
		...
		$crud = new \Magento\TestFramework\Entity ( $this->model, [ 
				'name' => 'new name' 
	...
	public function testIsUseStoreInUrl($storeInUrl, $disableStoreInUrl, $expectedResult) {
		...
		$params ['context'] = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Framework\Model\Context', [ 
				'appState' => $appStateMock 
		] );
		
		$configMock->expects ( $this->any () )->method ( 'getValue' )->with ( $this->stringContains ( Store::XML_PATH_STORE_IN_URL ) )->will ( $this->returnValue ( $storeInUrl ) );

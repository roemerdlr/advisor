...
class DeleteTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->deleteButtonBlock = $objectManager->create ( 'Magento\Integration\Block\Adminhtml\Widget\Grid\Column\Renderer\Button\Delete' );
	...
	public function testRender() {
		...
		$this->assertContains ( 'onclick="this.setAttribute(\'data-url\', ' . '\'http://localhost/index.php/backend/admin/integration/delete/id/' . $integration->getId (), $buttonHtml );

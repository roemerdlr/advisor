...
class WebapiTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetSelectedResourcesJson() {
		...
		$this->registry->register ( IntegrationController::REGISTRY_KEY_CURRENT_INTEGRATION, $this->getFixtureIntegration ()->getData () );
	...
	protected function createApiTabBlock() {
		$objectManager = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ();
		return $objectManager->create ( 'Magento\Integration\Block\Adminhtml\Integration\Activate\Permissions\Tab\Webapi' );
	}

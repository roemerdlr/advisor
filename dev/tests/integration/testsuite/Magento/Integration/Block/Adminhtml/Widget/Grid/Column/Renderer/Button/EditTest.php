...
class EditTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->editButtonBlock = $objectManager->create ( 'Magento\Integration\Block\Adminhtml\Widget\Grid\Column\Renderer\Button\Edit' );
	...
	public function testRenderEdit() {
		...
		$this->assertContains ( 'onclick="window.location.href=\'http://localhost/index.php/backend/admin/integration/edit/id/' . $integration->getId (), $buttonHtml );
	}

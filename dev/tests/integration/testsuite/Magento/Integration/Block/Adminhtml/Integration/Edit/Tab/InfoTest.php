...
class InfoTest extends \PHPUnit_Framework_TestCase {
	...
	public function testToHtmlNoExistingIntegrationData() {
		$this->assertRegExp ( '/<input id="integration_properties_name" name="name".*type="text".*>/', $this->block->toHtml () );
		$this->assertRegExp ( '/<input id="integration_properties_email" name="email".*type="text".*>/', $this->block->toHtml () );
		$this->assertRegExp ( '/<input id="integration_properties_endpoint" name="endpoint".*type="text".*>/', $this->block->toHtml () );
		$this->assertRegExp ( '/<input id="integration_properties_identity_link_url" name="identity_link_url".*type="text".*>/', $this->block->toHtml () );
	}

...
class OverviewTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_block = $this->_objectManager->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\Multishipping\Block\Checkout\Overview', 'checkout_overview', [ 
				'data' => [ 
		...
		$this->_block->getChildBlock ( 'renderer.list' )->addChild ( 'default', '\Magento\Checkout\Block\Cart\Item\Renderer', [ 

...
class MultishippingTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_multishippingCheckout = Bootstrap::getObjectManager ()->create ( 'Magento\Multishipping\Model\Checkout\Type\Multishipping' );
		$this->addressRepository = Bootstrap::getObjectManager ()->create ( 'Magento\Customer\Api\AddressRepositoryInterface' );
		parent::setUp ();
	}
	...
	public function testGetCustomerDefaultAddress($addressType) {
		...
		$this->assertEquals ( $secondFixtureAddressStreet, $address->getStreet (), "Street in default {$addressType} address is invalid." );

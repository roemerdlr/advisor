...
class AbstractTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$params = [ 
				$objectManager->create ( 'Magento\CatalogImportExport\Model\Import\Product' ),
				'simple' 
		];
		$this->_model = $this->getMockForAbstractClass ( 'Magento\CatalogImportExport\Model\Import\Product\Type\AbstractType', [ 

...
class RateRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSaveThrowsExceptionIfTaxRateWithCorrespondingCodeAlreadyExists() {
		...
		$this->dataObjectHelper->populateWithArray ( $taxRate1, $invalidTaxData, '\Magento\Tax\Api\Data\TaxRateInterface' );
		
		$taxRate2 = $this->taxRateFactory->create ();
		$this->dataObjectHelper->populateWithArray ( $taxRate2, $invalidTaxData, '\Magento\Tax\Api\Data\TaxRateInterface' );
	 ...
	 * @throws \Magento\Framework\Exception\InputException @dataProvider createDataProvider
	...
	public function testGet() {
		...
		$rate = $this->objectManager->create ( 'Magento\Tax\Model\Calculation\Rate' )->setData ( $data )->save ();
	...
	public function testSaveUpdatesTaxRate() {
		$taxRate = $this->taxRateFactory->create ();
		$taxRate->setTaxCountryId ( 'US' )->setTaxRegionId ( 42 )->setRate ( 8.25 )->setCode ( 'UpdateTaxRates' )->setTaxPostcode ( '78780' );
		$taxRate = $this->rateRepository->save ( $taxRate );
		
		$updatedTaxRate = $this->taxRateFactory->create ();
		$updatedTaxRate->setId ( $taxRate->getId () )->setCode ( 'UpdateTaxRates' )->setTaxCountryId ( 'US' )->setTaxRegionId ( 42 )->setRate ( 8.25 )->setZipIsRange ( true )->setZipFrom ( 78700 )->setZipTo ( 78780 );
	...
	public function testSaveThrowsExceptionIfTargetTaxRateExistsButProvidedDataIsInvalid() {
		...
		$updatedTaxRate = $this->taxRateFactory->create ();
		$updatedTaxRate->setId ( $taxRate->getId () )->setTaxCountryId ( 'US' )->setTaxRegionId ( 42 )->setRate ( 8.25 )->setCode ( 'UpdateTaxRates' )->setTaxPostcode ( null );
	...
	public function testDeleteById() {
		...
		$taxRateData->setCode ( 'TX' )->setTaxCountryId ( 'US' )->setRate ( 5 )->setTaxPostcode ( 77000 )->setTaxRegionId ( 1 );
	 ...
	 * @param $expectedRateCodes @magentoDbIsolation
	 *        	enabled

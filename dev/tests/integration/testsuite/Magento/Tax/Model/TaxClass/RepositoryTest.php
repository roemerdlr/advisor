...
class RepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSave() {
		...
		$taxClassDataObject->setClassName ( self::SAMPLE_TAX_CLASS_NAME )->setClassType ( TaxClassManagementInterface::TYPE_CUSTOMER );
	...
	public function testSaveThrowsExceptionIfGivenTaxClassNameIsNotUnique() {
		...
		$taxClassDataObject = $this->taxClassFactory->create ();
		$taxClassDataObject->setClassName ( $this->predefinedTaxClasses [TaxClassModel::TAX_CLASS_TYPE_PRODUCT] )->setClassType ( TaxClassManagementInterface::TYPE_PRODUCT );
	...
	public function testSaveThrowsExceptionIfGivenDataIsInvalid() {
		$taxClassDataObject = $this->taxClassFactory->create ();
		$taxClassDataObject->setClassName ( null )->setClassType ( '' );
		try {
			$this->taxClassRepository->save ( $taxClassDataObject );
	...
	public function testDeleteById() {
		...
		$this->setExpectedException ( 'Magento\Framework\Exception\NoSuchEntityException', "No such entity with class_id = $taxClassId" );
	...
	public function testSaveWithExistingTaxClass() {
		...
		$taxClassDataObject = $this->taxClassFactory->create ();
		$taxClassDataObject->setClassName ( $updatedTaxClassName )->setClassId ( $taxClassId )->setClassType ( TaxClassModel::TAX_CLASS_TYPE_CUSTOMER );

...
class TaxRuleCollectionTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCreateTaxRuleCollectionItem() {
		...
		$firstTaxRuleFixture = Bootstrap::getObjectManager ()->get ( 'Magento\Framework\Registry' )->registry ( '_fixture/Magento_Tax_Model_Calculation_Rule' );
		...
		$taxRulesCollection = Bootstrap::getObjectManager ()->create ( 'Magento\Tax\Model\TaxRuleCollection' );

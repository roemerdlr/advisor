...
class RateTest extends \Magento\TestFramework\TestCase\AbstractBackendController {
	...
	public function testAjaxSaveAction($postData, $expectedData) {
		...
		$rate = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Tax\Model\Calculation\Rate' )->load ( $rateId, 'tax_calculation_rate_id' );

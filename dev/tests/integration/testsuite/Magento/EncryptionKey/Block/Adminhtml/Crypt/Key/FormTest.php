...
class FormTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPrepareForm() {
		...
		$block = $objectManager->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\EncryptionKey\Block\Adminhtml\Crypt\Key\Form' );
		
		$prepareFormMethod = new \ReflectionMethod ( 'Magento\EncryptionKey\Block\Adminhtml\Crypt\Key\Form', '_prepareForm' );
		...
		$this->assertEquals ( [ 
				0 => 'No',
				1 => 'Yes' 
		], $generateRandomField->getOptions () );

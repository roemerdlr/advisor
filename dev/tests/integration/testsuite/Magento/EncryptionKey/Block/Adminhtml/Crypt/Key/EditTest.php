...
class EditTest extends \PHPUnit_Framework_TestCase {
	...
	public function testEditBlock() {
		 ...
		 */
		$block = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\EncryptionKey\Block\Adminhtml\Crypt\Key\Edit' );

...
class OrderItemRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->giftMessageOrderItemRepository = $this->objectManager->create ( 'Magento\GiftMessage\Model\OrderItemRepository' );
	}
	...
	public function testSave() {
		...
		/** @var \Magento\GiftMessage\Api\Data\MessageInterface $message */
		$result = $this->giftMessageOrderItemRepository->save ( $order->getEntityId (), $orderItem->getItemId (), $this->message );

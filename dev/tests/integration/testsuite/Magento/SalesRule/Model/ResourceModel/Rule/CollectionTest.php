...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSetValidationFilter($couponCode, $expectedItems) {
		$collection = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\SalesRule\Model\ResourceModel\Rule\Collection' );
	...
	public function setValidationFilterDataProvider() {
		return [ 
				...
				'Check result with auto generated coupon' => [ 
						'autogenerated_3_1',
						[ 
								'#3',
								'#5' 
	...
	protected function setSpecificTimezone($timezone) {
		...
		\Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Config\Model\Config\Factory' )->create ()->addData ( $localeData )->save ();
	}

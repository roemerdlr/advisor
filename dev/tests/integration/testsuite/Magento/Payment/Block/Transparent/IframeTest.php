...
class IframeTest extends \PHPUnit_Framework_TestCase {
	...
	public function testToHtml($xssString) {
		/** @var $block Iframe */
		$block = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\Payment\Block\Transparent\Iframe' );
	...
	public function xssDataProvider() {
		return [ 
				...
				[ 
						'javascript%3Aalert%28String.fromCharCode%280x78%29%2BString.fromCharCode%280x73%29%2BString.' . 'fromCharCode%280x73%29%29' 
				],
				[ 

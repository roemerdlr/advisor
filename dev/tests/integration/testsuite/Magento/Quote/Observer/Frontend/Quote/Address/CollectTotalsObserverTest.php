...
class CollectTotalsObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $this->objectManager->create ( 'Magento\Quote\Observer\Frontend\Quote\Address\CollectTotalsObserver' );
	}
	...
	public function testChangeQuoteCustomerGroupIdForCustomerWithDisabledAutomaticGroupChange() {
		...
		$eventObserver = $objectManager->create ( 'Magento\Framework\Event\Observer', [ 
				'data' => [ 
						'quote' => $quote,

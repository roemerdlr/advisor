...
class DataTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetResetPasswordLinkExpirationPeriod() {
		...
		$configModel = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Backend\App\ConfigInterface' );
		$this->assertEquals ( 1, ( int ) $configModel->getValue ( \Magento\User\Helper\Data::XML_PATH_ADMIN_RESET_PASSWORD_LINK_EXPIRATION_PERIOD ) );
	}
}

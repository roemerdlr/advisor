...
class InvalidateTokenTest extends \Magento\TestFramework\TestCase\AbstractBackendController {
	...
	public function testInvalidateSingleToken() {
		...
		$tokenService->createAdminAccessToken ( $adminUserNameFromFixture, \Magento\TestFramework\Bootstrap::ADMIN_PASSWORD );
	...
	public function testInvalidateMultipleTokens() {
		...
		$tokenModelCollectionFactory = Bootstrap::getObjectManager ()->get ( 'Magento\Integration\Model\ResourceModel\Oauth\Token\CollectionFactory' );

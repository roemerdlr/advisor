...
class ProductTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetCollectionNone() {
		$model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Sitemap\Model\ResourceModel\Catalog\Product' );
		$products = $model->getCollection ( \Magento\Store\Model\Store::DISTRO_STORE_ID );
		
		$this->_checkProductCollection ( $products, 3, [ 
				1,
				4,
				5 
		] );
	...
	public function testGetCollectionAll() {
		...
		$this->assertEquals ( 'catalog/product/m/a/magento_image_sitemap.png', $products [4]->getImages ()->getThumbnail (), 'Incorrect thumbnail' );
		...
		$this->assertEquals ( 'catalog/product/m/a/magento_image_sitemap.png', $imagesCollection [0]->getUrl (), 'Incorrect image url' );
		$this->assertEquals ( 'catalog/product/s/e/second_image.png', $imagesCollection [1]->getUrl (), 'Incorrect image url' );
		...
		$this->assertEquals ( 'catalog/product/s/e/second_image_1.png', $imagesCollection [0]->getUrl (), 'Image url is incorrect' );
		$this->assertEquals ( 'catalog/product/s/e/second_image_1.png', $products [5]->getImages ()->getThumbnail (), 'Product thumbnail is incorrect' );
	}

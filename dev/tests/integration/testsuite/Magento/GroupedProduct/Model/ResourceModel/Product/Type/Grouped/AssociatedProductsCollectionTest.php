...
class AssociatedProductsCollectionTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetColumnValues() {
		...
		$collection = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\GroupedProduct\Model\ResourceModel\Product\Type\Grouped\AssociatedProductsCollection' );

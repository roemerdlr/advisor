...
class CartTest extends \PHPUnit_Framework_TestCase {
	public function testGetMethods() {
		...
		$child = $layout->createBlock ( 'Magento\Framework\View\Element\Text' )->setChild ( 'child1', $layout->createBlock ( 'Magento\Framework\View\Element\Text', 'method1' ) )->setChild ( 'child2', $layout->createBlock ( 'Magento\Framework\View\Element\Text', 'method2' ) );

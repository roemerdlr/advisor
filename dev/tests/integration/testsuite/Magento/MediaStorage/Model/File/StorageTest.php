...
class StorageTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetScriptConfig() {
		$config = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\MediaStorage\Model\File\Storage' )->getScriptConfig ();
		...
		$this->assertEquals ( $filesystem->getDirectoryRead ( DirectoryList::MEDIA )->getAbsolutePath (), $config ['media_directory'] );

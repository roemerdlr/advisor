...
class DefaultRendererTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->_addressConfig = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Customer\Model\Address\Config' );
	}
	...
	public function renderDataProvider() {
		...
		$address = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Customer\Model\Address' )->setData ( $data );

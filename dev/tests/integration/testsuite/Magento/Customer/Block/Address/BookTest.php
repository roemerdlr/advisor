...
class BookTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->currentCustomer = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->get ( 'Magento\Customer\Helper\Session\CurrentCustomer' );
		/** @var \Magento\Framework\View\LayoutInterface $layout */
		$layout = Bootstrap::getObjectManager ()->get ( 'Magento\Framework\View\LayoutInterface' );
		$layout->setBlock ( 'head', $blockMock );
		$this->_block = $layout->createBlock ( 'Magento\Customer\Block\Address\Book', '', [ 
	...
	public function testGetAddressEditUrl() {
		$this->assertEquals ( 'http://localhost/index.php/customer/address/edit/id/1/', $this->_block->getAddressEditUrl ( 1 ) );
	}
	...
	public function testGetAdditionalAddresses() {
		...
		$this->assertInstanceOf ( '\Magento\Customer\Api\Data\AddressInterface', $this->_block->getAdditionalAddresses () [0] );

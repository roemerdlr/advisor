...
class FormTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		parent::setUp ();
		$this->layout = Bootstrap::getObjectManager ()->create ( 'Magento\Framework\View\Layout' );
		$this->groupRepository = Bootstrap::getObjectManager ()->get ( 'Magento\Customer\Api\GroupRepositoryInterface' );
		$this->groupManagement = Bootstrap::getObjectManager ()->get ( 'Magento\Customer\Api\GroupManagementInterface' );
	...
	public function testGetFormExistInCustomGroup() {
		...
		$searchCriteria = Bootstrap::getObjectManager ()->create ( 'Magento\Framework\Api\SearchCriteriaBuilder' )->addFilters ( [ 
				$builder->setField ( 'code' )->setValue ( 'custom_group' )->create () 
		] );

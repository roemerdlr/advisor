...
class PersonalInfoTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->_block = $this->_objectManager->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\Customer\Block\Adminhtml\Edit\Tab\View\PersonalInfo', '', [ 
	...
	public function testGetCreateDate() {
		$createdAt = $this->_block->formatDate ( $this->_loadCustomer ()->getCreatedAt (), \IntlDateFormatter::MEDIUM, true );
	...
	private function _createCustomer() {
		...
		$data = [ 
				'account' => $this->_dataObjectProcessor->buildOutputDataArray ( $customer, 'Magento\Customer\Api\Data\CustomerInterface' ) 
		];

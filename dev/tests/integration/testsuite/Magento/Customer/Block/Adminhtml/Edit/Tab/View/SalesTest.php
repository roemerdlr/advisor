...
class SalesTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->block = $objectManager->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\Customer\Block\Adminhtml\Edit\Tab\View\Sales', 'sales_' . mt_rand (), [ 
	...
	public function testFormatCurrency() {
		$this->assertEquals ( '<span class="price">$10.00</span>', $this->block->formatCurrency ( 10.00, self::MAIN_WEBSITE ) );
	}
	...
	/**
	 * Verify sales totals.
	 * No sales so there are no totals.
	 */

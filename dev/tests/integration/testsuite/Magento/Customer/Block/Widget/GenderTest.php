...
class GenderTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * Test initialization and set up.
	 * Create the Gender block.
	 * 
	 * @return void
	 */
	protected function setUp() {
		...
		$this->_block = $objectManager->get ( 'Magento\Framework\View\LayoutInterface' )->createBlock ( 'Magento\Customer\Block\Widget\Gender' );
	}

...
class CustomerMetadataTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$objectManager->configure ( [ 
				'Magento\Framework\Api\ExtensionAttribute\Config\Reader' => [ 
						'arguments' => [ 
								'fileResolver' => [ 
										'instance' => 'Magento\Customer\Model\FileResolverStub' 
								] 
						] 
				] 
		] );
		...
		$this->_extensibleDataObjectConverter = $objectManager->get ( 'Magento\Framework\Api\ExtensibleDataObjectConverter' );
	}
	...
	public function testGetCustomerAttributeMetadataNoSuchEntity() {
		try {
			...
			$this->assertEquals ( 'No such entity with entityType = customer, attributeCode = wrong_attribute_code', $e->getMessage () );
		}
	}

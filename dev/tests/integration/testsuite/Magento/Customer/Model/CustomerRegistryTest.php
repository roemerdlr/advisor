...
class CustomerRegistryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_model = Bootstrap::getObjectManager ()->create ( 'Magento\Customer\Model\CustomerRegistry' );
	}
	...
	public function testRetrieveCached() {
		...
		$this->assertEquals ( $customerBeforeDeletion, $this->_model->retrieveByEmail ( self::CUSTOMER_EMAIL, self::WEBSITE_ID ) );
	}

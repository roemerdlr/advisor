...
class GroupRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function getGroupsDataProvider() {
		return [ 
				[ 
						[ 
								GroupInterface::ID => 0,
								GroupInterface::CODE => 'NOT LOGGED IN',
	...
	public function searchGroupsDataProvider() {
		$builder = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Framework\Api\FilterBuilder' );
		return [ 
				'eq' => [ 
						[ 
				...
				'like' => [ 
						[ 
								$builder->setField ( GroupInterface::CODE )->setValue ( 'er' )->setConditionType ( 'like' )->create () 
						],
						[ ],
						[ 
								1 => [ 
				...
				'like_tax_name' => [ 
						[ 
								$builder->setField ( GroupInterface::TAX_CLASS_NAME )->setValue ( 'Retail Customer' )->setConditionType ( 'like' )->create () 
						],
						[ ],
						[ 
								0 => [ 

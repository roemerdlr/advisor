...
class AccountTest extends \Magento\TestFramework\TestCase\AbstractController {
	 ...
	 *        	Customer to mark as logged in for the session
	 * @return void
	 */
	...
	public function testCreatepasswordActionWithDirectLink() {
		...
		$customer = Bootstrap::getObjectManager ()->create ( 'Magento\Customer\Model\Customer' )->load ( 1 );
		
		$token = Bootstrap::getObjectManager ()->get ( 'Magento\Framework\Math\Random' )->getUniqueHash ();
	...
	public function testNoConfirmCreatePostAction() {
		...
		$this->getRequest ()->setMethod ( 'POST' )->setParam ( 'firstname', 'firstname1' )->setParam ( 'lastname', 'lastname1' )->setParam ( 'company', '' )->setParam ( 'email', 'test1@email.com' )->setParam ( 'password', 'password' )->setParam ( 'password_confirmation', 'password' )->setParam ( 'telephone', '5123334444' )->setParam ( 'street', [ 
				'1234 fake street',
				'' 
		] )->setParam ( 'city', 'Austin' )->setParam ( 'region_id', 57 )->setParam ( 'region', '' )->setParam ( 'postcode', '78701' )->setParam ( 'country_id', 'US' )->setParam ( 'default_billing', '1' )->setParam ( 'default_shipping', '1' )->setParam ( 'is_subscribed', '0' )->setPostValue ( 'create_address', true );
	...
	public function testWithConfirmCreatePostAction() {
		...
		$this->getRequest ()->setMethod ( 'POST' )->setParam ( 'firstname', 'firstname2' )->setParam ( 'lastname', 'lastname2' )->setParam ( 'company', '' )->setParam ( 'email', $email )->setParam ( 'password', 'password' )->setParam ( 'password_confirmation', 'password' )->setParam ( 'telephone', '5123334444' )->setParam ( 'street', [ 
				'1234 fake street',
				'' 
		] )->setParam ( 'city', 'Austin' )->setParam ( 'region_id', 57 )->setParam ( 'region', '' )->setParam ( 'postcode', '78701' )->setParam ( 'country_id', 'US' )->setParam ( 'default_billing', '1' )->setParam ( 'default_shipping', '1' )->setParam ( 'is_subscribed', '1' )->setPostValue ( 'create_address', true );
		
		$this->dispatch ( 'customer/account/createPost' );
		$this->assertRedirect ( $this->stringContains ( 'customer/account/index/' ) );
		$this->assertSessionMessages ( $this->equalTo ( [ 
				'You must confirm your account. Please check your email for the confirmation link or ' . '<a href="http://localhost/index.php/customer/account/confirmation/email/' . $email . '/">click here</a> for a new link.' 
		] ), MessageInterface::TYPE_SUCCESS );
	}
	...
	public function testExistingEmailCreatePostAction() {
		// Setting data for request
		$this->getRequest ()->setMethod ( 'POST' )->setParam ( 'firstname', 'firstname' )->setParam ( 'lastname', 'lastname' )->setParam ( 'company', '' )->setParam ( 'email', 'customer@example.com' )->setParam ( 'password', 'password' )->setParam ( 'password_confirmation', 'password' )->setParam ( 'telephone', '5123334444' )->setParam ( 'street', [ 
				'1234 fake street',
				'' 
		] )->setParam ( 'city', 'Austin' )->setParam ( 'region_id', 57 )->setParam ( 'region', '' )->setParam ( 'postcode', '78701' )->setParam ( 'country_id', 'US' )->setParam ( 'default_billing', '1' )->setParam ( 'default_shipping', '1' )->setParam ( 'is_subscribed', '1' )->setPostValue ( 'create_address', true );
		...
		$this->assertSessionMessages ( $this->equalTo ( [ 
				'There is already an account with this email address. ' . 'If you are sure that it is your email address, ' . '<a href="http://localhost/index.php/customer/account/forgotpassword/">click here</a>' . ' to get your password and access your account.' 
	...
	public function testResetPasswordPostNoTokenAction() {
		$this->getRequest ()->setParam ( 'id', 1 )->setParam ( 'token', '8ed8677e6c79e68b94e61658bd756ea5' )->setPostValue ( [ 
	...
	public function testResetPasswordPostAction() {
		$this->getRequest ()->setQueryValue ( 'id', 1 )->setQueryValue ( 'token', '8ed8677e6c79e68b94e61658bd756ea5' )->setPostValue ( [ 
				'password' => 'new-password',
				'password_confirmation' => 'new-password' 
		] );
	...
	public function testEditAction() {
		...
		$this->assertContains ( '<input type="checkbox" name="change_password" id="change-password" value="1" ' . 'title="Change Password" class="checkbox"/>', $body );
	}
	...
	public function testChangePasswordEditAction() {
		...
		$this->assertContains ( '<input type="checkbox" name="change_password" id="change-password" value="1" ' . 'title="Change Password" checked="checked" class="checkbox"/>', $body );
	}
	...
	public function testEditPostAction() {
		...
		$customerRepository = Bootstrap::getObjectManager ()->get ( 'Magento\Customer\Api\CustomerRepositoryInterface' );

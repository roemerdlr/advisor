...
$model->setName ( FIXTURE_ATTRIBUTE_USER_DEFINED_CUSTOMER_NAME )->setEntityTypeId ( 1 )->setIsUserDefined ( 1 )->setAttributeSetId ( 1 )->setAttributeGroupId ( 1 )->setFrontendInput ( 'text' )->setFrontendLabel ( FIXTURE_ATTRIBUTE_USER_DEFINED_CUSTOMER_FRONTEND_LABEL )->setSortOrder ( 1221 );

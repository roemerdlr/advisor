...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_model = \Magento\TestFramework\Helper\Bootstrap::getObjectManager ()->create ( 'Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection' );
	}
	...
	public function testAddAttributeGrouping() {
		...
		], $select->getPart ( \Magento\Framework\DB\Select::GROUP ) );
	}
}

...
class CartItemRepositoryTest extends WebapiAbstract {
	...
	public function testAddItem() {
		...
		$this->assertCount ( 1, $response ['product_option'] ['extension_attributes'] ['downloadable_option'] ['downloadable_links'] );
		$this->assertContains ( $linkId, $response ['product_option'] ['extension_attributes'] ['downloadable_option'] ['downloadable_links'] );
	}

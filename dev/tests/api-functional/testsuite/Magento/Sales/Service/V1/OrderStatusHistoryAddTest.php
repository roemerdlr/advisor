...
class OrderStatusHistoryAddTest extends WebapiAbstract {
	...
	public function testOrderCommentAdd() {
		...
		foreach ( $commentData as $key => $value ) {
			...
			$this->assertEquals ( $commentData [OrderStatusHistoryInterface::IS_CUSTOMER_NOTIFIED], $statusHistoryComment->getIsCustomerNotified () );
			$this->assertEquals ( $commentData [OrderStatusHistoryInterface::IS_VISIBLE_ON_FRONT], $statusHistoryComment->getIsVisibleOnFront () );
		}
	}
}

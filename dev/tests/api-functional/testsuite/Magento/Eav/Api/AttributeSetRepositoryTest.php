...
class AttributeSetRepositoryTest extends WebapiAbstract {
	...
	public function testDeleteByIdDefaultAttributeSet() {
		...
		$defaultAttributeSetId = $eavConfig->getEntityType ( \Magento\Catalog\Api\Data\ProductAttributeInterface::ENTITY_TYPE_CODE )->getDefaultAttributeSetId ();
	...
	protected function getAttributeSetByName($attributeSetName) {
		...
		$attributeSet = $objectManager->create ( 'Magento\Eav\Model\Entity\Attribute\Set' )->load ( $attributeSetName, 'attribute_set_name' );

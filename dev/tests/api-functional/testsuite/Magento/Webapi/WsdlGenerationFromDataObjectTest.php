...
class WsdlGenerationFromDataObjectTest extends \Magento\TestFramework\TestCase\WebapiAbstract {
	...
	protected function _getWsdlContent($wsdlUrl) {
		...
		$this->assertTrue ( $responseDom->loadXML ( $responseContent ), "Valid XML is always expected as a response for WSDL request." );
...
TYPES_SECTION_DECLARATION;
		...
		$this->assertContains ( $this->_convertXmlToString ( $typesSectionDeclaration ), $wsdlContent, 'Types section declaration is invalid' );
...
REQUEST_ELEMENT;
		...
		$this->assertContains ( $this->_convertXmlToString ( $requestElement ), $wsdlContent, 'Request element declaration in types section is invalid' );
...
RESPONSE_ELEMENT;
		...
		$this->assertContains ( $this->_convertXmlToString ( $responseElement ), $wsdlContent, 'Response element declaration in types section is invalid' );
	}
...
REQUEST_TYPE;
		...
		// @codingStandardsIgnoreEnd
		$this->assertContains ( $this->_convertXmlToString ( $requestType ), $wsdlContent, 'Request type declaration in types section is invalid' );
...
RESPONSE_TYPE;
		...
		// @codingStandardsIgnoreEnd
		$this->assertContains ( $this->_convertXmlToString ( $responseType ), $wsdlContent, 'Response type declaration in types section is invalid' );
...
RESPONSE_TYPE;
		...
		// @codingStandardsIgnoreEnd
		$this->assertContains ( $this->_convertXmlToString ( $referencedType ), $wsdlContent, 'Declaration of complex type generated from Data Object, which is referenced in response, is invalid' );
	}
...
FIRST_PORT_TYPE;
		...
		$this->assertContains ( $this->_convertXmlToString ( $firstPortType ), $wsdlContent, 'Port type declaration is missing or invalid' );
		
		if (! $this->isSingleService) {
			$secondPortType = <<< SECOND_PORT_TYPE
<portType name="testModule5AllSoapAndRestV2PortType">
SECOND_PORT_TYPE;
			$this->assertContains ( $this->_convertXmlToString ( $secondPortType ), $wsdlContent, 'Port type declaration is missing or invalid' );
		}
...
OPERATION_DECLARATION;
		...
		$this->assertContains ( $this->_convertXmlToString ( $operationDeclaration ), $wsdlContent, 'Operation in port type is invalid' );
	}
...
FIRST_BINDING;
		...
		$this->assertContains ( $this->_convertXmlToString ( $firstBinding ), $wsdlContent, 'Binding declaration is missing or invalid' );
...
<binding name="testModule5AllSoapAndRestV2Binding" type="tns:testModule5AllSoapAndRestV2PortType">
    <soap12:binding style="document" transport="http://schemas.xmlsoap.org/soap/http"/>
SECOND_BINDING;
			$this->assertContains ( $this->_convertXmlToString ( $secondBinding ), $wsdlContent, 'Binding declaration is missing or invalid' );
		}
...
OPERATION_DECLARATION;
		...
		$this->assertContains ( $this->_convertXmlToString ( $operationDeclaration ), $wsdlContent, 'Operation in binding is invalid' );
	}
...
FIRST_SERVICE_DECLARATION;
		...
		// @codingStandardsIgnoreEnd
		$this->assertContains ( $this->_convertXmlToString ( $firstServiceDeclaration ), $wsdlContent, 'First service section is invalid' );
...
SECOND_SERVICE_DECLARATION;
			// @codingStandardsIgnoreEnd
			$this->assertContains ( $this->_convertXmlToString ( $secondServiceDeclaration ), $wsdlContent, 'Second service section is invalid' );
		}
	}
...
MESSAGES_DECLARATION;
		$this->assertContains ( $this->_convertXmlToString ( $itemMessagesDeclaration ), $wsdlContent, 'Messages section for "item" operation is invalid' );
...
MESSAGES_DECLARATION;
		$this->assertContains ( $this->_convertXmlToString ( $itemsMessagesDeclaration ), $wsdlContent, 'Messages section for "items" operation is invalid' );
	}
...
<fault name="GenericFault" message="tns:GenericFault"/>
FAULT_IN_PORT_TYPE;
		$this->assertContains ( $this->_convertXmlToString ( $faultsInPortType ), $wsdlContent, 'SOAP Fault section in port type section is invalid' );
	}
...
<fault name="GenericFault"/>
FAULT_IN_BINDING;
		$this->assertContains ( $this->_convertXmlToString ( $faultsInBinding ), $wsdlContent, 'SOAP Fault section in binding section is invalid' );
	}
...
GENERIC_FAULT_IN_MESSAGES;
		$this->assertContains ( $this->_convertXmlToString ( $genericFaultMessage ), $wsdlContent, 'Generic SOAP Fault declaration in messages section is invalid' );
	}
	...
	protected function _checkFaultsComplexTypeSection($wsdlContent) {
		$this->assertContains ( $this->_convertXmlToString ( '<xsd:element name="GenericFault" type="tns:GenericFault"/>' ), $wsdlContent, 'Default SOAP Fault complex type element declaration is invalid' );
...
GENERIC_FAULT_COMPLEX_TYPE;
		$this->assertContains ( $this->_convertXmlToString ( $genericFaultType ), $wsdlContent, 'Default SOAP Fault complex types declaration is invalid' );
...
PARAM_COMPLEX_TYPE;
		$this->assertContains ( $this->_convertXmlToString ( $detailsParameterType ), $wsdlContent, 'Details parameter complex types declaration is invalid.' );
...
WRAPPED_ERROR_COMPLEX_TYPE;
		...
		$this->assertContains ( $this->_convertXmlToString ( $detailsWrappedErrorType ), $wsdlContent, 'Details wrapped error complex types declaration is invalid.' );
...
PARAMETERS_COMPLEX_TYPE;
		// @codingStandardsIgnoreEnd
		$this->assertContains ( $this->_convertXmlToString ( $detailsParametersType ), $wsdlContent, 'Details parameters (array of parameters) complex types declaration is invalid.' );
...
WRAPPED_ERRORS_COMPLEX_TYPE;
		...
		// @codingStandardsIgnoreEnd
		$this->assertContains ( $this->_convertXmlToString ( $detailsWrappedErrorsType ), $wsdlContent, 'Details wrapped errors (array of wrapped errors) complex types declaration is invalid.' );
	}
}

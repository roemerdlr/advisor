...
class CoreRoutingTest extends \Magento\Webapi\Routing\BaseService {
	...
	public function testRestNoAcceptHeader() {
		...
		$curlClient = Bootstrap::getObjectManager ()->get ( 'Magento\TestFramework\TestCase\Webapi\Adapter\Rest\CurlClient' );
		$response = $curlClient->get ( '/V1/testmodule1/resource1/1', [ ], [ 
				'Accept:' 
		] );

...
class TaxClassRepositoryTest extends WebapiAbstract {
	...
	public function setUp() {
		...
		$this->taxClassFactory = Bootstrap::getObjectManager ()->create ( 'Magento\Tax\Api\Data\TaxClassInterfaceFactory' );
		$this->taxClassRegistry = Bootstrap::getObjectManager ()->create ( 'Magento\Tax\Model\ClassModelRegistry' );
		$this->taxClassRepository = Bootstrap::getObjectManager ()->create ( 'Magento\Tax\Model\TaxClass\Repository', [ 
	...
	public function testGetTaxClass() {
		...
		$this->assertEquals ( $taxClassData [ClassModel::KEY_TYPE], TaxClassManagementInterface::TYPE_CUSTOMER );
	}
	...
	public function testSearchTaxClass() {
		...
		$filter = $this->filterBuilder->setField ( $taxClassNameField )->setValue ( $taxClassName )->create ();
	...
	public function testSearchTaxClassMultipleFilterGroups() {
		...
		$customerTaxClass = [ 
				ClassModel::KEY_NAME => 'Retail Customer',

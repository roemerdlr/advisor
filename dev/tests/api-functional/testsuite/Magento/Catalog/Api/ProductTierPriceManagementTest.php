...
class ProductTierPriceManagementTest extends WebapiAbstract {
	...
	public function testGetList($customerGroupId, $count, $value, $qty) {
		...
		$tearPriceList = $this->_webApiCall ( $serviceInfo, [ 
				'sku' => $productSku,
	...
	public function testDelete($customerGroupId, $qty) {
		...
		$serviceInfo = [ 
				'rest' => [ 
						'resourcePath' => self::RESOURCE_PATH . $productSku . "/group-prices/" . $customerGroupId . "/tiers/" . $qty,
	...
	public function deleteDataProvider() {
		return [ 
				'delete_tier_price_for_specific_customer_group' => [ 
						0,
						3 
				],
				'delete_tier_price_for_all_customer_group' => [ 
						'all',
						5 
				] 
		];
	...
	public function testAdd() {
		...
		$serviceInfo = [ 
				'rest' => [ 
						'resourcePath' => '/V1/products/' . $productSku . '/group-prices/' . $customerGroupId . '/tiers/' . $qty . '/price/' . $price,

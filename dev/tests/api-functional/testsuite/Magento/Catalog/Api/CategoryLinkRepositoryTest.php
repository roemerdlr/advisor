...
class CategoryLinkRepositoryTest extends WebapiAbstract {
	...
	public function testSave($productLink, $productId, $productPosition = 0) {
		...
		$serviceInfo = [ 
				'rest' => [ 
						'resourcePath' => self::RESOURCE_PATH_SUFFIX . '/' . $this->categoryId . '/' . self::RESOURCE_PATH_PREFIX,
	...
	public function testDelete() {
		...
		$serviceInfo = [ 
				'rest' => [ 
						'resourcePath' => self::RESOURCE_PATH_SUFFIX . '/' . $this->categoryId . '/' . self::RESOURCE_PATH_PREFIX . '/simple',

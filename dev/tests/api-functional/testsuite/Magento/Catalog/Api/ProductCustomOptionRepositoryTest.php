...
class ProductCustomOptionRepositoryTest extends WebapiAbstract {
	...
	public function testGet() {
		...
		$service = Bootstrap::getObjectManager ()->get ( 'Magento\Catalog\Api\ProductCustomOptionRepositoryInterface' );
		...
		$option = $this->_webApiCall ( $serviceInfo, [ 
				'sku' => $productSku,
				'optionId' => $optionId 
		] );
	...
	public function testGetList() {
		...
		$options = $this->_webApiCall ( $serviceInfo, [ 
				'sku' => $productSku 
		] );
	...
	public function testUpdate() {
		...
		if (TESTS_WEB_API_ADAPTER == self::ADAPTER_SOAP) {
			...
			$updatedOption = $this->_webApiCall ( $serviceInfo, [ 
					'id' => $optionId,
					'option' => $optionDataPost 
			] );
		} else {
	...
	public function testUpdateOptionAddingNewValue($optionType) {
		...
		if (TESTS_WEB_API_ADAPTER == self::ADAPTER_SOAP) {
			...
			$valueObject = $this->_webApiCall ( $serviceInfo, [ 

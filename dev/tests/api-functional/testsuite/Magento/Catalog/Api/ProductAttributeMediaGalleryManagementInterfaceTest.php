...
class ProductAttributeMediaGalleryManagementInterfaceTest extends \Magento\TestFramework\TestCase\WebapiAbstract {
	...
	public function testCreate() {
		...
		$actualResult = $this->_webApiCall ( $this->createServiceInfo, [ 
				'sku' => 'simple',
				'entry' => $requestData 
		] );
	...
	public function testUpdate() {
		...
		$this->updateServiceInfo ['rest'] ['resourcePath'] = $this->updateServiceInfo ['rest'] ['resourcePath'] . '/' . $this->getTargetGalleryEntryId ();
	...
	public function testUpdateThrowsExceptionIfTargetProductDoesNotExist() {
		$this->updateServiceInfo ['rest'] ['resourcePath'] = '/V1/products/wrong_product_sku/media' . '/' . $this->getTargetGalleryEntryId ();
		$requestData = [ 

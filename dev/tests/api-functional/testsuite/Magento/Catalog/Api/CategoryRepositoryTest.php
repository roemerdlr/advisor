...
class CategoryRepositoryTest extends WebapiAbstract {
	...
	public function testCreate() {
		...
		foreach ( [ 
			...
			$this->assertEquals ( $categoryData [$fieldName], $result [$fieldName], sprintf ( '"%s" field value is invalid', $fieldName ) );
		}
...
;
	...
	protected function getSimpleCategoryData($categoryData = []) {
		return [ 
				'path' => '2',
				'parent_id' => '2',
				'name' => isset ( $categoryData ['name'] ) ? $categoryData ['name'] : uniqid ( 'Category-', true ),
				'is_active' => '1',
				'include_in_menu' => "1",
				'available_sort_by' => [ 
						'position',

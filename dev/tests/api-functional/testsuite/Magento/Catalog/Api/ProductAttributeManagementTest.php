...
class ProductAttributeManagementTest extends \Magento\TestFramework\TestCase\WebapiAbstract {
	...
	public function testUnassignAttribute() {
		...
		$attributeManagement->assign ( \Magento\Catalog\Api\Data\ProductAttributeInterface::ENTITY_TYPE_CODE, $payload ['attributeSetId'], $payload ['attributeGroupId'], $payload ['attributeCode'], $payload ['sortOrder'] );
		
		$serviceInfo = [ 
				'rest' => [ 
						'resourcePath' => self::RESOURCE_PATH . '/' . $payload ['attributeSetId'] . '/attributes/' . $payload ['attributeCode'],

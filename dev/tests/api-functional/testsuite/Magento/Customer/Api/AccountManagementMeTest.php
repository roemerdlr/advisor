...
class AccountManagementMeTest extends \Magento\TestFramework\TestCase\WebapiAbstract {
	...
	public function testUpdateCustomer() {
		...
		$updatedCustomerData = $this->dataObjectProcessor->buildOutputDataArray ( $customerData, 'Magento\Customer\Api\Data\CustomerInterface' );
	...
	public function testGetCustomerData() {
		...
		$customerData = $this->_getCustomerData ( $this->customerData [CustomerInterface::ID] );
		$expectedCustomerDetails = $this->dataObjectProcessor->buildOutputDataArray ( $customerData, 'Magento\Customer\Api\Data\CustomerInterface' );
		$expectedCustomerDetails ['addresses'] [0] ['id'] = ( int ) $expectedCustomerDetails ['addresses'] [0] ['id'];
		
		$expectedCustomerDetails ['addresses'] [1] ['id'] = ( int ) $expectedCustomerDetails ['addresses'] [1] ['id'];
	...
	public function testGetCustomerActivateCustomer() {
		...
		$requestData = [ 
				'confirmationKey' => $this->customerData [CustomerInterface::CONFIRMATION] 
		];

...
class GroupManagementTest extends WebapiAbstract {
	 ...
	 * @param int $storeId
	 *        	The store Id
	 * @param array $defaultGroupData
	 *        	The default group data for the store with the specified Id.
	 *        	
	 ...
	 * @param int $groupId
	 *        	The group Id
	 * @param bool $isDeleteable
	 *        	Whether the group can or cannot be deleted.
	 *        	

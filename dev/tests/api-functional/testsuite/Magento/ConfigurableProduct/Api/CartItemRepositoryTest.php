...
class CartItemRepositoryTest extends WebapiAbstract {
	...
	public function testAddProductWithIncorrectOptions() {
		...
		$requestData ['cartItem'] ['product_option'] ['extension_attributes'] ['configurable_item_options'] [0] ['option_id'] = 1000;
		
		$requestData ['cartItem'] ['product_option'] ['extension_attributes'] ['configurable_item_options'] [0] ['option_value'] = 2000;
	...
	public function testUpdate() {
		...
		$this->assertEquals ( $response ['product_option'] ['extension_attributes'] ['configurable_item_options'] [0], $requestData ['cartItem'] ['product_option'] ['extension_attributes'] ['configurable_item_options'] [0] );
	}

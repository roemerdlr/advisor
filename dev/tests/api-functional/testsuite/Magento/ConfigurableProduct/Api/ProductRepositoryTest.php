...
class ProductRepositoryTest extends WebapiAbstract {
	...
	public function testCreateConfigurableProduct() {
		...
		$this->assertTrue ( isset ( $resultConfigurableProductOptions [0] ['values'] ) );
	...
	public function testUpdateConfigurableProductOption() {
		...
		$response [ExtensibleDataInterface::EXTENSION_ATTRIBUTES_KEY] ['configurable_product_options'] [0] = $updatedOption;

...
class CartItemRepositoryTest extends WebapiAbstract {
	...
	public function testGetAll() {
		...
		$quote = $this->objectManager->create ( 'Magento\Quote\Model\Quote' )->load ( 'test_order_bundle', 'reserved_order_id' );
		$quoteId = $quote->getId ();
		...
		foreach ( $actualOptions as $option ) {
			$id = $option ['option_id'];
			$expectedSelections = is_array ( $bundleOption [$id] ) ? $bundleOption [$id] : [ 
					$bundleOption [$id] 
			];
	...
	public function testAddItem() {
		...
		$quote = $this->objectManager->create ( 'Magento\Quote\Model\Quote' )->load ( 'test_order_item_with_items', 'reserved_order_id' );
	...
	public function testUpdate() {
		...
		foreach ( $optionCollection as $option ) {
			...
			$option ['option_selections'] = [ 
					$selectionsCollection->getLastItem ()->getSelectionId () 
			];
		...
		$quoteUpdated = $this->objectManager->create ( 'Magento\Quote\Model\Quote' )->load ( 'test_order_bundle', 'reserved_order_id' );

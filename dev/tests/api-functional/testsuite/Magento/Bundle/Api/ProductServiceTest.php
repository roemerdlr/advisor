...
class ProductServiceTest extends WebapiAbstract {
	...
	public function testCreateBundle() {
		...
		$this->assertTrue ( isset ( $response [ExtensibleDataInterface::EXTENSION_ATTRIBUTES_KEY] ["bundle_product_options"] ) );
		$resultBundleProductOptions = $response [ExtensibleDataInterface::EXTENSION_ATTRIBUTES_KEY] ["bundle_product_options"];
	...
	public function testUpdateBundleAddSelection() {
		...
		$this->assertGreaterThan ( $bundleOptions [0] ['product_links'] [0] ['id'], $bundleOptions [0] ['product_links'] [1] ['id'] );
	}

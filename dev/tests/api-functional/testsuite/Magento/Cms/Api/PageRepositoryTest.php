...
class PageRepositoryTest extends WebapiAbstract {
	...
	public function testGet() {
		...
		$page = $this->_webApiCall ( $serviceInfo, [ 
				PageInterface::PAGE_ID => $this->currentPage->getId () 
		] );
	...
	public function testUpdate() {
		...
		$pageDataObject->setTitle ( $pageTitle )->setIdentifier ( $pageIdentifier );
		$this->currentPage = $this->pageRepository->save ( $pageDataObject );
		$this->dataObjectHelper->populateWithArray ( $this->currentPage, [ 
				PageInterface::TITLE => $newPageTitle 
		], 'Magento\Cms\Api\Data\PageInterface' );
		$pageData = $this->dataObjectProcessor->buildOutputDataArray ( $this->currentPage, 'Magento\Cms\Api\Data\PageInterface' );

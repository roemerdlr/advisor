...
class AllSoapAndRest implements \Magento\TestModule5\Service\V1\AllSoapAndRestInterface {
	...
	public function item($entityId) {
		return $this->factory->create ()->setEntityId ( $entityId )->setName ( 'testItemName' )->setIsEnabled ( true )->setHasOrders ( true );
	}
	 ...
	 *
	 */
	public function nestedUpdate($parentId, $entityId, \Magento\TestModule5\Service\V1\Entity\AllSoapAndRest $entityItem) {
		return $entityItem;
	}
}

...
class AllSoapAndRest implements \Magento\TestModule1\Service\V1\AllSoapAndRestInterface {
	 ...
	 */
	public function __construct(ItemFactory $itemFactory, CustomAttributeDataObjectFactory $customAttributeNestedDataObjectFactory) {
	...
	public function update(Item $entityItem) {
		return $this->itemFactory->create ()->setItemId ( $entityItem->getItemId () )->setName ( 'Updated' . $entityItem->getName () );
	}

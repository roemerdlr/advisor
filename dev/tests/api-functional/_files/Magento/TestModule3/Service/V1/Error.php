...
class Error implements \Magento\TestModule3\Service\V1\ErrorInterface {
	...
	public function resourceNotFoundException() {
		throw new NoSuchEntityException ( __ ( 'Resource with ID "%1" not found.', 'resourceY' ) );
	}
	...
	public function webapiException() {
		throw new \Magento\Framework\Webapi\Exception ( __ ( 'Service not found' ), 5555, \Magento\Framework\Webapi\Exception::HTTP_NOT_FOUND );
	}

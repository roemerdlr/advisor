...
class OauthHelper {
	 ...
	 * No resources are available to this consumer.
	 *
	...
	public static function getAccessToken() {
		...
		$accessToken = $oAuthClient->requestAccessToken ( $requestToken->getRequestToken (), $consumerCredentials ['verifier'], $requestToken->getRequestTokenSecret () );
		
		/**
		 * TODO: Reconsider return format.
		 * It is not aligned with method name.
		 */
		return [ 
	 ...
	 *        	list of resources to grant to the integration

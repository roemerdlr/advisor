...
class Soap implements \Magento\TestFramework\TestCase\Webapi\AdapterInterface {
	 ...
	 *        	PHP service interface name, should include version if present
	...
	public function generateWsdlUrl($services, $storeCode = null) {
		...
		ksort ( $services );
		if ($storeCode == null) {
			$storeCode = Bootstrap::getObjectManager ()->get ( 'Magento\Store\Model\StoreManagerInterface' )->getStore ()->getCode ();
		}

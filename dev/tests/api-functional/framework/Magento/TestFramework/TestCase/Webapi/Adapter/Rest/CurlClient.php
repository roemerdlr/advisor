...
class CurlClient {
	 ...
	 *        	Resource URL like /V1/Resource1/123
	 * @param array $data        	
	 * @param array $headers        	
	 * @return mixed
	 */
	 ...
	 * @param array $data        	
	 * @param boolean $put
	 *        	Set true to post data as HTTP PUT operation (update). If this value is set to false,
	 ...
	 *
	 * @param array $customCurlOpts
	 *        	Additional / overridden cURL options
	 * @param array $headers        	
	 * @return array
	 */
	...
	protected function _checkJsonError() {
		...
		if ($jsonError !== JSON_ERROR_NONE) {
			...
			throw new \Exception ( 'JSON Encoding / Decoding error: ' . $message . var_export ( func_get_arg ( 0 ), true ), $jsonError );
		}
	}
}

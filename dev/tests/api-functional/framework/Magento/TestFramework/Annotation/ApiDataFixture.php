...
class ApiDataFixture {
	...
	public function __construct($fixtureBaseDir) {
		if (! is_dir ( $fixtureBaseDir )) {
			throw new \Magento\Framework\Exception\LocalizedException ( __ ( "Fixture base directory '%1' does not exist.", $fixtureBaseDir ) );
		}
	...
	protected function _applyOneFixture($fixture) {
		try {
			...
			echo 'Exception occurred when running the ' . (is_array ( $fixture ) || is_scalar ( $fixture ) ? json_encode ( $fixture ) : 'callback') . ' fixture: ', PHP_EOL, $e;
		}

...
class Customer extends WebapiAbstract {
	...
	public function createSampleCustomer() {
		...
		$customerDataArray = $this->dataObjectProcessor->buildOutputDataArray ( $this->createSampleCustomerDataObject (), '\Magento\Customer\Api\Data\CustomerInterface' );
		$requestData = [ 

...
/**
 * Set of tests for static code analysis, e.g.
 * code style, code complexity, copy paste detecting, etc.
 */
class LiveCodeTest extends PHPUnit_Framework_TestCase {
	...
	public function testCodeMess() {
		...
		$this->assertEquals ( Command::EXIT_SUCCESS, $codeMessDetector->run ( self::getWhitelist ( [ 
				'php' 
	...
	public function testCopyPaste() {
		...
		$this->assertTrue ( $copyPasteDetector->run ( [ 
				BP 
	...
	public function testDeadCode() {
		...
		$declared = [ ];
		$called = [ ];
		$collectedFiles = Files::init ()->getPhpFiles ( Files::INCLUDE_APP_CODE | Files::INCLUDE_PUB_CODE | Files::INCLUDE_LIBS | Files::INCLUDE_TEMPLATES | Files::INCLUDE_TESTS | Files::AS_DATA_SET | Files::INCLUDE_NON_CLASSES );

...
class FilesystemTest extends \PHPUnit_Framework_TestCase {
	public function testRelocations() {
		 ...
		 */
		function ($path) {
			$this->assertFileNotExists ( \Magento\Framework\App\Utility\Files::init ()->getPathToSource () . '/' . $path );
	...
	public function relocationsDataProvider() {
		return [ 
				'Relocated to pub/errors' => [ 
						'errors' 
				],
				'Eliminated with Magento_Compiler' => [ 
						'includes' 
				],
				'Relocated to lib/web' => [ 
						'js' 
				],
				'Relocated to pub/media' => [ 
						'media' 
				],
				'Eliminated as not needed' => [ 
						'pkginfo' 
				],
				'Dissolved into themes under app/design ' => [ 
						'skin' 
				],
				'Dissolved into different modules\' view/frontend' => [ 
				...
				'Eliminated Magento/plushe theme' => [ 
						'app/design/frontend/Magento/plushe' 
				] 
		];
	}
	...
	public function testObsoleteViewPaths() {
		...
		$allowedThemeFiles = array_merge ( $allowedFiles, [ 
				'composer.json',
				'theme.xml',
				'LICENSE.txt',
				'LICENSE_AFL.txt' 

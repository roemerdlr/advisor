...
class TableTest extends \PHPUnit_Framework_TestCase {
	 ...
	 *        	Method name, or array with method name and index of table parameter in signature
	 * @return string
	 */
	...
	protected function _composeFoundsMessage($legacyTables) {
		...
		$result = 'Legacy table names with slash must be fixed to direct table names. Found: ' . implode ( ', ', $descriptions ) . '.';
		return $result;
	}
}

...
return [ 
		...
		[ 
				'CACHE_TAG',
				'Magento\Api\Model\Config',
				'Magento_Api_Model_Cache_Type::CACHE_TAG' 
		],
		[ 
				'CACHE_TAG',
				'Magento\Framework\AppInterface' 
		...
		[ 
				...
				'Magento_Core_Model_Cache_Type_Translate::CACHE_TAG' 
		],
		[ 
				'CACHE_TAG',
				'Magento\Rss\Block\Catalog\NotifyStock' 
		],
		[ 
				'CACHE_TAG',
		...
		[ 
				...
				'Magento_Core_Model_App::PARAM_APP_DIRS' 
		],
		[ 
				'INIT_OPTION_REQUEST',
				'Magento\Core\Model\App' 
		...
		[ 
				'INIT_OPTION_RESPONSE',
				'Magento\Core\Model\App' 
		],
		[ 
				'INIT_OPTION_SCOPE_CODE',
				'Magento\Core\Model\App',
				'Magento_Core_Model_App::PARAM_RUN_CODE' 
		],
		[ 
				'INIT_OPTION_SCOPE_TYPE',
				'Magento\Core\Model\App',
				'Magento_Core_Model_App::PARAM_RUN_TYPE' 
		],
		[ 
				'INIT_OPTION_URIS',
				'Magento\Core\Model\App' 
		...
		[ 
				'PATH_PREFIX_CUSTOMIZATION',
				'Magento\Core\Model\Theme' 
		],
		[ 
				'PATH_PREFIX_CUSTOMIZED',
				'Magento\Core\Model\Theme\Files' 
		],
		[ 
				'PUBLIC_BASE_THEME_DIR',
				'Magento\Core\Model\Design\PackageInterface' 
		],
		[ 
				'PUBLIC_CACHE_TAG',
		...
		[ 
				'TYPE_BINARY',
				null,
				'Magento_DB_Ddl_Table::TYPE_BLOB' 
		],
		[ 
				'TYPE_CHAR',
				null,
				'Magento_DB_Ddl_Table::TYPE_TEXT' 
		],
		[ 
				'TYPE_CLOB',
				null,
		...
		[ 
				'TYPE_DOUBLE',
				null,
				'Magento_DB_Ddl_Table::TYPE_FLOAT' 
		],
		[ 
				'TYPE_LONGVARBINARY',
				null,
		...
		[ 
				'TYPE_TIME',
				null,
				'Magento_DB_Ddl_Table::TYPE_TIMESTAMP' 
		],
		[ 
				'TYPE_TINYINT',
				null,
				'Magento_DB_Ddl_Table::TYPE_SMALLINT' 
		],
		[ 
				'TYPE_VARCHAR',
				null,
		...
		[ 
				'XML_NODE_PAGE_TEMPLATE_FILTER',
				'Magento\Cms\Helper\Data' 
		],
		[ 
				'XML_NODE_BLOCK_TEMPLATE_FILTER',
				'Magento\Cms\Helper\Data' 
		],
		[ 
		...
		[ 
				'XML_PATH_ALLOW_MAP_UPDATE',
				'Mage_Core_Model_Design_PackageInterface' 
		],
		[ 
				'XML_PATH_BACKEND_FRONTNAME',
		...
		[ 
				...
				'Mage_Core_Model_App',
				'Mage_Core_Model_Config_Primary::XML_PATH_INSTALL_DATE' 
		],
		[ 
				'XML_PATH_LOCALE_INHERITANCE',
				'Mage_Core_Model_Translate' 
		],
		[ 
				'XML_PATH_PRODUCT_ATTRIBUTES',
		...
		[ 
				'XML_PATH_SESSION_MESSAGE_MODELS',
		...
		[ 
				'XML_PAGE_TYPE_RENDER_INHERITED',
		...
		[ 
				'XML_PATH_WEBAPI_REQUEST_INTERPRETERS',
				'Magento\Webapi\Controller\Request\Rest\Interpreter\Factory' 
		],
		[ 
				'XML_PATH_WEBAPI_RESPONSE_RENDERS',
				'Magento\Webapi\Controller\Response\Rest\Renderer\Factor' 
		],
		[ 
				'XML_PATH_THEME' 
		],
		...
		[ 
				'XML_NODE_BUNDLE_PRODUCT_TYPE',
				'Magento\Bundle\Helper\Data' 
		],
		[ 
				'XML_PATH_CONFIGURABLE_ALLOWED_TYPES',
				'Magento\Catalog\Helper\Product\Configuration' 
		],
		[ 
				'XML_PATH_GROUPED_ALLOWED_PRODUCT_TYPES',
				'Magento\Catalog\Model\Config' 
		],
		[ 
				'PRODUCT_OPTIONS_GROUPS_PATH',
		...
		[ 
				'XML_PATH_UNASSIGNABLE_ATTRIBUTES',
				'Magento\Catalog\Helper\Product' 
		],
		[ 
				'XML_PATH_ATTRIBUTES_USED_IN_AUTOGENERATION',
				'Magento\Catalog\Helper\Product' 
		],
		[ 
				'XML_PATH_PRODUCT_TYPE_SWITCHER_LABEL',
				'Magento\Catalog\Helper\Product' 
		],
		[ 
				'CONFIG_KEY_ENTITIES',
		...
		[ 
				'CONFIG_KEY_PATH_TO_MAP_FILE',
				'Magento\Framework\Module\Setup\Migration' 
		],
		[ 
				'XML_PATH_SKIP_PROCESS_MODULES_UPDATES',
				'Magento\Framework\App\UpdaterInterface' 
		],
		[ 
		...
		[ 
				'XML_PATH_USE_CUSTOM_ADMIN_PATH',
				'Magento\Backend\Helper\Data' 
		],
		[ 
				'XML_PATH_CUSTOM_ADMIN_PATH',
				'Magento\Backend\Helper\Data' 
		],
		[ 
				'XML_PATH_BACKEND_AREA_FRONTNAME',
				'Magento\Backend\Helper\Data' 
		],
		[ 
		...
		[ 
				'UPLOAD_ROOT',
				'Magento\Backend\Model\Config\Backend\Logo' 
		],
		[ 
				'UPLOAD_ROOT',
				'Magento\Backend\Model\Config\Backend\Favicon' 
		],
		[ 
				'DIRECTORY_SEPARATOR',
		...
		[ 
				'LOCALE_DIR',
				'\Magento\Framework\App\Filesystem',
				'\Magento\Framework\App\Filesystem\DirectoryList::LOCALE' 
		],
		[ 
				'PUB_DIR',
				'\Magento\Framework\App\Filesystem',
		...
		[ 
				'PUBLIC_MINIFY_DIR',
				'',
				'\Magento\Framework\View\Asset\MinifyService::getRelativeDir' 
		],
		[ 
				'CONTENT_TYPE_CSS',
				'Magento\Framework\View\Publisher' 
		...
		[ 
				'HTTP',
				'Magento\Framework\Filesystem',
				'\Magento\Framework\Filesystem\DriverPool::HTTP' 
		],
		[ 
				'HTTPS',
				'Magento\Framework\Filesystem',
				'\Magento\Framework\Filesystem\DriverPool::HTTPS' 
		],
		[ 
				'SEARCH_TYPE_LIKE',
		...
		[ 
				'VAT_CLASS_ERROR',
				'Magento\Customer\Helper\Data',
				'Magento\Customer\Model\Vat::VAT_CLASS_ERROR' 
		],
		[ 
				'VAT_CLASS_INVALID',
				'Magento\Customer\Helper\Data',
				'Magento\Customer\Model\Vat::VAT_CLASS_INVALID' 
		],
		[ 
				'VAT_CLASS_INTRA_UNION',
				'Magento\Customer\Helper\Data',
				'Magento\Customer\Model\Vat::VAT_CLASS_INTRA_UNION' 
		],
		[ 
				'VAT_CLASS_DOMESTIC',
				'Magento\Customer\Helper\Data',
				'Magento\Customer\Model\Vat::VAT_CLASS_DOMESTIC' 
		],
		[ 
		...
		[ 
				...
				'Magento\Customer\Helper\Data',
				'Magento\Customer\Model\Vat::VAT_VALIDATION_WSDL_URL' 
		],
		[ 
		...
		[ 
				'CONFIG_PATH_WSDL_CACHE_ENABLED',
		...
		[ 
				'KEY_DB',
				'Magento\Setup\Model\ConfigOptionsList',
				'Magento\Framework\Config\ConfigOptionsListConstants::KEY_DB' 
		],
		[ 
				'KEY_ENCRYPTION_KEY',
				'Magento\Setup\Model\ConfigOptionsList',

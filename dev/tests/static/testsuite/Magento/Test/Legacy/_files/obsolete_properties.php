...
return [ 
		...
		[ 
				'_customerFactory ',
				'\Magento\Sales\Block\Adminhtml\Billing\Agreement\View\Tab\Info' 
		],
		[ 
				'_customerFactory ',
		...
		[ 
				'_optionsMapping',
				null,
				'\Magento\Framework\Filesystem::getDirectoryRead($nodeKey)->getAbsolutePath()' 
		],
		[ 
				'_order',
		...
		[ 
				'_shipTable',
				'Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\Collection' 
		],
		[ 
				'_showTemplateHints',
		...
		[ 
				'_defaultIndexer',
				'Magento\CatalogInventory\Model\ResourceModel\Indexer\Stock' 
		],
		[ 
				'_engine',
		...
		[ 
				'_coreRegistry',
				'Magento\Sales\Block\Adminhtml\Order\View\Messages',
				'coreRegistry' 
		],
		[ 
				'_message',
		...
		[ 
				'_dirs',
				'Magento\Framework\View\Block\Template\Context' 
		],
		[ 
				'_coreDir',
				'Magento\Sales\Model\Order\Pdf\AbstractItems',
				'_rootDirectory' 
		],
		[ 
				'_dir',
		...
		[ 
				'_dir',
				'Magento\Catalog\Model\ResourceModel\Product\Attribute\Backend\Image',
				'_filesystem' 
		],
		[ 
				'_dir',
				'Magento\CatalogEvent\ModelEvent',
				'_filesystem' 
		],
		[ 
				'_dir',
				'Magento\Cms\Helper\Wyiswig\Images' 
		],
		[ 
				'_dir',
				'Magento\Email\Model\Template' 
		...
		[ 
				'_dir',
				'Magento\Install\Model\Installer\Filesystem' 
		],
		[ 
				'_coreDir',
		...
		[ 
				'_flatResourceFactory',
				'Magento\Catalog\Model\Observer' 
		],
		[ 
				'_catalogCategoryFlat',
				'Magento\Catalog\Model\Observer' 
		],
		[ 
				'_catalogCategoryFlat',
		...
		[ 
				'_layout',
				'Magento\Install\App\Action\Plugin\Design' 
		],
		[ 
				'_layout',
		...
		[ 
				...
				'\Magento\Framework\File\Mime::$mimeTypes' 
		],
		[ 
				'_viewFileResolution',
				'Magento\Framework\View\FileSystem',
				'_fileResolution, _localeFileResolution' 
		],
		[ 
				'_productInstance',
		...
		[ 
				'_usageFactory',
				'Magento\SalesRule\Model\Validator',
				'Magento\SalesRule\Model\Validator\Utility' 
		],
		[ 
				'_couponFactory',
				'Magento\SalesRule\Model\Validator',
		...
		[ 
				'_openActions',
				'Magento\Customer\Controller\Account',
				'Magento\Customer\Controller\Account::openActions' 
		],
		[ 
				'_session',
				'Magento\Customer\Controller\Account',
				'Magento\Customer\Controller\Account::session' 
		],
		[ 
				'_cache',
		...
		[ 
				...
				'Magento\Setup\Module\DataSetup::_resourceName' 
		],
		[ 
				'_moduleConfig',
				'Magento\Framework\Module\Setup',
				'Magento\Setup\Module\DataSetup::_moduleConfig' 
		],
		[ 
		...
		[ 
				'_setupCache',
				'Magento\Framework\Module\Setup',
				'Magento\Setup\Module\DataSetup::_setupCache' 
		],
		[ 
				'_modulesReader',
				'Magento\Framework\Module\Setup',
				'Magento\Setup\Module\DataSetup::_modulesReader' 
		],
		[ 
				'_eventManager',
				'Magento\Framework\Module\Setup',
				'Magento\Setup\Module\DataSetup::_eventManager' 
		],
		[ 
				'_logger',
				'Magento\Framework\Module\Setup',
				'Magento\Setup\Module\DataSetup::_logger' 
		],
		[ 
				'_resource',
				'Magento\Framework\Module\Setup',
				'Magento\Setup\Module\DataSetup::_resource' 
		],
		[ 
				'_migrationFactory',
				'Magento\Framework\Module\Setup',
				'Magento\Setup\Module\DataSetup::_migrationFactory' 
		],
		[ 
				'filesystem',
				'Magento\Framework\Module\Setup',
				'Magento\Setup\Module\DataSetup::filesystem' 
		],
		[ 
				'modulesDir',
				'Magento\Framework\Module\Setup',
				'Magento\Setup\Module\DataSetup::modulesDir' 
		],
		[ 
				'_directoryData',
		...
		[ 
				'_aliases',
				'Magento\Framework\App\Request\Http',
				'Magento\Framework\HTTP\PhpEnvironment\Request::aliases' 
		],
		[ 
				'_route',
				'Magento\Framework\App\Request\Http',
		...
		[ 
				'_locale',
				'Magento\Framework\Data\Form\Filter\Date',
				'localeResolver' 
		],
		[ 
				'_locale',

...
return [ 
		...
		[ 
				...
				'Magento\Framework\Acl\Role\Registry' 
		],
		[ 
		...
		[ 
				...
				'Magento\User\Model\ResourceModel\Acl' 
		],
		[ 
		...
		[ 
				...
				'Magento\Authorization\Model\Roles' 
		],
		[ 
		...
		[ 
				...
				'Magento\User\Model\ResourceModel\Roles' 
		],
		[ 
		...
		[ 
				...
				'Magento\User\Model\ResourceModel\Roles\Collection' 
		],
		[ 
				'Mage_Admin_Model_Resource_Roles_User_Collection',
				'Magento\User\Model\ResourceModel\Roles\User\Collection' 
		],
		[ 
		...
		[ 
				...
				'Magento\Reports\Block\Adminhtml\Customer\Totals' 
		],
		[ 
		...
		[ 
				...
				'Magento\Reports\Block\Adminhtml\Product\Sold' 
		],
		[ 
		...
		[ 
				...
				'Magento\Reports\Block\Adminhtml\Customer\Orders' 
		],
		[ 
		...
		[ 
				...
				'Magento\Reports\Block\Adminhtml\Refresh\Statistics' 
		],
		[ 
		...
		[ 
				'Magento\GoogleCheckout' 
		], // removed module
		[ 
				'Magento\Sales\Block\Adminhtml\Order\Shipment\Create\Form',
		...
		[ 
				'Magento\Sales\Block\Adminhtml\Order\Shipment\View\Form',
				'Magento\Shipping\Block\Adminhtml\View\Form' 
		],
		[ 
				'Magento\Sales\Block\Adminhtml\Order\Shipment\View\Items',
				'Magento\Shipping\Block\Adminhtml\View\Items' 
		],
		[ 
				'Magento\Sales\Block\Adminhtml\Order\Shipment\Create',
				'Magento\Shipping\Block\Adminhtml\Create' 
		],
		[ 
				'Magento\Sales\Block\Adminhtml\Order\Shipment\View',
				'Magento\Shipping\Block\Adminhtml\View' 
		],
		[ 
				'Magento\Sales\Block\Order\Shipment\Items',
				'Magento\Shipping\Block\Items' 
		],
		[ 
				'Magento\Sales\Controller\Adminhtml\Order\Shipment',
		...
		[ 
				'Magento\Sales\Block\Order\Shipment',
				'Magento\Shipping\Block\Order\Shipment' 
		],
		[ 
		...
		[ 
				...
				'Magento\Config\Block\System\Config\Switcher' 
		],
		[ 
		...
		[ 
				'Magento\Adminhtml\Model\Email\Template',
				'Magento\Email\Model\Adminhtml\Template' 
		],
		[ 
		...
		[ 
				...
				'Magento\Config\Model\Config\Backend\Log\Cron' 
		],
		[ 
		...
		[ 
				...
				'Magento\Config\Model\Config\Source\Admin\Page' 
		],
		[ 
		...
		[ 
				...
				'Magento\Config\Model\Config\Source\Date\Short' 
		],
		[ 
		...
		[ 
				...
				'Magento\Config\Model\Config\Source\Checktype' 
		],
		[ 
		...
		[ 
				...
				'Magento\Config\Controller\Adminhtml\System\Config' 
		],
		[ 
		...
		[ 
				'Mage_Backend_Model_Menu_Factory',
				'Mage_Backend_Model_MenuFactory' 
		],
		[ 
				'Magento\Backend\Model\Auth\Exception',
				'Magento\Framework\Exception\AuthenticationException' 
		],
		[ 
				'Magento\Backend\Model\Auth\Plugin\Exception',
				'Magento\Framework\Exception\Plugin\AuthenticationException' 
		],
		[ 
				'Mage_Bundle_Product_EditController',
				'Mage_Bundle_Controller_Adminhtml_Bundle_Selection' 
		],
		[ 
		...
		[ 
				'Magento\Catalog\Block\Layer\Filter\Attribute',
				'Magento\LayeredNavigation\Block\Navigation\FilterRenderer' 
		],
		[ 
				'Magento\Catalog\Block\Layer\Filter\Category',
				'Magento\LayeredNavigation\Block\Navigation\FilterRenderer' 
		],
		[ 
				'Magento\Catalog\Block\Layer\Filter\Decimal',
				'Magento\LayeredNavigation\Block\Navigation\FilterRenderer' 
		],
		[ 
				'Magento\Catalog\Block\Layer\Filter\Price',
				'Magento\LayeredNavigation\Block\Navigation\FilterRenderer' 
		],
		[ 
				'Magento\Catalog\Block\Layer\State',
				'Magento\LayeredNavigation\Block\Navigation\State' 
		],
		[ 
				'Magento\Catalog\Block\Layer\View',
				'Magento\LayeredNavigation\Block\Navigation' 
		],
		[ 
				'Magento\CatalogSearch\Block\Layer',
				'Magento\LayeredNavigation\Block\Navigation' 
		],
		[ 
		...
		[ 
				'Magento\CatalogSearch\Model\Layer',
				'Magento\Catalog\Model\Layer' 
		],
		[ 
				'Magento\Solr\Block\Catalog\Layer\View',
				'Magento\LayeredNavigation\Block\Navigation' 
		],
		[ 
		...
		[ 
				'Magento\Solr\Block\Catalogsearch\Layer',
				'Magento\LayeredNavigation\Block\Navigation\FilterRenderer' 
		],
		[ 
				'Magento\Solr\Model\Catalog\Layer',
				'Magento\Catalog\Model\Layer\Category' 
		],
		[ 
				'Magento\Solr\Model\Catalog\Layer\Filter\Attribute',
				'Magento\Catalog\Model\Layer\Filter\Attribute' 
		],
		[ 
				'Magento\Solr\Model\Catalog\Layer\Filter\Category',
				'Magento\Catalog\Model\Layer\Filter\Category' 
		],
		[ 
				'Magento\Solr\Model\Catalog\Layer\Filter\Decimal',
				'Magento\Catalog\Model\Layer\Filter\Decimal' 
		],
		[ 
				'Magento\Solr\Model\Catalog\Layer\Filter\Price',
				'Magento\Catalog\Model\Layer\Filter\Price' 
		],
		[ 
				'Magento\Solr\Model\Search\Layer\Filter\Attribute',
				'Magento\Catalog\Model\Layer\Filter\Attribute' 
		],
		[ 
				'Magento\Solr\Model\Search\Layer',
				'Magento\Catalog\Model\Layer' 
		],
		[ 
		...
		[ 
				'Mage_Core_Controller_Magento_Router_Admin',
		...
		[ 
				'Mage_Core_Model_Config_Fieldset',
		...
		[ 
				'Magento\Framework\Filesystem\Adapter\Local',
				'Magento\Framework\Filesystem\Driver\File' 
		],
		[ 
				'Magento\Framework\Filesystem\Adapter\Zlib',
				'Magento\Framework\Filesystem\Driver\Zlib' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Email\Info',
				'Magento\Framework\Mail\MessageInterface' 
		],
		[ 
				'Magento\Core\Model\Email\Sender',
				'Magento\Framework\Mail\Template\TransportBuilder' 
		],
		[ 
				'Magento\Core\Model\Email\Template\Mailer',
				'Magento\Framework\Mail\Template\TransportBuilder' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Resource\Db\Profiler',
				'Magento\Framework\Model\ResourceModel\Db\Profiler' 
		],
		[ 
				'Magento\Framework\Model\ModelResource\Db\Profiler',
				'Magento\Framework\Model\ResourceModel\Db\Profiler' 
		],
		[ 
		...
		[ 
				...
				'Magento\Framework\Model\ResourceModel\Entity\Table' 
		],
		[ 
				'Magento\Framework\Model\ModelResource\Entity\Table',
				'Magento\Framework\Model\ResourceModel\Entity\Table' 
		],
		[ 
				'Magento\Core\Model\Resource\Flag',
		...
		[ 
				'Magento\Core\Model\Resource\Type\AbstractType',
		...
		[ 
				'Magento\Core\Model\Resource\Type\Db',
				'Magento\Framework\Model\ResourceModel\Type\Db' 
		],
		[ 
				'Magento\Framework\Model\ModelResource\Type\Db',
				'Magento\Framework\Model\ResourceModel\Type\Db' 
		],
		[ 
		...
		[ 
				'Magento\Email\Model\Info',
				'Magento\Framework\Mail\MessageInterface' 
		],
		[ 
				'Magento\Email\Model\Sender',
				'Magento\Framework\Mail\Template\TransportBuilder' 
		],
		[ 
				'Magento\Email\Model\Template\Mailer',
				'Magento\Framework\Mail\Template\TransportBuilder' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Email\Transport',
		...
		[ 
				'Magento\Core\Model\Email\Template\Filter',
				'Magento\Email\Model\Template\Filter' 
		],
		[ 
				'Magento\Core\Model\Email\Template\Config\Converter',
				'Magento\Email\Model\Template\Config\Converter' 
		],
		[ 
				'Magento\Core\Model\Template\Config\Data',
				'Magento\Email\Model\Template\Config\Data' 
		],
		[ 
				'Magento\Core\Model\Template\Config\SchemaLocator',
				'Magento\Email\Model\Template\Config\SchemaLocator' 
		],
		[ 
				'Magento\Core\Model\Resource\Email\Template',
				'Magento\Email\Model\ResourceModel\Template' 
		],
		[ 
				'Magento\Core\Model\Resource\Email\Template\Collection',
		...
		[ 
				'Magento\Core\Model\Source\Email\Variables',
				'Magento\Email\Model\Source\Variables' 
		],
		[ 
				'Magento\Core\Model\Store\ListInterface',
				'Magento\Store\Model\StoreManagerInterface' 
		],
		[ 
				'Magento\Core\Model\Store\StorageInterface',
				'Magento\Store\Model\StoreManagerInterface' 
		],
		[ 
		...
		[ 
				...
				'Magento\Backend\Controller\Catalog\Product' 
		],
		[ 
		...
		[ 
				...
				'Magento\GoogleOptimizer\Adminhtml\Googleoptimizer\IndexController' 
		],
		[ 
				'Mage_GoogleShopping_Block_Adminhtml_Types_Grid' 
		],
		[ 
				'Mage_GoogleShopping_Helper_SiteVerification',
				'Mage_GoogleShopping_Block_SiteVerification' 
		],
		[ 
		...
		[ 
				'Magento\Integration\Exception',
				'Magento\Framework\Exception\IntegrationException' 
		],
		[ 
		...
		[ 
				...
				'Magento_Backend_Model_Auth and \Magento\Backend\Model\Auth\Session' 
		],
		[ 
		...
		[ 
				'Varien_Profiler',
				'Magento_Framework_Profiler' 
		],
		[ 
				'Mage_Adminhtml_Block_Notification_Window',
				'Magento\AdminNotification\Block\Window' 
		],
		[ 
		...
		[ 
				...
				'Magento\AdminNotification\Block\Notification\Grid' 
		],
		[ 
		...
		[ 
				...
				'Decomposed into \Magento\Catalog\Block\Product\View\Gallery' . ' and \Magento\Catalog\Block\Product\View\BaseImage classes' 
		],
		[ 
				'Magento\Wishlist\Block\Links',
		...
		[ 
				'Magento\Log\Model\Resource\Helper\Mysql4',
				'Magento\Log\Model\Resource\Helper' 
		],
		[ 
				'Magento\CatalogSearch\Model\ResourceModel\Helper\Mysql4',
				'Magento\CatalogSearch\Model\ResourceModel\Helper' 
		],
		[ 
				'Magento\ImportExport\Model\ResourceModel\Helper\Mysql4',
				'Magento\ImportExport\Model\ResourceModel\Helper' 
		],
		[ 
				'Magento\Reports\Model\ResourceModel\Helper\Mysql4',
				'Magento\Reports\Model\ResourceModel\Helper' 
		],
		[ 
				'Magento\Backup\Model\ResourceModel\Helper\Mysql4',
				'Magento\Backup\Model\ResourceModel\Helper' 
		],
		[ 
				'Magento\Sales\Model\CarrierFactory',
				'Magento\Shipping\Model\CarrierFactory' 
		],
		[ 
				'Magento\Sales\Model\Order\Pdf\Shipment\Packaging',
		...
		[ 
				'Magento\Sales\Model\ResourceModel\Helper\Mysql4',
		...
		[ 
				'Magento\Core\Model\Resource\Helper\AbstractHelper',
		...
		[ 
				'Magento\Catalog\Model\ResourceModel\Helper\Mysql4',
				'Magento\Catalog\Model\ResourceModel\Helper' 
		],
		[ 
				'Magento\Cron\Exception',
				'Magento\Framework\Exception\CronException' 
		],
		[ 
				'Magento\Eav\Model\ResourceModel\Helper\Mysql4',
		...
		[ 
				'Magento\Sales\Model\ResourceModel\Helper\HelperInterface',
		...
		[ 
				'Magento\Payment\Block\Form\Banktransfer',
				'Magento\OfflinePayments\Block\Form\Banktransfer' 
		],
		[ 
				'Magento\Payment\Block\Form\Cashondelivery',
				'Magento\OfflinePayments\Block\Form\Cashondelivery' 
		],
		[ 
				'Magento\Payment\Block\Form\Ccsave',
				'Magento\OfflinePayments\Block\Form\Ccsave' 
		],
		[ 
				'Magento\Payment\Block\Form\Checkmo',
				'Magento\OfflinePayments\Block\Form\Checkmo' 
		],
		[ 
				'Magento\Payment\Block\Form\Purchaseorder',
				'Magento\OfflinePayments\Block\Form\Purchaseorder' 
		],
		[ 
				'Magento\Payment\Block\Info\Ccsave',
				'Magento\OfflinePayments\Block\Info\Ccsave' 
		],
		[ 
				'Magento\Payment\Block\Info\Checkmo',
				'Magento\OfflinePayments\Block\Info\Checkmo' 
		],
		[ 
				'Magento\Payment\Block\Info\Purchaseorder',
				'Magento\OfflinePayments\Block\Info\Purchaseorder' 
		],
		[ 
				'Magento\Payment\Model\Info\Exception',
				'Magento\Framework\Exception\PaymentException' 
		],
		[ 
				'Magento\Payment\Model\Method\Banktransfer',
				'Magento\OfflinePayments\Model\Banktransfer' 
		],
		[ 
				'Magento\Payment\Model\Method\Cashondelivery',
				'Magento\OfflinePayments\Model\Cashondelivery' 
		],
		[ 
				'Magento\Payment\Model\Method\Ccsave',
				'Magento\OfflinePayments\Model\Ccsave' 
		],
		[ 
				'Magento\Payment\Model\Method\Checkmo',
				'Magento\OfflinePayments\Model\Checkmo' 
		],
		[ 
				'Magento\Payment\Model\Method\Purchaseorder',
		...
		[ 
				'Magento\Core\Controller\Response\Http',
				'Magento\Framework\App\Response\Http' 
		],
		[ 
				'Magento\Core\Controller\Varien\Action\Forward',
				'Magento\Framework\App\Action\Forward' 
		],
		[ 
				'Magento\Core\Controller\Varien\Action\Redirect',
		...
		[ 
				'Magento\Core\Controller\FrontInterface',
				'Magento\Framework\App\FrontControllerInterface' 
		],
		[ 
				'Magento\Core\Model\App\Emulation',
		...
		[ 
				'Magento\Core\Model\Event\Config\SchemaLocator',
		...
		[ 
				'Magento\Core\Model\Request\PathInfoProcessor',
		...
		[ 
				'Magento\Core\Model\Theme\FileProvider',
		...
		[ 
				'Magento\Core\Model\Theme\Resolver',
		...
		[ 
				'Magento\Core\Model\Theme\Customization\Config',
				'Magento\Theme\Model\Theme\Customization\Config' 
		],
		[ 
				'Magento\Core\Model\Theme\Data\Collection',
				'Magento\Theme\Model\Theme\Data\Collection' 
		],
		[ 
				'Magento\Core\Model\Theme\Domain\Physical',
				'Magento\Theme\Model\Theme\Domain\Physical' 
		],
		[ 
				'Magento\Core\Model\Theme\Domain\Staging',
		...
		[ 
				'Magento\Core\Model\Theme\Source\Theme',
				'Magento\Theme\Model\Theme\Source\Theme' 
		],
		[ 
				'Magento\Core\Model\ThemeInterface',
		...
		[ 
				'Magento\Core\Model\Design\Fallback\Rule\Simple',
				'Magento\Framework\View\Design\Fallback\Rule\Simple' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Layout\File\Factory',
		...
		[ 
				'Magento\Core\Model\Layout\File\ListFile',
		...
		[ 
				'Magento\Core\Model\Layout\File\Source\Override\Base',
				'Magento\Framework\View\Layout\File\Override\Base' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Layout\File\Source\Theme',
				'Magento\Framework\View\Layout\File\Source\Theme' 
		],
		[ 
				'Magento\Core\Model\Layout\File\SourceInterface',
				'Magento\Framework\View\File\CollectorInterface' 
		],
		[ 
				'Magento\Core\Model\LayoutFactory',
				'Magento\Framework\View\LayoutFactory' 
		],
		[ 
				'Magento\Core\Model\TemplateEngine\EngineInterface',
				'Magento\Framework\View\TemplateEngineInterface' 
		],
		[ 
				'Magento\Core\Model\TemplateEngine\Factory',
				'Magento\Framework\View\TemplateEngineFactory' 
		],
		[ 
				'Magento\Core\Model\TemplateEngine\Php',
				'Magento\Framework\View\TemplateEngine\Php' 
		],
		[ 
				'Magento\Core\Model\TemplateEngine\Pool',
		...
		[ 
				'Magento\Adminhtml\Block\Promo\Catalog\Edit',
				'Magento\CatalogRule\Block\Adminhtml\Promo\Catalog\Edit' 
		],
		[ 
				'Magento\Adminhtml\Block\Promo\Catalog',
		...
		[ 
				'Magento\Adminhtml\Block\Promo\Widget\Chooser',
				'Magento\CatalogRule\Block\Adminhtml\Widget\Chooser' 
		],
		[ 
				'Magento\Adminhtml\Block\Promo\Quote\Edit\Form',
				'Magento\SalesRule\Block\Adminhtml\Promo\Quote\Edit\Form' 
		],
		[ 
		...
		[ 
				'Magento\Adminhtml\Block\Promo\Quote\Edit',
				'Magento\SalesRule\Block\Adminhtml\Promo\Quote\Edit' 
		],
		[ 
				'Magento\Adminhtml\Block\Promo\Quote',
				'Magento\SalesRule\Block\Adminhtml\Promo\Quote' 
		],
		[ 
				'Magento\Adminhtml\Controller\Promo\Catalog',
				'Magento\CatalogRule\Controller\Adminhtml\Promo\Catalog' 
		],
		[ 
				'Magento\Adminhtml\Controller\Promo\Quote',
				'Magento\SalesRule\Controller\Adminhtml\Promo\Quote' 
		],
		[ 
				'Magento\Adminhtml\Controller\Promo\Widget',
				'Magento\CatalogRule\Controller\Adminhtml\Promo\Widget' 
		],
		[ 
				'Magento\Adminhtml\Controller\Promo',
				'Magento\CatalogRule\Controller\Adminhtml\Promo' 
		],
		[ 
				'Magento\Adminhtml\Controller\System\Account',
				'Magento\Backend\Controller\Adminhtml\System\Account' 
		],
		[ 
				'Magento\Adminhtml\Controller\System\Backup',
		...
		[ 
				'Magento\Adminhtml\Controller\System\Variable',
				'Magento\Variable\Controller\Adminhtml\System\Variable' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Account\Edit\Form',
				'Magento\Backend\Block\System\Account\Edit\Form' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Account\Edit',
				'Magento\Backend\Block\System\Account\Edit' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Cache\Edit',
				'Magento\Backend\Block\System\Cache\Edit' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Cache\Form',
				'Magento\Backend\Block\System\Cache\Form' 
		],
		[ 
		...
		[ 
				'Magento\Adminhtml\Block\System\Design\Edit\Tabs',
				'Magento\Backend\Block\System\Design\Edit\Tabs' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Design\Edit',
				'Magento\Backend\Block\System\Design\Edit' 
		],
		[ 
		...
		[ 
				'Magento\Adminhtml\Block\System\Store\Delete\Form',
				'Magento\Backend\Block\System\Store\Delete\Form' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Store\Delete\Group',
				'Magento\Backend\Block\System\Store\Delete\Group' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Store\Delete\Website',
				'Magento\Backend\Block\System\Store\Delete\Website' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Store\Delete',
		...
		[ 
				'Magento\Adminhtml\Block\System\Store\Edit',
		...
		[ 
				'Magento\Adminhtml\Block\System\Store\Store',
				'Magento\Backend\Block\System\Store\Store' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Variable\Edit\Form',
				'Magento\Variable\Block\System\Variable\Edit\Form' 
		],
		[ 
				'Magento\Backend\Block\System\Variable\Edit\Form',
				'Magento\Variable\Block\System\Variable\Edit\Form' 
		],
		[ 
				'Magento\Adminhtml\Block\System\Variable\Edit',
		...
		[ 
				...
				'Magento\Variable\Block\System\Variable' 
		],
		[ 
		...
		[ 
				...
				'Magento\CheckoutAgreements\Block\Adminhtml\Agreement' 
		],
		[ 
		...
		[ 
				...
				'Magento\Framework\View\Asset\SourceFileInterface' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\View\Service',
		...
		[ 
				'Magento\Core\Model\View\Url\Config',
				'Magento\Framework\View\Url\Config' 
		],
		[ 
				'Magento\Core\Model\View\Config',
				'Magento\Framework\View\Config' 
		],
		[ 
				'Magento\Core\Model\Image\Factory',
				'Magento\Framework\Image\Factory' 
		],
		[ 
				'Magento\Core\Model\Theme\Image',
				'Magento\Framework\View\Design\Theme\Image' 
		],
		[ 
				'Magento\Core\Model\Theme\FlyweightFactory',
		...
		[ 
				'Magento\Core\Model\EntryPoint\Cron',
		...
		[ 
				'Magento\Log\Model\EntryPoint\Shell',
		...
		[ 
				'Magento\Framework\Data\Form\Factory',
				'Magento\Framework\Data\FormFactory' 
		],
		[ 
				'Magento\Framework\App\Cache\Config',
				'Magento\Framework\Cache\Config' 
		],
		[ 
				'Magento\Framework\App\Cache\Config\Converter',
				'Magento\Framework\Cache\Config\Converter' 
		],
		[ 
				'Magento\Framework\App\Cache\Config\Data',
				'Magento\Framework\Cache\Config\Data' 
		],
		[ 
				'Magento\Framework\App\Cache\Config\Reader',
				'Magento\Framework\Cache\Config\Reader' 
		],
		[ 
				'Magento\Framework\App\Cache\Config\SchemaLocator',
		...
		[ 
				'Magento\Core\Model\Fieldset\Config\SchemaLocator',
				'Magento\Framework\DataObject\Copy\Config\SchemaLocator' 
		],
		[ 
				'Magento\Core\Model\ModuleManager',
				'Magento\Framework\Module\Manager' 
		],
		[ 
				'Magento\Core\Model\EntryPoint\Media',
		...
		[ 
				'Magento\Backend\Controller\AbstractAction',
		...
		[ 
				'Magento\Core\Block\Text\TextList\Item',
				'Magento\Framework\View\Element\Text\TextList\Item' 
		],
		[ 
				'Magento\Core\Block\Text\TextList\Link',
				'Magento\Framework\View\Element\Text\TextList\Link' 
		],
		[ 
				'Magento\Core\Block\Messages',
				'Magento\Framework\View\Element\Messages' 
		],
		[ 
				'Magento\Core\Model\Message',
				'Magento\Framework\Message\Factory' 
		],
		[ 
				'Magento\Core\Model\Resource\Setup',
				'Magento\Theme\Model\ResourceModel\Setup' 
		],
		[ 
				'Magento\Core\Model\Message\AbstractMessage',
				'Magento\Framework\Message\AbstractMessage' 
		],
		[ 
				'Magento\Core\Model\Message\Collection',
				'Magento\Framework\Message\Collection' 
		],
		[ 
				'Magento\Core\Model\Message\CollectionFactory',
		...
		[ 
				'Magento\Core\Block\Html\Date',
				'Magento\Framework\View\Element\Html\Date' 
		],
		[ 
				'Magento\Core\Model\Theme\Observer',
		...
		[ 
				'Magento\Core\Block\Html\Select',
				'Magento\Framework\View\Element\Html\Select' 
		],
		[ 
				'Magento\Core\Block\AbstractBlock',
		...
		[ 
				'Magento\Core\Block\Html\Calendar',
				'Magento\Framework\View\Element\Html\Calendar' 
		],
		[ 
				'Magento\Core\Block\Html\Link',
				'Magento\Framework\View\Element\Html\Link' 
		],
		[ 
				'Magento\Core\Block\Context',
		...
		[ 
				...
				'Magento\Search\Block\Adminhtml\Reports\Search' 
		],
		[ 
		...
		[ 
				'Magento\Backend\Controller\Adminhtml\System\Variable',
				'Magento\Variable\Controller\Adminhtml\System\Variable' 
		],
		[ 
		...
		[ 
				'Magento\Page\Block\Js\Components',
				'Magento\Framework\View\Element\Js\Components' 
		],
		[ 
				'Magento\Page\Block\Js\Cookie',
				'Magento\Framework\View\Element\Js\Cookie' 
		],
		[ 
				'Magento\Page\Block\Html',
				'Magento\Theme\Block\Html' 
		],
		[ 
				'Magento\Page\Block\Html\Breadcrumbs',
				'Magento\Theme\Block\Html\Breadcrumbs' 
		],
		[ 
				'Magento\Page\Block\Html\Footer',
		...
		[ 
				'Magento\Page\Block\Html\Header',
				'Magento\Theme\Block\Html\Header' 
		],
		[ 
				'Magento\Page\Block\Html\Notices',
		...
		[ 
				'Magento\Page\Block\Html\Title',
				'Magento\Theme\Block\Html\Title' 
		],
		[ 
				'Magento\Page\Block\Html\Topmenu',
				'Magento\Theme\Block\Html\Topmenu' 
		],
		[ 
				'Magento\Page\Block\Html\Welcome',
				'Magento\Theme\Block\Html\Welcome' 
		],
		[ 
				'Magento\Page\Helper\Layout',
				'Magento\Theme\Helper\Layout' 
		],
		[ 
				'Magento\Page\Model\Source\Layout',
		...
		[ 
				'Magento\Page\Model\Config\SchemaLocator',
		...
		[ 
				'Magento\Core\Model\Page\Asset\AssetInterface',
				'Magento\Framework\View\Asset\AssetInterface' 
		],
		[ 
				'Magento\Core\Model\Page\Asset\Collection',
		...
		[ 
				'Magento\Core\Model\Page\Asset\MergeStrategy\Direct',
				'Magento\Framework\View\Asset\MergeStrategy\Direct' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Page\Asset\MergeableInterface',
		...
		[ 
				'Magento\Core\Model\Page\Asset\Minified',
		...
		[ 
				'Magento\Core\Model\Page\Asset\MinifyService',
				'Magento\Framework\View\Asset\MinifyService' 
		],
		[ 
				'Magento\Core\Model\Page\Asset\PublicFile',
				'Magento\Framework\View\Asset\PublicFile' 
		],
		[ 
				'Magento\Core\Model\Page\Asset\Remote',
				'Magento\Framework\View\Asset\Remote' 
		],
		[ 
				'Magento\Core\Model\Page\Asset\ViewFile',
				'Magento\Framework\View\Asset\File' 
		],
		[ 
				'Magento\Page\Block\Html\Head\AssetBlock',
				'Magento\Theme\Block\Html\Head\AssetBlockInterface' 
		],
		[ 
		...
		[ 
				'Magento\Page\Model\Asset\GroupedCollection',
				'Magento\Framework\View\Asset\GroupedCollection' 
		],
		[ 
				'Magento\Page\Model\Asset\PropertyGroup',
		...
		[ 
				'Magento\Core\Model\Theme\Label',
				'Magento\Framework\View\Design\Theme\Label' 
		],
		[ 
				'Magento\Core\Model\Theme\LabelFactory',
				'Magento\Framework\View\Design\Theme\LabelFactory' 
		],
		[ 
				'Magento\Core\Model\DesignLoader',
				'Magento\Framework\View\DesignLoader' 
		],
		[ 
				'Magento\Page\Block\Switcher',
				'Magento\Store\Block\Switcher' 
		],
		[ 
				'Magento\Core\Model\Layout\PageType\Config',
		...
		[ 
				'Magento\Core\Model\Layout\PageType\Config\Reader',
		...
		[ 
				'Magento\Core\Model\Theme\CopyService',
				'Magento\Theme\Model\CopyService' 
		],
		[ 
				'Magento\Core\Model\Resource\Session',
				'Magento\Framework\Session\SaveHandler\DbTable' 
		],
		[ 
				'Magento\Core\Model\Session\Exception',
				'Magento\Framework\Session\Exception' 
		],
		[ 
		...
		[ 
				'Magento\Shipping\Model\Rate\Result\Method',
		...
		[ 
				'Magento\Shipping\Model\Rate\Request',
		...
		[ 
				'Magento\Validator\Composite\VarienObject',
				'Magento\Framework\Validator\DataObject' 
		],
		[ 
				'Magento\GoogleShopping\Helper\Price',
		...
		[ 
				'Magento\Core\Model\Image\Adapter\Config',
				'Magento\Framework\Image\Adapter\Config' 
		],
		[ 
				'Magento\Core\Model\AbstractShell',
				'Magento\Framework\App\AbstractShell' 
		],
		[ 
				'Magento\Core\Model\Calculator',
				'Magento\Framework\Math\Calculator' 
		],
		[ 
				'Magento\Core\Model\Log\Adapter',
				'Magento\Framework\Logger\Adapter' 
		],
		[ 
				'Magento\Core\Model\Input\Filter',
				'Magento\Framework\Filter\Input' 
		],
		[ 
				'Magento\Core\Model\Input\Filter\MaliciousCode',
		...
		[ 
				'Magento\Core\Model\Option\ArrayPool',
				'Magento\Framework\Option\ArrayPool' 
		],
		[ 
				'Magento\Core\Helper\String',
		...
		[ 
				'Magento\Core\App\Action\Plugin\Install',
				'Magento\Framework\App\Bootstrap' 
		],
		[ 
				'Magento\Core\App\Action\Plugin\Session',
				'Magento\Cookie\Block\RequireCookie' 
		],
		[ 
				'Magento\Core\Model\LocaleInterface',
				'Magento\Framework\Locale\ResolverInterface, Magento\Framework\Locale\CurrencyInterface,' . 'Magento\Framework\Locale\FormatInterface, Magento\Framework\Stdlib\DateTime\TimezoneInterface' 
		],
		[ 
				'Magento\Core\Model\Locale',
				'Magento\Framework\Locale\Resolver, Magento\Framework\Locale\Currency, Magento\Framework\Locale\Format, ' . 'Magento\Framework\Stdlib\DateTime\Timezone, Magento\Framework\Locale\Lists' 
		],
		[ 
		...
		[ 
				'Magento\Framework\Locale\Hierarchy\Config\Reader',
				'Magento\Framework\App\Language\Dictionary' 
		],
		[ 
		...
		[ 
				'Magento\Framework\Locale\Hierarchy\Config',
				'Magento\Framework\App\Language\Dictionary' 
		],
		[ 
				'Magento\Core\Model\Locale\Config',
				'Magento\Framework\Locale\Config' 
		],
		[ 
				'Magento\Core\Model\Locale\Validator',
		...
		[ 
				'Magento\Usa\Block\Adminhtml\Dhl\Unitofmeasure',
				'Magento\Dhl\Block\Adminhtml\Unitofmeasure' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Dhl\International',
		...
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Dhl\AbstractDhl',
		...
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Fedex',
				'Magento\Fedex\Model\Carrier' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Fedex\Source\Droppff',
				'Magento\Fedex\Model\Source\Droppff' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Fedex\Source\Freemethod',
				'Magento\Fedex\Model\Source\Freemethod' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Fedex\Source\Generic',
				'Magento\Fedex\Model\Source\Generic' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Fedex\Source\Method',
				'Magento\Fedex\Model\Source\Method' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Fedex\Source\Packaging',
		...
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Ups\Source\Container',
				'Magento\Ups\Model\Config\Source\Container' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Ups\Source\DestType',
				'Magento\Ups\Model\Config\Source\DestType' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Ups\Source\Freemethod',
				'Magento\Ups\Model\Config\Source\Freemethod' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Ups\Source\Generic',
				'Magento\Ups\Model\Config\Source\Generic' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Ups\Source\Method',
		...
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Ups\Source\Pickup',
				'Magento\Ups\Model\Config\Source\Pickup' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Ups\Source\Type',
				'Magento\Ups\Model\Config\Source\Type' 
		],
		[ 
		...
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Usps\Source\Container',
				'Magento\Usps\Model\Source\Container' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Usps\Source\Freemethod',
		...
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Usps\Source\Machinable',
				'Magento\Usps\Model\Source\Machinable' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Usps\Source\Method',
				'Magento\Usps\Model\Source\Method' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Usps\Source\Size',
		...
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Usps',
				'Magento\Usps\Model\Carrier' 
		],
		[ 
				'Magento\Usa\Model\Shipping\Carrier\Ups',
				'Magento\Ups\Model\Carrier' 
		],
		[ 
				'Magento\Usa\Model\Simplexml\Element',
		...
		[ 
				'Magento\Catalog\Helper\Product\Url',
		...
		[ 
				'Magento\PubSub' 
		], // unused library code which was removed
		[ 
				'Magento\Outbound' 
		], // unused library code which was removed
		[ 
				'Magento\Indexer\Model\Processor\CacheInvalidate',
				'Magento\Indexer\Model\Processor\InvalidateCache' 
		],
		[ 
		...
		[ 
				'Magento\Core\Controller\Ajax',
				'Magento\Translation\Controller\Ajax' 
		],
		[ 
				'Magento\Core\Helper\Translate',
		...
		[ 
				'Magento\Core\Model\Resource\Translate',
		...
		[ 
				'Magento\Framework\App\Locale\ScopeConfigInterface',
				'Magento\Framework\App\Config\ScopeConfigInterface' 
		],
		[ 
				'Magento\Core\App\Action\Plugin\StoreCheck',
		...
		[ 
				'Magento\Core\App\Response\Redirect',
		...
		[ 
				'Magento\Core\Block\Store\Switcher',
		...
		[ 
				'Magento\Core\Helper\Cookie',
				'Magento\Cookie\Helper\Cookie' 
		],
		[ 
				'Magento\Store\Helper\Cookie',
				'Magento\Cookie\Helper\Cookie' 
		],
		[ 
		...
		[ 
				...
				'Magento\Store\Model\Config\Reader\ReaderPool' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Resource\Store\Group',
		...
		[ 
				'Magento\Core\Model\Resource\Website',
		...
		[ 
				'Magento\Core\Model\ScopeInterface',
		...
		[ 
				'Magento\Core\Model\Store\Storage\DefaultStorage',
				'Magento\Store\Model\Storage\DefaultStorage' 
		],
		[ 
				'Magento\Core\Model\Store\StorageFactory',
		...
		[ 
				'Magento\Framework\App\ReinitableConfigInterface',
				'Magento\Framework\App\Config\ReinitableConfigInterface' 
		],
		[ 
				'Magento\BaseScopeInterface',
				'Magento\Framework\App\ScopeInterface' 
		],
		[ 
				'Magento\BaseScopeResolverInterface',
		...
		[ 
				'Magento\Framework\Store\ScopeInterface',
				'Magento\Store\Model\ScopeInterface' 
		],
		[ 
				'Magento\Core\Model\Module\Output\Config',
				'Magento\Framework\Module\Output\Config' 
		],
		[ 
				'Magento\Core\Model\Resource\Setup\Context',
				'Magento\Framework\Module\Setup\Context' 
		],
		[ 
				'Magento\Core\Model\Resource\Setup\Migration',
		...
		[ 
				'Magento\Core\Model\Session\Validator',
				'Magento\Framework\Session\Validator' 
		],
		[ 
				'Magento\Core\Block\Formkey',
				'Magento\Framework\View\Element\FormKey' 
		],
		[ 
				'Magento\Rating\Helper\Data',
				'Magento\Review\Helper\Data' 
		],
		[ 
				'Magento\Rating\Controller\Adminhtml\Index',
		...
		[ 
				'Magento\Rating\Block\Adminhtml\Rating',
				'Magento\Review\Block\Adminhtml\Rating' 
		],
		[ 
				'Magento\Rating\Block\Adminhtml\Edit',
				'Magento\Review\Block\Adminhtml\Rating\Edit' 
		],
		[ 
				'Magento\Rating\Block\Adminhtml\Edit\Tabs',
				'Magento\Review\Block\Adminhtml\Rating\Edit\Tabs' 
		],
		[ 
				'Magento\Rating\Block\Adminhtml\Edit\Form',
				'Magento\Review\Block\Adminhtml\Rating\Edit\Form' 
		],
		[ 
		...
		[ 
				'Magento\Rating\Model\Resource\Rating\Collection',
				'Magento\Review\Model\ResourceModel\Rating\Collection' 
		],
		[ 
				'Magento\Rating\Model\Resource\Rating\Option\Vote',
		...
		[ 
				'Magento\Rating\Model\Resource\Rating\Option',
				'Magento\Review\Model\ResourceModel\Rating\Option' 
		],
		[ 
				'Magento\Rating\Model\Resource\Rating\Entity',
				'Magento\Review\Model\ResourceModel\Rating\Entity' 
		],
		[ 
				'Magento\Rating\Model\Rating\Entity',
				'Magento\Review\Model\Rating\Entity' 
		],
		[ 
				'Magento\Rating\Model\Resource\Rating',
				'Magento\Review\Model\ResourceModel\Rating' 
		],
		[ 
				'Magento\Rating\Model\Rating\Option',
		...
		[ 
				'Magento\Core\Model\App\Area\CacheIdentifierPlugin',
				'Magento\PageCache\App\CacheIdentifierPlugin' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Resource\Variable',
				'Magento\Variable\Model\ResourceModel\Variable' 
		],
		[ 
				'Magento\Core\Model\Resource\Variable\Collection',
		...
		[ 
				'Magento\Checkout\Block\Agreements',
		...
		[ 
				'Magento\Checkout\Model\ResourceModel\Agreement',
		...
		[ 
				'Magento\Backup\Archive\Tar',
				'Magento\Framework\Backup\Archive\Tar' 
		],
		[ 
				'Magento\Backup\Db\BackupDbInterface',
				'Magento\Framework\Backup\Db\BackupDbInterface' 
		],
		[ 
				'Magento\Backup\Db\BackupFactory',
				'Magento\Framework\Backup\Db\BackupFactory' 
		],
		[ 
				'Magento\Backup\Db\BackupInterface',
				'Magento\Framework\Backup\Db\BackupInterface' 
		],
		[ 
				'Magento\Backup\Exception\CantLoadSnapshot',
				'Magento\Framework\Backup\Exception\CantLoadSnapshot' 
		],
		[ 
				'Magento\Backup\Exception\FtpConnectionFailed',
				'Magento\Framework\Backup\Exception\FtpConnectionFailed' 
		],
		[ 
				'Magento\Backup\Exception\FtpValidationFailed',
				'Magento\Framework\Backup\Exception\FtpValidationFailed' 
		],
		[ 
				'Magento\Backup\Exception\NotEnoughFreeSpace',
				'Magento\Framework\Backup\Exception\NotEnoughFreeSpace' 
		],
		[ 
				'Magento\Backup\Exception\NotEnoughPermissions',
				'Magento\Framework\Backup\Exception\NotEnoughPermissions' 
		],
		[ 
				'Magento\Backup\Filesystem\Iterator\File',
				'Magento\Framework\Backup\Filesystem\Iterator\File' 
		],
		[ 
				'Magento\Backup\Filesystem\Iterator\Filter',
				'Magento\Framework\Backup\Filesystem\Iterator\Filter' 
		],
		[ 
		...
		[ 
				'Magento\Backup\Filesystem\Rollback\Fs',
				'Magento\Framework\Backup\Filesystem\Rollback\Fs' 
		],
		[ 
				'Magento\Backup\Filesystem\Rollback\Ftp',
				'Magento\Framework\Backup\Filesystem\Rollback\Ftp' 
		],
		[ 
				'Magento\Backup\Filesystem\Helper',
				'Magento\Framework\Backup\Filesystem\Helper' 
		],
		[ 
				'Magento\Backup\AbstractBackup',
				'Magento\Framework\Backup\AbstractBackup' 
		],
		[ 
				'Magento\Backup\BackupException',
				'Magento\Framework\Backup\BackupException' 
		],
		[ 
				'Magento\Backup\BackupInterface',
		...
		[ 
				'Magento\Backup\Filesystem',
				'Magento\Framework\Backup\Filesystem' 
		],
		[ 
				'Magento\Backup\Media',
				'Magento\Framework\Backup\Media' 
		],
		[ 
				'Magento\Backup\Nomedia',
		...
		[ 
				'Magento\ImportExport\Model\Export\Product',
		...
		[ 
				'Magento\ImportExport\Model\Import\Product',
		...
		[ 
				'Magento\CurrencyFactory',
				'Magento\Framework\CurrencyFactory' 
		],
		[ 
				'Magento\CurrencyInterface',
		...
		[ 
				'Magento\Framework\BootstrapException',
				'Magento\Framework\Exception\State\InitException' 
		],
		[ 
		...
		[ 
				'Magento\Less\File\Source\Theme',
		...
		[ 
				'Magento\Framework\View\Layout\File\FileList\Collator',
		...
		[ 
				'Magento\Framework\View\Layout\File\Source\Override\Base',
		...
		[ 
				'Magento\Framework\View\Layout\File\Factory',
				'Magento\Framework\View\File\Factory' 
		],
		[ 
		...
		[ 
				'Magento\Framework\View\Url\Resolver',
				'Magento\Framework\View\Asset\Repository' 
		],
		[ 
		...
		[ 
				'Magento\Less\PreProcessor\File\Less',
				'Magento\Framework\View\Asset\File' 
		],
		[ 
		...
		[ 
				...
				'Magento\Framework\View\Asset\PreProcessing\Cache' 
		],
		[ 
		...
		[ 
				'Magento\Tax\Model\Config\Source\TaxClass\Customer',
		...
		[ 
				'Magento\AdminNotification\Model\System\MessageList',
		...
		[ 
				'Magento\Tax\Block\Adminhtml\Rate\ImportExport',
				'Magento\TaxImportExport\Block\Adminhtml\Rate\ImportExport' 
		],
		[ 
		...
		[ 
				'Magento\Tax\Controller\Adminhtml\Rate\ExportCsv',
				'Magento\TaxImportExport\Controller\Adminhtml\Rate\ExportCsv' 
		],
		[ 
		...
		[ 
				'Magento\Tax\Controller\Adminhtml\Rate\ExportXml',
		...
		[ 
				'Magento\Tax\Model\Rate\CsvImportHandler',
		...
		[ 
				'\Magento\Framework\App\EntryPoint\EntryPoint',
				'\Magento\Framework\App\Bootstrap' 
		],
		[ 
				'\Magento\Framework\App\EntryPointInterface',
				'\Magento\Framework\App\Bootstrap' 
		],
		[ 
				'Magento\Framework\Module\FrontController\Plugin\Install',
		...
		[ 
				'\Magento\Cron\App\Cron\Plugin\ApplicationInitializer',
				'Magento\Framework\App\Bootstrap' 
		],
		[ 
				'Magento\Framework\App\Error\Handler',
		...
		[ 
				'Magento\Framework\Error\Handler',
				'Magento\Framework\App\ErrorHandler' 
		],
		[ 
				'Magento\Framework\Error\HandlerInterface',
				'Magento\Framework\App\ErrorHandler' 
		],
		[ 
				'Magento\Index' 
		...
		[ 
				'\Magento\Framework\Api\Eav\AbstractObject',
				'Magento\Framework\Api\AbstractExtensibleObject' 
		],
		[ 
				'\Magento\Framework\Api\AbstractObject',
		...
		[ 
				'\Magento\Checkout\Service\V1\QuoteLoader',
		...
		[ 
				'Magento\Rss\Block\Order\Details',
				'Magento\Sales\Block\Order\Details' 
		],
		[ 
				'Magento\Rss\Model\Resource\Order',
				'Magento\Sales\Model\ResourceModel\Order\Rss\OrderStatus' 
		],
		[ 
		...
		[ 
				'Magento\Framework\Filesystem\DriverFactory',
		...
		[ 
				'Magento\Framework\App\View\Deployment\Version\Generator\Timestamp',
		...
		[ 
				'Magento\Framework\Interception\Config',
		...
		[ 
				'Magento\Framework\ObjectManager\ConfigCache',
		...
		[ 
				'Magento\Framework\HTTP\IClient',
				'Magento\Framework\HTTP\ClientInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\TaxCalculationServiceInterface',
				'Magento\Tax\Api\TaxCalculationInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\Data\TaxRule',
				'Magento\Tax\Api\Data\TaxRuleInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\Data\TaxRuleSearchResults',
		...
		[ 
				'Magento\Tax\Service\V1\Collection\TaxRuleCollection',
				'Magento\Tax\Model\TaxRuleCollection' 
		],
		[ 
				'Magento\Tax\Service\V1\TaxRateServiceInterface',
				'Magento\Tax\Api\TaxRateRepositoryInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\Data\TaxRateTitle',
		...
		[ 
				...
				'Magento\Tax\Api\Data\TaxRateTitleDataBuilder' 
		],
		[ 
		...
		[ 
				'Magento\Tax\Service\V1\Data\TaxRateSearchResults',
		...
		[ 
				'Magento\Tax\Service\V1\Collection\TaxRateCollection',
				'Magento\Tax\Model\TaxRateCollection' 
		],
		[ 
				'Magento\Tax\Service\V1\Data\TaxClassKey',
				'Magento\Tax\Api\Data\TaxClassKeyInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\Data\TaxClassSearchResults',
				'Magento\Tax\Api\Data\TaxClassSearchResultsInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\Data\TaxClass',
		...
		[ 
				'Magento\Tax\Service\V1\Data\OrderTaxDetails',
		...
		[ 
				'Magento\Tax\Service\V1\Data\OrderTaxDetails\Item',
				'Magento\Tax\Api\Data\OrderTaxDetailsItemInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\Data\QuoteDetails',
				'Magento\Tax\Api\Data\QuoteDetailsInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\Data\QuoteDetails\Item',
		...
		[ 
				'Magento\Tax\Service\V1\Data\TaxDetails\AppliedTaxRate',
				'Magento\Tax\Api\Data\AppliedTaxRateInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\Data\TaxDetails\Item',
				'Magento\Tax\Api\Data\TaxDetailsItemInterface' 
		],
		[ 
				'Magento\Tax\Service\V1\OrderTaxServiceInterface',
				'Magento\Tax\Api\OrderTaxManagementInterface' 
		],
		[ 
				'Magento\Tools\I18n\Code',
				'Magento\Setup\Module\I18n' 
		],
		[ 
				'Magento\TestFramework\Utility\AggregateInvoker',
				'Magento\Framework\App\Utility\AggregateInvoker' 
		],
		[ 
				'Magento\TestFramework\Utility\Classes',
				'Magento\Framework\App\Utility\Classes' 
		],
		[ 
				'Magento\TestFramework\Utility\Files',
		...
		[ 
				'Magento\Framework\Test\Utility\AggregateInvoker',
				'Magento\Framework\App\Utility\AggregateInvoker' 
		],
		[ 
				'Magento\Framework\Test\Utility\Classes',
				'Magento\Framework\App\Utility\Classes' 
		],
		[ 
				'Magento\Framework\Test\Utility\Files',
				'Magento\Framework\App\Utility\Files' 
		],
		[ 
				'Magento\Bundle\Service\V1\Data\Product\Link',
				'Magento\Bundle\Api\Data\LinkInterface' 
		],
		[ 
				'Magento\Bundle\Service\V1\Data\Product\Option',
		...
		[ 
				'Magento\Sales\Model\ResourceModel\AbstractResource',
				'Magento\Framework\Model\ResourceModel\Db\AbstractDb' 
		],
		[ 
		...
		[ 
				...
				'Magento\Theme\Model\ResourceModel\Design\Collection' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Resource\Theme',
		...
		[ 
				'Magento\Core\Model\Resource\Theme\Data\Collection',
				'Magento\Theme\Model\ResourceModel\Theme\Data\Collection' 
		],
		[ 
				'Magento\Core\Model\Resource\Theme\File\Collection',
				'Magento\Theme\Model\ResourceModel\Theme\File\Collection' 
		],
		[ 
				'Magento\Core\Model\Resource\Theme\Grid\Collection',
				'Magento\Theme\Model\ResourceModel\Theme\Grid\Collection' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Resource\Theme\File',
				'Magento\Core\Model\Resource\Theme\File' 
		],
		[ 
		...
		[ 
				'Magento\Paypal\Model\ResourceModel\Setup',
				'Magento\Paypal\Setup\InstallData' 
		],
		[ 
		...
		[ 
				'Magento\Framework\App\Cache\State\OptionsInterface',
				'Magento\Framework\App\Cache\State' 
		],
		[ 
		...
		[ 
				'Magento\Core\App\Action\Plugin\Design',
		...
		[ 
				'Magento\Backend\Model\Config\Backend\Cookie\Lifetime',
				'Magento\Cookie\Model\Config\Backend\Lifetime' 
		],
		[ 
				'Magento\Backend\Model\Config\Backend\Cookie\Path',
		...
		[ 
				'Magento\Core\Block\RequireCookie',
				'Magento\Cookie\Block\RequireCookie' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\Layout\Translator',
				'Magento\Framework\View\Model\Layout\Translator' 
		],
		[ 
		...
		[ 
				'Magento\Core\Model\PageLayout\Config\Builder',
				'Magento\Theme\Model\PageLayout\Config\Builder' 
		],
		[ 
				'Magento\Core\Model\Layout\DepersonalizePlugin',
		...
		[ 
				'Magento\Core\Model\Resource\Layout\Link',
		...
		[ 
				'Magento\Integration\Model\Manager',
		...
		[ 
				'Magento\Webapi\Model\PathProcessor',
		...
		[ 
				'Magento\Webapi\Controller\Response',
		...
		[ 
				'Magento\Webapi\Model\Config\Integration\Converter',
		...
		[ 
				'Magento\Webapi\Model\Plugin\Service\V1\Integration',
				'Magento\Integration\Model\Plugin\Service\V1\Integration' 
		],
		[ 
				'Magento\Webapi\Model\Plugin\Setup',
				'Magento\Integration\Model\Plugin\Setup' 
		],
		[ 
		...
		[ 
				'Magento\Authorization\Model\ResourceModel\Setup',
				'Magento\Authorization\Setup\AuthorizationFactory' 
		],
		[ 
				'Magento\Catalog\Model\ResourceModel\Setup',
				'Magento\Catalog\Setup\CategorySetup' 
		],
		[ 
				'Magento\Checkout\Model\ResourceModel\Setup',
				'Magento\Checkout\Setup\InstallData' 
		],
		[ 
				'Magento\Cms\Model\ResourceModel\Setup',
				'Magento\Cms\Setup\InstallData' 
		],
		[ 
		...
		[ 
				'Magento\Dhl\Model\Resource\Setup',
				'Magento\Dhl\Setup\InstallData' 
		],
		[ 
				'Magento\Directory\Model\ResourceModel\Setup',
				'Magento\Directory\Setup\InstallData' 
		],
		[ 
		...
		[ 
				'Magento\GiftMessage\Model\ResourceModel\Setup',
				'Magento\GiftMessage\Setup\InstallData' 
		],
		[ 
				'Magento\GoogleShopping\Model\Resource\Setup',
				'Magento\GoogleShopping\Setup\InstallData' 
		],
		[ 
				'Magento\Reports\Model\ResourceModel\Setup',
				'Magento\Reports\Setup\InstallData' 
		],
		[ 
				'Magento\Sales\Model\ResourceModel\Setup',
				'Magento\Sales\Setup\SalesSetup' 
		],
		[ 
				'Magento\Tax\Model\ResourceModel\Setup',
				'Magento\Tax\Setup\TaxSetup' 
		],
		[ 
				'Magento\Theme\Model\ResourceModel\Setup',
				'Magento\Theme\Setup\InstallData' 
		],
		[ 
				'Magento\Weee\Model\ResourceModel\Setup',
				'Magento\Weee\Setup\InstallData' 
		],
		[ 
		...
		[ 
				'Magento\Setup\Model\UserConfigurationDataMapper',
				'Magento\Setup\Model\StoreConfigurationDataMapper' 
		],
		[ 
				'Magento\Framework\App\State\Cleanup',
		...
		[ 
				'Magento\Tax\Model\ResourceModel\Sales\Order\Tax\Item',
		...
		[ 
				'Magento\Tools\I18n\Dictionary\Loader\File\Csv',
				'Magento\Setup\Module\I18n\Dictionary\Loader\File\Csv' 
		],
		[ 
				'Magento\Tools\I18n\Dictionary\Loader\FileInterface',
		...
		[ 
				'Magento\Tools\I18n\Dictionary\WriterInterface',
				'Magento\Setup\Module\I18n\Dictionary\WriterInterface' 
		],
		[ 
				'Magento\Tools\I18n\Dictionary',
				'Magento\Setup\Module\I18n\Dictionary' 
		],
		[ 
				'Magento\Tools\I18n\Factory',
				'Magento\Setup\Module\I18n\Factory' 
		],
		[ 
				'Magento\Tools\I18n\FilesCollector',
				'Magento\Setup\Module\I18n\FilesCollector' 
		],
		[ 
				'Magento\Tools\I18n\Locale',
		...
		[ 
				'Magento\Tools\I18n\Pack\Writer\File\AbstractFile',
				'Magento\Setup\Module\I18n\Pack\Writer\File\AbstractFile' 
		],
		[ 
				'Magento\Tools\I18n\Pack\Writer\File\Csv',
				'Magento\Setup\Module\I18n\Pack\Writer\File\Csv' 
		],
		[ 
				'Magento\Tools\I18n\Pack\WriterInterface',
		...
		[ 
				'Magento\Tools\I18n\Parser\Adapter\Js',
		...
		[ 
				'Magento\Tools\I18n\Parser\Adapter\Xml',
				'Magento\Setup\Module\I18n\Parser\Adapter\Xml' 
		],
		[ 
				'Magento\Tools\I18n\Parser\AdapterInterface',
				'Magento\Setup\Module\I18n\Parser\AdapterInterface' 
		],
		[ 
		...
		[ 
				'Magento\Tools\I18n\Parser\Parser',
				'Magento\Setup\Module\I18n\Parser\Parser' 
		],
		[ 
				'Magento\Tools\I18n\ParserInterface',
				'Magento\Setup\Module\I18n\ParserInterface' 
		],
		[ 
				'Magento\Tools\I18n\ServiceLocator',
				'Magento\Setup\Module\I18n\ServiceLocator' 
		],
		[ 
				'Magento\Tools\Di\App\Task\Manager',
		...
		[ 
				'Magento\Tools\Di\App\Task\Operation\Area',
				'Magento\Setup\Module\Di\App\Task\Operation\Area' 
		],
		[ 
				'Magento\Tools\Di\App\Task\Operation\Interception',
		...
		[ 
				'Magento\Tools\Di\App\Task\OperationFactory',
				'Magento\Setup\Module\Di\App\Task\OperationFactory' 
		],
		[ 
				'Magento\Tools\Di\App\Task\OperationInterface',
		...
		[ 
				'Magento\Tools\Di\Code\Generator',
				'Magento\Setup\Module\Di\Code\Generator' 
		],
		[ 
				'Magento\Tools\Di\Code\GeneratorFactory',
		...
		[ 
				'Magento\Tools\Di\Code\Reader\Decorator\Area',
				'Magento\Setup\Module\Di\Code\Reader\Decorator\Area' 
		],
		[ 
				'Magento\Tools\Di\Code\Reader\Decorator\Directory',
				'Magento\Setup\Module\Di\Code\Reader\Decorator\Directory' 
		],
		[ 
		...
		[ 
				'Magento\Tools\Di\Code\Reader\Type',
				'Magento\Setup\Module\Di\Code\Reader\Type' 
		],
		[ 
				'Magento\Tools\Di\Code\Scanner\ArrayScanner',
				'Magento\Setup\Module\Di\Code\Scanner\ArrayScanner' 
		],
		[ 
				'Magento\Tools\Di\Code\Scanner\CompositeScanner',
				'Magento\Setup\Module\Di\Code\Scanner\CompositeScanner' 
		],
		[ 
				'Magento\Tools\Di\Code\Scanner\DirectoryScanner',
		...
		[ 
				'Magento\Tools\Di\Code\Scanner\PhpScanner',
				'Magento\Setup\Module\Di\Code\Scanner\PhpScanner' 
		],
		[ 
				'Magento\Tools\Di\Code\Scanner\PluginScanner',
				'Magento\Setup\Module\Di\Code\Scanner\PluginScanner' 
		],
		[ 
				'Magento\Tools\Di\Code\Scanner\RepositoryScanner',
				'Magento\Setup\Module\Di\Code\Scanner\RepositoryScanner' 
		],
		[ 
				'Magento\Tools\Di\Code\Scanner\ScannerInterface',
		...
		[ 
				'Magento\Tools\Di\Code\Scanner\XmlScanner',
				'Magento\Setup\Module\Di\Code\Scanner\XmlScanner' 
		],
		[ 
				'Magento\Tools\Di\Compiler\ArgumentsResolver',
		...
		[ 
				'Magento\Tools\Di\Compiler\Config\Reader',
		...
		[ 
				'Magento\Tools\Di\Compiler\ConstructorArgument',
		...
		[ 
				'Magento\Tools\Di\Definition\Collection',
				'Magento\Setup\Module\Di\Definition\Collection' 
		],
		[ 
				'Magento\Tools\Di\Definition\Compressor\UniqueList',
				'Magento\Setup\Module\Di\Definition\Compressor\UniqueList' 
		],
		[ 
				'Magento\Tools\Di\Definition\Compressor',
				'Magento\Setup\Module\Di\Definition\Compressor' 
		],
		[ 
				'Magento\Tools\Di\Definition\Serializer\Igbinary',
				'Magento\Setup\Module\Di\Definition\Serializer\Igbinary' 
		],
		[ 
		...
		[ 
				'Magento\Tools\Di\Definition\Serializer\Standard',
				'Magento\Setup\Module\Di\Definition\Serializer\Standard' 
		],
		[ 
		...
		[ 
				'Magento\Integration\Service\V1\IntegrationInterface',
		...
		[ 
				'Magento\Tools\Dependency\Circular',
				'Magento\Setup\Module\Dependency\Circular' 
		],
		[ 
				'Magento\Tools\Dependency\Parser\Code',
				'Magento\Setup\Module\Dependency\Parser\Code' 
		],
		[ 
				'Magento\Tools\Dependency\Parser\Composer\Json',
				'Magento\Setup\Module\Dependency\Composer\Json' 
		],
		[ 
				'Magento\Tools\Dependency\Parser\Config\Xml',
				'Magento\Setup\Module\Dependency\Config\Xml' 
		],
		[ 
				'Magento\Tools\Dependency\ParserInterface',
		...
		[ 
				'Magento\Tools\Dependency\Report\BuilderInterface',
				'Magento\Setup\Module\Dependency\Report\BuilderInterface' 
		],
		[ 
				'Magento\Tools\Dependency\Report\Circular\Builder',
		...
		[ 
				'Magento\Tools\Dependency\Report\Circular\Writer',
				'Magento\Setup\Module\Dependency\Report\Circular\Writer' 
		],
		[ 
		...
		[ 
				'Magento\Tools\Dependency\Report\Dependency\Builder',
				'Magento\Setup\Module\Dependency\Report\Dependency\Builder' 
		],
		[ 
		...
		[ 
				'Magento\Tools\Dependency\Report\Dependency\Writer',
				'Magento\Setup\Module\Dependency\Report\Dependency\Writer' 
		],
		[ 
				'Magento\Tools\Dependency\Report\Framework\Builder',
				'Magento\Setup\Module\Dependency\Report\Framework\Builder' 
		],
		[ 
		...
		[ 
				'Magento\Tools\Dependency\Report\Framework\Writer',
				'Magento\Setup\Module\Dependency\Report\Framework\Writer' 
		],
		[ 
		...
		[ 
				'Magento\Tools\Dependency\Report\WriterInterface',
				'Magento\Setup\Module\Dependency\Report\WriterInterface' 
		],
		[ 
				'Magento\Tools\Dependency\ServiceLocator',
				'Magento\Setup\Module\Dependency\ServiceLocator' 
		],
		[ 
				'Magento\Tools\SampleData\Helper\Csv\Reader',
				'Magento\SampleData\Helper\Csv\Reader' 
		],
		[ 
				'Magento\Tools\SampleData\Helper\Csv\ReaderFactory',
				'Magento\SampleData\Helper\Csv\ReaderFactory' 
		],
		[ 
				'Magento\Tools\SampleData\Helper\Deploy',
				'Magento\SampleData\Helper\Deploy' 
		],
		[ 
				'Magento\Tools\SampleData\Helper\Fixture',
				'Magento\SampleData\Helper\Fixture' 
		],
		[ 
				'Magento\Tools\SampleData\Helper\PostInstaller',
				'Magento\SampleData\Helper\PostInstaller' 
		],
		[ 
				'Magento\Tools\SampleData\Helper\StoreManager',
				'Magento\SampleData\Helper\StoreManager' 
		],
		[ 
				'Magento\Tools\SampleData\Installer',
				'Magento\SampleData\Model\Installer' 
		],
		[ 
				'Magento\Tools\SampleData\Logger',
				'Magento\SampleData\Model\Logger' 
		],
		[ 
				'Magento\Tools\SampleData\ObserverManager',
				'Magento\SampleData\Model\ObserverManager' 
		],
		[ 
				'Magento\Tools\SampleData\SetupFactory',
				'Magento\SampleData\Model\SetupFactory' 
		],
		[ 
				'Magento\Tools\SampleData\SetupInterface',
				'Magento\SampleData\Model\SetupInterface' 
		],
		[ 
		...
		[ 
				'Magento\Tools\SampleData\Module\Bundle\Setup\Product',
				'Magento\SampleData\Module\Bundle\Setup\Product' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Bundle\Setup',
				'Magento\SampleData\Module\Bundle\Setup' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Catalog\Setup\Attribute',
				'Magento\SampleData\Module\Catalog\Setup\Attribute' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Catalog\Setup\Category',
				'Magento\SampleData\Module\Catalog\Setup\Category' 
		],
		[ 
		...
		[ 
				...
				'Magento\SampleData\Module\Catalog\Setup\Product' 
		],
		[ 
		...
		[ 
				'Magento\Tools\SampleData\Module\Catalog\Setup',
				'Magento\SampleData\Module\Catalog\Setup' 
		],
		[ 
				'Magento\Tools\SampleData\Module\CatalogRule\Setup\Rule',
				'Magento\SampleData\Module\CatalogRule\Setup\Rule' 
		],
		[ 
				'Magento\Tools\SampleData\Module\CatalogRule\Setup',
				'Magento\SampleData\Module\CatalogRule\Setup' 
		],
		[ 
		...
		[ 
				'Magento\Tools\SampleData\Module\Cms\Setup\Block',
				'Magento\SampleData\Module\Cms\Setup\Block' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Cms\Setup\Page',
				'Magento\SampleData\Module\Cms\Setup\Page' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Cms\Setup',
				'Magento\SampleData\Module\Cms\Setup' 
		],
		[ 
		...
		[ 
				...
				'Magento\SampleData\Module\Customer\Setup\Customer' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Customer\Setup',
				'Magento\SampleData\Module\Customer\Setup' 
		],
		[ 
				'Magento\Tools\SampleData\Module\CustomerBalance\Observer',
				'Magento\SampleData\Module\CustomerBalance\Observer' 
		],
		[ 
		...
		[ 
				'Magento\Tools\SampleData\Module\Downloadable\Setup',
				'Magento\SampleData\Module\Downloadable\Setup' 
		],
		[ 
		...
		[ 
				'Magento\Tools\SampleData\Module\GiftCard\Setup\Product',
				'Magento\SampleData\Module\GiftCard\Setup\Product' 
		],
		[ 
				'Magento\Tools\SampleData\Module\GiftCard\Setup',
				'Magento\SampleData\Module\GiftCard\Setup' 
		],
		[ 
		...
		[ 
				'Magento\Tools\SampleData\Module\GiftRegistry\Setup',
		...
		[ 
				'Magento\Tools\SampleData\Module\GroupedProduct\Setup',
				'Magento\SampleData\Module\GroupedProduct\Setup' 
		],
		[ 
		...
		[ 
				'Magento\Tools\SampleData\Module\MultipleWishlist\Setup',
				'Magento\SampleData\Module\MultipleWishlist\Setup' 
		],
		[ 
		...
		[ 
				'Magento\Tools\SampleData\Module\OfflineShipping\Setup',
				'Magento\SampleData\Module\OfflineShipping\Setup' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Review\Setup\Review',
				'Magento\SampleData\Module\Review\Setup\Review' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Review\Setup',
		...
		[ 
				'Magento\Tools\SampleData\Module\Sales\Setup\Order',
				'Magento\SampleData\Module\Sales\Setup\Order' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Sales\Setup',
				'Magento\SampleData\Module\Sales\Setup' 
		],
		[ 
				'Magento\Tools\SampleData\Module\SalesRule\Setup\Rule',
				'Magento\SampleData\Module\SalesRule\Setup\Rule' 
		],
		[ 
				'Magento\Tools\SampleData\Module\SalesRule\Setup',
				'Magento\SampleData\Module\SalesRule\Setup' 
		],
		[ 
				'Magento\Tools\SampleData\Module\TargetRule\Setup\Rule',
				'Magento\SampleData\Module\TargetRule\Setup\Rule' 
		],
		[ 
				'Magento\Tools\SampleData\Module\TargetRule\Setup',
				'Magento\SampleData\Module\TargetRule\Setup' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Tax\Setup\Tax',
				'Magento\SampleData\Module\Tax\Setup\Tax' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Tax\Setup',
				'Magento\SampleData\Module\Tax\Setup' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Theme\Setup',
				'Magento\SampleData\Module\Theme\Setup' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Widget\Setup\CmsBlock',
				'Magento\SampleData\Module\Widget\Setup\CmsBlock' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Widget\Setup',
				'Magento\SampleData\Module\Widget\Setup' 
		],
		[ 
		...
		[ 
				'Magento\Tools\SampleData\Module\Wishlist\Setup\Wishlist',
				'Magento\SampleData\Module\Wishlist\Setup\Wishlist' 
		],
		[ 
				'Magento\Tools\SampleData\Module\Wishlist\Setup',
				'Magento\SampleData\Module\Wishlist\Setup' 
		],
		[ 
		...
		[ 
				'Magento\ToolkitFramework\Fixture',
				'Magento\Setup\Fixtures\Fixture' 
		],
		[ 
				'Magento\ToolkitFramework\Application',
				'Magento\Setup\Fixtures\FixtureModel' 
		],
		[ 
				'Magento\Framework\Locale\Lists',
		...
		[ 
				'Magento\Framework\Config\ConfigOptionsList',
		...
		[ 
				'Magento\Ui\DataProvider\EavValidationRul',
		...
		[ 
				'Magento\Framework\View\Asset\ModuleNotation\Resolver',
		...
		[ 
				...
				'corresponding classes in Magento\Bundle\Observer\*' 
		],
		[ 
				'Magento\CatalogRule\Model\Observer',
				'corresponding classes in Magento\CatalogRule\Observer\*' 
		],
		[ 
				'Magento\Tax\Model\Observer',
				'corresponding classes in Magento\Tax\Observer\*' 
		],
		[ 
				'Magento\CacheInvalidate\Model\Observer',
				'corresponding classes in Magento\CacheInvalidate\Observer\*' 
		],
		[ 
				'Magento\Catalog\Model\Observer',
				'corresponding classes in Magento\Catalog\Observer\*' 
		],
		[ 
				'Magento\CatalogInventory\Model\Observer',
				'corresponding classes in Magento\CatalogInventory\Observer\*' 
		],
		[ 
				'Magento\Paypal\Model\Observer',
				'corresponding classes in Magento\Paypal\Observer\*' 
		],
		[ 
				'Magento\Checkout\Model\Observer',
				'corresponding classes in Magento\Checkout\Observer\*' 
		],
		[ 
				'Magento\CurrencySymbol\Model\Observer',
				'corresponding classes in Magento\CurrencySymbol\Observer\*' 
		],
		[ 
		...
		[ 
				'Magento\Eav\Model\Entity\Increment\Numeric',
		...
		[ 
				'Magento\OfflineShipping\Model\Observer\SalesRule\ActionsTab',
				'Magento\OfflineShipping\Observer\*' 
		],
		[ 
				'Magento\Theme\Model\Observer',
		...
		[ 
				'Magento\Catalog\Observer\CatalogCheckIsUsingStaticUrlsAllowed',
				'Magento\Catalog\Observer\*' 
		],
		[ 
		...
		[ 
				...
				'Magento\Msrp\Observer\*' 
		],
		[ 
				'Magento\Customer\Model\Observer\Log',
		...
		[ 
				'Magento\Paypal\Model\Observer\RestrictAdminBillingAgreementUsage',
				'Magento\Paypal\Observer\*' 
		],
		[ 
				'Magento\GiftMessage\Model\Observer',
				'Magento\GiftMessage\Observer\*' 
		],
		[ 
				'Magento\Quote\Model\Observer\Webapi\Submit',
				'Magento\Quote\Observer\*' 
		],
		[ 
		...
		[ 
				'Magento\CatalogRule\Observer\ProcessAdminFinalPrice',
				'Magento\CatalogRule\Observer\*' 
		],
		[ 
				'Magento\CatalogRule\Observer\ProcessFrontFinalPrice',
				'Magento\CatalogRule\Observer\*' 
		],
		[ 
				'Magento\CatalogRule\Observer\PrepareCatalogProductCollectionPrices',
				'Magento\CatalogRule\Observer\*' 
		],
		[ 
				'Magento\Review\Model\Observer',
		...
		[ 
				'Magento\GoogleAnalytics\Model\Observer',
				'Magento\GoogleAnalytics\Observer\*' 
		],
		[ 
		...
		[ 
				...
				'Magento\ProductVideo\Observer\*' 
		],
		[ 
				'Magento\Checkout\Observer\LoadCustomerQuote',
				'Magento\Checkout\Observer\*' 
		],
		[ 
				'Magento\Checkout\Observer\UnsetAll',
				'Magento\Checkout\Observer\*' 
		],
		[ 
				'Magento\AdminNotification\Model\Observer',
				'Magento\AdminNotification\Observer\*' 
		],
		[ 
				'Magento\Cron\Model\Observer',
				'Magento\Cron\Observer\*' 
		],
		[ 
				'Magento\User\Model\Backend\Observer\AuthObserver',
				'Magento\User\Observer\*' 
		],
		[ 
		...
		[ 
				...
				'Magento\SalesRule\Observer\*' 
		],
		[ 
				'Magento\CatalogUrlRewrite\Observer\CategorySaveRewritesHistorySetter',
		...
		[ 
				'Magento\CatalogUrlRewrite\Model\Product\Observer',
				'Magento\CatalogUrlRewrite\Observer\*' 
		],
		[ 
				'Magento\CatalogUrlRewrite\Model\Category\Observer',
				'Magento\CatalogUrlRewrite\Observer\*' 
		],
		[ 
				'Magento\CatalogUrlRewrite\Observer\ProductUrlKeyAutogenerator',
				'Magento\CatalogUrlRewrite\Observer\*' 
		],
		[ 
				'Magento\Weee\Model\Total\Observer\Webapi\Item',
				'Magento\Weee\Observer\*' 
		],
		[ 
		...
		[ 
				...
				'Magento\GoogleAdwords\Observer\*' 
		],
		[ 
				'Magento\Bundle\Observer\AppendUpsellProducts',
				'Magento\Bundle\Observer\*' 
		],
		[ 
				'Magento\Bundle\Observer\LoadProductOptions',
				'Magento\Bundle\Observer\*' 
		],
		[ 
				'Magento\Bundle\Observer\InitOptionRenderer',
				'Magento\Bundle\Observer\*' 
		],
		[ 
				'Magento\Bundle\Observer\SetAttributeTabBlock',
				'Magento\Bundle\Observer\*' 
		],
		[ 
				'Magento\Config\Model\Config\Backend\Admin\Observer',
				'Magento\Config\Observer\*' 
		],
		[ 
		...
		[ 
				'Magento\Persistent\Model\Observer\ApplyPersistentData',
				'Magento\Persistent\Observer\*' 
		],
		[ 
				'Magento\Persistent\Model\Observer\DisableGuestCheckout',
				'Magento\Persistent\Observer\*' 
		],
		[ 
				'Magento\Persistent\Model\Observer\CustomerAuthenticatedEvent',
				'Magento\Persistent\Observer\*' 
		],
		[ 
				'Magento\Persistent\Model\Observer\SetQuotePersistentData',
				'Magento\Persistent\Observer\*' 
		],
		[ 
				'Magento\Persistent\Model\Observer\SetLoadPersistentQuote',
				'Magento\Persistent\Observer\*' 
		],
		[ 
				'Magento\Persistent\Model\Observer\RemovePersistentCookie',
				'Magento\Persistent\Observer\*' 
		],
		[ 
		...
		[ 
				'Magento\Persistent\Model\Observer\UpdateCustomerCookies',
				'Magento\Persistent\Observer\*' 
		],
		[ 
		...
		[ 
				'Magento\Persistent\Model\Observer\CheckExpirePersistentQuote',
				'Magento\Persistent\Observer\*' 
		],
		[ 
		...
		[ 
				'Magento\Persistent\Model\Observer\PreventClearCheckoutSession',
				'Magento\Persistent\Observer\*' 
		],
		[ 
				'Magento\Persistent\Model\Observer\MakePersistentQuoteGuest',
				'Magento\Persistent\Observer\*' 
		],
		[ 
				'Magento\CmsUrlRewrite\Model\Observer',
				'Magento\CmsUrlRewrite\Observer\*' 
		],
		[ 
				'Magento\Cms\Model\Observer',
				'Magento\Cms\Observer\*' 
		],
		[ 
				'Magento\OfflinePayments\Model\Observer',
				'Magento\OfflinePayments\Observer\*' 
		],
		[ 
		...
		[ 
				...
				'Magento\SalesSequence\Observer\*' 
		],
		[ 
				'Magento\Checkout\Observer\SalesQuoteSaveAfter',
				'Magento\Checkout\Observer\*' 
		],
		[ 
		...
		[ 
				'Magento\CacheInvalidate\Observer\InvalidateVarnish',
				'Magento\CacheInvalidate\Observer\*' 
		],
		[ 
				'Magento\CacheInvalidate\Observer\FlushAllCache',
				'Magento\CacheInvalidate\Observer\*' 
		],
		[ 
				'Magento\PageCache\Model\Observer\ProcessLayoutRenderElement',
				'Magento\PageCache\Observer\*' 
		],
		[ 
				'Magento\PageCache\Model\Observer\FlushCacheByTags',
				'Magento\PageCache\Observer\*' 
		],
		[ 
				'Magento\PageCache\Model\Observer\InvalidateCacheIfChanged',
				'Magento\PageCache\Observer\*' 
		],
		[ 
				'Magento\PageCache\Model\Observer\FlushAllCache',
				'Magento\PageCache\Observer\*' 
		],
		[ 
				'Magento\PageCache\Model\Observer\InvalidateCache',
				'Magento\PageCache\Observer\*' 
		],
		[ 
				'Magento\PageCache\Model\Observer\RegisterFormKeyFromCookie',
				'Magento\PageCache\Observer\*' 
		],
		[ 
				'Magento\PageCache\Model\Observer\FlushFormKeyOnLogout',
				'Magento\PageCache\Observer\*' 
		],
		[ 
		...
		[ 
				...
				'Magento\Payment\Observer\*' 
		],
		[ 
				'Magento\Tax\Observer\AggregateSalesReportTaxData',

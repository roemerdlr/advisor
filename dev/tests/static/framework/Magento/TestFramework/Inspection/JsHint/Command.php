...
class Command extends \Magento\TestFramework\Inspection\AbstractCommand {
	 ...
	 *        	Destination file to write JsHint report to
	 */
	...
	protected function _buildShellCmd($whiteList, $blackList) {
		return $this->_getHostScript ( true ) . ' ' . '"' . $this->_getJsHintPath () . '" ' . '"' . $this->getFileName () . '" ' . $this->_getJsHintOptions ();
	}
	 ...
	 * @param array $blackList
	 *        	Files/directories to be excluded from the inspection
	 * @return bool
	 */

...
class CopyPasteDetector implements ToolInterface, BlacklistInterface {
	 ...
	 * @return int @SuppressWarnings(PHPMD.UnusedLocalVariable)
	 */
	public function run(array $whiteList) {
		...
		$command = 'phpcpd' . ' --log-pmd ' . escapeshellarg ( $this->reportFile ) . ' --min-lines 13' . $blackListStr . ' ' . implode ( ' ', $whiteList );

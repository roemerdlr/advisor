...
class AssertSearchSynonymMassActionNotOnFrontend extends AbstractConstraint {
	 ...
	 * @return void
	 */
	public function processAssert(array $searchTerms, CmsIndex $cmsIndex, BrowserInterface $browser, AssertSearchSynonymNotOnFrontend $assertSearchSynonymNotOnFrontend) {

...
class DeleteStoreGroupEntityTest extends Injectable {
	 ...
	 * @return void
	 */
	public function __inject(StoreIndex $storeIndex, EditGroup $editGroup, DeleteGroup $deleteGroup, BackupIndex $backupIndex) {
	...
	public function test(StoreGroup $storeGroup, $createBackup) {
		...
		$this->deleteGroup->getDeleteGroupForm ()->fillForm ( [ 

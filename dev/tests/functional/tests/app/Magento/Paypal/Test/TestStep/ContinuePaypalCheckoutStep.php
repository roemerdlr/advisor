...
class ContinuePaypalCheckoutStep implements TestStepInterface {
	 ...
	 */
	public function __construct(SandboxCustomer $sandboxCustomer, ExpressReview $expressReview, AssertTotalPaypalReview $assertTotalPaypalReview, array $paypalPrices = []) {

...
class ExpressCheckoutOrderPlaceStep implements TestStepInterface {
	 ...
	 * @param array $prices        	
	 */
	public function __construct(ObjectManager $objectManager, OrderReviewExpress $orderReviewExpress, CheckoutOnepage $checkoutOnepage, CheckoutOnepageSuccess $checkoutOnepageSuccess, array $shipping = [], array $prices = []) {

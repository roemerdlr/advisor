...
class View extends \Magento\Catalog\Test\Block\Product\View {
	...
	public function getDownloadableLinksBlock() {
		return $this->blockFactory->create ( 'Magento\Downloadable\Test\Block\Catalog\Product\View\Links', [ 
	...
	public function getDownloadableSamplesBlock() {
		return $this->blockFactory->create ( 'Magento\Downloadable\Test\Block\Catalog\Product\View\Samples', [ 
	...
	public function getOptions(FixtureInterface $product) {
		...
		return [ 
				'downloadable_options' => $downloadableOptions 
		] + parent::getOptions ( $product );
	}
}

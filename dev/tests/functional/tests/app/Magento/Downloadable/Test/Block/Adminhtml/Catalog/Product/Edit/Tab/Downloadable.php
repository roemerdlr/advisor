...
class Downloadable extends Tab {
	...
	public function getDownloadableBlock($type, SimpleElement $element = null) {
		...
		return $this->blockFactory->create ( 'Magento\Downloadable\Test\Block\Adminhtml\Catalog\Product\Edit\Tab\Downloadable\\' . $type, [ 
	...
	public function getDataFormTab($fields = null, SimpleElement $element = null) {
		...
		if (isset ( $fields ['downloadable_sample'] ['value'] )) {
			$newFields ['downloadable_sample'] = $this->getDownloadableBlock ( 'Samples' )->getDataSamples ( $fields ['downloadable_sample'] ['value'] );
		}
		if (isset ( $fields ['downloadable_links'] ['value'] )) {
			$newFields ['downloadable_links'] = $this->getDownloadableBlock ( 'Links' )->getDataLinks ( $fields ['downloadable_links'] ['value'] );
		}

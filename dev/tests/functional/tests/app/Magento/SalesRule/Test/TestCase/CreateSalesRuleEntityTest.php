 ...
 * Precondition:
 * 1.
 * 2 sub categories in Default Category are created.
...
class CreateSalesRuleEntityTest extends Injectable {
	 ...
	 * @return void
	 */
	public function __inject(PromoQuoteNew $promoQuoteNew, PromoQuoteIndex $promoQuoteIndex, PromoQuoteEdit $promoQuoteEdit) {
	...
	public function __prepare(FixtureFactory $fixtureFactory) {
		...
		$productForSalesRule2 = $fixtureFactory->createByCode ( 'catalogProductSimple', [ 

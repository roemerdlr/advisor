...
abstract class AssertCartPriceRuleApplying extends AbstractConstraint {
	 ...
	 * @return void @SuppressWarnings(PHPMD.ExcessiveParameterList)
	 */
	public function processAssert(CheckoutCart $checkoutCart, CmsIndex $cmsIndex, CustomerAccountLogin $customerAccountLogin, CustomerAccountLogout $customerAccountLogout, CatalogCategoryView $catalogCategoryView, CatalogProductView $catalogProductView, Customer $customer, SalesRule $salesRule, SalesRule $salesRuleOrigin, array $productQuantity, CatalogProductSimple $productForSalesRule1, CatalogProductSimple $productForSalesRule2 = null, Address $address = null, $isLoggedIn = null, array $shipping = []) {
	...
	protected function login() {
		$this->objectManager->create ( 'Magento\Customer\Test\TestStep\LoginCustomerOnFrontendStep', [ 

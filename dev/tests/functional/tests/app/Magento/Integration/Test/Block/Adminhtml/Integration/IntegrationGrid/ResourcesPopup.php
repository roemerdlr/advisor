...
class ResourcesPopup extends Form {
	 ...
	 */
	public function __construct(SimpleElement $element, BlockFactory $blockFactory, Mapper $mapper, BrowserInterface $browser) {
	...
	protected function waitPopupToLoad() {
		...
		$context->waitUntil ( function () use($context, $selector) {

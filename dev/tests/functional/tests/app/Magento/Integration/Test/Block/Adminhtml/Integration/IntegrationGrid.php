...
class IntegrationGrid extends Grid {
	...
	public function getResourcesPopup() {
		...
		$resourcesPopup = $this->blockFactory->create ( 'Magento\Integration\Test\Block\Adminhtml\Integration\IntegrationGrid\ResourcesPopup', [ 
	...
	public function getTokensPopup() {
		$tokensPopup = $this->blockFactory->create ( 'Magento\Integration\Test\Block\Adminhtml\Integration\IntegrationGrid\TokensPopup', [ 

...
class View extends ParentView {
	...
	public function getGroupedProductBlock() {
		return $this->blockFactory->create ( 'Magento\GroupedProduct\Test\Block\Catalog\Product\View\Type\Grouped', [ 
	...
	public function getOptions(FixtureInterface $product) {
		return [ 
				'grouped_options' => $this->getGroupedProductBlock ()->getOptions ( $product ) 
		];
	}

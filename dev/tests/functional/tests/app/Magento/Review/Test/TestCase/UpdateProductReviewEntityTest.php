...
class UpdateProductReviewEntityTest extends Injectable {
	 ...
	 * @return void
	 */
	public function __inject(ReviewIndex $reviewIndex, ReviewEdit $reviewEdit, RatingIndex $ratingIndex, RatingEdit $ratingEdit) {
	...
	public function test(Review $reviewInitial, Review $review) {
		...
		$this->reviewIndex->getReviewGrid ()->searchAndOpen ( [ 

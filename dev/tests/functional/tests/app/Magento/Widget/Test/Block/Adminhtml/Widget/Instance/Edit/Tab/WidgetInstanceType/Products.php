...
class Products extends WidgetInstanceForm {
	...
	public function fillForm(array $parametersFields, SimpleElement $element = null) {
		...
		$fields = $this->dataMapping ( array_diff_key ( $parametersFields, [ 
				'entities' => '' 
		] ) );
	...
	protected function selectEntityInGrid(FixtureInterface $product) {
		...
		$productGrid = $this->blockFactory->create ( 'Magento\Widget\Test\Block\Adminhtml\Widget\Instance\Edit\Tab\WidgetInstanceType\Product\Grid', [ 
				'element' => $this->_rootElement->find ( $this->productGrid, Locator::SELECTOR_XPATH ) 
		] );
		$productGrid->searchAndSelect ( [ 

...
class Sidebar extends Block {
	...
	public function getCartItem(FixtureInterface $product) {
		...
		if ($this->hasRender ( $typeId )) {
			...
			$cartItemBlock = $this->_rootElement->find ( sprintf ( $this->cartProductList . $this->cartProductName, $product->getName () ), Locator::SELECTOR_XPATH );
			$cartItem = $this->blockFactory->create ( 'Magento\Checkout\Test\Block\Cart\Sidebar\Item', [ 

...
class Payment extends Block {
	...
	public function selectPaymentMethod(array $payment, CreditCard $creditCard = null) {
		...
		if ($creditCard !== null) {
			...
			$formBlock = $this->blockFactory->create ( '\\Magento\\Payment\\Test\\Block\\Form\\Cc', [ 
	...
	public function getSelectedPaymentMethodBlock() {
		...
		return $this->blockFactory->create ( '\Magento\Checkout\Test\Block\Onepage\Payment\Method', [ 
				'element' => $element 
		] );
	}

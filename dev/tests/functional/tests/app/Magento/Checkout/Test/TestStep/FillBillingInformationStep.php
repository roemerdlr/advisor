...
class FillBillingInformationStep implements TestStepInterface {
	 ...
	 */
	public function __construct(CheckoutOnepage $checkoutOnepage, AssertBillingAddressSameAsShippingCheckbox $assertBillingAddressCheckbox, Address $billingAddress = null, $billingCheckboxState = null) {

...
class EstimateShippingAndTaxStep implements TestStepInterface {
	 ...
	 */
	public function __construct(CheckoutCart $checkoutCart, Address $address, AssertEstimateShippingAndTax $assertEstimateShippingAndTax, FixtureFactory $fixtureFactory, array $products, array $shipping = [], Cart $cart = null) {
	...
	public function run() {
		...
		if ($this->cart !== null) {
			$cart = $this->fixtureFactory->createByCode ( 'cart', [ 

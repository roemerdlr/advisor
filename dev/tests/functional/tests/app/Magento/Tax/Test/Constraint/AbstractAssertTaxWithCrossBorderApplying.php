...
abstract class AbstractAssertTaxWithCrossBorderApplying extends AbstractConstraint {
	...
	/**
	 * 1.
	 * Login with each customer and get product price on category, product and cart pages
	 ...
	 * @return void
	 */
	public function processAssert(CatalogProductSimple $product, CmsIndex $cmsIndex, CatalogCategoryView $catalogCategoryView, CatalogProductView $catalogProductView, CheckoutCart $checkoutCart, array $customers) {

...
class Form extends FormInterface {
	 ...
	 * @return $this|void @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	...
	protected function addNewTaxRates($taxRule) {
		...
		$taxRateForm = $this->blockFactory->create ( 'Magento\Tax\Test\Block\Adminhtml\Rule\Edit\TaxRate', [ 
	...
	protected function waitForTaxRates() {
		$browser = $this->browser;
		$taxRateMultiSelectList = $this->taxRateMultiSelectList;
		$browser->waitUntil ( function () use($browser, $taxRateMultiSelectList) {

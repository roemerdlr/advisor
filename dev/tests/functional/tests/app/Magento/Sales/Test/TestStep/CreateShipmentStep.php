...
class CreateShipmentStep implements TestStepInterface {
	 ...
	 *        	[optional]
	 */
	public function __construct(OrderIndex $orderIndex, SalesOrderView $salesOrderView, OrderShipmentNew $orderShipmentNew, OrderShipmentView $orderShipmentView, OrderInjectable $order, $data = null) {

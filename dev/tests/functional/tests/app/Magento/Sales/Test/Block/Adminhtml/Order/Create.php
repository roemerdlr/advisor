...
class Create extends Block {
	...
	public function getItemsBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Items', [ 
	...
	public function getBillingAddressBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Billing\Address', [ 
	...
	protected function getShippingAddressBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Shipping\Address', [ 
	...
	protected function getBillingMethodBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Billing\Method', [ 
	...
	protected function getShippingMethodBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Shipping\Method', [ 
	...
	protected function getTotalsBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Totals', [ 
	...
	public function getGridBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Search\Grid', [ 
	...
	public function getAccountBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Form\Account', [ 
	...
	public function updateProductsData(array $products) {
		...
		$items = $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Items', [ 

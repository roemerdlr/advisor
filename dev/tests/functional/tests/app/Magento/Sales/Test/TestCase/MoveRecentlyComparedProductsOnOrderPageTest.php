...
class MoveRecentlyComparedProductsOnOrderPageTest extends Injectable {
	 ...
	 * @return void
	 */
	public function __inject(CmsIndex $cmsIndex, CatalogProductView $catalogProductView, OrderCreateIndex $orderCreateIndex, CustomerIndex $customerIndex, CustomerIndexEdit $customerIndexEdit, CatalogProductCompare $catalogProductCompare) {

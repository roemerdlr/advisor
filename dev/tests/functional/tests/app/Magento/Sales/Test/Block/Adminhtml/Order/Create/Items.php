...
class Items extends Block {
	...
	public function clickAddProducts() {
		...
		$this->_rootElement->waitUntil ( function () use($element, $selector) {
	...
	public function getItemProductByName($name) {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\Items\ItemProduct', [ 

...
class CustomerActivities extends Block {
	...
	public function getLastOrderedItemsBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\CustomerActivities\Sidebar\LastOrderedItems', [ 
	...
	public function getRecentlyViewedItemsBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\CustomerActivities\Sidebar\RecentlyViewedItems', [ 
	...
	public function getProductsInComparisonBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\CustomerActivities\Sidebar\ProductsInComparison', [ 
	...
	public function getRecentlyComparedProductsBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\CustomerActivities\Sidebar\RecentlyComparedProducts', [ 
	...
	public function getRecentlyViewedProductsBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\CustomerActivities\Sidebar\RecentlyViewedProducts', [ 
				'element' => $this->_rootElement->find ( $this->recentlyViewedSidebar ) 
		] );
	}
	...
	public function getShoppingCartItemsBlock() {
		return $this->blockFactory->create ( 'Magento\Sales\Test\Block\Adminhtml\Order\Create\CustomerActivities\Sidebar\ShoppingCartItems', [ 

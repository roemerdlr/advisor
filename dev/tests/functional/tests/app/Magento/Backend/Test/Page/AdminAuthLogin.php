...
class AdminAuthLogin extends Page {
	...
	public function getLoginBlock() {
		return Factory::getBlockFactory ()->getMagentoBackendAdminLogin ( $this->browser->find ( $this->loginBlock, Locator::SELECTOR_CSS ) );
	}
	...
	public function getHeaderBlock() {
		return Factory::getBlockFactory ()->getMagentoBackendPageHeader ( $this->browser->find ( $this->headerBlock, Locator::SELECTOR_CSS ) );
	}

...
class Group extends Form {
	...
	public function setValue($field, $value) {
		...
		$element = $this->_rootElement->find ( sprintf ( $this->element, $field ), Locator::SELECTOR_XPATH, $input );
		
		if ($element->isDisabled ()) {
			$checkbox = $this->_rootElement->find ( sprintf ( $this->defaultCheckbox, $field ), Locator::SELECTOR_XPATH, 'checkbox' );

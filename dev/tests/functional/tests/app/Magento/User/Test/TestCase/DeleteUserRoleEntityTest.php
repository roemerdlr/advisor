...
class DeleteUserRoleEntityTest extends Injectable {
	 ...
	 * @return void
	 */
	public function __inject(UserRoleIndex $userRoleIndex, UserRoleEditRole $userRoleEditRole, AdminAuthLogin $adminAuthLogin, Dashboard $dashboard) {
	 ...
	 * @return void
	 */
	public function testDeleteAdminUserRole(Role $role, User $adminUser, $isDefaultUser) {
		$filter = [ 

...
class SalesCouponReportEntityTest extends Injectable {
	 ...
	 * @return void
	 */
	public function __inject(OrderIndex $orderIndex, OrderInvoiceNew $orderInvoiceNew, SalesCouponReportView $salesCouponReportView, SalesOrderView $salesOrderView, Statistics $reportStatistic) {

...
class CustomerReviewReportEntityTest extends Injectable {
	...
	public function __prepare(FixtureFactory $fixtureFactory) {
		$customer = $fixtureFactory->createByCode ( 'customer', [ 
				'dataset' => 'johndoe_unique' 
		] );
		$customer->persist ();
	 ...
	 * @return void
	 */
	public function __inject(ProductReportReview $productReportReview, CatalogProductView $pageCatalogProductView, CmsIndex $cmsIndex, CatalogCategoryView $catalogCategoryView, CustomerAccountLogout $customerAccountLogout) {
	 ...
	 * @return array @SuppressWarnings(PHPMD.ConstructorWithNameAsEnclosingClass)
	 */

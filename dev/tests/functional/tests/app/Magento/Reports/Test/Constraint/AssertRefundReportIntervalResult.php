...
class AssertRefundReportIntervalResult extends AbstractAssertSalesReportResult {
	 ...
	 * @return void
	 */
	public function processAssert(OrderInjectable $order, array $refundsReport, array $initialRefundsResult, RefundsReport $refundsReportPage) {
		...
		\PHPUnit_Framework_Assert::assertEquals ( $prepareInitialResult, $salesResult, "Refund total Sales result is not correct." );
	}

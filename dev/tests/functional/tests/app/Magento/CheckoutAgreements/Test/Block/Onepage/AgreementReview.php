...
class AgreementReview extends Payment {
	...
	public function setAgreement($value, CheckoutAgreement $agreement) {
		$this->getSelectedPaymentMethodBlock ()->_rootElement->find ( sprintf ( $this->agreementCheckbox, $agreement->getCheckboxText () ), Locator::SELECTOR_XPATH, 'checkbox' )->setValue ( $value );
	}

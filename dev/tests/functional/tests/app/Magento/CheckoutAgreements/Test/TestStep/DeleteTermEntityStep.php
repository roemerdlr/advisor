...
class DeleteTermEntityStep implements TestStepInterface {
	 ...
	 */
	public function __construct(DeleteAllTermsEntityStep $deleteAllTermsEntityStep, CheckoutAgreementIndex $agreementIndex, CheckoutAgreementNew $agreementNew, CheckoutAgreement $agreement) {
	 ...
	 */
	public function run() {
		$this->agreementIndex->open ()->getAgreementGridBlock ()->searchAndOpen ( [ 

...
class AssertCustomerGroupForm extends AbstractConstraint {
	 ...
	 * @return void
	 */
	public function processAssert(CustomerGroupIndex $customerGroupIndex, CustomerGroupNew $customerGroupNew, CustomerGroup $customerGroup, CustomerGroup $customerGroupOriginal = null) {

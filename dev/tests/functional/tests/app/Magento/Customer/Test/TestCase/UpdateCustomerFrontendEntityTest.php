 ...
 * Preconditions:
 * 1.
 * Default test customer is created
 *
 * Steps:
...
class UpdateCustomerFrontendEntityTest extends Injectable {
	 ...
	 * @return void
	 */
	public function __inject(CmsIndex $cmsIndex, FixtureFactory $fixtureFactory, CustomerAccountIndex $customerAccountIndex, CustomerAccountEdit $customerAccountEdit, CustomerAddressEdit $customerAddressEdit) {

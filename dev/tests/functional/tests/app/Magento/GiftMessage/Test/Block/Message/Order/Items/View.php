...
class View extends Block {
	...
	public function getGiftMessage($itemName) {
		...
		$messageElement = $this->_rootElement->find ( sprintf ( $this->giftMessageForItemSelector, $itemName ), Locator::SELECTOR_XPATH );
	...
	protected function clickGiftMessageButton($itemName) {
		$this->_rootElement->find ( sprintf ( $this->giftMessageButtonSelector, $itemName ), Locator::SELECTOR_XPATH )->click ();
	}
	...
	protected function giftMessageButtonIsVisible($itemName) {
		return $this->_rootElement->find ( sprintf ( $this->giftMessageButtonSelector, $itemName ), Locator::SELECTOR_XPATH )->isVisible ();
	}
}

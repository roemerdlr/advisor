...
class GridPageAction extends ParentGridPageActions {
	...
	public function addProduct($productType = 'simple') {
		...
		$this->_rootElement->find ( str_replace ( '%productType%', $productType, $this->productItem ), Locator::SELECTOR_CSS )->click ();
	}
	...
	public function getTypeList() {
		$this->_rootElement->find ( $this->toggleButton, Locator::SELECTOR_CSS )->click ();
		return $this->_rootElement->find ( $this->typeList, Locator::SELECTOR_CSS )->getText ();
	}
}

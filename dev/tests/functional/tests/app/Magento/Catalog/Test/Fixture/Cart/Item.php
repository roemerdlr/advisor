	...
	public function __construct(FixtureInterface $product) {
		...
		foreach ( $checkoutCustomOptions as $key => $checkoutCustomOption ) {
			...
			$checkoutCustomOptions [$key] = [ 
					'title' => isset ( $customOptions [$attribute] ['title'] ) ? $customOptions [$attribute] ['title'] : $attribute,
					'value' => isset ( $customOptions [$attribute] ['options'] [$option] ['title'] ) ? $customOptions [$attribute] ['options'] [$option] ['title'] : $option 
			];
		}

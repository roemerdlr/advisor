...
class ProductDetails extends ProductTab {
	...
	public function fillFormTab(array $fields, SimpleElement $element = null) {
		...
		if (isset ( $data ['category_ids'] )) {
			...
			if (isset ( $fields ['category_ids'] ['source'] ) && $fields ['category_ids'] ['source']->getCategories () !== null && ! $fields ['category_ids'] ['source']->getCategories () [0]->hasData ( 'id' )) {
				$this->blockFactory->create ( 'Magento\Catalog\Test\Block\Adminhtml\Product\Edit\Tab\ProductDetails\NewCategoryIds', [ 

 ...
 * 1.
 * Attribute is created (Attribute)
...
class UpdateProductAttributeEntityTest extends Injectable {
	...
	public function testUpdateProductAttribute(CatalogProductAttribute $productAttributeOriginal, CatalogProductAttribute $attribute, CatalogAttributeSet $attributeSet, CatalogProductAttributeIndex $attributeIndex, CatalogProductAttributeNew $attributeNew, CatalogProductSimple $productSimple) {
		...
		return [ 
				'product' => $this->prepareProduct ( $productSimple, $attribute, $attributeSet ) 
		];
	}
	...
	protected function prepareAttribute($attribute, $productAttributeOriginal) {
		...
		return $this->fixtureFactory->createByCode ( 'catalogProductAttribute', [ 
				'data' => $attributeData 
		] );
	}
}

...
class PromotedSection extends Block {
	...
	public function getProductItem(FixtureInterface $product) {
		...
		return $this->blockFactory->create ( 'Magento\Catalog\Test\Block\Product\ProductList\ProductItem', [ 
	...
	public function getProducts() {
		...
		foreach ( $elements as $element ) {
			$result [] = $this->blockFactory->create ( 'Magento\Catalog\Test\Block\Product\ProductList\ProductItem', [ 
					'element' => $element 
			] );
		}

...
class AssertAddedProductAttributeOnProductForm extends AbstractConstraint {
	/**
	 * Add this attribute to Default attribute Template.
	 * Create product and Assert that created attribute
	...
	protected function createProductWithAttributeSet(CatalogProductAttribute $attribute, CatalogAttributeSet $attributeSet) {
		$product = ObjectManager::getInstance ()->create ( 'Magento\Catalog\Test\TestStep\AddAttributeToAttributeSetStep', [ 
				'attribute' => $attribute,

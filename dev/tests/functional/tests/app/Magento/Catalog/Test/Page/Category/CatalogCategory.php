...
class CatalogCategory extends Page {
	...
	public function getFormBlock() {
		return Factory::getBlockFactory ()->getMagentoCatalogAdminhtmlCategoryEditCategoryForm ( $this->browser->find ( $this->formBlock, Locator::SELECTOR_CSS ) );
	}
	...
	public function getTreeBlock() {
		return Factory::getBlockFactory ()->getMagentoCatalogAdminhtmlCategoryTree ( $this->browser->find ( $this->treeBlock, Locator::SELECTOR_CSS, 'tree' ), $this->getTemplateBlock () );
	}
	...
	public function getMessagesBlock() {
		return Factory::getBlockFactory ()->getMagentoBackendMessages ( $this->browser->find ( $this->messagesBlock, Locator::SELECTOR_CSS ) );
	}

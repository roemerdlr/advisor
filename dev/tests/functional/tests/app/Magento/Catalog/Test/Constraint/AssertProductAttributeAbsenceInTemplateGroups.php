...
class AssertProductAttributeAbsenceInTemplateGroups extends AbstractConstraint {
	...
	public function processAssert(CatalogAttributeSet $attributeSet, CatalogProductSetIndex $productSetIndex, CatalogProductSetEdit $productSetEdit) {
		...
		\PHPUnit_Framework_Assert::assertFalse ( $productSetEdit->getAttributeSetEditBlock ()->checkProductAttribute ( $attributeCode ), "Attribute " . $attributeCode . " is present in Attribute set's Groups section." );
	}

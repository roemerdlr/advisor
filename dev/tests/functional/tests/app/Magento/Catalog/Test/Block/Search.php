...
class Search extends Block {
	 ...
	 * @return void @SuppressWarnings(PHPMD.ConstructorWithNameAsEnclosingClass)
	 */
	...
	public function isSuggestSearchVisible($text, $amount = null) {
		...
		return ( bool ) $this->_rootElement->waitUntil ( function () use($rootElement, $searchAutocomplete) {

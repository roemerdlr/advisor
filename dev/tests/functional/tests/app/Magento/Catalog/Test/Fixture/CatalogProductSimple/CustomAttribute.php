...
class CustomAttribute extends DataSource {
	...
	public function __construct(FixtureFactory $fixtureFactory, array $params, $data) {
		...
		if (is_array ( $data ) && isset ( $data ['dataset'] )) {
			...
			$data = $fixtureFactory->createByCode ( 'catalogProductAttribute', [ 
		...
		$this->data ['code'] = $data->hasData ( 'attribute_code' ) == false ? $this->createAttributeCode ( $data ) : $data->getAttributeCode ();
		$this->attribute = $data;
	}

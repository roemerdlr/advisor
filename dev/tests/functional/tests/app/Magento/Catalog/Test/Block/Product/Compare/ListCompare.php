...
class ListCompare extends Block {
	...
	public function getComparableAttributes() {
		...
		$this->_rootElement->waitUntil ( function () use($rootElement, $element) {
	...
	public function getProductAttribute($indexProduct, $attributeKey) {
		return trim ( $this->getCompareProductAttribute ( $attributeKey )->find ( sprintf ( $this->attributeSelector, $indexProduct ), Locator::SELECTOR_XPATH )->getText () );
	}
	...
	public function getEmptyMessage() {
		...
		$this->_rootElement->waitUntil ( function () use($rootElement, $selector) {

...
class SaveAttributeStep implements TestStepInterface {
	 ...
	 */
	public function __construct(CatalogProductAttributeNew $attributeNew, CatalogProductAttribute $attribute, ObjectManager $objectManager) {
	...
	public function cleanup() {
		$this->objectManager->create ( 'Magento\Catalog\Test\TestStep\DeleteAttributeStep', [ 

...
class Related extends PromotedSection {
	...
	public function getProductItem(FixtureInterface $product) {
		...
		return $this->blockFactory->create ( 'Magento\Catalog\Test\Block\Product\ProductList\Related\ProductItem', [ 
	...
	public function getProducts() {
		...
		foreach ( $elements as $element ) {
			$result [] = $this->blockFactory->create ( 'Magento\Catalog\Test\Block\Product\ProductList\Related\ProductItem', [ 
					'element' => $element 
			] );
		}

...
class Config extends Tab {
	...
	public function fillFormTab(array $fields, SimpleElement $element = null) {
		$attributes = isset ( $fields ['configurable_attributes_data'] ['source'] ) ? $fields ['configurable_attributes_data'] ['value'] : [ ];
		
		$this->showContent ();
		$attributesValue = isset ( $fields ['configurable_attributes_data'] ['source'] ) ? $fields ['configurable_attributes_data'] ['source']->getAttributesData () : [ ];
	...
	public function getAttributeBlock() {
		return $this->blockFactory->create ( 'Magento\ConfigurableProduct\Test\Block\Adminhtml\Product\Edit\Tab\Variations\Config\Attribute', [ 
	...
	public function getVariationsBlock() {
		return $this->blockFactory->create ( 'Magento\ConfigurableProduct\Test\Block\Adminhtml\Product\Edit\Tab\Variations\Config\Matrix', [ 
	...
	public function getDataFormTab($fields = null, SimpleElement $element = null) {
		...
		return [ 
				'configurable_attributes_data' => $data 
		];
	}

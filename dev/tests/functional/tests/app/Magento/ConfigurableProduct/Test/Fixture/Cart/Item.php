	...
	public function __construct(FixtureInterface $product) {
		...
		foreach ( $checkoutConfigurableOptions as $key => $checkoutConfigurableOption ) {
			...
			$checkoutConfigurableOptions [$key] = [ 
					'title' => isset ( $attributesData [$attribute] ['label'] ) ? $attributesData [$attribute] ['label'] : $attribute,
					'value' => isset ( $attributesData [$attribute] ['options'] [$option] ['label'] ) ? $attributesData [$attribute] ['options'] [$option] ['label'] : $option 
			];
		}

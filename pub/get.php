...
$request = new \Magento\MediaStorage\Model\File\Storage\Request ( new Request ( new PhpCookieReader (), new Magento\Framework\Stdlib\StringUtils () ) );
...
if (empty ( $mediaDirectory )) {
	...
	$params [Factory::PARAM_CACHE_FORCED_OPTIONS] = [ 
			'frontend_options' => [ 
					'disable_save' => true 
			] 
	];
...
$app = $bootstrap->createApplication ( 'Magento\MediaStorage\App\Media', [ 

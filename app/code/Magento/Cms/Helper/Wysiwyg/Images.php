...
class Images extends \Magento\Framework\App\Helper\AbstractHelper {
	 ...
	 */
	public function __construct(\Magento\Framework\App\Helper\Context $context, \Magento\Backend\Helper\Data $backendData, \Magento\Framework\Filesystem $filesystem, \Magento\Store\Model\StoreManagerInterface $storeManager) {
	...
	public function isUsingStaticUrlsAllowed() {
		...
		$this->_eventManager->dispatch ( 'cms_wysiwyg_images_static_urls_allowed', [ 
				'result' => $checkResult,
	 ...
	 *        	Filename transferred via Ajax
	 * @param bool $renderAsTag
	 *        	Leave image HTML as is or transform it to controller directive
	 * @return string
	 */
	public function getImageHtmlDeclaration($filename, $renderAsTag = false) {
		...
		if ($renderAsTag) {
			...
			if ($this->isUsingStaticUrlsAllowed ()) {
				...
				$html = $this->_backendData->getUrl ( 'cms/wysiwyg/directive', [ 

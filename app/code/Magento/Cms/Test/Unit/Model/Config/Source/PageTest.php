...
class PageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->collectionFactory = $this->getMock ( 'Magento\Cms\Model\ResourceModel\Page\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->page = $objectManager->getObject ( 'Magento\Cms\Model\Config\Source\Page', [ 

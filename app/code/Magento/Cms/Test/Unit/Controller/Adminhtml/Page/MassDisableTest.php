...
class MassDisableTest extends AbstractMassActionTest {
	...
	protected function setUp() {
		...
		$this->collectionFactoryMock = $this->getMock ( 'Magento\Cms\Model\ResourceModel\Page\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->pageCollectionMock = $this->getMock ( 'Magento\Cms\Model\ResourceModel\Page\Collection', [ ], [ ], '', false );
		
		$this->massDisableController = $this->objectManager->getObject ( 'Magento\Cms\Controller\Adminhtml\Page\MassDisable', [ 
	...
	protected function getPageMock() {
		$pageMock = $this->getMock ( 'Magento\Cms\Model\ResourceModel\Page\Collection', [ 
				'setIsActive',
				'save' 
		], [ ], '', false );

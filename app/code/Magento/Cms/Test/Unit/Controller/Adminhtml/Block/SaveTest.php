...
class SaveTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->dataProcessorMock = $this->getMock ( 'Magento\Cms\Controller\Adminhtml\Block\PostDataProcessor', [ 
				'filter' 
		], [ ], '', false );
		...
		$this->saveController = $this->objectManager->getObject ( 'Magento\Cms\Controller\Adminhtml\Block\Save', [ 
	...
	public function testSaveAction() {
		...
		$this->dataProcessorMock->expects ( $this->any () )->method ( 'filter' )->with ( $postData )->willReturn ( $filteredPostData );
		...
		$this->messageManagerMock->expects ( $this->once () )->method ( 'addSuccess' )->with ( __ ( 'You saved the block.' ) );
	...
	public function testSaveActionNoId() {
		...
		$this->blockMock->expects ( $this->any () )->method ( 'load' )->willReturnSelf ();
		$this->blockMock->expects ( $this->any () )->method ( 'getId' )->willReturn ( false );
	...
	public function testSaveAndContinue() {
		...
		$this->resultRedirect->expects ( $this->atLeastOnce () )->method ( 'setPath' )->with ( '*/*/edit', [ 

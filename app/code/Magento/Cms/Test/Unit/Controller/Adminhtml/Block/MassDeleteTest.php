...
class MassDeleteTest extends AbstractMassActionTest {
	...
	protected function setUp() {
		...
		$this->collectionFactoryMock = $this->getMock ( 'Magento\Cms\Model\ResourceModel\Block\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->blockCollectionMock = $this->getMock ( 'Magento\Cms\Model\ResourceModel\Block\Collection', [ ], [ ], '', false );
		
		$this->massDeleteController = $this->objectManager->getObject ( 'Magento\Cms\Controller\Adminhtml\Block\MassDelete', [ 
	...
	protected function getBlockMock() {
		$blockMock = $this->getMock ( 'Magento\Cms\Model\ResourceModel\Block\Collection', [ 
				'delete' 
		], [ ], '', false );

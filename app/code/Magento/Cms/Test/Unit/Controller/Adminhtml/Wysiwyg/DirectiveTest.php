...
class DirectiveTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->imageAdapterMock = $this->getMockBuilder ( 'Magento\Framework\Image\Adapter\AdapterInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'getMimeType',
				'getColorAt',
				'getImage',
				'watermark',
		...
		$this->rawFactoryMock = $this->getMockBuilder ( 'Magento\Framework\Controller\Result\RawFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		$this->rawMock = $this->getMockBuilder ( 'Magento\Framework\Controller\Result\Raw' )->disableOriginalConstructor ()->getMock ();
		...
		$this->wysiwygDirective = $objectManager->getObject ( 'Magento\Cms\Controller\Adminhtml\Wysiwyg\Directive', [ 
	...
	public function testExecute() {
		...
		$this->imageAdapterMock->expects ( $this->once () )->method ( 'open' )->with ( self::IMAGE_PATH );

...
class DeleteTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->blockMock = $this->getMockBuilder ( 'Magento\Cms\Model\Block' )->disableOriginalConstructor ()->setMethods ( [ 
				'load',
				'delete' 
		] )->getMock ();
		...
		$this->deleteController = $this->objectManager->getObject ( 'Magento\Cms\Controller\Adminhtml\Block\Delete', [ 
	...
	public function testDeleteAction() {
		...
		$this->messageManagerMock->expects ( $this->once () )->method ( 'addSuccess' )->with ( __ ( 'You deleted the block.' ) );
	...
	public function testDeleteActionNoId() {
		...
		$this->messageManagerMock->expects ( $this->once () )->method ( 'addError' )->with ( __ ( 'We can\'t find a block to delete.' ) );

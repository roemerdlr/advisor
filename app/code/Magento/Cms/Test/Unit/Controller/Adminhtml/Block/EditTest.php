...
class EditTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->objectManagerMock = $this->getMockBuilder ( 'Magento\Framework\ObjectManager\ObjectManager' )->setMethods ( [ 
				'create',
				'get' 
		...
		$this->editController = $this->objectManager->getObject ( 'Magento\Cms\Controller\Adminhtml\Block\Edit', [ 
	...
	public function testEditAction($blockId, $label, $title) {
		...
		$sessionManagerMock = $this->getMock ( 'Magento\Backend\Model\Session', [ 
				'getFormData' 
		], [ ], '', false );

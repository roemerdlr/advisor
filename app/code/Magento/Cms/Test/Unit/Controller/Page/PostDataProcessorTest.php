...
class PostDataProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->validatorFactory = $this->getMock ( 'Magento\Framework\View\Model\Layout\Update\ValidatorFactory', [ 
				'create' 
		], [ ], '', false );
		$this->postDataProcessor = new PostDataProcessor ( $this->dateFilter, $this->messageManager, $this->validatorFactory );
	}

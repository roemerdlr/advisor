...
class NoCookiesObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->eventMock = $this->getMockBuilder ( 'Magento\Framework\Event' )->setMethods ( [ 
				'getStatus',
				'getRedirect' 
		] )->disableOriginalConstructor ()->getMock ();
		$this->objectMock = $this->getMockBuilder ( 'Magento\Framework\DataObject' )->setMethods ( [ 
				'setLoaded',
				'setForwardModule',
		...
		$this->noCookiesObserver = $objectManager->getObject ( 'Magento\Cms\Observer\NoCookiesObserver', [ 

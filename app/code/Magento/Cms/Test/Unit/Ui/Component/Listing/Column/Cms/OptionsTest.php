...
class OptionsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->systemStoreMock = $this->getMockBuilder ( 'Magento\Store\Model\System\Store' )->disableOriginalConstructor ()->getMock ();
		...
		$this->options = $objectManager->getObject ( 'Magento\Cms\Ui\Component\Listing\Column\Cms\Options', [ 

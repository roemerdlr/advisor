...
class Page {
	 ...
	 */
	public function __construct(CmsPageUrlPathGenerator $cmsPageUrlPathGenerator, UrlPersistInterface $urlPersist) {
	 ...
	 * @return \Magento\Cms\Model\ResourceModel\Page @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

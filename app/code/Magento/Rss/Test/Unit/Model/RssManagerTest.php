...
class RssManagerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->rssManager = $objectManagerHelper->getObject ( 'Magento\Rss\Model\RssManager', [ 
	...
	public function testGetProvider() {
		...
		$this->assertInstanceOf ( '\Magento\Framework\App\Rss\DataProviderInterface', $this->rssManager->getProvider ( 'rss_feed' ) );
	}

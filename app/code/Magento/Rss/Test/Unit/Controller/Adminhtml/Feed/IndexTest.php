...
class IndexTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->rssManager = $this->getMock ( 'Magento\Rss\Model\RssManager', [ 
				'getProvider' 
		], [ ], '', false );
		$this->scopeConfigInterface = $this->getMock ( 'Magento\Framework\App\Config\ScopeConfigInterface' );
		$this->rssFactory = $this->getMock ( 'Magento\Rss\Model\RssFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$controllerArguments = $objectManagerHelper->getConstructArguments ( 'Magento\Rss\Controller\Adminhtml\Feed\Index', [ 
	...
	public function testExecute() {
		...
		$rssModel = $this->getMock ( 'Magento\Rss\Model\Rss', [ 
				'setDataProvider',
				'createRssXml' 
		], [ ], '', false );

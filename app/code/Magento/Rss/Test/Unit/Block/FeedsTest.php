...
class FeedsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->block = $this->objectManagerHelper->getObject ( 'Magento\Rss\Block\Feeds', [ 
	...
	public function testGetFeeds() {
		...
		$this->rssManagerInterface->expects ( $this->once () )->method ( 'getProviders' )->will ( $this->returnValue ( [ 
				$provider1,
				$provider2 
		] ) );

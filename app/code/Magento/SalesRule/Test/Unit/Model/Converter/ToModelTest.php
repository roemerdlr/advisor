...
class ToModelTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->ruleFactory = $this->getMockBuilder ( 'Magento\SalesRule\Model\RuleFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		...
		$this->model = $helper->getObject ( 'Magento\SalesRule\Model\Converter\ToModel', [ 
	...
	public function testDataModelToArray() {
		 ...
		 */
		$dataCondition = $this->getMockBuilder ( '\Magento\SalesRule\Model\Data\Condition' )->disableOriginalConstructor ()->setMethods ( [ 
				'create',
				'load',
				'getConditionType',
				'getValue',
		...
		$dataCondition1 = $this->getMockBuilder ( '\Magento\SalesRule\Model\Data\Condition' )->disableOriginalConstructor ()->setMethods ( [ 
				'create',
				'load',
				'getConditionType',
				'getValue',
		...
		$dataCondition2 = $this->getMockBuilder ( '\Magento\SalesRule\Model\Data\Condition' )->disableOriginalConstructor ()->setMethods ( [ 
				'create',
				'load',
				'getConditionType',
				'getValue',
		...
		$dataCondition->expects ( $this->atLeastOnce () )->method ( 'getConditions' )->willReturn ( [ 
				$dataCondition1,
				$dataCondition2 
		] );
	...
	public function testToModel() {
		...
		$ruleModel = $this->getMockBuilder ( '\Magento\SalesRule\Model\Rule' )->disableOriginalConstructor ()->setMethods ( [ 
				'create',
				'load',
				'getId',
				'getData' 
		...
		$ruleModel->expects ( $this->atLeastOnce () )->method ( 'getData' )->willReturn ( [ 
				'data_1' => 1 
		] );
		
		$this->dataObjectProcessor->expects ( $this->any () )->method ( 'buildOutputDataArray' )->willReturn ( [ 
				'data_2' => 2 
		] );

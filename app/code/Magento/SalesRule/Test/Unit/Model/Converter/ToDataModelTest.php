...
class ToDataModelTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->ruleFactory = $this->getMockBuilder ( 'Magento\SalesRule\Model\RuleFactory' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		
		$this->ruleDataFactory = $this->getMockBuilder ( 'Magento\SalesRule\Api\Data\RuleInterfaceFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		
		$this->conditionDataFactory = $this->getMockBuilder ( 'Magento\SalesRule\Api\Data\ConditionInterfaceFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		
		$this->dataObjectProcessor = $this->getMockBuilder ( '\Magento\Framework\Reflection\DataObjectProcessor' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		
		$this->ruleLabelFactory = $this->getMockBuilder ( '\Magento\SalesRule\Api\Data\RuleLabelInterfaceFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		
		$this->salesRule = $this->getMockBuilder ( '\Magento\SalesRule\Model\Rule' )->disableOriginalConstructor ()->setMethods ( [ 
				'_construct',
				'getData',
		...
		$this->model = $helper->getObject ( 'Magento\SalesRule\Model\Converter\ToDataModel', [ 
	...
	public function testToDataModel() {
		$array = [ 
				...
				'name' => 'testrule',
				'is_active' => '1',
				'conditions_serialized' => 'a:7:{s:4:"type";s:46:"Magento\SalesRule\Model\Rule\Condition\Combine";s:9:"attribute";N;' . 's:8:"operator";N;s:5:"value";s:1:"1";s:18:"is_value_processed";N;s:10:"aggregator";s:3:"all";' . 's:10:"conditions";a:1:{i:0;a:5:{s:4:"type";s:46:"Magento\SalesRule\Model\Rule\Condition\Address";' . 's:9:"attribute";s:13:"base_subtotal";s:8:"operator";s:2:">=";s:5:"value";s:3:"100";' . 's:18:"is_value_processed";b:0;}}}',
				'actions_serialized' => 'a:7:{s:4:"type";s:54:"Magento\SalesRule\Model\Rule\Condition\Product\Combine";s:9:"attribute";N;' . 's:8:"operator";N;s:5:"value";s:1:"1";s:18:"is_value_processed";N;s:10:"aggregator";s:3:"all";' . 's:10:"conditions";a:1:{i:0;a:5:{s:4:"type";s:46:"Magento\SalesRule\Model\Rule\Condition\Product";' . 's:9:"attribute";s:16:"attribute_set_id";s:8:"operator";s:2:"==";s:5:"value";s:1:"4";' . 's:18:"is_value_processed";b:0;}}}',
				'coupon_type' => '1',
				'coupon_code' => '',
				'store_labels' => [ 
						0 => 'TestRule',
		...
		$dataModel = $this->getMockBuilder ( '\Magento\SalesRule\Model\Data\Rule' )->disableOriginalConstructor ()->setMethods ( [ 
				'create',
				'getStoreLabels',
				'setStoreLabels',
				'getCouponType',
		...
		$dataLabel = $this->getMockBuilder ( '\Magento\SalesRule\Api\Data\RuleLabel' )->setMethods ( [ 
				'setStoreId',
				'setStoreLabel',
				'setStoreLabels' 
		] )->disableOriginalConstructor ()->getMock ();
		
		$dataCondition = $this->getMockBuilder ( '\Magento\SalesRule\Model\Data\Condition' )->setMethods ( [ 
				'setData' 
		] )->disableOriginalConstructor ()->getMock ();

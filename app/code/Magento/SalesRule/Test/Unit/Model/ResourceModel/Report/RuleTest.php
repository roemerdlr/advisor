...
class RuleTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetUniqRulesNamesList() {
		$dbAdapterMock = $this->getMockBuilder ( 'Magento\Framework\DB\Adapter\Pdo\Mysql' )->setMethods ( [ 
				'_connect',
				'quote' 
		...
		$connectionMock->expects ( $this->once () )->method ( 'fetchAll' )->with ( $select )->will ( $this->returnCallback ( [ 
				$this,
				'fetchAllCallback' 
		] ) );
		...
		$createdatFactoryMock = $this->getMock ( 'Magento\SalesRule\Model\ResourceModel\Report\Rule\CreatedatFactory', [ 
				'create' 
		], [ ], '', false );
		$updatedatFactoryMock = $this->getMock ( 'Magento\SalesRule\Model\ResourceModel\Report\Rule\UpdatedatFactory', [ 
				'create' 
		], [ ], '', false );
		
		$objectHelper = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		$model = $objectHelper->getObject ( 'Magento\SalesRule\Model\ResourceModel\Report\Rule', [ 

...
class QuoteConfigProductAttributesTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->plugin = $objectManager->getObject ( 'Magento\SalesRule\Model\Plugin\QuoteConfigProductAttributes', [ 
	...
	public function testAfterGetProductAttributes() {
		...
		$this->ruleResource->expects ( $this->once () )->method ( 'getActiveAttributes' )->will ( $this->returnValue ( [ 
				[ 

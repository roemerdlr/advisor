...
class RuleRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->searchResultFactory = $this->getMock ( $className, [ 
				'create' 
		], [ ], '', false );
		...
		$this->extensionAttributesJoinProcessorMock = $this->getMock ( $className, [ 
				'process' 
		], [ ], '', false );
		
		$objectManager = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		$this->ruleRepository = $objectManager->getObject ( 'Magento\SalesRule\Model\RuleRepository', [ 
	...
	public function testGetList() {
		...
		$this->extensionAttributesJoinProcessorMock->expects ( $this->once () )->method ( 'process' )->with ( $collectionMock, 'Magento\SalesRule\Api\Data\RuleInterface' );
		...
		$filterMock->expects ( $this->once () )->method ( 'getField' )->willReturn ( 'rule_id' );

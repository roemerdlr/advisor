...
class FormatTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->salesRuleCoupon = $this->getMock ( 'Magento\SalesRule\Helper\Coupon', [ ], [ ], '', false );
		
		$this->model = $objectManager->getObject ( 'Magento\SalesRule\Model\System\Config\Source\Coupon\Format', [ 
	...
	public function testToOptionArray() {
		...
		$this->salesRuleCoupon->expects ( $this->once () )->method ( 'getFormatsList' )->will ( $this->returnValue ( [ 
				$formatTitle 
		] ) );

...
class CouponTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->resourceMock = $this->getMock ( 'Magento\SalesRule\Model\ResourceModel\Coupon', [ 
				'loadPrimaryByRule',
				'load',
				'__wakeup',
				'getIdFieldName' 
		...
		$this->couponModel = $objectManager->getObject ( 'Magento\SalesRule\Model\Coupon', [ 
	...
	public function testSetRule() {
		...
		$ruleMock = $this->getMock ( 'Magento\SalesRule\Model\Rule', [ 
				'getId',
				'__wakeup' 
		], [ ], '', false );

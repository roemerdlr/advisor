...
class DiscountsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->collectionFactory = $this->getMock ( 'Magento\SalesRule\Model\ResourceModel\Rule\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->objectManagerHelper = new ObjectManagerHelper ( $this );
		$this->discounts = $this->objectManagerHelper->getObject ( 'Magento\SalesRule\Model\Rss\Discounts', [ 
				'collectionFactory' => $this->collectionFactory 
		] );
	}
	public function testGetDiscountCollection() {
		$ruleCollection = $this->getMock ( 'Magento\SalesRule\Model\ResourceModel\Rule\Collection', [ 

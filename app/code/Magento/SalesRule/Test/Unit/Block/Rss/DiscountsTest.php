...
class DiscountsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->rssModel = $this->getMock ( 'Magento\SalesRule\Model\Rss\Discounts', [ 
				'__wakeup',
		...
		$this->block = $this->objectManagerHelper->getObject ( 'Magento\SalesRule\Block\Rss\Discounts', [ 
	...
	public function testGetRssData() {
		...
		$ruleModel = $this->getMock ( 'Magento\SalesRule\Model\Rule', [ 
				'__wakeup',
				'getCouponCode',
				'getToDate',
				'getFromDate',
		...
		$this->rssModel->expects ( $this->any () )->method ( 'getDiscountCollection' )->will ( $this->returnValue ( [ 
				$ruleModel 
		] ) );

...
class CatalogAttributeDeleteAfterObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helper->getObject ( 'Magento\SalesRule\Observer\CatalogAttributeDeleteAfterObserver', [ 
				'checkSalesRulesAvailability' => $this->checkSalesRulesAvailability 
		] );
	}
	protected function initMocks() {
		$this->checkSalesRulesAvailability = $this->getMock ( 'Magento\SalesRule\Observer\CheckSalesRulesAvailability', [ ], [ ], '', false );
	}

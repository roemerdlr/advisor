...
class Rule extends \Magento\Rule\Model\AbstractModel {
	...
	public function getCouponCodeGenerator() {
		if (! $this->_couponCodeGenerator) {
			return $this->_codegenFactory->create ( [ 
					'data' => [ 
							'length' => 16 
					] 
			] );
	...
	public function getCouponTypes() {
		if ($this->_couponTypes === null) {
			...
			$this->_eventManager->dispatch ( 'salesrule_rule_get_coupon_types', [ 
					'transport' => $transport 
			] );
	 ...
	 *
	 * @param bool $saveNewlyCreated
	 *        	Whether or not to save newly created coupon
	 * @param int $saveAttemptCount
	 *        	Number of attempts to save newly created coupon
	 * @return \Magento\SalesRule\Model\Coupon|null
	 * @throws \Exception|\Magento\Framework\Exception\LocalizedException @SuppressWarnings(PHPMD.CyclomaticComplexity)

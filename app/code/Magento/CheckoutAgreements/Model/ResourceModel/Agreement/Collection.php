...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection {
	...
	protected function _construct() {
		$this->_init ( 'Magento\CheckoutAgreements\Model\Agreement', 'Magento\CheckoutAgreements\Model\ResourceModel\Agreement' );
	}
	...
	public function addStoreFilter($store) {
		...
		], 'main_table.agreement_id = ' . $alias . '.agreement_id', [ ] )->where ( $alias . '.store_id IN (?)', $storeFilter )->group ( 'main_table.agreement_id' );

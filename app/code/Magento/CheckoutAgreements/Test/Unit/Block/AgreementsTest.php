...
class AgreementsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $objectManager->getObject ( 'Magento\CheckoutAgreements\Block\Agreements', [ 
	...
	public function testGetAgreements() {
		...
		$agreementCollection->expects ( $this->once () )->method ( 'addFieldToFilter' )->with ( 'is_active', 1 )->willReturnSelf ();

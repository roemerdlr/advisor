...
class AgreementsValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testIsValid($data, $result) {
		$this->object = $this->objectManagerHelper->getObject ( 'Magento\CheckoutAgreements\Model\AgreementsValidator', [ ] );
	...
	public function testNotIsValid($data, $result) {
		...
		$provider->expects ( $this->once () )->method ( 'getRequiredAgreementIds' )->will ( $this->returnValue ( [ 
				1,
				3,
				'4' 
		] ) );

...
class AgreementsConfigProviderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->agreementsRepositoryMock = $this->getMock ( '\Magento\CheckoutAgreements\Api\CheckoutAgreementsRepositoryInterface', [ ], [ ], '', false );
		$this->escaperMock = $this->getMock ( '\Magento\Framework\Escaper', [ ], [ ], '', false );
		
		$this->model = new \Magento\CheckoutAgreements\Model\AgreementsConfigProvider ( $this->scopeConfigMock, $this->agreementsRepositoryMock, $this->escaperMock );
	}
	public function testGetConfigIfContentIsHtml() {
		...
		$this->agreementsRepositoryMock->expects ( $this->any () )->method ( 'getList' )->willReturn ( [ 
				$agreement 
		] );

...
class Ga extends \Magento\Framework\View\Element\Template {
	 ...
	 * @param array $data        	
	 */
	public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Sales\Model\ResourceModel\Order\CollectionFactory $salesOrderCollection, \Magento\GoogleAnalytics\Helper\Data $googleAnalyticsData, array $data = []) {
	 ...
	 * The custom "page name" may be set from layout or somewhere else.
	 * It must start from slash.
	 *

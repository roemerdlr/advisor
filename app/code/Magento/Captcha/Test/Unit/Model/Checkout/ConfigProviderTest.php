...
class ConfigProviderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = new \Magento\Captcha\Model\Checkout\ConfigProvider ( $this->storeManagerMock, $this->captchaHelperMock, $formIds );
	}
	...
	public function testGetConfig($isRequired, $captchaGenerations, $expectedConfig) {
		...
		$this->storeMock->expects ( $this->once () )->method ( 'getUrl' )->with ( 'captcha/refresh', [ 
				'_secure' => true 

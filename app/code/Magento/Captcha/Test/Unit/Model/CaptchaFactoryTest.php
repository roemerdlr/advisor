...
class CaptchaFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCreateNegative() {
		...
		$this->setExpectedException ( 'InvalidArgumentException', 'Magento\Captcha\Model\\' . ucfirst ( $captchaType ) . ' does not implement \Magento\Captcha\Model\CaptchaInterface' );

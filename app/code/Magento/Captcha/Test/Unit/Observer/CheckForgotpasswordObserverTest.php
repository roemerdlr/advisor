...
class CheckForgotpasswordObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->checkForgotpasswordObserver = $this->_objectManager->getObject ( 'Magento\Captcha\Observer\CheckForgotpasswordObserver', [ 
				'helper' => $this->_helper,
	...
	public function testCheckForgotpasswordRedirects() {
		...
		$this->checkForgotpasswordObserver->execute ( new \Magento\Framework\Event\Observer ( [ 

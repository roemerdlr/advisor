...
class CheckUserCreateObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->checkUserCreateObserver = $this->_objectManager->getObject ( 'Magento\Captcha\Observer\CheckUserCreateObserver', [ 
				'helper' => $this->_helper,
	...
	public function testCheckUserCreateRedirectsError() {
		...
		$this->_urlManager->expects ( $this->once () )->method ( 'getUrl' )->with ( $redirectRoutePath, [ 
				'_nosecret' => true 
		...
		$this->checkUserCreateObserver->execute ( new \Magento\Framework\Event\Observer ( [ 

...
class CheckRegisterCheckoutObserver implements ObserverInterface {
	 ...
	 */
	public function __construct(\Magento\Captcha\Helper\Data $helper, \Magento\Framework\App\ActionFlag $actionFlag, CaptchaStringResolver $captchaStringResolver, \Magento\Checkout\Model\Type\Onepage $typeOnepage, \Magento\Framework\Json\Helper\Data $jsonHelper) {
		$this->_helper = $helper;

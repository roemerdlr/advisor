...
class ChangeTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->encryptMock = $this->getMockBuilder ( 'Magento\Framework\Encryption\EncryptorInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'setNewKey',
				'exportKeys' 
		...
		$this->model = $helper->getObject ( 'Magento\EncryptionKey\Model\ResourceModel\Key\Change', [ 

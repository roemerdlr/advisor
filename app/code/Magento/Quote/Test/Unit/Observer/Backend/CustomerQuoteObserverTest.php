...
class CustomerQuoteObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->customerQuote = $objectManager->getObject ( 'Magento\Quote\Observer\Backend\CustomerQuoteObserver', [ 
	...
	public function testDispatchNoCustomerGroupChange() {
		...
		$origCustomerDataObjectMock->expects ( $this->any () )->method ( 'getGroupId' )->will ( $this->returnValue ( 1 ) );
		...
		$this->quoteRepositoryMock->expects ( $this->once () )->method ( 'getForCustomer' )->willThrowException ( new \Magento\Framework\Exception\NoSuchEntityException () );

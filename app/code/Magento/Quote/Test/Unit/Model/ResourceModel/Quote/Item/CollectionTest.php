...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->collection = $objectManager->getObject ( 'Magento\Quote\Model\ResourceModel\Quote\Item\Collection', [ 
	...
	public function testInstanceOf() {
		$this->assertInstanceOf ( 'Magento\Framework\Model\ResourceModel\Db\VersionControl\Collection', $this->collection );
	}
}

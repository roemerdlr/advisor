...
class ItemTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->model = $objectManager->getObject ( 'Magento\Quote\Model\ResourceModel\Quote\Item', [ 
				'context' => $contextMock,
	...
	public function testSaveNotModifiedItem() {
		$this->entitySnapshotMock->expects ( $this->exactly ( 2 ) )->method ( 'isModified' )->with ( $this->quoteItemMock )->willReturn ( false );
		
		$this->quoteItemMock->expects ( $this->never () )->method ( 'isOptionsSaved' );
		$this->quoteItemMock->expects ( $this->never () )->method ( 'saveItemOptions' );
	...
	public function testSaveSavedBeforeItem() {
		...
		$this->quoteItemMock->expects ( $this->once () )->method ( 'isOptionsSaved' )->willReturn ( true );
		$this->quoteItemMock->expects ( $this->never () )->method ( 'saveItemOptions' );

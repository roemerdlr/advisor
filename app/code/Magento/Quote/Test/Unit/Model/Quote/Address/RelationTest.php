...
class RelationTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->modelMock = $this->getMock ( 'Magento\Framework\Model\AbstractModel', [ 
				'getItemsCollection',
	...
	public function testProcessRelation() {
		$itemsCollection = $this->getMock ( 'Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection', [ ], [ ], '', false );
		$shippingRatesCollection = $this->getMock ( 'Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection', [ ], [ ], '', false );
		...
		$this->modelMock->expects ( $this->once () )->method ( 'getShippingRatesCollection' )->willReturn ( $shippingRatesCollection );

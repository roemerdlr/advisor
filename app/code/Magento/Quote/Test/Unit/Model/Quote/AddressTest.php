...
class AddressTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->address = $objectManager->getObject ( 'Magento\Quote\Model\Quote\Address', [ 
	...
	public function testValidateMiniumumAmountDisabled() {
		...
		$this->scopeConfig->expects ( $this->once () )->method ( 'isSetFlag' )->with ( 'sales/minimum_order/active', ScopeInterface::SCOPE_STORE, $storeId )->willReturn ( false );
	...
	public function testValidateMiniumumAmountVirtual() {
		...
		$this->quote->expects ( $this->once () )->method ( 'getStoreId' )->willReturn ( $storeId );
		$this->quote->expects ( $this->once () )->method ( 'getIsVirtual' )->willReturn ( true );

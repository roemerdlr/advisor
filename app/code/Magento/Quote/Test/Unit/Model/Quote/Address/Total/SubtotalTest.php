...
class SubtotalTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->stockRegistry = $this->getMock ( 'Magento\CatalogInventory\Model\StockRegistry', [ 
				'getStockItem',
				'__wakeup' 
		], [ ], '', false );
	...
	public function testCollect($price, $originalPrice, $itemHasParent, $expectedPrice, $expectedOriginalPrice) {
		...
		$quoteItem = $this->objectManager->getObject ( 'Magento\Quote\Model\Quote\Item', [ 
		...
		$total = $this->getMock ( '\Magento\Quote\Model\Quote\Address\Total', [ 
				'setBaseVirtualAmount',
				'setVirtualAmount',
				'setTotalQty' 
		], [ ], '', false );

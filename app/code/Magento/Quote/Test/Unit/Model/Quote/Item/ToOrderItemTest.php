...
class ToOrderItemTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->orderItemFactoryMock = $this->getMock ( 'Magento\Sales\Api\Data\OrderItemInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		$this->objectCopyServiceMock = $this->getMock ( 'Magento\Framework\DataObject\Copy', [ ], [ ], '', false );
		$this->quoteItemMock = $this->getMock ( 'Magento\Quote\Model\Quote\Item', [ ], [ ], '', false );
		$this->productMock = $this->getMock ( 'Magento\Catalog\Model\Product', [ ], [ ], '', false );
		$this->productTypeMock = $this->getMock ( 'Magento\Catalog\Model\Product\Type\Simple', [ ], [ ], '', false );
		...
		$this->converter = new \Magento\Quote\Model\Quote\Item\ToOrderItem ( $this->orderItemFactoryMock, $this->objectCopyServiceMock, $dataObjectHelper );
	}
	...
	public function testConvert() {
		...
		$this->productTypeMock->expects ( $this->once () )->method ( 'getOrderOptions' )->with ( $this->productMock )->willReturn ( [ 
				'option' 
		] );

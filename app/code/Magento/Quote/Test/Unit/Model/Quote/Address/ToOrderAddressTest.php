...
class ToOrderAddressTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->orderAddressRepositoryMock = $this->getMock ( 'Magento\Sales\Model\Order\AddressRepository', [ 
				'create' 
		], [ ], '', false );
	...
	public function testConvert() {
		...
		$this->dataObjectHelper->expects ( $this->once () )->method ( 'populateWithArray' )->with ( $this->orderInterfaceMock, [ 
				'test' => 'beer' 
		], '\Magento\Sales\Api\Data\OrderAddressInterface' )->willReturnSelf ();

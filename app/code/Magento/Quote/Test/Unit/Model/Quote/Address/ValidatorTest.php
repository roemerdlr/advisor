...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->itemMock = $this->getMock ( '\Magento\Quote\Model\Quote\Address', [ 
				'getCountryId',
				'getEmail' 
		], [ ], '', false );
		$this->countryFactoryMock->expects ( $this->any () )->method ( 'create' )->will ( $this->returnValue ( $this->countryMock ) );
		$this->model = $objectManager->getObject ( 'Magento\Quote\Model\Quote\Address\Validator', [ 

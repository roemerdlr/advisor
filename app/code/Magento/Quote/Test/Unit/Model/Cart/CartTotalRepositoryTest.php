...
class CartTotalRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->totalsFactoryMock = $this->getMock ( 'Magento\Quote\Api\Data\TotalsInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->converterMock = $this->getMock ( 'Magento\Quote\Model\Cart\Totals\ItemConverter', [ ], [ ], '', false );
		...
		$this->model = new \Magento\Quote\Model\Cart\CartTotalRepository ( $this->totalsFactoryMock, $this->quoteRepositoryMock, $this->dataObjectHelperMock, $this->couponServiceMock, $this->totalsConverterMock, $this->converterMock );
	}

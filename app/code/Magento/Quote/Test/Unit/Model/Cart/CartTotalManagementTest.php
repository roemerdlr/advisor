...
class CartTotalManagementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $this->objectManager->getObject ( '\Magento\Quote\Model\Cart\CartTotalManagement', [ 
	...
	public function testCollectTotals() {
		...
		$this->shippingMock->expects ( $this->once () )->method ( 'set' )->with ( $cartId, $shippingCarrierCode, $shippingMethodCode );

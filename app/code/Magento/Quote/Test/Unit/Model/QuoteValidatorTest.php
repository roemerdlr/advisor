...
class QuoteValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCheckQuoteAmountExistingError() {
		$this->quoteMock->expects ( $this->once () )->method ( 'getHasError' )->will ( $this->returnValue ( true ) );
		
		$this->quoteMock->expects ( $this->never () )->method ( 'setHasError' );
		
		$this->quoteMock->expects ( $this->never () )->method ( 'addMessage' );
	...
	public function testValidateBeforeSubmitThrowsExceptionIfShippingAddressIsInvalid() {
		...
		$shippingAddressMock->expects ( $this->any () )->method ( 'validate' )->willReturn ( [ 
	...
	public function testValidateBeforeSubmitThrowsExceptionIfBillingAddressIsNotValid() {
		...
		$billingAddressMock->expects ( $this->any () )->method ( 'validate' )->willReturn ( [ 

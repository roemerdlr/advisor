...
class GuestCartManagementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->quoteManagementMock = $this->getMockForAbstractClass ( 'Magento\Quote\Api\CartManagementInterface', [ ], '', false, true, true, [ ] );
		$this->quoteIdMaskFactoryMock = $this->getMock ( 'Magento\Quote\Model\QuoteIdMaskFactory', [ 
				'create' 
		], [ ], '', false );
		$this->quoteIdMaskMock = $this->getMock ( 'Magento\Quote\Model\QuoteIdMask', [ 
				'getQuoteId',
				'getMaskedId',
				'load',
				'save',
		...
		$this->quoteMock = $this->getMockForAbstractClass ( 'Magento\Quote\Api\Data\CartInterface', [ ], '', false, true, true, [ 
				'setCheckoutMethod' 
		] );
		
		$this->guestCartManagement = $objectManager->getObject ( 'Magento\Quote\Model\GuestCart\GuestCartManagement', [ 

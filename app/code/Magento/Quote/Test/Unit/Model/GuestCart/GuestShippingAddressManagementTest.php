...
class GuestShippingAddressManagementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->shippingAddressManagementMock = $this->getMock ( 'Magento\Quote\Model\ShippingAddressManagementInterface', [ ], [ ], '', false );
		...
		$this->model = $objectManager->getObject ( 'Magento\Quote\Model\GuestCart\GuestShippingAddressManagement', [ 
	...
	public function testGet() {
		$this->shippingAddressManagementMock->expects ( $this->once () )->method ( 'get' )->willReturn ( $this->quoteAddressMock );

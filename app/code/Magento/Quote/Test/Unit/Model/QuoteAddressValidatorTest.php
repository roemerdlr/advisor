...
class QuoteAddressValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->model = $this->objectManager->getObject ( '\Magento\Quote\Model\QuoteAddressValidator', [ 
	...
	public function testValidateInvalidAddress() {
		...
		$this->addressRepositoryMock->expects ( $this->once () )->method ( 'getById' )->willThrowException ( new \Magento\Framework\Exception\NoSuchEntityException () );
	...
	public function testValidateWithAddressOfOtherCustomer() {
		...
		$this->customerRepositoryMock->expects ( $this->once () )->method ( 'getById' )->with ( $addressCustomer )->willReturn ( $customerMock );

...
class Item extends \Magento\Quote\Model\Quote\Item\AbstractItem implements \Magento\Quote\Api\Data\CartItemInterface {
	...
	public function setQty($qty) {
		...
		$this->_eventManager->dispatch ( 'sales_quote_item_qty_set_after', [ 
				'item' => $this 
		] );
	...
	public function setProduct($product) {
		...
		$this->_eventManager->dispatch ( 'sales_quote_item_set_product', [ 
				'product' => $product,
				'quote_item' => $this 
		] );
	...
	public function addOption($option) {
		...
		} elseif ($option instanceof \Magento\Framework\DataObject && ! $option instanceof \Magento\Quote\Model\Quote\Item\Option) {
	...
	protected function _addOptionCode($option) {
		if (! isset ( $this->_optionsByCode [$option->getCode ()] )) {
			...
			throw new \Magento\Framework\Exception\LocalizedException ( __ ( 'An item option with code %1 already exists.', $option->getCode () ) );
		}
		return $this;
	}

...
class Address extends \Magento\Customer\Model\Address\AbstractAddress implements \Magento\Quote\Api\Data\AddressInterface {
	 ...
	 *
	 * @return \Magento\Quote\Model\Quote\Address\Item[] @SuppressWarnings(PHPMD.CyclomaticComplexity)
	...
	public function getGroupedAllShippingRates() {
		...
		foreach ( $this->getShippingRatesCollection () as $rate ) {
			if (! $rate->isDeleted () && $this->_carrierFactory->get ( $rate->getCarrier () )) {
				...
				$rates [$rate->getCarrier ()] [0]->carrier_sort_order = $this->_carrierFactory->get ( $rate->getCarrier () )->getSortOrder ();
			}
		}
		uasort ( $rates, [ 
				$this,
	...
	public function getTotals() {
		$totalsData = array_merge ( $this->getData (), [ 
	...
	public function validateMinimumAmount() {
		...
		$validateEnabled = $this->_scopeConfig->isSetFlag ( 'sales/minimum_order/active', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId );
		if (! $validateEnabled) {
			return true;
		}

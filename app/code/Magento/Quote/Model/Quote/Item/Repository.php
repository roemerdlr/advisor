...
class Repository implements \Magento\Quote\Api\CartItemRepositoryInterface {
	 ...
	 */
	public function __construct(\Magento\Quote\Api\CartRepositoryInterface $quoteRepository, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository, \Magento\Quote\Api\Data\CartItemInterfaceFactory $itemDataFactory, array $cartItemProcessors = []) {
	 ...
	 */
	protected function getBuyRequest($productType, \Magento\Quote\Api\Data\CartItemInterface $cartItem) {
		$params = (isset ( $this->cartItemProcessors [$productType] )) ? $this->cartItemProcessors [$productType]->convertToBuyRequest ( $cartItem ) : null;
	 ...
	 * @return \Magento\Framework\DataObject|float
	 */
	protected function addCustomOptionsToBuyRequest(\Magento\Quote\Api\Data\CartItemInterface $cartItem, $params) {
	 ...
	 * @return \Magento\Quote\Api\Data\CartItemInterface
	 */
	protected function addProductOptions($productType, \Magento\Quote\Api\Data\CartItemInterface $cartItem) {
		$cartItem = (isset ( $this->cartItemProcessors [$productType] )) ? $this->cartItemProcessors [$productType]->processOptions ( $cartItem ) : $cartItem;
		return $cartItem;
	}

...
class Authorization {
	 ...
	 * @throws \Magento\Framework\Exception\NoSuchEntityException @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	public function afterGetActive(\Magento\Quote\Api\CartRepositoryInterface $subject, \Magento\Quote\Model\Quote $quote) {

...
class NewVideoTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 *
	 * @var \Magento\Framework\TestFramework\Unit\Helper\ObjectManager |\Magento\ProductVideo\Block\Adminhtml\Product\Edit\NewVideo
	 */
	protected $block;
	public function setUp() {
		...
		$this->block = $objectManager->getObject ( '\Magento\ProductVideo\Block\Adminhtml\Product\Edit\NewVideo', [ 

...
class RetrieveImageTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 *
	 * @var \Magento\ProductVideo\Controller\Adminhtml\Product\Gallery\RetrieveImage |\PHPUnit_Framework_MockObject_MockObject
	 */
	protected $image;
	...
	public function setUp() {
		...
		$this->rawFactoryMock = $this->getMock ( '\Magento\Framework\Controller\Result\RawFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->image = $objectManager->getObject ( '\Magento\ProductVideo\Controller\Adminhtml\Product\Gallery\RetrieveImage', [ 

...
class ChangeTemplateObserverTest extends \PHPUnit_Framework_TestCase {
	public function testChangeTemplate() {
		...
		/**
		 *
		 * @var \PHPUnit_Framework_MockObject_MockObject |\Magento\ProductVideo\Block\Adminhtml\Product\Edit\NewVideo $block
		 */
		$block = $this->getMock ( '\Magento\ProductVideo\Block\Adminhtml\Product\Edit\NewVideo', [ ], [ ], '', false );
		$block->expects ( $this->once () )->method ( 'setTemplate' )->with ( 'Magento_ProductVideo::helper/gallery.phtml' )->willReturnSelf ();

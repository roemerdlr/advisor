...
class ExternalVideoEntryProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 *
	 * @var \Magento\Framework\TestFramework\Unit\Helper\ObjectManager |\Magento\ProductVideo\Model\Product\Attribute\Media\ExternalVideoEntryProcessor
	 */
	protected $modelObject;
	public function setUp() {
		$this->productFactoryMock = $this->getMock ( '\Magento\Catalog\Model\ResourceModel\ProductFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->modelObject = $objectManager->getObject ( '\Magento\ProductVideo\Model\Plugin\ExternalVideoEntryProcessor', [ 

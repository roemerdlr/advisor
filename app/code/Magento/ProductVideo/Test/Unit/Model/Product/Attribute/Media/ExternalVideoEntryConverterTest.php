...
class ExternalVideoEntryConverterTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 *
	 * @var \PHPUnit_Framework_MockObject_MockObject |\Magento\Catalog\Api\Data\ProductAttributeMediaGalleryEntryInterface
	 */
	...
	/**
	 *
	 * @var \PHPUnit_Framework_MockObject_MockObject |\Magento\Catalog\Api\Data\ProductAttributeMediaGalleryEntryExtensionFactory
	 */
	...
	/**
	 *
	 * @var \Magento\Framework\TestFramework\Unit\Helper\ObjectManager |\Magento\ProductVideo\Model\Product\Attribute\Media\ExternalVideoEntryConverter
	 */
	protected $modelObject;
	public function setUp() {
		$this->mediaGalleryEntryFactoryMock = $this->getMock ( '\Magento\Catalog\Api\Data\ProductAttributeMediaGalleryEntryInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->mediaGalleryEntryMock = $this->getMock ( '\Magento\Catalog\Api\Data\ProductAttributeMediaGalleryEntryInterface', [ 
				'getId',
				'setId',
				'getMediaType',
				'setMediaType',
		...
		$this->videoEntryFactoryMock = $this->getMock ( '\Magento\Framework\Api\Data\VideoContentInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->mediaGalleryEntryExtensionFactoryMock = $this->getMock ( '\Magento\Catalog\Api\Data\ProductAttributeMediaGalleryEntryExtensionFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->mediaGalleryEntryExtensionMock = $this->getMock ( '\Magento\Catalog\Api\Data\ProductAttributeMediaGalleryEntryExtension', [ 
				'setVideoContent',
				'getVideoContent',
				'getVideoProvider' 
		], [ ], '', false );
		...
		$this->modelObject = $objectManager->getObject ( '\Magento\ProductVideo\Model\Product\Attribute\Media\ExternalVideoEntryConverter', [ 

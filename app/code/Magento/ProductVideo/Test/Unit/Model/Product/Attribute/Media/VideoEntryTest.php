...
class VideoEntryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->modelObject = $this->getMock ( '\Magento\ProductVideo\Model\Product\Attribute\Media\VideoEntry', [ 
				'getData',
				'setData' 
		], [ ], '', false );
	}
	...
	public function testGetVideoUrl() {
		$this->modelObject->expects ( $this->once () )->method ( 'getData' )->willReturn ( 'https://www.url.com/watch?v=aaaaaaaaa' );

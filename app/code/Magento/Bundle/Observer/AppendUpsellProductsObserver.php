...
class AppendUpsellProductsObserver implements ObserverInterface {
	 ...
	 */
	public function __construct(\Magento\Bundle\Helper\Data $bundleData, \Magento\Catalog\Model\Product\Visibility $productVisibility, \Magento\Catalog\Model\Config $config, \Magento\Bundle\Model\ResourceModel\Selection $bundleSelection) {
	...
	public function execute(\Magento\Framework\Event\Observer $observer) {
		...
		$bundleCollection->addFieldToFilter ( 'entity_id', [ 
				'in' => $bundleIds 

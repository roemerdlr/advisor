...
class Extend extends \Magento\Catalog\Block\Adminhtml\Form\Renderer\Fieldset\Element {
	...
	public function isDisabledField() {
		return $this->_getData ( 'is_disabled_field' ) || ($this->getProduct ()->getId () && $this->getAttribute ()->getAttributeCode () === 'price') || $this->getElement ()->getReadonly ();
	}
	...
	public function getExtendedElement($switchAttributeCode) {
		...
		return $form->addField ( $switchAttributeCode, 'select', [ 

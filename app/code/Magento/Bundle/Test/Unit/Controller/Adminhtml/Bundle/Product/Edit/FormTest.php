...
class FormTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->productBuilder = $this->getMockBuilder ( '\Magento\Catalog\Controller\Adminhtml\Product\Builder' )->disableOriginalConstructor ()->setMethods ( [ 
				'build' 
		] )->getMock ();
		$this->initializationHelper = $this->getMockBuilder ( '\Magento\Catalog\Controller\Adminhtml\Product\Initialization\Helper' )->disableOriginalConstructor ()->setMethods ( [ 
				'initialize' 
		] )->getMock ();
		...
		$this->controller = $this->objectManagerHelper->getObject ( '\Magento\Bundle\Controller\Adminhtml\Bundle\Product\Edit\Form', [ 
	...
	public function testExecute() {
		...
		$block = $this->getMockBuilder ( 'Magento\Bundle\Block\Adminhtml\Catalog\Product\Edit\Tab\Bundle' )->disableOriginalConstructor ()->setMethods ( [ 
				'setIndex',
				'toHtml' 
		] )->getMock ();

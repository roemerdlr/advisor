...
class GridTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->controller = $this->objectManagerHelper->getObject ( '\Magento\Bundle\Controller\Adminhtml\Bundle\Selection\Grid', [ 
				'context' => $this->context 
		] );
	}
	public function testExecute() {
		$layout = $this->getMock ( '\Magento\Framework\View\LayoutInterface' );
		$block = $this->getMockBuilder ( 'Magento\Bundle\Block\Adminhtml\Catalog\Product\Edit\Tab\Bundle\Option\Search\Grid' )->disableOriginalConstructor ()->setMethods ( [ 
				'setIndex',
				'toHtml' 
		] )->getMock ();

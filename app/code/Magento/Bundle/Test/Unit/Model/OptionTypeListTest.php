...
class OptionTypeListTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->typeFactoryMock = $this->getMock ( '\Magento\Bundle\Api\Data\OptionTypeInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		$this->model = new \Magento\Bundle\Model\OptionTypeList ( $this->typeMock, $this->typeFactoryMock );
	}
	public function testGetItems() {
		$this->typeMock->expects ( $this->once () )->method ( 'toOptionArray' )->willReturn ( [ 
				[ 
						'value' => 'value',
						'label' => 'label' 
				] 

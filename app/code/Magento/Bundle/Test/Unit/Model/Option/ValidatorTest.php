...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$validate = $helper->getObject ( 'Magento\Framework\Validator\NotEmpty', [ 
				'options' => NotEmpty::ALL 
		] );
		
		$validateFactory = $this->getMockBuilder ( 'Magento\Framework\Validator\NotEmptyFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		$validateFactory->expects ( $this->once () )->method ( 'create' )->willReturn ( $validate );

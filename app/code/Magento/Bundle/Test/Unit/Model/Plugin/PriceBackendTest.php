...
class PriceBackendTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->priceAttributeMock = $this->getMockBuilder ( 'Magento\Catalog\Model\Product\Attribute\Backend\Price' )->disableOriginalConstructor ()->getMock ();
	...
	public function aroundValidateDataProvider() {
		return [ 
				[ 
						...
						'priceType' => Price::PRICE_TYPE_FIXED,
						'result' => static::CLOSURE_VALUE 
				],
				[ 
						'type' => Type::TYPE_SIMPLE,
						'priceType' => Price::PRICE_TYPE_DYNAMIC,
						'result' => static::CLOSURE_VALUE 
				],
				[ 

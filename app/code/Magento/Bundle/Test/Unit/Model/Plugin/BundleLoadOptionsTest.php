...
class BundleLoadOptionsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = new \Magento\Bundle\Model\Plugin\BundleLoadOptions ( $this->optionListMock, $this->productExtensionFactory );
	}
	...
	public function testAroundLoad() {
		...
		$productExtensionMock->expects ( $this->once () )->method ( 'setBundleProductOptions' )->with ( [ 
				$optionMock 
		] )->willReturnSelf ();

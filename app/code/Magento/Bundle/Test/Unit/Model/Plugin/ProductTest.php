...
class ProductTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->type = $this->getMockBuilder ( '\Magento\Bundle\Model\Product\Type' )->disableOriginalConstructor ()->setMethods ( [ 
				'getParentIdsByChild' 
		] )->getMock ();
		
		$this->plugin = $objectManager->getObject ( 'Magento\Bundle\Model\Plugin\Product', [ 
				'type' => $this->type 
		] );
	}

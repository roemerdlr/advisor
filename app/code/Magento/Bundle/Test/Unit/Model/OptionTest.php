...
class OptionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->selectionFirst = $this->getMock ( 'Magento\Catalog\Model\Product', [ 
				'__wakeup',
				'isSaleable',
				'getIsDefault',
				'getSelectionId' 
		], [ ], '', false );
		$this->selectionSecond = $this->getMock ( 'Magento\Catalog\Model\Product', [ 
				'__wakeup',
				'isSaleable',
				'getIsDefault',
				'getSelectionId' 
	...
	public function testIsSaleablePositive() {
		...
		$this->model->setSelections ( [ 
				$this->selectionFirst,
				$this->selectionSecond 
		] );

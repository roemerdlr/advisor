...
class ViewTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->optionFactory = $this->getMock ( 'Magento\Eav\Model\ResourceModel\Entity\Attribute\OptionFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->model = (new ObjectManager ( $this ))->getObject ( 'Magento\Bundle\Model\Product\Attribute\Source\Price\View', [ 

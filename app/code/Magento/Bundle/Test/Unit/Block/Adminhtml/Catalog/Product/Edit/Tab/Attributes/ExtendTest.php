...
class ExtendTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->object = $this->objectManagerHelper->getObject ( 'Magento\\Bundle\\Block\\Adminhtml\\Catalog\\Product\\Edit\\Tab\\Attributes\\Extend', [ 
	...
	public function getProduct() {
		...
		$this->registry->expects ( $this->once () )->method ( 'registry' )->with ( 'product' )->will ( $this->returnValue ( $product ) );
		return $product;
	}

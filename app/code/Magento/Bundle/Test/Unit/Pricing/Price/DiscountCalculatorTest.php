...
class DiscountCalculatorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function getPriceMock($value) {
		...
		$price->expects ( $this->exactly ( 3 ) )->method ( 'getDiscountPercent' )->will ( $this->returnValue ( $value ) );
		return $price;
	}
	...
	public function testCalculateDiscountWithDefaultAmount() {
		...
		$this->priceInfoMock->expects ( $this->once () )->method ( 'getPrices' )->will ( $this->returnValue ( [ 

...
class CartItemProcessor implements CartItemProcessorInterface {
	 ...
	 */
	public function __construct(\Magento\Framework\DataObject\Factory $objectFactory, QuoteApi\ProductOptionExtensionFactory $productOptionExtensionFactory, BundleOptionInterfaceFactory $bundleOptionFactory, QuoteApi\ProductOptionInterfaceFactory $productOptionFactory) {
	...
	public function processOptions(CartItemInterface $cartItem) {
		...
		foreach ( $bundleOptions as $optionId => $optionSelections ) {
			...
			$optionSelections = is_array ( $optionSelections ) ? $optionSelections : [ 
					$optionSelections 
			];

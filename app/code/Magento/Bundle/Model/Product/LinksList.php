...
class LinksList {
	 ...
	 */
	public function __construct(\Magento\Bundle\Api\Data\LinkInterfaceFactory $linkFactory, \Magento\Bundle\Model\Product\Type $type, \Magento\Framework\Api\DataObjectHelper $dataObjectHelper) {
	...
	public function getItems(\Magento\Catalog\Api\Data\ProductInterface $product, $optionId) {
		$selectionCollection = $this->type->getSelectionsCollection ( [ 
				$optionId 
		], $product );

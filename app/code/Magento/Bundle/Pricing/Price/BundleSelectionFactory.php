...
class BundleSelectionFactory {
	 ...
	 */
	public function create(Product $bundleProduct, Product $selection, $quantity, array $arguments = []) {
		...
		if (! $selectionPrice instanceof BundleSelectionPrice) {
			throw new \InvalidArgumentException ( get_class ( $selectionPrice ) . ' doesn\'t extend BundleSelectionPrice' );
		}

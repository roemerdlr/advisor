...
class Calculator implements BundleCalculatorInterface {
	 ...
	 */
	public function __construct(CalculatorBase $calculator, AmountFactory $amountFactory, BundleSelectionFactory $bundleSelectionFactory, TaxHelper $taxHelper, PriceCurrencyInterface $priceCurrency) {
	 ...
	 * @return \Magento\Framework\Pricing\Amount\AmountInterface @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	 ...
	 * @return \Magento\Framework\Pricing\Amount\AmountInterface
	 */
	public function getOptionsAmount(Product $saleableItem, $exclude = null, $searchMin = true, $baseAmount = 0., $useRegularPrice = false) {
		return $this->calculateBundleAmount ( $baseAmount, $saleableItem, $this->getSelectionAmounts ( $saleableItem, $searchMin, $useRegularPrice ), $exclude );
	}
	...
	public function getAmountWithoutOption($amount, Product $saleableItem) {
		return $this->calculateBundleAmount ( $amount, $saleableItem, [ ] );
	}
	...
	protected function getSelectionAmounts(Product $bundleProduct, $searchMin, $useRegularPrice = false) {
		...
		if ($searchMin && $bundleProduct->getPriceType () == Price::PRICE_TYPE_DYNAMIC && ! $this->hasRequiredOption ( $bundleProduct )) {
	...
	protected function hasRequiredOption($bundleProduct) {
		$options = array_filter ( $this->getBundleOptions ( $bundleProduct ), function ($item) {
	 ...
	 * @param \Magento\Bundle\Pricing\Price\BundleSelectionPrice[] $selectionPriceList        	
	 * @param null|bool|string|array $exclude        	
	 * @return \Magento\Framework\Pricing\Amount\AmountInterface @SuppressWarnings(PHPMD.CyclomaticComplexity)
	 */
	 ...
	 * @param \Magento\Bundle\Pricing\Price\BundleSelectionPrice[] $selectionPriceList        	
	 * @param bool $searchMin        	
	 * @return \Magento\Bundle\Pricing\Price\BundleSelectionPrice[] @SuppressWarnings(PHPMD.CyclomaticComplexity)
	 */

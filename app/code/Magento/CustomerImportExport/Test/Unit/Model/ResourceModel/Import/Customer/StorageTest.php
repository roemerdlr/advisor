...
class StorageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function _getModelDependencies() {
		$select = $this->getMockBuilder ( 'Magento\Framework\DB\Select' )->disableOriginalConstructor ()->setMethods ( [ 
				'from' 
		] )->getMock ();
		$select->expects ( $this->any () )->method ( 'from' )->will ( $this->returnCallback ( [ 
				$this,
				'validateFrom' 
		] ) );
		$customerCollection = $this->getMockBuilder ( 'Magento\Customer\Model\ResourceModel\Customer\Collection' )->disableOriginalConstructor ()->setMethods ( [ 
				'load',

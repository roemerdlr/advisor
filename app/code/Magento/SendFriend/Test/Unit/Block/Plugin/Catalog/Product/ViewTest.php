...
class ViewTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->sendfriendModel = $this->getMock ( 'Magento\SendFriend\Model\SendFriend', [ 
				'__wakeup',
				'canEmailToFriend' 
		], [ ], '', false );
		...
		$this->view = $this->objectManagerHelper->getObject ( 'Magento\SendFriend\Block\Plugin\Catalog\Product\View', [ 

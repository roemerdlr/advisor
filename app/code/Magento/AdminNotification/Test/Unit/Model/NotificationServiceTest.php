...
class NotificationServiceTest extends \PHPUnit_Framework_TestCase {
	...
	protected function _getServiceInstanceForMarkAsReadTest($notificationId) {
		/**
		 *
		 * @var $notificationFactory \PHPUnit_Framework_MockObject_MockObject|\Magento\AdminNotification\Model\InboxFactory
		 */
		$notificationFactory = $this->getMock ( 'Magento\AdminNotification\Model\InboxFactory', [ 
				'create' 
		], [ ], '', false );
		$notification = $this->getMock ( 'Magento\AdminNotification\Model\Inbox', [ 
				'load',
				'getId',
				'save',
				'setIsRead',

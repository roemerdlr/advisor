...
class SecurityTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_curlFactoryMock = $this->getMock ( 'Magento\Framework\HTTP\Adapter\CurlFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->_messageModel = $objectManagerHelper->getObject ( 'Magento\AdminNotification\Model\System\Message\Security', $arguments );
	}
	 ...
	 * @param
	 *        	$response
	 * @return void @dataProvider isDisplayedDataProvider
	 */

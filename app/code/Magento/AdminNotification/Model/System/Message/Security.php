...
class Security implements \Magento\Framework\Notification\MessageInterface {
	 ...
	 */
	public function __construct(\Magento\Framework\App\CacheInterface $cache, \Magento\Backend\App\ConfigInterface $backendConfig, \Magento\Framework\App\Config\ScopeConfigInterface $config, \Magento\Framework\HTTP\Adapter\CurlFactory $curlFactory) {
		$this->_cache = $cache;

...
class ToolbarEntry extends \Magento\Backend\Block\Template {
	...
	public function formatNotificationDate($dateString) {
		...
		if ($date == new \DateTime ( 'today' )) {
			return $this->_localeDate->formatDateTime ( $date, \IntlDateFormatter::NONE, \IntlDateFormatter::SHORT );
		}
		return $this->_localeDate->formatDateTime ( $date, \IntlDateFormatter::MEDIUM, \IntlDateFormatter::MEDIUM );
	}
}

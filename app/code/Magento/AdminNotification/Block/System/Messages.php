...
class Messages extends \Magento\Backend\Block\Template {
	...
	public function getLastCritical() {
		...
		if (isset ( $items [0] ) && $items [0]->getSeverity () == \Magento\Framework\Notification\MessageInterface::SEVERITY_CRITICAL) {
			return $items [0];
		}
		return null;
	}
	...
	public function getCriticalCount() {
		return $this->_messages->getCountBySeverity ( \Magento\Framework\Notification\MessageInterface::SEVERITY_CRITICAL );
	}

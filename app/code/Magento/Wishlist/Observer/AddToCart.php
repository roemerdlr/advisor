...
class AddToCart implements ObserverInterface {
	 ...
	 */
	public function __construct(CheckoutSession $checkoutSession, CustomerSession $customerSession, WishlistFactory $wishlistFactory, ManagerInterface $messageManager) {

...
class LocaleQuantityProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->filter = $this->getMockBuilder ( 'Magento\Framework\Filter\LocalizedToNormalized' )->disableOriginalConstructor ()->getMock ();
	...
	public function testProcess($qtyResult, $expectedResult) {
		...
		$this->filter->expects ( $this->once () )->method ( 'setOptions' )->with ( [ 
				'locale' => $localCode 
		] )->willReturnSelf ();

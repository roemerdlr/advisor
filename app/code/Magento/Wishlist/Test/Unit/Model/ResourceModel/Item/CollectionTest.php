...
class CollectionTest extends \PHPUnit_Framework_TestCase {
 ...
 WHERE (INSTR(product_name_table.value, 'TestProductName'))";
	...
	public function setUp() {
		...
		$resource = $this->getMock ( 'Magento\Wishlist\Model\ResourceModel\Item', [ 
				'getConnection',
				'getMainTable',
				'getTableName',
				'getTable' 
		...
		$catalogConfFactory = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\ConfigFactory', [ 
				'create' 
		], [ ], '', false );
		
		$catalogConf = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Config', [ 
				'getEntityTypeId' 
		], [ ], '', false );
		...
		$attribute = $this->getMock ( 'Magento\Catalog\Model\Entity\Attribute', [ 
				'loadByCode',
				'getBackendTable',
				'getId' 
		], [ ], '', false );
		...
		$catalogAttrFactory = $this->getMock ( 'Magento\Catalog\Model\Entity\AttributeFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->collection = $this->objectManager->getObject ( 'Magento\Wishlist\Model\ResourceModel\Item\Collection', [ 
				'resource' => $resource,

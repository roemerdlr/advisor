...
class MoveToWishlistTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $objectManagerHelper->getObject ( 'Magento\Wishlist\Block\Cart\Item\Renderer\Actions\MoveToWishlist', [ 
				'wishlistHelper' => $this->wishlistHelperMock 
		] );
	}
	public function testIsAllowInCart() {
		$this->wishlistHelperMock->expects ( $this->once () )->method ( 'isAllowInCart' )->willReturn ( true );

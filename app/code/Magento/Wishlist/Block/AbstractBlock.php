...
abstract class AbstractBlock extends \Magento\Catalog\Block\Product\AbstractProduct {
	 ...
	 * @return \Magento\Wishlist\Block\Customer\Wishlist @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	 ...
	 * @return string|null
	 */
	public function getItemPriceHtml(\Magento\Catalog\Model\Product\Configuration\Item\ItemInterface $item, $priceType = \Magento\Catalog\Pricing\Price\ConfiguredPriceInterface::CONFIGURED_PRICE_CODE, $renderZone = \Magento\Framework\Pricing\Render::ZONE_ITEM_LIST, array $arguments = []) {

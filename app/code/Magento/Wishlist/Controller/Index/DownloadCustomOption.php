...
class DownloadCustomOption extends \Magento\Wishlist\Controller\AbstractIndex {
	 ...
	 *
	 * @return \Magento\Framework\Controller\Result\Forward @SuppressWarnings(PHPMD.CyclomaticComplexity)
	...
	public function execute() {
		...
		try {
			...
			if ($secretKey == $info ['secret_key']) {
				$this->_fileResponseFactory->create ( $info ['title'], [ 
						'value' => $info ['quote_path'],
						'type' => 'filename' 
				], DirectoryList::ROOT );
			}
		} catch ( \Exception $e ) {

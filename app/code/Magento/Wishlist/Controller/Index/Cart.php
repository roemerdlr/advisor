...
class Cart extends \Magento\Wishlist\Controller\AbstractIndex {
	...
	public function execute() {
		...
		$configureUrl = $this->_url->getUrl ( '*/*/configure/', [ 
				'id' => $item->getId (),
		...
		try {
			...
			$options = $this->optionFactory->create ()->getCollection ()->addItemFilter ( [ 
					$itemId 
			] );
			$item->setOptions ( $options->getOptionsByItem ( $itemId ) );
			
			$buyRequest = $this->productHelper->addParamsToBuyRequest ( $this->getRequest ()->getParams (), [ 

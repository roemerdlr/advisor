...
class Wishlist extends \Magento\Framework\Model\AbstractModel implements \Magento\Framework\DataObject\IdentityInterface {
	 ...
	 */
	public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Catalog\Helper\Product $catalogProduct, \Magento\Wishlist\Helper\Data $wishlistData, ResourceWishlist $resource, Collection $resourceCollection, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Framework\Stdlib\DateTime\DateTime $date, ItemFactory $wishlistItemFactory, CollectionFactory $wishlistCollectionFactory, \Magento\Catalog\Model\ProductFactory $productFactory, \Magento\Framework\Math\Random $mathRandom, \Magento\Framework\Stdlib\DateTime $dateTime, ProductRepositoryInterface $productRepository, $useCurrentWebsite = true, array $data = []) {
	 ...
	 * @param bool $create
	 *        	Create wishlist if don't exists
	 * @return $this
	 */
	...
	public function addItem(Item $item) {
		...
		if (! $item->getId ()) {
			$this->getItemCollection ()->addItem ( $item );
			$this->_eventManager->dispatch ( 'wishlist_add_item', [ 
					'item' => $item 
			] );
		}
		return $this;
	 ...
	 * @return Item|string @SuppressWarnings(PHPMD.CyclomaticComplexity)
	...
	public function addNewItem($product, $buyRequest = null, $forciblySetQty = false) {
		...
		$this->_eventManager->dispatch ( 'wishlist_product_add_after', [ 
				'items' => $items 
		] );

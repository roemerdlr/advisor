...
class Grid extends \Magento\Wishlist\Model\ResourceModel\Item\Collection {
	...
	protected function _initSelect() {
		parent::_initSelect ();
		$this->addCustomerIdFilter ( $this->_registryManager->registry ( RegistryConstants::CURRENT_CUSTOMER_ID ) )->resetSortOrder ()->addDaysInWishlist ()->addStoreData ();
		return $this;
	}

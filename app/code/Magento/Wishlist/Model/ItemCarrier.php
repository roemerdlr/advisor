...
class ItemCarrier {
	 ...
	 */
	public function __construct(Session $customerSession, LocaleQuantityProcessor $quantityProcessor, Cart $cart, Logger $logger, WishlistHelper $helper, CartHelper $cartHelper, UrlInterface $urlBuilder, MessageManager $messageManager, RedirectInterface $redirector) {
	...
	public function moveAllToCart(Wishlist $wishlist, $qtys) {
		...
		if ($isOwner) {
			...
			$indexUrl = $this->urlBuilder->getUrl ( 'wishlist/shared', [ 

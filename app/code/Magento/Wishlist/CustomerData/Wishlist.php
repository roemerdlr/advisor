...
class Wishlist implements SectionSourceInterface {
	 ...
	 */
	public function __construct(\Magento\Wishlist\Helper\Data $wishlistHelper, \Magento\Wishlist\Block\Customer\Sidebar $block, \Magento\Catalog\Helper\ImageFactory $imageHelperFactory, \Magento\Framework\App\ViewInterface $view) {
	...
	protected function getItemData(\Magento\Wishlist\Model\Item $wishlistItem) {
		...
		return [ 
				...
				'product_price' => $this->block->getProductPriceHtml ( $product, \Magento\Catalog\Pricing\Price\ConfiguredPriceInterface::CONFIGURED_PRICE_CODE, \Magento\Framework\Pricing\Render::ZONE_ITEM_LIST, [ 
						'item' => $wishlistItem 
				] ),
	 ...
	 * @return \Magento\Catalog\Block\Product\Image @SuppressWarnings(PHPMD.NPathComplexity)
	 */

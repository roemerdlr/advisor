...
class LinkTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->link = $this->objectManagerHelper->getObject ( 'Magento\Catalog\Block\Category\Rss\Link', [ 
	...
	public function testIsTopCategory($isTop, $categoryLevel) {
		$categoryModel = $this->getMock ( '\Magento\Catalog\Model\Category', [ 
				'__wakeup',
				'getLevel' 
		], [ ], '', false );
	...
	public function testGetLink() {
		...
		$storeModel = $this->getMock ( '\Magento\Store\Model\Category', [ 
				'__wakeup',
				'getId' 
		], [ ], '', false );

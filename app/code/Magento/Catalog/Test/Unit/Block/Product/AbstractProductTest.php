...
class AbstractProductTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->productContextMock = $this->getMock ( 'Magento\Catalog\Block\Product\Context', [ 
				'getLayout',
				'getStockRegistry',
				'getImageBuilder' 
		], [ ], '', false );
		...
		$this->stockRegistryMock = $this->getMockForAbstractClass ( 'Magento\CatalogInventory\Api\StockRegistryInterface', [ ], '', false, true, true, [ 
				'getStockItem' 
		] );
		...
		$this->productContextMock->expects ( $this->once () )->method ( 'getImageBuilder' )->will ( $this->returnValue ( $this->imageBuilder ) );
	...
	public function testGetProductPrice() {
		...
		$priceRenderBlock = $this->getMock ( 'Magento\Framework\Pricing\Render', [ 
				'render' 
		], [ ], '', false );
	 ...
	 * @return void @dataProvider dataProviderGetMinimalQty
	 */
	public function testGetMinimalQty($minSale, $result) {
		...
		$stockItemMock = $this->getMockForAbstractClass ( 'Magento\CatalogInventory\Api\Data\StockItemInterface', [ ], '', false, true, true, [ 
				'getMinSaleQty' 
		] );

...
class OptionsTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetOptionHtml() {
		...
		$optValFactoryMock = $this->getMock ( 'Magento\Catalog\Model\Product\Option\ValueFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->_optionsBlock = $this->_objectHelper->getObject ( 'Magento\Catalog\Block\Product\View\Options', [ 
				'context' => $context,
				'option' => $option 
		] );
		...
		$option->setType ( 'date' );
		$dateBlock->expects ( $this->any () )->method ( 'setOption' )->with ( $this->equalTo ( $option ) )->will ( $this->returnValue ( $dateBlock ) );

...
class ListTest extends \PHPUnit_Framework_TestCase {
	public function testGetMode() {
		...
		$block = $this->getMock ( 'Magento\Catalog\Block\Product\ListProduct', [ 
				'getChildBlock' 
		], [ ], '', false );
		$block->expects ( $this->atLeastOnce () )->method ( 'getChildBlock' )->with ( 'toolbar' )->will ( $this->returnValue ( $childBlock ) );

...
class NotifyStockTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->rssModel = $this->getMockBuilder ( 'Magento\Catalog\Model\Rss\Product\NotifyStock' )->setMethods ( [ 
		...
		$this->block = $this->objectManagerHelper->getObject ( 'Magento\Catalog\Block\Adminhtml\Rss\NotifyStock', [ 
	...
	public function testGetRssData() {
		...
		$this->urlBuilder->expects ( $this->once () )->method ( 'getUrl' )->with ( 'catalog/product/edit', [ 
				'id' => 1,
				'_secure' => true,
				'_nosecret' => true 

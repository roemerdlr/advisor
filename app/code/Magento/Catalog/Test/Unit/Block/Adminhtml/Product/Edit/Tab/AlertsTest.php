...
class AlertsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->alerts = $helper->getObject ( 'Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Alerts', [ 
	...
	public function canShowTabDataProvider() {
		return [ 
				'alert_price_and_stock_allow' => [ 
						true,
						true,
						true 
				],
				'alert_price_is_allowed_and_stock_is_unallowed' => [ 
						true,
						false,
						true 
				],
				'alert_price_is_unallowed_and_stock_is_allowed' => [ 
						false,
						true,
						true 
				],
				'alert_price_is_unallowed_and_stock_is_unallowed' => [ 
						false,
						false,
						false 
				] 

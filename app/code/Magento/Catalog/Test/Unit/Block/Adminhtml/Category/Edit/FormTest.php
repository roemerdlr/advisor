...
class FormTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->categoryTreeMock = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Category\Tree', [ ], [ ], '', false );
		...
		$this->urlBuilderMock = $this->getMockBuilder ( 'Magento\Framework\UrlInterface' )->disableOriginalConstructor ()->getMockForAbstractClass ();
		...
		$this->form = $this->objectManager->getObject ( 'Magento\Catalog\Block\Adminhtml\Category\Edit\Form', [ 
	...
	public function testGetDeleteUrl() {
		...
		$this->urlBuilderMock->expects ( $this->once () )->method ( 'getUrl' )->with ( 'catalog/*/delete', [ 
				'_current' => true,
				'_query' => [ 
						'isAjax' => null 
				],
	...
	public function testGetRefreshPathUrl() {
		...
		$this->urlBuilderMock->expects ( $this->once () )->method ( 'getUrl' )->with ( 'catalog/*/refreshPath', [ 
				'_current' => true,
				'_query' => [ 
						'isAjax' => null 
				],

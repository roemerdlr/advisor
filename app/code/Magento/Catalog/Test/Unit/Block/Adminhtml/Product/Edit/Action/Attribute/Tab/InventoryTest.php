...
class InventoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->inventory = $objectManager->getObject ( 'Magento\Catalog\Block\Adminhtml\Product\Edit\Action\Attribute\Tab\Inventory', [ 
	...
	public function testGetStoreId() {
		$this->requestMock->expects ( $this->once () )->method ( 'getParam' )->with ( 'store' )->will ( $this->returnValue ( '125' ) );
	...
	public function testGetDefaultConfigValue() {
		$this->stockConfigurationMock->expects ( $this->once () )->method ( 'getDefaultConfigValue' )->with ( 'field-name' )->will ( $this->returnValue ( 'return-value' ) );

...
class OptionsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_optionResource = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Product\Option', [ ], [ ], '', false );
	}
	public function testGetOptionHtml() {
		...
		$context = $this->_objectHelper->getObject ( 'Magento\Framework\View\Element\Template\Context', [ 
				'layout' => $layout 
		] );
		$optionFactoryMock = $this->getMock ( 'Magento\Catalog\Model\Product\Option\ValueFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$dateBlock = $this->getMock ( 'Magento\Catalog\Block\Adminhtml\Product\Composite\Fieldset\Options', [ 
		...
		$this->_optionsBlock = $this->_objectHelper->getObject ( 'Magento\Catalog\Block\Adminhtml\Product\Composite\Fieldset\Options', [ 
				'context' => $context,
				'option' => $option 
		] );
		...
		$stockItemFactoryMock = $this->getMock ( 'Magento\CatalogInventory\Api\Data\StockItemInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->_optionsBlock->setProduct ( $this->_objectHelper->getObject ( 'Magento\Catalog\Model\Product', [ 
				'collectionFactory' => $this->getMock ( 'Magento\Framework\Data\CollectionFactory', [ ], [ ], '', false ),

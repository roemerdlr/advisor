...
class AdvancedTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->block = $objectManager->getObject ( 'Magento\Catalog\Block\Adminhtml\Product\Attribute\Edit\Tab\Advanced', [ 
	...
	public function testToHtml() {
		...
		$formElement = $this->getMock ( 'Magento\Framework\Data\Form\Element\Text', [ 
				'setDisabled' 
		], [ ], '', false );
		...
		$this->yesNo->expects ( $this->any () )->method ( 'toOptionArray' )->willReturn ( [ 
				'yes',
				'no' 
		] );

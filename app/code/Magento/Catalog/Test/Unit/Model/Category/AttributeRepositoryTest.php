...
class AttributeRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = (new ObjectManager ( $this ))->getObject ( 'Magento\Catalog\Model\Category\AttributeRepository', [ 
	...
	public function testGet() {
		...
		$dataInterfaceMock = $this->getMock ( 'Magento\Catalog\Api\Data\CategoryAttributeInterface', [ ], [ ], '', false );
		$this->attributeRepositoryMock->expects ( $this->once () )->method ( 'get' )->with ( \Magento\Catalog\Api\Data\CategoryAttributeInterface::ENTITY_TYPE_CODE, $attributeCode )->willReturn ( $dataInterfaceMock );
	...
	public function testGetCustomAttributesMetadata() {
		...
		$this->searchBuilderMock->expects ( $this->once () )->method ( 'addFilters' )->with ( [ 
				$filterMock 
		] )->willReturnSelf ();
		$searchCriteriaMock = $this->getMock ( 'Magento\Framework\Api\SearchCriteria', [ ], [ ], '', false );

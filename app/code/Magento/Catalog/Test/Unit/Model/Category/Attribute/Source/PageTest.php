...
class PageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helper->getObject ( '\Magento\Catalog\Model\Category\Attribute\Source\Page', [ 
	...
	private function getMockedCollection() {
		...
		$mock = $mockBuilder->disableOriginalConstructor ()->getMock ();
		
		$mock->expects ( $this->any () )->method ( 'load' )->will ( $this->returnValue ( $mock ) );
		
		$mock->expects ( $this->any () )->method ( 'toOptionArray' )->will ( $this->returnValue ( $this->testArray ) );

...
class SortbyTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helper->getObject ( '\Magento\Catalog\Model\Category\Attribute\Source\Sortby', [ 
	...
	private function getMockedConfig() {
		...
		$mock->expects ( $this->any () )->method ( 'getAttributesUsedForSortBy' )->will ( $this->returnValue ( [ 
				[ 
						'frontend_label' => 'fl',
						'attribute_code' => 'fc' 
				] 

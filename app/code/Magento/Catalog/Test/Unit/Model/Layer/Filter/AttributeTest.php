...
class AttributeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->filterAttribute = $this->getMockBuilder ( '\Magento\Catalog\Model\ResourceModel\Layer\Filter\Attribute' )->disableOriginalConstructor ()->setMethods ( [ 
				'getCount',
		...
		$string = $this->getMockBuilder ( '\Magento\Framework\Stdlib\StringUtils' )->disableOriginalConstructor ()->setMethods ( [ 
				'strlen' 
		] )->getMock ();
		...
		$this->target = $objectManagerHelper->getObject ( 'Magento\Catalog\Model\Layer\Filter\Attribute', [ 

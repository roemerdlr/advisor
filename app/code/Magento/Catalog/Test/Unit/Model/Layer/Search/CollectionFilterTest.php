...
class CollectionFilterTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $objectManager->getObject ( 'Magento\Catalog\Model\Layer\Search\CollectionFilter', [ 
	...
	public function testFilter() {
		$collectionMock = $this->getMock ( '\Magento\Catalog\Model\ResourceModel\Product\Collection', [ 

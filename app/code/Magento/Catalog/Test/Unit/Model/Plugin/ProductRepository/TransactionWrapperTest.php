...
class TransactionWrapperTest extends \PHPUnit_Framework_TestCase {
	...
	public function testAroundSaveCommit() {
		...
		$this->assertEquals ( $this->productMock, $this->model->aroundSave ( $this->subjectMock, $this->closureMock, $this->productMock, $this->saveOption ) );
	}
	...
	public function testAroundDeleteCommit() {
		...
		$this->assertEquals ( $this->productMock, $this->model->aroundDelete ( $this->subjectMock, $this->closureMock, $this->productMock, $this->saveOption ) );
	}

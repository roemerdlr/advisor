...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->optionsFactoryMock = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Product\Option\Value\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		$this->storeManagerMock = $this->getMock ( 'Magento\Store\Model\StoreManager', [ ], [ ], '', false );
		$this->resourceMock = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Product\Option', [ 
				'getConnection',
				'__wakeup',
				'getMainTable',
				'getTable' 

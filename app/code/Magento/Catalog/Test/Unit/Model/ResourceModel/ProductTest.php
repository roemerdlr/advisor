...
class ProductTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->typeFactoryMock = $this->getMock ( '\Magento\Eav\Model\Entity\TypeFactory', [ 
				'create',
				'__wakeup' 
		], [ ], '', false );
		
		$this->model = $objectManager->getObject ( 'Magento\Catalog\Model\ResourceModel\Product', [ 
	...
	public function testValidateWrongAttributeSet() {
		...
		$productMock = $this->getMock ( '\Magento\Framework\DataObject', [ 
				'getAttributeSetId',
				'__wakeup' 
		], [ ], '', false );

...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->storeManagerMock->expects ( $this->any () )->method ( 'getStore' )->will ( $this->returnCallback ( function ($store) {
			return is_object ( $store ) ? $store : new \Magento\Framework\DataObject ( [ 
					'id' => 42 
			] );
		} ) );
		...
		$this->collection = $this->objectManagerHelper->getObject ( 'Magento\Catalog\Model\ResourceModel\Product\Link\Product\Collection', [ 
	...
	public function testSetProduct() {
		...
		$productStore = new \Magento\Framework\DataObject ( [ 
				'id' => 33 
		] );

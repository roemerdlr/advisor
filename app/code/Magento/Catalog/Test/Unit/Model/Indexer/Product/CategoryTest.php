...
class CategoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->fullMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Category\Product\Action\FullFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->rowsMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Product\Category\Action\RowsFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->model = new \Magento\Catalog\Model\Indexer\Product\Category ( $this->fullMock, $this->rowsMock, $this->indexerRegistryMock );
	}
	public function testExecuteWithIndexerWorking() {
		...
		$rowMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Product\Category\Action\Rows', [ 
				'execute' 
		], [ ], '', false );
	...
	protected function prepareIndexer() {
		$this->indexerRegistryMock->expects ( $this->once () )->method ( 'get' )->with ( \Magento\Catalog\Model\Indexer\Product\Category::INDEXER_ID )->will ( $this->returnValue ( $this->indexerMock ) );
	}
}

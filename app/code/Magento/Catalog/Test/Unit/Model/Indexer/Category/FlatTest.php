...
class FlatTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->fullMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Category\Flat\Action\FullFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->rowsMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Category\Flat\Action\RowsFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->model = new \Magento\Catalog\Model\Indexer\Category\Flat ( $this->fullMock, $this->rowsMock, $this->indexerRegistryMock );
	}
	...
	public function testExecuteWithIndexerWorking() {
		...
		$rowMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Category\Flat\Action\Rows', [ 
				'reindex' 
		], [ ], '', false );

...
class ProductTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->rowsMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Category\Product\Action\RowsFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->model = new \Magento\Catalog\Model\Indexer\Category\Product ( $this->fullMock, $this->rowsMock, $this->indexerRegistryMock );
	}
	public function testExecuteWithIndexerWorking() {
		...
		$rowMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Category\Product\Action\Rows', [ 
				'execute' 
		], [ ], '', false );
	...
	protected function prepareIndexer() {
		$this->indexerRegistryMock->expects ( $this->any () )->method ( 'get' )->with ( \Magento\Catalog\Model\Indexer\Category\Product::INDEXER_ID )->will ( $this->returnValue ( $this->indexerMock ) );
	}
}

...
class AffectCacheTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->subjectMock = $this->getMockForAbstractClass ( 'Magento\Framework\Indexer\ActionInterface', [ ], '', false, true, true, [ ] );
	...
	public function testBeforeExecute() {
		...
		$this->contextMock->expects ( $this->once () )->method ( 'registerEntities' )->with ( $this->equalTo ( \Magento\Catalog\Model\Category::ENTITY ), $this->equalTo ( $expectedIds ) )->will ( $this->returnValue ( $this->contextMock ) );

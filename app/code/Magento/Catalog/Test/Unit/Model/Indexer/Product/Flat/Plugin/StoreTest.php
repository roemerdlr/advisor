...
class StoreTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->processorMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Product\Flat\Processor', [ 
	...
	public function testBeforeSaveSwitchStoreGroup($matcherMethod, $storeGroupChanged) {
		...
		$this->storeMock->expects ( $this->once () )->method ( 'dataHasChangedFor' )->with ( 'group_id' )->will ( $this->returnValue ( $storeGroupChanged ) );

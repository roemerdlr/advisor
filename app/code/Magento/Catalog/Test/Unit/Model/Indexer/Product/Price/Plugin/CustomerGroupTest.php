...
class CustomerGroupTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$indexerMock = $this->getMock ( 'Magento\Indexer\Model\Indexer', [ 
				'getId',
				'invalidate' 
		], [ ], '', false );
		...
		$this->_model = $this->_objectManager->getObject ( 'Magento\Catalog\Model\Indexer\Product\Price\Plugin\CustomerGroup', [ 

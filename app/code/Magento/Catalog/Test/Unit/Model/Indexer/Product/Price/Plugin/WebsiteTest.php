...
class WebsiteTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_priceProcessorMock = $this->getMock ( 'Magento\Catalog\Model\Indexer\Product\Price\Processor', [ 
				'markIndexerAsInvalid' 
		], [ ], '', false );
		
		$this->_model = $this->_objectManager->getObject ( 'Magento\Catalog\Model\Indexer\Product\Price\Plugin\Website', [ 

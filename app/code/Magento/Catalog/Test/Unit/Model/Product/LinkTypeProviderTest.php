...
class LinkTypeProviderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->linkTypeFactoryMock = $this->getMock ( 'Magento\Catalog\Api\Data\ProductLinkTypeInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		$this->linkAttributeFactoryMock = $this->getMock ( 'Magento\Catalog\Api\Data\ProductLinkAttributeInterfaceFactory', [ 
				'create' 
		], [ ], '', false, false );
		$this->linkFactoryMock = $this->getMock ( '\Magento\Catalog\Model\Product\LinkFactory', [ 
				'create' 
		], [ ], '', false, false );
		$this->linkTypes = [ 
		...
		$this->model = $objectManager->getObject ( 'Magento\Catalog\Model\Product\LinkTypeProvider', [ 
	...
	public function testGetItemAttributes($type, $typeId) {
		...
		$linkMock = $this->getMock ( '\Magento\Catalog\Model\Product\Link', [ 
				'getAttributes' 
		], [ ], '', false );

...
class GroupTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helper->getObject ( '\Magento\Catalog\Model\Product\Attribute\Group', [ 
	...
	private function getMockedCollection() {
		...
		$mock->expects ( $this->any () )->method ( 'setAttributeGroupFilter' )->will ( $this->returnValue ( $mock ) );
		$mock->expects ( $this->any () )->method ( 'getIterator' )->will ( $this->returnValue ( new \ArrayIterator ( [ 
				$item 
		] ) ) );

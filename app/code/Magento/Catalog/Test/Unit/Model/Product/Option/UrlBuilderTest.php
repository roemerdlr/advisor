...
class UrlBuilderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helper->getObject ( '\Magento\Catalog\Model\Product\Option\UrlBuilder', [ 
	...
	private function getMockedFrontendUrlBuilder() {
		$mockBuilder = $this->getMockBuilder ( '\Magento\Framework\UrlInterface' )->disableOriginalConstructor ();
		$mock = $mockBuilder->getMockForAbstractClass ();
		
		$mock->expects ( $this->any () )->method ( 'getUrl' )->will ( $this->returnValue ( 'testResult' ) );

...
class ImageEntryConverterTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 *
	 * @var \PHPUnit_Framework_MockObject_MockObject |\Magento\Catalog\Api\Data\ProductAttributeMediaGalleryEntry
	 */
	...
	/**
	 *
	 * @var \Magento\Catalog\Model\Product\Attribute\Backend\Media\ImageEntryConverter |\Magento\Framework\TestFramework\Unit\Helper\ObjectManager
	 */
	...
	public function setUp() {
		...
		$this->modelObject = $objectManager->getObject ( '\Magento\Catalog\Model\Product\Attribute\Backend\Media\ImageEntryConverter', [ 

...
class DefaultValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->validator = new \Magento\Catalog\Model\Product\Option\Validator\DefaultValidator ( $configMock, $priceConfigMock );
	}
	 ...
	 *        	$price
	 * @param $product @dataProvider
	 *        	validationNegativePriceDataProvider
	 */

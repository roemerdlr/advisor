...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_factory = $objectManagerHelper->getObject ( 'Magento\Catalog\Model\Product\Option\Type\Factory', [ 
	...
	public function testCreate() {
		...
		$this->_objectManagerMock->expects ( $this->once () )->method ( 'create' )->with ( $className, [ ] )->will ( $this->returnValue ( $filterMock ) );
	...
	public function testCreateWithArguments() {
		...
		$filterMock = $this->getMock ( $className, [ ], [ ], '', false );
		$this->_objectManagerMock->expects ( $this->once () )->method ( 'create' )->with ( $className, $arguments )->will ( $this->returnValue ( $filterMock ) );

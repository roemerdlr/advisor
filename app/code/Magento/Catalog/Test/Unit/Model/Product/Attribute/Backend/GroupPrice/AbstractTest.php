...
class AbstractTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_helper = $this->getMock ( 'Magento\Catalog\Helper\Data', [ 
				'isPriceGlobal' 
		], [ ], '', false );
		...
		$this->_model = $this->getMockForAbstractClass ( 'Magento\Catalog\Model\Product\Attribute\Backend\GroupPrice\AbstractGroupPrice', [ 
		...
		$resource = $this->getMock ( 'StdClass', [ 
				'getMainTable' 
		] );

...
class CountryofmanufactureTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @param
	 *        	$cachedDataSrl
	 * @param $cachedDataUnsrl @dataProvider
	 *        	testGetAllOptionsDataProvider
	 */
	public function testGetAllOptions($cachedDataSrl, $cachedDataUnsrl) {
		...
		$countryOfManufacture = $this->objectManagerHelper->getObject ( 'Magento\Catalog\Model\Product\Attribute\Source\Countryofmanufacture', [ 
	...
	public function testGetAllOptionsDataProvider() {
		return [ 
				[ 
						'cachedDataSrl' => 'a:1:{s:3:"key";s:4:"data";}',
						'cachedDataUnsrl' => [ 
								'key' => 'data' 
						] 
				] 

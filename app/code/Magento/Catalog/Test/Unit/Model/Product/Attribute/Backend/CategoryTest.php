...
class CategoryTest extends \PHPUnit_Framework_TestCase {
	public function testAfterLoad() {
		...
		$product = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'getCategoryIds',
				'setData' 
		] );
		...
		$categoryAttribute = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'getAttributeCode' 
		] );
		$categoryAttribute->expects ( $this->once () )->method ( 'getAttributeCode' )->will ( $this->returnValue ( 'category_ids' ) );

...
class PriceTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->tpFactory = $this->getMockForAbstractClass ( 'Magento\Catalog\Api\Data\ProductTierPriceInterfaceFactory', [ ], '', false, true, true, [ 
				'create' 
		] );
		...
		$storeMangerMock = $this->getMockForAbstractClass ( 'Magento\Store\Model\StoreManagerInterface', [ ], '', false, true, true, [ 
				'getWebsite' 
		] );
		...
		$this->model = $this->objectManagerHelper->getObject ( 'Magento\Catalog\Model\Product\Type\Price', [ 
	...
	public function pricesDataProvider() {
		return [ 
				'global price scope' => [ 
						$this::PRICE_SCOPE_GLOBAL,
						0 
				],
				'website price scope' => [ 
						$this::PRICE_SCOPE_WEBSITE,
						2 
				] 
		];
	}

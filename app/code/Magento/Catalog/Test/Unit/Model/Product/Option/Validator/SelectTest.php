...
class SelectTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->validator = new \Magento\Catalog\Model\Product\Option\Validator\Select ( $configMock, $priceConfigMock );
	}
	...
	public function testIsValidateWithInvalidOptionValues() {
		...
		$this->valueMock->expects ( $this->never () )->method ( 'getPriceType' );
		$this->valueMock->expects ( $this->never () )->method ( 'getPrice' );
		$this->valueMock->expects ( $this->once () )->method ( 'getData' )->with ( 'values' )->will ( $this->returnValue ( 'invalid_data' ) );
		$messages = [ 

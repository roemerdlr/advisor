...
class ProductLinksTest extends \PHPUnit_Framework_TestCase {
	...
	private function getMockedProduct() {
		...
		$mock->expects ( $this->any () )->method ( 'getRelatedReadonly' )->will ( $this->returnValue ( false ) );
		
		$mock->expects ( $this->any () )->method ( 'getUpsellReadonly' )->will ( $this->returnValue ( false ) );
		
		$mock->expects ( $this->any () )->method ( 'getCrosssellReadonly' )->will ( $this->returnValue ( false ) );
		
		$mock->expects ( $this->any () )->method ( 'setCrossSellLinkData' );
		
		$mock->expects ( $this->any () )->method ( 'setUpSellLinkData' );
		
		$mock->expects ( $this->any () )->method ( 'setRelatedLinkData' );

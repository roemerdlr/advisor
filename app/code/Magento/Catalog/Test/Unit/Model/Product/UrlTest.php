...
class UrlTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->filter = $this->getMockBuilder ( 'Magento\Framework\Filter\FilterManager' )->disableOriginalConstructor ()->setMethods ( [ 
				'translitUrl' 
		] )->getMock ();
		
		$this->urlFinder = $this->getMockBuilder ( 'Magento\UrlRewrite\Model\UrlFinderInterface' )->disableOriginalConstructor ()->getMock ();
		
		$this->url = $this->getMockBuilder ( 'Magento\Framework\Url' )->disableOriginalConstructor ()->setMethods ( [ 
				'setScope',
				'getUrl' 
		] )->getMock ();
		...
		$urlFactory = $this->getMockBuilder ( '\Magento\Framework\UrlFactory' )->disableOriginalConstructor ()->getMock ();
		$urlFactory->method ( 'create' )->willReturn ( $this->url );
	 ...
	 * @param
	 *        	$productId
	 * @param $productUrlKey @SuppressWarnings(PHPMD.ExcessiveParameterList)        	
	 */

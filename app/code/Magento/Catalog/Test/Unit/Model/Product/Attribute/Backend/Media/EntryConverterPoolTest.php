...
class EntryConverterPoolTest extends \PHPUnit_Framework_TestCase {
	/**
	 *
	 * @var \PHPUnit_Framework_MockObject_MockObject |\Magento\Catalog\Model\Product\Attribute\Backend\Media\ImageEntryConverter
	 */
	protected $imageMock;
	
	/**
	 *
	 * @var \PHPUnit_Framework_MockObject_MockObject |\Magento\ProductVideo\Model\Product\Attribute\Media\ExternalVideoEntryConverter
	 */
	protected $videoMock;
	...
	public function setUp() {
		$this->imageMock = $this->getMock ( '\Magento\Catalog\Model\Product\Attribute\Backend\Media\ImageEntryConverter', [ ], [ ], '', false );
		
		$this->imageMock->expects ( $this->any () )->method ( 'getMediaEntryType' )->willReturn ( 'image' );
		
		$this->videoMock = $this->getMock ( '\Magento\ProductVideo\Model\Product\Attribute\Media\ExternalVideoEntryConverter', [ ], [ ], '', false );
	...
	public function testGetConverterByMediaTypeImage() {
		...
		$converterPool = $objectManager->getObject ( '\Magento\Catalog\Model\Product\Attribute\Backend\Media\EntryConverterPool', [ 

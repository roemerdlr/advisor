...
class ActionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->productWebsiteFactory = $this->getMock ( '\Magento\Catalog\Model\Product\WebsiteFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->productWebsite = $this->getMock ( '\Magento\Catalog\Model\Product\Website', [ 
				'addProducts',
				'removeProducts',
				'__wakeup' 
		], [ ], '', false );
		$this->productWebsiteFactory->expects ( $this->any () )->method ( 'create' )->will ( $this->returnValue ( $this->productWebsite ) );
		$this->categoryIndexer = $this->getMock ( '\Magento\Indexer\Model\Indexer', [ 
				'getId',
				'load',
				'isScheduled',
				'reindexList' 
		...
		$this->model = $objectManager->getObject ( 'Magento\Catalog\Model\Product\Action', [ 
	 ...
	 * @param
	 *        	$type
	 * @param $methodName @dataProvider
	 *        	updateWebsitesDataProvider
	 */

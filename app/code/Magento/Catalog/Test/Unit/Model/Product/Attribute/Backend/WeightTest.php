...
class WeightTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$localeFormat = $objectHelper->getObject ( 'Magento\Framework\Locale\Format', [ 
		...
		$this->model = $objectHelper->getObject ( 'Magento\Catalog\Model\Product\Attribute\Backend\Weight', [ 

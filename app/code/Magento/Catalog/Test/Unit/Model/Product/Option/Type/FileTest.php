...
class FileTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->rootDirectory = $this->getMockBuilder ( 'Magento\Framework\Filesystem\Directory\ReadInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'isFile',
				'isReadable',
				'getAbsolutePath' 
		] )->getMockForAbstractClass ();
		
		$this->coreFileStorageDatabase = $this->getMock ( 'Magento\MediaStorage\Helper\File\Storage\Database', [ 
				'copyFile' 
		], [ ], '', false );
	}
	...
	protected function getFileObject() {
		return $this->objectManager->getObject ( 'Magento\Catalog\Model\Product\Option\Type\File', [ 
				'saleableItem' => $this->rootDirectory,
				'priceCurrency' => $this->coreFileStorageDatabase 
		] );
	}
	public function testCopyQuoteToOrder() {
		$optionMock = $this->getMockBuilder ( 'Magento\Catalog\Model\Product\Configuration\Item\Option\OptionInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'getValue' 
		] )->getMockForAbstractClass ();

...
class ImageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helper->getObject ( '\Magento\Catalog\Model\Product\Attribute\Frontend\Image', [ 
	...
	private function getMockedProduct() {
		...
		$mock->expects ( $this->any () )->method ( 'getData' )->will ( $this->returnValue ( 'img.jpg' ) );
		
		$mock->expects ( $this->any () )->method ( 'getStore' );
	...
	private function getMockedStoreManager() {
		...
		$mock->expects ( $this->any () )->method ( 'getStore' )->will ( $this->returnValue ( $mockedStore ) );
	...
	private function getMockedStore() {
		...
		$mock->expects ( $this->any () )->method ( 'getBaseUrl' )->will ( $this->returnValue ( '' ) );
	...
	private function getMockedAttribute() {
		...
		$mock->expects ( $this->any () )->method ( 'getAttributeCode' );

...
class ListSortTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helper->getObject ( 'Magento\Catalog\Model\Config\Source\ListSort', [ 
	...
	public function testToOptionalArray() {
		$except = [ 
				...
				[ 
						'label' => 'testLabel',
						'value' => 'testAttributeCode' 
				] 
		];
		$this->catalogConfig->expects ( $this->any () )->method ( 'getAttributesUsedForSortBy' )->will ( $this->returnValue ( [ 
				[ 
						'frontend_label' => 'testLabel',
						'attribute_code' => 'testAttributeCode' 
				] 
		] ) );

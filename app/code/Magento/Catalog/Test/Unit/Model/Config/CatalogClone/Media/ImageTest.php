...
class ImageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->attributeCollectionFactory = $this->getMockBuilder ( 'Magento\Catalog\Model\ResourceModel\Product\Attribute\CollectionFactory' )->setMethods ( [ 
				'create' 
		...
		$this->model = $helper->getObject ( 'Magento\Catalog\Model\Config\CatalogClone\Media\Image', [ 
	...
	public function testGetPrefixes() {
		...
		$frontend = $this->getMockBuilder ( 'Magento\Eav\Model\Entity\Attribute\Frontend\AbstractFrontend' )->setMethods ( [ 
				'getLabel' 
		...
		$this->attributeCollection->expects ( $this->any () )->method ( 'getIterator' )->will ( $this->returnValue ( new \ArrayIterator ( [ 
				$this->attribute 
		] ) ) );
		...
		$this->assertEquals ( [ 
				[ 
						'field' => 'attributeCode_',
						'label' => 'testLabel' 
				] 
		], $this->model->getPrefixes () );
	}
}

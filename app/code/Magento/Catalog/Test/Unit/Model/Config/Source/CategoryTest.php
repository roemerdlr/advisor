...
class CategoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->category = $this->getMockBuilder ( 'Magento\Catalog\Model\ResourceModel\Category' )->setMethods ( [ 
				'getName',
				'getId' 
		 ...
		 */
		$categoryCollectionFactory = $this->getMockBuilder ( 'Magento\Catalog\Model\ResourceModel\Category\CollectionFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		$categoryCollectionFactory->expects ( $this->any () )->method ( 'create' )->will ( $this->returnValue ( $this->categoryCollection ) );
	...
	public function testToOptionArray() {
		...
		$this->categoryCollection->expects ( $this->any () )->method ( 'getIterator' )->will ( $this->returnValue ( new \ArrayIterator ( [ 
				$this->category 
		] ) ) );

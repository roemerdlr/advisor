...
class TypeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->productOptionConfig = $this->getMockBuilder ( 'Magento\Catalog\Model\ProductOptions\ConfigInterface' )->setMethods ( [ 
				'getAll' 
		] )->disableOriginalConstructor ()->getMockForAbstractClass ();
		
		$helper = new ObjectManager ( $this );
		$this->model = $helper->getObject ( 'Magento\Catalog\Model\Config\Source\Product\Options\Type', [ 

...
class CategoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->categoryLayer = $this->getMock ( 'Magento\Catalog\Model\Layer\Category', [ 
				'setStore',
				'__wakeup' 
		], [ ], '', false );
		$this->collectionFactory = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Product\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		$this->visibility = $this->getMock ( 'Magento\Catalog\Model\Product\Visibility', [ 
				'getVisibleInCatalogIds',
				'__wakeup' 
		], [ ], '', false );
		
		/** @var \PHPUnit_Framework_MockObject_MockObject|\Magento\Catalog\Model\Layer\Resolver $layerResolver */
		$layerResolver = $this->getMockBuilder ( '\Magento\Catalog\Model\Layer\Resolver' )->disableOriginalConstructor ()->setMethods ( [ 
				'get',
				'create' 
		] )->getMock ();
		$layerResolver->expects ( $this->any () )->method ( $this->anything () )->will ( $this->returnValue ( $this->categoryLayer ) );
		
		$this->objectManagerHelper = new ObjectManagerHelper ( $this );
		/** @var \Magento\Catalog\Model\Rss\Category model */
		$this->model = $this->objectManagerHelper->getObject ( 'Magento\Catalog\Model\Rss\Category', [ 
	...
	public function testGetProductCollection() {
		...
		$products = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Product\Collection', [ 
				'setStoreId',
				'addAttributeToSort',
				'setVisibility',
				'setCurPage',
		...
		$resourceCollection = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Collection\AbstractCollection', [ 
		...
		$layer = $this->getMock ( 'Magento\Catalog\Model\Layer', [ 
				'setCurrentCategory',

...
class NotifyStockTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->stockFactory = $this->getMock ( 'Magento\CatalogInventory\Model\ResourceModel\StockFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->notifyStock = $this->objectManagerHelper->getObject ( 'Magento\Catalog\Model\Rss\Product\NotifyStock', [ 

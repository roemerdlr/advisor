...
return [ 
		...
		'type_modelinstance_invalid_value' => [ 
				...
				[ 
						"Element 'type', attribute 'modelInstance': [facet 'pattern'] The value '123' is not accepted by the" . " pattern '[a-zA-Z_\\\\\\\\]+'.\nLine: 1\n",
		...
		'type_pricemodel_instance_invalid_value' => [ 
				...
				[ 
						"Element 'priceModel', attribute 'instance': [facet 'pattern'] The value '123123' is not accepted " . "by the pattern '[a-zA-Z_\\\\\\\\]+'.\nLine: 1\n",
		...
		'type_indexermodel_instance_invalid_value' => [ 
				...
				[ 
						"Element 'indexerModel', attribute 'instance': [facet 'pattern'] The value '123' is not accepted by " . "the pattern '[a-zA-Z_\\\\\\\\]+'.\nLine: 1\n",
		...
		'stockindexermodel_instance_invalid_value' => [ 
				...
				[ 
						"Element 'stockIndexerModel', attribute 'instance': [facet 'pattern'] The value '1234' is not " . "accepted by the pattern '[a-zA-Z_\\\\\\\\]+'.\nLine: 1\n",

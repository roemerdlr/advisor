...
return [ 
		...
		'type_pricemodel_without_required_instance_attribute' => [ 
				'<?xml version="1.0" encoding="UTF-8"?><config>' . '<type label="some_label" name="some_name" modelInstance="model_name"><priceModel/></type></config>',
				[ 
						"Element 'priceModel': The attribute 'instance' is required but missing.\nLine: 1\n" 
				] 
		],
		'type_indexmodel_without_required_instance_attribute' => [ 
				'<?xml version="1.0" encoding="UTF-8"?><config>' . '<type label="some_label" name="some_name" modelInstance="model_name"><indexerModel/></type></config>',
				[ 
		...
		'type_stockindexermodel_without_required_instance_attribute' => [ 
				'<?xml version="1.0" encoding="UTF-8"?><config><type label="some_label" ' . 'name="some_name" modelInstance="model_name"><stockIndexerModel/></type></config>',
				[ 

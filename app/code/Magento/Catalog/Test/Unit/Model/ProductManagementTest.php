...
class ProductManagementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->productsFactoryMock = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Product\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		$this->model = new \Magento\Catalog\Model\ProductManagement ( $this->productsFactoryMock );
	}

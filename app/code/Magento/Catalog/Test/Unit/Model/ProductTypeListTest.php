...
class ProductTypeListTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->factoryMock = $this->getMock ( 'Magento\Catalog\Api\Data\ProductTypeInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		$this->model = new ProductTypeList ( $this->typeConfigMock, $this->factoryMock );
	}
	public function testGetProductTypes() {
		...
		$productTypeMock->expects ( $this->once () )->method ( 'setName' )->with ( $simpleProductType ['name'] )->willReturnSelf ();

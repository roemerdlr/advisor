...
class CompareTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->context = $this->getMock ( 'Magento\Framework\App\Helper\Context', [ 
				'getUrlBuilder',
				'getRequest',
				'getUrlEncoder' 
		], [ ], '', false );
		...
		$this->context->expects ( $this->once () )->method ( 'getUrlEncoder' )->will ( $this->returnValue ( $this->urlEncoder ) );
		$this->postDataHelper = $this->getMock ( 'Magento\Framework\Data\Helper\PostHelper', [ 
				'getPostData' 
		], [ ], '', false );
		...
		$this->compareHelper = $objectManager->getObject ( 'Magento\Catalog\Helper\Product\Compare', [ 
	...
	public function testGetClearListUrl() {
		...
		// Verification
		$this->urlBuilder->expects ( $this->once () )->method ( 'getUrl' )->with ( $url )->will ( $this->returnValue ( $url ) );

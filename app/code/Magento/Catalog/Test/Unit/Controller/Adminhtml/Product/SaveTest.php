...
class SaveTest extends \Magento\Catalog\Test\Unit\Controller\Adminhtml\ProductTest {
	...
	protected function setUp() {
		...
		$this->action = (new ObjectManagerHelper ( $this ))->getObject ( 'Magento\Catalog\Controller\Adminhtml\Product\Save', [ 
	 ...
	 * @return void @dataProvider exceptionTypeDataProvider
	 */

...
class HelperTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->stockFilterMock = $this->getMock ( 'Magento\Catalog\Controller\Adminhtml\Product\Initialization\StockDataFilter', [ ], [ ], '', false );
		$this->productLinksMock = $this->getMock ( 'Magento\Catalog\Model\Product\Initialization\Helper\ProductLinks', [ ], [ ], '', false );
	...
	public function testInitialize() {
		...
		$this->stockFilterMock->expects ( $this->once () )->method ( 'filter' )->with ( [ 
				'stock_data' 
		...
		$this->productMock->expects ( $this->once () )->method ( 'setWebsiteIds' )->with ( [ 
				$this->websiteId 
		] );

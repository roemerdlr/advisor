...
class SaveTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->contextMock = $this->getMock ( 'Magento\Backend\App\Action\Context', [ 
				'getTitle',
				'getRequest',
				'getObjectManager',
				'getEventManager',
		...
		$this->resultRedirectFactoryMock = $this->getMock ( 'Magento\Backend\Model\View\Result\RedirectFactory', [ 
				'create' 
		], [ ], '', false );
		$this->resultRawFactoryMock = $this->getMock ( 'Magento\Framework\Controller\Result\RawFactory', [ ], [ ], '', false );
		$this->resultJsonFactoryMock = $this->getMock ( 'Magento\Framework\Controller\Result\JsonFactory', [ 
				'create' 
		], [ ], '', false );
		$this->layoutFactoryMock = $this->getMock ( 'Magento\Framework\View\LayoutFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->eventManagerMock = $this->getMockForAbstractClass ( 'Magento\Framework\Event\ManagerInterface', [ ], '', false, true, true, [ 
				'dispatch' 
		] );
		$this->responseMock = $this->getMockForAbstractClass ( 'Magento\Framework\App\ResponseInterface', [ ], '', false );
		...
		$this->save = $this->objectManager->getObject ( 'Magento\Catalog\Controller\Adminhtml\Category\Save', [ 
	 ...
	 * @return void @dataProvider dataProviderExecute
	...
	public function testExecute($categoryId, $storeId, $activeTabId, $parentId) {
		...
		/**
		 *
		 * @var \Magento\Backend\Model\View\Result\Redirect |\PHPUnit_Framework_MockObject_MockObject $resultRedirectMock
		 */
		$resultRedirectMock = $this->getMock ( 'Magento\Backend\Model\View\Result\Redirect', [ ], [ ], '', false );
		/**
		 *
		 * @var \Magento\Framework\View\Element\Messages |\PHPUnit_Framework_MockObject_MockObject $blockMock
		 */
		$blockMock = $this->getMock ( 'Magento\Framework\View\Element\Messages', [ 
				'setMessages',
				'getGroupedHtml' 
		], [ ], '', false );
		/**
		 ...
		 */
		$categoryMock = $this->getMock ( 'Magento\Catalog\Model\Category', [ 
				'setStoreId',
				'load',
				'getPath',
				'getResource',
		...
		/**
		 *
		 * @var \Magento\Catalog\Model\Category |\PHPUnit_Framework_MockObject_MockObject $parentCategoryMock
		 */
		$parentCategoryMock = $this->getMock ( 'Magento\Catalog\Model\Category', [ 
				'setStoreId',
				'load',
				'getPath',
				'setPath',
		...
		/**
		 *
		 * @var \Magento\Backend\Model\Auth\Session |\PHPUnit_Framework_MockObject_MockObject $sessionMock
		 */
		$sessionMock = $this->getMock ( 'Magento\Backend\Model\Auth\Session', [ 
				'setActiveTabId' 
		], [ ], '', false );
		/**
		 *
		...
		/**
		 *
		 * @var \Magento\Cms\Model\Wysiwyg\Config |\PHPUnit_Framework_MockObject_MockObject $wysiwygConfigMock
		 */
		$wysiwygConfigMock = $this->getMock ( 'Magento\Cms\Model\Wysiwyg\Config', [ 
				'setStoreId' 
		], [ ], '', false );
		/**
		 *
		 * @var \Magento\Store\Model\StoreManagerInterface |\PHPUnit_Framework_MockObject_MockObject $storeManagerMock
		 */
		$storeManagerMock = $this->getMockForAbstractClass ( 'Magento\Store\Model\StoreManagerInterface', [ ], '', false, true, true, [ 
				'getStore',
				'getRootCategoryId' 
		] );
		/**
		 ...
		 */
		$layoutMock = $this->getMockForAbstractClass ( 'Magento\Framework\View\Layout', [ ], '', false, true, true, [ 
				'getMessagesBlock' 
		] );
		/**
		 *
		 * @var \Magento\Framework\Controller\Result\Json |\PHPUnit_Framework_MockObject_MockObject $resultJsonMock
		 */
		$resultJsonMock = $this->getMock ( 'Magento\Cms\Model\Wysiwyg\Config', [ 
				'setData' 
		], [ ], '', false );
		/**
		 *
		 * @var \Magento\Framework\Message\Collection |\PHPUnit_Framework_MockObject_MockObject $messagesMock
		 */
		...
		$this->requestMock->expects ( $this->atLeastOnce () )->method ( 'getParam' )->will ( $this->returnValueMap ( [ 
				[ 
						'id',
						false,
						$categoryId 
		...
		$this->objectManagerMock->expects ( $this->atLeastOnce () )->method ( 'get' )->will ( $this->returnValueMap ( [ 
				[ 
		...
		$registryMock->expects ( $this->any () )->method ( 'register' )->will ( $this->returnValueMap ( [ 
				[ 
						'category',
						$categoryMock 
				],
		...
		$this->requestMock->expects ( $this->atLeastOnce () )->method ( 'getPost' )->will ( $this->returnValueMap ( [ 
				[ 
						'use_config',
						[ 
								'attribute' 
		...
		$categoryMock->expects ( $this->atLeastOnce () )->method ( 'setData' )->will ( $this->returnValueMap ( [ 
				[ 
						'attribute',
						null,
						true 
		...
		$this->eventManagerMock->expects ( $this->once () )->method ( 'dispatch' )->with ( 'catalog_category_prepare_save', [ 
		...
		$categoryMock->expects ( $this->once () )->method ( 'toArray' )->will ( $this->returnValue ( [ 
				'category-data' 
		] ) );
		$resultJsonMock->expects ( $this->once () )->method ( 'setData' )->with ( [ 

...
class EditTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->eavAttribute = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Eav\Attribute', [ 
				'setEntityTypeId',
				'load',
				'getId',
				'getEntityTypeId',
		...
		$this->resultPage = $this->getMockBuilder ( 'Magento\Backend\Model\View\Result\Page' )->disableOriginalConstructor ()->setMethods ( [ 
				'setActiveMenu',
				'getConfig',
				'addBreadcrumb',
				'addHandle',
		...
		$this->resultPageFactory = $this->getMockBuilder ( 'Magento\Framework\View\Result\PageFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		...
		$this->pageTitle = $this->getMockBuilder ( 'Magento\Framework\View\Page\Title' )->disableOriginalConstructor ()->getMock ();
		...
		$this->editController = $this->objectManager->getObject ( 'Magento\Catalog\Controller\Adminhtml\Product\Attribute\Edit', [ 
	...
	public function testExecutePopup() {
		...
		$this->resultPage->expects ( $this->once () )->method ( 'addHandle' )->with ( [ 
				'popup',
				'catalog_product_attribute_edit_popup' 
		] )->willReturnSelf ();

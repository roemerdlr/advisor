	...
	public function execute() {
		...
		if ($this->getRequest ()->getQuery ( 'isAjax' )) {
			...
			$eventResponse = new \Magento\Framework\DataObject ( [ 
					'content' => $resultPage->getLayout ()->getBlock ( 'category.edit' )->getFormHtml () . $resultPage->getLayout ()->getBlock ( 'category.tree' )->getBreadcrumbsJavascript ( $breadcrumbsPath, 'editingCategoryBreadcrumbs' ),
			...
			$this->_eventManager->dispatch ( 'category_prepare_ajax_response', [ 

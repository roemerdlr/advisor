...
class SuggestCategories extends \Magento\Catalog\Controller\Adminhtml\Category {
	...
	public function execute() {
		...
		return $resultJson->setJsonData ( $this->layoutFactory->create ()->createBlock ( 'Magento\Catalog\Block\Adminhtml\Category\Tree' )->getSuggestedCategoriesJson ( $this->getRequest ()->getParam ( 'label_part' ) ) );
	}
}

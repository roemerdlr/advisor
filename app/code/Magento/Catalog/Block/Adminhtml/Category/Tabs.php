...
class Tabs extends \Magento\Backend\Block\Widget\Tabs {
	...
	protected function _prepareLayout() {
		...
		$this->addTab ( 'products', [ 
				...
				'content' => $this->getLayout ()->createBlock ( 'Magento\Catalog\Block\Adminhtml\Category\Tab\Product', 'category.product.grid' )->toHtml () 
		] );
		
		// dispatch event add custom tabs
		$this->_eventManager->dispatch ( 'adminhtml_catalog_category_tabs', [ 
				'tabs' => $this 
		] );

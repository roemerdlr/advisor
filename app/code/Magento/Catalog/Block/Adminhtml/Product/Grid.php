...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended {
	...
	protected function _prepareCollection() {
		...
		$collection = $this->_productFactory->create ()->getCollection ()->addAttributeToSelect ( 'sku' )->addAttributeToSelect ( 'name' )->addAttributeToSelect ( 'attribute_set_id' )->addAttributeToSelect ( 'type_id' )->setStore ( $store );
		...
		if ($store->getId ()) {
			...
			$collection->joinAttribute ( 'name', 'catalog_product/name', 'entity_id', null, 'inner', Store::DEFAULT_STORE_ID );
	...
	protected function _prepareMassaction() {
		...
		$this->getMassactionBlock ()->addItem ( 'status', [ 
				...
				'url' => $this->getUrl ( 'catalog/*/massStatus', [ 
						'_current' => true 
				] ),
				'additional' => [ 
						'visibility' => [ 
		...
		if ($this->_authorization->isAllowed ( 'Magento_Catalog::update_attributes' )) {
			$this->getMassactionBlock ()->addItem ( 'attributes', [ 
					...
					'url' => $this->getUrl ( 'catalog/product_action_attribute/edit', [ 
							'_current' => true 
					] ) 
			] );
		}
	...
	public function getGridUrl() {
		return $this->getUrl ( 'catalog/*/grid', [ 
				'_current' => true 
		] );
	}

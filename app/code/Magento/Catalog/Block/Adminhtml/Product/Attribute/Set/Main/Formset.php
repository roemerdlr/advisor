...
class Formset extends \Magento\Backend\Block\Widget\Form\Generic {
	...
	protected function _prepareForm() {
		...
		$fieldset = $form->addFieldset ( 'set_name', [ 
		...
		if (! $this->getRequest ()->getParam ( 'id', false )) {
			...
			$sets = $this->_setFactory->create ()->getResourceCollection ()->setEntityTypeFilter ( $this->_coreRegistry->registry ( 'entityType' ) )->load ()->toOptionArray ();

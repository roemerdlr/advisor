...
class Main extends AbstractMain {
	...
	protected function _prepareForm() {
		...
		$response->setTypes ( [ ] );
		$this->_eventManager->dispatch ( 'adminhtml_product_attribute_types', [ 
				'response' => $response 
		] );
		$_hiddenFields = [ ];
		...
		$this->_eventManager->dispatch ( 'product_attribute_form_build_main_tab', [ 
				'form' => $form 
		] );
	...
	protected function _getAdditionalElementTypes() {
		return [ 
				'apply' => 'Magento\Catalog\Block\Adminhtml\Product\Helper\Form\Apply' 
		];
	}
}

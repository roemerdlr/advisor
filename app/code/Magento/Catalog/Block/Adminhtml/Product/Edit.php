...
class Edit extends \Magento\Backend\Block\Widget {
	...
	protected function _prepareLayout() {
		...
		if (! $this->getProduct ()->isReadonly ()) {
			$this->addChild ( 'reset_button', 'Magento\Backend\Block\Widget\Button', [ 
					'label' => __ ( 'Reset' ),
					'onclick' => 'setLocation(\'' . $this->getUrl ( 'catalog/*/*', [ 
							'_current' => true 
					] ) . '\')' 
	...
	public function getValidationUrl() {
		return $this->getUrl ( 'catalog/*/validate', [ 
				'_current' => true 
		] );
	}
	...
	public function getSaveUrl() {
		return $this->getUrl ( 'catalog/*/save', [ 
				'_current' => true,
				'back' => null 
		] );
	}
	...
	public function getDuplicateUrl() {
		return $this->getUrl ( 'catalog/*/duplicate', [ 
				'_current' => true 
		] );
	}

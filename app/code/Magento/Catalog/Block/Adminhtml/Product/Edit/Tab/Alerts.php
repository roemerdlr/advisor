	...
	protected function _prepareLayout() {
		...
		if ($alertPriceAllow) {
			$accordion->addItem ( 'price', [ 
					...
					'content' => $this->getLayout ()->createBlock ( 'Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Alerts\Price' )->toHtml () . '<br />',
					'open' => true 
			] );
		}
		if ($alertStockAllow) {
			$accordion->addItem ( 'stock', [ 
					...
					'content' => $this->getLayout ()->createBlock ( 'Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Alerts\Stock' ),
					'open' => true 
			] );
		}

...
class Price extends Extended {
	...
	protected function _prepareColumns() {
		...
		$this->addColumn ( 'price', [ 
				...
				'index' => 'price',
				'type' => 'currency',
				'currency_code' => $this->_scopeConfig->getValue ( \Magento\Directory\Model\Currency::XML_PATH_CURRENCY_BASE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE ) 
		] );
	...
	public function getGridUrl() {
		...
		return $this->getUrl ( 'catalog/product/alertsPriceGrid', [ 
				'id' => $productId,
				'store' => $storeId 
		] );
	}

...
class Price extends \Magento\Backend\Block\Widget\Form\Generic {
	...
	protected function _prepareForm() {
		...
		$fieldset = $form->addFieldset ( 'tiered_price', [ 
				'legend' => __ ( 'Tier Pricing' ) 
		] );
		...
		$form->getElement ( 'tier_price' )->setRenderer ( $this->getLayout ()->createBlock ( 'Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Price\Tier' ) );

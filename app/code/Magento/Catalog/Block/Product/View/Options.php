...
class Options extends \Magento\Framework\View\Element\Template {
	...
	protected function _getPriceConfiguration($option) {
		...
		$data = [ 
				'prices' => [ 
						...
						'basePrice' => [ 
								'amount' => $this->_catalogData->getTaxPrice ( $option->getProduct (), $optionPrice, false, null, null, null, null, null, false ) 
						],
						'finalPrice' => [ 
								'amount' => $this->_catalogData->getTaxPrice ( $option->getProduct (), $optionPrice, true, null, null, null, null, null, false ) 
						] 
				],
	...
	public function getJsonConfig() {
		...
		$this->_eventManager->dispatch ( 'catalog_product_option_price_configuration_after', [ 
				'configObj' => $configObj 
		] );

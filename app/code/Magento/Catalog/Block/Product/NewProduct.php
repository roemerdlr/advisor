...
class NewProduct extends \Magento\Catalog\Block\Product\AbstractProduct implements \Magento\Framework\DataObject\IdentityInterface {
	...
	protected function _getProductCollection() {
		...
		$collection = $this->_addProductAttributesAndPrices ( $collection )->addStoreFilter ()->addAttributeToFilter ( 'news_from_date', [ 
				'or' => [ 
						0 => [ 
								'date' => true,
		...
		], 'left' )->addAttributeToFilter ( 'news_to_date', [ 
				'or' => [ 
						0 => [ 
								'date' => true,
		...
		] )->addAttributeToSort ( 'news_from_date', 'desc' )->setPageSize ( $this->getProductsCount () )->setCurPage ( 1 );

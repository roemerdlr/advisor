...
class UpgradeSchema implements UpgradeSchemaInterface {
	...
	protected function createValueToEntityTable(SchemaSetupInterface $setup) {
		 ...
		 */
		$table = $setup->getConnection ()->newTable ( $setup->getTable ( Media::GALLERY_VALUE_TO_ENTITY_TABLE ) )->addColumn ( 'value_id', \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER, null, [ 
				'unsigned' => true,
				'nullable' => false 
		], 'Value media Entry ID' )->addColumn ( 'entity_id', \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER, null, [ 
				'unsigned' => true,
				'nullable' => false 
		], 'Product entity ID' )->addIndex ( $setup->getIdxName ( Media::GALLERY_VALUE_TO_ENTITY_TABLE, [ 
				'value_id',
				'entity_id' 
	...
	private function addSupportVideoMediaAttributes(SchemaSetupInterface $setup) {
		 ...
		 */
		$setup->getConnection ()->addColumn ( $setup->getTable ( Media::GALLERY_TABLE ), 'media_type', [ 
		...
		$setup->getConnection ()->addColumn ( $setup->getTable ( Media::GALLERY_TABLE ), 'disabled', [ 
		...
		$setup->getConnection ()->addColumn ( $setup->getTable ( Media::GALLERY_VALUE_TABLE ), 'record_id', [ 

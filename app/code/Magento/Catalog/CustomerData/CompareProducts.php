...
class CompareProducts implements SectionSourceInterface {
	 ...
	 */
	public function __construct(\Magento\Catalog\Helper\Product\Compare $helper, \Magento\Catalog\Model\Product\Url $productUrl, \Magento\Catalog\Helper\Output $outputHelper) {
		$this->helper = $helper;

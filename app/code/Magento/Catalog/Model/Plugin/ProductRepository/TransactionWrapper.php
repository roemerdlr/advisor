...
class TransactionWrapper {
	 ...
	 */
	public function __construct(\Magento\Catalog\Model\ResourceModel\Product $resourceModel) {
	 ...
	 * @throws \Exception @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	public function aroundDelete(\Magento\Catalog\Api\ProductRepositoryInterface $subject, \Closure $proceed, \Magento\Catalog\Api\Data\ProductInterface $product) {
		$this->resourceModel->beginTransaction ();
		try {
			/** @var bool $result */

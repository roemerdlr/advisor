...
class Price {
	 ...
	 */
	public function __construct(Layer $layer, Registry $coreRegistry, ScopeConfigInterface $scopeConfig, \Magento\Catalog\Model\ResourceModel\Layer\Filter\Price $resource) {
		$this->layer = $layer;
	...
	public function getRangeCalculationValue() {
		return $this->scopeConfig->getValue ( self::XML_PATH_RANGE_CALCULATION, ScopeInterface::SCOPE_STORE );
	}
	...
	public function getRangeStepValue() {
		return $this->scopeConfig->getValue ( self::XML_PATH_RANGE_STEP, ScopeInterface::SCOPE_STORE );
	}
	...
	public function getOnePriceIntervalValue() {
		return $this->scopeConfig->getValue ( self::XML_PATH_ONE_PRICE_INTERVAL, ScopeInterface::SCOPE_STORE );
	}
	...
	public function getIntervalDivisionLimitValue() {
		return $this->scopeConfig->getValue ( self::XML_PATH_INTERVAL_DIVISION_LIMIT, ScopeInterface::SCOPE_STORE );
	}
	...
	public function getRangeMaxIntervalsValue() {
		return $this->scopeConfig->getValue ( self::XML_PATH_RANGE_MAX_INTERVALS, ScopeInterface::SCOPE_STORE );
	}

...
class RowsFactory {
	 ...
	 */
	public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = 'Magento\Catalog\Model\Indexer\Category\Product\Action\Rows') {
	...
	public function create(array $data = []) {
		...
		if (! $instance instanceof \Magento\Catalog\Model\Indexer\Category\Product\AbstractAction) {
			throw new \InvalidArgumentException ( $this->instanceName . ' is not instance of \Magento\Catalog\Model\Indexer\Category\Product\AbstractAction' );
		}
		return $instance;
	}
}

...
class Price {
	...
	public function getBasePrice($product, $qty = null) {
		...
		return min ( $this->_applyTierPrice ( $product, $qty, $price ), $this->_applySpecialPrice ( $product, $price ) );
	}
	...
	public function getTierPrice($qty, $product) {
		...
		if ($qty) {
			...
			foreach ( $prices as $price ) {
				...
				if ($price ['price_qty'] == $prevQty && $prevGroup != $allGroupsId && $price ['cust_group'] == $allGroupsId) {

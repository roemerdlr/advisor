...
class Option extends AbstractExtensibleModel implements ProductCustomOptionInterface {
	...
	public function saveOptions() {
		foreach ( $this->getOptions () as $option ) {
			...
			$this->setData ( $option )->setData ( 'product_id', $this->getProduct ()->getId () )->setData ( 'store_id', $this->getProduct ()->getStoreId () );
			/**
	...
	/**
	 * Return price.
	 * If $flag is true and price is percent
	 ...
	 * Get option id
	 *
	 * @return int|null @codeCoverageIgnoreStart
	 */
	 ...
	 * @return $this
	 */
	public function setExtensionAttributes(\Magento\Catalog\Api\Data\ProductCustomOptionExtensionInterface $extensionAttributes) {

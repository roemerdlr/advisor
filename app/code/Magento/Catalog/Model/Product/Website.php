...
class Website extends \Magento\Framework\Model\AbstractModel {
	...
	public function removeProducts($websiteIds, $productIds) {
		try {
			...
			throw new \Magento\Framework\Exception\LocalizedException ( __ ( 'Something went wrong while removing products from the websites.' ) );
		}
		return $this;
	}
	...
	public function addProducts($websiteIds, $productIds) {
		try {
			...
			throw new \Magento\Framework\Exception\LocalizedException ( __ ( 'Something went wrong while adding products to websites.' ) );
		}
		return $this;
	}

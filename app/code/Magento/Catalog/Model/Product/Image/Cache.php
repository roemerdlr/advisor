...
class Cache {
	 ...
	 */
	public function __construct(ConfigInterface $viewConfig, ThemeCollection $themeCollection, ImageHelper $imageHelper) {
		...
		if (! $this->data) {
			...
			foreach ( $this->themeCollection->loadRegisteredThemes () as $theme ) {
				...
				foreach ( $images as $imageId => $imageData ) {
					$this->data [$theme->getCode () . $imageId] = array_merge ( [ 
							'id' => $imageId 
					], $imageData );
				}
			}

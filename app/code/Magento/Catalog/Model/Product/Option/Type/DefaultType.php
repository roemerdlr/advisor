...
class DefaultType extends \Magento\Framework\DataObject {
	...
	public function getSkipCheckRequiredOption() {
		return $this->getProduct ()->getSkipCheckRequiredOption () || $this->getProcessMode () == \Magento\Catalog\Model\Product\Type\AbstractType::PROCESS_MODE_LITE;
	}
	...
	public function prepareForCart() {
		...
		throw new LocalizedException ( __ ( 'We can\'t add the product to the cart because of an option validation issue.' ) );
	}
	...
	/**
	 * Parse user input value and return cart prepared value, i.e.
	 * "one, two" => "1,2"
	 *
	 * @param string $optionValue        	

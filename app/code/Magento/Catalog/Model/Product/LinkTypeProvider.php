...
class LinkTypeProvider implements \Magento\Catalog\Api\ProductLinkTypeListInterface {
	 ...
	 */
	public function __construct(\Magento\Catalog\Api\Data\ProductLinkTypeInterfaceFactory $linkTypeFactory, \Magento\Catalog\Api\Data\ProductLinkAttributeInterfaceFactory $linkAttributeFactory, \Magento\Catalog\Model\Product\LinkFactory $linkFactory, array $linkTypes = []) {
	...
	public function getItems() {
		...
		foreach ( $this->getLinkTypes () as $type => $typeCode ) {
			...
			$linkType->setName ( $type )->setCode ( $typeCode );
			$output [] = $linkType;
		}
		return $output;
	}

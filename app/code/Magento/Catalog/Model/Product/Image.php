...
class Image extends \Magento\Framework\Model\AbstractModel {
	 ...
	 *
	 * @param string|null $file        	
	 * @return float|int @SuppressWarnings(PHPMD.NPathComplexity)
	 */
	...
	public function setBaseFile($file) {
		...
		if (! $file) {
			...
			$isConfigPlaceholder = $this->_scopeConfig->getValue ( "catalog/placeholder/{$this->getDestinationSubdir()}_placeholder", \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
	 ...
	 */
	public function setWatermark($file, $position = null, $size = null, $width = null, $height = null, $opacity = null) {

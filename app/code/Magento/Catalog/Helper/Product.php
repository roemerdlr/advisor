...
class Product extends \Magento\Framework\Url\Helper\Data {
	...
	public function canUseCanonicalTag($store = null) {
		return $this->scopeConfig->getValue ( self::XML_PATH_USE_PRODUCT_CANONICAL_TAG, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	}
	 ...
	 *
	 * @return bool|ModelProduct @SuppressWarnings(PHPMD.CyclomaticComplexity)

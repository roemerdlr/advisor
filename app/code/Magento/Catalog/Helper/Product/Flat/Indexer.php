...
class Indexer extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	public function getFlatColumns() {
		if ($this->_columns === null) {
			...
			foreach ( $this->getAttributes () as $attribute ) {
				...
				$columns = $attribute->setFlatAddFilterableAttributes ( $this->isAddFilterableAttributes () )->setFlatAddChildData ( $this->isAddChildData () )->getFlatColumns ();
				if ($columns !== null) {
	...
	public function getAttributes() {
		if ($this->_attributes === null) {
			...
			foreach ( $attributeCodes as $attributeCode ) {
				$attribute = $this->_eavConfig->getAttribute ( $this->getEntityType (), $attributeCode )->setEntity ( $entity );
				try {
	...
	public function getAttributeCodes() {
		if ($this->_attributeCodes === null) {
			...
			], 'additional_table.attribute_id = main_table.attribute_id' )->where ( 'main_table.entity_type_id = :entity_type_id' );
			$whereCondition = [ 
	...
	public function getFlatIndexes() {
		if ($this->_indexes === null) {
			...
			foreach ( $this->getAttributes () as $attribute ) {
				...
				$indexes = $attribute->setFlatAddFilterableAttributes ( $this->isAddFilterableAttributes () )->setFlatAddChildData ( $this->isAddChildData () )->getFlatIndexes ();
				if ($indexes !== null) {

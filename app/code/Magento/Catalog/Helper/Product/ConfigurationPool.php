...
class ConfigurationPool {
	...
	public function get($className) {
		if (! isset ( $this->_instances [$className] )) {
			...
			if (false === $helperInstance instanceof \Magento\Catalog\Helper\Product\Configuration\ConfigurationInterface) {
				throw new \LogicException ( "{$className} doesn't implement " . "\\Magento\\Catalog\\Helper\\Product\\Configuration\\ConfigurationInterface" );
			}

...
class MaxHeapTableSizeProcessorOnFullReindex {
	 ...
	 */
	public function __construct(MaxHeapTableSizeProcessor $maxHeapTableSizeProcessor, LoggerInterface $logger) {
	 ...
	 * @param Full $subject        	
	 * @param Full $result        	
	 * @return Full @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

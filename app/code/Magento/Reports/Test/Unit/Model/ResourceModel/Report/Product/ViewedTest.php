...
class ViewedTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->selectMock = $this->getMockBuilder ( 'Magento\Framework\DB\Select' )->disableOriginalConstructor ()->setMethods ( [ 
				'from',
				'where',
				'joinInner',
				'joinLeft',
		...
		$this->flagMock = $this->getMockBuilder ( 'Magento\Reports\Model\Flag' )->disableOriginalConstructor ()->setMethods ( [ 
				'setReportFlagCode',
				'unsetData',
				'loadSelf',
				'setFlagData',
		...
		$this->flagFactoryMock = $this->getMockBuilder ( 'Magento\Reports\Model\FlagFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		...
		$this->viewed = (new ObjectManager ( $this ))->getObject ( 'Magento\Reports\Model\ResourceModel\Report\Product\Viewed', [ 

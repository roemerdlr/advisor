...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->selectMock = $this->getMockBuilder ( 'Magento\Framework\DB\Select' )->setMethods ( [ 
				'where',
				'from' 
		...
		$this->dbMock = $this->getMockBuilder ( 'Magento\Framework\DB\Adapter\Pdo\Mysql' )->disableOriginalConstructor ()->getMock ();
		...
		$this->resourceMock->expects ( $this->any () )->method ( 'getConnection' )->willReturn ( $this->dbMock );

...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->timezoneMock->expects ( $this->any () )->method ( 'formatDateTime' )->will ( $this->returnCallback ( [ 
				$this,
				'formatDateTime' 
		] ) );
	...
	public function formatDateTime() {
		...
		$formatter = new \IntlDateFormatter ( "en_US", \IntlDateFormatter::SHORT, \IntlDateFormatter::SHORT, new \DateTimeZone ( 'America/Los_Angeles' ) );

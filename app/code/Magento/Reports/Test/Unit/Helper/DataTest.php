...
class DataTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->itemFactoryMock = $this->getMockBuilder ( 'Magento\Reports\Model\ItemFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		
		$this->data = new Data ( $this->contextMock, $this->itemFactoryMock );
	}
	...
	public function testPrepareIntervalsCollection($from, $to, $period, $results) {
		...
		$item = $this->getMockBuilder ( 'Magento\Reports\Model\Item' )->disableOriginalConstructor ()->setMethods ( [ 
				'setPeriod',
				'setIsEmpty' 
		] )->getMock ();

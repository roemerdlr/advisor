...
class DateTest extends \PHPUnit_Framework_TestCase {
	...
	private function mockGridDateColumnConfig($objectDataIndex, $periodType) {
		$columnMock = $this->getMockBuilder ( 'Magento\Backend\Block\Widget\Grid\Column' )->disableOriginalConstructor ()->setMethods ( [ 
				'getIndex',
				'getPeriodType' 
		] )->getMock ();
	...
	public function testRender($data, $locale, $index, $period, $result) {
		...
		$objectMock = $this->getMockBuilder ( 'Magento\Framework\DataObject' )->setMethods ( [ 
				'getData' 
		] )->getMock ();

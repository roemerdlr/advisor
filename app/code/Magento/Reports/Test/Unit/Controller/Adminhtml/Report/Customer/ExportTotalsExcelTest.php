...
class ExportTotalsExcelTest extends \Magento\Reports\Test\Unit\Controller\Adminhtml\Report\AbstractControllerTest {
	...
	protected function setUp() {
		...
		$this->exportTotalsExcel = new ExportTotalsExcel ( $this->contextMock, $this->fileFactoryMock );
	}
	...
	public function testExecute() {
		...
		$this->fileFactoryMock->expects ( $this->once () )->method ( 'create' )->with ( 'customer_totals.xml', [ 
				'export' 

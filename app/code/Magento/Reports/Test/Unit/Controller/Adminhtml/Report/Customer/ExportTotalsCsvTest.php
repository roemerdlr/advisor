...
class ExportTotalsCsvTest extends \Magento\Reports\Test\Unit\Controller\Adminhtml\Report\AbstractControllerTest {
	...
	protected function setUp() {
		...
		$this->exportTotalsCsv = new ExportTotalsCsv ( $this->contextMock, $this->fileFactoryMock );
	}
	...
	public function testExecute() {
		...
		$this->fileFactoryMock->expects ( $this->once () )->method ( 'create' )->with ( 'customer_totals.csv', [ 
				'export' 

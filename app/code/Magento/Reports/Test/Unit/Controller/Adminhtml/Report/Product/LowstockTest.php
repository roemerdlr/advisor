...
class LowstockTest extends \Magento\Reports\Test\Unit\Controller\Adminhtml\Report\AbstractControllerTest {
	...
	protected function setUp() {
		...
		$this->lowstock = $objectManager->getObject ( 'Magento\Reports\Controller\Adminhtml\Report\Product\Lowstock', [ 
	...
	public function testExecute() {
		...
		$this->menuBlockMock->expects ( $this->once () )->method ( 'setActive' )->with ( 'Magento_Reports::report_products_lowstock' );

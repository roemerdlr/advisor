...
class ExportSoldCsvTest extends \Magento\Reports\Test\Unit\Controller\Adminhtml\Report\AbstractControllerTest {
	...
	protected function setUp() {
		...
		$this->exportSoldCsv = $objectManager->getObject ( 'Magento\Reports\Controller\Adminhtml\Report\Product\ExportSoldCsv', [ 
	...
	public function testExecute() {
		...
		$this->fileFactoryMock->expects ( $this->once () )->method ( 'create' )->with ( 'products_ordered.csv', $content, \Magento\Framework\App\Filesystem\DirectoryList::VAR_DIR );

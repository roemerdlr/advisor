...
class ExportAccountsCsvTest extends \Magento\Reports\Test\Unit\Controller\Adminhtml\Report\AbstractControllerTest {
	...
	protected function setUp() {
		...
		$this->exportAccountsCsv = new ExportAccountsCsv ( $this->contextMock, $this->fileFactoryMock );
	}
	...
	public function testExecute() {
		...
		$this->fileFactoryMock->expects ( $this->once () )->method ( 'create' )->with ( 'new_accounts.csv', [ 
				'export' 

...
abstract class AbstractControllerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->requestMock = $this->getMockForAbstractClassBuilder ( 'Magento\Framework\App\RequestInterface', [ 
				'isDispatched',
				'initForward',
				'setDispatched',
				'isForwarded' 
		] );
		$this->breadcrumbsBlockMock = $this->getMockForAbstractClassBuilder ( 'Magento\Framework\View\Element\BlockInterface', [ 
				'addLink' 
		] );
		$this->menuBlockMock = $this->getMockForAbstractClassBuilder ( 'Magento\Framework\View\Element\BlockInterface', [ 
				'setActive',
				'getMenuModel' 
		] );
		...
		$this->abstractBlockMock = $this->getMockBuilder ( 'Magento\Framework\View\Element\AbstractBlock' )->setMethods ( [ 
				'getCsvFile',
				'getExcelFile',
		...
		$this->layoutMock->expects ( $this->any () )->method ( 'getBlock' )->will ( $this->returnValueMap ( [ 
				[ 
						'breadcrumbs',

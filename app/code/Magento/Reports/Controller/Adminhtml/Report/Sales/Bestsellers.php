...
class Bestsellers extends \Magento\Reports\Controller\Adminhtml\Report\Sales {
	...
	public function execute() {
		...
		$this->_initAction ()->_setActiveMenu ( 'Magento_Reports::report_products_bestsellers' )->_addBreadcrumb ( __ ( 'Products Bestsellers Report' ), __ ( 'Products Bestsellers Report' ) );

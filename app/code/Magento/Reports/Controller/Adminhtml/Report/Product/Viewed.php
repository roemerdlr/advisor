...
class Viewed extends \Magento\Reports\Controller\Adminhtml\Report\Product {
	...
	public function execute() {
		try {
			...
			$this->_initAction ()->_setActiveMenu ( 'Magento_Reports::report_products_viewed' )->_addBreadcrumb ( __ ( 'Products Most Viewed Report' ), __ ( 'Products Most Viewed Report' ) );
			...
			$this->messageManager->addError ( __ ( 'An error occurred while showing the product views report. Please review the log and try again.' ) );

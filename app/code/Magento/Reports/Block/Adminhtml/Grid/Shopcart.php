...
class Shopcart extends \Magento\Backend\Block\Widget\Grid\Extended {
	...
	public function getCurrentCurrencyCode() {
		if ($this->_currentCurrencyCode === null) {
			...
			$this->_currentCurrencyCode = count ( $this->_storeIds ) > 0 ? $this->_storeManager->getStore ( current ( $this->_storeIds ) )->getBaseCurrencyCode () : $this->_storeManager->getStore ()->getBaseCurrencyCode ();
		}

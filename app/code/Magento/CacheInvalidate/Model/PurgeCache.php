...
class PurgeCache {
	 ...
	 */
	public function __construct(\Magento\PageCache\Model\Cache\Server $cacheServer, \Magento\CacheInvalidate\Model\SocketFactory $socketAdapterFactory, InvalidateLogger $logger) {
	...
	public function sendPurgeRequest($tagsPattern) {
		...
		$headers = [ 
				self::HEADER_X_MAGENTO_TAGS_PATTERN => $tagsPattern 
		];
		$socketAdapter->setOptions ( [ 
				'timeout' => 10 
		] );

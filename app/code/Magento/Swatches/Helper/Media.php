...
class Media extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	public function getSwatchAttributeImage($swatchType, $file) {
		...
		$absoluteImagePath = $this->mediaDirectory->getAbsolutePath ( $this->getSwatchMediaPath () . '/' . $generationPath );
	...
	public function getSwatchMediaUrl() {
		return $this->storeManager->getStore ()->getBaseUrl ( \Magento\Framework\UrlInterface::URL_TYPE_MEDIA ) . $this->getSwatchMediaPath ();
	}

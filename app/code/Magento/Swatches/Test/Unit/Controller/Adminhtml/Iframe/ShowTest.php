...
class ShowTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->responseMock = $this->getMock ( '\Magento\Framework\App\Response', [ 
				'setBody' 
		], [ ], '', false );
		...
		$this->adapterFactoryMock = $this->getMock ( '\Magento\Framework\Image\AdapterFactory', [ 
				'create' 
		], [ ], '', false );
		$this->configMock = $this->getMock ( '\Magento\Catalog\Model\Product\Media\Config', [ ], [ ], '', false );
		$this->filesystemMock = $this->getMock ( '\Magento\Framework\Filesystem', [ ], [ ], '', false );
		$this->uploaderFactoryMock = $this->getMock ( '\Magento\MediaStorage\Model\File\UploaderFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->controller = $objectManager->getObject ( '\Magento\Swatches\Controller\Adminhtml\Iframe\Show', [ 
	...
	public function testExecuteException() {
		$this->uploaderFactoryMock->expects ( $this->once () )->method ( 'create' )->will ( $this->throwException ( new \Exception () ) );

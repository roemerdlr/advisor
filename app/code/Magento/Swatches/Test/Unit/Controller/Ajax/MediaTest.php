...
class MediaTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->requestMock->expects ( $this->any () )->method ( 'getParam' )->withConsecutive ( [ 
				...
				'additional' 
		] )->willReturnOnConsecutiveCalls ( 59, [ 
				'size' => 454 
		], [ 
				'color' => 43 
		] );
		...
		$this->controller = $this->objectManager->getObject ( '\Magento\Swatches\Controller\Ajax\Media', [ 
	...
	public function testExecute() {
		...
		$this->swatchHelperMock->expects ( $this->once () )->method ( 'getAttributesFromConfigurable' )->with ( $this->productMock )->willReturn ( [ 
				$this->attributeMock 
		] );
		
		$this->swatchHelperMock->expects ( $this->once () )->method ( 'loadVariationByFallback' )->with ( $this->productMock, [ 
				'size' => 454,
				'color' => 43 

...
class MediaTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->writeInstanceMock = $this->getMock ( '\Magento\Framework\Filesystem\Directory\WriteInterface', [ ], [ ], '', false );
		$this->fileStorageDbMock = $this->getMock ( '\Magento\MediaStorage\Helper\File\Storage\Database', [ 
				'checkDbUsage',
				'getUniqueFilename',
				'renameFile' 
		], [ ], '', false );
		...
		$this->themeCollectionMock = $this->getMock ( '\Magento\Theme\Model\ResourceModel\Theme\Collection', [ 
				'loadRegisteredThemes' 
		], [ ], '', false );
		
		$this->viewConfigMock = $this->getMock ( '\Magento\Framework\View\Config', [ ], [ ], '', false );
		...
		$this->fileSystemMock->expects ( $this->any () )->method ( 'getDirectoryWrite' )->will ( $this->returnValue ( $this->mediaDirectoryMock ) );
		
		$this->mediaHelperObject = $objectManager->getObject ( '\Magento\Swatches\Helper\Media', [ 
	...
	public function testGenerateSwatchVariations() {
		...
		$image = $this->getMock ( '\Magento\Framework\Image', [ 
				'resize',
				'save',
				'keepTransparency',
				'constrainOnly',

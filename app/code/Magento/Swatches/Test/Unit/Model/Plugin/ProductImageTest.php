...
class ProductImageTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->swatchesHelperMock = $this->getMock ( '\Magento\Swatches\Helper\Data', [ 
				'loadVariationByFallback',
				'isSwatchAttribute' 
		], [ ], '', false );
		
		$this->attributeFactoryMock = $this->getMock ( '\Magento\Catalog\Model\ResourceModel\Eav\AttributeFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->eavConfigMock = $this->getMock ( '\Magento\Eav\Model\Config', [ ], [ ], '', false );
		
		$this->attributeMock = $this->getMock ( '\Magento\Catalog\Model\ResourceModel\Eav\Attribute', [ 
				'loadByCode',
				'getId',
		...
		$this->pluginModel = $objectManager->getObject ( 'Magento\Swatches\Model\Plugin\ProductImage', [ 

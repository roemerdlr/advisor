...
class FilterRendererTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->swatchHelperMock = $this->getMock ( '\Magento\Swatches\Helper\Data', [ 
				'isSwatchAttribute' 
		], [ ], '', false );
		
		$this->blockMock = $this->getMock ( '\Magento\Swatches\Block\LayeredNavigation\RenderLayered', [ 
				'setSwatchFilter',
				'toHtml' 
		], [ ], '', false );
		
		$this->filterMock = $this->getMock ( '\Magento\Catalog\Model\Layer\Filter\AbstractFilter', [ 
				'getAttributeModel',
				'hasAttributeModel' 
		], [ ], '', false );
		
		$this->filterRendererMock = $this->getMock ( '\Magento\LayeredNavigation\Block\Navigation\FilterRenderer', [ ], [ ], '', false );
		...
		$this->plugin = $objectManager->getObject ( 'Magento\Swatches\Model\Plugin\FilterRenderer', [ 

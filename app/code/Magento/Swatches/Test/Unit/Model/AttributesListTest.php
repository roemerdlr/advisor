...
class AttributesListTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$collectionFactoryMock = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Product\Attribute\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->attributeListModel = new \Magento\Swatches\Model\AttributesList ( $collectionFactoryMock, $this->swatchHelper );
	}
	public function testGetAttributes() {
		...
		$source->expects ( $this->once () )->method ( 'getAllOptions' )->with ( false )->will ( $this->returnValue ( [ 
				'options' 
		] ) );

...
class InstructionsConfigProviderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->methodOneMock = $this->getMock ( 'Magento\Payment\Model\Method\AbstractMethod', [ 
				'isAvailable',
				'getInstructions' 
		], [ ], '', false );
		$this->methodTwoMock = $this->getMock ( 'Magento\Payment\Model\Method\AbstractMethod', [ 
				'isAvailable',
				'getInstructions' 
		], [ ], '', false );
		
		$paymentHelperMock = $this->getMock ( 'Magento\Payment\Helper\Data', [ ], [ ], '', false );
		$paymentHelperMock->expects ( $this->exactly ( 2 ) )->method ( 'getMethodInstance' )->willReturnMap ( [ 
				[ 

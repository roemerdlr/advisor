...
class SetCanApplyMsrpObserver implements ObserverInterface {
	 ...
	 */
	public function __construct(\Magento\Msrp\Model\Config $config, \Magento\Msrp\Model\Quote\Address\CanApplyMsrp $canApplyMsrp, \Magento\Msrp\Model\Quote\Msrp $msrp) {
		$this->config = $config;

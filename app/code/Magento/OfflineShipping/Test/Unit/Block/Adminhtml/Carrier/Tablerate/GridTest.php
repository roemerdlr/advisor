...
class GridTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->backendHelperMock = $this->getMockBuilder ( '\Magento\Backend\Helper\Data' )->disableOriginalConstructor ()->getMock ();
		
		$this->collectionFactoryMock = $this->getMockBuilder ( '\Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\CollectionFactory' )->disableOriginalConstructor ()->getMock ();
		...
		$this->model = new \Magento\OfflineShipping\Block\Adminhtml\Carrier\Tablerate\Grid ( $this->context, $this->backendHelperMock, $this->collectionFactoryMock, $this->tablerateMock );
	}
	public function testSetWebsiteId() {
		...
		$this->storeManagerMock->expects ( $this->once () )->method ( 'getWebsite' )->with ( $websiteId )->willReturn ( $websiteMock );
	...
	public function testGetWebsiteId() {
		...
		$websiteMock = $this->getMockBuilder ( 'Magento\Store\Model\Website' )->disableOriginalConstructor ()->setMethods ( [ 
				'getId' 
		] )->getMock ();

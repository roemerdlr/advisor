...
class ExportTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$backendUrl->expects ( $this->once () )->method ( 'getUrl' )->with ( "*/*/exportTablerates", [ 
				'website' => 1 
		] );
		
		$objectManager = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		$this->_object = $objectManager->getObject ( 'Magento\OfflineShipping\Block\Adminhtml\Form\Field\Export', [ 
	...
	public function testGetElementHtml() {
		...
		$form = $this->getMock ( 'Magento\Framework\Data\Form', [ 
				'getParent' 
		], [ ], '', false, false );
		...
		$mockData = $this->getMock ( 'StdClass', [ 
				'toHtml' 
		] );

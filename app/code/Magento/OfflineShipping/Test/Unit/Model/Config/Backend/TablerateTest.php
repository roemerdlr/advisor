...
class TablerateTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->tableateFactoryMock = $this->getMockBuilder ( 'Magento\OfflineShipping\Model\ResourceModel\Carrier\TablerateFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
	...
	public function testAfterSave() {
		$tablerateMock = $this->getMockBuilder ( 'Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate' )->disableOriginalConstructor ()->setMethods ( [ 
				'uploadAndImport' 
		] )->getMock ();

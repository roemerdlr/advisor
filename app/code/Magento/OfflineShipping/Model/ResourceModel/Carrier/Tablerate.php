...
class Tablerate extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
	...
	public function getRate(\Magento\Quote\Model\Quote\Address\RateRequest $request) {
		...
		$select = $connection->select ()->from ( $this->getMainTable () )->where ( 'website_id = :website_id' )->order ( [ 
	 ...
	 * @see https://wiki.corp.x.com/display/MCOMS/Magento+Filesystem+Decisions @SuppressWarnings(PHPMD.CyclomaticComplexity)

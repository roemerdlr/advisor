 ...
 */
class Flatrate extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements \Magento\Shipping\Model\Carrier\CarrierInterface {
	/**
	 *
	 * @var string
	 */
	 ...
	 * @return Result|bool @SuppressWarnings(PHPMD.CyclomaticComplexity)
	...
	public function getAllowedMethods() {
		return [ 
				'flatrate' => $this->getConfigData ( 'name' ) 
		];
	}
}

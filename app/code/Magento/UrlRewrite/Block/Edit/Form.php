...
class Form extends \Magento\Backend\Block\Widget\Form\Generic {
	...
	protected function _prepareForm() {
		...
		$fieldset->addField ( 'entity_type', 'hidden', [ 
				'name' => 'entity_type',
		...
		$fieldset->addField ( 'request_path', 'text', [ 
		...
		$fieldset->addField ( 'target_path', 'text', [ 
	...
	protected function _prepareStoreElement($fieldset) {
		if ($this->_storeManager->isSingleStoreMode ()) {
			...
			$storeElement = $fieldset->addField ( 'store_id', 'select', [ 
					'label' => __ ( 'Store' ),
					'title' => __ ( 'Store' ),
					'name' => 'store_id',
					'required' => true,

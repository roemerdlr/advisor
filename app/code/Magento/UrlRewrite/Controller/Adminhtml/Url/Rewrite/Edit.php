	...
	public function execute() {
		...
		switch ($mode) {
			case self::PRODUCT_MODE :
				$editBlock = $this->_view->getLayout ()->createBlock ( 'Magento\UrlRewrite\Block\Catalog\Product\Edit', '', [ 
						'data' => [ 
			...
			case self::CATEGORY_MODE :
				$editBlock = $this->_view->getLayout ()->createBlock ( 'Magento\UrlRewrite\Block\Catalog\Category\Edit', '', [ 
						'data' => [ 
								'category' => $this->_getCategory (),
								'url_rewrite' => $this->_getUrlRewrite () 
						] 
			...
			case self::CMS_PAGE_MODE :
				$editBlock = $this->_view->getLayout ()->createBlock ( 'Magento\UrlRewrite\Block\Cms\Page\Edit', '', [ 
						'data' => [ 
			...
			case self::ID_MODE :
			default :
				$editBlock = $this->_view->getLayout ()->createBlock ( 'Magento\UrlRewrite\Block\Edit', '', [ 
						'data' => [ 
								'url_rewrite' => $this->_getUrlRewrite () 
						] 
				] );

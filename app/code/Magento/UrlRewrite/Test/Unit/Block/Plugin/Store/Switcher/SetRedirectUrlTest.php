...
class SetRedirectUrlTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->unit = (new ObjectManager ( $this ))->getObject ( 'Magento\UrlRewrite\Block\Plugin\Store\Switcher\SetRedirectUrl', [ 
	...
	public function testGetTargetStorePostData() {
		...
		$this->assertEquals ( [ 
				$this->store,
				[ 
						\Magento\Framework\App\ActionInterface::PARAM_NAME_URL_ENCODED => 'encoded-path' 
				] 
		], $this->unit->beforeGetTargetStorePostData ( $this->switcher, $this->store, [ ] ) );
	}
}

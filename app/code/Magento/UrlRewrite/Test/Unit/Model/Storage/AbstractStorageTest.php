...
class AbstractStorageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->storage = $this->getMockForAbstractClass ( 'Magento\UrlRewrite\Model\Storage\AbstractStorage', [ 
	...
	public function testFindOneByDataIfNotFound() {
		...
		$this->storage->expects ( $this->once () )->method ( 'doFindOneByData' )->with ( $data )->will ( $this->returnValue ( null ) );
	...
	public function testReplaceIfThrewDuplicateEntryExceptionWithCustomMessage() {
		$this->storage->expects ( $this->once () )->method ( 'doReplace' )->will ( $this->throwException ( new \Magento\Framework\Exception\AlreadyExistsException ( __ ( 'Custom storage message' ) ) ) );

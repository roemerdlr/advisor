...
class SaveInventoryDataObserver implements ObserverInterface {
	 ...
	 */
	public function __construct(StockIndexInterface $stockIndex, StockConfigurationInterface $stockConfiguration, StockRegistryInterface $stockRegistry, StockItemRepositoryInterface $stockItemRepository) {
	 ...
	 * Product qty calculated dynamically.
	 *

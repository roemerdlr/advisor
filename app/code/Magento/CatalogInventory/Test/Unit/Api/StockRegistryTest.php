...
class StockRegistryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->stockRegistryProvider = $this->getMockForAbstractClass ( 'Magento\CatalogInventory\Model\Spi\StockRegistryProviderInterface', [ 
				'getStock',
				'getStockItem',
				'getStockStatus' 
		], '', false );
		...
		$this->stockRegistry = $this->objectManagerHelper->getObject ( '\Magento\CatalogInventory\Model\StockRegistry', [ 
	...
	public function testGetStockItemBySku() {
		$this->assertEquals ( $this->stockItem, $this->stockRegistry->getStockItemBySku ( $this->productSku, $this->websiteId ) );
	}

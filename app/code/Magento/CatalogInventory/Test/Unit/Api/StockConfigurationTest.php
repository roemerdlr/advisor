...
class StockConfigurationTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->config = $this->getMockForAbstractClass ( 'Magento\Catalog\Model\ProductTypes\ConfigInterface', [ ], '', false );
		$this->scopeConfig = $this->getMockForAbstractClass ( 'Magento\Framework\App\Config\ScopeConfigInterface', [ 
				'isSetFlag' 
		], '', false );
		
		$this->minsaleqtyHelper = $this->getMock ( 'Magento\CatalogInventory\Helper\Minsaleqty', [ ], [ ], '', false );
		
		$this->objectManagerHelper = new ObjectManagerHelper ( $this );
		$this->stockConfiguration = $this->objectManagerHelper->getObject ( 'Magento\CatalogInventory\Model\Configuration', [ 
				'config' => $this->config,

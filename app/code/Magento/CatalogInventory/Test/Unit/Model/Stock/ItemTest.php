...
class ItemTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->resource = $this->getMock ( 'Magento\CatalogInventory\Model\ResourceModel\Stock\Item', [ ], [ ], '', false );
		
		$this->resourceCollection = $this->getMock ( 'Magento\CatalogInventory\Model\ResourceModel\Stock\Item\Collection', [ ], [ ], '', false );
		
		$this->objectManagerHelper = new ObjectManagerHelper ( $this );
		
		$this->item = $this->objectManagerHelper->getObject ( 'Magento\CatalogInventory\Model\Stock\Item', [ 

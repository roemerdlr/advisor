...
class AroundProductRepositorySaveTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->plugin = new \Magento\CatalogInventory\Model\Plugin\AroundProductRepositorySave ( $this->stockRegistry, $this->storeManager );
		...
		$this->stockItemMock = $this->getMockBuilder ( 'Magento\CatalogInventory\Api\Data\StockItemInterface' )->setMethods ( [ 
				'setWebsiteId',
				'getWebsiteId' 
	...
	public function testAroundSaveWhenProductHasNoStockItemNeedingToBeUpdated() {
		...
		$this->assertEquals ( $this->savedProductMock, $this->plugin->aroundSave ( $this->productRepositoryMock, $this->closureMock, $this->productMock ) );
	}
	public function testAroundSaveWhenProductHasNoPersistentStockItemInfo() {
		...
		$this->productExtensionMock->expects ( $this->once () )->method ( 'getStockItem' )->willReturn ( null );

...
class ItemTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$resourceMock = $this->getMock ( 'Magento\Framework\Model\ResourceModel\AbstractResource', [ 
				'_construct',
				'getConnection',
				'getIdFieldName' 
		], [ ], '', false );
		...
		$this->_model = $objectHelper->getObject ( '\Magento\CatalogInventory\Model\Adminhtml\Stock\Item', [ 

...
class CatalogInventoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->duplicateMock = $this->getMock ( '\Magento\Catalog\Model\Product', [ 
				'setStockData',
				'__wakeup' 
		], [ ], '', false );
		
		$this->stockItemDoMock = $this->getMockForAbstractClass ( 'Magento\CatalogInventory\Api\Data\StockItemInterface', [ 
				'getItemId',
		...
		$this->model = $this->objectManager->getObject ( 'Magento\CatalogInventory\Model\Product\CopyConstructor\CatalogInventory', [ 

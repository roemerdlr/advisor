...
class StockTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_factoryElementMock = $this->getMock ( 'Magento\Framework\Data\Form\Element\Factory', [ ], [ ], '', false );
		$this->_collectionFactoryMock = $this->getMock ( 'Magento\Framework\Data\Form\Element\CollectionFactory', [ ], [ ], '', false );
		$this->_qtyMock = $this->getMock ( 'Magento\Framework\Data\Form\Element\Text', [ 
				'setForm',
				'setValue',
				'setName' 
		], [ ], '', false );
		$this->_factoryTextMock = $this->getMock ( 'Magento\Framework\Data\Form\Element\TextFactory', [ ], [ ], '', false );
	...
	public function testSetForm() {
		...
		$this->_block->setForm ( $objectManager->getObject ( 'Magento\Framework\Data\Form\Element\Text', [ 
				'factoryElement' => $this->_factoryElementMock,
				'factoryCollection' => $this->_collectionFactoryMock 
		] ) );
	}

...
class ProductViewTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->stockItem = $this->getMockBuilder ( '\Magento\CatalogInventory\Model\Stock\Item' )->disableOriginalConstructor ()->setMethods ( [ 
				'getQtyMinAllowed',
				'getQtyMaxAllowed',
				'getQtyIncrements' 
		] )->getMock ();
		...
		$this->block = $objectManager->getObject ( 'Magento\CatalogInventory\Block\Plugin\ProductView', [ 

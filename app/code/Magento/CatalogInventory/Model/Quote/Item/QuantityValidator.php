...
class QuantityValidator {
	 ...
	 */
	public function __construct(QuantityValidator\Initializer\Option $optionInitializer, QuantityValidator\Initializer\StockItem $stockItemInitializer, StockRegistryInterface $stockRegistry, StockStateInterface $stockState) {
	...
	public function validate(\Magento\Framework\Event\Observer $observer) {
		 ...
		 * For composite products check base (parent) item stock status
		 */

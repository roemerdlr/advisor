...
class Customergroup extends \Magento\Framework\View\Element\Html\Select {
	 ...
	 * @param array $data        	
	 */
	public function __construct(\Magento\Framework\View\Element\Context $context, GroupManagementInterface $groupManagement, GroupRepositoryInterface $groupRepository, SearchCriteriaBuilder $searchCriteriaBuilder, array $data = []) {
	 ...
	 *
	 * @param int $groupId
	 *        	return name by customer group id
	 * @return array|string
	 */

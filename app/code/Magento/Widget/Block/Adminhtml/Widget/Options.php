...
class Options extends \Magento\Backend\Block\Widget\Form\Generic {
	 ...
	 * @return \Magento\Framework\Data\Form\Element\AbstractElement @SuppressWarnings(PHPMD.CyclomaticComplexity)
	...
	protected function _addField($parameter) {
		...
		if ($helper = $parameter->getHelperBlock ()) {
			$helperBlock = $this->getLayout ()->createBlock ( $helper->getType (), '', [ 
					'data' => $helper->getData () 
			] );

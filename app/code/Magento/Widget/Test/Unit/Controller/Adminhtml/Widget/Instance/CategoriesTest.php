...
class CategoriesTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->chooser = $this->getMock ( $this->blockClass, [ 
				'setUseMassaction',
				'setId',
				'setIsAnchorOnly',
	...
	public function testExecute() {
		...
		$this->chooser->expects ( $this->once () )->method ( 'setSelectedCategories' )->with ( explode ( ',', $selectedCategories ) )->willReturnSelf ();
		...
		$this->resultFactory->expects ( $this->once () )->method ( 'create' )->with ( \Magento\Framework\Controller\ResultFactory::TYPE_RAW )->willReturn ( $this->resultRaw );
		...
		$this->controller = (new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this ))->getObject ( 'Magento\Widget\Controller\Adminhtml\Widget\Instance\Categories', [ 

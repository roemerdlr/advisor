...
class ChooserTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->childNode = $this->getMock ( 'Magento\Framework\Data\Tree\Node', [ 
				'getLevel',
				'hasChildren' 
		], [ ], '', false );
		$this->rootNode = $this->getMock ( 'Magento\Framework\Data\Tree\Node', [ 
				'getLevel',
				'hasChildren',
				'getChildren' 
		], [ ], '', false );
	...
	public function testGetTreeHasLevelField() {
		...
		$chooser = (new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this ))->getObject ( 'Magento\Widget\Block\Adminhtml\Widget\Catalog\Category\Chooser', [ 

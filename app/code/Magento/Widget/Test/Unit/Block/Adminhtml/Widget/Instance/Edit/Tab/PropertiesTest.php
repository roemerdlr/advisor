...
class PropertiesTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->propertiesBlock = $objectManager->getObject ( 'Magento\Widget\Block\Adminhtml\Widget\Instance\Edit\Tab\Properties', [ 
	...
	public function testIsHidden($widgetConfig, $isHidden) {
		...
		$this->registry->expects ( $this->atLeastOnce () )->method ( 'registry' )->with ( 'current_widget_instance' )->willReturn ( $this->widget );

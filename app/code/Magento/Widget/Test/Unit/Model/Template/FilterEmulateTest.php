...
class FilterEmulateTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->filterEmulate = $this->objectManagerHelper->getObject ( 'Magento\Widget\Model\Template\FilterEmulate', [ 
	...
	public function testWidgetDirective() {
		...
		$this->appStateMock->expects ( $this->once () )->method ( 'emulateAreaCode' )->with ( 'frontend', [ 
				$this->filterEmulate,
				'generateWidget' 
		], [ 
				$construction 

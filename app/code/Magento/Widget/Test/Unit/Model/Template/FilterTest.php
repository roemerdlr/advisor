...
class FilterTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->filter = $this->objectManagerHelper->getObject ( 'Magento\Widget\Model\Template\Filter', [ 
	 ...
	 * @return void @dataProvider generateWidgetDataProvider
	 */
	public function testGenerateWidget($construction, $name, $type, $preConfigId, $params, $preconfigure, $widgetXml, $widgetBlock, $expectedResult) {
	...
	protected function generalForGenerateWidget($name, $type, $preConfigId, $params, $preconfigure, $widgetXml, $widgetBlock) {
		...
		$this->layoutMock->expects ( $this->any () )->method ( 'createBlock' )->with ( $type, $name, [ 
				'data' => $params 
	...
	protected function getBlockMock($returnedResult = '') {
		...
		$blockMock = $this->getMockBuilder ( 'Magento\Widget\Block\BlockInterface' )->setMethods ( [ 
				'toHtml' 
		] )->getMockForAbstractClass ();
		$blockMock->expects ( $this->any () )->method ( 'toHtml' )->willReturn ( $returnedResult );

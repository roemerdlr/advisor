...
class NamespaceResolverTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->moduleListMock = $this->getMockBuilder ( 'Magento\Framework\Module\ModuleListInterface' )->getMockForAbstractClass ();
		
		$this->namespaceResolver = $objectManager->getObject ( 'Magento\Widget\Model\NamespaceResolver', [ 

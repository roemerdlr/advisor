...
class AllowedIpsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$eventMangerMock = $this->getMockBuilder ( '\Magento\Framework\Event\ManagerInterface' )->disableOriginalConstructor ()->getMock ();
		$contextMock->expects ( $this->any () )->method ( 'getEventDispatcher' )->willReturn ( $eventMangerMock );
		
		$objectManagerHelper = new ObjectManagerHelper ( $this );
		$escaper = $objectManagerHelper->getObject ( '\Magento\Framework\Escaper' );
		$this->model = $objectManagerHelper->getObject ( 'Magento\Developer\Model\Config\Backend\AllowedIps', [ 
				'context' => $contextMock,
				'escaper' => $escaper 
		] );
	}
	...
	public function beforeSaveDataProvider() {
		return [ 
				...
				[ 
						'10.64.206.85, 10.64.1a.x, ,,',
						'10.64.206.85' 
				],
				[ 
						' ,, 10.64.206.85, 10.49.206.85 , ',
						'10.64.206.85, 10.49.206.85' 
				],
				[ 
            ...
            [ 
						'*[789bo88n=], 12.34.56.78,[,q 049cq9840@@',
						'12.34.56.78' 
				] 
		];
	}

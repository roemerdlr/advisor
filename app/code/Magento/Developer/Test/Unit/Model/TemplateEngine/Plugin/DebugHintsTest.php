...
class DebugHintsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->devHelperMock = $this->getMockBuilder ( 'Magento\Developer\Helper\Data' )->disableOriginalConstructor ()->getMock ();
		
		$this->debugHintsFactory = $this->getMockBuilder ( 'Magento\Developer\Model\TemplateEngine\Decorator\DebugHintsFactory' )->setMethods ( [ 
				'create' 
	 ...
	 * @return void @dataProvider afterCreateActiveDataProvider
	 */
	public function testAfterCreateActive($debugHintsPath, $showBlockHints) {
		$this->devHelperMock->expects ( $this->once () )->method ( 'isDevAllowed' )->willReturn ( true );
		...
		$debugHintsDecorator = $this->getMockBuilder ( 'Magento\Developer\Model\TemplateEngine\Decorator\DebugHints' )->disableOriginalConstructor ()->getMock ();
		
		$this->debugHintsFactory->expects ( $this->once () )->method ( 'create' )->with ( [ 
				'subject' => $engine,
	 ...
	 * @return void @dataProvider afterCreateInactiveDataProvider
	 */

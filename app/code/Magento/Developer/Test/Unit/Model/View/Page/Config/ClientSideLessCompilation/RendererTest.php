...
class RendererTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->model = $this->getMock ( 'Magento\Developer\Model\View\Page\Config\ClientSideLessCompilation\Renderer', [ 
				'renderAssetGroup' 
		], $mocks );
	}
	...
	public function testRenderLessJsScripts() {
		...
		$propertyGroups = [ 
				$this->getMockBuilder ( 'Magento\Framework\View\Asset\PropertyGroup' )->disableOriginalConstructor ()->getMock () 
		];
		...
		// Call method
		$this->assertSame ( $resultGroups, $this->model->renderAssets ( [ 
				'js' => '' 
		] ) );
	}
}

...
class DebugHints {
	 ...
	 */
	public function __construct(ScopeConfigInterface $scopeConfig, StoreManagerInterface $storeManager, DevHelper $devHelper, DebugHintsFactory $debugHintsFactory, $debugHintsPath) {
	 ...
	 *
	 * @return TemplateEngineInterface @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

...
class Renderer extends Config\Renderer {
	 ...
	 */
	public function __construct(Config $pageConfig, \Magento\Framework\View\Asset\MergeService $assetMergeService, \Magento\Framework\UrlInterface $urlBuilder, \Magento\Framework\Escaper $escaper, \Magento\Framework\Stdlib\StringUtils $string, \Psr\Log\LoggerInterface $logger, \Magento\Framework\View\Asset\Repository $assetRepo) {
	...
	protected function renderAssetHtml($template, $assets) {
		...
		try {
			foreach ( $assets as $asset ) {
				...
				if ($asset instanceof \Magento\Framework\View\Asset\File && $asset->getSourceUrl () != $asset->getUrl ()) {

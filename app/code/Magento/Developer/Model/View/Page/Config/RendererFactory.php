...
class RendererFactory extends \Magento\Framework\View\Page\Config\RendererFactory {
	 ...
	 */
	public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, array $rendererTypes = []) {
	...
	public function create(array $data = []) {
		...
		return $this->objectManager->create ( $this->rendererTypes [$renderer], $data );
	}
}

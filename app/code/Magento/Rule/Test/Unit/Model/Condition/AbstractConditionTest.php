...
class AbstractConditionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->_condition = $this->getMockForAbstractClass ( '\Magento\Rule\Model\Condition\AbstractCondition', [ ], '', false, false, true, [ 
				'getInputType' 
		] );
	}

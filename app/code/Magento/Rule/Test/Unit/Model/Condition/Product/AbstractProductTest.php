...
class AbstractProductTest extends \PHPUnit_Framework_TestCase {
	...
	public function testValidateAttributeEqualCategoryId() {
		$product = $this->getMock ( 'Magento\Framework\Model\AbstractModel', [ 
				"getAttribute" 
		], [ ], '', false );
	...
	public function testValidateEmptyEntityAttributeValues() {
		...
		$product->expects ( $this->once () )->method ( 'getResource' )->willReturn ( null );
		$product->setId ( 1 );
		$configProperty = new \ReflectionProperty ( 'Magento\Rule\Model\Condition\Product\AbstractProduct', '_entityAttributeValues' );
	...
	public function testValidateEmptyEntityAttributeValuesWithResource() {
		...
		$newResource = $this->getMock ( '\Magento\Catalog\Model\ResourceModel\Product', [ 
				'getAttribute' 
		], [ ], '', false );
	...
	public function testPrepareValueOptions($setData, $attributeObjectFrontendInput, $attrObjectSourceAllOptionsValue, $attrSetCollectionOptionsArray, $expectedAttrObjSourceAllOptionsParam, $expectedValueSelectOptions, $expectedValueOption) {
		...
		$attrObjectSourceMock = $this->getMockBuilder ( 'Magento\Eav\Model\Entity\Attribute\Source\AbstractSource' )->setMethods ( [ 
				'getAllOptions' 
		...
		$attributeObjectMock = $this->getMockBuilder ( 'Magento\Catalog\Model\ResourceModel\Eav\Attribute' )->setMethods ( [ 
				'usesSource',
				'getFrontendInput',
				'getSource',
				'getAllOptions' 
		...
		$entityTypeMock = $this->getMockBuilder ( 'Magento\Framework\Model\AbstractModel\Type' )->setMethods ( [ 
				'getId' 
		] )->disableOriginalConstructor ()->getMock ();
		$entityTypeMock->method ( 'getId' )->willReturn ( 'SomeEntityType' );
		
		$configValueMock = $this->getMock ( 'Magento\Eav\Model\Config', [ 
				'getAttribute',
				'getEntityType' 
		], [ ], '', false );
		...
		$attrSetCollectionValueMock = $this->getMockBuilder ( 'Magento\Eav\Model\ResourceModel\Entity\Attribute\Set\Collection' )->setMethods ( [ 
				'setEntityTypeFilter',
				'load',
				'toOptionArray' 
		] )->disableOriginalConstructor ()->getMock ();
		...
		return [ 
				...
				[ 
						...
						[ 
								[ 
										'value' => 'value5',
										'label' => 'Label for value 5' 
								],
								[ 
										'value' => 'value6',
										'label' => 'Label for value 6' 
								] 
						],
						[ 
								'value5' => 'Label for value 5',
				...
				[ 
						...
						[ 
								[ 
										'value' => 'value7',
										'label' => 'Label for value 7' 
								],
								[ 
										'value' => 'value8',
										'label' => 'Label for value 8' 
								] 
						],
						null,
						false,
				...
				[ 
						...
						[ 
								[ 
										'value' => 'valueA',
										'label' => 'Label for value A' 
								],
								[ 
										'value' => [ 
												'array value' 
										],
										'label' => 'Label for value B' 
								] 
						],
						null,
						false,

...
class AbstractCollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_db = $this->getMockForAbstractClass ( '\Magento\Framework\Model\ResourceModel\Db\AbstractDb', [ ], '', false, false, true, [ 
				'__sleep',
				'__wakeup' 
		] );
		$this->objectManagerHelper = new ObjectManagerHelper ( $this );
		$this->abstractCollection = $this->getMockForAbstractClass ( '\Magento\Rule\Model\ResourceModel\Rule\Collection\AbstractCollection', [ 
	...
	public function testAddWebsiteFilter() {
		...
		$this->assertInstanceOf ( '\Magento\Rule\Model\ResourceModel\Rule\Collection\AbstractCollection', $this->abstractCollection->addWebsiteFilter ( $website ) );
	}

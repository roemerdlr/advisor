...
class Synchronize extends \Magento\MediaStorage\Controller\Adminhtml\System\Config\System\Storage {
	...
	public function execute() {
		...
		if ($flag && $flag->getState () == \Magento\MediaStorage\Model\File\Storage\Flag::STATE_RUNNING && $flag->getLastUpdate () && time () <= strtotime ( $flag->getLastUpdate () ) + \Magento\MediaStorage\Model\File\Storage\Flag::FLAG_TTL) {
			return;
		}

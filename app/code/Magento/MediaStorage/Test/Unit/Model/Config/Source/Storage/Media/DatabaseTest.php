...
class DatabaseTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->deploymentConfig->expects ( $this->any () )->method ( 'get' )->with ( 'resource' )->will ( $this->returnValue ( [ 
				'default_setup' => [ 
						'name' => 'default_setup',
						'connection' => 'connect1' 
				],
	...
	public function testToOptionArray() {
		$this->assertNotEquals ( $this->mediaDatabase->toOptionArray (), [ 
				[ 
						'value' => 'default_setup',
						'label' => 'default_setup' 
				],
				[ 
						...
						'label' => 'custom_resource' 
				] 
		] );
		
		$this->assertEquals ( $this->mediaDatabase->toOptionArray (), [ 
				[ 
						'value' => 'custom_resource',
						'label' => 'custom_resource' 
				],
		...
		$this->assertEquals ( current ( $this->mediaDatabase->toOptionArray () ), [ 
				'value' => 'custom_resource',
				'label' => 'custom_resource' 
		] );
	}

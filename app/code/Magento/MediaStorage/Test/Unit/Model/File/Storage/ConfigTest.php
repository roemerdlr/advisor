...
class ConfigTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSave() {
		...
		$directory = $this->getMock ( 'Magento\Framework\Filesystem\Direcoty\Write', [ 
				'openFile',
				'getRelativePath' 
		], [ ], '', false );
		...
		$filesystem = $this->getMock ( 'Magento\Framework\Filesystem', [ 
				'getDirectoryWrite' 
		], [ ], '', false );
		$filesystem->expects ( $this->once () )->method ( 'getDirectoryWrite' )->with ( DirectoryList::ROOT )->will ( $this->returnValue ( $directory ) );

...
class FileTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->directoryReadMock = $this->getMock ( 'Magento\Framework\Filesystem\Directory\Read', [ 
				'isDirectory',
				'readRecursively' 
		], [ ], '', false );
		
		$this->storageFile = new \Magento\MediaStorage\Model\ResourceModel\File\Storage\File ( $this->filesystemMock, $this->loggerMock );
	}
	...
	public function testGetStorageData() {
		...
		$this->directoryReadMock->expects ( $this->any () )->method ( 'isDirectory' )->will ( $this->returnValueMap ( [ 
				[ 
						'/',
						true 
				],

...
class Storage extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	protected $_internalStorageList = [ 
			\Magento\MediaStorage\Model\File\Storage::STORAGE_MEDIA_FILE_SYSTEM 
	];
	 ...
	 */
	public function __construct(\Magento\Framework\App\Helper\Context $context, \Magento\MediaStorage\Helper\File\Storage\Database $coreFileStorageDb, \Magento\MediaStorage\Model\File\Storage $storage, \Magento\MediaStorage\Model\File\Storage\File $filesystemStorage) {
	...
	public function getCurrentStorageCode() {
		if ($this->_currentStorage === null) {
			$this->_currentStorage = ( int ) $this->scopeConfig->getValue ( \Magento\MediaStorage\Model\File\Storage::XML_PATH_STORAGE_MEDIA, 'default' );
		}

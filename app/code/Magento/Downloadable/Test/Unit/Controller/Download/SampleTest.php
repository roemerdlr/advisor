...
class SampleTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->sample = $this->objectManagerHelper->getObject ( 'Magento\Downloadable\Controller\Download\Sample', [ 
	...
	public function testExecuteLinkTypeUrl() {
		$sampleMock = $this->getMockBuilder ( 'Magento\Downloadable\Model\Sample' )->disableOriginalConstructor ()->setMethods ( [ 
				'getId',
				'load',
				'getSampleType',
				'getSampleUrl' 
		...
		$this->objectManager->expects ( $this->once () )->method ( 'create' )->with ( 'Magento\Downloadable\Model\Sample' )->willReturn ( $sampleMock );
		...
		$sampleMock->expects ( $this->once () )->method ( 'getSampleType' )->willReturn ( \Magento\Downloadable\Helper\Download::LINK_TYPE_URL );
	...
	public function testExecuteLinkTypeFile() {
		...
		$fileHelperMock = $this->getMockBuilder ( 'Magento\Downloadable\Helper\File' )->disableOriginalConstructor ()->setMethods ( [ 
				'getFilePath' 
		] )->getMock ();

...
class TypeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$resourceProductMock = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Product', [ 
				'getEntityType' 
		], [ ], '', false );
		...
		$eavConfigMock = $this->getMock ( '\Magento\Eav\Model\Config', [ 
		...
		$this->typeHandler = $this->getMockBuilder ( '\Magento\Downloadable\Model\Product\TypeHandler\TypeHandler' )->disableOriginalConstructor ()->setMethods ( [ 
				'save' 
		] )->getMock ();
		
		$this->target = $objectHelper->getObject ( 'Magento\Downloadable\Model\Product\Type', [ 

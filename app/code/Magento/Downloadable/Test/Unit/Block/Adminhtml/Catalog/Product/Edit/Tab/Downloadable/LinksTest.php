...
class LinksTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->downloadableLinkModel = $this->getMock ( '\Magento\Downloadable\Model\Link', [ 
				'__wakeup',
				'getId',
				'getTitle',
				'getPrice',
		...
		$this->block = $objectManagerHelper->getObject ( 'Magento\Downloadable\Block\Adminhtml\Catalog\Product\Edit\Tab\Downloadable\Links', [ 
	...
	public function testGetLinkData() {
		...
		$this->downloadableProductModel->expects ( $this->any () )->method ( 'getLinks' )->will ( $this->returnValue ( [ 
				$this->downloadableLinkModel 
		] ) );

	...
	public function execute(\Magento\Framework\Event\Observer $observer) {
		if (! $this->_checkoutSession->getHasDownloadableProducts ()) {
			...
			foreach ( $order->getAllItems () as $item ) {
				...
				if ($item->getProductType () == \Magento\Downloadable\Model\Product\Type::TYPE_DOWNLOADABLE || $item->getRealProductType () == \Magento\Downloadable\Model\Product\Type::TYPE_DOWNLOADABLE || $item->getProductOptionByCode ( 'is_downloadable' )) {

...
class AroundProductRepositorySave {
	 ...
	 */
	public function __construct(\Magento\Downloadable\Api\LinkRepositoryInterface $linkRepository, \Magento\Downloadable\Api\SampleRepositoryInterface $sampleRepository) {

...
class ProductOptionProcessor implements ProductOptionProcessorInterface {
	 ...
	 */
	public function __construct(DataObjectFactory $objectFactory, DataObjectHelper $dataObjectHelper, DownloadableOptionFactory $downloadableOptionFactory) {
	...
	public function convertToProductOption(DataObject $request) {
		...
		if (! empty ( $links ) && is_array ( $links )) {
			$this->dataObjectHelper->populateWithArray ( $downloadableOption, [ 

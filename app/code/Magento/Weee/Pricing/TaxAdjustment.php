...
class TaxAdjustment implements AdjustmentInterface {
	 ...
	 * @param int $sortOrder        	
	 */
	public function __construct(WeeeHelper $weeeHelper, TaxHelper $taxHelper, PriceCurrencyInterface $priceCurrency, $sortOrder = null) {
	...
	public function isIncludedInDisplayPrice() {
		...
		if ($this->weeeHelper->isEnabled () == true && $this->weeeHelper->isTaxable () == true && $this->weeeHelper->typeOfDisplay ( [ 
	...
	public function isExcludedWith($adjustmentCode) {
		return (($adjustmentCode == self::ADJUSTMENT_CODE) || ($adjustmentCode == \Magento\Tax\Pricing\Adjustment::ADJUSTMENT_CODE));
	}

...
class ContextPluginTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->contextPlugin = $this->objectManager->getObject ( 'Magento\Weee\Model\App\Action\ContextPlugin', [ 
	...
	public function testAroundDispatchBasedOnDefault() {
		...
		$this->taxHelperMock->expects ( $this->once () )->method ( 'getTaxBasedOn' )->willReturn ( 'billing' );
		...
		$this->weeeTaxMock->expects ( $this->once () )->method ( 'isWeeeInLocation' )->with ( 'US', 0, 1 )->willReturn ( true );
		
		$this->httpContextMock->expects ( $this->once () )->method ( 'setValue' )->with ( 'weee_tax_region', [ 
				'countryId' => 'US',
				'regionId' => 0 
		], 0 );
	...
	public function testAroundDispatchBasedOnOrigin() {
		...
		$this->taxHelperMock->expects ( $this->once () )->method ( 'getTaxBasedOn' )->willReturn ( 'origin' );

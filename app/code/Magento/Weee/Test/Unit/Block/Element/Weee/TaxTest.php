...
class TaxTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetEscapedValue() {
		...
		$collectionFactory = $this->getMock ( 'Magento\Framework\Data\Form\Element\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->model = $objectManager->getObject ( 'Magento\Weee\Block\Element\Weee\Tax', [ 
		...
		$this->model->setEntityAttribute ( new \Magento\Framework\DataObject ( [ 
				'store_id' => 1 
		] ) );

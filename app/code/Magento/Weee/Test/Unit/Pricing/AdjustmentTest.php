...
class AdjustmentTest extends \PHPUnit_Framework_TestCase {
	...
	public function testIsIncludedInDisplayPrice($expectedResult) {
		...
		$this->weeeHelper->expects ( $this->any () )->method ( 'typeOfDisplay' )->with ( $displayTypes )->will ( $this->returnValue ( $expectedResult ) );
	...
	public function testApplyAdjustment($amount, $amountOld, $expectedResult) {
		...
		$this->weeeHelper->expects ( $this->any () )->method ( 'getAmountExclTax' )->will ( $this->returnValue ( $amountOld ) );
	...
	public function testGetSortOrder($isTaxable, $expectedResult) {
		$this->weeeHelper->expects ( $this->any () )->method ( 'isTaxable' )->will ( $this->returnValue ( $isTaxable ) );

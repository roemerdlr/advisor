...
class TaxAdjustmentTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->weeeHelperMock = $this->getMock ( 'Magento\Weee\Helper\Data', [ 
				'typeOfDisplay',
				'isTaxable' 
		], [ ], '', false );
		
		$this->model = $this->objectManager->getObject ( '\Magento\Weee\Pricing\Render\TaxAdjustment', [ 
	...
	public function getDefaultExclusionsDataProvider() {
		return [ 
				'weee part of exclusions' => [ 
						true 
				],
				'weee not part of exclusions' => [ 
						false 
				] 
		];
	}

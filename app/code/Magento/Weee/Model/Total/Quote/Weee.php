...
class Weee extends AbstractTotal {
	 ...
	 */
	public function __construct(\Magento\Weee\Helper\Data $weeeData, PriceCurrencyInterface $priceCurrency) {
	 ...
	 * @return void|$this @SuppressWarnings(PHPMD.ExcessiveMethodLength)
	 ...
	 * @param \Magento\Quote\Model\Quote $quote        	
	 * @param \Magento\Quote\Model\Quote\Address\Total $total        	
	 * @return array|null @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

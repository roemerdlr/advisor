...
class WeeeConfigProvider implements ConfigProviderInterface {
	 ...
	 */
	public function __construct(WeeeHelper $weeeHelper, StoreManagerInterface $storeManager, Config $weeeConfig) {
	...
	public function iDisplayPriceWithWeeeDetails() {
		...
		], 'cart', $this->storeManager->getStore ()->getId () );
	...
	public function isDisplayFinalPrice() {
		$flag = $this->weeeHelper->typeOfDisplay ( WeeeDisplayConfig::DISPLAY_EXCL_DESCR_INCL, 'cart', $this->storeManager->getStore ()->getId () );

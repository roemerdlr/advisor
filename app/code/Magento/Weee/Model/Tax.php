...
class Tax extends \Magento\Framework\Model\AbstractModel {
	 ...
	 * @return float
	 */
	public function getWeeeAmountExclTax($product, $shipping = null, $billing = null, $website = null) {
		$amountExclTax = 0;
		$attributes = $this->getProductWeeeAttributes ( $product, $shipping, $billing, $website, true, false );
		foreach ( $attributes as $attribute ) {
	...
	public function getProductWeeeAttributes($product, $shipping = null, $billing = null, $website = null, $calculateTax = null, $round = true) {
		...
		foreach ( $productAttributes as $attribute ) {
			...
			if ($value) {
				...
				$one->setName ( __ ( $attribute ['label_value'] ? $attribute ['label_value'] : $attribute ['frontend_label'] ) )->setAmount ( $amount )->setTaxAmount ( $taxAmount )->setAmountExclTax ( $amountExclTax )->setCode ( $attribute ['attribute_code'] );

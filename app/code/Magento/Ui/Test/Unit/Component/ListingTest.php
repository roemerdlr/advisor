...
class ListingTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetComponentName() {
		/** @var Listing $listing */
		$listing = $this->objectManager->getObject ( 'Magento\Ui\Component\Listing', [ 
	...
	public function testPrepare() {
		...
		$this->contextMock->expects ( $this->once () )->method ( 'addComponentDefinition' )->with ( $listing->getComponentName (), [ 
				'extends' => 'test_config_extends',
				'testData' => 'testValue' 
		] );

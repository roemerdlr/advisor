...
class PagingTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetComponentName() {
		/** @var Paging $listing */
		$paging = $this->objectManager->getObject ( 'Magento\Ui\Component\Paging', [ 
	...
	public function testPrepare() {
		...
		$this->contextMock->expects ( $this->once () )->method ( 'getRequestParam' )->with ( 'paging' )->willReturn ( [ 
				'pageSize' => 5,
				'current' => 3 
		] );
		...
		$this->contextMock->expects ( $this->once () )->method ( 'addComponentDefinition' )->with ( $paging->getComponentName (), [ 
				'extends' => 'test_config_extends',
				'testData' => 'testValue' 
		] );

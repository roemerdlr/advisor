...
class DateTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetComponentName() {
		$date = new Date ( $this->contextMock, $this->uiComponentFactory, $this->filterBuilderMock, $this->filterModifierMock, [ ] );
	...
	public function testPrepare($name, $filterData, $expectedCondition) {
		...
		$this->contextMock->expects ( $this->any () )->method ( 'getNamespace' )->willReturn ( Date::NAME );
		$this->contextMock->expects ( $this->any () )->method ( 'addComponentDefinition' )->with ( Date::NAME, [ 
				'extends' => Date::NAME 
		] );
		...
		$this->uiComponentFactory->expects ( $this->any () )->method ( 'create' )->with ( $name, Date::COMPONENT, [ 

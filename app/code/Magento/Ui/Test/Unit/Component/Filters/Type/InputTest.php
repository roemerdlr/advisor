...
class InputTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetComponentName() {
		$date = new Input ( $this->contextMock, $this->uiComponentFactory, $this->filterBuilderMock, $this->filterModifierMock, [ ] );
	...
	public function testPrepare($name, $filterData, $expectedCondition) {
		...
		$this->contextMock->expects ( $this->any () )->method ( 'addComponentDefinition' )->with ( Input::NAME, [ 
				'extends' => Input::NAME 
		] );
		...
		$this->uiComponentFactory->expects ( $this->any () )->method ( 'create' )->with ( $name, Input::COMPONENT, [ 

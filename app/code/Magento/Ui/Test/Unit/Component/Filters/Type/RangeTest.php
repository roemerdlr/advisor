...
class RangeTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetComponentName() {
		$range = new Range ( $this->contextMock, $this->uiComponentFactory, $this->filterBuilderMock, $this->filterModifierMock, [ ] );
	...
	public function testPrepare($name, $filterData, $expectedCondition) {
		...
		$this->contextMock->expects ( $this->any () )->method ( 'addComponentDefinition' )->with ( Range::NAME, [ 
				'extends' => Range::NAME 
		] );

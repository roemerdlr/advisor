...
class FilterModifierTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->dataProvider = $this->getMockForAbstractClass ( 'Magento\Framework\View\Element\UiComponent\DataProvider\DataProviderInterface' );
		$this->filterBuilder = $this->getMock ( 'Magento\Framework\Api\FilterBuilder', [ ], [ ], '', false );
		$this->unit = (new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this ))->getObject ( 'Magento\Ui\Component\Filters\FilterModifier', [ 
	...
	public function testNotApplyFilterModifier() {
		$this->request->expects ( $this->once () )->method ( 'getParam' )->with ( \Magento\Ui\Component\Filters\FilterModifier::FILTER_MODIFIER )->willReturn ( [ ] );
	...
	/**
	 *
	 * @return void @assertException \Magento\Framework\Exception\LocalizedException
	 */
	 ...
	 * @param
	 *        	$value
	 * @return void @dataProvider getApplyFilterModifierDataProvider
	 */

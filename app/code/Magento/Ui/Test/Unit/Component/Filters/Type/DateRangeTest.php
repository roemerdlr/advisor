...
class DateRangeTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetComponentName() {
		$dateRange = new DateRange ( $this->contextMock, $this->uiComponentFactory, $this->filterBuilderMock, $this->filterModifierMock, [ ] );
	...
	public function testPrepare($name, $filterData, $expectedCondition) {
		...
		$this->contextMock->expects ( $this->any () )->method ( 'addComponentDefinition' )->with ( DateRange::NAME, [ 
				'extends' => DateRange::NAME 
		] );
		...
		$this->uiComponentFactory->expects ( $this->any () )->method ( 'create' )->with ( $name, DateRange::COMPONENT, [ 

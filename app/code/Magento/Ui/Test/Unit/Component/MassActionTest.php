...
class MassActionTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetComponentName() {
		...
		$massAction = $this->objectManager->getObject ( 'Magento\Ui\Component\MassAction', [ 
	 ...
	 * @return void @dataProvider getPrepareDataProvider
	 */
	public function testPrepare($componentName, $componentData) {
		/** @var \Magento\Ui\Component\Action $action */
		$action = $this->objectManager->getObject ( 'Magento\Ui\Component\MassAction', [ 
				'context' => $this->contextMock,
				'data' => [ 
						'name' => $componentName,

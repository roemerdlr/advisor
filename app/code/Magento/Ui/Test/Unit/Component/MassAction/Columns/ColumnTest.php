...
class ColumnTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->column = $this->objectManager->getObject ( 'Magento\Ui\Component\MassAction\Columns\Column', [ 
	...
	public function testPrepare() {
		...
		$this->contextMock->expects ( $this->once () )->method ( 'getNamespace' )->willReturn ( 'test_namespace' );
		$this->contextMock->expects ( $this->once () )->method ( 'addComponentDefinition' )->with ( $this->column->getComponentName (), [ 
				'extends' => 'test_namespace' 
		] );

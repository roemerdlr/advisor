...
class DateTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->timezoneMock = $this->getMockBuilder ( 'Magento\Framework\Stdlib\DateTime\TimezoneInterface' )->disableOriginalConstructor ()->getMock ();
		
		$this->model = $this->objectManager->getObject ( 'Magento\Ui\Component\Listing\Columns\Date', [ 

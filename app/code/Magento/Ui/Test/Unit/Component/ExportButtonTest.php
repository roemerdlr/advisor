...
class ExportButtonTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$context = $this->getMockBuilder ( 'Magento\Framework\View\Element\UiComponent\ContextInterface' )->getMockForAbstractClass ();
		...
		$this->model = $this->objectManager->getObject ( 'Magento\Ui\Component\ExportButton', [ 
	...
	public function testPrepare() {
		...
		$this->urlBuilderMock->expects ( $this->once () )->method ( 'getUrl' )->with ( 'test_url' )->willReturnArgument ( 0 );

...
class RenderTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->uiFactoryMock = $this->getMockBuilder ( 'Magento\Framework\View\Element\UiComponentFactory' )->disableOriginalConstructor ()->getMock ();
	...
	public function testExecuteAjaxRequest() {
		 ...
		 */
		$viewMock = $this->getMockForAbstractClass ( 'Magento\Framework\View\Element\UiComponentInterface', [ ], '', false, true, true, [ 
				'render' 
		] );

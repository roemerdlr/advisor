...
class ActionPool implements ActionPoolInterface {
	...
	public function getToolbar() {
		return $this->context->getPageLayout () ? $this->context->getPageLayout ()->getBlock ( static::ACTIONS_PAGE_TOOLBAR ) : false;
	}
	...
	protected function createContainer($key, UiComponentInterface $view) {
		$container = $this->context->getPageLayout ()->createBlock ( 'Magento\Ui\Component\Control\Container', 'container-' . $view->getName () . '-' . $key, [ 
				'data' => [ 

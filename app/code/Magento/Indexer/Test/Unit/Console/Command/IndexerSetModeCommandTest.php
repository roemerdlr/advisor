...
class IndexerSetModeCommandTest extends AbstractIndexerCommandCommonSetup {
	 ...
	 * @expectedExceptionMessage Missing argument 'mode'.
	 * Accepted values for mode are 'realtime' or 'schedule'
	 */
	...
	public function testExecuteAll() {
		...
		$this->assertSame ( 'Index mode for Indexer Title_indexerOne was changed from ' . '\'Update by Schedule\' to \'Update on Save\'' . PHP_EOL, $actualValue );
	}
	...
	public function executeWithIndexDataProvider() {
		return [ 
				[ 
						...
						false,
						'realtime',
						'Index mode for Indexer Title_indexerOne was changed from \'Update by Schedule\' to \'Update on Save\'' . PHP_EOL 
				],
				[ 
						false,
						false,
						false,
						'realtime',
						'Index mode for Indexer Title_indexerOne has not been changed' . PHP_EOL 
				],
				[ 
						true,
						true,
				...
				[ 
						...
						true,
						'schedule',
						'Index mode for Indexer Title_indexerOne was changed from \'Update on Save\' to \'Update by Schedule\'' . PHP_EOL 
				] 
		];
	}

...
class ListActionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->block = $this->getMock ( '\Magento\Framework\View\Element\AbstractBlock', [ 
				'setActive',
				'getMenuModel' 
		], [ ], '', false );
		...
		$this->menu = $this->getMock ( '\Magento\Backend\Model\Menu', [ 
				'getParentItems' 
		], [ ], '', false );
		
		$this->items = $this->getMock ( '\Magento\Backend\Model\Menu\Item', [ 
				'getParentItems' 
		], [ ], '', false );
		...
		$this->page = $this->getMock ( '\Magento\Framework\View\Result\Page', [ 
				'getConfig' 
		], [ ], '', false );
		$this->config = $this->getMock ( '\Magento\Framework\View\Result\Page', [ 
				'getTitle' 
		], [ ], '', false );
		$this->title = $this->getMock ( '\Title', [ 
				'prepend' 
		], [ ], '', false );

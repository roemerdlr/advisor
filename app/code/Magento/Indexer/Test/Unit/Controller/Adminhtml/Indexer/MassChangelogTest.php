...
class MassChangelogTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->objectManager = $this->getMock ( 'Magento\Framework\TestFramework\Unit\Helper\ObjectManager', [ 
				'get' 
		], [ ], '', false );
		...
		$this->indexReg = $this->getMock ( 'Magento\Framework\Indexer\IndexerRegistry', [ 
				'get',
				'setScheduled' 
		], [ ], '', false );
	...
	public function testExecute($indexerIds, $exception, $expectsExceptionValues) {
		...
		if (! is_array ( $indexerIds )) {
			...
			$indexerInterface = $this->getMockForAbstractClass ( 'Magento\Framework\Indexer\IndexerInterface', [ 
					'setScheduled' 
			], '', false );

...
class StateTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_contextMock = $this->getMock ( '\Magento\Framework\Model\Context', [ 
				'getEventDispatcher' 
		], [ ], '', false );
		...
		$this->_resourceCollectionMock = $this->getMock ( '\Magento\Indexer\Model\ResourceModel\Indexer\State\Collection', [ ], [ ], '', false );
		
		$this->model = new \Magento\Indexer\Model\Indexer\State ( $this->_contextMock, $this->_registryMock, $this->_resourceMock, $this->_resourceCollectionMock );
	}

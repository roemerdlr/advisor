...
class ProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->indexerFactoryMock = $this->getMock ( 'Magento\Indexer\Model\IndexerFactory', [ 
				'create' 
		], [ ], '', false );
		$this->indexersFactoryMock = $this->getMock ( 'Magento\Indexer\Model\Indexer\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		$this->viewProcessorMock = $this->getMockForAbstractClass ( 'Magento\Framework\Mview\ProcessorInterface', [ ], '', false );
		$this->model = new \Magento\Indexer\Model\Processor ( $this->configMock, $this->indexerFactoryMock, $this->indexersFactoryMock, $this->viewProcessorMock );
	}

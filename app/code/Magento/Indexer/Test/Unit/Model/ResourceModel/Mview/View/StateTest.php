...
class StateTest extends \PHPUnit_Framework_TestCase {
	...
	public function testConstruct() {
		...
		$arguments = $objectManager->getConstructArguments ( '\Magento\Indexer\Model\ResourceModel\Mview\View\State', [ 
				'resource' => $resourceMock 
		] );
		$this->model = $objectManager->getObject ( '\Magento\Indexer\Model\ResourceModel\Mview\View\State', $arguments );
		$this->assertEquals ( [ 
				[ 
						'field' => [ 
								'view_id' 

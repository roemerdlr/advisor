...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	public function testConstruct() {
		...
		$this->model = new \Magento\Indexer\Model\ResourceModel\Indexer\State\Collection ( $entityFactoryMock, $loggerMock, $fetchStrategyMock, $managerMock, $connectionMock, $resourceMock );
		
		$this->assertInstanceOf ( 'Magento\Indexer\Model\ResourceModel\Indexer\State\Collection', $this->model );
		$this->assertEquals ( 'Magento\Indexer\Model\Indexer\State', $this->model->getModelName () );
		$this->assertEquals ( 'Magento\Indexer\Model\ResourceModel\Indexer\State', $this->model->getResourceModelName () );
	}
}

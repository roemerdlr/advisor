...
class Mapper {
	 ...
	 */
	public function __construct(\Magento\Config\Model\Config\Structure\SearchInterface $fieldLocator, FieldFactory $fieldFactory, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig) {

...
class Config extends \Magento\Framework\DataObject {
	...
	public function save() {
		...
		try {
			...
			$this->_eventManager->dispatch ( "admin_system_config_changed_section_{$this->getSection()}", [ 
	 ...
	 *        	Config path prefix
	 * @param bool $full
	 *        	Simple config structure or not
	 * @param array $oldConfig
	 *        	Config data to extend
	 * @return array
	 */
	...
	public function setDataByPath($path, $value) {
		...
		if ($keyDepth !== 3) {
			throw new \UnexpectedValueException ( "Allowed depth of configuration is 3 (<section>/<group>/<field>). Your configuration depth is " . $keyDepth . " for path '$path'" );
		}
		$data = [ 
				'section' => $pathParts [0],
				'groups' => [ 

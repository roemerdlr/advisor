...
class AbstractElementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = $this->getMockForAbstractClass ( 'Magento\Config\Model\Config\Structure\AbstractElement', [ 
	...
	public function testGetFrontEndModel() {
		$this->_model->setData ( [ 
				'frontend_model' => 'frontend_model_name' 
		], 'store' );

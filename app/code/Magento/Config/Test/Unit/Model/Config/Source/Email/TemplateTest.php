...
class TemplateTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_templatesFactory = $this->getMock ( 'Magento\Email\Model\ResourceModel\Template\CollectionFactory', [ ], [ ], '', false );
		$this->_model = new \Magento\Config\Model\Config\Source\Email\Template ( $this->_coreRegistry, $this->_templatesFactory, $this->_emailConfig );
	}
	public function testToOptionArray() {
		$collection = $this->getMock ( 'Magento\Email\Model\ResourceModel\Template\Collection', [ ], [ ], '', false );
		$collection->expects ( $this->once () )->method ( 'toOptionArray' )->will ( $this->returnValue ( [ 
				[ 
						'value' => 'template_one',
						'label' => 'Template One' 
				],

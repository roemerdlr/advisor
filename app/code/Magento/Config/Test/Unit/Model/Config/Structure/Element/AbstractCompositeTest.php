...
class AbstractCompositeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_iteratorMock = $this->getMock ( 'Magento\Config\Model\Config\Structure\Element\Iterator', [ ], [ ], '', false );
		...
		$this->_model = $this->getMockForAbstractClass ( 'Magento\Config\Model\Config\Structure\Element\AbstractComposite', [ 
	...
	public function testSetDataInitializesChildIterator() {
		$this->_iteratorMock->expects ( $this->once () )->method ( 'setElements' )->with ( [ 
				'someGroup' => [ ] 
		], 'scope' );

...
class TimezoneTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->listMock = $this->getMockBuilder ( 'Magento\Framework\Locale\TranslatedLists' )->disableOriginalConstructor ()->getMock ();
	...
	public function testToOptionArray() {
		...
		$this->listMock->expects ( $this->once () )->method ( 'getOptionTimezones' )->willReturn ( $preparedList );

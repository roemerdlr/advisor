...
class ExtendsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_sut = new \Magento\Config\Model\Config\Structure\Mapper\ExtendsMapper ( new \Magento\Config\Model\Config\Structure\Mapper\Helper\RelativePathConverter () );
	}
	...
	public function testMapWithBadPath() {
		$this->setExpectedException ( 'InvalidArgumentException', 'Invalid path in extends attribute of config/system/sections/section1 node' );
		$sourceData = [ 
				'config' => [ 
						'system' => [ 
								'sections' => [ 

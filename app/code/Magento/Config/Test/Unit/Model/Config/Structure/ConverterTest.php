...
class ConverterTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$factoryMock = $this->getMock ( 'Magento\Config\Model\Config\Structure\Mapper\Factory', [ ], [ ], '', false, false );
		
		$mapperMock = $this->getMock ( 'Magento\Config\Model\Config\Structure\Mapper\Dependencies', [ ], [ ], '', false, false );

...
class EncryptedTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_resourceMock = $this->getMock ( 'Magento\Framework\Model\ResourceModel\AbstractResource', [ 
				'_construct',
				'getConnection',
				'getIdFieldName',
				'beginTransaction',
		...
		$this->_encryptorMock = $this->getMock ( 'Magento\Framework\Encryption\EncryptorInterface', [ ], [ ], '', false );
		$this->_model = $helper->getObject ( 'Magento\Config\Model\Config\Backend\Encrypted', [ 

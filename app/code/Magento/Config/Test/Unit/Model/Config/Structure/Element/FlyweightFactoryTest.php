...
class FlyweightFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = new \Magento\Config\Model\Config\Structure\Element\FlyweightFactory ( $this->_objectManagerMock );
	}
	...
	public function testCreate() {
		$this->_objectManagerMock->expects ( $this->any () )->method ( 'create' )->will ( $this->returnValueMap ( [ 
				[ 

...
class TabTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_iteratorMock = $this->getMock ( 'Magento\Config\Model\Config\Structure\Element\Iterator\Field', [ ], [ ], '', false );
		
		$this->_model = (new ObjectManager ( $this ))->getObject ( 'Magento\Config\Model\Config\Structure\Element\Tab', [ 

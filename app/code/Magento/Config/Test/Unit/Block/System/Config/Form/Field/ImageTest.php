...
class ImageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->image = $objectManager->getObject ( 'Magento\Config\Block\System\Config\Form\Field\Image', [ 
	...
	public function testGetElementHtmlWithValue() {
		...
		$this->urlBuilderMock->expects ( $this->once () )->method ( 'getBaseUrl' )->with ( [ 
				'_type' => $type 
		...
		$this->assertContains ( '<a href="' . $url . $this->testData ['path'] . '/' . $this->testData ['value'] . '" onclick="imagePreview(\'' . $expectedHtmlId . '_image\'); return false;"', $html );

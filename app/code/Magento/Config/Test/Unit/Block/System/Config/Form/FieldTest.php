...
class FieldTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_storeManagerMock = $this->getMock ( 'Magento\Store\Model\StoreManager', [ ], [ ], '', false, false );
	...
	public function testRenderHtmlIdLabelInputElementName() {
		...
		$expected .= '<td class="label"><label for="' . $this->_testData ['htmlId'] . '">' . $this->_testData ['label'] . '</label></td>';
	...
	public function testRenderValueWithCommentBlock() {
		...
		$expected = '<td class="value">' . $this->_testData ['elementHTML'] . '<p class="note"><span>' . $testComment . '</span></p></td>';
		$actual = $this->_object->render ( $this->_elementMock );
	...
	public function testRenderValueWithTooltipBlock() {
		...
		$expected = '<td class="value with-tooltip">' . $this->_testData ['elementHTML'] . '<div class="tooltip"><span class="help"><span></span></span><div class="tooltip-content">' . $testTooltip . '</div></div></td>';
		$actual = $this->_object->render ( $this->_elementMock );
		$this->assertContains ( $expected, $actual );
	}

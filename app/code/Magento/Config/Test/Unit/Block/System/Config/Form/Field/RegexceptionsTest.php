...
class RegexceptionsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->labelFactoryMock = $this->getMockBuilder ( 'Magento\Framework\View\Design\Theme\LabelFactory' )->disableOriginalConstructor ()->getMock ();
	...
	public function testRenderCellTemplateValueColumn() {
		...
		$this->object->addColumn ( $columnName, $this->cellParameters );
		
		$this->assertEquals ( $expectedResult, $this->object->renderCellTemplate ( $columnName ) );
	}

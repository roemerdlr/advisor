...
class SetModeCommandTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->command = $objectManager->getObject ( 'Magento\Deploy\Console\Command\SetModeCommand', [ 
	...
	public function testSetDeveloperMode() {
		...
		$this->assertContains ( "developer mode", $tester->getDisplay () );
	}
	...
	public function testSetInvalidMode() {
		...
		$this->assertContains ( "Cannot switch into given mode", $tester->getDisplay () );
	}
}

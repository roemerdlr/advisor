...
class Filesystem {
	 ...
	 */
	public function __construct(\Magento\Framework\App\DeploymentConfig\Writer $writer, \Magento\Framework\App\DeploymentConfig\Reader $reader, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\Filesystem $filesystem, \Magento\Framework\App\Filesystem\DirectoryList $directoryList, \Magento\Framework\Filesystem\Driver\File $driverFile, \Magento\Store\Model\Config\StoreView $storeView, \Magento\Framework\Shell $shell) {
		$this->writer = $writer;
		$this->reader = $reader;
	 ...
	 * @return void
	 */
	public function regenerateStatic(\Symfony\Component\Console\Output\OutputInterface $output) {
		...
		], self::PERMISSIONS_DIR, self::PERMISSIONS_DIR );
	...
	public function lockStaticResources() {
		...
		$this->changePermissions ( [ 
				...
				DirectoryList::DI,
				DirectoryList::TMP_MATERIALIZATION_DIR 
		], self::PERMISSIONS_DIR, self::PERMISSIONS_FILE );
	}
}

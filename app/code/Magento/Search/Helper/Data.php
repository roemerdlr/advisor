...
class Data extends AbstractHelper {
	 ...
	 */
	public function __construct(Context $context, StringUtils $string, QueryFactory $queryFactory, Escaper $escaper, StoreManagerInterface $storeManager) {
		$this->string = $string;
	...
	public function getSuggestUrl() {
		return $this->_getUrl ( 'search/ajax/suggest', [ 
	...
	public function getMinQueryLength($store = null) {
		return $this->_scopeConfig->getValue ( SearchQuery::XML_PATH_MIN_QUERY_LENGTH, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	}
	...
	public function getMaxQueryLength($store = null) {
		return $this->_scopeConfig->getValue ( SearchQuery::XML_PATH_MAX_QUERY_LENGTH, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	}

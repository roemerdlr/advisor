...
class Query extends AbstractModel implements QueryInterface {
	...
	public function getMinQueryLength() {
		return $this->_scopeConfig->getValue ( self::XML_PATH_MIN_QUERY_LENGTH, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->getStoreId () );
	}
	...
	public function getMaxQueryLength() {
		return $this->_scopeConfig->getValue ( self::XML_PATH_MAX_QUERY_LENGTH, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->getStoreId () );
	}

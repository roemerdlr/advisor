...
class SearchEngineTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$adapterFactory = $this->getMockBuilder ( 'Magento\Search\Model\AdapterFactory' )->disableOriginalConstructor ()->getMock ();
		...
		$this->searchEngine = $helper->getObject ( 'Magento\Search\Model\SearchEngine', [ 

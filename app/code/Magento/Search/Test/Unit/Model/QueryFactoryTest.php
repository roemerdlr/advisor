...
class QueryFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->contextMock = $this->getMockBuilder ( 'Magento\Framework\App\Helper\Context' )->setMethods ( [ 
				'getRequest',
				'getScopeConfig' 
		...
		$this->stringMock = $this->getMockBuilder ( 'Magento\Framework\Stdlib\StringUtils' )->setMethods ( [ 
				'cleanString',
				'substr' 
		] )->getMock ();
		...
		$this->contextMock->expects ( $this->once () )->method ( 'getScopeConfig' )->will ( $this->returnValue ( $this->scopeConfigMock ) );
		$this->queryMock = $this->getMockBuilder ( '\Magento\Search\Model\Query' )->disableOriginalConstructor ()->setMethods ( [ 
				'setIsQueryTextExceeded',
				'getId',
				'setQueryText',
				'loadByQuery' 
		] )->getMock ();
		$this->objectManagerHelper = new ObjectManagerHelper ( $this );
		$this->queryFactory = $this->objectManagerHelper->getObject ( 'Magento\Search\Model\QueryFactory', [ 
	...
	private function mapScopeConfig(array $map) {
		$this->scopeConfigMock->expects ( $this->atLeastOnce () )->method ( 'getValue' )->will ( $this->returnCallback ( function ($path) use($map) {

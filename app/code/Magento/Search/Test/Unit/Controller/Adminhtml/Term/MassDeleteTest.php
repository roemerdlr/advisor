...
class MassDeleteTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->objectManager = $this->getMockBuilder ( '\Magento\Framework\ObjectManagerInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		...
		$this->controller = $this->objectManagerHelper->getObject ( 'Magento\Search\Controller\Adminhtml\Term\MassDelete', [ 
	...
	private function createQuery($index, $id) {
		$query = $this->getMockBuilder ( 'Magento\Search\Model\Query' )->disableOriginalConstructor ()->setMethods ( [ 
				'load',
				'delete' 
		] )->getMock ();

...
class AbstractTemplateTest extends \PHPUnit_Framework_TestCase {
	...
	protected function getModelMock(array $mockedMethods = []) {
		...
		return $this->getMockForAbstractClass ( 'Magento\Email\Model\AbstractTemplate', $helper->getConstructArguments ( 'Magento\Email\Model\AbstractTemplate', [ 
				'design' => $this->design,
		...
		] ), '', true, true, true, array_merge ( $mockedMethods, [ 
				'__wakeup',
				'__sleep',
				'_init' 
		] ) );
	...
	public function testGetProcessedTemplate($variables, $templateType, $storeId, $expectedVariables, $expectedResult) {
		$filterTemplate = $this->getMockBuilder ( 'Magento\Email\Model\Template\Filter' )->setMethods ( [ 
				'setUseSessionInUrl',
		...
		$filterTemplate->expects ( $this->once () )->method ( 'setPlainTemplateMode' )->with ( $templateType === \Magento\Framework\App\TemplateTypesInterface::TYPE_TEXT )->will ( $this->returnSelf () );
		...
		$model->expects ( $this->atLeastOnce () )->method ( 'isPlain' )->will ( $this->returnValue ( $templateType === \Magento\Framework\App\TemplateTypesInterface::TYPE_TEXT ) );
	...
	public function testGetDesignConfig() {
		...
		$model = $this->getMockForAbstractClass ( 'Magento\Email\Model\AbstractTemplate', $helper->getConstructArguments ( 'Magento\Email\Model\AbstractTemplate', [ 
				'design' => $designMock,

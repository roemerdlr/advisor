	...
	public function mergedXmlDataProvider() {
		return [ 
				...
				'node "template" with invalid attribute "type"' => [ 
						...
						[ 
								"Element 'template', attribute 'type': " . "[facet 'enumeration'] The value 'invalid' is not an element of the set {'html', 'text'}.",
								"Element 'template', attribute 'type': " . "'invalid' is not a valid value of the atomic type 'emailTemplateFormatType'." 
						] 
				],
				...
				'node "template" with invalid attribute "area"' => [ 
						...
						[ 
								"Element 'template', attribute 'area': " . "[facet 'enumeration'] The value 'invalid' is not an element of the set {'frontend', 'adminhtml'}.",
								"Element 'template', attribute 'area': " . "'invalid' is not a valid value of the atomic type 'areaType'." 
						] 
				],

...
class FileResolverTest extends \PHPUnit_Framework_TestCase {
	public function testGet() {
		...
		$fileIteratorFactory->expects ( $this->once () )->method ( 'create' )->will ( $this->returnValue ( $expected ) );
		$dirSearch->expects ( $this->once () )->method ( 'collectFiles' )->with ( ComponentRegistrar::MODULE, 'etc/file' );

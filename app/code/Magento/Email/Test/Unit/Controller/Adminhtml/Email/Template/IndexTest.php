...
class IndexTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->indexController = $objectManager->getObject ( 'Magento\Email\Controller\Adminhtml\Email\Template\Index', [ 
	...
	public function testExecuteAjax() {
		...
		$indexController = $this->getMockBuilder ( 'Magento\Email\Controller\Adminhtml\Email\Template\Index' )->setMethods ( [ 
				'getRequest',
				'_forward' 
		] )->disableOriginalConstructor ()->getMock ();
		$indexController->expects ( $this->once () )->method ( 'getRequest' )->will ( $this->returnValue ( $this->requestMock ) );
		$indexController->expects ( $this->once () )->method ( '_forward' )->with ( 'grid' );

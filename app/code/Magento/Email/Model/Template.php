...
class Template extends AbstractTemplate implements \Magento\Framework\Mail\TemplateInterface {
	...
	public function isValidForSend() {
		return ! $this->scopeConfig->isSetFlag ( Template::XML_PATH_SYSTEM_SMTP_DISABLE, ScopeInterface::SCOPE_STORE ) && $this->getSenderName () && $this->getSenderEmail () && $this->getTemplateSubject ();
	}
	 ...
	 *
	 * @return \Exception|null @codeCoverageIgnore
	 */
	...
	public function processTemplate() {
		...
		if (! $this->getId ()) {
			throw new \Magento\Framework\Exception\MailException ( __ ( 'Invalid transactional email code: %1', $templateId ) );
		}

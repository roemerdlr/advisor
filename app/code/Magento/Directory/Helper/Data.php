...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
	 ...
	 * @param string $from        	
	 * @param string $to        	
	 * @return float @SuppressWarnings(PHPMD.ShortVariable)
	 */
	...
	public function getCountriesWithOptionalZip($asJson = false) {
		if (null === $this->_optZipCountries) {
			$value = trim ( $this->scopeConfig->getValue ( self::OPTIONAL_ZIP_COUNTRIES_CONFIG_PATH, ScopeInterface::SCOPE_STORE ) );
	...
	public function isShowNonRequiredState() {
		return ( bool ) $this->scopeConfig->getValue ( self::XML_PATH_DISPLAY_ALL_STATES, ScopeInterface::SCOPE_STORE );
	}
	...
	public function getDefaultCountry($store = null) {
		return $this->scopeConfig->getValue ( self::XML_PATH_DEFAULT_COUNTRY, ScopeInterface::SCOPE_STORE, $store );
	}

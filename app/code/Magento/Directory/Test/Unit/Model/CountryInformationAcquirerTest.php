...
class CountryInformationAcquirerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->countryInformationFactory = $this->getMock ( $className, [ 
				'create' 
		], [ ], '', false );
		
		$className = '\Magento\Directory\Model\Data\RegionInformationFactory';
		$this->regionInformationFactory = $this->getMock ( $className, [ 
				'create' 
		], [ ], '', false );
		
		$className = '\Magento\Directory\Helper\Data';
		$this->directoryHelper = $this->getMock ( $className, [ 
		...
		$this->model = $this->objectManager->getObject ( '\Magento\Directory\Model\CountryInformationAcquirer', [ 
	...
	public function testGetCountryInfo() {
		...
		$countryCollection = $this->getMock ( '\Magento\Directory\Model\ResourceModel\Country\Collection', [ ], [ ], '', false );

...
class ObserverTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->importFactory = $this->getMockBuilder ( 'Magento\Directory\Model\Currency\Import\Factory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		$this->scopeConfig = $this->getMockBuilder ( 'Magento\Framework\App\MutableScopeConfig' )->disableOriginalConstructor ()->setMethods ( [ 
				'getValue' 
		] )->getMock ();
		...
		$this->currencyFactory = $this->getMockBuilder ( 'Magento\Directory\Model\CurrencyFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		...
		$this->observer = $this->objectManager->getObject ( 'Magento\Directory\Model\Observer', [ 
	...
	public function testScheduledUpdateCurrencyRates() {
		...
		$importInterfaceMock = $this->getMockBuilder ( 'Magento\Directory\Model\Currency\Import\Webservicex' )->disableOriginalConstructor ()->setMethods ( [ 
				'fetchRates',
				'getMessages' 
		] )->getMock ();
		...
		$currencyMock = $this->getMockBuilder ( 'Magento\Directory\Model\Currency' )->disableOriginalConstructor ()->setMethods ( [ 
				'saveRates',
				'__wakeup',
				'__sleep' 
		] )->getMock ();

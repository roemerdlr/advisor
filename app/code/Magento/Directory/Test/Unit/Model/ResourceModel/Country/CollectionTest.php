...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$resource = $this->getMockForAbstractClass ( 'Magento\Framework\Model\ResourceModel\Db\AbstractDb', [ ], '', false, true, true, [ 
				'getConnection',
				'getMainTable',
				'getTable',
				'__wakeup' 
		...
		$countryFactory = $this->getMock ( 'Magento\Directory\Model\ResourceModel\CountryFactory', [ ], [ ], '', false );
		$helperDataMock = $this->getMock ( 'Magento\Directory\Helper\Data', [ ], [ ], '', false );

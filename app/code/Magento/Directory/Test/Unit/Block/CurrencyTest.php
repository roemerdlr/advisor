...
class CurrencyTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->object = new \Magento\Directory\Block\Currency ( $context, $currencyFactory, $this->postDataHelper, $localeResolver );
	}
	public function testGetSwitchCurrencyPostData() {
		...
		$this->postDataHelper->expects ( $this->once () )->method ( 'getPostData' )->with ( $this->equalTo ( $switchUrl ), $this->equalTo ( [ 

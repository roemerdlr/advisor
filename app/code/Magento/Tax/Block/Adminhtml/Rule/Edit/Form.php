...
class Form extends \Magento\Backend\Block\Widget\Form\Generic {
	...
	protected function _prepareForm() {
		...
		$fieldset->addField ( 'tax_customer_class', 'editablemultiselect', [ 
		...
		$fieldset->addField ( 'tax_product_class', 'editablemultiselect', [ 
		...
		$fieldset->addField ( 'tax_rate', 'editablemultiselect', [ 
				'name' => 'tax_rate',
				'label' => __ ( 'Tax Rate' ),
				'class' => 'required-entry',

...
class Notifications implements \Magento\Framework\Notification\MessageInterface {
	 ...
	 */
	public function __construct(\Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Framework\UrlInterface $urlBuilder, \Magento\Tax\Model\Config $taxConfig) {
	...
	public function getIgnoreTaxNotificationUrl($section) {
		return $this->urlBuilder->getUrl ( 'tax/tax/ignoreTaxNotification', [ 
				'section' => $section 
		] );
	}
	...
	public function isDisplayed() {
		...
		if ((! empty ( $this->storesWithInvalidDisplaySettings ) && ! $this->taxConfig->isWrongDisplaySettingsIgnored ()) || (! empty ( $this->storesWithInvalidDiscountSettings ) && ! $this->taxConfig->isWrongDiscountSettingsIgnored ())) {
			return true;
		}

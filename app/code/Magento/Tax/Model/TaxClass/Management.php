...
class Management implements \Magento\Tax\Api\TaxClassManagementInterface {
	 ...
	 */
	public function __construct(SearchCriteriaBuilder $searchCriteriaBuilder, FilterBuilder $filterBuilder, \Magento\Tax\Model\TaxClass\Repository $classRepository) {
			...
			switch ($taxClassKey->getType ()) {
				...
				case TaxClassKeyInterface::TYPE_NAME :
					$searchCriteria = $this->searchCriteriaBuilder->addFilters ( [ 
							...
							$this->filterBuilder->setField ( ClassModel::KEY_NAME )->setValue ( $taxClassKey->getValue () )->create () 
					] )->create ();

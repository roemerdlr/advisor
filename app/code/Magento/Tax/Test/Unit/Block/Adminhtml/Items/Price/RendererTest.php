...
class RendererTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->itemPriceRenderer = $this->getMockBuilder ( '\Magento\Tax\Block\Item\Price\Renderer' )->disableOriginalConstructor ()->setMethods ( [ 
				'displayPriceInclTax',
				'displayPriceExclTax',
				'displayBothPrices',
				'getTotalAmount',
		...
		$this->defaultColumnRenderer = $this->getMockBuilder ( '\Magento\Sales\Block\Adminhtml\Items\Column\DefaultColumn' )->disableOriginalConstructor ()->setMethods ( [ 
				'displayPrices' 
		] )->getMock ();
		
		$this->renderer = $objectManager->getObject ( 'Magento\Tax\Block\Adminhtml\Items\Price\Renderer', [ 
	...
	public function testDisplayBothPrices() {
		$flag = true;
		$this->itemPriceRenderer->expects ( $this->once () )->method ( 'displayBothPrices' )->will ( $this->returnValue ( $flag ) );

...
class TaxRuleRegistryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->taxRuleModelFactoryMock = $this->getMockBuilder ( 'Magento\Tax\Model\Calculation\RuleFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		$this->taxRuleRegistry = $objectManager->getObject ( 'Magento\Tax\Model\Calculation\TaxRuleRegistry', [ 

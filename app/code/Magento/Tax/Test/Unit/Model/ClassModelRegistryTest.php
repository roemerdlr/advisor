...
class ClassModelRegistryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->classModelFactoryMock = $this->getMockBuilder ( 'Magento\Tax\Model\ClassModelFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		$this->taxRuleRegistry = $objectManager->getObject ( 'Magento\Tax\Model\ClassModelRegistry', [ 
	...
	public function testUpdateTaxClassNotExistingEntity() {
		...
		$this->classModelMock->expects ( $this->once () )->method ( 'getId' )->will ( $this->returnValue ( null ) );

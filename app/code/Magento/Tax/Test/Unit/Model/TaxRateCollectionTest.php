...
class TaxRateCollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->rateServiceMock = $this->getMock ( 'Magento\Tax\Api\TaxRateRepositoryInterface', [ 
				'save',
				'get',
				'deleteById',
				'getList',
		...
		$this->searchCriteriaMock = $this->getMock ( 'Magento\Framework\Api\SearchCriteriaInterface', [ ], [ ], '', false );
		...
		$this->model = new TaxRateCollection ( $this->entityFactoryMock, $this->filterBuilderMock, $this->searchCriteriaBuilderMock, $this->sortOrderBuilderMock, $this->rateServiceMock, $this->rateConverterMock );
	}

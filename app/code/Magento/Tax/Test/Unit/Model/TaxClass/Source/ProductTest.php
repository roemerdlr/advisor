...
class ProductTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->taxClassRepositoryMock = $this->getMockForAbstractClass ( 'Magento\Tax\Api\TaxClassRepositoryInterface', [ 
				'getList' 
		], '', false, true, true, [ ] );
		...
		$this->product = $this->objectManager->getObject ( 'Magento\Tax\Model\TaxClass\Source\Product', [ 
	...
	public function testGetFlatColumns() {
		$abstractAttrMock = $this->getMock ( '\Magento\Eav\Model\Entity\Attribute\AbstractAttribute', [ 
				'getAttributeCode',
				'__wakeup' 
		], [ ], '', false );
	...
	public function testGetAllOptionsNameIntegrity(array $value) {
		...
		$searchResultsMock = $this->getMockForAbstractClass ( 'Magento\Tax\Api\Data\TaxClassSearchResultsInterface', [ ], '', false, true, true, [ 
				'getItems' 
		] );
		$taxClassMock = $this->getMockForAbstractClass ( 'Magento\Tax\Api\Data\TaxClassInterface', [ 
				'getClassId',
				'getClassName' 
		], '', false, true, true );

...
class CustomerLoggedInObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->groupRepositoryMock = $this->getMockBuilder ( 'Magento\Customer\Model\ResourceModel\GroupRepository' )->disableOriginalConstructor ()->getMock ();
		...
		$this->session = $this->objectManager->getObject ( 'Magento\Tax\Observer\CustomerLoggedInObserver', [ 
	...
	public function testExecute() {
		...
		$this->customerSessionMock->expects ( $this->once () )->method ( 'setDefaultTaxBillingAddress' )->with ( [ 
				'country_id' => 1,
				'region_id' => null,
				'postcode' => 11111 
		] );
		$this->customerSessionMock->expects ( $this->once () )->method ( 'setDefaultTaxShippingAddress' )->with ( [ 
				'country_id' => 1,
				'region_id' => null,
				'postcode' => 11111 
		] );

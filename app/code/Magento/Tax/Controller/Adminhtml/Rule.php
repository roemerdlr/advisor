...
abstract class Rule extends \Magento\Backend\App\Action {
	...
	protected function initResultPage() {
		...
		$resultPage->setActiveMenu ( 'Magento_Tax::sales_tax_rules' )->addBreadcrumb ( __ ( 'Tax' ), __ ( 'Tax' ) )->addBreadcrumb ( __ ( 'Tax Rules' ), __ ( 'Tax Rules' ) );
		return $resultPage;
	}
	 ...
	 * @return \Magento\Tax\Api\Data\TaxRuleInterface @SuppressWarnings(PHPMD.NPathComplexity)
	 */

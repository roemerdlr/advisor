...
class CustomerPlugin {
	 ...
	 * @return CustomerInterface @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	 ...
	 *        	Function we are wrapping around
	 * @param int $customerId
	 *        	Input to the function
	 * @return bool
	 */
	public function aroundDeleteById(CustomerRepository $subject, callable $deleteCustomerById, $customerId) {

...
class TransportBuilder extends \Magento\Framework\Mail\Template\TransportBuilder {
	...
	protected function prepareMessage() {
		...
		$this->message->setMessageType ( \Magento\Framework\Mail\MessageInterface::TYPE_HTML )->setBody ( $template->getProcessedTemplate ( $this->templateVars ) )->setSubject ( $template->getSubject () );

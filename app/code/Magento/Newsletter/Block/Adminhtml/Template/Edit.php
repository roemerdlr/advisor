...
class Edit extends Widget {
	...
	protected function _prepareLayout() {
		...
		if (! $this->isTextType ()) {
			$this->getToolbar ()->addChild ( 'to_plain_button', 'Magento\Backend\Block\Widget\Button', [ 
			...
			$this->getToolbar ()->addChild ( 'to_html_button', 'Magento\Backend\Block\Widget\Button', [ 
		...
		$this->getToolbar ()->addChild ( 'preview_button', 'Magento\Backend\Block\Widget\Button', [ 
		...
		if ($this->getEditMode ()) {
			...
			$this->getToolbar ()->addChild ( 'save_as_button', 'Magento\Backend\Block\Widget\Button', [ 
					'label' => __ ( 'Save As' ),
					'data_attribute' => [ 

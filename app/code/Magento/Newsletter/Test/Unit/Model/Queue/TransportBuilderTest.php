...
class TransportBuilderTest extends \Magento\Framework\Mail\Test\Unit\Template\TransportBuilderTest {
	 ...
	 */
	public function testGetTransport($templateType = TemplateTypesInterface::TYPE_HTML, $messageType = MessageInterface::TYPE_HTML, $bodyText = '<h1>Html message</h1>') {
		...
		$template->expects ( $this->once () )->method ( 'getProcessedTemplate' )->with ( $vars )->will ( $this->returnValue ( $bodyText ) );

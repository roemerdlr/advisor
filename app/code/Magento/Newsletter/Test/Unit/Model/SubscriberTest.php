...
class SubscriberTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->resource = $this->getMock ( 'Magento\Newsletter\Model\ResourceModel\Subscriber', [ 
				'loadByEmail',
				'getIdFieldName',
				'save',
				'loadByCustomerData',
	...
	public function testUpdateSubscription() {
		...
		$this->resource->expects ( $this->atLeastOnce () )->method ( 'loadByCustomerData' )->with ( $customerDataMock )->willReturn ( [ 
				'subscriber_id' => 1,
				'subscriber_status' => 1 
		] );
	...
	protected function sendEmailCheck() {
		$storeModel = $this->getMockBuilder ( '\Magento\Store\Model\Store' )->disableOriginalConstructor ()->setMethods ( [ 
				'getId' 
		] )->getMock ();

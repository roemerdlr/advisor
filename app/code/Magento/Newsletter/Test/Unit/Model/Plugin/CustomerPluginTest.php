...
class CustomerPluginTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->subscriberFactory = $this->getMockBuilder ( '\Magento\Newsletter\Model\SubscriberFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		$this->subscriber = $this->getMockBuilder ( '\Magento\Newsletter\Model\Subscriber' )->setMethods ( [ 
				'loadByEmail',
				'getId',
				'delete',
				'updateSubscription' 
		...
		$this->plugin = $this->objectManager->getObject ( 'Magento\Newsletter\Model\Plugin\CustomerPlugin', [ 

...
class MainTest extends \PHPUnit_Framework_TestCase {
	...
	public function testConstruct() {
		...
		$this->customerViewHelper->expects ( $this->once () )->method ( 'getCustomerName' )->with ( $dummyCustomer )->will ( $this->returnValue ( new \Magento\Framework\DataObject () ) );
		...
		$this->model = $objectManagerHelper->getObject ( 'Magento\Review\Block\Adminhtml\Main', [ 

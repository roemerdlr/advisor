...
class RssTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->rss = $this->getMock ( 'Magento\Review\Model\Rss', [ 
				'__wakeUp',
				'getProductCollection' 
		], [ ], '', false );
		$this->urlBuilder = $this->getMock ( 'Magento\Framework\UrlInterface' );
		$this->objectManagerHelper = new ObjectManagerHelper ( $this );
		$this->block = $this->objectManagerHelper->getObject ( 'Magento\Review\Block\Adminhtml\Rss', [ 
	...
	public function testGetRssData() {
		...
		$productModel = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Product', [ 
				'getStoreId',
				'getId',
				'getReviewId',
				'getName',
		...
		$this->rss->expects ( $this->once () )->method ( 'getProductCollection' )->will ( $this->returnValue ( [ 
				$productModel 
		] ) );

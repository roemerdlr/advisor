...
class RecentTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->collection = $this->getMock ( 'Magento\Review\Model\ResourceModel\Review\Product\Collection', [ ], [ ], '', false );
		$this->collectionFactory = $this->getMock ( 'Magento\Review\Model\ResourceModel\Review\Product\CollectionFactory', [ 
				'create' 
		], [ ], '', false );

...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->resourceMock = $this->getMockBuilder ( 'Magento\Framework\Model\ResourceModel\Db\AbstractDb' )->setMethods ( [ 
				'getConnection',
				'getMainTable',
				'getTable' 
		...
		$this->collection = $objectManager->getObject ( 'Magento\Review\Model\ResourceModel\Review\Summary\Collection', [ 
	...
	public function testFetchItem() {
		...
		$objectMock = $this->getMock ( 'Magento\Framework\Model\AbstractModel', [ 
				'setData' 
		], [ ], '', false );
	...
	public function testLoad() {
		...
		$this->fetchStrategyMock->expects ( $this->once () )->method ( 'fetchAll' )->with ( $this->selectMock, [ ] )->will ( $this->returnValue ( [ 
				$data 
		] ) );

...
class RssTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->rss = $this->objectManagerHelper->getObject ( 'Magento\Review\Model\Rss', [ 
				'eventManager' => $this->managerInterface,
				'reviewFactory' => $this->reviewFactory 
		] );
	}
	public function testGetProductCollection() {
		$reviewModel = $this->getMock ( 'Magento\Review\Model\Review', [ 
				'__wakeUp',
				'getProductCollection' 
		], [ ], '', false );
		$productCollection = $this->getMock ( 'Magento\Review\Model\ResourceModel\Review\Product\Collection', [ 
				'addStatusFilter',

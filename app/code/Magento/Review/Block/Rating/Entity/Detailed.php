...
class Detailed extends \Magento\Framework\View\Element\Template {
	...
	protected function _toHtml() {
		...
		$ratingCollection = $this->_ratingFactory->create ()->getResourceCollection ()->addEntityFilter ( 'product' ) // TOFIX
->setPositionOrder ()->setStoreFilter ( $this->_storeManager->getStore ()->getId () )->addRatingPerStoreName ( $this->_storeManager->getStore ()->getId () )->load ();

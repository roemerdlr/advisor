...
class ButtonTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->buttonRenderer = $this->objectManagerHelper->getObject ( 'Magento\Integration\Block\Adminhtml\Widget\Grid\Column\Renderer\Button', [ 
	...
	public function testRender() {
		...
		$column->expects ( $this->any () )->method ( 'getType' )->will ( $this->returnValue ( 'bigButton' ) );

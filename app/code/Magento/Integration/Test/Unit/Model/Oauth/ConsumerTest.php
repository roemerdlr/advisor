...
class ConsumerTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->oauthDataMock = $this->getMock ( 'Magento\Integration\Helper\Oauth\Data', [ 
		...
		$this->resourceMock = $this->getMock ( 'Magento\Integration\Model\ResourceModel\Oauth\Consumer', [ 
	...
	public function testGetConsumerExpirationPeriodValid() {
		$this->resourceMock->expects ( $this->once () )->method ( 'getTimeInSecondsSinceCreation' )->will ( $this->returnValue ( 30 ) );

...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$arguments = $objectManagerHelper->getConstructArguments ( 'Magento\Integration\Model\ResourceModel\Integration\Collection', [ 
				'resource' => $resource 
		] );
		
		$this->collection = $this->getMockBuilder ( 'Magento\Integration\Model\ResourceModel\Integration\Collection' )->setConstructorArgs ( $arguments )->setMethods ( [ 
				'addFilter',
				'_translateCondition',
				'getMainTable' 
		] )->getMock ();
	...
	public function testAddUnsecureUrlsFilter() {
		...
		$this->collection->expects ( $this->at ( 1 ) )->method ( '_translateCondition' )->with ( 'identity_link_url', [ 
				'like' => 'http:%' 

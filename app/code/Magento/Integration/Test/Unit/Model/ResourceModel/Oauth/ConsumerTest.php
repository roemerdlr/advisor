...
class ConsumerTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->consumerMock = $this->getMock ( 'Magento\Integration\Model\Oauth\Consumer', [ 
				'setUpdatedAt',
				'getId' 
		], [ ], '', false );
	...
	public function testAfterDelete() {
		...
		$this->assertInstanceOf ( 'Magento\Integration\Model\ResourceModel\Oauth\Consumer', $this->consumerResource->_afterDelete ( $this->consumerMock ) );
	}

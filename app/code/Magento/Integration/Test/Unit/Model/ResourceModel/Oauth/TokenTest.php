...
class TokenTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->tokenResource = $objectManager->getObject ( 'Magento\Integration\Model\ResourceModel\Oauth\Token', [ 
				'context' => $contextMock 
		] );
	}
	public function testCleanOldAuthorizedTokensExcept() {
		$tokenMock = $this->getMock ( 'Magento\Integration\Model\Oauth\Token', [ 
				'getId',
				'getAuthorized',
				'getConsumerId',
				'getCustomerId',

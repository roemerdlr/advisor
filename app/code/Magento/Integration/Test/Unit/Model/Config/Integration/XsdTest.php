		...
		return [ 
				...
				'irrelevant node in resource' => [ 
                    ...
                    <integration name="TestIntegration1">
						...
						[ 
								"Element 'resource': Element content is not allowed, " . "because the content type is a simple type definition." 
						] 
				],
				/**
				...
				'integration with empty name' => [ 
                    ...
                    <integration name="">
						...
						[ 
								"Element 'integration', attribute 'name': [facet 'minLength'] The value '' has a length of '0'; " . "this underruns the allowed minimum length of '2'.",
								"Element 'integration', attribute 'name': " . "'' is not a valid value of the atomic type 'integrationNameType'." 
						] 
				],
				...
				'resource with empty name' => [ 
                    ...
                    <integration name="TestIntegration1">
						...
						[ 
								"Element 'resource', attribute 'name': [facet 'pattern'] " . "The value '' is not accepted by the pattern '.+_.+::.+'.",
								"Element 'resource', attribute 'name': '' " . "is not a valid value of the atomic type 'resourceNameType'." 
						] 
				],
				/**
				 * Invalid values
				...
				'resource with invalid name' => [ 
                    ...
                    <integration name="TestIntegration1">
						...
						[ 
								"Element 'resource', attribute 'name': [facet 'pattern'] " . "The value 'customer_manage' is not accepted by the pattern '.+_.+::.+'.",
								"Element 'resource', attribute 'name': 'customer_manage' " . "is not a valid value of the atomic type 'resourceNameType'." 
						] 
				] 
		];
	}

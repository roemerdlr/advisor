		...
		return [ 
				...
				'endpoint_url is empty' => [ 
                    ...
                    <integration name="TestIntegration1">
						...
						[ 
								"Element 'endpoint_url': [facet 'minLength'] The value has a length of '0'; this underruns" . " the allowed minimum length of '4'.",
				...
				'identity_link_url is empty' => [ 
                    ...
                    <integration name="TestIntegration1">
						...
						[ 
								"Element 'identity_link_url': [facet 'minLength'] The value has a length of '0'; this underruns" . " the allowed minimum length of '4'.",
				...
				'invalid email' => [ 
                    ...
                    <integration name="TestIntegration1">
						...
						[ 
								"Element 'email': [facet 'pattern'] The value 'invalid' " . "is not accepted by the pattern '[^@]+@[^\.]+\..+'.",

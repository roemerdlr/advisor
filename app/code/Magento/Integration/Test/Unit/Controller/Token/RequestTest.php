...
class RequestTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->requestAction = $this->objectManagerHelper->getObject ( 'Magento\Integration\Controller\Token\Request', [ 
	...
	public function testRequestAction() {
		...
		$this->frameworkOauthSvcMock->expects ( $this->once () )->method ( 'getRequestToken' )->willReturn ( [ 
				'response' 
		] );

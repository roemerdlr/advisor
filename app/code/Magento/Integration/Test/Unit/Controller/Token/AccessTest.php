...
class AccessTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$page = $this->getMock ( 'Magento\Framework\View\Page', [ 
				'getConfig',
				'initLayout',
		...
		$this->context->expects ( $this->any () )->method ( 'getObjectManager' )->will ( $this->returnValue ( $objectManager ) );
		...
		$this->context->expects ( $this->any () )->method ( 'getResultFactory' )->will ( $this->returnValue ( $resultFactory ) );
		...
		$this->integrationServiceMock = $this->getMock ( 'Magento\Integration\Api\IntegrationServiceInterface', [ ], [ ], '', false );
		
		/** @var \Magento\Framework\TestFramework\Unit\Helper\ObjectManager $objectManagerHelper */
		$this->objectManagerHelper = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		
		$this->accessAction = $this->objectManagerHelper->getObject ( 'Magento\Integration\Controller\Token\Access', [ 
	...
	public function testAccessAction() {
		...
		$this->frameworkOauthSvcMock->expects ( $this->once () )->method ( 'getAccessToken' )->willReturn ( [ 
				'response' 
		] );

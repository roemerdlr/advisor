...
class AdminTokenService implements \Magento\Integration\Api\AdminTokenServiceInterface {
	 ...
	 */
	public function __construct(TokenModelFactory $tokenModelFactory, UserModel $userModel, TokenCollectionFactory $tokenModelCollectionFactory, CredentialsValidator $validatorHelper) {

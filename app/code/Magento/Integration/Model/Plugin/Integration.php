...
class Integration {
	 ...
	 */
	public function __construct(AuthorizationServiceInterface $integrationAuthorizationService, AclRetriever $aclRetriever) {
	 ...
	 *
	 * @return IntegrationModel @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

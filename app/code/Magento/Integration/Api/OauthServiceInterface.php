...
interface OauthServiceInterface {
	 ...
	 *        	- Information provided by an integration when the integration is installed.
	 *        	<pre>
	 *        	array(
	...
	/**
	 * Execute post to integration (consumer) HTTP Post URL.
	 * Generate and return oauth_verifier.
	 *
	 * @param int $consumerId
	 *        	- The consumer Id.
	 * @param string $endpointUrl
	 *        	- The integration endpoint Url (for HTTP Post)

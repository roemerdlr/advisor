...
class Webapi extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface {
	 ...
	 * Get tab label
	 *
	 * @return \Magento\Framework\Phrase @codeCoverageIgnore
	 */
	...
	public function canShowTab() {
		...
		return ! isset ( $integrationData [Info::DATA_SETUP_TYPE] ) || $integrationData [Info::DATA_SETUP_TYPE] != IntegrationModel::TYPE_CONFIG;
	}

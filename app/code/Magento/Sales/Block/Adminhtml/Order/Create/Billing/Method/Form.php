...
class Form extends \Magento\Payment\Block\Form\Container {
	 ...
	 * @param array $data        	
	 */
	public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Payment\Helper\Data $paymentHelper, \Magento\Payment\Model\Checks\SpecificationFactory $methodSpecificationFactory, \Magento\Backend\Model\Session\Quote $sessionQuote, array $data = []) {
	...
	public function hasSsCardType() {
		...
		$ssPresenations = array_intersect ( [ 
				'SS',
				'SM',
				'SO' 
		], $availableTypes );

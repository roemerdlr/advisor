...
class CleanExpiredQuotes {
	 ...
	 */
	public function __construct(StoresConfig $storesConfig, \Magento\Quote\Model\ResourceModel\Quote\CollectionFactory $collectionFactory) {
	...
	public function execute() {
		...
		foreach ( $lifetimes as $storeId => $lifetime ) {
			...
			$quotes->addFieldToFilter ( 'updated_at', [ 
					'to' => date ( "Y-m-d", time () - $lifetime ) 
			] );

...
class TransactionsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->transactionsTab = $this->objectManager->getObject ( 'Magento\Sales\Block\Adminhtml\Order\View\Tab\Transactions', [ 
	...
	public function testCanShowTab($methodClass, $expectedResult) {
		...
		$this->paymentMock->expects ( $this->any () )->method ( 'getMethodInstance' )->willReturn ( $methodInstance );
	...
	public function canShowTabDataProvider() {
		return [ 
				[ 
						'\Magento\Sales\Test\Unit\Block\Adminhtml\Order\View\Tab\Stub\OnlineMethod',
						true 
				],
				[ 

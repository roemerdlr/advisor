...
class HistoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->commentsHistory = $this->objectManager->getObject ( 'Magento\Sales\Block\Adminhtml\Order\View\Tab\History', [ 
	...
	public function testGetItemComment() {
		...
		$this->adminHelperMock->expects ( $this->once () )->method ( 'escapeHtmlWithLinks' )->with ( $item ['comment'], [ 
				'b',
				'br',
				'strong',
				'i',

...
class RssTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->rss = $this->objectManagerHelper->getObject ( 'Magento\Sales\Block\Order\Info\Buttons\Rss', [ 
				'request' => $request,
	...
	public function testGetLink() {
		...
		$this->urlBuilderInterface->expects ( $this->once () )->method ( 'getUrl' )->with ( [ 
				'type' => 'order_status',
				'_secure' => true,
				'_query' => [ 
						'data' => $data 
	...
	public function testIsRssAllowed() {
		$this->scopeConfigInterface->expects ( $this->once () )->method ( 'isSetFlag' )->with ( 'rss/order/status', \Magento\Store\Model\ScopeInterface::SCOPE_STORE )->will ( $this->returnValue ( true ) );

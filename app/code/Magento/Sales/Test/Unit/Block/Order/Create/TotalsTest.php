...
class TotalsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->quoteMock = $this->getMockBuilder ( 'Magento\Quote\Model\Quote' )->disableOriginalConstructor ()->setMethods ( [ 
		...
		$this->totals = $this->helperManager->getObject ( 'Magento\Sales\Block\Adminhtml\Order\Create\Totals', [ 

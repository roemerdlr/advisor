...
class DefaultRendererTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->block = $this->objectManager->getObject ( 'Magento\Sales\Block\Order\Item\Renderer\DefaultRenderer', [ 
		...
		$this->itemMock = $this->getMockBuilder ( '\Magento\Sales\Model\Order\Item' )->disableOriginalConstructor ()->setMethods ( $itemMockMethods )->getMock ();
	}
	...
	public function testGetTotalAmount() {
		...
		$this->itemMock->expects ( $this->once () )->method ( 'getDiscountTaxCompensationAmount' )->will ( $this->returnValue ( $discountTaxCompensationAmount ) );

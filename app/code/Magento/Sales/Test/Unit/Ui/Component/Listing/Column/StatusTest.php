...
class StatusTest extends \PHPUnit_Framework_TestCase {
	public function testPrepareDataSource() {
		...
		$collection->expects ( $this->once () )->method ( 'toOptionHash' )->willReturn ( $itemMapping );
		
		$collectionFactoryMock = $this->getMock ( 'Magento\Sales\Model\ResourceModel\Order\Status\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		$collectionFactoryMock->expects ( $this->once () )->method ( 'create' )->willReturn ( $collection );
		...
		$model = $objectManager->getObject ( 'Magento\Sales\Ui\Component\Listing\Column\Status', [ 

...
class CancelTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->controller = $objectManager->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Invoice\Cancel', [ 
				'context' => $contextMock,
	...
	public function testExecute() {
		...
		$this->requestMock->expects ( $this->once () )->method ( 'getParam' )->with ( 'invoice_id' )->willReturn ( $invoiceId );
		...
		$invoiceMock->expects ( $this->once () )->method ( 'cancel' );
		...
		$this->messageManagerMock->expects ( $this->once () )->method ( 'addSuccess' )->with ( 'You canceled the invoice.' );
		...
		$this->objectManagerMock->expects ( $this->at ( 1 ) )->method ( 'create' )->with ( 'Magento\Framework\DB\Transaction' )->will ( $this->returnValue ( $transactionMock ) );

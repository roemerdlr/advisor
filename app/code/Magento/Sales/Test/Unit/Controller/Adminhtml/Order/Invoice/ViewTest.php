...
class ViewTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->controller = $objectManager->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Invoice\View', [ 
				'context' => $contextMock,
	...
	public function testExecute() {
		...
		$menuBlockMock = $this->getMockBuilder ( 'Magento\Backend\Block\Menu' )->disableOriginalConstructor ()->setMethods ( [ 
				'getParentItems',
				'getMenuModel' 
		] )->getMock ();
		...
		$invoiceViewBlockMock = $this->getMockBuilder ( 'Magento\Sales\Block\Adminhtml\Order\Invoice\View' )->disableOriginalConstructor ()->setMethods ( [ 
				'updateBackButtonUrl' 
		] )->getMock ();

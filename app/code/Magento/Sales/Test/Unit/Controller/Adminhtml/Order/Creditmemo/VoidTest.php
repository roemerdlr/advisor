...
class VoidTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->creditmemoMock = $this->getMockBuilder ( 'Magento\Sales\Model\Order\Creditmemo' )->disableOriginalConstructor ()->setMethods ( [ 
				'getInvoice',
				'getOrder',
				'cancel',
				'getId',
		...
		$this->controller = $objectManager->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Creditmemo\Void', [ 
	...
	public function testExecuteNoCreditmemo() {
		...
		$this->loaderMock->expects ( $this->once () )->method ( 'load' )->willReturn ( false );
	...
	public function testExecuteModelException() {
		...
		$this->requestMock->expects ( $this->any () )->method ( 'getParam' )->withAnyParameters ()->willReturnArgument ( 0 );
		$this->creditmemoMock->expects ( $this->once () )->method ( 'void' )->willThrowException ( $e );
		...
		$this->creditmemoMock->expects ( $this->atLeastOnce () )->method ( 'getId' )->willReturn ( $id );

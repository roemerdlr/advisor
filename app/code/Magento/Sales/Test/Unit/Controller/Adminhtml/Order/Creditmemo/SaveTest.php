...
class SaveTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_controller = $helper->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Creditmemo\Save', [ 
				'context' => $context,
	...
	public function testSaveActionOnlineRefundToStoreCredit() {
		...
		$this->resultRedirectMock->expects ( $this->once () )->method ( 'setPath' )->with ( 'sales/*/new', [ 
				'_current' => true 
		] )->willReturnSelf ();
		
		$this->_setSaveActionExpectationForMageCoreException ( $data, 'Cannot create online refund for Refund to Store Credit.' );
		
		$this->assertInstanceOf ( 'Magento\Backend\Model\View\Result\Redirect', $this->_controller->execute () );
	}

...
class HoldTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->controller = $objectManagerHelper->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Hold', [ 
	...
	public function testExecuteNotPost() {
		...
		$this->messageManager->expects ( $this->once () )->method ( 'addError' )->with ( 'You have not put the order on hold.' );

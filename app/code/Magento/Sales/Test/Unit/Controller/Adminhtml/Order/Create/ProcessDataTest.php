...
class ProcessDataTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->processData = $objectManagerHelper->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Create\ProcessData', [ 
				'context' => $context,
	...
	public function testExecute($noDiscount, $couponCode, $errorMessage, $actualCouponCode) {
		...
		$item = $this->getMockForAbstractClass ( 'Magento\Eav\Model\Entity\Collection\AbstractCollection', [ ], '', false, true, true, [ 
				'getNoDiscount' 
		] );
		$quote->expects ( $this->any () )->method ( 'getAllItems' )->willReturn ( [ 
				$item 
		] );

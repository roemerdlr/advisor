...
class EmailTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->orderEmail = $objectManagerHelper->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Email', [ 
	...
	public function testEmail() {
		...
		$this->resultRedirect->expects ( $this->once () )->method ( 'setPath' )->with ( 'sales/order/view', [ 
				'order_id' => $orderId 
		] )->willReturnSelf ();
	...
	public function testEmailNoOrderId() {
		...
		$this->orderRepositoryMock->expects ( $this->once () )->method ( 'get' )->with ( null )->willThrowException ( new \Magento\Framework\Exception\NoSuchEntityException ( __ ( 'Requested entity doesn\'t exist' ) ) );

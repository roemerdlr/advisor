...
class PrintActionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->fileFactory = $this->getMockBuilder ( 'Magento\Framework\App\Response\Http\FileFactory' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		
		$this->controller = $objectManager->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Invoice\PrintAction', [ 
				'context' => $contextMock,
	...
	public function testExecute() {
		...
		$pdfMock = $this->getMock ( 'Magento\Sales\Model\Order\Pdf\Invoice', [ 
				'render',
				'getPdf' 
		], [ ], '', false );

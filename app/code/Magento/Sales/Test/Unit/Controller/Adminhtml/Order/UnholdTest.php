...
class UnholdTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->controller = $objectManagerHelper->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Unhold', [ 
	...
	public function testExecuteNotPost() {
		...
		$this->messageManager->expects ( $this->once () )->method ( 'addError' )->with ( 'Can\'t unhold order.' );

...
class VoidTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->controller = $objectManager->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\Invoice\Void', [ 
				'context' => $contextMock,
	...
	public function testExecute() {
		...
		$this->invoiceManagement->expects ( $this->once () )->method ( 'setVoid' )->with ( $invoiceId )->willReturn ( true );
		...
		$transactionMock = $this->getMockBuilder ( 'Magento\Framework\DB\Transaction' )->disableOriginalConstructor ()->getMock ();
		...
		$this->messageManagerMock->expects ( $this->once () )->method ( 'addSuccess' )->with ( 'The invoice has been voided.' );
	...
	public function testExecuteModelException() {
		...
		$this->invoiceManagement->expects ( $this->once () )->method ( 'setVoid' )->with ( $invoiceId )->will ( $this->throwException ( $e ) );

...
class ReviewPaymentTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->orderMock = $this->getMockBuilder ( 'Magento\Sales\Api\Data\OrderInterface' )->setMethods ( [ 
				'getPayment' 
		...
		$this->requestMock = $this->getMockBuilder ( 'Magento\Framework\App\Request\Http' )->setMethods ( [ 
				'getParam' 
		...
		$this->reviewPayment = (new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this ))->getObject ( 'Magento\Sales\Controller\Adminhtml\Order\ReviewPayment', [ 

...
class GuestTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->storeModelMock = $this->getMockBuilder ( 'Magento\Store\Model\Store' )->disableOriginalConstructor ()->getMock ();
		$this->salesOrderMock = $this->getMock ( 'Magento\Sales\Model\Order', [ 
				'getProtectCode',
		...
		$this->guest = $this->objectManagerHelper->getObject ( 'Magento\Sales\Helper\Guest', [ 
	...
	public function testLoadValidOrderNotEmptyPost() {
		...
		$billingAddressMock = $this->getMock ( 'Magento\Sales\Model\Order\Address', [ 
				'getLastname',
				'getEmail',
				'__wakeup' 
		], [ ], '', false );

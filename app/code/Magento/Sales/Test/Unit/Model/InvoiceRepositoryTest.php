...
class InvoiceRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->searchResultFactory = $this->getMockBuilder ( 'Magento\Sales\Api\Data\InvoiceSearchResultInterfaceFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		$this->invoice = $objectManager->getObject ( 'Magento\Sales\Model\Order\InvoiceRepository', [ 
				'invoiceMetadata' => $this->invoiceMetadata,
				'searchResultFactory' => $this->searchResultFactory 
		] );
		$this->type = $this->getMock ( 'Magento\Eav\Model\Entity\Type', [ 
				'fetchNewIncrementId' 
		], [ ], '', false );
	}
	public function testGet() {
		...
		$entity->expects ( $this->once () )->method ( 'getEntityId' )->willReturn ( $id );
	...
	public function testGetList() {
		...
		$collection = $this->getMockBuilder ( 'Magento\Sales\Model\ResourceModel\Order\Invoice\Collection' )->disableOriginalConstructor ()->getMock ();

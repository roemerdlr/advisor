...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->historyItemMock = $this->getMock ( 'Magento\Sales\Model\Order\Status\History', [ 
				'__wakeup',
				'addData' 
		], [ ], '', false );
		$this->resourceMock = $this->getMockForAbstractClass ( 'Magento\Sales\Model\ResourceModel\EntityAbstract', [ ], '', false, true, true, [ 
				'getConnection',
				'getMainTable',
				'getTable',
				'__wakeup' 
	...
	public function testGetUnnotifiedForInstance() {
		...
		$this->connectionMock->expects ( $this->exactly ( 3 ) )->method ( 'prepareSqlCondition' )->will ( $this->returnValueMap ( [ 
				[ 
						'entity_name',
						$entityType,
						'sql-string' 

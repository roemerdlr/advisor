...
class HistoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->historyResource = $objectManager->getObject ( 'Magento\Sales\Model\ResourceModel\Order\Status\History', [ 
				'context' => $contextMock,
	...
	public function testSave() {
		...
		$this->validatorMock->expects ( $this->once () )->method ( 'validate' )->with ( $historyMock )->will ( $this->returnValue ( [ ] ) );

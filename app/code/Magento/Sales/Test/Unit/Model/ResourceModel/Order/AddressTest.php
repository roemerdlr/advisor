...
class AddressTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->addressMock = $this->getMock ( 'Magento\Sales\Model\Order\Address', [ 
				'__wakeup',
				'getParentId',
				'hasDataChanges',
				'beforeSave',
		...
		$this->addressResource = $objectManager->getObject ( 'Magento\Sales\Model\ResourceModel\Order\Address', [ 
	...
	public function testSave() {
		...
		$this->addressMock->expects ( $this->once () )->method ( 'getParentId' )->will ( $this->returnValue ( 1 ) );

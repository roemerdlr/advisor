...
class HelperTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->appResource = $this->getMock ( 'Magento\Framework\App\ResourceConnection', [ ], [ ], '', false );
		
		$this->resourceHelper = $this->getMock ( 'Magento\Reports\Model\ResourceModel\Helper', [ ], [ ], '', false );
		
		$this->connectionMock = $this->getMock ( 'Magento\Framework\DB\Adapter\Pdo\Mysql', [ ], [ ], '', false );
		
		$this->helper = $objectManager->getObject ( 'Magento\Sales\Model\ResourceModel\Helper', [ 

...
class GridPoolTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->orderGridMock = $this->getMock ( 'Magento\Sales\Model\ResourceModel\Grid', [ ], [ ], '', false );
		$this->invoiceGridMock = $this->getMock ( 'Magento\Sales\Model\ResourceModel\Grid', [ ], [ ], '', false );
		$this->shipmentGridMock = $this->getMock ( 'Magento\Sales\Model\ResourceModel\Grid', [ ], [ ], '', false );
		$this->creditmemoGridMock = $this->getMock ( 'Magento\Sales\Model\ResourceModel\Grid', [ ], [ ], '', false );

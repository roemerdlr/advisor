...
class TrackTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->trackResource = $objectManager->getObject ( 'Magento\Sales\Model\ResourceModel\Order\Shipment\Track', [ 
				'context' => $contextMock,
	...
	public function testSave() {
		$this->entitySnapshotMock->expects ( $this->once () )->method ( 'isModified' )->with ( $this->trackModelMock )->willReturn ( true );
		$this->validatorMock->expects ( $this->once () )->method ( 'validate' )->with ( $this->equalTo ( $this->trackModelMock ) )->will ( $this->returnValue ( [ ] ) );

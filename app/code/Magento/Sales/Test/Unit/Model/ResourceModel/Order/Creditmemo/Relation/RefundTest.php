...
class RefundTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->invoiceRepositoryMock = $this->getMockBuilder ( 'Magento\Sales\Api\InvoiceRepositoryInterface' )->disableOriginalConstructor ()->getMock ();
		...
		$this->refundResource = $objectManager->getObject ( 'Magento\Sales\Model\ResourceModel\Order\Creditmemo\Relation\Refund', [ 
	...
	public function testProcessRelation() {
		...
		$creditmemoMock->expects ( $this->once () )->method ( 'getState' )->willReturn ( \Magento\Sales\Model\Order\Creditmemo::STATE_REFUNDED );
		$creditmemoMock->expects ( $this->any () )->method ( 'getOrder' )->willReturn ( $orderMock );

...
class GridAsyncInsertTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->unit = new \Magento\Sales\Model\GridAsyncInsert ( $this->gridAggregatorMock, $this->scopeConfigurationMock );
	}
	public function testAsyncInsert() {
		...
		$this->gridAggregatorMock->expects ( $this->once () )->method ( 'refreshBySchedule' );

...
class AggregateSalesReportInvoicedDataTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->invoicedFactoryMock = $this->getMockBuilder ( 'Magento\Sales\Model\ResourceModel\Report\InvoicedFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		...
		$this->observer = new AggregateSalesReportInvoicedData ( $this->localeResolverMock, $this->localeDateMock, $this->invoicedFactoryMock );
	}

...
class AggregateSalesReportBestsellersDataTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->bestsellersFactoryMock = $this->getMockBuilder ( 'Magento\Sales\Model\ResourceModel\Report\BestsellersFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		...
		$this->observer = new AggregateSalesReportBestsellersData ( $this->localeResolverMock, $this->localeDateMock, $this->bestsellersFactoryMock );
	}
	public function testExecute() {
		$date = $this->setupAggregate ();
		$bestsellersMock = $this->getMockBuilder ( 'Magento\Sales\Model\ResourceModel\Report\Bestsellers' )->disableOriginalConstructor ()->getMock ();

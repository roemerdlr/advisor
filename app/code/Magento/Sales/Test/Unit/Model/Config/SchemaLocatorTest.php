...
class SchemaLocatorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_moduleReaderMock = $this->getMockBuilder ( 'Magento\Framework\Module\Dir\Reader' )->disableOriginalConstructor ()->getMock ();
		$this->_moduleReaderMock->expects ( $this->once () )->method ( 'getModuleDir' )->with ( 'etc', 'Magento_Sales' )->will ( $this->returnValue ( 'schema_dir' ) );

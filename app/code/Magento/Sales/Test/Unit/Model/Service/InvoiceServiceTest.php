...
class InvoiceServiceTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->repositoryMock = $this->getMockForAbstractClass ( 'Magento\Sales\Api\InvoiceRepositoryInterface', [ 
				'get' 
		], '', false );
		$this->commentRepositoryMock = $this->getMockForAbstractClass ( 'Magento\Sales\Api\InvoiceCommentRepositoryInterface', [ 
				'getList' 
		], '', false );
		...
		$this->invoiceNotifierMock = $this->getMock ( 'Magento\Sales\Model\Order\InvoiceNotifier', [ 
				'notify' 
		], [ ], '', false );
		
		$this->invoiceService = $objectManager->getObject ( 'Magento\Sales\Model\Service\InvoiceService', [ 

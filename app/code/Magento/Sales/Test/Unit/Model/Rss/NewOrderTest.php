...
class NewOrderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->rssUrlBuilderInterface = $this->getMockBuilder ( 'Magento\Framework\App\Rss\UrlBuilderInterface' )->setMethods ( [ 
				'getUrl' 
		] )->disableOriginalConstructor ()->getMock ();
		$this->objectManagerHelper = new ObjectManagerHelper ( $this );
		$this->model = $this->objectManagerHelper->getObject ( 'Magento\Sales\Model\Rss\NewOrder', [ 
	...
	public function testGetData() {
		...
		$this->rssUrlBuilderInterface->expects ( $this->once () )->method ( 'getUrl' )->with ( [ 
				'_secure' => true,
				'_nosecret' => true,
				'type' => 'new_order' 
		...
		$order = $this->getMockBuilder ( 'Magento\Sales\Model\Order' )->setMethods ( [ 
				'__sleep',
				'__wakeup',
		...
		$collection = $this->getMockBuilder ( '\Magento\Sales\Model\ResourceModel\Order\Collection' )->setMethods ( [ 
		...
		$block = $this->getMock ( 'Magento\Sales\Block\Adminhtml\Order\Details', [ 
				'setOrder',
				'toHtml' 
		], [ ], '', false );

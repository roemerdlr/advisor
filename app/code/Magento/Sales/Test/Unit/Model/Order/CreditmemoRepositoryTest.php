...
class CreditmemoRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->searchResultFactoryMock = $this->getMock ( 'Magento\Sales\Api\Data\CreditmemoSearchResultInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		$this->creditmemo = $objectManager->getObject ( 'Magento\Sales\Model\Order\CreditmemoRepository', [ 

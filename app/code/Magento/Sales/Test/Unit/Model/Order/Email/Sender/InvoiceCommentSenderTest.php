...
class InvoiceCommentSenderTest extends AbstractSenderTest {
	...
	protected function setUp() {
		...
		$this->invoiceResource = $this->getMock ( '\Magento\Sales\Model\ResourceModel\Order\Invoice', [ ], [ ], '', false );
		...
		$this->sender = new InvoiceCommentSender ( $this->templateContainerMock, $this->identityContainerMock, $this->senderBuilderFactoryMock, $this->loggerMock, $this->addressRenderer, $this->eventManagerMock );
	}
	...
	public function testSendTrueWithCustomerCopy() {
		...
		$this->templateContainerMock->expects ( $this->once () )->method ( 'setTemplateVars' )->with ( $this->equalTo ( [ 

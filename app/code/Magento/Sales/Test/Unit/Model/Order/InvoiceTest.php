...
class InvoiceTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->orderMock->expects ( $this->any () )->method ( 'setHistoryEntityName' )->with ( $this->entityType )->will ( $this->returnSelf () );
		...
		$this->orderFactory = $this->getMock ( 'Magento\Sales\Model\OrderFactory', [ 
				'create' 
		], [ ], '', false );
	...
	public function testCanVoid($canVoid) {
		...
		$this->paymentMock->expects ( $this->once () )->method ( 'canVoid', '__wakeup' )->willReturn ( $canVoid );
	...
	public function testGetOrder() {
		$this->orderMock->expects ( $this->once () )->method ( 'setHistoryEntityName' )->with ( $this->entityType )->will ( $this->returnSelf () );

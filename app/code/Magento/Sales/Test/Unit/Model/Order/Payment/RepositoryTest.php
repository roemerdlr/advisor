...
class RepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->searchResultFactory = $this->getMock ( 'Magento\Sales\Api\Data\OrderPaymentSearchResultInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		$this->searchCriteria = $this->getMock ( 'Magento\Framework\Api\SearchCriteria', [ ], [ ], '', false );
		$this->collection = $this->getMock ( 'Magento\Sales\Model\ResourceModel\Order\Payment\Collection', [ ], [ ], '', false );
		$this->paymentResource = $this->getMock ( 'Magento\Sales\Model\ResourceModel\Order\Payment', [ ], [ ], '', false );
		...
		$this->repository = $objectManager->getObject ( 'Magento\Sales\Model\Order\Payment\Repository', [ 
	...
	public function testSave() {
		...
		$this->paymentResource->expects ( $this->once () )->method ( 'save' )->with ( $payment )->willReturn ( $payment );

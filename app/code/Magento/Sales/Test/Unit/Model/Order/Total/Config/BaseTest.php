...
class BaseTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetTotalModels() {
		...
		$this->salesConfig->expects ( $this->once () )->method ( 'getGroupTotals' )->will ( $this->returnValue ( [ 
				'some_code' => [ 
						'instance' => 'Magento\Sales\Model\Order\Total\AbstractTotal',
						'sort_order' => 1903 
				],
				'other_code' => [ 
						'instance' => 'Magento\Sales\Model\Order\Total\AbstractTotal',
		...
		$this->configCacheType->expects ( $this->once () )->method ( 'save' )->with ( 'a:2:{i:0;s:10:"other_code";i:1;s:9:"some_code";}', 'sorted_collectors' );
	...
	public function testGetTotalModelsInvalidTotalModel() {
		...
		$this->orderTotalFactory->expects ( $this->any () )->method ( 'create' )->with ( 'Magento\Sales\Model\Order\Total\AbstractTotal' )->will ( $this->returnValue ( $this ) );
		
		$this->object->getTotalModels ();
	}
	public function testGetTotalUnserializeCachedCollectorCodes() {
		$total = $this->getMockForAbstractClass ( 'Magento\Sales\Model\Order\Total\AbstractTotal' );
		$this->salesConfig->expects ( $this->any () )->method ( 'getGroupTotals' )->will ( $this->returnValue ( [ 
				'some_code' => [ 
						'instance' => 'Magento\Sales\Model\Order\Total\AbstractTotal',
						'sort_order' => 1903 
				],

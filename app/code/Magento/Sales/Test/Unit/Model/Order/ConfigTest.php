...
class ConfigTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->orderStatusCollectionFactoryMock = $this->getMock ( 'Magento\Sales\Model\ResourceModel\Order\Status\CollectionFactory', [ 
				'create' 
		], [ ], '', false, false );
		$this->salesConfig = (new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this ))->getObject ( 'Magento\Sales\Model\Order\Config', [ 
	...
	public function testGetInvisibleOnFrontStatuses() {
		...
		$collectionMock = $this->getMock ( 'Magento\Sales\Model\ResourceModel\Order\Status\Collection', [ 
				'create',
				'joinStates' 
		], [ ], '', false, false );

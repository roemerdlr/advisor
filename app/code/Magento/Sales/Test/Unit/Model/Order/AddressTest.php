...
class AddressTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->regionMock = $this->getMock ( 'Magento\Directory\Model\Region', [ 
				'load',
				'getCountryId',
				'getCode' 
		], [ ], '', false );
		$objectManager = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		$this->address = $objectManager->getObject ( 'Magento\Sales\Model\Order\Address', [ 
	...
	public function testGetRegionCodeRegion($region, $regionId) {
		...
		$this->regionMock->expects ( $this->once () )->method ( 'getCountryId' )->willReturn ( 1 );

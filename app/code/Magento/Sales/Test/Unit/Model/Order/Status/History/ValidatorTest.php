...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	public function testValidate() {
		$history = $this->getMock ( 'Magento\Sales\Model\Order\Status\History', [ 
				'hasData' 
		], [ ], '', false );
		$history->expects ( $this->any () )->method ( 'hasData' )->will ( $this->returnValue ( true ) );

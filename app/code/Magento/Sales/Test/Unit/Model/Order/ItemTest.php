...
class ItemTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @param
	 *        	$qtyShipped
	 * @param $expectedStatus @dataProvider
	 *        	getStatusIdDataProvider
	 */
	public function testGetStatusId($qtyBackOrdered, $qtyCanceled, $qtyInvoiced, $qtyOrdered, $qtyRefunded, $qtyShipped, $expectedStatus) {
	...
	public function getStatusIdDataProvider() {
		return [ 
				...
				[ 
						...
						10,
						99,
						\Magento\Sales\Model\Order\Item::STATUS_MIXED 
				],
				[ 
						0,
						10,
						...
						10,
						0,
						\Magento\Sales\Model\Order\Item::STATUS_INVOICED 
				],
				[ 
						1,
						10,
				...
				[ 
						...
						10,
						79,
						\Magento\Sales\Model\Order\Item::STATUS_PARTIAL 
				],
				[ 
						0,
						10,

...
class ItemTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->orderItemFactoryMock = $this->getMockBuilder ( 'Magento\Sales\Model\Order\ItemFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		$this->item = $objectManager->getObject ( 'Magento\Sales\Model\Order\Creditmemo\Item', [ 
	...
	public function testGetOrderItemFromCreditmemo() {
		...
		$orderMock->expects ( $this->once () )->method ( 'getItemById' )->with ( $orderItemId )->willReturn ( $orderItemMock );
	...
	public function testGetOrderItemFromFactory() {
		...
		$orderItemMock = $this->getMockBuilder ( 'Magento\Sales\Model\Order\Item' )->disableOriginalConstructor ()->getMock ();
		$orderItemMock->expects ( $this->once () )->method ( 'load' )->with ( $orderItemId )->willReturnSelf ();
		
		$this->orderItemFactoryMock->expects ( $this->once () )->method ( 'create' )->willReturn ( $orderItemMock );
	...
	public function testSetQtyDecimalException() {
		...
		$orderItemMock = $this->getMockBuilder ( 'Magento\Sales\Model\Order\Item' )->disableOriginalConstructor ()->getMock ();
		$orderItemMock->expects ( $this->once () )->method ( 'getIsQtyDecimal' )->willReturn ( true );

...
class Pdfcreditmemos extends \Magento\Sales\Controller\Adminhtml\Order\AbstractMassAction {
	 ...
	 */
	public function __construct(Context $context, Filter $filter, Creditmemo $pdfCreditmemo, DateTime $dateTime, FileFactory $fileFactory, CollectionFactory $collectionFactory) {

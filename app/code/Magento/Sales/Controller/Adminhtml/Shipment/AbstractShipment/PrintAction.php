...
abstract class PrintAction extends \Magento\Backend\App\Action {
	 ...
	 */
	public function __construct(Context $context, FileFactory $fileFactory, ForwardFactory $resultForwardFactory) {
	...
	public function execute() {
		...
		if ($shipmentId) {
			...
			if ($shipment) {
				$pdf = $this->_objectManager->create ( 'Magento\Sales\Model\Order\Pdf\Shipment' )->getPdf ( [ 
						$shipment 
				] );

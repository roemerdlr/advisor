...
class CreditmemoLoader extends DataObject {
	 ...
	 *
	 * @return \Magento\Sales\Model\Order\Creditmemo|false @SuppressWarnings(PHPMD.CyclomaticComplexity)
	 */
	public function load() {
		...
		$this->eventManager->dispatch ( 'adminhtml_sales_order_creditmemo_register_before', [ 

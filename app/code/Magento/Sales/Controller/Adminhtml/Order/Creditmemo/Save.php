...
class Save extends \Magento\Backend\App\Action {
	...
	/**
	 * Save creditmemo
	 * We can save only new creditmemo.
	 * Existing creditmemos are not editable
	 *
	 * @return \Magento\Backend\Model\View\Result\Redirect|\Magento\Backend\Model\View\Result\Forward @SuppressWarnings(PHPMD.CyclomaticComplexity)
	...
	public function execute() {
		...
		$resultRedirect->setPath ( 'sales/*/new', [ 
				'_current' => true 
		] );
		return $resultRedirect;
	}

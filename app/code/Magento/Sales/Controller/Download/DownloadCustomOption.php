...
class DownloadCustomOption extends \Magento\Framework\App\Action\Action {
	 ...
	 */
	public function __construct(Context $context, ForwardFactory $resultForwardFactory, Download $download, Unserialize $unserialize) {
	 ...
	 *
	 * @return void|\Magento\Framework\Controller\Result\Forward @SuppressWarnings(PHPMD.CyclomaticComplexity)
	 */

...
/**
 * Service model for managing statuses information.
 * Statuses are just records with code, message and any
...
class ListStatus {
	 ...
	 *        	Usually a name of module, that adds this status
	 * @param int|null $code
	 *        	Code of status, unique for origin, that sets it

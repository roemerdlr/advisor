...
class AggregateSalesReportRefundedData {
	 ...
	 */
	public function __construct(ResolverInterface $localeResolver, TimezoneInterface $timezone, \Magento\Sales\Model\ResourceModel\Report\RefundedFactory $refundedFactory) {

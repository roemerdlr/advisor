...
class History extends AbstractModel implements OrderStatusHistoryInterface {
	 ...
	 *
	 * @param mixed $flag
	 *        	OPTIONAL (notification is not applicable by default)
	 * @return $this
	 */
	 ...
	 * @return $this
	 */
	public function setExtensionAttributes(\Magento\Sales\Api\Data\OrderStatusHistoryExtensionInterface $extensionAttributes) {

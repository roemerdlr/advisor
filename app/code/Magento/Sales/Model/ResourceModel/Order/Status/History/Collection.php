...
class Collection extends AbstractCollection implements OrderStatusHistorySearchResultInterface {
	...
	public function getUnnotifiedForInstance($instance) {
		...
		$this->setOrderFilter ( $instance )->setOrder ( 'created_at', 'desc' )->addFieldToFilter ( 'entity_name', $instance->getEntityType () )->addFieldToFilter ( 'is_customer_notified', 0 )->setPageSize ( 1 );

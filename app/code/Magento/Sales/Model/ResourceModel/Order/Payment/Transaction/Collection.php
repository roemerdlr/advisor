...
class Collection extends AbstractCollection implements TransactionSearchResultInterface {
	...
	protected function _construct() {
		$this->_init ( 'Magento\Sales\Model\Order\Payment\Transaction', 'Magento\Sales\Model\ResourceModel\Order\Payment\Transaction' );
	...
	protected function _renderFiltersBefore() {
		...
		if ($this->_addPaymentInformation) {
			...
			], 'main_table.payment_id = sop.entity_id', $this->_addPaymentInformation );
		}
		if ($this->_storeIds) {
		...
		if ($this->_addOrderInformation) {
			...
			], 'main_table.order_id = so.entity_id', $this->_addOrderInformation );
		}
	}

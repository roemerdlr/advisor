...
class Collection extends AbstractCollection implements OrderSearchResultInterface {
	...
	protected function _construct() {
		...
		$this->addFilterToMap ( 'entity_id', 'main_table.entity_id' )->addFilterToMap ( 'customer_id', 'main_table.customer_id' )->addFilterToMap ( 'quote_address_id', 'main_table.quote_address_id' );
	}
	...
	public function addBillingAgreementsFilter($agreements) {
		...
		], 'main_table.entity_id = sbao.order_id', [ ] )->where ( 'sbao.agreement_id IN(?)', $agreements );
		return $this;
	}
}

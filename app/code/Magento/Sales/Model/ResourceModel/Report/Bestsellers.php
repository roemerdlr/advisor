...
class Bestsellers extends AbstractReport {
	...
	public function aggregate($from = null, $to = null) {
		...
		try {
			...
			], 'order_item.order_id = source_table.entity_id', [ ] )->where ( 'source_table.state != ?', \Magento\Sales\Model\Order::STATE_CANCELED )->where ( 'order_item.product_type NOT IN(?)', $this->ignoredProductTypes );

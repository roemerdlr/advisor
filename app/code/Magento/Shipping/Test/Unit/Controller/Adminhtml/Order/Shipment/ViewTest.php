...
class ViewTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->blockMock = $this->getMock ( 'Magento\Shipping\Block\Adminhtml\View', [ 
				'updateBackButtonUrl' 
		], [ ], '', false );
		...
		$this->controller = $objectManager->getObject ( 'Magento\Shipping\Controller\Adminhtml\Order\Shipment\View', [ 
	...
	public function testExecute() {
		...
		$layoutMock->expects ( $this->once () )->method ( 'getBlock' )->with ( 'sales_shipment_view' )->willReturn ( $this->blockMock );
		$this->blockMock->expects ( $this->once () )->method ( 'updateBackButtonUrl' )->with ( $comeFrom )->willReturnSelf ();
		
		$this->resultPageMock->expects ( $this->once () )->method ( 'setActiveMenu' )->with ( 'Magento_Sales::sales_shipment' )->willReturnSelf ();

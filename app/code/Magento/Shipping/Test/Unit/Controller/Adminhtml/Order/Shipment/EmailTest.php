...
class EmailTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->shipmentLoader = $this->getMock ( 'Magento\Shipping\Controller\Adminhtml\Order\ShipmentLoader', [ 
				'setOrderId',
				'setShipmentId',
				'setShipment',
				'setTracking',
		...
		$this->resultFactory = $this->getMock ( 'Magento\Framework\Controller\ResultFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->shipmentEmail = $objectManagerHelper->getObject ( 'Magento\Shipping\Controller\Adminhtml\Order\Shipment\Email', [ 
	...
	public function testEmail() {
		...
		$orderShipment = $this->getMock ( 'Magento\Sales\Model\Order\Shipment', [ 
				'load',
				'save',
				'__wakeup' 
		], [ ], '', false );
		$shipmentNotifierClassName = 'Magento\Shipping\Model\ShipmentNotifier';
		$shipmentNotifier = $this->getMock ( $shipmentNotifierClassName, [ 
				'notify',
				'__wakeup' 
		], [ ], '', false );
	...
	protected function prepareRedirect($path, $arguments, $index) {
		...
		$this->resultRedirect->expects ( $this->at ( $index ) )->method ( 'setPath' )->with ( $path, [ 

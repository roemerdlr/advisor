...
class GetShippingItemsGridTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->controller = new \Magento\Shipping\Controller\Adminhtml\Order\Shipment\GetShippingItemsGrid ( $contextMock, $this->shipmentLoaderMock );
	}
	...
	public function testExecute() {
		...
		$gridMock = $this->getMock ( 'Magento\Shipping\Block\Adminhtml\Order\Packaging\Grid', [ 
				'setIndex',
				'toHtml' 
		], [ ], '', false );

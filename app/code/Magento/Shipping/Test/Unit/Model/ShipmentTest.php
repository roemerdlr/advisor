...
class ShipmentTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->orderRepository = $this->getMock ( '\Magento\Sales\Api\OrderRepositoryInterface', [ ], [ ], '', false );
		...
		$arguments = [ 
				...
				'shipmentItemCollectionFactory' => $this->getMock ( 'Magento\Sales\Model\ResourceModel\Order\Shipment\Item\CollectionFactory', [ ], [ ], '', false ),
				'trackCollectionFactory' => $this->getMock ( 'Magento\Sales\Model\ResourceModel\Order\Shipment\Track\CollectionFactory', [ ], [ ], '', false ),
				'commentFactory' => $this->getMock ( 'Magento\Sales\Model\Order\Shipment\CommentFactory', [ ], [ ], '', false ),
				'commentCollectionFactory' => $this->getMock ( 'Magento\Sales\Model\ResourceModel\Order\Shipment\Comment\CollectionFactory', [ ], [ ], '', false ) 
		];

...
abstract class AbstractCarrierOnline extends AbstractCarrier {
	 ...
	 * We need to pass children of a bundle instead passing the
	 ...
	 * @return $this|bool|\Magento\Framework\DataObject @SuppressWarnings(PHPMD.CyclomaticComplexity)
	...
	protected function _getQuotesCacheKey($requestParams) {
		if (is_array ( $requestParams )) {
			$requestParams = implode ( ',', array_merge ( [ 
					$this->getCarrierCode () 
			], array_keys ( $requestParams ), $requestParams ) );
		}
	 ...
	 * Strip tags and entities from name
	 *
	 * @param string|object $name
	 *        	service name or object with implemented __toString() method

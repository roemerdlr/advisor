...
class SampleDataRemoveCommand extends Command {
	 ...
	 */
	public function __construct(Filesystem $filesystem, Dependency $sampleDataDependency, ArrayInputFactory $arrayInputFactory, ApplicationFactory $applicationFactory) {
	...
	protected function configure() {
		$this->setName ( 'sampledata:remove' )->setDescription ( 'Remove all sample data packages from composer.json' );
		parent::configure ();
	}
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		if (! empty ( $sampleDataPackages )) {
			...
			$commandInput = $this->arrayInputFactory->create ( [ 

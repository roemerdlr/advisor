...
class Attribute {
	 ...
	 */
	public function aroundGetStoreLabelsByAttributeId(\Magento\Eav\Model\ResourceModel\Entity\Attribute $subject, \Closure $proceed, $attributeId) {
		...
		if ($this->isCacheEnabled) {
			$this->cache->save ( serialize ( $storeLabels ), $cacheId, [ 

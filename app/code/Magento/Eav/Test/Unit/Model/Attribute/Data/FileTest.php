...
class FileTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->fileValidatorMock = $this->getMock ( '\Magento\MediaStorage\Model\File\Validator\NotProtectedExtension', [ 
				'isValid',
				'getMessages' 
		], [ ], '', false );
		$filesystemMock = $this->getMock ( '\Magento\Framework\Filesystem', [ ], [ ], '', false );
		
		$this->model = new \Magento\Eav\Model\Attribute\Data\File ( $timezoneMock, $loggerMock, $localeResolverMock, $this->urlEncoder, $this->fileValidatorMock, $filesystemMock );
	}
	...
	public function validateValueDataProvider() {
		return [ 
				...
				[ 
						...
						'fileIsValid' => true,
						'expectedResult' => [ 
								'"Label" is not a valid file extension.' 
						] 
				],
				[ 
						'value' => [ 

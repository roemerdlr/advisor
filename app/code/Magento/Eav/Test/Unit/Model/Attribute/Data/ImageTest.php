...
class ImageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$fileValidatorMock = $this->getMock ( '\Magento\MediaStorage\Model\File\Validator\NotProtectedExtension', [ ], [ ], '', false );
		$filesystemMock = $this->getMock ( '\Magento\Framework\Filesystem', [ ], [ ], '', false );
		
		$this->model = new \Magento\Eav\Model\Attribute\Data\Image ( $timezoneMock, $loggerMock, $localeResolverMock, $urlEncoder, $fileValidatorMock, $filesystemMock );
	}
	
	/**
	 * Attention: this test depends on mock of "is_uploaded_file" function in .
	 * /FileTest.php,
	...
	public function validateValueDataProvider() {
		return [ 
				[ 
						...
						'rules' => [ ],
						'expectedResult' => [ 
								'"Label" is not a valid file' 
						] 
				],
				[ 
						'value' => [ 
								'delete' => 'delete',
								'tmp_name' => __DIR__ . '/_files/image.ico',
								'name' => 'image.ico' 
						],
						'originalValue' => 'value',
						'isRequired' => true,
						...
						'rules' => [ ],
						'expectedResult' => [ 
								'"Label" is not a valid image format' 
						] 
				],
				[ 
						'value' => [ 
								'delete' => 'delete',
								'tmp_name' => __DIR__ . '/_files/image.jpg',
								'name' => 'image.ppp' 
						],
						'originalValue' => 'value',
						'isRequired' => true,
				...
				[ 
						...
						'expectedResult' => [ 
								'"Label" exceeds the allowed file size.' 
						] 
				],
				[ 
						'value' => [ 

...
class DateTest extends \PHPUnit_Framework_TestCase {
	...
	public function testOutputValue($format, $value, $callTimes, $expectedResult) {
		...
		$attributeMock = $this->getMock ( '\Magento\Eav\Model\Attribute', [ 
				'getInputFilter',
				'__wakeup' 
		], [ ], '', false );
	...
	public function validateValueDataProvider() {
		return [ 
				...
				[ 
						'value' => '2000-01-01',
						'rules' => [ 
								'date_range_min' => strtotime ( '2001-01-01' ),
								'date_range_max' => strtotime ( '2002-01-01' ) 
						],
						'originalValue' => '',
						'isRequired' => false,
						'expectedResult' => [ 
								'Please enter a valid date between 01/01/2001 and 01/01/2002 at Label.' 
						] 
				],
				[ 
						'value' => '2000-01-01',
						...
						'isRequired' => false,
						'expectedResult' => [ 
								'Please enter a valid date equal to or greater than 01/01/2001 at Label.' 
						] 
				],
				[ 
						'value' => '2010-01-01',
						'rules' => [ 
								'date_range_max' => strtotime ( '2001-01-01' ) 
						],
						'originalValue' => '',
						'isRequired' => false,
						'expectedResult' => [ 
								'Please enter a valid date less than or equal to 01/01/2001 at Label.' 
						] 
				] 
		];
	}

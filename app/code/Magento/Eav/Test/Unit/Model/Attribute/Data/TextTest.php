...
class TextTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$locale = $this->getMock ( 'Magento\Framework\Stdlib\DateTime\TimezoneInterface', [ ], [ ], '', false, false );
		...
		$arguments = $objectManagerHelper->getConstructArguments ( $attributeClass, [ 
		 ...
		 */
		$attribute = $this->getMock ( $attributeClass, [ 
				'_init' 
		], $arguments );

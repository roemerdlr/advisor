...
class DatetimeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->attributeMock = $this->getMock ( '\Magento\Eav\Model\Entity\Attribute\AbstractAttribute', [ 
				'getAttributeCode',
				'getFrontendLabel' 
		], [ ], '', false );
	...
	public function testGetValue() {
		...
		$this->attributeMock->expects ( $this->any () )->method ( 'getAttributeCode' )->willReturn ( 'datetime' );
		$this->attributeMock->expects ( $this->any () )->method ( 'getData' )->with ( 'frontend_input' )->willReturn ( 'text' );

...
class BooleanTest extends \PHPUnit_Framework_TestCase {
	 ...
	 */
	public function testAddValueSortToCollection($direction, $isScopeGlobal, $expectedJoinCondition, $expectedOrder) {
		...
		foreach ( $expectedJoinCondition as $step => $data ) {
			$selectMock->expects ( $this->at ( $step ) )->method ( 'joinLeft' )->with ( $data ['requisites'], $data ['condition'], [ ] )->will ( $this->returnSelf () );
		}
	...
	protected function getCollectionMock() {
		...
		$collectionMock = $this->getMock ( '\Magento\Eav\Model\Entity\Collection\AbstractCollection', $collectionMethods, [ ], '', false );
	...
	protected function getAttributeMock() {
		...
		$attributeMock = $this->getMock ( '\Magento\Eav\Model\Entity\Attribute\AbstractAttribute', $attributeMockMethods, [ ], '', false );

...
class TypeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->attrFactoryMock = $this->getMock ( 'Magento\Eav\Model\Entity\AttributeFactory', [ ], [ ], '', false );
		$this->attrSetFactoryMock = $this->getMock ( 'Magento\Eav\Model\Entity\Attribute\SetFactory', [ ], [ ], '', false );
		$this->storeFactoryMock = $this->getMock ( 'Magento\Eav\Model\Entity\StoreFactory', [ 
				'create' 
		], [ ], '', false );
		$this->universalFactoryMock = $this->getMock ( 'Magento\Framework\Validator\UniversalFactory', [ ], [ ], '', false );
		$this->resourceMock = $this->getMockForAbstractClass ( 'Magento\Framework\Model\ResourceModel\Db\AbstractDb', [ ], '', false, false, true, [ 
				'beginTransaction',
				'rollBack',
				'commit',
				'getIdFieldName',
		...
		$this->model = new \Magento\Eav\Model\Entity\Type ( $this->contextMock, $this->registryMock, $this->attrFactoryMock, $this->attrSetFactoryMock, $this->storeFactoryMock, $this->universalFactoryMock, $this->resourceMock );
	}

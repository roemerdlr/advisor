...
class AbstractCollectionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->statementMock = $this->getMock ( 'Magento\Framework\DB\Statement\Pdo\Mysql', [ 
				'fetch' 
		], [ ], '', false );
		/** @var $selectMock \Magento\Framework\DB\Select|\PHPUnit_Framework_MockObject_MockObject */
		$selectMock = $this->getMock ( 'Magento\Framework\DB\Select', [ ], [ ], '', false );
		$this->coreEntityFactoryMock->expects ( $this->any () )->method ( 'create' )->will ( $this->returnCallback ( [ 
				$this,
				'getMagentoObject' 
		] ) );
		...
		$this->validatorFactoryMock->expects ( $this->any () )->method ( 'create' )->with ( 'test_entity_model' ) // see \Magento\Eav\Test\Unit\Model\Entity\Collection\AbstractCollectionStub

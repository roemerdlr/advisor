...
class GroupTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->resourceMock = $this->getMock ( 'Magento\Eav\Model\ResourceModel\Entity\Attribute\Group', [ ], [ ], '', false );
		$translitFilter = $this->getMockBuilder ( \Magento\Framework\Filter\Translit::class )->disableOriginalConstructor ()->getMock ();

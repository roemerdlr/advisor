...
class DataTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->helper = $objectManager->getObject ( '\Magento\Eav\Helper\Data', [ 
	...
	public function testGetAttributeLockedFieldsNonCachedLockedFiled() {
		...
		$this->attributeConfig->expects ( $this->once () )->method ( 'getEntityAttributesLockedFields' )->with ( 'entityTypeCode' )->will ( $this->returnValue ( $lockedFields ) );

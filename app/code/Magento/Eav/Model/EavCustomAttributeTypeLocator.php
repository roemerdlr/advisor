...
class EavCustomAttributeTypeLocator implements CustomAttributeTypeLocatorInterface {
	 ...
	 *        	Backend Model and DataInterface map for a service
	 *        	<pre>
	 *        	[
	 ...
	 *        	</pre>
	 */
	public function __construct(AttributeRepositoryInterface $attributeRepository, \Magento\Framework\Stdlib\StringUtils $stringUtility, array $serviceEntityTypeMap = [], array $serviceBackendModelDataInterfaceMap = []) {

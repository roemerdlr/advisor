...
class Data extends \Magento\Framework\Validator\AbstractValidator {
	...
	protected function _getAttributes($entity) {
		...
		} elseif ($entity instanceof \Magento\Framework\Model\AbstractModel && $entity->getResource () instanceof \Magento\Eav\Model\Entity\AbstractEntity) { // $entity is EAV-model

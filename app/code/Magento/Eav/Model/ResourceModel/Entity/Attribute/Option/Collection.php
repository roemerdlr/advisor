...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection {
	...
	protected function _construct() {
		$this->_init ( 'Magento\Eav\Model\Entity\Attribute\Option', 'Magento\Eav\Model\ResourceModel\Entity\Attribute\Option' );
	...
	public function setStoreFilter($storeId = null, $useDefaultValue = true) {
		...
		if ($useDefaultValue) {
			...
			$this->getSelect ()->joinLeft ( [ 
					'tsv' => $this->_optionValueTable 
			], $joinCondition, 'value' )->where ( 'tsv.store_id = ?', $storeId );
		}
	...
	public function setIdFilter($optionId) {
		return $this->addFieldToFilter ( 'main_table.option_id', [ 
				'in' => $optionId 
		] );
	}

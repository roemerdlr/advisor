...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection {
	 ...
	 *
	 * @return string|null @codeCoverageIgnore
	 */
	...
	protected function _beforeLoad() {
		...
		], 'main_table.attribute_id = ea.attribute_id', $eaColumns );
		...
		if ($additionalTable) {
			...
			], 'main_table.attribute_id = ca.attribute_id', $caColumns );
		}
		...
		if ($this->_getEavWebsiteTable ()) {
			...
			], $joinWebsiteExpression, $saColumns );
		}

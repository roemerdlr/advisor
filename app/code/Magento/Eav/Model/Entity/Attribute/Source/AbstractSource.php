...
abstract class AbstractSource implements \Magento\Eav\Model\Entity\Attribute\Source\SourceInterface, \Magento\Framework\Option\ArrayInterface {
	 ...
	 * @return \Magento\Eav\Model\Entity\Attribute\Frontend\AbstractFrontend @codeCoverageIgnore
	 */
	 ...
	 *
	 * @param int $store        	
	 * @return \Magento\Framework\DB\Select|null @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 *         @codeCoverageIgnore
	 */
	 ...
	 *
	 * @param string|int $value        	
	 * @return string|bool @codeCoverageIgnore
	 */

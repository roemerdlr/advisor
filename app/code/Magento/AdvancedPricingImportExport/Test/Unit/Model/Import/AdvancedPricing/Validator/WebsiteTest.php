...
class WebsiteTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->storeResolver = $this->getMock ( '\Magento\CatalogImportExport\Model\Import\Product\StoreResolver', [ 
				'getWebsiteCodeToId' 
		], [ ], '', false );
		
		$this->website = $this->getMock ( '\Magento\AdvancedPricingImportExport\Model\Import\AdvancedPricing\Validator\Website', [ 
				'getAllWebsitesValue',
				'_clearMessages',
				'_addMessages' 
		], [ 
	 ...
	 */
	public function testIsValidReturn($value, $allWebsites, $colTierPriceWebsite, $expectedResult) {
	...
	public function testIsValidReturnAddMessagesCall() {
		...
		$expectedMessages = [ 
				AdvancedPricing\Validator\Website::ERROR_INVALID_WEBSITE 
		];
	...
	public function testGetAllWebsitesValue() {
		...
		$website = $this->getMock ( '\Magento\AdvancedPricingImportExport\Model\Import\AdvancedPricing\Validator\Website', null, [ 
				$this->storeResolver,
				$this->webSiteModel 
		], '' );

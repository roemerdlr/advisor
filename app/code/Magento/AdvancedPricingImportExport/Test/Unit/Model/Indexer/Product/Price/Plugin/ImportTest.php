...
class ImportTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->import = $this->getMock ( '\Magento\AdvancedPricingImportExport\Model\Indexer\Product\Price\Plugin\Import', [ 
				'getPriceIndexer',
				'invalidateIndexer' 
		], [ ], '', false );
		$this->advancedPricing = $this->getMock ( '\Magento\AdvancedPricingImportExport\Model\Import\AdvancedPricing', [ ], [ ], '', false );

...
class RedirectTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_urlCoderMock = $this->getMock ( '\Magento\Framework\Encryption\UrlCoder', [ ], [ ], '', false );
		...
		$this->_model = new \Magento\Store\App\Response\Redirect ( $this->_requestMock, $this->_storeManagerMock, $this->_urlCoderMock, $this->_sessionMock, $this->_sidResolverMock, $this->_urlBuilderMock );
	}

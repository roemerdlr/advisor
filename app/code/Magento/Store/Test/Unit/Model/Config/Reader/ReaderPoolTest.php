...
class ReaderPoolTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_defaultReaderMock = $this->getMock ( 'Magento\Store\Model\Config\Reader\DefaultReader', [ ], [ ], '', false );
		$this->_websiteReaderMock = $this->getMock ( 'Magento\Store\Model\Config\Reader\Website', [ ], [ ], '', false );
		$this->_storeReaderMock = $this->getMock ( 'Magento\Store\Model\Config\Reader\Store', [ ], [ ], '', false );

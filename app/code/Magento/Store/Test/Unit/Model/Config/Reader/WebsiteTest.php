...
class WebsiteTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$websiteFactoryMock = $this->getMock ( 'Magento\Store\Model\WebsiteFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->_model = new \Magento\Store\Model\Config\Reader\Website ( $this->_initialConfigMock, $this->_scopePullMock, new \Magento\Framework\App\Config\Scope\Converter (), $this->_collectionFactory, $websiteFactoryMock );
	}
	public function testRead() {
		...
		$this->_initialConfigMock->expects ( $this->any () )->method ( 'getData' )->with ( "websites|{$websiteCode}" )->will ( $this->returnValue ( [ 
				'config' => [ 
						'key1' => 'website_value1',
						'key2' => 'website_value2' 
				] 
		...
		$this->_collectionFactory->expects ( $this->once () )->method ( 'create' )->with ( [ 
				...
				new \Magento\Framework\DataObject ( [ 
						'path' => 'config/key1',
						'value' => 'website_db_value1' 
				] ),
				new \Magento\Framework\DataObject ( [ 
						'path' => 'config/key3',
						'value' => 'website_db_value3' 
				] ) 
		] ) );
		$expectedData = [ 
				'config' => [ 

...
class StoreManagementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->storesFactoryMock = $this->getMock ( 'Magento\Store\Model\ResourceModel\Store\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		$this->model = new \Magento\Store\Model\StoreManagement ( $this->storesFactoryMock );
	}

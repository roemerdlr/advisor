...
class WebsiteTest extends \PHPUnit_Framework_TestCase {
	public function testIsCanDelete() {
		...
		$websiteCollection = $this->getMock ( 'Magento\Store\Model\ResourceModel\Website\Collection', [ 
				'getSize' 
		], [ ], '', false );
		$websiteCollection->expects ( $this->any () )->method ( 'getSize' )->will ( $this->returnValue ( 2 ) );
		
		$websiteFactory = $this->getMock ( 'Magento\Store\Model\WebsiteFactory', [ 
				'create',
				'getCollection',
				'__wakeup' 
		], [ ], '', false );
		...
		$websiteModel = $objectManager->getObject ( 'Magento\Store\Model\Website', [ 

...
class WebsiteManagementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->websitesFactoryMock = $this->getMock ( 'Magento\Store\Model\ResourceModel\Website\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		$this->model = new \Magento\Store\Model\WebsiteManagement ( $this->websitesFactoryMock );
	}

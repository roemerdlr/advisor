...
class InformationTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->renderer = $this->getMockBuilder ( 'Magento\Store\Model\Address\Renderer' )->disableOriginalConstructor ()->setMethods ( [ 
				'format' 
		] )->getMock ();
		...
		$region = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'load',
				'getName' 
		] );
		...
		$country = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'loadByCode',
				'getName' 
		] );

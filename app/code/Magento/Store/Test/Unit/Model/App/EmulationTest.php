...
class EmulationTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		// Mocks
		$this->designMock = $this->getMockBuilder ( 'Magento\Theme\Model\Design' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		...
		$this->translateMock = $this->getMockBuilder ( 'Magento\Framework\TranslateInterface' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		$this->scopeConfigMock = $this->getMockBuilder ( 'Magento\Framework\App\Config\ScopeConfigInterface' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		$this->localeResolverMock = $this->getMockBuilder ( 'Magento\Framework\Locale\ResolverInterface' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		$this->inlineConfigMock = $this->getMockBuilder ( 'Magento\Framework\Translate\Inline\ConfigInterface' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		$this->inlineTranslationMock = $this->getMockBuilder ( 'Magento\Framework\Translate\Inline\StateInterface' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		$this->viewDesignMock = $this->getMockForAbstractClass ( 'Magento\Framework\View\DesignInterface' );
		$this->storeMock = $this->getMockBuilder ( 'Magento\Store\Model\Store' )->disableOriginalConstructor ()->setMethods ( [ 
				'__wakeup',
				'getStoreId' 
		] )->getMock ();

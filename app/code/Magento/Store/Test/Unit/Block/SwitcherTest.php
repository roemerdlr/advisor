...
class SwitcherTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->switcher = (new ObjectManager ( $this ))->getObject ( 'Magento\Store\Block\Switcher', [ 
	...
	public function testGetTargetStorePostData() {
		...
		$this->corePostDataHelper->expects ( $this->any () )->method ( 'getPostData' )->with ( $storeSwitchUrl, [ 
				'___store' => 'new-store' 
		] );

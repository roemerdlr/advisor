...
class Switcher extends \Magento\Framework\View\Element\Template {
	...
	public function getRawStores() {
		if (! $this->hasData ( 'raw_stores' )) {
			...
			foreach ( $websiteStores as $store ) {
				...
				$localeCode = $this->_scopeConfig->getValue ( Data::XML_PATH_DEFAULT_LOCALE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	...
	public function getGroups() {
		if (! $this->hasData ( 'groups' )) {
			...
			$groups = [ ];
			$localeCode = $this->_scopeConfig->getValue ( Data::XML_PATH_DEFAULT_LOCALE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE );

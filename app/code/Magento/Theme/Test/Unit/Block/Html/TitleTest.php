...
class TitleTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$context = $this->objectManagerHelper->getObject ( 'Magento\Framework\View\Element\Template\Context', [ 
				'pageConfig' => $this->pageConfigMock 
		] );
		
		$this->htmlTitle = $this->objectManagerHelper->getObject ( 'Magento\Theme\Block\Html\Title', [ 
				'context' => $context 
		] );
	}
	...
	public function testGetPageTitleWithSetPageTitle() {
		...
		$this->pageConfigMock->expects ( $this->never () )->method ( 'getTitle' );
	...
	public function testGetPageTitle() {
		...
		$this->pageTitleMock->expects ( $this->once () )->method ( 'getShort' )->willReturn ( $title );

...
HTML;
	...
	public function setUp() {
		...
		$children = $this->getMock ( 'Magento\Framework\Data\Tree\Node\Collection', [ 
				'count' 
		], [ 
				'container' => $container 
		] );
		...
		for($i = 0; $i < 10; $i ++) {
			$id = "category-node-$i";
			$categoryNode = $this->getMock ( 'Magento\Framework\Data\Tree\Node', [ 
					'getId',
					'hasChildren' 
			], [ ], '', false );
		...
		$node = $this->getMock ( 'Magento\Framework\Data\Tree\Node', [ 
				'getChildren' 
		], [ ], '', false );

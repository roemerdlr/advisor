...
class ContentTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$constructArguments = $objectManagerHelper->getConstructArguments ( 'Magento\Theme\Block\Adminhtml\Wysiwyg\Files\Content', [ 
	...
	public function testGetNewFolderUrl($requestParams) {
		...
		$this->_urlBuilder->expects ( $this->once () )->method ( 'getUrl' )->with ( 'adminhtml/*/newFolder', $requestParams )->will ( $this->returnValue ( $expectedUrl ) );
	...
	public function testGetDeleteFilesUrl($requestParams) {
		...
		$this->_urlBuilder->expects ( $this->once () )->method ( 'getUrl' )->with ( 'adminhtml/*/deleteFiles', $requestParams )->will ( $this->returnValue ( $expectedUrl ) );
	...
	public function testGetOnInsertUrl($requestParams) {
		...
		$this->_urlBuilder->expects ( $this->once () )->method ( 'getUrl' )->with ( 'adminhtml/*/onInsert', $requestParams )->will ( $this->returnValue ( $expectedUrl ) );
	...
	public function testGetTargetElementId() {
		...
		$this->_request->expects ( $this->once () )->method ( 'getParam' )->with ( 'target_element_id' )->will ( $this->returnValue ( $expectedRequest ) );
	...
	public function testGetContentsUrl() {
		...
		$this->_urlBuilder->expects ( $this->once () )->method ( 'getUrl' )->with ( 'adminhtml/*/contents', [ 
				'type' => $expectedRequest 
		] + $requestParams )->will ( $this->returnValue ( $expectedUrl ) );

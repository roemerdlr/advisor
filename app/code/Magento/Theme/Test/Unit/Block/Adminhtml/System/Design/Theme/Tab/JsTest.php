...
class JsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$constructArguments = $objectManagerHelper->getConstructArguments ( 'Magento\Theme\Block\Adminhtml\System\Design\Theme\Edit\Tab\Js', [ 
				'formFactory' => $this->getMock ( 'Magento\Framework\Data\FormFactory', [ ], [ ], '', false ),
				'objectManager' => $this->getMock ( 'Magento\Framework\ObjectManagerInterface' ),
				'urlBuilder' => $this->_urlBuilder 
		] );
		
		$this->_model = $this->getMock ( 'Magento\Theme\Block\Adminhtml\System\Design\Theme\Edit\Tab\Js', [ 
				'_getCurrentTheme' 
	...
	public function testGetJsUploadUrl() {
		...
		$this->_urlBuilder->expects ( $this->once () )->method ( 'getUrl' )->with ( 'adminhtml/system_design_theme/uploadjs', [ 
				'id' => $themeId 

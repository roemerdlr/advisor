...
class GridTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$context->expects ( $this->any () )->method ( 'getView' )->willReturn ( $this->view );
		...
		$this->controller = new Grid ( $context, $this->registry, $this->fileFactory, $this->repository, $this->filesystem );
	}

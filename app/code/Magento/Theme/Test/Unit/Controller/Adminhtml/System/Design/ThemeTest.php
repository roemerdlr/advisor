...
abstract class ThemeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->redirect = $this->getMockForAbstractClass ( 'Magento\Framework\App\Response\RedirectInterface', [ ], '', false );
		$this->session = $this->getMock ( 'Magento\Backend\Model\Session', [ 
				'setIsUrlNotice',
				'setThemeData',
				'setThemeCustomCssData' 
		], [ ], '', false );
		...
		$this->_model = $helper->getObject ( 'Magento\Theme\Controller\Adminhtml\System\Design\Theme\\' . $this->name, [ 

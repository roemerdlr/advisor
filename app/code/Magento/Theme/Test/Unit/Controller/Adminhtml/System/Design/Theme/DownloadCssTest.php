...
class DownloadCssTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->controller = new DownloadCss ( $context, $this->registry, $this->fileFactory, $this->repository, $this->filesystem );
	}
	public function testExecute() {
		...
		$this->repository->expects ( $this->once () )->method ( 'createAsset' )->with ( $fileId, [ 
				'themeModel' => $theme 
		] )->willReturn ( $file );
		...
		$this->fileFactory->expects ( $this->once () )->method ( 'create' )->with ( $relPath, [ 
				'type' => 'filename',
				'value' => $relPath 
	...
	public function testExecuteInvalidArgument() {
		...
		$this->objectManager->expects ( $this->any () )->method ( 'get' )->willReturnMap ( [ 
				[ 

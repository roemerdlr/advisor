...
class DeleteFilesTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->controller = $helper->getObject ( 'Magento\Theme\Controller\Adminhtml\System\Design\Wysiwyg\Files\DeleteFiles', [ 
	...
	public function testExecute() {
		...
		$jsonData = $this->getMock ( 'Magento\Framework\Json\Helper\Data', [ ], [ ], '', false );
		$jsonData->expects ( $this->once () )->method ( 'jsonDecode' )->with ( '{"files":"file"}' )->willReturn ( [ 
				'files' => 'file' 
		] );

...
class ContentsTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->controller = $helper->getObject ( 'Magento\Theme\Controller\Adminhtml\System\Design\Wysiwyg\Files\Contents', [ 
	...
	public function testExecute() {
		...
		$block = $this->getMockForAbstractClass ( 'Magento\Framework\View\Element\BlockInterface', [ ], '', false, false, true, [ 
				'setStorage' 
		] );

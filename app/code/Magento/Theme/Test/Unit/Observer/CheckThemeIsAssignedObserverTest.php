...
class CheckThemeIsAssignedObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->themeObserver = $objectManagerHelper->getObject ( 'Magento\Theme\Observer\CheckThemeIsAssignedObserver', [ 
	...
	public function testCheckThemeIsAssigned() {
		...
		$this->eventDispatcher->expects ( $this->any () )->method ( 'dispatch' )->with ( 'assigned_theme_changed', [ 
				'theme' => $themeMock 
		] );

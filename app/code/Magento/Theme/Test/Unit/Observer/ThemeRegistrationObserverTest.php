...
class ThemeRegistrationObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->registration = $this->getMockBuilder ( 'Magento\Theme\Model\Theme\Registration' )->disableOriginalConstructor ()->getMock ();
		$this->logger = $this->getMockBuilder ( 'Psr\Log\LoggerInterface' )->getMock ();
		
		$objectManagerHelper = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		$this->themeObserver = $objectManagerHelper->getObject ( 'Magento\Theme\Observer\ThemeRegistrationObserver', [ 
	...
	public function testThemeRegistration() {
		...
		$eventMock = $this->getMockBuilder ( 'Magento\Framework\Event' )->setMethods ( [ 
				'getPathPattern' 

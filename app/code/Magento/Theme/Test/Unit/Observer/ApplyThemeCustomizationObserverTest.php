...
class ApplyThemeCustomizationObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->assetsMock = $this->getMock ( 'Magento\Framework\View\Asset\GroupedCollection', [ ], [ ], '', false, false );
		...
		$this->themeObserver = $objectManagerHelper->getObject ( 'Magento\Theme\Observer\ApplyThemeCustomizationObserver', [ 
				'design' => $designMock,
	...
	public function testApplyThemeCustomization() {
		...
		$this->themeCustomization->expects ( $this->once () )->method ( 'getFiles' )->will ( $this->returnValue ( [ 
				$file 
		] ) );

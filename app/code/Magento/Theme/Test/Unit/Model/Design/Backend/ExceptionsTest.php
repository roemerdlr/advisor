...
class ExceptionsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = (new ObjectManager ( $this ))->getObject ( 'Magento\Theme\Model\Design\Backend\Exceptions', [ 
	 ...
	 * @test
	 * 
	 * @return void @covers \Magento\Theme\Model\Design\Backend\Exceptions::beforeSave

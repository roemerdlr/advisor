...
class ThemeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = (new ObjectManager ( $this ))->getObject ( 'Magento\Theme\Model\Design\Backend\Theme', [ 
	 ...
	 * @test
	 * 
	 * @return void @covers \Magento\Theme\Model\Design\Backend\Theme::beforeSave
	 *         @covers \Magento\Theme\Model\Design\Backend\Theme::__construct
	 */
	public function testBeforeSave() {
		$this->designMock->expects ( $this->once () )->method ( 'setDesignTheme' )->with ( 'some_value', Area::AREA_FRONTEND );
	...
	public function testAfterSave($callNumber, $oldValue) {
		...
		$this->configMock->expects ( $this->any () )->method ( 'getValue' )->willReturnMap ( [ 
				[ 

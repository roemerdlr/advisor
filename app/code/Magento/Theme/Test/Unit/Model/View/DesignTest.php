...
class DesignTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->flyweightThemeFactory = $this->getMock ( 'Magento\Framework\View\Design\Theme\FlyweightFactory', [ ], [ ], '', false );
		$this->config = $this->getMockForAbstractClass ( 'Magento\Framework\App\Config\ScopeConfigInterface' );
		$this->themeFactory = $this->getMock ( 'Magento\Theme\Model\ThemeFactory', [ 
				'create' 
		], [ ], '', false );
		$this->objectManager = $this->getMockForAbstractClass ( 'Magento\Framework\ObjectManagerInterface' );
		$this->state = $this->getMock ( 'Magento\Framework\App\State', [ ], [ ], '', false );
		$themes = [ 
				Design::DEFAULT_AREA => $this->defaultTheme 
		];
		$this->model = new Design ( $this->storeManager, $this->flyweightThemeFactory, $this->config, $this->themeFactory, $this->objectManager, $this->state, $themes );
	}
	...
	public function getThemePathDataProvider() {
		return [ 
				...
				[ 
						'',
						'2',
						\Magento\Framework\View\DesignInterface::PUBLIC_THEME_DIR . '2' 
				],
				[ 
						'',
						'',
	 ...
	 * @test
	 * 
	 * @return void @covers \Magento\Theme\Model\View\Design::getDesignParams
	 ...
	 * @test
	 * 
	 * @return void @covers \Magento\Theme\Model\View\Design::setDesignTheme

...
class ConfigTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->dataStorage = $this->getMockBuilder ( 'Magento\Framework\Config\DataInterface' )->disableOriginalConstructor ()->getMock ();
	 ...
	 * @test
	 * 
	 * @return void @covers \Magento\Theme\Model\Layout\Config::getPageLayouts

...
class LayoutTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->config = $this->getMockBuilder ( 'Magento\Theme\Model\Layout\Config' )->disableOriginalConstructor ()->getMock ();
	 ...
	 * @test
	 * 
	 * @return void @covers \Magento\Theme\Model\Layout\Source\Layout::toOptionArray
	...
	public function testToOptionArray() {
		...
		$this->config->expects ( $this->once () )->method ( 'getPageLayouts' )->willReturn ( [ 
				new DataObject ( $data ) 
		] );

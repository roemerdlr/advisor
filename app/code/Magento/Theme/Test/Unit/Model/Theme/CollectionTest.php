...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->entityFactory = $this->getMockBuilder ( 'Magento\Framework\Data\Collection\EntityFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		$this->themeConfigFactory = $this->getMockBuilder ( 'Magento\Framework\Config\ThemeFactory' )->setMethods ( [ 
				'create' 
	...
	public function testLoadData() {
		...
		$this->themePackageList->expects ( $this->once () )->method ( 'getThemes' )->will ( $this->returnValue ( [ 
				$themePackage 
		] ) );
		...
		$this->themeConfigFactory->expects ( $this->once () )->method ( 'create' )->with ( [ 
		...
		$theme->expects ( $this->once () )->method ( 'addData' )->with ( [ 
				'parent_id' => null,

...
class SingleFileTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->file = $this->getMockBuilder ( 'Magento\Framework\View\Design\Theme\Customization\FileInterface' )->getMock ();
	...
	public function testUpdate() {
		...
		$customFiles = [ ];
		$fileType = 'png';
		$customCss = $this->getMockBuilder ( 'Magento\Framework\View\Design\Theme\FileInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'delete',
				'save',
				'getContent',
				'getFileInfo',
		...
		$customCss->expects ( $this->once () )->method ( 'setData' )->with ( 'content', $fileContent );
		$customCss->expects ( $this->once () )->method ( 'setTheme' )->with ( $theme );
		$customCss->expects ( $this->once () )->method ( 'save' );
		$this->file->expects ( $this->once () )->method ( 'create' )->willReturn ( $customCss );

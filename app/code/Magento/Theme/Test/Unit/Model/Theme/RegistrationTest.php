...
class RegistrationTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->collectionFactory = $this->getMockBuilder ( 'Magento\Theme\Model\ResourceModel\Theme\Data\CollectionFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		$this->filesystemCollection = $this->getMockBuilder ( 'Magento\Theme\Model\Theme\Data\Collection' )->disableOriginalConstructor ()->getMock ();
		
		$this->model = new Registration ( $this->collectionFactory, $this->filesystemCollection );
	}
	...
	public function testRegister() {
		...
		$parentThemeFromCollection = $this->getMockBuilder ( 'Magento\Framework\View\Design\ThemeInterface' )->setMethods ( [ 
				'getType',
				'getId' 
		] )->getMockForAbstractClass ();
		$themeFromCollection = $this->getMockBuilder ( 'Magento\Framework\View\Design\ThemeInterface' )->setMethods ( [ 
				'setType',
				'save',
				'getParentTheme',
				'getType',
		...
		$this->filesystemCollection->expects ( $this->once () )->method ( 'getIterator' )->willReturn ( new \ArrayIterator ( [ 
				$theme 
		] ) );

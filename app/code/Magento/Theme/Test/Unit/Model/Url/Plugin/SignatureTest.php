...
class SignatureTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->deploymentVersion = $this->getMock ( 'Magento\Framework\App\View\Deployment\Version', [ ], [ ], '', false );
	...
	public function testAroundGetBaseUrlInactive($fixtureConfigFlag, $inputUrlType) {
		$this->config->expects ( $this->any () )->method ( 'getValue' )->with ( Signature::XML_PATH_STATIC_FILE_SIGNATURE )->will ( $this->returnValue ( $fixtureConfigFlag ) );
	...
	public function aroundGetBaseUrlInactiveDataProvider() {
		return [ 
				'disabled in config, relevant URL type' => [ 
						0,
						\Magento\Framework\UrlInterface::URL_TYPE_STATIC 
				],
				'enabled in config, irrelevant URL type' => [ 
						1,

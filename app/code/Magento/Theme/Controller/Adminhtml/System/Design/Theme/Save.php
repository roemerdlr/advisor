...
class Save extends \Magento\Theme\Controller\Adminhtml\System\Design\Theme {
	...
	public function execute() {
		...
		try {
			if ($this->getRequest ()->getPostValue ()) {
				...
				if (! empty ( $themeData ['theme_id'] )) {
					...
					$theme = $parentTheme->getDomainModel ( \Magento\Framework\View\Design\ThemeInterface::TYPE_PHYSICAL )->createVirtualTheme ( $parentTheme );
				}
		...
		$redirectBack ? $this->_redirect ( 'adminhtml/*/edit', [ 
				'id' => $theme->getId () 

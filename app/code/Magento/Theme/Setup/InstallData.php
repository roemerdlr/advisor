...
class InstallData implements InstallDataInterface {
	 ...
	 */
	public function __construct(\Magento\Theme\Model\ResourceModel\Theme\CollectionFactory $themeResourceFactory, \Magento\Theme\Model\Theme\CollectionFactory $themeFactory) {
	...
	public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context) {
		 ...
		 */
		$setup->getConnection ()->update ( $setup->getTable ( 'theme' ), [ 
				'area' => 'frontend' 
		], [ 
				'area = ?' => '' 
		] );

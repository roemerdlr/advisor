...
class ThemeValidator {
	 ...
	 */
	public function __construct(StoreManagerInterface $storeManager, ThemeProviderInterface $themeProvider, ValueInterface $configData) {
	...
	public function validateIsThemeInUse($themePaths) {
		...
		$configData = $this->configData->getCollection ()->addFieldToFilter ( 'path', DesignInterface::XML_PATH_THEME_ID )->addFieldToFilter ( 'value', [ 

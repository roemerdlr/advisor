...
class Signature {
	 ...
	 */
	public function __construct(\Magento\Framework\View\Url\ConfigInterface $config, \Magento\Framework\App\View\Deployment\Version $deploymentVersion) {
		$this->config = $config;
	 ...
	 * @param null $secure        	
	 * @return string
	 * @see \Magento\Framework\Url\ScopeInterface::getBaseUrl() @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	public function aroundGetBaseUrl(\Magento\Framework\Url\ScopeInterface $subject, \Closure $proceed, $type = \Magento\Framework\UrlInterface::URL_TYPE_LINK, $secure = null) {

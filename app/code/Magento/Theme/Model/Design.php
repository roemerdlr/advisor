...
class Design extends AbstractModel implements IdentityInterface, DesignInterface {
	 ...
	 * @param array $data        	
	 */
	public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\Stdlib\DateTime\TimezoneInterface $localeDate, \Magento\Framework\Stdlib\DateTime $dateTime, AbstractResource $resource = null, \Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = []) {
	...
	public function loadChange($storeId, $date = null) {
		...
		if ($result === false) {
			...
			$this->_cacheManager->save ( serialize ( $result ), $changeCacheId, [ 
					self::CACHE_TAG 
			], 86400 );
		} else {

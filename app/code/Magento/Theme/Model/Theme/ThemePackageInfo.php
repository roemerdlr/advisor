...
class ThemePackageInfo {
	 ...
	 */
	public function __construct(ComponentRegistrar $componentRegistrar, ReadFactory $readDirFactory) {
	...
	public function getFullThemePath($packageName) {
		...
		return isset ( $this->packageNameToFullPathMap [$packageName] ) ? $this->packageNameToFullPathMap [$packageName] : '';
	}

...
class Pager extends \Magento\Framework\View\Element\Template {
	...
	public function getAnchorTextForPrevious() {
		return $this->_scopeConfig->getValue ( 'design/pagination/anchor_text_for_previous', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
	}
	...
	public function getAnchorTextForNext() {
		return $this->_scopeConfig->getValue ( 'design/pagination/anchor_text_for_next', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
	}

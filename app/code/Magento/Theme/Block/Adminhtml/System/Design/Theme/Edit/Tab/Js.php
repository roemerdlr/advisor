...
class Js extends \Magento\Theme\Block\Adminhtml\System\Design\Theme\Edit\AbstractTab {
	...
	protected function _addThemeJsFieldset() {
		$form = $this->getForm ();
		$themeFieldset = $form->addFieldset ( 'theme_js', [ 
		...
		$jsFieldset = $themeFieldset->addFieldset ( 'js_fieldset_javascript_content', [ 
				'class' => 'fieldset-wide' 
		] );
		
		$this->_addElementTypes ( $themeFieldset );
		
		$themeFieldset->addField ( 'js_files_uploader', 'js_files', [ 
		...
		$themeFieldset->addField ( 'js_uploader_button', 'button', [ 
	...
	public function getJsUploadUrl() {
		return $this->getUrl ( 'adminhtml/system_design_theme/uploadjs', [ 

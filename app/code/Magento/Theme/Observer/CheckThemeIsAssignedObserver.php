...
class CheckThemeIsAssignedObserver implements ObserverInterface {
	 ...
	 */
	public function __construct(\Magento\Theme\Model\Config\Customization $themeConfig, \Magento\Framework\Event\ManagerInterface $eventDispatcher) {
	...
	public function execute(EventObserver $observer) {
		...
		if ($theme instanceof \Magento\Framework\View\Design\ThemeInterface) {
			...
			if ($this->themeConfig->isThemeAssignedToStore ( $theme )) {
				$this->eventDispatcher->dispatch ( 'assigned_theme_changed', [ 
						'theme' => $theme 
				] );
			}
		}

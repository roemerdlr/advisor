...
class Cookie extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	public function isUserNotAllowSaveCookie() {
		...
		return $this->scopeConfig->getValue ( self::XML_PATH_COOKIE_RESTRICTION, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->_currentStore ) && empty ( $acceptedSaveCookiesWebsites [$this->_website->getId ()] );
	}
	...
	public function getCookieRestrictionLifetime() {
		return ( int ) $this->scopeConfig->getValue ( self::XML_PATH_COOKIE_RESTRICTION_LIFETIME, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->_currentStore );
	}
}

...
class LifetimeTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->resourceMock = $this->getMockBuilder ( 'Magento\Framework\Module\ModuleResource' )->disableOriginalConstructor ( 'delete' )->getMock ();
	...
	public function testBeforeSaveException() {
		...
		$this->validatorMock->expects ( $this->once () )->method ( 'isValid' )->with ( $invalidCookieLifetime )->willReturn ( false );
	...
	public function testBeforeSaveNoException() {
		...
		$this->validatorMock->expects ( $this->once () )->method ( 'isValid' )->with ( $validCookieLifetime )->willReturn ( true );

...
class PayPalTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->controller = $this->objectManagerHelper->getObject ( 'Magento\Braintree\Test\Unit\Controller\Stub\PayPalStub', [ 
				'context' => $contextMock,
	...
	public function testDispatchNotActive() {
		...
		$this->braintreePayPalConfigMock->expects ( $this->once () )->method ( 'isActive' )->willReturn ( false );

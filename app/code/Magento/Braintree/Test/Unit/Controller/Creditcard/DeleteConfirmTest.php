...
class DeleteConfirmTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->vault = $this->getMockBuilder ( '\Magento\Braintree\Model\Vault' )->disableOriginalConstructor ()->getMock ();
	...
	public function testExecute() {
		...
		$this->vault->expects ( $this->once () )->method ( 'deleteCard' )->willReturn ( json_decode ( json_encode ( [ 
				'success' => true 
		] ) ) );
		...
		$messageManager->expects ( $this->once () )->method ( 'addSuccess' )->with ( $phrase );
		
		$notification = $objectManager->getObject ( 'Magento\Braintree\Controller\Creditcard\DeleteConfirm', [ 
	...
	public function testExecuteNoTokenRedirect() {
		...
		$this->vault->expects ( $this->never () )->method ( 'deleteCard' );
		...
		$notification = $objectManager->getObject ( 'Magento\Braintree\Controller\Creditcard\Edit', [ 
				'request' => $this->request,
				'resultRedirectFactory' => $this->resultRedirectFactory,
				'vault' => $this->vault 
		] );

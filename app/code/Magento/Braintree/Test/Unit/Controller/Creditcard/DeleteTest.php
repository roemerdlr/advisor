...
class DeleteTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->pageConfig = $this->getMockBuilder ( '\Magento\Framework\View\Page\Config' )->disableOriginalConstructor ()->setMethods ( [ 
				'set',
				'getTitle' 
		] )->getMock ();
	...
	public function testExecute() {
		...
		$notification = $objectManager->getObject ( 'Magento\Braintree\Controller\Creditcard\Delete', [ 
	...
	public function testExecuteNoTokenRedirect() {
		...
		$this->vault->expects ( $this->never () )->method ( 'storedCard' );

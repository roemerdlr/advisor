...
class PlaceOrderTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->checkoutSessionMock = $this->getMockBuilder ( '\Magento\Checkout\Model\Session' )->disableOriginalConstructor ()->setMethods ( [ 
				'clearHelperData',
				'getQuote',
				'setLastQuoteId',
		...
		$this->controller = $this->objectManagerHelper->getObject ( '\Magento\Braintree\Controller\PayPal\PlaceOrder', [ 
				'context' => $contextMock,

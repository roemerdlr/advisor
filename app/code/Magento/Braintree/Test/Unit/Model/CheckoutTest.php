...
class CheckoutTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $this->objectManagerHelper->getObject ( 'Magento\Braintree\Model\Checkout', [ 
	...
	protected function setupAddressMock() {
		$this->billingAddressMock = $this->getMockBuilder ( '\Magento\Quote\Model\Quote\Address' )->disableOriginalConstructor ()->setMethods ( [ 
		...
		$this->shippingAddressMock = $this->getMockBuilder ( '\Magento\Quote\Model\Quote\Address' )->disableOriginalConstructor ()->setMethods ( [ 
				'setShouldIgnoreValidation',
				'setSameAsBilling',
				'setEmail',
				'setPrefix',
				...
				'with_billing_address' => [ 
						...
						'expected_shipping' => [ 
								...
								'setStreet' => [ 
										...
										self::SHIPPING_EXTENDED_ADDRESS 
								],

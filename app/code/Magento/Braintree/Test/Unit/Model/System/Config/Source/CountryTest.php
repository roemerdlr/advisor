...
class CountryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->countryCollectionMock = $this->getMockBuilder ( '\Magento\Directory\Model\ResourceModel\Country\Collection' )->disableOriginalConstructor ()->getMock ();
		
		$this->objectManagerHelper = new ObjectManagerHelper ( $this );
		$this->model = $this->objectManagerHelper->getObject ( '\Magento\Braintree\Model\System\Config\Source\Country', [ 
	...
	public function testToOptionArrayMultiSelect() {
		...
		$this->countryCollectionMock->expects ( $this->once () )->method ( 'addFieldToFilter' )->with ( 'country_id', [ 
				'nin' => $excludedCountries 
		] )->willReturnSelf ();
	...
	public function testToOptionArray() {
		...
		$header = [ 
				'value' => '',
				'label' => new \Magento\Framework\Phrase ( '--Please Select--' ) 
		];

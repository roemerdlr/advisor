...
class CcTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $this->objectManagerHelper->getObject ( '\Magento\Braintree\Model\Config\Cc', [ 
	...
	public function testCanUseCcTypeForCountry($country, $ccType, $countryCardType, $ccTypes, $expectedResult) {
		...
		$valueMap = [ 
				[ 
						$prefix . Cc::KEY_COUNTRY_CREDIT_CARD,
						ScopeInterface::SCOPE_STORE,
						null,
						$countryCardType 
				],
				[ 
						$prefix . Cc::KEY_CC_TYPES,
						ScopeInterface::SCOPE_STORE,
						null,
						$ccTypes 
				] 
	...
	public function canUseCcTypeForCountryDataProvider() {
		return [ 
				...
				'no_country_card_config_not_allowed' => [ 
						...
						'country_specific_card_types' => 'illega_serialized_form',
						'cc_types' => 'VI,MA,AE',
						'expected_result' => new \Magento\Framework\Phrase ( 'Credit card type is not allowed for this payment method.' ) 
				],
				...
				'country_card_not_found_card_type_not_allowed' => [ 
						...
						'cc_types' => 'VI,MA,AE',
						'expected_result' => new \Magento\Framework\Phrase ( 'Credit card type is not allowed for your country.' ) 
				],
				'country_card_found' => [ 
						'country' => 'US',
						'cc_type' => 'random_card_type',

...
class PayPalTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $this->objectManagerHelper->getObject ( '\Magento\Braintree\Model\Config\PayPal', [ 
	...
	public function testGetMerchantNameOverride() {
		...
		$this->scopeConfigMock->expects ( $this->once () )->method ( 'getValue' )->with ( $prefix . PayPal::KEY_MERCHANT_NAME_OVERRIDE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, null )->willReturn ( $merchantName );

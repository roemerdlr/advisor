...
class ProcessBraintreeAddressTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->processBraintreeAddressObserver = $this->objectManagerHelper->getObject ( 'Magento\Braintree\Observer\ProcessBraintreeAddress', [ ] );
	}
	public function testProcessBraintreeAddressIfPaymentIsBraintree() {
		...
		$paymentMock->expects ( $this->once () )->method ( 'getMethod' )->willReturn ( \Magento\Braintree\Model\PaymentMethod\PayPal::METHOD_CODE );

...
class AddPaypalShortcuts implements ObserverInterface {
	 ...
	 */
	public function __construct(\Magento\Braintree\Model\PaymentMethod\PayPal $methodPayPal, \Magento\Braintree\Model\Config\PayPal $paypalConfig) {
	...
	public function execute(\Magento\Framework\Event\Observer $observer) {
		...
		if (! $this->methodPayPal->isActive () || ! $this->paypalConfig->isShortcutCheckoutEnabled () || ! $isMiniCart) {
			return;
		}

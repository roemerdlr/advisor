...
class Management extends \Magento\Framework\View\Element\Template {
	 ...
	 */
	public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Directory\Model\ResourceModel\Region\CollectionFactory $regionCollectionFactory, \Magento\Payment\Model\Config $paymentConfig, \Magento\Braintree\Model\Vault $vault, \Magento\Braintree\Model\Config\Cc $config, \Magento\Customer\Model\Session $customerSession, \Magento\Customer\Api\CustomerRepositoryInterface $customerRepository, \Magento\Payment\Model\CcConfig $ccConfig, \Magento\Braintree\Helper\Data $dataHelper, array $data = []) {
	...
	public function countrySelect($name, $id, $default = '', $title = 'Country') {
		...
		return $this->getChildBlock ( 'customer_creditcard_management_country' )->getCountryHtmlSelect ( $default, $name, $id, $title );
	}
	...
	public function getEditUrl($token) {
		return $this->getUrl ( 'braintree/creditcard/edit', [ 
				'token' => $token,
				'_secure' => true 
		] );
	}
	...
	public function getDeleteUrl($token) {
		return $this->getUrl ( 'braintree/creditcard/delete', [ 
				'token' => $token,
				'_secure' => true 
		] );
	}

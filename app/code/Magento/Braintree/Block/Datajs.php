...
class Datajs extends \Magento\Framework\View\Element\Template {
	...
	public function getJsSrc() {
		return $this->_scopeConfig->getValue ( self::JS_SRC_CONFIG_PATH, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, null );
	}
	...
	public function getMerchantId() {
		return $this->_scopeConfig->getValue ( self::MERCHANT_ID_CONFIG_PATH, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, null );
	}

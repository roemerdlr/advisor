...
class Countries extends \Magento\Framework\View\Element\Html\Select {
	 ...
	 * @param array $data        	
	 */
	public function __construct(\Magento\Framework\View\Element\Context $context, \Magento\Braintree\Model\System\Config\Source\Country $countrySource, \Magento\Directory\Model\ResourceModel\Country\CollectionFactory $countryCollectionFactory, array $data = []) {
	...
	protected function _getCountries() {
		if (! $this->countries) {
			...
			$this->countries = $this->countryCollectionFactory->create ()->addFieldToFilter ( 'country_id', [ 
					'nin' => $restrictedCountries 

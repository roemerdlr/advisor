...
class Checkout extends \Magento\Paypal\Model\Express\Checkout {
	...
	public function initializeQuoteForReview($paymentMethodNonce, array $details) {
		...
		$this->_quote->setMayEditShippingAddress ( true );
		$this->_quote->setMayEditShippingMethod ( true );
	...
	protected function importBillingAddressData($address, $exportedAddress) {
		$line1 = isset ( $exportedAddress ['streetAddress'] ) ? $exportedAddress ['streetAddress'] : $exportedAddress ['line1'];
		$line2 = isset ( $exportedAddress ['extendedAddress'] ) ? $exportedAddress ['extendedAddress'] : $exportedAddress ['line2'];
		$city = isset ( $exportedAddress ['locality'] ) ? $exportedAddress ['locality'] : $exportedAddress ['city'];
		$regionCode = isset ( $exportedAddress ['region'] ) ? $exportedAddress ['region'] : $exportedAddress ['state'];
		$countryCode = isset ( $exportedAddress ['countryCodeAlpha2'] ) ? $exportedAddress ['countryCodeAlpha2'] : $exportedAddress ['countryCode'];

...
class Config {
	 ...
	 */
	public function __construct(ScopeConfigInterface $scopeConfig, BraintreeConfiguration $braintreeConfiguration, BraintreeClientToken $braintreeClientToken, \Magento\Braintree\Model\System\Config\Source\Country $sourceCountry) {
	 ...
	 * This function can be called more than once with different storeId
	 *
	 * @param int $storeId        	
	 * @return $this
	 */

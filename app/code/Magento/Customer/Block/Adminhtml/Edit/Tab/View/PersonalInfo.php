...
class PersonalInfo extends \Magento\Backend\Block\Template {
	 ...
	 * since his last activity.
	 * Used only if it's impossible to get such setting
	 * from configuration.
	 */
	...
	public function getStoreCreateDate() {
		...
		try {
			return $this->formatDate ( $createdAt, \IntlDateFormatter::MEDIUM, true, $this->getStoreCreateDateTimezone () );
		} catch ( \Exception $e ) {
	...
	public function getCreateDate() {
		return $this->formatDate ( $this->getCustomer ()->getCreatedAt (), \IntlDateFormatter::MEDIUM, true );
	}
	...
	protected function getOnlineMinutesInterval() {
		$configValue = $this->_scopeConfig->getValue ( 'customer/online_customers/online_minutes_interval', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );

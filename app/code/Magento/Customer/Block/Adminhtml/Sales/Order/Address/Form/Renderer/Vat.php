...
class Vat extends \Magento\Backend\Block\Widget\Form\Renderer\Fieldset\Element {
	...
	public function getValidateButton() {
		if ($this->_validateButton === null) {
			...
			$groupMessage = __ ( 'The customer is now assigned to Customer Group %s.' ) . ' ' . __ ( 'Would you like to change the Customer Group for this order?' );
			...
			$this->_validateButton = $this->getLayout ()->createBlock ( 'Magento\Backend\Block\Widget\Button' )->setData ( [ 

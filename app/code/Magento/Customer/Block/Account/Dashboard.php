...
class Dashboard extends \Magento\Framework\View\Element\Template {
	...
	public function getAddressesUrl() {
		return $this->_urlBuilder->getUrl ( 'customer/address/index', [ 
				'_secure' => true 
		] );
	}
	...
	public function getOrdersUrl() {
		return $this->_urlBuilder->getUrl ( 'customer/order/index', [ 
				'_secure' => true 
		] );
	}
	...
	public function getReviewsUrl() {
		return $this->_urlBuilder->getUrl ( 'review/customer/index', [ 
				'_secure' => true 
		] );
	}
	...
	public function getWishlistUrl() {
		return $this->_urlBuilder->getUrl ( 'customer/wishlist/index', [ 
				'_secure' => true 
		] );
	}
	
	/**
	 * Retrieve the subscription object (i.e.
	 * the subscriber).
	 *
	...
	public function getSubscriptionObject() {
		if ($this->subscription === null) {
			$this->subscription = $this->_createSubscriber ()->loadByCustomerId ( $this->customerSession->getCustomerId () );
		}
	...
	/**
	 * Retrieve the customer's primary addresses (i.e.

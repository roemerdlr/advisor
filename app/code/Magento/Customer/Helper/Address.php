...
class Address extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	public function getConfig($key, $store = null) {
		...
		if (! isset ( $this->_config [$websiteId] )) {
			$this->_config [$websiteId] = $this->scopeConfig->getValue ( 'customer/address', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
		}
	 ...
	 * @return string @SuppressWarnings(PHPMD.NPathComplexity)
	 */
	...
	public function isVatValidationEnabled($store = null) {
		return ( bool ) $this->scopeConfig->getValue ( self::XML_PATH_VAT_VALIDATION_ENABLED, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	}
	...
	public function isDisableAutoGroupAssignDefaultValue() {
		return ( bool ) $this->scopeConfig->getValue ( self::XML_PATH_VIV_DISABLE_AUTO_ASSIGN_DEFAULT, \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
	}
	...
	public function hasValidateOnEachTransaction($store = null) {
		return ( bool ) $this->scopeConfig->getValue ( self::XML_PATH_VIV_ON_EACH_TRANSACTION, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	}
	...
	public function getTaxCalculationAddressType($store = null) {
		return ( string ) $this->scopeConfig->getValue ( self::XML_PATH_VIV_TAX_CALCULATION_ADDRESS_TYPE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	}
	...
	public function isVatAttributeVisible() {
		return ( bool ) $this->scopeConfig->getValue ( self::XML_PATH_VAT_FRONTEND_VISIBILITY, \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
	}
}

...
class AbstractAddress extends AbstractExtensibleModel implements AddressModelInterface {
	...
	/**
	 * Alias for a street setter.
	 * To be used though setDataUsingMethod('street_full', $value).
	 *
	...
	public function getRegionId() {
		...
		if (! $regionId) {
			if (is_numeric ( $region )) {
				...
				$regionModel = $this->_createRegionInstance ()->loadByCode ( $this->getRegionCode (), $this->getCountryId () );
	...
	public function format($type) {
		...
		$this->_eventManager->dispatch ( 'customer_address_format', [ 
				'type' => $formatType,
				'address' => $this 
		] );
	 ...
	 * @return AddressInterface Use Api/Data/AddressInterface as a result of service operations. Don't rely on the model to provide
	 ...
	 *
	 * @return bool|array @SuppressWarnings(PHPMD.CyclomaticComplexity)

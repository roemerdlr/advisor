...
class Validator extends \Magento\Eav\Model\Validator\Attribute\Data {
	 ...
	 *
	 * @param \Magento\Framework\DataObject|array $entityData
	 *        	Data set from the Model attributes
	 * @return bool
	 */
	...
	public function validateData(array $data, array $attributes, $entityType) {
		foreach ( $attributes as $attribute ) {
			...
			$value = empty ( $data [$attributeCode] ) && isset ( $this->_entityData [$attributeCode] ) ? $this->_entityData [$attributeCode] : $data [$attributeCode];

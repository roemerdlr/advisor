...
class Form {
	...
	public function getAllowedAttributes() {
		...
		foreach ( $attributes as $attributeCode => $attribute ) {
			if ($this->_ignoreInvisible && ! $attribute->isVisible () || in_array ( $attribute->getAttributeCode (), $this->_filterAttributes )) {
	...
	protected function _getValidator(array $data) {
		...
		$builder->addConfiguration ( 'metadata_data_validator', [ 

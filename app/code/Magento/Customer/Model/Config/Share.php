...
class Share extends \Magento\Framework\App\Config\Value implements \Magento\Framework\Option\ArrayInterface {
	...
	public function isWebsiteScope() {
		return $this->_config->getValue ( self::XML_PATH_CUSTOMER_ACCOUNT_SHARE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE ) == self::SHARE_WEBSITE;
	}
	 ...
	 *
	 * @param int $websiteId
	 *        	the ID to use if website scope is on
	 * @return int[]
	 */

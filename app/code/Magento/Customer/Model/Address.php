...
class Address extends \Magento\Customer\Model\Address\AbstractAddress {
	 ...
	 * @return $this Use Api/RepositoryInterface for the operations in the Data Interfaces. Don't rely on Address Model
	 */
	...
	/**
	 * Set Region ID.
	 * $regionId is automatically converted to integer
	 *
	 * @param int $regionId        	
	 * @return $this
	 */

...
class SectionPool implements SectionPoolInterface {
	...
	/**
	 * Section map.
	 * Key is section name, value is section source object class
	 *
	 * @var array
	 */
	 ...
	 */
	public function __construct(ObjectManagerInterface $objectManager, \Magento\Customer\CustomerData\Section\Identifier $identifier, array $sectionSourceMap = []) {

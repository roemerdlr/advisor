...
class AttributeRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->customerMetadataManagement = $this->getMockForAbstractClass ( 'Magento\Customer\Api\CustomerMetadataManagementInterface', [ ], '', false );
		$this->addressMetadataManagement = $this->getMockForAbstractClass ( 'Magento\Customer\Api\AddressMetadataManagementInterface', [ ], '', false );
		$this->customerMetadata = $this->getMockForAbstractClass ( 'Magento\Customer\Api\CustomerMetadataInterface', [ ], '', false );
		$this->addressMetadata = $this->getMockForAbstractClass ( 'Magento\Customer\Api\AddressMetadataInterface', [ ], '', false );
		$this->attribute = $this->getMockForAbstractClass ( 'Magento\Customer\Api\Data\AttributeMetadataInterface', [ ], '', false );
		...
		$this->component = new AttributeRepository ( $this->customerMetadataManagement, $this->addressMetadataManagement, $this->customerMetadata, $this->addressMetadata, $this->attributeFilter );
	}
	public function testGetList() {
		...
		$this->addressMetadata->expects ( $this->once () )->method ( 'getAllAttributesMetadata' )->willReturn ( [ 
				$this->attribute 
		] );

...
class UpgradeHashAlgorithmCommandTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->customerCollectionFactory = $this->getMockBuilder ( 'Magento\Customer\Model\ResourceModel\Customer\CollectionFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		
		$this->objectManager = new ObjectManager ( $this );
		
		$this->command = $this->objectManager->getObject ( 'Magento\Customer\Console\Command\UpgradeHashAlgorithmCommand', [ 
	...
	public function testConfigure() {
		...
		$this->assertEquals ( 'Upgrade customer\'s hash according to the latest algorithm', $this->command->getDescription () );
	}
}

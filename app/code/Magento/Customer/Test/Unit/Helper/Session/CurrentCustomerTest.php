...
class CurrentCustomerTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->customerInterfaceFactoryMock = $this->getMock ( 'Magento\Customer\Api\Data\CustomerInterfaceFactory', [ 
				'create',
				'setGroupId' 
		], [ ], '', false );
		...
		$this->currentCustomer = new \Magento\Customer\Helper\Session\CurrentCustomer ( $this->customerSessionMock, $this->layoutMock, $this->customerInterfaceFactoryMock, $this->customerRepositoryMock, $this->requestMock, $this->moduleManagerMock, $this->viewMock );
	}

...
class IndexTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->indexController = $objectManager->getObject ( 'Magento\Customer\Controller\Adminhtml\Index\Index', [ 
	...
	public function testExecute() {
		...
		$this->resultPageMock->expects ( $this->atLeastOnce () )->method ( 'addBreadcrumb' )->withConsecutive ( [ 
				'Customers',
				'Customers' 
		], [ 
				'Manage Customers',

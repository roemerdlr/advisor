...
class ValidateTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->controller = $objectManager->getObject ( 'Magento\Customer\Controller\Adminhtml\System\Config\Validatevat\Validate', [ 
	...
	protected function mockResultJson() {
		...
		$resultJsonFactory = $this->getMockBuilder ( 'Magento\Framework\Controller\Result\JsonFactory' )->setMethods ( [ 
				'create' 

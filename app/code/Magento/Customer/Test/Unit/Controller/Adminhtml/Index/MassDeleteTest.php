...
class MassDeleteTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->massAction = $objectManagerHelper->getObject ( 'Magento\Customer\Controller\Adminhtml\Index\MassDelete', [ 
	...
	public function testExecute() {
		...
		$this->customerRepositoryMock->expects ( $this->any () )->method ( 'deleteById' )->willReturnMap ( [ 
				[ 
						10,
						true 
				],
	...
	public function testExecuteWithException() {
		...
		$this->customerRepositoryMock->expects ( $this->any () )->method ( 'deleteById' )->willThrowException ( new \Exception ( 'Some message.' ) );

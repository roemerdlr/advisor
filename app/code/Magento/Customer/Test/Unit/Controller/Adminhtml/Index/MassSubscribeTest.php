...
class MassSubscribeTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->massAction = $objectManagerHelper->getObject ( 'Magento\Customer\Controller\Adminhtml\Index\MassSubscribe', [ 
	...
	public function testExecute() {
		...
		$this->subscriberMock->expects ( $this->any () )->method ( 'subscribeCustomerById' )->willReturnMap ( [ 
				[ 
						10,
						true 
				],

...
class MassUnsubscribeTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->customerCollectionFactoryMock = $this->getMockBuilder ( 'Magento\Customer\Model\ResourceModel\Customer\CollectionFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		...
		$subscriberFactoryMock = $this->getMockBuilder ( 'Magento\Newsletter\Model\SubscriberFactory' )->setMethods ( [ 
				'create' 
		...
		$this->massAction = $objectManagerHelper->getObject ( 'Magento\Customer\Controller\Adminhtml\Index\MassUnsubscribe', [ 
	...
	public function testExecute() {
		...
		$this->customerRepositoryMock->expects ( $this->any () )->method ( 'getById' )->willReturnMap ( [ 
				[ 
						10,
						true 
				],
		...
		$this->subscriberMock->expects ( $this->any () )->method ( 'unsubscribeCustomerById' )->willReturnMap ( [ 
				[ 
						10,
						true 
				],

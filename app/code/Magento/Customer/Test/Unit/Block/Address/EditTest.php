...
class EditTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->addressRepositoryMock = $this->getMockBuilder ( 'Magento\Customer\Api\AddressRepositoryInterface' )->getMock ();
		...
		$this->addressDataFactoryMock = $this->getMockBuilder ( 'Magento\Customer\Api\Data\AddressInterfaceFactory' )->setMethods ( [ 
				'create' 
		...
		$this->model = $this->objectManager->getObject ( 'Magento\Customer\Block\Address\Edit', [ 
	...
	public function testSetLayoutWithAlienAddress() {
		...
		$this->customerSessionMock->expects ( $this->at ( 0 ) )->method ( 'getCustomerId' )->willReturn ( $customerId + 1 );
		...
		$newAddressMock->expects ( $this->once () )->method ( 'getId' )->willReturn ( null );
	...
	public function testSetLayoutWithoutAddressId() {
		...
		$this->requestMock->expects ( $this->once () )->method ( 'getParam' )->with ( 'id', null )->willReturn ( '' );

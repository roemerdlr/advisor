...
class AbstractWidgetTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->_block = new \Magento\Customer\Block\Widget\AbstractWidget ( $this->getMock ( 'Magento\Framework\View\Element\Template\Context', [ ], [ ], '', false ), $this->_addressHelper, $this->getMockBuilder ( '\Magento\Customer\Api\CustomerMetadataInterface' )->getMockForAbstractClass () );
	}
	...
	public function testGetConfig($key, $expectedValue) {
		$this->_addressHelper->expects ( $this->once () )->method ( 'getConfig' )->with ( $key )->will ( $this->returnValue ( $expectedValue ) );
	 ...
	 *
	 * @param string $format
	 *        	Field id format (e.g. '%s' or '%d')
	 * @param string $fieldId
	 *        	Field id
	 * @param string $expectedValue
	 *        	The value we expect from AbstractWidget::getFieldId()
	 * @param string $method
	 *        	The method to invoke on the result from getFieldId() should return true
	 *        	
	 ...
	 *
	 * @param string $format
	 *        	Field name format (e.g. '%s' or '%d')
	 * @param string $fieldName
	 *        	The field name
	 * @param string $expectedValue
	 *        	The value we expect from AbstractWidget::getFieldName
	 * @param string $method
	 *        	The method to invoke on the result from getFieldName() should return true
	 *        	

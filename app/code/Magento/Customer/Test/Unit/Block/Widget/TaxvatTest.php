...
class TaxvatTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->customerMetadata->expects ( $this->any () )->method ( 'getAttributeMetadata' )->with ( self::TAXVAT_ATTRIBUTE_CODE )->will ( $this->returnValue ( $this->attribute ) );
		
		$this->_block = new \Magento\Customer\Block\Widget\Taxvat ( $this->getMock ( 'Magento\Framework\View\Element\Template\Context', [ ], [ ], '', false ), $this->getMock ( 'Magento\Customer\Helper\Address', [ ], [ ], '', false ), $this->customerMetadata );
	}
	
	/**
	 *
	 * @param bool $isVisible
	 *        	Determines whether the 'taxvat' attribute is visible or enabled
	 * @param bool $expectedValue
	 *        	The value we expect from Taxvat::isEnabled()
	 * @return void @dataProvider isEnabledDataProvider
	 */
	 ...
	 *        	Determines whether the 'taxvat' attribute is required
	 * @param bool $expectedValue
	 *        	The value we expect from Taxvat::isRequired()
	 * @return void @dataProvider isRequiredDataProvider
	 */

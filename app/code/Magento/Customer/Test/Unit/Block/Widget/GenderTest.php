...
class GenderTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->customerMetadata->expects ( $this->any () )->method ( 'getAttributeMetadata' )->with ( self::GENDER_ATTRIBUTE_CODE )->will ( $this->returnValue ( $this->attribute ) );
		...
		$this->block = new \Magento\Customer\Block\Widget\Gender ( $this->getMock ( 'Magento\Framework\View\Element\Template\Context', [ ], [ ], '', false ), $this->getMock ( 'Magento\Customer\Helper\Address', [ ], [ ], '', false ), $this->customerMetadata, $this->customerRepository, $this->customerSession );
	}
	 ...
	 *        	Determines whether the 'gender' attribute is visible or enabled
	 * @param bool $expectedValue
	 *        	The value we expect from Gender::isEnabled()
	 ...
	 * @param bool $expectedValue
	 *        	The value we expect from Gender::isRequired()

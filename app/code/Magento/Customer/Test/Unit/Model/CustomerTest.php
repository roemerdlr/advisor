...
class CustomerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->attributeFactoryMock = $this->getMock ( 'Magento\Customer\Model\AttributeFactory', [ 
				'create' 
		], [ ], '', false );
		$this->attributeCustomerMock = $this->getMock ( 'Magento\Customer\Model\Attribute', [ ], [ ], '', false );
		$this->resourceMock = $this->getMock ( '\Magento\Customer\Model\ResourceModel\Customer', // '\Magento\Framework\DataObject',
[ 
				'getIdFieldName' 
		], [ ], '', false, false );
		...
		$this->_model = $helper->getObject ( 'Magento\Customer\Model\Customer', [ 
	...
	public function validateDataProvider() {
		...
		return [ 
				...
				[ 
						...
						[ 
								'Please correct this email address: "".' 
						] 
				],
				[ 
						array_merge ( $data, [ 
	...
	public function testSendNewAccountEmailWithoutStoreId() {
		...
		$website->expects ( $this->once () )->method ( 'getStoreIds' )->will ( $this->returnValue ( [ 
				1,
				2,
				3,
				4 

...
class RegionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->regionFactory = $this->getMock ( 'Magento\Directory\Model\RegionFactory', [ 
				'create' 
		], [ ], '', false );
		$this->region = $this->getMock ( 'Magento\Directory\Model\Region', [ 
				'load',
				'getId',
				'getCountryId',
				'getName' 
		...
		$this->object = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'getData',
				'getCountryId',
				'setRegionId',
				'setRegion' 

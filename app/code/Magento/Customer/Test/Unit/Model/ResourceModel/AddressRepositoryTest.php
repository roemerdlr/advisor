...
class AddressRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->addressFactory = $this->getMock ( 'Magento\Customer\Model\AddressFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->addressSearchResultsFactory = $this->getMock ( 'Magento\Customer\Api\Data\AddressSearchResultsInterfaceFactory', [ 
				'create' 
		], [ ], '', false );
		$this->addressCollectionFactory = $this->getMock ( 'Magento\Customer\Model\ResourceModel\Address\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->address = $this->getMock ( 'Magento\Customer\Model\Address', [ 
				'getId',
				'getCountryId',
				'getFirstname',
				'getLastname',
		...
		$this->repository = new \Magento\Customer\Model\ResourceModel\AddressRepository ( $this->addressFactory, $this->addressRegistry, $this->customerRegistry, $this->addressResourceModel, $this->directoryData, $this->addressSearchResultsFactory, $this->addressCollectionFactory, $this->extensionAttributesJoinProcessor );
	}

...
class CustomerManagementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->customersFactoryMock = $this->getMock ( 'Magento\Customer\Model\ResourceModel\Customer\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		$this->model = new \Magento\Customer\Model\CustomerManagement ( $this->customersFactoryMock );
	}

...
class FilterTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->model = new Filter ( $this->resource, $this->flatScopeResolver, $this->indexerRegistry );
	}
	public function testFilter() {
		...
		$this->connection->expects ( $this->once () )->method ( 'describeTable' )->with ( $tableName )->willReturn ( [ 
				'attribute-code' => [ 
						'Attribute data' 
				] 
		] );

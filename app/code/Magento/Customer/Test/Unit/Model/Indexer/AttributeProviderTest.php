...
class AttributeProviderTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->object = new AttributeProvider ( $this->eavConfig );
	}
	...
	public function testAddDynamicData() {
		...
		$attribute = $this->getMockBuilder ( 'Magento\Customer\Model\Attribute' )->disableOriginalConstructor ()->setMethods ( [ 
				'setEntity',
				'getName',
				'getFrontendInput',
				'getBackendType',
		...
		$attribute->expects ( $this->any () )->method ( 'canBeFilterableInGrid' )->willReturn ( false );
	...
	public function testAddDynamicDataWithStaticAndSearchable() {
		...
		$attribute->expects ( $this->any () )->method ( 'getFrontendInput' )->willReturn ( $attrFrontendInput );
		$attribute->expects ( $this->any () )->method ( 'getBackendType' )->willReturn ( $attrBackendType );
		$attribute->expects ( $this->any () )->method ( 'canBeSearchableInGrid' )->willReturn ( true );
		$attribute->expects ( $this->never () )->method ( 'canBeFilterableInGrid' );

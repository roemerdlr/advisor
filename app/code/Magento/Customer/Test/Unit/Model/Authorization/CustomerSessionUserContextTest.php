...
class CustomerSessionUserContextTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->customerSessionUserContext = $this->objectManager->getObject ( 'Magento\Customer\Model\Authorization\CustomerSessionUserContext', [ 
	...
	public function setupUserId($userId) {
		$this->customerSession->expects ( $this->once () )->method ( 'getId' )->will ( $this->returnValue ( $userId ) );
	}
}

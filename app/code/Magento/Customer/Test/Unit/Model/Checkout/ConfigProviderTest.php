...
class ConfigProviderTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->store = $this->getMockForAbstractClass ( 'Magento\Store\Api\Data\StoreInterface', [ ], '', false, false, true, [ 
				'getBaseUrl' 
		] );
		
		$this->provider = new ConfigProvider ( $this->urlBuilder, $this->storeManager, $this->scopeConfig );
	}
	public function testGetConfigWithoutRedirect() {
		...
		$this->scopeConfig->expects ( $this->once () )->method ( 'getValue' )->with ( Form::XML_PATH_ENABLE_AUTOCOMPLETE, ScopeInterface::SCOPE_STORE )->willReturn ( 1 );
		$this->assertEquals ( [ 

...
class SessionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_storageMock = $this->getMock ( 'Magento\Customer\Model\Session\Storage', [ 
	...
	public function testSetCustomerAsLoggedIn() {
		...
		$this->_eventManagerMock->expects ( $this->at ( 0 ) )->method ( 'dispatch' )->with ( 'customer_login', [ 
				'customer' => $customer 
		] );
		$this->_eventManagerMock->expects ( $this->at ( 1 ) )->method ( 'dispatch' )->with ( 'customer_data_object_login', [ 

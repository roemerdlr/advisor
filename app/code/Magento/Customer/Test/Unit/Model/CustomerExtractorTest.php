...
class CustomerExtractorTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->formFactory = $this->getMockForAbstractClass ( 'Magento\Customer\Model\Metadata\FormFactory', [ ], '', false, false, true, [ 
				'create' 
		] );
		$this->customerFactory = $this->getMockForAbstractClass ( 'Magento\Customer\Api\Data\CustomerInterfaceFactory', [ ], '', false, false, true, [ 
				'create' 
		] );
		$this->storeManager = $this->getMockForAbstractClass ( 'Magento\Store\Model\StoreManagerInterface', [ ], '', false );
		$this->customerGroupManagement = $this->getMockForAbstractClass ( 'Magento\Customer\Api\GroupManagementInterface', [ ], '', false );
		...
		$this->customerGroup = $this->getMockForAbstractClass ( 'Magento\Customer\Api\Data\GroupInterface', [ ], '', false );
		$this->customerExtractor = new CustomerExtractor ( $this->formFactory, $this->customerFactory, $this->storeManager, $this->customerGroupManagement, $this->dataObjectHelper );
	}
	public function testExtract() {
		...
		$this->customerForm->expects ( $this->once () )->method ( 'getAllowedAttributes' )->willReturn ( [ 
				'group_id' => 'attribute object' 
		] );

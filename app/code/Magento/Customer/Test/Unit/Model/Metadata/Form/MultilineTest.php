...
class MultilineTest extends TextTest {
	...
	protected function getClass($value) {
		return new \Magento\Customer\Model\Metadata\Form\Multiline ( $this->localeMock, $this->loggerMock, $this->attributeMetadataMock, $this->localeResolverMock, $value, 0, false, $this->stringHelper );
	}
	...
	public function validateValueRequiredDataProvider() {
		return array_merge ( parent::validateValueRequiredDataProvider (), [ 
				'lines' => [ 
						[ 
								'one',
								'two' 
	...
	public function validateValueLengthDataProvider() {
		return array_merge ( parent::validateValueLengthDataProvider (), [ 
				'long lines' => [ 
						[ 
								'0123456789',
								'0123456789' 

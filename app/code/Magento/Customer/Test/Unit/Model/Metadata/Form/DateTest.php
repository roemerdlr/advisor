...
class DateTest extends AbstractFormTestCase {
	 ...
	 *        	Array of more validation metadata
	 * @param bool $required
	...
	public function validateValueDataProvider() {
		return [ 
				...
				'Empty value, required' => [ 
						...
						true,
						[ 
								'"Space Date" is a required value.' 
						] 
				],
				'Valid date, min set' => [ 
						'1961-5-5',
						[ 
								'date_range_min' => strtotime ( '4/12/1961' ) 
						],
						false,
						true 
				],
	...
	public function testOutputValue() {
		...
		$date = new \Magento\Customer\Model\Metadata\Form\Date ( $this->localeMock, $this->loggerMock, $this->attributeMetadataMock, $this->localeResolverMock, '2012/12/31', 0 );

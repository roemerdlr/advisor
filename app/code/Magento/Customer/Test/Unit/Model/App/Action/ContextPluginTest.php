...
class ContextPluginTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->plugin = new \Magento\Customer\Model\App\Action\ContextPlugin ( $this->customerSessionMock, $this->httpContextMock );
	}
	...
	public function testAroundDispatch() {
		...
		$this->httpContextMock->expects ( $this->atLeastOnce () )->method ( 'setValue' )->will ( $this->returnValueMap ( [ 
				[ 

...
interface GroupRepositoryInterface {
	 ...
	 * @throws \Magento\Framework\Exception\State\InvalidTransitionException If saving customer group with customer group code that is used by an existing customer group

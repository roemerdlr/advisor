...
class Load extends \Magento\Framework\App\Action\Action {
	 ...
	 */
	public function __construct(Context $context, JsonFactory $resultJsonFactory, \Magento\Customer\CustomerData\Section\Identifier $sectionIdentifier, SectionPoolInterface $sectionPool) {
	...
	public function execute() {
		...
		try {
			...
			$resultJson->setStatusHeader ( \Zend\Http\Response::STATUS_CODE_400, \Zend\Http\AbstractMessage::VERSION_11, 'Bad Request' );
			$response = [ 

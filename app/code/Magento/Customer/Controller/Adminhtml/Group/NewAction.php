...
class NewAction extends \Magento\Customer\Controller\Adminhtml\Group {
	...
	public function execute() {
		...
		if ($groupId === null) {
			...
			$resultPage->getConfig ()->getTitle ()->prepend ( $this->groupRepository->getById ( $groupId )->getCode () );
		}
		
		$resultPage->getLayout ()->addBlock ( 'Magento\Customer\Block\Adminhtml\Group\Edit', 'group', 'content' )->setEditMode ( ( bool ) $groupId );

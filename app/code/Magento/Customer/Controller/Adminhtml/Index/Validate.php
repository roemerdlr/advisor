...
class Validate extends \Magento\Customer\Controller\Adminhtml\Index {
	...
	protected function _validateCustomer($response) {
		...
		try {
			...
			$customerForm = $this->_formFactory->create ( 'customer', 'adminhtml_customer', $this->_extensibleDataObjectConverter->toFlatArray ( $customer, [ ], '\Magento\Customer\Api\Data\CustomerInterface' ), true );

...
abstract class Cart extends \Magento\Backend\App\Action {
	 ...
	 */
	public function __construct(Action\Context $context, \Magento\Quote\Api\CartRepositoryInterface $quoteRepository, \Magento\Quote\Model\QuoteFactory $quoteFactory) {

...
class ParamOverriderCustomerIdTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->model = (new ObjectManager ( $this ))->getObject ( 'Magento\Webapi\Controller\Rest\ParamOverriderCustomerId', [ 
	...
	public function testGetOverriddenValueIsCustomer() {
		...
		$this->userContext->expects ( $this->once () )->method ( 'getUserId' )->will ( $this->returnValue ( $retValue ) );

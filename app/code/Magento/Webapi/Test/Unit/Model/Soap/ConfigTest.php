...
class ConfigTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_soapConfig = $this->objectManager->getObject ( 'Magento\Webapi\Model\Soap\Config', [ 
	...
	public function testGetServiceMethodInfo() {
		...
		$methodInfo = $this->_soapConfig->getServiceMethodInfo ( 'customerCustomerRepositoryV1GetById', [ 

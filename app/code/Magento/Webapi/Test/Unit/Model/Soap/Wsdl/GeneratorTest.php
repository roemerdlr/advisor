...
class GeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$_wsdlMock = $this->getMockBuilder ( 'Magento\Webapi\Model\Soap\Wsdl' )->disableOriginalConstructor ()->setMethods ( [ 
		...
		$this->_wsdlFactoryMock = $this->getMockBuilder ( 'Magento\Webapi\Model\Soap\WsdlFactory' )->setMethods ( [ 
				'create' 
		...
		$this->_wsdlGenerator = $objectManager->getObject ( 'Magento\Webapi\Model\Soap\Wsdl\Generator', [ 

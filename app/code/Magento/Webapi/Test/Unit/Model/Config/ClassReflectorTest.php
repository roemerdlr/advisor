...
class ClassReflectorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_typeProcessor = $this->getMock ( '\Magento\Framework\Reflection\TypeProcessor', [ 
				'process' 
		], [ ], '', false );
		$this->_typeProcessor->expects ( $this->any () )->method ( 'process' )->will ( $this->returnValueMap ( [ 
				[ 
						'string',
						'str' 
				],
	...
	public function testReflectClassMethods() {
		$data = $this->_classReflector->reflectClassMethods ( '\\Magento\\Webapi\\Test\\Unit\\Model\\Config\\TestServiceForClassReflector', [ 
				'generateRandomString' => [ 
						'method' => 'generateRandomString' 
				] 
		] );
		$this->assertEquals ( [ 
				'generateRandomString' => $this->_getSampleReflectionData () 
		], $data );
	}
	...
	protected function _getSampleReflectionData() {
		return [ 
				'documentation' => 'Basic random string generator. This line is short description ' . 'This line is long description. This is still the long description.',
				'interface' => [ 
						'in' => [ 
								'parameters' => [ 
										'length' => [ 

...
class GeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->swaggerFactoryMock = $this->getMockBuilder ( 'Magento\Webapi\Model\Rest\SwaggerFactory' )->setMethods ( [ 
				'create' 
		...
		$this->customAttributeTypeLocatorMock->expects ( $this->any () )->method ( 'getAllServiceDataInterfaces' )->willReturn ( [ 
		...
		$this->generator = $this->objectManager->getObject ( 'Magento\Webapi\Model\Rest\Swagger\Generator', [ 
	...
	public function testGenerate($serviceMetadata, $typeData, $schema) {
		...
		$this->typeProcessorMock->expects ( $this->any () )->method ( 'getTypeData' )->willReturnMap ( [ 
				[ 
		...
		$this->typeProcessorMock->expects ( $this->any () )->method ( 'isTypeSimple' )->willReturnMap ( [ 
				[ 
						'int',
						true 
				] 
	...
	public function testGetObjectSchema($typeName, $description, $result) {
		...
		$property->setValue ( $this->generator, [ 

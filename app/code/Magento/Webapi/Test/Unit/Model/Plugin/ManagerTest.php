...
class ManagerTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->integrationConfigMock = $this->getMockBuilder ( '\Magento\Integration\Model\IntegrationConfig' )->disableOriginalConstructor ()->setMethods ( [ 
				'getIntegrations' 
		] )->getMock ();
		
		$this->integrationServiceMock = $this->getMockBuilder ( '\Magento\Integration\Api\IntegrationServiceInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'findByName',
				'update',
				'create',
				'get',
		...
		$this->integrationAuthorizationServiceMock = $this->getMockBuilder ( '\Magento\Integration\Api\AuthorizationServiceInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'grantPermissions',
				'grantAllPermissions',
				'removePermissions' 
		] )->getMock ();
		...
		$this->apiSetupPlugin = new \Magento\Webapi\Model\Plugin\Manager ( $this->integrationConfigMock, $this->integrationAuthorizationServiceMock, $this->integrationServiceMock );
	}
	...
	public function testAfterProcessIntegrationConfigSuccess() {
		...
		$this->integrationConfigMock->expects ( $this->once () )->method ( 'getIntegrations' )->will ( $this->returnValue ( [ 
				'TestIntegration1' => [ 

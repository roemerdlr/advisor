...
class ServiceMetadata {
	 ...
	 */
	public function __construct(\Magento\Webapi\Model\Config $config, WebApiCache $cache, \Magento\Webapi\Model\Config\ClassReflector $classReflector, \Magento\Framework\Reflection\TypeProcessor $typeProcessor) {
		$this->config = $config;
		$this->cache = $cache;
	 ...
	 * @param bool $preserveVersion
	 *        	Should version be preserved during interface name conversion into service name
	 * @return string

...
class Config {
	...
	protected function _createRoute($routeData) {
		...
		$route = $this->_routeFactory->createRoute ( 'Magento\Webapi\Controller\Rest\Router\Route', $routeData [self::KEY_ROUTE_PATH] );
	 ...
	 * Current HTTP method is taken into account.
	 *
	 * @param \Magento\Framework\Webapi\Rest\Request $request        	

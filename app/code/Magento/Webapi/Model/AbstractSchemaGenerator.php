...
abstract class AbstractSchemaGenerator {
	 ...
	 */
	public function __construct(Webapi $cache, \Magento\Framework\Reflection\TypeProcessor $typeProcessor, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Framework\Webapi\CustomAttributeTypeLocatorInterface $customAttributeTypeLocator, \Magento\Webapi\Model\ServiceMetadata $serviceMetadata) {
		$this->cache = $cache;
	...
	public function generate($requestedServices, $requestScheme, $requestHost, $endPointUrl) {
		...
		$this->cache->save ( $schemaContent, $cacheId, [ 
				Webapi::CACHE_TAG 
		] );

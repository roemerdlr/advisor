	...
	public function convert($source) {
		...
		foreach ( $routes as $route ) {
			...
			if (! isset ( $serviceClassData [self::KEY_METHODS] [$serviceMethod] )) {
				...
				$serviceClassData [self::KEY_METHODS] [$serviceMethod] [self::KEY_ACL_RESOURCES] = array_unique ( array_merge ( $serviceClassData [self::KEY_METHODS] [$serviceMethod] [self::KEY_ACL_RESOURCES], $resourcePermissionSet ) );
			}

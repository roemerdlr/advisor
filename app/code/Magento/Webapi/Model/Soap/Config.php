...
class Config {
	 ...
	 */
	public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\Registry $registry, \Magento\Webapi\Model\ServiceMetadata $serviceMetadata) {
	 ...
	 *        	The list of requested services with their versions
	 * @return array <pre>
	 *         array(
	 *         array(
	 *         'class' => $serviceClass,
	...
	public function getServiceMethodInfo($soapOperation, $requestedServices) {
		...
		if (! isset ( $soapOperations [$soapOperation] )) {
			throw new \Magento\Framework\Webapi\Exception ( __ ( 'Operation "%1" not found.', $soapOperation ), 0, \Magento\Framework\Webapi\Exception::HTTP_NOT_FOUND );
		}
		return [ 
	 ...
	 *        	e.g. \Magento\Catalog\Api\ProductInterfaceV1

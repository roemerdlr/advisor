...
class ServerFactory {
	 ...
	 */
	public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Webapi\Controller\Soap\Request\Handler $soapHandler) {
	 ...
	 *        	URL of a WSDL file
	 * @param array $options
	 *        	Options including encoding, soap_version etc
	 * @return \SoapServer
	 */
	public function create($url, $options) {
		$soapServer = $this->_objectManager->create ( 'SoapServer', [ 
				'wsdl' => $url,
				'options' => $options 
		] );

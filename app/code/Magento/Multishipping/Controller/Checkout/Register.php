...
class Register extends \Magento\Multishipping\Controller\Checkout {
	...
	public function execute() {
		...
		if ($registerForm) {
			$registerForm->setShowAddressFields ( true )->setBackUrl ( $this->_getHelper ()->getMSLoginUrl () )->setSuccessUrl ( $this->_getHelper ()->getMSShippingAddressSavedUrl () )->setErrorUrl ( $this->_url->getCurrentUrl () );
		}

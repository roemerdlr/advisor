...
class EditBillingTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->controller = $objectManager->getObject ( 'Magento\Multishipping\Controller\Checkout\Address\EditBilling', [ 
				'context' => $contextMock 
		] );
	}
	public function testExecute() {
		$this->stateMock->expects ( $this->once () )->method ( 'setActiveStep' )->with ( \Magento\Multishipping\Model\Checkout\Type\Multishipping\State::STEP_BILLING );
		...
		$this->addressFormMock->expects ( $this->once () )->method ( 'setTitle' )->with ( 'Edit Billing Address' )->willReturnSelf ();

...
class EditShippingTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$contextMock->expects ( $this->atLeastOnce () )->method ( 'getRequest' )->will ( $this->returnValue ( $this->request ) );
	...
	public function testExecute() {
		$this->stateMock->expects ( $this->once () )->method ( 'setActiveStep' )->with ( \Magento\Multishipping\Model\Checkout\Type\Multishipping\State::STEP_SHIPPING );
		...
		$this->addressFormMock->expects ( $this->once () )->method ( 'setTitle' )->with ( 'Edit Shipping Address' )->willReturnSelf ();
		...
		$this->checkoutMock->expects ( $this->once () )->method ( 'getCustomerDefaultShippingAddress' )->willReturn ( 'shipping_addres' );

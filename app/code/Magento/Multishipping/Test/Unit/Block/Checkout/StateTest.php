...
class StateTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->mShippingStateMock = $this->getMock ( 'Magento\Multishipping\Model\Checkout\Type\Multishipping\State', [ ], [ ], '', false );
	...
	public function testGetSteps() {
		$this->mShippingStateMock->expects ( $this->once () )->method ( 'getSteps' )->will ( $this->returnValue ( [ 
				'expected array' 
		] ) );

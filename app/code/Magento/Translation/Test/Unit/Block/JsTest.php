...
class JsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->configMock = $this->getMockBuilder ( 'Magento\Translation\Model\Js\Config' )->disableOriginalConstructor ()->getMock ();
		$this->fileManagerMock = $this->getMockBuilder ( '\Magento\Translation\Model\FileManager' )->disableOriginalConstructor ()->getMock ();
		$this->model = $objectManager->getObject ( 'Magento\Translation\Block\Js', [ 
	...
	public function testGetTranslationFileTimestamp() {
		$this->fileManagerMock->expects ( $this->once () )->method ( 'getTranslationFileTimestamp' )->willReturn ( 1445736974 );

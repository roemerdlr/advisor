...
class FileManagerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $objectManager->getObject ( '\Magento\Translation\Model\FileManager', [ 
	...
	public function testCreateTranslateConfigAsset() {
		...
		$contextMock = $this->getMockForAbstractClass ( '\Magento\Framework\View\Asset\ContextInterface', [ ], '', true, true, true, [ 
				'getPath' 
		] );
	...
	public function testGetTranslationFileTimestamp() {
		...
		$this->driverFileMock->expects ( $this->once () )->method ( 'stat' )->willReturn ( [ 
				'mtime' => 1445736974 
		] );

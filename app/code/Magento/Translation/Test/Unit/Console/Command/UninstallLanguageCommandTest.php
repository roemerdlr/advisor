...
class UninstallLanguageCommandTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->command = new UninstallLanguageCommand ( $this->dependencyChecker, $this->remove, $this->composerInfo, $this->cache, $this->backupRollbackFactory );
	...
	public function testExecute() {
		...
		$this->dependencyChecker->expects ( $this->once () )->method ( 'checkDependencies' )->with ( [ 
				'vendor/language-ua_ua' 
		] )->willReturn ( $dependencies );
		
		$this->composerInfo->expects ( $this->once () )->method ( 'getRootRequiredPackageTypesByName' )->willReturn ( [ 
	...
	public function testExecutePackageHasDependency() {
		...
		$this->assertContains ( 'Package vendor/language-ua_ua has dependencies and will be skipped', $this->tester->getDisplay () );

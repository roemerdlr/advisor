...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	public function testConstructor() {
		...
		$directoryWrite = $this->getMockBuilder ( '\Magento\Framework\Filesystem\Directory\WriteInterface' )->disableOriginalConstructor ()->getMock ();
		...
		$helper->getObject ( 'Magento\Backup\Model\Fs\Collection', [ 

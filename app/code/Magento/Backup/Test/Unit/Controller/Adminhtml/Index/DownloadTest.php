...
class DownloadTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->backupModelFactoryMock = $this->getMockBuilder ( 'Magento\Backup\Model\BackupFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		$this->backupModelMock = $this->getMockBuilder ( 'Magento\Backup\Model\Backup' )->disableOriginalConstructor ()->setMethods ( [ 
				'getTime',
				'exists',
				'getSize',
				'output' 
		...
		$this->context = $this->objectManager->getObject ( 'Magento\Backend\App\Action\Context', [ 
				'objectManager' => $this->objectManagerMock,
				'request' => $this->requestMock,
				'response' => $this->responseMock,
				'resultRedirectFactory' => $this->resultRedirectFactoryMock 
		] );
		$this->downloadController = $this->objectManager->getObject ( 'Magento\Backup\Controller\Adminhtml\Index\Download', [ 

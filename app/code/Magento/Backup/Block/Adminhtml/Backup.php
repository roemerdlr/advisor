...
class Backup extends \Magento\Backend\Block\Template {
	...
	protected function _prepareLayout() {
		...
		$this->getToolbar ()->addChild ( 'createSnapshotButton', 'Magento\Backend\Block\Widget\Button', [ 
		...
		$this->getToolbar ()->addChild ( 'createMediaBackupButton', 'Magento\Backend\Block\Widget\Button', [ 
		...
		$this->getToolbar ()->addChild ( 'createButton', 'Magento\Backend\Block\Widget\Button', [ 

...
class AuthorizationRoleTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->userResourceModelMock = $this->getMockBuilder ( 'Magento\User\Model\ResourceModel\User' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		...
		$this->model = $objectManager->getObject ( 'Magento\User\Model\Plugin\AuthorizationRole', [ 

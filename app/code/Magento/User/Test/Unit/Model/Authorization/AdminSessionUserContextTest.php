...
class AdminSessionUserContextTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->adminSession = $this->getMockBuilder ( 'Magento\Backend\Model\Auth\Session' )->disableOriginalConstructor ()->setMethods ( [ 
				'hasUser',
				'getUser',
				'getId' 
		] )->getMock ();
		
		$this->adminSessionUserContext = $this->objectManager->getObject ( 'Magento\User\Model\Authorization\AdminSessionUserContext', [ 

...
class ForceAdminPasswordChangeObserverTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->authMock = $this->getMockBuilder ( 'Magento\Framework\AuthorizationInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'isAllowed' 
		] )->getMock ();
		...
		$this->model = $helper->getObject ( 'Magento\User\Observer\Backend\ForceAdminPasswordChangeObserver', [ 
	...
	public function testForceAdminPasswordChange() {
		...
		$controllerMock = $this->getMockBuilder ( 'Magento\Framework\App\Action\AbstractAction' )->disableOriginalConstructor ()->setMethods ( [ 
				'getRedirect',
				'getRequest' 
		] )->getMockForAbstractClass ();
		/** @var \Magento\Framework\App\RequestInterface $requestMock */
		$requestMock = $this->getMockBuilder ( 'Magento\Framework\App\RequestInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'getFullActionName',
				'setDispatched' 
		] )->getMockForAbstractClass ();

...
class DataTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->mathRandomMock = $this->getMockBuilder ( 'Magento\Framework\Math\Random' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		...
		$this->model = $objectManager->getObject ( 'Magento\User\Helper\Data', [ 

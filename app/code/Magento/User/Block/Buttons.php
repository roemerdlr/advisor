...
class Buttons extends \Magento\Backend\Block\Template {
	...
	protected function _prepareLayout() {
		$this->getToolbar ()->addChild ( 'backButton', 'Magento\Backend\Block\Widget\Button', [ 
				'label' => __ ( 'Back' ),
				'onclick' => 'window.location.href=\'' . $this->getUrl ( '*/*/' ) . '\'',
				'class' => 'back' 
		] );
		
		$this->getToolbar ()->addChild ( 'resetButton', 'Magento\Backend\Block\Widget\Button', [ 
				'label' => __ ( 'Reset' ),
		...
		if (intval ( $this->getRequest ()->getParam ( 'rid' ) )) {
			$this->getToolbar ()->addChild ( 'deleteButton', 'Magento\Backend\Block\Widget\Button', [ 
					'label' => __ ( 'Delete Role' ),
					'onclick' => 'deleteConfirm(\'' . __ ( 'Are you sure you want to do this?' ) . '\', \'' . $this->getUrl ( '*/*/delete', [ 
		...
		$this->getToolbar ()->addChild ( 'saveButton', 'Magento\Backend\Block\Widget\Button', [ 
				'label' => __ ( 'Save Role' ),

...
abstract class User extends \Magento\Backend\App\AbstractAction {
	...
	protected function _initAction() {
		...
		$this->_setActiveMenu ( 'Magento_User::system_acl_users' )->_addBreadcrumb ( __ ( 'System' ), __ ( 'System' ) )->_addBreadcrumb ( __ ( 'Permissions' ), __ ( 'Permissions' ) )->_addBreadcrumb ( __ ( 'Users' ), __ ( 'Users' ) );
		return $this;
	}
	...
	protected function _getAdminUserData(array $data) {
		...
		if (! isset ( $data ['password'] ) && isset ( $data ['password_confirmation'] ) && $data ['password_confirmation'] === '') {

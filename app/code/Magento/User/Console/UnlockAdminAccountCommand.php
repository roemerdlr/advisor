...
class UnlockAdminAccountCommand extends Command {
	 ...
	 */
	public function __construct(AdminUser $adminUser, $name = null) {
	...
	protected function configure() {
		...
		$this->addArgument ( self::ARGUMENT_ADMIN_USERNAME, InputArgument::REQUIRED, self::ARGUMENT_ADMIN_USERNAME_DESCRIPTION );
		$this->setHelp ( <<<HELP

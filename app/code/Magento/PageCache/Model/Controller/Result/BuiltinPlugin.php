...
class BuiltinPlugin {
	 ...
	 */
	public function __construct(\Magento\PageCache\Model\Config $config, \Magento\Framework\App\PageCache\Kernel $kernel, \Magento\Framework\App\State $state, \Magento\Framework\Registry $registry) {
		$this->config = $config;
		$this->kernel = $kernel;
		$this->state = $state;
	 ...
	 * @return \Magento\Framework\Controller\ResultInterface @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

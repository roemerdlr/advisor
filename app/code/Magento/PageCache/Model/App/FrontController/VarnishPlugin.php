...
class VarnishPlugin {
	 ...
	 */
	public function __construct(\Magento\PageCache\Model\Config $config, \Magento\Framework\App\PageCache\Version $version, \Magento\Framework\App\State $state) {
		$this->config = $config;
	 ...
	 * @return false|\Magento\Framework\App\Response\Http|\Magento\Framework\Controller\ResultInterface @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

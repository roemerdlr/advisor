...
class CacheIdentifierPluginTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->pageCacheConfigMock = $this->getMock ( 'Magento\PageCache\Model\Config', [ 
				'getType',
				'isEnabled' 
		], [ ], '', false );
		
		$this->plugin = new \Magento\PageCache\Model\App\CacheIdentifierPlugin ( $this->designExceptionsMock, $this->requestMock, $this->pageCacheConfigMock );
	}

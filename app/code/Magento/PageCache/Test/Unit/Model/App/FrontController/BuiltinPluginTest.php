...
class BuiltinPluginTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->plugin = new \Magento\PageCache\Model\App\FrontController\BuiltinPlugin ( $this->configMock, $this->versionMock, $this->kernelMock, $this->stateMock );
	}
	...
	public function testAroundDispatchReturnsResultInterfaceProcessIfCacheMissed($state) {
		...
		$this->assertSame ( $result, $this->plugin->aroundDispatch ( $this->frontControllerMock, $closure, $this->requestMock ) );
	}

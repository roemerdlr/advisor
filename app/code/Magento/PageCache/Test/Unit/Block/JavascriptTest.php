...
class JavascriptTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->blockJavascript = $objectManager->getObject ( 'Magento\PageCache\Block\Javascript', [ 
	...
	public function testGetScriptOptions($isSecure, $url, $expectedResult) {
		...
		$this->requestMock->expects ( $this->once () )->method ( 'getRequestUri' )->will ( $this->returnValue ( 'uri' ) );

...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	public function isRowDownloadableEmptyOptions(array $rowData) {
		$result = isset ( $rowData [Downloadable::COL_DOWNLOADABLE_LINKS] ) && $rowData [Downloadable::COL_DOWNLOADABLE_LINKS] == '' && isset ( $rowData [Downloadable::COL_DOWNLOADABLE_SAMPLES] ) && $rowData [Downloadable::COL_DOWNLOADABLE_SAMPLES] == '';
		return $result;
	}
	...
	public function isRowDownloadableNoValid(array $rowData) {
		$result = isset ( $rowData [Downloadable::COL_DOWNLOADABLE_SAMPLES] ) || isset ( $rowData [Downloadable::COL_DOWNLOADABLE_LINKS] );
		return $result;
	}
	...
	public function fillExistOptions(array $base, array $option, array $existingOptions) {
		...
		foreach ( $existingOptions as $existingOption ) {
			if ($option ['link_url'] == $existingOption ['link_url'] && $option ['link_file'] == $existingOption ['link_file'] && $option ['link_type'] == $existingOption ['link_type'] && $option ['sample_url'] == $existingOption ['sample_url'] && $option ['sample_file'] == $existingOption ['sample_file'] && $option ['sample_type'] == $existingOption ['sample_type'] && $option ['product_id'] == $existingOption ['product_id']) {

...
class CurrencysymbolTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPrepareLayout() {
		$symbolSystemFactoryMock = $this->getMock ( 'Magento\CurrencySymbol\Model\System\CurrencysymbolFactory', [ 
				'create' 
		], [ ], '', false );
		
		$blockMock = $this->getMock ( 'Magento\Framework\View\Element\BlockInterface', [ 
				'addChild',
				'toHtml' 
		], [ ], '', false );
		...
		$blockMock->expects ( $this->once () )->method ( 'addChild' )->with ( 'save_button', 'Magento\Backend\Block\Widget\Button', [ 
		...
		$block = $this->objectManagerHelper->getObject ( 'Magento\CurrencySymbol\Block\Adminhtml\System\Currencysymbol', [ 

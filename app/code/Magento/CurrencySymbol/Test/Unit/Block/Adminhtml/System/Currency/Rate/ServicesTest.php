...
class ServicesTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPrepareLayout() {
		...
		$sourceServiceFactoryMock = $this->getMock ( 'Magento\Directory\Model\Currency\Import\Source\ServiceFactory', [ 
				'create' 
		], [ ], '', false );
		$sourceServiceMock = $this->getMock ( 'Magento\Directory\Model\Currency\Import\Source\Service', [ ], [ ], '', false );
		$backendSessionMock = $this->getMock ( 'Magento\Backend\Model\Session', [ 
		...
		$blockMock = $this->getMock ( 'Magento\Framework\View\Element\Html\Select', [ 
				'setOptions',
				'setId',
				'setName',
				'setValue',
		...
		$block = $this->objectManagerHelper->getObject ( 'Magento\CurrencySymbol\Block\Adminhtml\System\Currency\Rate\Services', [ 

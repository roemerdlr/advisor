...
class CurrencyTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPrepareLayout() {
		$childBlockMock = $this->getMock ( 'Magento\Framework\View\Element\BlockInterface', [ 
				'addChild',
				'toHtml' 
		], [ ], '', false );
		...
		$childBlockMock->expects ( $this->at ( 0 ) )->method ( 'addChild' )->with ( 'save_button', 'Magento\Backend\Block\Widget\Button', [ 
		...
		$childBlockMock->expects ( $this->at ( 1 ) )->method ( 'addChild' )->with ( 'reset_button', 'Magento\Backend\Block\Widget\Button', [ 
				'label' => __ ( 'Reset' ),
		...
		$block = $this->objectManagerHelper->getObject ( 'Magento\CurrencySymbol\Block\Adminhtml\System\Currency', [ 
				'layout' => $layoutMock 
		] );

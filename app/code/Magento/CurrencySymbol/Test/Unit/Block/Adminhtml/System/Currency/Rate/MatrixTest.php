...
class MatrixTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPrepareLayout() {
		...
		$currencyMock = $this->getMock ( 'Magento\Directory\Model\Currency', [ 
		...
		$block = $this->objectManagerHelper->getObject ( 'Magento\CurrencySymbol\Block\Adminhtml\System\Currency\Rate\Matrix', [ 

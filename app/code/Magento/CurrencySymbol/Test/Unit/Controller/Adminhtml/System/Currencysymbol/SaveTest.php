...
class SaveTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->currencySymbolMock = $this->getMock ( 'Magento\CurrencySymbol\Model\System\Currencysymbol', [ ], [ ], '', false );
		
		$this->filterManagerMock = $this->getMock ( 'Magento\Framework\Filter\FilterManager', [ 
				'stripTags' 
		], [ ], '', false );
		...
		$this->action = $objectManager->getObject ( 'Magento\CurrencySymbol\Controller\Adminhtml\System\Currencysymbol\Save', [ 

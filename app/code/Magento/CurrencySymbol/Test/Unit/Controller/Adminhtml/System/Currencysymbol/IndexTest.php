...
class IndexTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->menuItemMock = $this->getMock ( 'Magento\Backend\Model\Menu\Item', [ ], [ ], '', false );
		$this->menuMock = $this->getMock ( 'Magento\Backend\Model\Menu', [ ], [ ], '', false );
		...
		$this->blockMock = $this->getMockForAbstractClass ( 'Magento\Framework\View\Element\BlockInterface', [ ], '', false, false, true, [ 
				'addLink',
				'setActive',
				'getMenuModel' 
		] );
		...
		$this->action = $objectManager->getObject ( 'Magento\CurrencySymbol\Controller\Adminhtml\System\Currencysymbol\Index', [ 
				'view' => $this->viewMock 
		] );
	}
	public function testExecute() {
		$this->menuMock->expects ( $this->once () )->method ( 'getParentItems' )->willReturn ( [ 
				$this->menuItemMock 
		] );

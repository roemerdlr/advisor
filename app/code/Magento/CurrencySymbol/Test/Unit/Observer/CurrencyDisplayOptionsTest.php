...
class CurrencyDisplayOptionsTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->mockSymbolFactory = $this->getMock ( 'Magento\CurrencySymbol\Model\System\CurrencysymbolFactory', [ 
				'create' 
		], [ ], '', false );
		
		$this->mockSymbol = $this->getMock ( 'Magento\CurrencySymbol\Model\System\Currencysymbol', [ 
				'getCurrencySymbol' 
		], [ ], '', false );
		
		$this->mockEventObserver = $this->getMock ( 'Magento\Framework\Event\Observer', [ 
				'getEvent' 
		], [ ], '', false );
		
		$this->mockEvent = $this->getMock ( 'Magento\Framework\Event', [ 
				'getBaseCode',
				'getCurrencyOptions' 
		], [ ], '', false );

...
class SidebarTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->itemMock = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'getProduct' 
		], [ ], '', false );
		$this->productMock = $this->getMock ( 'Magento\Catalog\Model\Product', [ ], [ ], '', false );
		$this->subjectMock = $this->getMock ( 'Magento\Sales\Block\Adminhtml\Order\Create\Sidebar\AbstractSidebar', [ ], [ ], '', false );
	...
	public function testAroundGetItemQtyWhenProductGrouped() {
		...
		$this->assertEquals ( '', $this->sidebarMock->aroundGetItemQty ( $this->subjectMock, $this->closureMock, $this->itemMock ) );
	}
	...
	public function testAroundIsConfigurationRequiredWhenProductGrouped() {
		$this->assertEquals ( true, $this->sidebarMock->aroundIsConfigurationRequired ( $this->subjectMock, $this->closureMock, \Magento\GroupedProduct\Model\Product\Type\Grouped::TYPE_CODE ) );
	}
	public function testAroundIsConfigurationRequiredWhenProductNotGrouped() {
		$this->assertEquals ( 'Expected', $this->sidebarMock->aroundIsConfigurationRequired ( $this->subjectMock, $this->closureMock, 'someValue' ) );
	}
}

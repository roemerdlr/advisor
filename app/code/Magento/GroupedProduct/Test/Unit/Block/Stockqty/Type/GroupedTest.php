...
class GroupedTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->block = $objectManager->getObject ( 'Magento\GroupedProduct\Block\Stockqty\Type\Grouped', [ 
	...
	public function testGetIdentities() {
		...
		$typeInstance->expects ( $this->once () )->method ( 'getAssociatedProducts' )->will ( $this->returnValue ( [ 
				$childProduct 
		] ) );

...
class PopupTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->factory = $this->getMock ( 'Magento\Catalog\Model\ProductFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->action = $this->objectManager->getObject ( 'Magento\GroupedProduct\Controller\Adminhtml\Edit\Popup', [ 

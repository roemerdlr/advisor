...
class ActionTest extends \PHPUnit_Framework_TestCase {
	...
	public function testAroundUpdateAttributesNonScheduled() {
		...
		$this->indexerMock->expects ( $this->once () )->method ( 'reindexList' )->with ( [ 
				1,
				2,
				3 
		] );
		...
		$this->assertEquals ( $this->subjectMock, $this->model->aroundUpdateAttributes ( $this->subjectMock, $closureMock, [ 
				1,
				2,
				3 
		], [ 
	...
	public function testAroundUpdateWebsitesNonScheduled() {
		...
		$this->model->aroundUpdateWebsites ( $this->subjectMock, $closureMock, [ 
				1,
				2,
				3 
		], [ 
	...
	protected function prepareIndexer() {
		$this->indexerRegistryMock->expects ( $this->once () )->method ( 'get' )->with ( \Magento\CatalogSearch\Model\Indexer\Fulltext::INDEXER_ID )->will ( $this->returnValue ( $this->indexerMock ) );
	}
}

...
class AdvancedTest extends PHPUnit_Framework_TestCase {
	...
	public function testPrepareCondition($backendType, $value, $expected) {
		...
		$attributeMock->expects ( $this->once () )->method ( 'getBackendType' )->willReturn ( $backendType );
		
		$this->assertEquals ( $expected, $this->model->prepareCondition ( $attributeMock, $value ) );
	}

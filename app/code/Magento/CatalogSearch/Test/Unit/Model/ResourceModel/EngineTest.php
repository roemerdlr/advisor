...
class EngineTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$resource = $this->getMockBuilder ( '\Magento\Framework\App\ResourceConnection' )->disableOriginalConstructor ()->setMethods ( [ 
				'getConnection',
				'getTableName' 
		] )->getMock ();
		...
		$this->target = $objectManager->getObject ( '\Magento\CatalogSearch\Model\ResourceModel\Engine', [ 
				'resource' => $resource 
		] );
	}

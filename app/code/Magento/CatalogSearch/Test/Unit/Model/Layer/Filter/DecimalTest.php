...
class DecimalTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->filterItem = $this->getMockBuilder ( '\Magento\Catalog\Model\Layer\Filter\Item' )->disableOriginalConstructor ()->setMethods ( [ 
				'setFilter',
				'setLabel',
				'setValue',
				'setCount' 
		...
		$filterDecimalFactory = $this->getMockBuilder ( '\Magento\Catalog\Model\ResourceModel\Layer\Filter\DecimalFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		...
		$this->target = $objectManagerHelper->getObject ( 'Magento\CatalogSearch\Model\Layer\Filter\Decimal', [ 
	...
	public function testItemData() {
		...
		$this->fulltextCollection->expects ( $this->any () )->method ( 'getFacetedData' )->willReturn ( [ 
				'2_10' => [ 
						'count' => 5 
				],
				'*_*' => [ 

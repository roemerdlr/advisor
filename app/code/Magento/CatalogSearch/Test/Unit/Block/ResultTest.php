...
class ResultTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->queryMock = $this->getMockBuilder ( 'Magento\Search\Model\Query' )->disableOriginalConstructor ()->getMock ();
		$this->queryFactoryMock = $this->getMockBuilder ( 'Magento\Search\Model\QueryFactory' )->disableOriginalConstructor ()->setMethods ( [ 
				'get' 
		] )->getMock ();

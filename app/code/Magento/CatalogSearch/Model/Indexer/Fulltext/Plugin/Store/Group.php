...
class Group extends AbstractPlugin {
	 ...
	 */
	public function aroundSave(\Magento\Store\Model\ResourceModel\Group $subject, \Closure $proceed, \Magento\Framework\Model\AbstractModel $group) {
	 ...
	 * @return \Magento\Store\Model\ResourceModel\Group @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	public function afterDelete(\Magento\Store\Model\ResourceModel\Group $subject, \Magento\Store\Model\ResourceModel\Group $result) {
		$this->indexerRegistry->get ( Fulltext::INDEXER_ID )->invalidate ();
		return $result;
	}
}

...
class DataProvider implements DataProviderInterface {
	...
	public function getAggregations(\Magento\Framework\Search\Dynamic\EntityStorage $entityStorage) {
		...
		], 'main_table.entity_id  = entities.entity_id', [ ] )->columns ( $aggregation );
	 ...
	 *
	 */
	public function getInterval(BucketInterface $bucket, array $dimensions, \Magento\Framework\Search\Dynamic\EntityStorage $entityStorage) {

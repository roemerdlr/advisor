...
class ManagerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->sequence = $this->getMockForAbstractClass ( 'Magento\Framework\DB\Sequence\SequenceInterface', [ ], '', false, false, true, [ ] );
		$this->resourceSequenceMeta = $this->getMock ( 'Magento\SalesSequence\Model\ResourceModel\Meta', [ 
				'loadByEntityTypeAndStore' 
		], [ ], '', false );
		$this->sequenceFactory = $this->getMock ( 'Magento\SalesSequence\Model\SequenceFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->sequenceManager = $helper->getObject ( 'Magento\SalesSequence\Model\Manager', [ 

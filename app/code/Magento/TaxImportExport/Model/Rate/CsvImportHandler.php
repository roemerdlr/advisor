...
class CsvImportHandler {
	 ...
	 *
	 * @param array $file
	 *        	file info retrieved from $_FILES array
	 * @return void
	...
	/**
	 * Filter rates data (i.e.
	 * unset all invalid fields and check consistency)
	 *
	 * @param array $rateRawData        	
	 * @param array $invalidFields
	 *        	assoc array of invalid file fields
	 * @param array $validFields
	 *        	assoc array of valid file fields
	 * @return array
	 ...
	 *        	cache of regions of already used countries (is used to optimize performance)
	 * @param array $storesCache
	 *        	cache of stores related to tax rate titles

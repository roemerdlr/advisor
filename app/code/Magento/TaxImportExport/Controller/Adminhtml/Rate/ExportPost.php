...
class ExportPost extends \Magento\TaxImportExport\Controller\Adminhtml\Rate {
	...
	public function execute() {
		...
		$collection = $this->_objectManager->create ( 'Magento\Tax\Model\ResourceModel\Calculation\Rate\Collection' )->joinCountryTable ()->joinRegionTable ();
	...
	protected function _isAllowed() {
		return $this->_authorization->isAllowed ( 'Magento_Tax::manage_tax' ) || $this->_authorization->isAllowed ( 'Magento_TaxImportExport::import_export' );
	}
}

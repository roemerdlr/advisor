...
class ImportExport extends \Magento\TaxImportExport\Controller\Adminhtml\Rate {
	...
	public function execute() {
		...
		$resultPage->addContent ( $resultPage->getLayout ()->createBlock ( 'Magento\TaxImportExport\Block\Adminhtml\Rate\ImportExportHeader' ) );
		$resultPage->addContent ( $resultPage->getLayout ()->createBlock ( 'Magento\TaxImportExport\Block\Adminhtml\Rate\ImportExport' ) );

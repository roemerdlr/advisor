...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
	 ...
	 */
	public function __construct(\Magento\Framework\App\Helper\Context $context, \Magento\Framework\Module\Dir\Reader $modulesReader, \Magento\Framework\Escaper $escaper) {
	...
	public function isRememberMeEnabled($store = null) {
		return $this->scopeConfig->isSetFlag ( self::XML_PATH_REMEMBER_ME_ENABLED, ScopeInterface::SCOPE_STORE, $store );
	}
	...
	public function isRememberMeCheckedDefault($store = null) {
		return $this->scopeConfig->isSetFlag ( self::XML_PATH_REMEMBER_ME_DEFAULT, ScopeInterface::SCOPE_STORE, $store );
	}
	...
	public function isShoppingCartPersist($store = null) {
		return $this->scopeConfig->isSetFlag ( self::XML_PATH_PERSIST_SHOPPING_CART, ScopeInterface::SCOPE_STORE, $store );
	}
	...
	public function getLifeTime($store = null) {
		$lifeTime = intval ( $this->scopeConfig->getValue ( self::XML_PATH_LIFE_TIME, ScopeInterface::SCOPE_STORE, $store ) );
	...
	public function getClearOnLogout() {
		return $this->scopeConfig->isSetFlag ( self::XML_PATH_LOGOUT_CLEAR, ScopeInterface::SCOPE_STORE );
	}
	...
	public function getPersistentConfigFilePath() {
		return $this->_modulesReader->getModuleDir ( Dir::MODULE_ETC_DIR, $this->_getModuleName () ) . '/' . $this->_configFileName;
	}

...
class Session extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
	 ...
	 */
	public function __construct(\Magento\Framework\Model\ResourceModel\Db\Context $context, \Magento\Persistent\Model\SessionFactory $sessionFactory, $connectionName = null) {
	...
	protected function _getLoadSelect($field, $value, $object) {
		...
		if (! $object->getLoadExpired ()) {
			...
			], 'customer.entity_id = ' . $tableName . '.customer_id' )->where ( $tableName . '.updated_at >= ?', $object->getExpiredBefore () );
		}

...
class ConfigProviderPluginTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->maskFactoryMock = $this->getMock ( 'Magento\Quote\Model\QuoteIdMaskFactory', [ 
				'create',
				'__wakeup' 
		], [ ], '', false );
		...
		$this->plugin = new \Magento\Persistent\Model\Checkout\ConfigProviderPlugin ( $this->persistentHelperMock, $this->persistentSessionMock, $this->checkoutSessionMock, $this->maskFactoryMock, $this->customerSessionMock );
	}
	...
	public function configDataProvider() {
		return [ 
				[ 
						...
						true,
						true 
				], // disabled persistence case
				[ 
						true,
						false,
						true 
				], // persistence enabled but not persistent session
				[ 
						true,
						true,
						true 
...
;
	...
	public function testAfterGetConfigPositive() {
		...
		$quoteMaskMock = $this->getMock ( 'Magento\Quote\Model\QuoteIdMask', [ 
				'load',
				'getMaskedId' 
		], [ ], '', false );

...
class DepersonalizePluginTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->persistentSessionMock = $this->getMock ( 'Magento\Persistent\Model\Session', [ 
				'setCustomerId' 
		], [ ], '', false );
		
		$this->requestMock = $this->getMock ( 'Magento\Framework\App\Request\Http', [ ], [ ], '', false );
		
		$this->moduleManagerMock = $this->getMock ( 'Magento\Framework\Module\Manager', [ 
				'isEnabled' 
		], [ ], '', false );
		$this->cacheConfigMock = $this->getMock ( 'Magento\PageCache\Model\Config', [ 
				'isEnabled' 
		], [ ], '', false );
	...
	public function testAfterGenerateXml() {
		...
		$subjectMock = $this->getMockForAbstractClass ( 'Magento\Framework\View\LayoutInterface', [ ], '', false, true, true, [ 
				'isCacheable' 
		] );

...
class SessionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$resourceMock = $this->getMockForAbstractClass ( 'Magento\Framework\Model\ResourceModel\Db\AbstractDb', [ ], '', false, false, true, [ 
				'__wakeup',
				'getIdFieldName',
				'getConnection',
				'beginTransaction',
		...
		$context = $helper->getObject ( 'Magento\Framework\Model\Context', [ 
				'actionValidator' => $actionValidatorMock 
		] );
		
		$this->session = $helper->getObject ( 'Magento\Persistent\Model\Session', [ 
	...
	public function testRenewPersistentCookie($numGetCookieCalls, $numCalls, $cookieDuration = 1000, $cookieValue = 'cookieValue', $cookiePath = 'cookiePath') {
		...
		$cookieMetadataMock->expects ( $this->exactly ( $numCalls ) )->method ( 'setHttpOnly' )->with ( true )->will ( $this->returnSelf () );

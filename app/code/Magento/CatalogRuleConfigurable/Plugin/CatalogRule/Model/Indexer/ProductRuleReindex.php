...
class ProductRuleReindex {
	 ...
	 */
	public function __construct(Configurable $configurable, ConfigurableProductsProvider $configurableProductsProvider) {
	 ...
	 * @return void
	 */
	public function aroundExecuteRow(\Magento\CatalogRule\Model\Indexer\Product\ProductRuleIndexer $subject, \Closure $proceed, $id) {
		$configurableProductIds = $this->configurableProductsProvider->getIds ( [ 
				$id 
		] );

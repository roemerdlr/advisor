...
class ValidationTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->productMock = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'getId' 
		] );
		
		$this->validation = new Validation ( $this->configurableMock );
	}
	 ...
	 *        	dataProviderForValidateWithValidConfigurableProduct
	 * @return void
	 */

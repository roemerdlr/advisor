...
class AddGoogleExperimentTabObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_tabsMock = $this->getMock ( 'Magento\Catalog\Block\Adminhtml\Category\Tabs', [ ], [ ], '', false );
		$this->_eventObserverMock = $this->getMock ( 'Magento\Framework\Event\Observer', [ ], [ ], '', false );
		
		$objectManagerHelper = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		$this->_modelObserver = $objectManagerHelper->getObject ( 'Magento\GoogleOptimizer\Observer\Block\Category\AddGoogleExperimentTabObserver', [ 
	...
	public function testAddGoogleExperimentTabSuccess() {
		...
		$this->_layoutMock->expects ( $this->once () )->method ( 'createBlock' )->with ( 'Magento\GoogleOptimizer\Block\Adminhtml\Catalog\Category\Edit\Tab\Googleoptimizer', 'google-experiment-form' )->will ( $this->returnValue ( $block ) );
		...
		$this->_tabsMock->expects ( $this->once () )->method ( 'addTab' )->with ( 'google-experiment-tab', [ 

...
class DeleteProductGoogleExperimentScriptObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = $objectManagerHelper->getObject ( 'Magento\GoogleOptimizer\Observer\Product\DeleteProductGoogleExperimentScriptObserver', [ 
	...
	public function testDeleteFromProductGoogleExperimentScriptSuccess() {
		...
		$this->_codeMock->expects ( $this->once () )->method ( 'loadByEntityIdAndType' )->with ( $entityId, \Magento\GoogleOptimizer\Model\Code::ENTITY_TYPE_PRODUCT, $storeId );

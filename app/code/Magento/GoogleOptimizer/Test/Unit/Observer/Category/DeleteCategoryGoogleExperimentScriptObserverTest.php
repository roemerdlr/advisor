...
class DeleteCategoryGoogleExperimentScriptObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = $objectManagerHelper->getObject ( 'Magento\GoogleOptimizer\Observer\Category\DeleteCategoryGoogleExperimentScriptObserver', [ 
	...
	public function testDeleteFromCategoryGoogleExperimentScriptSuccess() {
		...
		$this->_codeMock->expects ( $this->once () )->method ( 'loadByEntityIdAndType' )->with ( $entityId, \Magento\GoogleOptimizer\Model\Code::ENTITY_TYPE_CATEGORY, $storeId );

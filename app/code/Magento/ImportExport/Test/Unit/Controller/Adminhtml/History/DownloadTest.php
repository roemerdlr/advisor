...
class DownloadTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->reportHelper = $this->getMock ( 'Magento\ImportExport\Helper\Report', [ 
				'importFileExists',
				'getReportSize',
				'getReportOutput' 
		], [ ], '', false );
		...
		$this->fileFactory = $this->getMock ( 'Magento\Framework\App\Response\Http\FileFactory', [ 
				'create' 
		], [ ], '', false );
		$this->resultRaw = $this->getMock ( 'Magento\Framework\Controller\Result\Raw', [ 
				'setContents' 
		], [ ], '', false );
		$this->resultRawFactory = $this->getMock ( '\Magento\Framework\Controller\Result\RawFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->resultRedirectFactory = $this->getMock ( 'Magento\Framework\Controller\Result\RedirectFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->downloadController = $this->objectManagerHelper->getObject ( 'Magento\ImportExport\Controller\Adminhtml\History\Download', [ 

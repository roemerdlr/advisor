...
class IndexTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->resultPage = $this->getMock ( 'Magento\Backend\Model\View\Result\Page', [ 
				'setActiveMenu',
				'getConfig',
				'getTitle',
				'prepend',
		...
		$this->indexController = $this->objectManagerHelper->getObject ( 'Magento\ImportExport\Controller\Adminhtml\History\Index', [ 

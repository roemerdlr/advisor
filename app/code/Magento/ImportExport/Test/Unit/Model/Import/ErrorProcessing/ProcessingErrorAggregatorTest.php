...
class ProcessingErrorAggregatorTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 *
	 * @var \Magento\ImportExport\Model\Import\ErrorProcessing\ProcessingErrorAggregator |\Magento\Framework\TestFramework\Unit\Helper\ObjectManager
	 */
	protected $model;
	...
	public function setUp() {
		$this->processingErrorFactoryMock = $this->getMock ( '\Magento\ImportExport\Model\Import\ErrorProcessing\ProcessingErrorFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->model = $objectManager->getObject ( '\Magento\ImportExport\Model\Import\ErrorProcessing\ProcessingErrorAggregator', [ 
	...
	public function isRowInvalidDataProvider() {
		return [ 
				...
				[ 
						ProcessingError::ERROR_LEVEL_NOTICE,
						9,
						false 
				],
				[ 
	...
	/**
	 * Test for method getInvalidRowsCount.
	...
	/**
	 * Test for method initValidationStrategy.
	 * Expected exeption due null incoming parameter
	 */
	...
	/**
	 * Test for method isErrorLimitExceeded.
	 * Expects error limit exceeded.
	 */
	...
	/**
	 * Test for method isErrorLimitExceeded.
	 * Unexpects error limit exceeded.
	 */
	...
	/**
	 * Test for method hasFatalExceptions.
	 * Expects no any fatal exceptions
	 */
	...
	/**
	 * Test for method hasToBeTerminated.
	 * Unexpects any errors and termination.
	 */
	...
	/**
	 * Test for method hasToBeTerminated.
	 * Expects errors and execute termination.
	 */
	...
	/**
	 * Test for method getErrorsByCode.
	 * Expects receive errors with code, which present in incomming parameter.
	 */
	public function testGetErrorsByCodeInArray() {
		...
		$result = $this->model->getErrorsByCode ( [ 
				'systemException' 
		] );
		$this->assertCount ( 2, $result );
	}
	...
	/**
	 * Test for method getErrorsByCode.
	 * Unexpects receive errors with code, which present in incomming parameter.
	 */
	...
	public function testGetErrorsCount() {
		...
		$this->model->addError ( 'columnNotFound', 'critical', 7, 'Some column name', 'No column', 'Description' );
		$this->model->addError ( 'systemException', 'not-critical', 9, 'Some column name', 'Message', 'Description' );
		$result = $this->model->getErrorsCount ( [ 
				'critical' 
		] );

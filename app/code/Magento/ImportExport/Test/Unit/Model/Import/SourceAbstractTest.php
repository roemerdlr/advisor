...
class SourceAbstractTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_model = $this->getMockForAbstractClass ( 'Magento\ImportExport\Model\Import\AbstractSource', [ 
				[ 
						'key1',
						'key2',
						'key3' 
	...
	public function testConstructException($argument) {
		$this->getMockForAbstractClass ( 'Magento\ImportExport\Model\Import\AbstractSource', [ 
				$argument 
		] );
	}

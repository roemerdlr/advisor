...
return [ 
		...
		'entity_with_invalid_model_value' => [ 
				...
				[ 
						"Element 'entity', attribute 'model': [facet 'pattern'] The value '12345' is not accepted by " . "the pattern '[A-Za-z_\\\\\\\\]+'.\nLine: 1\n",
		...
		'entity_with_invalid_behaviormodel_value' => [ 
				...
				[ 
						"Element 'entity', attribute 'behaviorModel': [facet 'pattern'] The value '=--09' is not " . "accepted by the pattern '[A-Za-z_\\\\\\\\]+'.\nLine: 1\n",
		...
		'entitytype_with_invalid_model_attribute_value' => [ 
				...
				[ 
						"Element 'entityType', attribute 'model': [facet 'pattern'] The value 'test1' is not " . "accepted by the pattern '[A-Za-z_\\\\\\\\]+'.\nLine: 1\n",
						"Element 'entityType', attribute 'model': 'test1' is not a valid value of the atomic type" . " 'modelName'.\nLine: 1\n" 
				] 
		],
		'entitytype_with_notallowed' => [ 
				'<?xml version="1.0"?><config><entityType entity="entity_name" name="some_name" ' . 'model="test" notallowed="test"/></config>',
				[ 

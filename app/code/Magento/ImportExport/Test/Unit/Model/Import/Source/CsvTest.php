...
class CsvTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_directoryMock = $this->getMock ( 'Magento\Framework\Filesystem\Directory\Write', [ ], [ ], '', false );
	}
	...
	public function testConstructException() {
		$this->_directoryMock->expects ( $this->any () )->method ( 'openFile' )->willThrowException ( new \Magento\Framework\Exception\FileSystemException ( __ ( 'Error message' ) ) );
	...
	public function testOptionalArgs($delimiter, $enclosure, $expectedColumns) {
		...
		$model = new \Magento\ImportExport\Model\Import\Source\Csv ( __DIR__ . '/_files/test.csv', $this->_directoryMock, $delimiter, $enclosure );

...
class EntityAbstractTest extends \Magento\ImportExport\Test\Unit\Model\Import\AbstractImportTestCase {
	...
	protected function setUp() {
		...
		$this->_model = $this->getMockBuilder ( 'Magento\ImportExport\Model\Import\AbstractEntity' )->setConstructorArgs ( $this->_getModelDependencies () )->setMethods ( [ 
	...
	public function attributeList() {
		...
		return [ 
				...
				[ 
						$this->_getDataSet ( 'test2', 'varchar', 'test string', substr ( $longString, 0, AbstractEntity::DB_MAX_VARCHAR_LENGTH ) ) 
				],
				[ 

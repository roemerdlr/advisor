...
class HistoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->historyResourceModel = $this->getMock ( 'Magento\ImportExport\Model\ResourceModel\History', [ 
				'getConnection',
				'getMainTable',
				'getIdFieldName' 
		], [ ], '', false );
		$dbAdapterMock = $this->getMock ( 'Magento\Framework\DB\Adapter\Pdo\Mysql', [ 
				'select',
				'fetchOne' 
		], [ ], '', false );

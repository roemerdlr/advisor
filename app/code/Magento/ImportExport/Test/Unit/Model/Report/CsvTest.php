...
class CsvTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->outputCsvFactoryMock = $this->getMock ( '\Magento\ImportExport\Model\Export\Adapter\CsvFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->sourceCsvFactoryMock = $this->getMock ( '\Magento\ImportExport\Model\Import\Source\CsvFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->csvModel = $objectManager->getObject ( '\Magento\ImportExport\Model\Report\Csv', [ 
	...
	public function testCreateReport() {
		...
		$errorProcessingMock = $this->getMock ( 'Magento\ImportExport\Model\Import\ErrorProcessing', [ 
				'getErrorMessage' 
		], [ ], '', false );
		$errorProcessingMock->expects ( $this->any () )->method ( 'getErrorMessage' )->willReturn ( 'some_error_message' );
		$errorAggregatorMock->expects ( $this->any () )->method ( 'getErrorByRowNumber' )->willReturn ( [ 
				$errorProcessingMock 
		] );

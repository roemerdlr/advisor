...
class EntityAbstractTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetFileNameAndSetFileName() {
		...
		$model = $this->getMockForAbstractClass ( 'Magento\ImportExport\Model\Export\AbstractEntity', [ ], 'Stub_UnitTest_Magento_ImportExport_Model_Export_Entity_TestSetAndGet', false );

...
class FormTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->_entityFactory = $this->getMockBuilder ( '\Magento\ImportExport\Model\Source\Import\EntityFactory' )->disableOriginalConstructor ()->getMock ();
		...
		$this->form = $this->getMockBuilder ( '\Magento\ImportExport\Block\Adminhtml\Import\Edit\Form' )->setConstructorArgs ( [ 
				$context,
				$registry,
				$formFactory,
				$this->_importModel,

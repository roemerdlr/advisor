...
class DownloadTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$urlModel = $this->getMock ( 'Magento\Backend\Model\Url', [ 
				'getUrl' 
		], [ ], '', false );
		$urlModel->expects ( $this->any () )->method ( 'getUrl' )->willReturn ( 'url' );
		$this->context = $this->getMock ( 'Magento\Backend\Block\Context', [ 
				'getUrlBuilder' 
		], [ ], '', false );
		...
		$this->download = $this->objectManagerHelper->getObject ( 'Magento\ImportExport\Block\Adminhtml\Grid\Column\Renderer\Download', [ 

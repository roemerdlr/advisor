...
class FilterTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->context = $this->getMock ( 'Magento\Backend\Block\Template\Context', [ 
				'getFileSystem',
				'getEscaper',
				'getLocaleDate',
				'getLayout' 
		...
		$dateBlock = $this->getMock ( 'Magento\Framework\View\Element\Html\Date', [ 
				'setValue',
				'getHtml',
				'setId',
				'getId' 
		...
		$this->filter = $this->objectManagerHelper->getObject ( 'Magento\ImportExport\Block\Adminhtml\Export\Filter', [ 

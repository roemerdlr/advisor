...
abstract class AbstractEntity {
	...
	protected function addErrors($code, $errors) {
		if ($errors) {
			$this->getErrorAggregator ()->addError ( $code, ProcessingError::ERROR_LEVEL_CRITICAL, null, implode ( '", "', $errors ) );
		}
	}
	 ...
	 *
	 * @return $this|void @SuppressWarnings(PHPMD.CyclomaticComplexity)
	 */
	 ...
	 * @return $this
	 */
	public function addRowError($errorCode, $errorRowNum, $colName = null, $errorMessage = null, $errorLevel = ProcessingError::ERROR_LEVEL_CRITICAL, $errorDescription = null) {
		$errorCode = ( string ) $errorCode;
		$this->getErrorAggregator ()->addError ( $errorCode, $errorLevel, $errorRowNum, $colName, $errorMessage, $errorDescription );
	 ...
	 *        	OPTIONAL Additional attributes' codes with index values.
	 * @return array
	 */
	 ...
	 * I.e. for setting some default parameters etc.
	 *
	 * @param array $params        	
	 * @return $this
	 */
	...
	/**
	 * Get data from outside to change behavior.
	 * I.e. for setting some default parameters etc.
	 *
	 * @return array $params
	 */

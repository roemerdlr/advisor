...
abstract class AbstractEav extends \Magento\ImportExport\Model\Import\AbstractEntity {
	 ...
	 *        	OPTIONAL Additional attribute codes with index values.
	 * @return array
	 */
	public function getAttributeOptions(\Magento\Eav\Model\Entity\Attribute\AbstractAttribute $attribute, array $indexAttributes = []) {
		$options = [ ];

...
class PluginTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->typeInstanceMock = $this->getMock ( 'Magento\ConfigurableProduct\Model\Product\Type\Configurable', [ 
	...
	public function testAroundGetOptionsWhenProductTypeIsConfigurable() {
		...
		$this->typeInstanceMock->expects ( $this->once () )->method ( 'getSelectedAttributesInfo' )->with ( $this->productMock )->will ( $this->returnValue ( [ 
				'attributes' 
		] ) );
		$this->assertEquals ( [ 
				'attributes',

...
class VariationMatrixTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $this->objectManagerHelper->getObject ( '\Magento\ConfigurableProduct\Model\Product\Type\VariationMatrix' );
	}

...
class AddAttributeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->controller = $this->objectManagerHelper->getObject ( '\Magento\ConfigurableProduct\Controller\Adminhtml\Product\AddAttribute', [ 
	...
	public function testExecute() {
		...
		$block = $this->getMockBuilder ( 'Magento\ConfigurableProduct\Block\Adminhtml\Product\Attribute\NewAttribute\Product\Created' )->disableOriginalConstructor ()->setMethods ( [ 
				'setIndex',
				'toHtml' 
		] )->getMock ();

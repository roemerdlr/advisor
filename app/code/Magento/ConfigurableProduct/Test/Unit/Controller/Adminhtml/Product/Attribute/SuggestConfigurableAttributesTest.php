...
class SuggestConfigurableAttributesTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->attributeListMock = $this->getMock ( 'Magento\ConfigurableProduct\Model\SuggestedAttributeList', [ ], [ ], '', false );
		$this->suggestAttributes = $helper->getObject ( 'Magento\ConfigurableProduct\Controller\Adminhtml\Product\Attribute\SuggestConfigurableAttributes', [ 

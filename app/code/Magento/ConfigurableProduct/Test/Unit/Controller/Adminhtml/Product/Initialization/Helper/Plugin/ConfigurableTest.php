...
class ConfigurableTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->productTypeMock = $this->getMock ( 'Magento\ConfigurableProduct\Model\Product\Type\Configurable', [ ], [ ], '', false );
		$this->variationHandler = $this->getMock ( 'Magento\ConfigurableProduct\Model\Product\VariationHandler', [ ], [ ], '', false );
	...
	public function testAfterInitializeIfAttributesNotEmptyAndActionNameNotGenerateVariations() {
		...
		$this->productTypeMock->expects ( $this->once () )->method ( 'setUsedProductAttributeIds' )->with ( $attributes, $this->productMock );

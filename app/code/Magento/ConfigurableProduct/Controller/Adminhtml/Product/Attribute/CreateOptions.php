...
class CreateOptions extends Action {
	 ...
	 */
	public function __construct(Action\Context $context, \Magento\Framework\Json\Helper\Data $jsonHelper, AttributeFactory $attributeFactory) {
	 ...
	 *
	 * @return array @TODO Move this logic to configurable product type model

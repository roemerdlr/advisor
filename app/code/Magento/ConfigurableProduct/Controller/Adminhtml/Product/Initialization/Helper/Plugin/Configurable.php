...
class Configurable {
	 ...
	 */
	public function __construct(\Magento\ConfigurableProduct\Model\Product\VariationHandler $variationHandler, \Magento\ConfigurableProduct\Model\Product\Type\Configurable $productType, \Magento\Framework\App\RequestInterface $request) {
	 ...
	 *
	 * @return \Magento\Catalog\Model\Product @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

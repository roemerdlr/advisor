...
class Filters implements ObserverInterface {
	 ...
	 */
	public function __construct(FilterFactory $filterFactory, CollectionFactory $attributeCollectionFactory) {
	...
	protected function getAttributes($attributeIds) {
		...
		return $attributeCollection->addFieldToFilter ( 'attribute_code', [ 
				'in' => $attributeIds 
		] );
	}
}

...
class ProductVariationsBuilder {
	 ...
	 */
	public function __construct(\Magento\Catalog\Model\ProductFactory $productFactory, \Magento\Framework\Api\AttributeValueFactory $customAttributeFactory, \Magento\ConfigurableProduct\Model\Product\Type\VariationMatrix $variationMatrix) {
	...
	public function create(\Magento\Catalog\Api\Data\ProductInterface $product, $attributes) {
		...
		foreach ( $variations as $variation ) {
			...
			foreach ( $variation as $attributeId => $valueInfo ) {
				...
				$customAttributes = array_merge ( $item->getCustomAttributes (), [ 

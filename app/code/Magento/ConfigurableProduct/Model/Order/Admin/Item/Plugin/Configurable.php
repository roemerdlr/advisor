...
class Configurable {
	 ...
	 */
	public function aroundGetSku(\Magento\Sales\Model\Order\Admin\Item $subject, \Closure $proceed, \Magento\Sales\Model\Order\Item $item) {
	 ...
	 * @return string @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	public function aroundGetName(\Magento\Sales\Model\Order\Admin\Item $subject, \Closure $proceed, \Magento\Sales\Model\Order\Item $item) {
		if ($item->getProductType () == \Magento\ConfigurableProduct\Model\Product\Type\Configurable::TYPE_CODE) {
			$productOptions = $item->getProductOptions ();

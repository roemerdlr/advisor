...
class CronTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->reportCountsMock = $this->getMockBuilder ( 'Magento\NewRelicReporting\Model\Cron\ReportCounts' )->disableOriginalConstructor ()->getMock ();
		
		$this->reportNewRelicCronMock = $this->getMockBuilder ( 'Magento\NewRelicReporting\Model\Cron\ReportNewRelicCron' )->disableOriginalConstructor ()->getMock ();
		
		$this->model = new Cron ( $this->configMock, $this->reportModulesInfoMock, $this->reportCountsMock, $this->reportNewRelicCronMock );
	}
	...
	public function testRunCronCronDisabledFromConfig() {
		$this->configMock->expects ( $this->once () )->method ( 'isCronEnabled' )->willReturn ( false );

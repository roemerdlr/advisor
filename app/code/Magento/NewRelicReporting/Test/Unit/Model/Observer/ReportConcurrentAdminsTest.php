...
class ReportConcurrentAdminsTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->backendAuthSession = $this->getMockBuilder ( 'Magento\Backend\Model\Auth\Session' )->disableOriginalConstructor ()->setMethods ( [ 
				'isLoggedIn',
				'getUser' 
		] )->getMock ();
		...
		$this->model = new ReportConcurrentAdmins ( $this->config, $this->backendAuthSession, $this->usersFactory, $this->jsonEncoder );
	}
	...
	public function testReportConcurrentAdminsUserIsNotLoggedIn() {
		...
		$this->backendAuthSession->expects ( $this->once () )->method ( 'isLoggedIn' )->willReturn ( false );

...
class Deployments {
	 ...
	 */
	public function __construct(\Magento\NewRelicReporting\Model\Config $config, \Psr\Log\LoggerInterface $logger, \Magento\Framework\HTTP\ZendClientFactory $clientFactory) {
		$this->config = $config;
		$this->logger = $logger;

...
class ReportConcurrentUsersToNewRelic implements ObserverInterface {
	 ...
	 */
	public function __construct(Config $config, \Magento\Customer\Model\Session $customerSession, \Magento\Customer\Api\CustomerRepositoryInterface $customerRepository, \Magento\Store\Model\StoreManagerInterface $storeManager, NewRelicWrapper $newRelicWrapper) {
		$this->config = $config;

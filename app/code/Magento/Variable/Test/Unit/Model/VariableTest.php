...
class VariableTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->resourceMock = $this->getMockBuilder ( 'Magento\Variable\Model\ResourceModel\Variable' )->disableOriginalConstructor ()->getMock ();
		$this->model = $this->objectManager->getObject ( 'Magento\Variable\Model\Variable', [ 
	...
	public function testGetValueEmptyHtml() {
		...
		$this->escaperMock->expects ( $this->once () )->method ( 'escapeHtml' )->with ( $plain )->willReturn ( $escapedPlain );
	...
	public function testGetVariablesOptionArrayNoGroup() {
		...
		$mockVariable = $this->getMock ( 'Magento\Variable\Model\Variable', [ 
				'getCollection' 

...
class CurrentUrlRewritesRegeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->currentUrlRewritesRegenerator = (new ObjectManager ( $this ))->getObject ( 'Magento\CatalogUrlRewrite\Model\Product\CurrentUrlRewritesRegenerator', [ 
	...
	public function testIsAutogeneratedWithoutSaveRewriteHistory() {
		...
		$this->product->expects ( $this->once () )->method ( 'getData' )->with ( 'save_rewrites_history' )->will ( $this->returnValue ( false ) );
	...
	public function testSkipGenerationForAutogenerated() {
		...
		$this->productUrlPathGenerator->expects ( $this->once () )->method ( 'getUrlPathWithSuffix' )->will ( $this->returnValue ( 'same-path' ) );
	...
	public function testIsAutogeneratedWithoutCategory() {
		...
		$this->prepareUrlRewriteMock ( $storeId, $productId, $requestPath, $targetPath, OptionProvider::PERMANENT, [ ], $description );

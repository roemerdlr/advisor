...
class Move {
	 ...
	 */
	public function __construct(CategoryUrlPathGenerator $categoryUrlPathGenerator, ChildrenCategoriesProvider $childrenCategoriesProvider) {
	 ...
	 * @return callable @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	public function aroundChangeParent(\Magento\Catalog\Model\ResourceModel\Category $subject, \Closure $proceed, $category, $newParent, $afterCategoryId) {

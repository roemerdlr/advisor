...
class Group {
	 ...
	 */
	public function __construct(UrlPersistInterface $urlPersist, CategoryFactory $categoryFactory, ProductFactory $productFactory, CategoryUrlRewriteGenerator $categoryUrlRewriteGenerator, ProductUrlRewriteGenerator $productUrlRewriteGenerator, StoreManagerInterface $storeManager) {
	 ...
	 * @return \Magento\Store\Model\ResourceModel\Group @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

...
class View {
	 ...
	 */
	public function __construct(UrlPersistInterface $urlPersist, CategoryFactory $categoryFactory, ProductFactory $productFactory, CategoryUrlRewriteGenerator $categoryUrlRewriteGenerator, ProductUrlRewriteGenerator $productUrlRewriteGenerator) {
	 ...
	 * @return \Magento\Store\Model\ResourceModel\Store @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	...
	protected function generateProductUrls($websiteId, $originWebsiteId, $storeId) {
		...
		$collection = $this->productFactory->create ()->getCollection ()->addCategoryIds ()->addAttributeToSelect ( [ 
				'name',
				'url_path',
				'url_key' 
	 ...
	 * @param callable $proceed        	
	 * @param AbstractModel $store        	
	 * @return mixed @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

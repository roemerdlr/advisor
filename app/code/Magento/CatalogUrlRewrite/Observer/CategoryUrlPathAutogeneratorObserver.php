...
class CategoryUrlPathAutogeneratorObserver implements ObserverInterface {
	 ...
	 */
	public function __construct(CategoryUrlPathGenerator $categoryUrlPathGenerator, ChildrenCategoriesProvider $childrenCategoriesProvider, StoreViewService $storeViewService) {
	...
	public function execute(\Magento\Framework\Event\Observer $observer) {
		...
		if ($category->getUrlKey () !== false) {
			$category->setUrlKey ( $this->categoryUrlPathGenerator->getUrlKey ( $category ) )->setUrlPath ( $this->categoryUrlPathGenerator->getUrlPath ( $category ) );

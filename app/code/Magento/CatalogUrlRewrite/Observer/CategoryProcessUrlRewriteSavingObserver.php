...
class CategoryProcessUrlRewriteSavingObserver implements ObserverInterface {
	 ...
	 */
	public function __construct(CategoryUrlRewriteGenerator $categoryUrlRewriteGenerator, UrlPersistInterface $urlPersist, UrlRewriteHandler $urlRewriteHandler) {

...
class ExpressRedirect extends \Magento\Framework\App\Helper\AbstractHelper {
	 ...
	 *        	@codeCoverageIgnore
	 */
	public function __construct(\Magento\Framework\App\ActionFlag $actionFlag, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Customer\Model\Session $customerSession, \Magento\Framework\App\Helper\Context $context) {
	...
	public function redirectLogin(RedirectLoginInterface $expressRedirect, $customerBeforeAuthUrlDefault = null) {
		...
		$expressRedirect->getResponse ()->setRedirect ( $this->_objectManager->get ( 'Magento\Framework\Url\Helper\Data' )->addRequestParam ( $expressRedirect->getLoginUrl (), [ 
				'context' => 'checkout' 
		] ) );

...
class ItemPool implements ItemPoolInterface {
	...
	/**
	 * Item map.
	 * Key is item type, value is item object id in di
	 *
	 * @var array
	 */
	protected $itemMap;
	 ...
	 *        	@codeCoverageIgnore
	 */
	public function __construct(ObjectManagerInterface $objectManager, $defaultItemId, array $itemMap = []) {
	...
	protected function get($type) {
		...
		if (! $item instanceof ItemInterface) {
			throw new LocalizedException ( __ ( '%1 doesn\'t extend \Magento\Checkout\CustomerData\ItemInterface', $type ) );
		}
		return $item;
	}
}

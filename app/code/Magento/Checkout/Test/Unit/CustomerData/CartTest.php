...
class CartTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->catalogUrlMock = $this->getMock ( '\Magento\Catalog\Model\ResourceModel\Url', [ 
		...
		$this->itemPoolInterfaceMock = $this->getMock ( '\Magento\Checkout\CustomerData\ItemPoolInterface', [ ], [ ], '', false );
		
		$this->model = new \Magento\Checkout\CustomerData\Cart ( $this->checkoutSessionMock, $this->catalogUrlMock, $this->checkoutCartMock, $this->checkoutHelperMock, $this->itemPoolInterfaceMock, $this->layoutMock );
	}
	...
	public function testGetSectionData() {
		...
		$subtotalMock = $this->getMock ( '\Magento\Framework\DataObject', [ 
				'getValue' 
		], [ ], '', false );
		...
		$this->catalogUrlMock->expects ( $this->once () )->method ( 'getRewriteByProductStore' )->with ( [ 
				$productId => $storeId 

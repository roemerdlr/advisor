...
class UpdateItemQtyTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->updateItemQty = $this->objectManagerHelper->getObject ( 'Magento\Checkout\Controller\Sidebar\UpdateItemQty', [ 
	...
	public function testExecute() {
		...
		$this->sidebarMock->expects ( $this->once () )->method ( 'updateQuoteItem' )->with ( 1, 2 )->willReturnSelf ();
	...
	public function testExecuteWithLocalizedException() {
		...
		$this->sidebarMock->expects ( $this->once () )->method ( 'checkQuoteItem' )->with ( 1 )->willThrowException ( new LocalizedException ( __ ( 'Error!' ) ) );
		
		$this->sidebarMock->expects ( $this->once () )->method ( 'getResponseData' )->with ( 'Error!' )->willReturn ( [ 
				'success' => false,
				'error_message' => 'Error!' 
		] );

...
class CreateTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->checkoutSession = $this->getMock ( '\Magento\Checkout\Model\Session', [ 
				'getLastOrderId' 
		], [ ], '', false );
		$this->customerSession = $this->getMock ( '\Magento\Customer\Model\Session', [ ], [ ], '', false );
		$this->orderCustomerService = $this->getMock ( '\Magento\Sales\Api\OrderCustomerManagementInterface', [ ], [ ], '', false );
		$this->messageManager = $this->getMock ( '\Magento\Framework\Message\ManagerInterface' );
		
		$this->action = $objectManagerHelper->getObject ( 'Magento\Checkout\Controller\Account\Create', [ 

...
class GenericTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $objectManagerHelper->getObject ( 'Magento\Checkout\Block\Cart\Item\Renderer\Actions\Generic', [ ] );
	}
	...
	public function testIsProductVisibleInSiteVisibility() {
		...
		$productMock->expects ( $this->once () )->method ( 'isVisibleInSiteVisibility' )->willReturn ( true );

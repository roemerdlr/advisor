...
class ShippingTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = new \Magento\Checkout\Block\Cart\Shipping ( $this->context, $this->customerSession, $this->checkoutSession, $this->configProvider, [ 
	...
	public function testGetJsLayout() {
		...
		$layoutProcessed ['components'] ['thirdComponent'] = [ 
				'param' => 'value' 
		];
		
		$this->layoutProcessor->expects ( $this->once () )->method ( 'process' )->with ( $this->layout )->willReturn ( $layoutProcessed );
		$this->assertEquals ( \Zend_Json::encode ( $layoutProcessed ), $this->model->getJsLayout () );
	}

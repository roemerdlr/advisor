...
class LayoutProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->countryCollection = $this->getMock ( '\Magento\Directory\Model\ResourceModel\Country\Collection', [ ], [ ], '', false );
		$this->regionCollection = $this->getMock ( '\Magento\Directory\Model\ResourceModel\Region\Collection', [ ], [ ], '', false );
		
		$this->model = new \Magento\Checkout\Block\Cart\LayoutProcessor ( $this->merger, $this->countryCollection, $this->regionCollection );
	}
	public function testProcess() {
		...
		$layout = [ ];
		$layout ['components'] ['block-summary'] ['children'] ['block-shipping'] ['children'] ['address-fieldsets'] ['children'] = [ 
				'fieldOne' => [ 
						'param' => 'value' 
				],
				'fieldTwo' => [ 
		...
		$layoutMerged = $layout;
		$layoutMerged ['components'] ['block-summary'] ['children'] ['block-shipping'] ['children'] ['address-fieldsets'] ['children'] ['fieldThree'] = [ 
				'param' => 'value' 
		];

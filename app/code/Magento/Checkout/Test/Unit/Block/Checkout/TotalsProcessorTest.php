...
class TotalsProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testProcess() {
		...
		$expectedResult ['components'] ['checkout'] ['children'] ['sidebar'] ['children'] ['summary'] ['children'] ['totals'] ['children'] = [ 
				'sub-total' => [ 
						'sortOrder' => 10 
				],
				'grand-total' => [ 
		...
		$this->scopeConfigMock->expects ( $this->once () )->method ( 'getValue' )->with ( 'sales/totals_sort' )->willReturn ( $configData );

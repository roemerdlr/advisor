...
class DepersonalizePluginTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->checkoutSessionMock = $this->getMock ( 'Magento\Framework\Session\Generic', [ 
				'clearStorage',
				'setData',
				'getData' 
		], [ ], '', false );
		...
		$this->plugin = new \Magento\Checkout\Model\Layout\DepersonalizePlugin ( $this->depersonalizeCheckerMock, $this->checkoutSessionMock );
	}

...
class PaymentInformationManagementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->billingAddressManagementMock = $this->getMock ( '\Magento\Quote\Api\BillingAddressManagementInterface' );
		...
		$this->model = $objectManager->getObject ( 'Magento\Checkout\Model\PaymentInformationManagement', [ 
	...
	public function testSavePaymentInformationAndPlaceOrder() {
		...
		$this->assertEquals ( $orderId, $this->model->savePaymentInformationAndPlaceOrder ( $cartId, $paymentMock, $billingAddressMock ) );
	}

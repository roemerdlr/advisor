...
class OnepageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->customerFormFactoryMock = $this->getMock ( 'Magento\Customer\Model\FormFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->onepage = $this->objectManagerHelper->getObject ( 'Magento\Checkout\Model\Type\Onepage', [ 
	...
	public function getCheckoutMethodDataProvider() {
		return [
				...
				[ 
						false,
						Onepage::METHOD_GUEST,
						true,
						Onepage::METHOD_GUEST 
				],
				[ 
						false,
						Onepage::METHOD_REGISTER,
						false,
						Onepage::METHOD_REGISTER 
				] 
		];
	...
	public function testSaveCheckoutMethod() {
		...
		], $this->onepage->saveCheckoutMethod ( null ) );
		/** @var \Magento\Quote\Model\Quote|\PHPUnit_Framework_MockObject_MockObject $quoteMock */
		$quoteMock = $this->getMock ( 'Magento\Quote\Model\Quote', [ 
				'setCheckoutMethod',
				'__wakeup' 

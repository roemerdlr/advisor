...
class GuestPaymentInformationManagementTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->billingAddressManagementMock = $this->getMock ( '\Magento\Quote\Api\GuestBillingAddressManagementInterface' );
		$this->paymentMethodManagementMock = $this->getMock ( '\Magento\Quote\Api\GuestPaymentMethodManagementInterface' );

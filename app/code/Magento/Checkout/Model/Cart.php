...
class Cart extends DataObject implements CartInterface {
	 ...
	 *
	 * @return \Magento\Checkout\Model\ResourceModel\Cart @codeCoverageIgnore
	 */
	 ...
	 *
	 * @return Session @codeCoverageIgnore
	 */
	 ...
	 *
	 * @return \Magento\Customer\Model\Session @codeCoverageIgnore
	 */
	 ...
	 *        	if is null set product qty like in order
	 * @return $this
	 */
	...
	public function addProduct($productInfo, $requestInfo = null) {
		...
		$this->_eventManager->dispatch ( 'checkout_cart_product_add_after', [ 
				'quote_item' => $result,
				'product' => $product 
		] );
	...
	public function updateItems($data) {
		...
		if ($qtyRecalculatedFlag) {
			$this->messageManager->addNotice ( __ ( 'We adjusted product quantities to fit the required increments.' ) );
		}
		
		$this->_eventManager->dispatch ( 'checkout_cart_update_items_after', [ 
				'cart' => $this,
				'info' => $infoDataObject 
		] );
	...
	public function save() {
		$this->_eventManager->dispatch ( 'checkout_cart_save_before', [ 
				'cart' => $this 
		] );
		 ...
		 */
		$this->_eventManager->dispatch ( 'checkout_cart_save_after', [ 
				'cart' => $this 
		] );
	 ...
	 *
	 * @return int|float @codeCoverageIgnore
	 */
	 ...
	 * @throws \Magento\Framework\Exception\LocalizedException
	 *
	 * @see \Magento\Quote\Model\Quote::updateItem() @SuppressWarnings(PHPMD.CyclomaticComplexity)
	 */
	public function updateItem($itemId, $requestInfo = null, $updatingParams = null) {
		...
		$this->_eventManager->dispatch ( 'checkout_cart_product_update_after', [ 
				'quote_item' => $result,
				'product' => $product 
		] );
		$this->_checkoutSession->setLastAddedProductId ( $productId );

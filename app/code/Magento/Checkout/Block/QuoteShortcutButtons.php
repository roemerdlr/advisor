...
class QuoteShortcutButtons extends \Magento\Catalog\Block\ShortcutButtons {
	 ...
	 *        	@codeCoverageIgnore
	 */
	public function __construct(Template\Context $context, \Magento\Checkout\Model\Session $checkoutSession, array $data = []) {
	...
	protected function _beforeToHtml() {
		$this->_eventManager->dispatch ( 'shortcut_buttons_container', [ 
				'container' => $this,

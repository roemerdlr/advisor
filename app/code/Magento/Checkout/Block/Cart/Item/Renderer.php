...
class Renderer extends \Magento\Framework\View\Element\Template implements \Magento\Framework\DataObject\IdentityInterface {
	 ...
	 * Get quote item
	 *
	 * @return AbstractItem @codeCoverageIgnore
	 */
	 ...
	 *
	 * @return AbstractBlock @codeCoverageIgnore
	 */
	...
	public function getProductPriceHtml(\Magento\Catalog\Model\Product $product) {
		...
		$price = '';
		if ($priceRender) {
			$price = $priceRender->render ( ConfiguredPriceInterface::CONFIGURED_PRICE_CODE, $product, [ 
	...
	/**
	 *
	 * @return \Magento\Framework\Pricing\Render @codeCoverageIgnore
	 */

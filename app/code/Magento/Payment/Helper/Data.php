...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	public function getMethodInstance($code) {
		$class = $this->scopeConfig->getValue ( $this->getMethodModelConfigName ( $code ), \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
		...
		if ($asLabelValue) {
			...
			foreach ( $methods as $code => $title ) {
				if (isset ( $groups [$code] )) {
					...
					$labelValues [$groupRelations [$code]] ['value'] [$code] = [ 
							'value' => $code,
							'label' => $title 
					];
				} else {
	...
	public function isZeroSubTotal($store = null) {
		return $this->scopeConfig->getValue ( \Magento\Payment\Model\Method\Free::XML_PATH_PAYMENT_FREE_ACTIVE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	}
	...
	public function getZeroSubTotalOrderStatus($store = null) {
		return $this->scopeConfig->getValue ( \Magento\Payment\Model\Method\Free::XML_PATH_PAYMENT_FREE_ORDER_STATUS, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	}
	...
	public function getZeroSubTotalPaymentAutomaticInvoice($store = null) {
		return $this->scopeConfig->getValue ( \Magento\Payment\Model\Method\Free::XML_PATH_PAYMENT_FREE_PAYMENT_ACTION, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store );
	}
}

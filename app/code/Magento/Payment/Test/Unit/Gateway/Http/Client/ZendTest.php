...
class ZendTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->converterMock = $this->getMockBuilder ( 'Magento\Payment\Gateway\Http\ConverterInterface' )->getMockForAbstractClass ();
		...
		$this->transferObjectMock = $this->getMockBuilder ( 'Magento\Payment\Gateway\Http\TransferInterface' )->getMockForAbstractClass ();
		
		$this->model = new Zend ( $this->zendClientFactoryMock, $this->loggerMock, $this->converterMock );
	}
	...
	public function testPlaceRequestClientFail() {
		...
		$this->clientMock->expects ( $this->once () )->method ( 'request' )->willThrowException ( new \Zend_Http_Client_Exception () );

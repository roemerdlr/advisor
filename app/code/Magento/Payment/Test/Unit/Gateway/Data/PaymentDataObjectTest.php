...
class PaymentDataObjectTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->orderMock = $this->getMockBuilder ( 'Magento\Payment\Gateway\Data\OrderAdapterInterface' )->getMockForAbstractClass ();
		
		$this->paymentMock = $this->getMockBuilder ( 'Magento\Payment\Model\InfoInterface' )->getMockForAbstractClass ();

...
class CcConfigTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = new \Magento\Payment\Model\CcConfig ( $this->configMock, $this->repositoryMock, $this->requestMock, $this->urlMock, $this->loggerMock );
	}
	...
	public function getViewFileUrlWithException() {
		...
		$this->urlMock->expects ( $this->once () )->method ( 'getUrl' )->with ( '', [ 

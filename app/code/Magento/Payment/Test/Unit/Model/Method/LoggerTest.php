...
class LoggerTest extends \PHPUnit_Framework_TestCase {
	...
	public function testDebugOn() {
		...
		$this->loggerMock->expects ( $this->once () )->method ( 'debug' )->with ( var_export ( $expectedDebugData, true ) );
	...
	public function testDebugOnNoReplaceKeys() {
		...
		$this->loggerMock->expects ( static::once () )->method ( 'debug' )->with ( var_export ( $debugData, true ) );

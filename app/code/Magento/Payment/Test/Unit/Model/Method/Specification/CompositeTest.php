...
class CompositeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->factoryMock = $this->getMock ( 'Magento\Payment\Model\Method\Specification\Factory', [ ], [ ], '', false );
	}
	...
	protected function createComposite($specifications = []) {
		...
		return $objectManager->getObject ( 'Magento\Payment\Model\Method\Specification\Composite', [ 

...
class CanUseForCountryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->countryProvider = $this->getMock ( 'Magento\Payment\Model\Checks\CanUseForCountry\CountryProvider', [ ], [ ], '', false, false );
	...
	public function testIsApplicable($expectation) {
		...
		$paymentMethod->expects ( $this->once () )->method ( 'canUseForCountry' )->with ( self::EXPECTED_COUNTRY_ID )->will ( $this->returnValue ( $expectation ) );

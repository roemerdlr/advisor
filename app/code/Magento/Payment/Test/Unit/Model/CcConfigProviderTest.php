...
class CcConfigProviderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = new \Magento\Payment\Model\CcConfigProvider ( $this->ccConfigMock, $this->assetSourceMock );
	}
	public function testGetConfig() {
		...
		$this->ccConfigMock->expects ( $this->atLeastOnce () )->method ( 'createAsset' )->withConsecutive ( [ 

...
class ConfigurableInfo extends \Magento\Payment\Block\Info {
	...
	protected function _prepareSpecificInformation($transport = null) {
		...
		if ($this->getIsSecureMode ()) {
			$storedFields = array_diff ( $storedFields, explode ( ',', ( string ) $this->config->getValue ( 'privateInfoKeys' ) ) );
		}
	 ...
	 * @return void
	 */
	protected function setDataToTransfer(\Magento\Framework\DataObject $transport, $field, $value) {

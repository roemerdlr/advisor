...
class Form extends \Magento\Payment\Block\Form\Cc {
	 ...
	 * @param array $data        	
	 */
	public function __construct(Context $context, Config $paymentConfig, Session $checkoutSession, array $data = []) {
	...
	protected function initializeMethod() {
		$this->setData ( 'method', $this->checkoutSession->getQuote ()->getPayment ()->getMethodInstance () );
	}
	...
	public function getMethod() {
		...
		if (! $method instanceof TransparentInterface && ! $method instanceof Adapter) {
			throw new LocalizedException ( __ ( 'We cannot retrieve the transparent payment method model object.' ) );
		}
		return $method;
	}
}

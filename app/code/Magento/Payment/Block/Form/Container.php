...
class Container extends \Magento\Framework\View\Element\Template {
	 ...
	 * @param array $data        	
	 */
	public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Payment\Helper\Data $paymentHelper, \Magento\Payment\Model\Checks\SpecificationFactory $methodSpecificationFactory, array $data = []) {
	...
	public function getMethods() {
		...
		if ($methods === null) {
			...
			$methods = [ ];
			$specification = $this->methodSpecificationFactory->create ( [ 

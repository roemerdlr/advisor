...
class Adapter implements MethodInterface {
	 ...
	 */
	public function __construct(ManagerInterface $eventManager, ValueHandlerPoolInterface $valueHandlerPool, PaymentDataObjectFactory $paymentDataObjectFactory, $code, $formBlockType, $infoBlockType, CommandPoolInterface $commandPool = null, ValidatorPoolInterface $validatorPool = null) {
	...
	public function fetchTransactionInfo(InfoInterface $payment, $transactionId) {
		$this->executeCommand ( 'fetch_transaction_information', $payment, [ 
	...
	public function order(InfoInterface $payment, $amount) {
		$this->executeCommand ( 'order', $payment, [ 
				'amount' => $amount 
		] );
	...
	public function authorize(InfoInterface $payment, $amount) {
		$this->executeCommand ( 'authorize', $payment, [ 
				'amount' => $amount 
		] );
	...
	public function capture(InfoInterface $payment, $amount) {
		$this->executeCommand ( 'capture', $payment, [ 
				'amount' => $amount 
		] );
	...
	public function refund(InfoInterface $payment, $amount) {
		$this->executeCommand ( 'refund', $payment, [ 
				'amount' => $amount 
		] );
	...
	public function void(InfoInterface $payment) {
		$this->executeCommand ( 'void', $payment );
	...
	public function assignData(\Magento\Framework\DataObject $data) {
		$this->eventManager->dispatch ( 'payment_method_assign_data_' . $this->getCode (), [ 
				'method' => $this,
				'data' => $data 
		] );
	...
	public function initialize($paymentAction, $stateObject) {
		$this->executeCommand ( 'initialize', $this->getInfoInstance (), [ 

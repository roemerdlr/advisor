...
abstract class AbstractMethod extends \Magento\Framework\Model\AbstractExtensibleModel implements MethodInterface, PaymentMethodInterface {
	 ...
	 * @throws \Magento\Framework\Exception\LocalizedException @api
	 */
	...
	public function validate() {
		...
		if (! $this->canUseForCountry ( $billingCountry )) {
			throw new \Magento\Framework\Exception\LocalizedException ( __ ( 'You can\'t use the payment type you selected to make payments to the billing country.' ) );
		}
		return $this;
	}

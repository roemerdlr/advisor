...
class Items extends \Magento\Backend\Block\Template {
	 ...
	 * Get order item
	 *
	 * @return \Magento\Quote\Model\Quote\Item @codeCoverageIgnore
	 */
	...
	public function getFormHtml() {
		return $this->getLayout ()->createBlock ( 'Magento\Sales\Block\Adminhtml\Order\Create\Giftmessage\Form' )->setEntity ( $this->getItem () )->setEntityType ( 'item' )->toHtml ();
	}

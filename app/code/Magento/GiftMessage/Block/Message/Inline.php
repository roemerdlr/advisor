...
class Inline extends \Magento\Framework\View\Element\Template {
	...
	/**
	 * Checkout type.
	 * 'onepage_checkout' and 'multishipping_address' are standard types
	 *
	 * @var string
	 */
	 ...
	 * Typical values are 'onepage_checkout' and 'multishipping_address'
	 *
	...
	public function getItems() {
		if (! $this->getData ( 'items' )) {
			...
			$this->_eventManager->dispatch ( 'gift_options_prepare_items', [ 
					'items' => $entityItems 
			] );

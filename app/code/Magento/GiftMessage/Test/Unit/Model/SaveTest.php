...
class SaveTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->messageFactoryMock = $this->getMockBuilder ( '\Magento\GiftMessage\Model\MessageFactory' )->setMethods ( [ 
				'create' 
		...
		$this->model = new \Magento\GiftMessage\Model\Save ( $productRepositoryMock, $this->messageFactoryMock, $sessionMock, $giftMessageHelperMock );
	}

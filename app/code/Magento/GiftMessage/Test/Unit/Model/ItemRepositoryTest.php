...
class ItemRepositoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->quoteItemMock = $this->getMock ( '\Magento\Qote\Model\Quote\Item', [ 
				'getGiftMessageId',
				'__wakeup' 
		], [ ], '', false );
		...
		$this->giftMessageManagerMock = $this->getMock ( 'Magento\GiftMessage\Model\GiftMessageManager', [ ], [ ], '', false );
		$this->helperMock = $this->getMock ( 'Magento\GiftMessage\Helper\Message', [ ], [ ], '', false );
		$this->storeMock = $this->getMock ( 'Magento\Store\Model\Store', [ ], [ ], '', false );
		$this->itemRepository = new \Magento\GiftMessage\Model\ItemRepository ( $this->quoteRepositoryMock, $this->storeManagerMock, $this->giftMessageManagerMock, $this->helperMock, $this->messageFactoryMock );
		
		$this->quoteRepositoryMock->expects ( $this->once () )->method ( 'getActive' )->with ( $this->cartId )->will ( $this->returnValue ( $this->quoteMock ) );
	}
	...
	public function testSaveWithInvalidTransitionException() {
		...
		$quoteItem = $this->getMock ( '\Magento\Sales\Model\Quote\Item', [ 
				'getIsVirtual',
				'__wakeup' 
		], [ ], '', false );

...
class MultishippingTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->plugin = $objectManager->getObject ( 'Magento\GiftMessage\Model\Type\Plugin\Multishipping', [ 
	...
	public function testBeforeSetShippingMethods($methods) {
		$this->requestMock->expects ( $this->once () )->method ( 'getParam' )->with ( 'giftmessage' )->will ( $this->returnValue ( 'Expected Value' ) );

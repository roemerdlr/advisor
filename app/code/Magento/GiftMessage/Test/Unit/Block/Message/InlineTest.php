...
class InlineTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->messageHelper = $this->getMockBuilder ( 'Magento\GiftMessage\Helper\Message' )->disableOriginalConstructor ()->getMock ();
		...
		$this->block = new \Magento\GiftMessage\Block\Message\Inline ( $this->context, $this->session, $this->messageHelper, $this->imageBuilder, $this->httpContext );
	}

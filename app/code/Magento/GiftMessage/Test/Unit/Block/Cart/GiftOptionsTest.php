...
class GiftOptionsTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->compositeConfigProvider = $this->getMock ( 'Magento\GiftMessage\Model\CompositeConfigProvider', [ ], [ ], '', false );
		$this->layoutProcessorMock = $this->getMockForAbstractClass ( 'Magento\Checkout\Block\Checkout\LayoutProcessorInterface', [ ], '', false );
		$this->model = new GiftOptions ( $this->context, $this->jsonEncoderMock, $this->compositeConfigProvider, [ 

...
class OrderSave {
	 ...
	 */
	public function __construct(\Magento\GiftMessage\Api\OrderRepositoryInterface $giftMessageOrderRepository, \Magento\GiftMessage\Api\OrderItemRepositoryInterface $giftMessageOrderItemRepository) {
	 ...
	 * @return \Magento\Sales\Api\Data\OrderInterface @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	public function aroundSave(\Magento\Sales\Api\OrderRepositoryInterface $subject, \Closure $proceed, \Magento\Sales\Api\Data\OrderInterface $order) {
	...
	protected function saveOrderGiftMessage(\Magento\Sales\Api\Data\OrderInterface $order) {
		if (null !== $order->getExtensionAttributes () && null !== $order->getExtensionAttributes ()->getGiftMessage ()) {

...
class Dependence extends \Magento\Backend\Block\AbstractBlock {
	 ...
	 *        	- element name in their fieldset/form namespace
	...
	protected function _toHtml() {
        ...
        new FormElementDependenceController(' . $this->_getDependsJson () . ($this->_configOptions ? ', ' . $this->_jsonEncoder->encode ( $this->_configOptions ) : '') . '); });</script>';
	}

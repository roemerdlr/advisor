...
class Grids extends \Magento\Backend\Block\Widget\Tabs {
	...
	protected function _prepareLayout() {
		...
		$this->addTab ( 'ordered_products', [ 
				...
				'content' => $this->getLayout ()->createBlock ( 'Magento\Backend\Block\Dashboard\Tab\Products\Ordered' )->toHtml (),
				'active' => true 
		] );
		...
		$this->addTab ( 'reviewed_products', [ 
				...
				'url' => $this->getUrl ( 'adminhtml/*/productsViewed', [ 
						'_current' => true 
				] ),
				'class' => 'ajax' 
		] );
		...
		$this->addTab ( 'new_customers', [ 
				...
				'url' => $this->getUrl ( 'adminhtml/*/customersNewest', [ 
						'_current' => true 
				] ),
				'class' => 'ajax' 
		] );
		...
		$this->addTab ( 'customers', [ 
				'label' => __ ( 'Customers' ),
				'url' => $this->getUrl ( 'adminhtml/*/customersMost', [ 
						'_current' => true 
				] ),
				'class' => 'ajax' 
		] );

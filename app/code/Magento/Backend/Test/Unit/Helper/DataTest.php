...
class DataTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_frontResolverMock = $this->getMock ( '\Magento\Backend\App\Area\FrontNameResolver', [ ], [ ], '', false );
		$this->_helper = new \Magento\Backend\Helper\Data ( $this->getMock ( 'Magento\Framework\App\Helper\Context', [ ], [ ], '', false, false ), $this->getMock ( '\Magento\Framework\App\Route\Config', [ ], [ ], '', false ), $this->getMock ( 'Magento\Framework\Locale\ResolverInterface' ), $this->getMock ( '\Magento\Backend\Model\Url', [ ], [ ], '', false ), $this->getMock ( '\Magento\Backend\Model\Auth', [ ], [ ], '', false ), $this->_frontResolverMock, $this->getMock ( '\Magento\Framework\Math\Random', [ ], [ ], '', false ), $this->getMock ( '\Magento\Framework\App\RequestInterface' ) );
	}

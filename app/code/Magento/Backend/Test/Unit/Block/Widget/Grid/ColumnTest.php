...
class ColumnTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_blockMock = $this->getMock ( 'Magento\Framework\View\Element\Template', [ 
				'setColumn',
				'getHtml' 
		], [ ], '', false, false );
	...
	public function testGetFilterWhenFilterIsNotSet() {
		$this->_layoutMock->expects ( $this->once () )->method ( 'createBlock' )->with ( 'Magento\Backend\Block\Widget\Grid\Column\Filter\Text' )->will ( $this->returnValue ( $this->_blockMock ) );
	...
	public function testGetRendererWheRendererSetFalse() {
		...
		$this->_layoutMock->expects ( $this->once () )->method ( 'createBlock' )->with ( 'Magento\Backend\Block\Widget\Grid\Column\Renderer\Text' )->will ( $this->returnValue ( $this->_blockMock ) );

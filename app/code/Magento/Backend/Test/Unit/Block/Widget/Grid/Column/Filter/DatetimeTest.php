...
class DatetimeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->mathRandomMock = $this->getMockBuilder ( 'Magento\Framework\Math\Random' )->disableOriginalConstructor ()->setMethods ( [ 
				'getUniqueHash' 
		] )->getMock ();
		...
		$this->dateTimeFormatterMock = $this->getMockBuilder ( 'Magento\Framework\Stdlib\DateTime\DateTimeFormatterInterface' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		
		$this->columnMock = $this->getMockBuilder ( 'Magento\Backend\Block\Widget\Grid\Column' )->disableOriginalConstructor ()->setMethods ( [ 
				'getTimezone',
				'getHtmlId',
				'getId' 
		] )->getMock ();
		
		$this->localeDateMock = $this->getMockBuilder ( '\Magento\Framework\Stdlib\DateTime\TimezoneInterface' )->disableOriginalConstructor ()->setMethods ( [ ] )->getMock ();
		
		$objectManagerHelper = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		$this->model = $objectManagerHelper->getObject ( 'Magento\Backend\Block\Widget\Grid\Column\Filter\Datetime', [ 

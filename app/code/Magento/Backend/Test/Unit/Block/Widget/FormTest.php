...
class FormTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->dataForm = $this->getMockBuilder ( 'Magento\Framework\Data\Form' )->disableOriginalConstructor ()->setMethods ( [ 
				'setParent',
				'setBaseUrl',
				'addCustomAttribute' 
		] )->getMock ();
		
		$this->model = new Form ( $this->context );
	}
	...
	public function testSetForm() {
		...
		$this->model->setData ( 'custom_attributes', [ 

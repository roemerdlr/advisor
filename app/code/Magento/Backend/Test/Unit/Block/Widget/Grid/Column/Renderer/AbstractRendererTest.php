...
class AbstractRendererTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->dataObjectMock = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'getData' 
		], [ ], '', false );
		...
		$this->renderer = $this->getMockBuilder ( 'Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer' )->disableOriginalConstructor ()->setMethods ( null )->getMock ();
	}
	 ...
	 * @return void @dataProvider renderDataProvider
	 */
	...
	public function renderDataProvider() {
		return [ 
				...
				[ 
						'editable' => true,
						'onlyEdit' => false,
						'expectedResult' => '<div class="admin__grid-control">' . '<span class="admin__grid-control-value">some value</span>' . '<input type="text" class="input-text " name="test" value="some value"/>' . '</div>' 
				],
				[ 
						'editable' => true,
						'onlyEdit' => true,
						'expectedResult' => '<div class="admin__grid-control">' . '<input type="text" class="input-text " name="test" value="some value"/>' . '</div>' 
				] 
		];
	}
}

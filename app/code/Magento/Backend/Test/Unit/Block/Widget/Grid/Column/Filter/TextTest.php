...
class TextTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->block = $this->objectManagerHelper->getObject ( 'Magento\Backend\Block\Widget\Grid\Column\Filter\Text', [ 
	...
	public function testGetHtml() {
		...
		$column = $this->getMockBuilder ( 'Magento\Backend\Block\Widget\Grid\Column' )->setMethods ( [ 
				'getId',
				'getHtmlId' 
		] )->disableOriginalConstructor ()->getMock ();

...
class RefreshStatisticsTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->refreshStatisticsController = $objectManagerHelper->getObject ( 'Magento\Backend\Controller\Adminhtml\Dashboard\RefreshStatistics', [ 
	...
	public function testExecute() {
		...
		$this->objectManager->expects ( $this->any () )->method ( 'create' )->with ( 'Magento\Sales\Model\ResourceModel\Report\Order' )->willReturn ( $this->order );

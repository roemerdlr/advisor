...
class CleanStaticFilesTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$context = $objectHelper->getObject ( '\Magento\Backend\App\Action\Context', [ 
		...
		$this->controller = $objectHelper->getObject ( 'Magento\Backend\Controller\Adminhtml\Cache\CleanStaticFiles', [ 
				'context' => $context 
		] );
	}

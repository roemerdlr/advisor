...
class AbstractTestCase extends \PHPUnit_Framework_TestCase {
	...
	protected function assertExecute($controllerName, $blockName) {
		...
		$outPut = "data";
		$resultRawMock = $this->getMock ( 'Magento\Framework\Controller\Result\Raw', [ 
				'setContents' 
		], [ ], '', false );
		$resultRawFactoryMock = $this->getMock ( 'Magento\Framework\Controller\Result\RawFactory', [ 
				'create' 
		], [ ], '', false );
		$layoutFactoryMock = $this->getMock ( 'Magento\Framework\View\LayoutFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$controller = $objectManager->getObject ( $controllerName, [ 

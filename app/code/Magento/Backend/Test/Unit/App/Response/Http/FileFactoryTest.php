...
class FileFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_responseMock = $this->getMock ( 'Magento\Framework\App\Response\Http', [ 
				'setRedirect',
				'__wakeup' 
		], [ ], '', false );
		$this->_responseMock->expects ( $this->any () )->method ( 'setRedirect' )->will ( $this->returnValue ( $this->_responseMock ) );
		...
		$this->_model = $helper->getObject ( 'Magento\Backend\App\Response\Http\FileFactory', [ 
	...
	public function testCreate() {
		$authStorageMock = $this->getMock ( 'Magento\Backend\Model\Auth\Session', [ 

...
class AbstractTotalsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = $this->getMockForAbstractClass ( 'Magento\Backend\Model\Widget\Grid\AbstractTotals', $arguments, '', true, false, true, [ ] );
	...
	protected function _prepareParserMock() {
		$this->_parserMock = $this->getMock ( 'Magento\Backend\Model\Widget\Grid\Parser', [ 
				'parseExpression',
				'isOperation' 
		] );
		...
		$this->_parserMock->expects ( $this->any () )->method ( 'parseExpression' )->will ( $this->returnValueMap ( $columnsValueMap ) );
		...
		$this->_parserMock->expects ( $this->any () )->method ( 'isOperation' )->will ( $this->returnValueMap ( $isOperationValueMap ) );
	}
	...
	protected function _prepareFactoryMock() {
		$this->_factoryMock = $this->getMock ( 'Magento\Framework\DataObject\Factory', [ 
				'create' 
		], [ ], '', false, false, false );

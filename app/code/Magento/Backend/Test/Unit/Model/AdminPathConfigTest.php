...
class AdminPathConfigTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->coreConfig = $this->getMockForAbstractClass ( 'Magento\Framework\App\Config\ScopeConfigInterface', [ ], '', false );
		$this->backendConfig = $this->getMockForAbstractClass ( 'Magento\Backend\App\ConfigInterface', [ ], '', false );
		$this->url = $this->getMockForAbstractClass ( 'Magento\Framework\UrlInterface', [ ], '', false, true, true, [ 
				'getBaseUrl' 
		] );
	...
	public function testGetCurrentSecureUrl() {
		$request = $this->getMockForAbstractClass ( 'Magento\Framework\App\RequestInterface', [ ], '', false, true, true, [ 
				'getPathInfo' 
		] );

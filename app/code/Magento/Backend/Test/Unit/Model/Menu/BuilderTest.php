...
class BuilderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetResultBuildsTreeStructure() {
		...
		$this->_menuMock->expects ( $this->at ( 0 ) )->method ( 'add' )->with ( $this->isInstanceOf ( 'Magento\Backend\Model\Menu\Item' ), $this->equalTo ( null ), $this->equalTo ( 2 ) );
		
		$this->_menuMock->expects ( $this->at ( 1 ) )->method ( 'add' )->with ( $this->isInstanceOf ( 'Magento\Backend\Model\Menu\Item' ), $this->equalTo ( null ), $this->equalTo ( 4 ) );
		
		$this->_model->processCommand ( new \Magento\Backend\Model\Menu\Builder\Command\Add ( [ 
				'id' => 'item1',
				'title' => 'Item 1',
	...
	public function testGetResultSkipsRemovedItems() {
		...
		$this->_model->processCommand ( new \Magento\Backend\Model\Menu\Builder\Command\Remove ( [ 
				'id' => 1 
		] ) );

...
class AbstractCommandTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_model = $this->getMockForAbstractClass ( 'Magento\Backend\Model\Menu\Builder\AbstractCommand', [ 
				[ 
						'id' => 'item' 
				] 
		] );
	...
	public function testChainAddsNewCommandAsNextInChain() {
		$command1 = $this->getMock ( 'Magento\Backend\Model\Menu\Builder\Command\Update', [ ], [ 
				[ 
						'id' => 1 
				] 
		] );
		$command2 = $this->getMock ( 'Magento\Backend\Model\Menu\Builder\Command\Remove', [ ], [ 
				[ 
						'id' => 1 
				] 
		] );

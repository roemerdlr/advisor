...
class AclTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->authorizationMock = $this->getMockBuilder ( 'Magento\Framework\AuthorizationInterface' )->getMock ();
	...
	public function testFilterAclElements() {
		...
		$this->authorizationMock->expects ( $this->exactly ( 3 ) )->method ( 'isAllowed' )->willReturnMap ( [ 
				[ 
						'acl_authorised',
						null,
						true 
		...
		$structureMock->expects ( $this->exactly ( 3 ) )->method ( 'getChildren' )->willReturnMap ( [ 
				[ 
						'element_2',
						[ 
								'element_2_child' => [ ] 
		...
		$scheduledStructureMock->expects ( $this->exactly ( 3 ) )->method ( 'unsetElement' )->willReturnMap ( [ 
				[ 
						'element_2',
						null 
				],
		...
		$structureMock->expects ( $this->exactly ( 2 ) )->method ( 'unsetElement' )->willReturnMap ( [ 
				[ 
						'element_2',
						true,
						true 

...
class PageTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->resultPage = $this->objectManagerHelper->getObject ( 'Magento\Backend\Model\View\Result\Page', [ 
	...
	public function testAddBreadcrumb() {
		...
		$this->layoutMock->expects ( $this->once () )->method ( 'getBlock' )->with ( 'breadcrumbs' )->willReturn ( $this->breadcrumbsBlockMock );
		$this->breadcrumbsBlockMock->expects ( $this->once () )->method ( 'addLink' )->with ( $label, $title, $link )->willReturnSelf ();

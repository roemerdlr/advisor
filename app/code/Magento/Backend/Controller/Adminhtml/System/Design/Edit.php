...
class Edit extends \Magento\Backend\Controller\Adminhtml\System\Design {
	...
	public function execute() {
		...
		$resultPage->getConfig ()->getTitle ()->prepend ( $design->getId () ? __ ( 'Edit Store Design Change' ) : __ ( 'New Store Design Change' ) );
		...
		$resultPage->addLeft ( $resultPage->getLayout ()->createBlock ( 'Magento\Backend\Block\System\Design\Edit\Tabs', 'design_tabs' ) );

...
class FrontNameResolver implements \Magento\Framework\App\Area\FrontNameResolverInterface {
	 ...
	 */
	public function __construct(\Magento\Backend\App\Config $config, DeploymentConfig $deploymentConfig, ScopeConfigInterface $scopeConfig) {
		$this->config = $config;
	 ...
	 *        	If true, verify front name is valid for this url (hostname is correct)
	 * @return string|bool
	 */

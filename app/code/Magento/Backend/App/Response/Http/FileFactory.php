...
class FileFactory extends \Magento\Framework\App\Response\Http\FileFactory {
	 ...
	 */
	public function __construct(\Magento\Framework\App\ResponseInterface $response, \Magento\Framework\Filesystem $filesystem, \Magento\Backend\Model\Auth $auth, \Magento\Backend\Model\UrlInterface $backendUrl, \Magento\Backend\Model\Session $session, \Magento\Framework\App\ActionFlag $flag, \Magento\Backend\Helper\Data $helper) {
		$this->_auth = $auth;
	 ...
	 *        	set to null to avoid starting output, $contentLength should be set explicitly in
	 *        	that case

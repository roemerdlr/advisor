...
/**
 * Menu item.
 * Should be used to create nested menu structures with \Magento\Backend\Model\Menu
 *
...
class Item {
	...
	public function getUrl() {
		if (( bool ) $this->_action) {
			return $this->_urlModel->getUrl ( ( string ) $this->_action, [ 
	 ...
	 * Disabled items are not shown to user
	 *
	 * @return bool
	 */
	public function isDisabled() {
		return ! $this->_moduleManager->isOutputEnabled ( $this->_moduleName ) || ! $this->_isModuleDependenciesAvailable () || ! $this->_isConfigDependenciesAvailable ();
	}

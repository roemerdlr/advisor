...
class Auth {
	 ...
	 *
	 * @return \Magento\Backend\Model\Auth\StorageInterface @codeCoverageIgnore
	 */
	...
	protected function _initCredentialStorage() {
		$this->_credentialStorage = $this->_modelFactory->create ( 'Magento\Backend\Model\Auth\Credential\StorageInterface' );
	}
	
	/**
	 * Return credential storage object
	 *
	 * @return null|\Magento\Backend\Model\Auth\Credential\StorageInterface @codeCoverageIgnore
	 */
	...
	public function login($username, $password) {
		...
		try {
			...
			self::throwException ( __ ( $e->getMessage () ?  : 'You did not sign in correctly or your account is temporarily disabled.' ) );
		}
	}

...
class Order extends \Magento\Framework\DataObject {
	 ...
	 */
	public function __construct(\Magento\Sales\Model\ResourceModel\Order\CollectionFactory $collectionFactory, \Magento\Backend\Helper\Data $adminhtmlData) {
	...
	public function load() {
		...
		] )->setCurPage ( $this->getStart () )->setPageSize ( $this->getLimit () )->load ();
		...
		foreach ( $collection as $order ) {
			$result [] = [ 
					...
					'url' => $this->_adminhtmlData->getUrl ( 'sales/order/view', [ 

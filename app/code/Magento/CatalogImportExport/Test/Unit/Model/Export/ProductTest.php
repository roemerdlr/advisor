...
class ProductTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->abstractCollection = $this->getMockForAbstractClass ( '\Magento\Eav\Model\Entity\Collection\AbstractCollection', [ ], '', false, true, true, [ 
				'count',
				'setOrder',
				'setStoreId',
				'getCurPage',
		...
		$this->productFactory = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\ProductFactory', [ 
				'create',
				'getTypeId' 
		], [ ], '', false );
		
		$this->attrSetColFactory = $this->getMock ( 'Magento\Eav\Model\ResourceModel\Entity\Attribute\Set\CollectionFactory', [ 
				'create',
				'setEntityTypeFilter' 
		], [ ], '', false );
		
		$this->categoryColFactory = $this->getMock ( 'Magento\Catalog\Model\ResourceModel\Category\CollectionFactory', [ 
				'create',
				'addNameToResult' 
		], [ ], '', false );
		...
		$this->writer = $this->getMock ( 'Magento\ImportExport\Model\Export\Adapter\AbstractAdapter', [ 
				'setHeaderCols',
				'writeRow',
				'getContents' 
		], [ ], '', false );
		...
		$this->product->__construct ( $this->localeDate, $this->config, $this->resource, $this->storeManager, $this->logger, $this->collection, $this->exportConfig, $this->productFactory, $this->attrSetColFactory, $this->categoryColFactory, $this->itemFactory, $this->optionColFactory, $this->attributeColFactory, $this->typeFactory, $this->linkTypeProvider, $this->rowCustomizer );
	...
	public function testGetHeaderColumns() {
		$product = $this->getMock ( 'Magento\CatalogImportExport\Model\Export\Product', [ 
				'_customHeadersMapping' 
		], [ ], '', false );
		$headerColumnsValue = [ 
				'headerColumns value' 
		...
		$product->expects ( $this->once () )->method ( '_customHeadersMapping' )->with ( $headerColumnsValue )->willReturn ( $expectedResult );

...
class ImportTest extends \PHPUnit_Framework_TestCase {
	public function testAfterImportSource() {
		/**
		 *
		 * @var \Magento\Catalog\Model\Indexer\Product\Flat\Processor \PHPUnit_Framework_MockObject_MockObject $processorMock
		 */
		$processorMock = $this->getMock ( 'Magento\CatalogInventory\Model\Indexer\Stock\Processor', [ 

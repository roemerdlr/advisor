...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$entityTypeModel = $this->getMock ( 'Magento\CatalogImportExport\Model\Import\Product\Type\Simple', [ 
				'retrieveAttributeFromCache' 
		], [ ], '', false );
		$entityTypeModel->expects ( $this->any () )->method ( 'retrieveAttributeFromCache' )->willReturn ( [ ] );
		$this->context = $this->getMock ( '\Magento\CatalogImportExport\Model\Import\Product', [ 
		...
		$this->validatorOne = $this->getMock ( 'Magento\CatalogImportExport\Model\Import\Product\Validator\Media', [ ], [ ], '', false );
		$this->validatorTwo = $this->getMock ( 'Magento\CatalogImportExport\Model\Import\Product\Validator\Website', [ ], [ ], '', false );
		...
		$this->validator = $this->objectManagerHelper->getObject ( 'Magento\CatalogImportExport\Model\Import\Product\Validator', [ 
	...
	public function attributeValidationProvider() {
		return [ 
				...
				[ 
						...
						[ 
								'product_type' => 'any',
								'unique_attribute' => 'unique-value',
								Product::COL_SKU => 'sku-0' 
						],
						true,
						'unique_attribute' 
				] 

...
class MediaTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->media = $this->objectManagerHelper->getObject ( 'Magento\CatalogImportExport\Model\Import\Product\Validator\Media', [ ]
	...
	public function testIsValidClearMessagesCall() {
		$media = $this->getMock ( '\Magento\CatalogImportExport\Model\Import\Product\Validator\Media', [ 
				'_clearMessages' 
		], [ ], '', false );

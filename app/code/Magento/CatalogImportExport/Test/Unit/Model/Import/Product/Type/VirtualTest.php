...
class VirtualTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPrepareAttributesWithDefaultValueForSave() {
		$virtualModelMock = $this->getMock ( 'Magento\CatalogImportExport\Model\Import\Product\Type\Virtual', null, [ ], '', false );
		
		$this->setPropertyValue ( $virtualModelMock, '_attributes', [ 
				'Default' => [ 
						'name' => [ 
								'id' => '69',
								'code' => 'name',

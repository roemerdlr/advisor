...
class TaxClassProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$taxClassCollection = $this->objectManagerHelper->getCollectionMock ( 'Magento\Tax\Model\ResourceModel\TaxClass\Collection', [ 
				$taxClass 
		] );
		
		$taxClassCollectionFactory = $this->getMock ( 'Magento\Tax\Model\ResourceModel\TaxClass\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$taxClassFactory = $this->getMock ( 'Magento\Tax\Model\ClassModelFactory', [ 
				'create' 
		], [ ], '', false );

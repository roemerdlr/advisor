...
class PlaceTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->placeOrderController = $this->objectManager->getObject ( 'Magento\Authorizenet\Controller\Directpost\Payment\Place', [ 
	 ...
	 */
	public function testExecute($paymentMethod, $controller, $quoteId, $orderId, $result) {
		...
		$this->cartManagementMock->expects ( $this->any () )->method ( 'placeOrder' )->will ( $this->returnValue ( $orderId ) );

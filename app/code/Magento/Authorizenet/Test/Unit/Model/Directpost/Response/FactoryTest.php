...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->objectManagerMock->expects ( $this->once () )->method ( 'create' )->with ( 'Magento\Authorizenet\Model\Directpost\Response', [ ] )->willReturn ( $this->responseMock );
		
		$this->responseFactory = $objectManager->getObject ( 'Magento\Authorizenet\Model\Directpost\Response\Factory', [ 

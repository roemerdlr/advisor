...
class SessionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->storageMock = $this->getMockBuilder ( 'Magento\Framework\Session\StorageInterface' )->setMethods ( [ 
				'setQuoteId' 
		] )->getMockForAbstractClass ();
		
		$this->objectManager = new ObjectManager ( $this );
		$this->session = $this->objectManager->getObject ( 'Magento\Authorizenet\Model\Directpost\Session', [ 

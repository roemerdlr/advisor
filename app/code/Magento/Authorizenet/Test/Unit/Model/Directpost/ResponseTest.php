...
class ResponseTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGenerateHash($merchantMd5, $merchantApiLogin, $amount, $amountTestFunc, $transactionId) {
		$this->assertEquals ( $this->generateHash ( $merchantMd5, $merchantApiLogin, $amountTestFunc, $transactionId ), $this->responseModel->generateHash ( $merchantMd5, $merchantApiLogin, $amount, $transactionId ) );
	}
	...
	public function isApprovedDataProvider() {
		return [ 
				...
				[ 
						Directpost::RESPONSE_CODE_DECLINED,
						false 
				],
				[ 
						Directpost::RESPONSE_CODE_ERROR,
						false 
				],
				[ 
						Directpost::RESPONSE_CODE_HELD,
						false 
				] 
		];
	}

...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->objectManagerMock->expects ( $this->once () )->method ( 'create' )->with ( 'Magento\Authorizenet\Model\Request', [ ] )->willReturn ( $this->requestMock );
		
		$this->requestFactory = $objectManager->getObject ( 'Magento\Authorizenet\Model\Request\Factory', [ 

...
class AbstractIndexerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->indexer = $this->getMockForAbstractClass ( 'Magento\CatalogRule\Model\Indexer\AbstractIndexer', [ 
				$this->indexBuilder,
	...
	public function testExecuteFull() {
		...
		$this->_eventManagerMock->expects ( $this->once () )->method ( 'dispatch' )->with ( 'clean_cache_by_tags', [ 
				'object' => $this->indexer 
		] );

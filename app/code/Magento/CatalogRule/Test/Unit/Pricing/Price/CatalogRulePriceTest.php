...
class CatalogRulePriceTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->saleableItemMock = $this->getMock ( 'Magento\Catalog\Model\Product', [ 
				'getId',
				'__wakeup',
				'getPriceInfo' 
		], [ ], '', false );
		...
		$this->priceInfoMock = $this->getMock ( '\Magento\Framework\Pricing\PriceInfo', [ 
				'getAdjustments' 
		], [ ], '', false );
		$this->catalogRuleResourceFactoryMock = $this->getMock ( '\Magento\CatalogRule\Model\ResourceModel\RuleFactory', [ 
				'create' 
		], [ ], '', false );

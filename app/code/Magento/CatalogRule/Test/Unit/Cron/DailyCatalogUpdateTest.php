...
class DailyCatalogUpdateTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->ruleProductProcessor = $this->getMock ( 'Magento\CatalogRule\Model\Indexer\Rule\RuleProductProcessor', [ ], [ ], '', false );
		
		$this->cron = (new ObjectManager ( $this ))->getObject ( 'Magento\CatalogRule\Cron\DailyCatalogUpdate', [ 

...
class CategoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->productRuleProcessor = $this->getMock ( 'Magento\CatalogRule\Model\Indexer\Product\ProductRuleProcessor', [ ], [ ], '', false );
		$this->subject = $this->getMock ( 'Magento\Catalog\Model\Category', [ 

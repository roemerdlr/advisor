...
class Rule extends \Magento\Rule\Model\AbstractModel {
	...
	public function getMatchingProductIds() {
		if ($this->_productIds === null) {
			...
			if ($this->getWebsiteIds ()) {
				...
				$this->_resourceIterator->walk ( $productCollection->getSelect (), [ 
						[ 
								$this,
	 ...
	 * @param float $price        	
	 * @return float|null @SuppressWarnings(PHPMD.CyclomaticComplexity)
	 */
	 ...
	 *
	 * @return array|int|null @codeCoverageIgnore
	 */

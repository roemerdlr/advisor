...
class Iframe extends \Magento\Paypal\Block\Payflow\Link\Iframe {
	...
	public function getFrameActionUrl() {
		return $this->getUrl ( 'paypal/payflowadvanced/form', [ 
				'_secure' => true 
		] );
	}
	...
	public function isTestMode() {
		$mode = $this->_paymentData->getMethodInstance ( \Magento\Paypal\Model\Config::METHOD_PAYFLOWADVANCED )->getConfigData ( 'sandbox_flag' );
		return ( bool ) $mode;
	}
}

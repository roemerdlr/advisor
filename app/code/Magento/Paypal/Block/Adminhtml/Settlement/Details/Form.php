	...
	protected function _prepareForm() {
		...
		$fieldsets = [ 
				'reference_fieldset' => [ 
						'fields' => [ 
								'transaction_id' => [ 
										'label' => $this->_settlement->getFieldLabel ( 'transaction_id' ) 
								],
								'invoice_id' => [ 
										'label' => $this->_settlement->getFieldLabel ( 'invoice_id' ) 
								],
								'paypal_reference_id' => [ 
								...
								'custom_field' => [ 
										'label' => $this->_settlement->getFieldLabel ( 'custom_field' ) 
								] 
						],
				...
				'transaction_fieldset' => [ 
						'fields' => [ 
								...
								'transaction_initiation_date' => [ 
										...
										'value' => $this->formatDate ( $model->getData ( 'transaction_initiation_date' ), \IntlDateFormatter::MEDIUM, true ) 
								],
								'transaction_completion_date' => [ 
										'label' => $this->_settlement->getFieldLabel ( 'transaction_completion_date' ),
										'value' => $this->formatDate ( $model->getData ( 'transaction_completion_date' ), \IntlDateFormatter::MEDIUM, true ) 
								],
								...
								'gross_transaction_amount' => [ 
										...
										'value' => $this->_localeCurrency->getCurrency ( $model->getData ( 'gross_transaction_currency' ) )->toCurrency ( $model->getData ( 'gross_transaction_amount' ) ) 
								] 
						],
				...
				'fee_fieldset' => [ 
						'fields' => [ 
								...
								'fee_amount' => [ 
										...
										'value' => $this->_localeCurrency->getCurrency ( $model->getData ( 'fee_currency' ) )->toCurrency ( $model->getCastedAmount ( 'fee_amount' ) ) 
								] 
						],

...
class AddPaypalShortcutsObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = $objectManagerHelper->getObject ( 'Magento\Paypal\Observer\AddPaypalShortcutsObserver', [ 
	...
	public function testAddPaypalShortcuts($paymentMethodsAvailability, $blocks) {
		...
		$shortcutButtonsMock = $this->getMockBuilder ( 'Magento\Catalog\Block\ShortcutButtons' )->setMethods ( [ 
				'getLayout',
				'addShortcut' 
		] )->disableOriginalConstructor ()->getMock ();

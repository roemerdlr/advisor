...
class SetResponseAfterSaveOrderObserverTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->paypalHssMock = $this->getMock ( 'Magento\Paypal\Helper\Hss', [ 
				'getHssMethods' 
		], [ ], '', false );
		$this->viewMock = $this->getMockForAbstractClass ( 'Magento\Framework\App\ViewInterface', [ ], '', false, true, true, [ ] );
		$objectManagerHelper = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		$this->_model = $objectManagerHelper->getObject ( 'Magento\Paypal\Observer\SetResponseAfterSaveOrderObserver', [ 

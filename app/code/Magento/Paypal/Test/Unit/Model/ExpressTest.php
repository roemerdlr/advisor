...
class ExpressTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_checkoutSession = $this->getMock ( 'Magento\Checkout\Model\Session', [ 
				'getPaypalTransactionData',
				'setPaypalTransactionData' 
		], [ ], '', false );
		$this->transactionBuilder = $this->getMockForAbstractClass ( 'Magento\Sales\Model\Order\Payment\Transaction\BuilderInterface', [ ], '', false, false );
		$this->_nvp = $this->getMock ( 'Magento\Paypal\Model\Api\Nvp', [ 
		...
		$this->_pro = $this->getMock ( 'Magento\Paypal\Model\ProFactory', [ 
				'create',
				'setMethod',
				'getApi',
				'importPaymentInfo',
	...
	public function testSetApiProcessableErrors() {
		...
		$this->_model = $this->_helper->getObject ( 'Magento\Paypal\Model\Express', [ 
	...
	public function testOrder() {
		...
		$paymentModel = $this->getMock ( 'Magento\Sales\Model\Order\Payment', [ 
				'__wakeup',
				'getBaseCurrency',
				'getOrder',

...
class ExpressConfigProviderTest extends \PHPUnit_Framework_TestCase {
	public function testGetConfig() {
		...
		$configFactory = $this->getMock ( 'Magento\Paypal\Model\ConfigFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$payment = $this->getMock ( 'Magento\Paypal\Model\Payflowpro', [ 
				'isAvailable',
				'getCheckoutRedirectUrl' 
		], [ ], 'paymentInstance', false );
		...
		$configProvider = new ExpressConfigProvider ( $configFactory, $localeResolver, $currentCustomer, $paypalHelper, $paymentHelper );

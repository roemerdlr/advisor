...
class OrdersUpdaterTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_agreementResource = $this->getMock ( '\Magento\Paypal\Model\ResourceModel\Billing\Agreement', [ ], [ ], '', false );
		
		$helper = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this );
		$this->_model = $helper->getObject ( 'Magento\Paypal\Model\Billing\Agreement\OrdersUpdater', [ 
	...
	public function testUpdateWhenBillingAgreementIsNotSet() {
		$this->_registry->expects ( $this->once () )->method ( 'registry' )->with ( 'current_billing_agreement' )->will ( $this->returnValue ( null ) );

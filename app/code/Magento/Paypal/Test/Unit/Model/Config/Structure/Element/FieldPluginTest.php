...
class FieldPluginTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helper->getObject ( 'Magento\Paypal\Model\Config\Structure\Element\FieldPlugin', [ 
	...
	public function testAroundGetConfigPathNonPaymentSection() {
		...
		$this->request->expects ( $this->once () )->method ( 'getParam' )->with ( 'section' )->will ( $this->returnValue ( 'non-payment' ) );

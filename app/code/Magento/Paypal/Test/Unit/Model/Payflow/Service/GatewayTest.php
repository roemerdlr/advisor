...
class GatewayTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->httpClientFactoryMock = $this->getMockBuilder ( '\Magento\Framework\HTTP\ZendClientFactory' )->setMethods ( [ 
				'create' 
	...
	public function testPostRequestOk() {
		...
		$zendResponseMock = $this->getMockBuilder ( '\Zend_Http_Response' )->setMethods ( [ 
				'getBody' 
		] )->disableOriginalConstructor ()->getMock ();

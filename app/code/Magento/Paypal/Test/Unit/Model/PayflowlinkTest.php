...
class PayflowlinkTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$configFactoryMock = $this->getMockBuilder ( 'Magento\Payment\Model\Method\ConfigInterfaceFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		
		$requestFactory = $this->getMockBuilder ( 'Magento\Paypal\Model\Payflow\RequestFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		...
		$this->model = $helper->getObject ( 'Magento\Paypal\Model\Payflowlink', [ 
	...
	public function testInitialize() {
		...
		$this->payflowRequest->expects ( $this->exactly ( 3 ) )->method ( 'setData' )->willReturnMap ( [ 
				[ 
						'user' => null,
						'vendor' => null,
						'partner' => null,
				...
				'USER2',
				'a20d3dc6824c1f7780c5529dc37ae5e',
				$this->returnSelf () 
		] );

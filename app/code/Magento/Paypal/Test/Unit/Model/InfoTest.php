...
class InfoTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->info = $this->objectManagerHelper->getObject ( 'Magento\Paypal\Model\Info' );
	}
	...
	public function testGetPaymentInfoLabelValues($additionalInfo, $expectation) {
		...
		$paymentInfo = $this->objectManagerHelper->getObject ( 'Magento\Payment\Model\Info' );
		$paymentInfo->setAdditionalInformation ( $additionalInfo );
		$this->assertEquals ( $this->_prepareLabelValuesExpectation ( $expectation ), $this->info->getPaymentInfo ( $paymentInfo, true ) );
	}
	...
	public function testGetPublicPaymentInfo($additionalInfo, $expectation) {
		...
		$paymentInfo = $this->objectManagerHelper->getObject ( 'Magento\Payment\Model\Info' );
		$paymentInfo->setAdditionalInformation ( $additionalInfo );
		$this->assertEquals ( $this->_prepareLabelValuesExpectation ( $expectation ), $this->info->getPublicPaymentInfo ( $paymentInfo, true ) );
	}

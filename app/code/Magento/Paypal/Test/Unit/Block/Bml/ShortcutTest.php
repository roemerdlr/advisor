...
class ShortcutTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->shortcut = $this->objectManagerHelper->getObject ( 'Magento\Paypal\Block\Bml\Shortcut', [ 
	...
	public function testToHtmlWrongValidation() {
		...
		$this->paypalShortcutHelperMock->expects ( $this->once () )->method ( 'validate' )->with ( $paymentMethodCode, $isInCatalog )->will ( $this->returnValue ( false ) );

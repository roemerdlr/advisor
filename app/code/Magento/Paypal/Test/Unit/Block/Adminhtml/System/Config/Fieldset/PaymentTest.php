...
class PaymentTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_element = $this->getMockForAbstractClass ( 'Magento\Framework\Data\Form\Element\AbstractElement', [ ], '', false, true, true, [ 
				'getHtmlId',
				'getElementHtml',
				'getName',
				'getElements',
		...
		$this->_model = $helper->getObject ( 'Magento\Paypal\Block\Adminhtml\System\Config\Fieldset\Payment', [ 
	...
	public function testIsPaymentEnabled($groupConfig, $expected) {
		...
		$this->_backendConfig->expects ( $this->any () )->method ( 'getConfigDataValue' )->will ( $this->returnValueMap ( [ 
				[ 
	...
	public function isPaymentEnabledDataProvider() {
		return [ 
				...
				[ 
						[ 
								'activity_path' => self::CONFIG_PATH_ACTIVE 
						],
						' class="section-config with-button enabled">' 
				],
				[ 
						[ 
								'activity_path' => self::CONFIG_PATH_NOT_ACTIVE 
						],
						' class="section-config with-button">' 
				],
				[ 

...
class CountryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = $helper->getObject ( 'Magento\Paypal\Block\Adminhtml\System\Config\Field\Country', [ 
	...
	public function testRender($requestCountry, $requestDefaultCountry, $canUseDefault, $inherit) {
		...
		$constraints = [ 
				...
				new \PHPUnit_Framework_Constraint_StringContains ( '$("' . $this->_element->getHtmlId () . '").observe("change", function () {' ) 
		];

...
class AbstractEnableTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->elementMock = $this->getMockBuilder ( 'Magento\Framework\Data\Form\Element\AbstractElement' )->setMethods ( [ 
				'getHtmlId',
				'getTooltip',
				'getForm' 
		] )->disableOriginalConstructor ()->getMockForAbstractClass ();
		
		$this->abstractEnable = $objectManager->getObject ( 'Magento\Paypal\Test\Unit\Block\Adminhtml\System\Config\Field\Enable\AbstractEnable\Stub' );
	}

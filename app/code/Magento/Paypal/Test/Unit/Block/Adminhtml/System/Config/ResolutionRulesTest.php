...
class ResolutionRulesTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->readerMock = $this->getMockBuilder ( 'Magento\Paypal\Model\Config\Rules\Reader' )->disableOriginalConstructor ()->getMock ();
		
		$this->resolutionRules = new \Magento\Paypal\Block\Adminhtml\System\Config\ResolutionRules ( $this->context, $this->readerMock );
	}

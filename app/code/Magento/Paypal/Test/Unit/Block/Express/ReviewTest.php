...
class ReviewTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helper->getObject ( 'Magento\Paypal\Block\Express\Review', [ 
				'context' => $context 
		] );
	}
	...
	public function testBeforeToHtmlWhenQuoteIsNotVirtual() {
		...
		$shippingRate = new \Magento\Framework\DataObject ( [ 
				'code' => 'Rate 1' 
		] );
		$shippingRates = [ 
				[ 
	...
	protected function _getQuoteMock() {
		$methodInstance = new \Magento\Framework\DataObject ( [ 

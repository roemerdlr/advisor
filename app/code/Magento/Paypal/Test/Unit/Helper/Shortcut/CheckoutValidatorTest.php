...
class CheckoutValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->checkoutValidator = $this->objectManagerHelper->getObject ( 'Magento\Paypal\Helper\Shortcut\CheckoutValidator', [ 
	...
	public function testIsMethodQuoteAvailableNoQuoteMethodNotAvailableFalse() {
		...
		$methodInstanceMock->expects ( $this->once () )->method ( 'isAvailable' )->with ( $quote )->will ( $this->returnValue ( false ) );

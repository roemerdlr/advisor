...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->factory = $this->objectManagerHelper->getObject ( 'Magento\Paypal\Helper\Shortcut\Factory', [ 
	...
	public function testCreateDefault() {
		...
		$this->objectManagerMock->expects ( $this->once () )->method ( 'create' )->with ( Factory::DEFAULT_VALIDATOR )->will ( $this->returnValue ( $instance ) );
		
		$this->assertInstanceOf ( 'Magento\Paypal\Helper\Shortcut\ValidatorInterface', $this->factory->create () );
	}

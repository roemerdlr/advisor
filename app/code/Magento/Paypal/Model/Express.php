...
class Express extends \Magento\Payment\Model\Method\AbstractMethod {
	...
	public function canUseCheckout() {
		if ($this->_scopeConfig->isSetFlag ( 'payment/hosted_pro/active', \Magento\Store\Model\ScopeInterface::SCOPE_STORE ) && ! $this->_scopeConfig->isSetFlag ( 'payment/hosted_pro/display_ec', \Magento\Store\Model\ScopeInterface::SCOPE_STORE )) {
			return false;
		}

...
class Gateway implements GatewayInterface {
	 ...
	 * @param Logger $logger        	
	 */
	public function __construct(ZendClientFactory $httpClientFactory, Random $mathRandom, Logger $logger) {
	...
	public function postRequest(DataObject $request, ConfigInterface $config) {
		...
		try {
			...
			], ( array ) $config->getValue ( 'getDebugReplacePrivateDataKeys' ), ( bool ) $config->getValue ( 'debug' ) );
		}

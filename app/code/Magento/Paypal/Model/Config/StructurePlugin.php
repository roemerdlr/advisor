...
class StructurePlugin {
	 ...
	 */
	public function __construct(\Magento\Config\Model\Config\ScopeDefiner $scopeDefiner, \Magento\Paypal\Helper\Backend $helper) {
	 ...
	 * @return \Magento\Config\Model\Config\Structure\ElementInterface @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */

...
abstract class AbstractConfig implements ConfigInterface {
	 ...
	 * @param string $key        	
	 * @param null $storeId        	
	 * @return null|string @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	...
	public function isWppApiAvailabe() {
		return $this->getValue ( 'api_username' ) && $this->getValue ( 'api_password' ) && ($this->getValue ( 'api_signature' ) || $this->getValue ( 'api_cert' ));
	}
	...
	public function isMethodActive($method) {
		switch ($method) {
			...
			case Config::METHOD_WPP_EXPRESS :
				$isEnabled = $this->_scopeConfig->isSetFlag ( 'payment/' . Config::METHOD_WPS_EXPRESS . '/active', ScopeInterface::SCOPE_STORE, $this->_storeId ) || $this->_scopeConfig->isSetFlag ( 'payment/' . Config::METHOD_WPP_EXPRESS . '/active', ScopeInterface::SCOPE_STORE, $this->_storeId );
				$method = Config::METHOD_WPP_EXPRESS;
				break;
			case Config::METHOD_WPS_BML :
			case Config::METHOD_WPP_BML :
				$isEnabled = $this->_scopeConfig->isSetFlag ( 'payment/' . Config::METHOD_WPS_BML . '/active', ScopeInterface::SCOPE_STORE, $this->_storeId ) || $this->_scopeConfig->isSetFlag ( 'payment/' . Config::METHOD_WPP_BML . '/active', ScopeInterface::SCOPE_STORE, $this->_storeId );
				$method = Config::METHOD_WPP_BML;
				break;
			case Config::METHOD_PAYMENT_PRO :
			case Config::METHOD_PAYFLOWPRO :
				$isEnabled = $this->_scopeConfig->isSetFlag ( 'payment/' . Config::METHOD_PAYMENT_PRO . '/active', ScopeInterface::SCOPE_STORE, $this->_storeId ) || $this->_scopeConfig->isSetFlag ( 'payment/' . Config::METHOD_PAYFLOWPRO . '/active', ScopeInterface::SCOPE_STORE, $this->_storeId );
	...
	public function getBuildNotationCode() {
		return $this->_scopeConfig->getValue ( 'paypal/bncode', ScopeInterface::SCOPE_STORE, $this->_storeId );
	}
}

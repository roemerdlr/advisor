...
class Settlement extends \Magento\Framework\Model\AbstractModel {
	...
	public static function createConnection(array $config) {
		if (! isset ( $config ['hostname'] ) || ! isset ( $config ['username'] ) || ! isset ( $config ['password'] ) || ! isset ( $config ['path'] )) {
	 ...
	 * @return \Magento\Framework\Phrase|string @SuppressWarnings(PHPMD.CyclomaticComplexity)
	 */
	 ...
	 *        	Whether to skip settings with disabled Automatic Fetching or not
	...
	public function getSftpCredentials($automaticMode = false) {
		...
		foreach ( $this->_storeManager->getStores () as $store ) {
			...
			$cfg = [ 
					'hostname' => $this->_scopeConfig->getValue ( 'paypal/fetch_reports/ftp_ip', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store ),
					'path' => $this->_scopeConfig->getValue ( 'paypal/fetch_reports/ftp_path', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store ),
					'username' => $this->_scopeConfig->getValue ( 'paypal/fetch_reports/ftp_login', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store ),
					'password' => $this->_scopeConfig->getValue ( 'paypal/fetch_reports/ftp_password', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store ),
					'sandbox' => $this->_scopeConfig->getValue ( 'paypal/fetch_reports/ftp_sandbox', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store ) 
			];
	 ...
	 *
	 * @param array $list
	 *        	List of files as per $connection->rawls()

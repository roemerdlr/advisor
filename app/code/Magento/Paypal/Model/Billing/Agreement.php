...
class Agreement extends \Magento\Paypal\Model\Billing\AbstractAgreement {
	...
	public function place() {
		...
		$this->setCustomerId ( $this->getCustomerId () )->setMethodCode ( $this->getMethodCode () )->setReferenceId ( $this->getBillingAgreementId () )->setStatus ( self::STATUS_ACTIVE )->setAgreementLabel ( $paymentMethodInstance->getTitle () )->save ();
	...
	public function getAvailableCustomerBillingAgreements($customerId) {
		...
		$collection->addFieldToFilter ( 'customer_id', $customerId )->addFieldToFilter ( 'status', self::STATUS_ACTIVE )->setOrder ( 'agreement_id' );
		return $collection;
	}

...
class ExpressConfigProvider implements ConfigProviderInterface {
	...
	public function getConfig() {
		$config = [ 
				'payment' => [ 
						'paypalExpress' => [ 
								'paymentAcceptanceMarkHref' => $this->config->getPaymentMarkWhatIsPaypalUrl ( $this->localeResolver ),
								'paymentAcceptanceMarkSrc' => $this->config->getPaymentMarkImageUrl ( $this->localeResolver->getLocale () ) 
						] 
				] 
		];
		foreach ( $this->methodCodes as $code ) {

...
class IndexTest extends \PHPUnit_Framework_TestCase {
	public function testExecute() {
		...
		$resultPageFactory = $this->getMockBuilder ( 'Magento\Framework\View\Result\PageFactory' )->disableOriginalConstructor ()->getMock ();
		...
		$model = $objectManager->getObject ( 'Magento\Swagger\Controller\Index\Index', [ 

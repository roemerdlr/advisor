...
class ConditionsTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$arguments = $objectManagerHelper->getConstructArguments ( 'Magento\CatalogWidget\Controller\Adminhtml\Product\Widget\Conditions', [ 
				'rule' => $this->rule,
	...
	public function testExecute() {
		...
		$condition = $this->getMockBuilder ( 'Magento\CatalogWidget\Model\Rule\Condition\Product' )->setMethods ( [ 
				'setId',
				'setType',
				'setRule',
				'setPrefix',

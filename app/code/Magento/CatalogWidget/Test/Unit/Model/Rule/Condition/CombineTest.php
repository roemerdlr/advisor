...
class CombineTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->conditionFactory = $this->getMockBuilder ( '\Magento\CatalogWidget\Model\Rule\Condition\ProductFactory' )->setMethods ( [ 
				'create' 
	...
	public function testGetNewChildSelectOptions() {
		$expectedOptions = [ 
				...
				[ 
						...
						'value' => [ 
								[ 
										'value' => 'Magento\CatalogWidget\Model\Rule\Condition\Product|sku',
										'label' => 'SKU' 
								],
								[ 
										'value' => 'Magento\CatalogWidget\Model\Rule\Condition\Product|category',
										'label' => 'Category' 
								] 
						] 
				] 
		...
		$productCondition = $this->getMockBuilder ( '\Magento\CatalogWidget\Model\Rule\Condition\Product' )->setMethods ( [ 
	...
	public function testCollectValidatedAttributes() {
		...
		$condition = $this->getMockBuilder ( 'Magento\CatalogWidget\Model\Rule\Condition\Combine' )->disableOriginalConstructor ()->setMethods ( [ 
				'addToCollection' 
		] )->getMock ();
		$condition->expects ( $this->any () )->method ( 'addToCollection' )->with ( $collection )->will ( $this->returnSelf () );
		
		$this->condition->setConditions ( [ 
				$condition 
		] );

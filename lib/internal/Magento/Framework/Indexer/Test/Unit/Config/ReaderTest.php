...
class ReaderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_converter = $this->getMock ( 'Magento\Framework\Indexer\Config\Converter', [ 
				'convert' 
		] );
		...
		$this->_model = new \Magento\Framework\Indexer\Config\Reader ( $this->_fileResolverMock, $this->_converter, new \Magento\Framework\Indexer\Config\SchemaLocator ( new \Magento\Framework\Config\Dom\UrnResolver () ), $validationState );
	}

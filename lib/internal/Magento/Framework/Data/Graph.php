...
class Graph {
	 ...
	 *
	 * @param array $nodes
	 *        	plain array with node identifiers
	 * @param array $relations
	 *        	array of 2-item plain arrays, which represent relations of nodes "from" "to"
	 */
	...
	/**
	 * Export relations between nodes.
	 * Can return inverse relations
	 *
	 * @param int $mode        	
	 * @return array
	 * @throws \InvalidArgumentException

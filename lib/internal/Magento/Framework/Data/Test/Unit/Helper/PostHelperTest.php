...
class PostHelperTest extends \PHPUnit_Framework_TestCase {
	public function testGetPostData() {
		...
		$urlHelper = $this->getMockBuilder ( 'Magento\Framework\Url\Helper\Data' )->disableOriginalConstructor ()->getMock ();
		$urlHelper->expects ( $this->once () )->method ( 'getEncodedUrl' )->willReturn ( 'L2NvbnRyb2xsZXIvc2FtcGxlL2FjdGlvbi91cmwvZm9yX3VlbmM,' );

...
class NoteTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = new \Magento\Framework\Data\Form\Element\Note ( $factoryMock, $collectionFactoryMock, $escaperMock );
	...
	public function testGetElementHtml() {
		...
		$this->assertEquals ( "note_before<div id=\"note_id\" class=\"control-value admin__field-value\"></div>note_after", $html );
	}
}

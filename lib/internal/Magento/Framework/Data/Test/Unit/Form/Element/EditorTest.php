...
class EditorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $this->objectManager->getObject ( 'Magento\Framework\Data\Form\Element\Editor', [ 
		...
		$this->formMock = $this->getMock ( 'Magento\Framework\Data\Form', [ 
				'getHtmlIdPrefix',
				'getHtmlIdSuffix' 
		], [ ], '', false, false );
	...
	public function testConstruct() {
		...
		$model = $this->objectManager->getObject ( 'Magento\Framework\Data\Form\Element\Editor', [ 
				'factoryElement' => $this->factoryMock,
				'factoryCollection' => $this->collectionFactoryMock,
				'escaper' => $this->escaperMock,
				'data' => [ 
	...
	public function testGetElementHtml() {
		...
		$this->configMock->expects ( $this->any () )->method ( 'getData' )->willReturnMap ( [ 
				[ 
						'enabled',
						null,
						true 
	...
	public function testGetConfig() {
		$config = $this->getMock ( '\Magento\Framework\DataObject', [ 
				'getData' 
		], [ ], '', false );

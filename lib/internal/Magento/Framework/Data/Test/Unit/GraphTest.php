...
class GraphTest extends \PHPUnit_Framework_TestCase {
	...
	public function testFindCycle() {
		...
		$model = new \Magento\Framework\Data\Graph ( $nodes, [ 
				[ 
						1,
						2 
				],
	...
	public function testDfs() {
		...
		$this->assertEquals ( [ 
				...
				2,
				1 
		], $model->dfs ( 3, 1, \Magento\Framework\Data\Graph::INVERSE ) );
		...
		$this->assertEquals ( [ 
				...
				2,
				3 
		], $model->dfs ( 1, 3, \Magento\Framework\Data\Graph::NON_DIRECTIONAL ) );
	}

...
class FormTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_factoryCollectionMock = $this->getMock ( 'Magento\Framework\Data\Form\Element\CollectionFactory', [ 
				'create' 
		], [ ], '', false );
		...
		$this->_formKeyMock = $this->getMock ( 'Magento\Framework\Data\Form\FormKey', [ 
				'getFormKey' 
		], [ ], '', false );
	...
	public function testSettersGetters() {
		...
		$this->assertSame ( $this->_form->getHtmlAttributes (), [ 
				'id',
				'name',
				'method',
				'action',

...
class AbstractCriteriaTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @param array $result        	
	 * @return void @dataProvider dataProviderAddField
	 */
	 ...
	 * @param string $type        	
	 * @param array $result        	
	 * @return void @dataProvider dataProviderAddFilter
	 */
	 ...
	 * @param bool $unShift        	
	 * @param array $result        	
	 * @return void @dataProvider dataProviderAddOrder
	 */
	 ...
	 * @param int $size        	
	 * @param array $result        	
	 * @return void @dataProvider dataProviderSetLimit
	 */
	 ...
	 *        	Alias identifier
	 * @param array $result        	
	 * @return void @dataProvider dataProviderRemoveField
	 */
	 ...
	 * @param array $actualField        	
	 * @param array $result        	
	 * @return void @dataProvider dataProviderRemoveAllFields
	 */
	 ...
	 * @param string $name        	
	 * @param array $result        	
	 * @return void @dataProvider dataProviderRemoveFilter
	 */
	 ...
	 * @param array $actualField        	
	 * @param array $result        	
	 * @return void @dataProvider dataProviderRemoveAllFilters
	 */
	 ...
	 *
	 * @param array $result        	
	 * @return void @dataProvider dataProviderReset
	 */
	...
	public function dataProviderAddFilter() {
		...
		return [ 
				[ 
						...
						'type' => 'test-type',
						'result' => [ 
								'test-filter-name' => $objectManager->getObject ( 'Magento\Framework\DataObject', [ 
										'data' => [ 
												'name' => 'test-filter-name',
												'field' => 'test-field-name',
												'condition' => 'test-condition',

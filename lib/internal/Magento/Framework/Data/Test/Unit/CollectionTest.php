...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->_model = new \Magento\Framework\Data\Collection ( $this->getMock ( 'Magento\Framework\Data\Collection\EntityFactory', [ ], [ ], '', false ) );
	}
	...
	public function testGetFilters() {
		...
		$this->assertEquals ( 'field1', $this->_model->getFilter ( [ 
				'field1',
				'field2' 
		] ) [0]->getData ( 'field' ) );
		$this->assertEquals ( 'field2', $this->_model->getFilter ( [ 
				'field1',
				'field2' 
		] ) [1]->getData ( 'field' ) );
	}
	...
	public function testPossibleFlowWithItem() {
		$firstItemMock = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'getId',
				'getData',
				'toArray' 
		], [ ], '', false );
		$secondItemMock = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'getId',
				'getData',
				'toArray' 
		], [ ], '', false );
		...
		$this->assertEquals ( [ 
				'first_value',
				'second_value' 
		], $this->_model->getColumnValues ( 'colName' ) );
		$this->assertEquals ( [ 
				$secondItemMock 
		], $this->_model->getItemsByColumnValue ( 'colName', 'second_value' ) );

...
class Date extends AbstractElement {
	...
	public function getElementHtml() {
		...
		$dataInit = 'data-mage-init="' . $this->_escape ( json_encode ( [ 
				'calendar' => [ 
		...
		$html = sprintf ( '<input name="%s" id="%s" value="%s" %s %s />', $this->getName (), $this->getHtmlId (), $this->_escape ( $this->getValue () ), $this->serialize ( $this->getHtmlAttributes () ), $dataInit );

...
class Factory {
	 ...
	 *        	Standard element type or Custom element class
	 * @param array $config        	
	...
	public function create($elementType, array $config = []) {
		...
		if (! $element instanceof AbstractElement) {
			throw new \InvalidArgumentException ( $className . ' doesn\'n extend \Magento\Framework\Data\Form\Element\AbstractElement' );
		}
		return $element;
	}
}

...
class Converter extends \Magento\Framework\Code\Generator\EntityAbstract {
	...
	protected function _getDefaultConstructorDefinition() {
		return [ 
				...
				'body' => "\$this->" . $this->_getFactoryPropertyName () . " = \$" . $this->_getFactoryPropertyName () . ';',
				'docblock' => [ 
						'shortDescription' => ucfirst ( static::ENTITY_TYPE ) . ' constructor',
						'tags' => [ 
								[ 
										'name' => 'param',
										'description' => $this->getSourceClassName () . " \$" . $this->_getFactoryPropertyName () 
								] 
						] 
				] 
		];
	...
	protected function _getClassMethods() {
		...
		$body = 'return $this->' . $this->_getFactoryPropertyName () . '->create()->setData($' . $paramName . '->__toArray());';
		$getModel = [ 
				'name' => 'getModel',
				'parameters' => [ 
						[ 

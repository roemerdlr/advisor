	...
	protected function _getSourceResourceClassName() // Invoice\Resource
{
	...
	protected function _getDefaultConstructorDefinition() {
		return [ 
				...
				'body' => "\$this->" . $this->_getSourceResourcePropertyName () . " = \$" . $this->_getSourceResourcePropertyName () . ";\n" . "\$this->" . $this->_getSourceFactoryPropertyName () . " = \$" . $this->_getSourceFactoryPropertyName () . ";\n" . "\$this->resource = \$resource;",
				'docblock' => [ 
						'shortDescription' => ucfirst ( static::ENTITY_TYPE ) . ' constructor',
						'tags' => [ 
								[ 
										'name' => 'param',
										'description' => $this->_getSourceResourceClassName () . " \$" . $this->_getSourceResourcePropertyName () 
								],
								[ 
										'name' => 'param',
										'description' => $this->getSourceClassName () . 'Factory' . " \$" . $this->_getSourceFactoryPropertyName () 
								],
								[ 
										'name' => 'param',
	...
	protected function _getRegisterDeletedMethod() {
		$body = "\$hash = spl_object_hash(\$entity);" . "array_push(\$this->stack, \$hash);" . "\$this->entitiesPool[\$hash] = [" . "    'entity' => \$entity," . "    'action' => 'removed'" . "];";
		return [ 
	...
	protected function _validateData() {
		...
		if ($result) {
			...
			if ($resultClassName !== $sourceClassName . 'Persistor') {
				$this->_addError ( 'Invalid Factory class name [' . $resultClassName . ']. Use ' . $sourceClassName . 'Persistor' );
				$result = false;
			}
		}
		return $result;

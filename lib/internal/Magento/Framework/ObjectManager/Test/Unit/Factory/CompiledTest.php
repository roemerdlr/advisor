...
class CompiledTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->config = $this->getMockBuilder ( 'Magento\Framework\ObjectManager\ConfigInterface' )->setMethods ( [ ] )->getMock ();
	...
	public function testCreateSimple() {
		...
		$this->config->expects ( $this->any () )->method ( 'getArguments' )->willReturnMap ( [ 
				[ 
						$requestedType,
						$expectedConfig 
				],
		...
		$this->config->expects ( $this->any () )->method ( 'getInstanceType' )->willReturnMap ( [ 
				[ 
						$requestedType,
						$type 
				],
		...
		$this->assertInstanceOf ( 'Magento\Framework\ObjectManager\Test\Unit\Factory\Fixture\Compiled\SimpleClassTesting', $result );

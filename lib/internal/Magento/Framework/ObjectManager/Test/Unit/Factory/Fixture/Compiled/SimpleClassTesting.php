...
class SimpleClassTesting {
	 ...
	 */
	public function __construct(DependencyTesting $nonSharedDependency, DependencySharedTesting $sharedDependency, $value = 'value', array $valueArray = [
        'default_value1',
        'default_value2'
        ], $globalValue = '', $nullValue = null) {

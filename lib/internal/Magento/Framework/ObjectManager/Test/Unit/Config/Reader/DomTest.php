...
class DomTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->converterMock = $this->getMock ( '\Magento\Framework\ObjectManager\Config\Mapper\Dom', [ ], [ ], '', false );
		$this->schemaLocatorMock = $this->getMock ( '\Magento\Framework\ObjectManager\Config\SchemaLocator', [ ], [ ], '', false );
		$this->validationStateMock = $this->getMock ( '\Magento\Framework\Config\ValidationStateInterface', [ ], [ ], '', false );
		
		$this->model = new \Magento\Framework\ObjectManager\Config\Reader\Dom ( $this->fileResolverMock, $this->converterMock, $this->schemaLocatorMock, $this->validationStateMock, 'filename.xml', [ ], '\ConfigDomMock' );
	}

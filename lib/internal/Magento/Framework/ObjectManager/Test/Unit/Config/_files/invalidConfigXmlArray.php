...
return [ 
        ...
        <config>
            ...
            <preference for="Some_For_Name" type="Some_Type_Name" />
				...
				[ 
						"Element 'preference': Duplicate key-sequence ['Some_For_Name'] in unique " . "identity-constraint 'uniquePreference'.\nLine: 4\n" 
				] 
		],
        ...
        <config><type name="Some_Name"><plugin name="some_name" disabled="string" /></type></config>',
				[ 
						"Element 'plugin', attribute 'disabled': 'string' is not a valid value of the atomic " . "type 'xs:boolean'.\nLine: 2\n" 
				] 
		],
        ...
        <config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
            <type name="Some_Name">
				...
				[ 
						"Element 'argument': Duplicate key-sequence ['same_argument_name'] in key identity-constraint " . "'argumentName'.\nLine: 6\n" 
				] 
		],
		...
		'virtualtype_with_forbidden_shared_attribute_value' => [ 
				...
				[ 
						"Element 'virtualType', attribute 'shared': 'forbidden' is not a valid value of the atomic " . "type 'xs:boolean'.\nLine: 1\n" 
				] 
		],
		...
		'virtualtype_with_same_name_attribute_value' => [ 
				...
				[ 
						"Element 'virtualType': Duplicate key-sequence ['test_name'] in unique" . " identity-constraint 'uniqueVirtualType'.\nLine: 1\n" 
				] 
		],

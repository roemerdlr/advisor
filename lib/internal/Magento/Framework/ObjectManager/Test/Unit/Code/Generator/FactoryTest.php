...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGenerate() {
		...
		$this->ioObjectMock->expects ( $this->once () )->method ( 'generateResultFileName' )->with ( '\Magento\Framework\ObjectManager\Code\Generator\SampleFactory' )->will ( $this->returnValue ( 'sample_file.php' ) );
		$factoryCode = file_get_contents ( __DIR__ . '/_files/SampleFactory.txt' );
		$this->ioObjectMock->expects ( $this->once () )->method ( 'writeResultFile' )->with ( 'sample_file.php', $factoryCode );

...
class ProxyTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGenerate() {
		...
		$this->ioObjectMock->expects ( $this->once () )->method ( 'generateResultFileName' )->with ( '\Magento\Framework\ObjectManager\Code\Generator\Sample_Proxy' )->will ( $this->returnValue ( 'sample_file.php' ) );
		$this->ioObjectMock->expects ( $this->once () )->method ( 'writeResultFile' )->with ( 'sample_file.php', $sampleProxyCode );

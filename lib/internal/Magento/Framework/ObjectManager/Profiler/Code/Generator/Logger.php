...
class Logger extends \Magento\Framework\Code\Generator\EntityAbstract {
				...
				[ 
						...
						'docblock' => [ 
								...
								'tags' => [ 
										[ 
												'name' => 'var',
												'description' => '\Magento\Framework\ObjectManager\Factory\Log' 
										] 
								] 
						] 
				],
	...
	protected function _getClassMethods() {
		...
		$methods [] = [ 
				...
				'docblock' => [ 
						...
						'tags' => [ 
								[ 
										'name' => 'param',
										'description' => 'string $methodName' 
								],
								[ 
										'name' => 'param',
										'description' => 'array $methodArguments' 
								],
								[ 
										'name' => 'return',
										'description' => 'mixed' 
		...
		foreach ( $publicMethods as $method ) {
			if (! ($method->isConstructor () || $method->isFinal () || $method->isStatic () || $method->isDestructor ()) && ! in_array ( $method->getName (), [ 
					'__sleep',
					'__wakeup',
					'__clone' 
			] )) {
	...
	protected function _validateData() {
		...
		if ($result) {
			...
			if ($resultClassName !== $sourceClassName . '\\Logger') {
				$this->_addError ( 'Invalid Logger class name [' . $resultClassName . ']. Use ' . $sourceClassName . '\\Logger' );
				$result = false;
			}
		}
		return $result;

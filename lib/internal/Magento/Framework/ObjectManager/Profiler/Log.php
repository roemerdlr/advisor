...
class Log {
	...
	public function display() {
		...
		echo '<table border="1" cellspacing="0" cellpadding="2">', '<thead><tr><th>', "Creation chain (Red items are never used) Total: {$this->stats['total']}\n", "Used: {$this->stats['used']} Not used: {$this->stats['unused']}", '</th></tr></thead>', '<tbody>', '<tr><th>Instance class</th></tr>';

...
class PlaceholderTest extends \PHPUnit_Framework_TestCase {
	 ...
	 *        	The arguments supplying values for the placeholders
	 * @param string $result
	 *        	The result of Phrase rendering
	 *        	
	 *        	@dataProvider renderPlaceholderDataProvider
	 */
	public function testRenderPlaceholder($text, array $arguments, $result) {
		$this->assertEquals ( $result, $this->_renderer->render ( [ 
				$text 
		], $arguments ) );
	}

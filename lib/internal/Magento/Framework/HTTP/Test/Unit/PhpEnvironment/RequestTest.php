...
class RequestTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetCookie() {
		...
		$this->cookieReader->expects ( $this->once () )->method ( 'getCookie' )->with ( $key, $default );
	...
	public function testGetCookieDefault() {
		...
		$this->cookieReader->expects ( $this->once () )->method ( 'getCookie' )->with ( $key, $default )->will ( $this->returnValue ( $default ) );
	...
	public function testGetCookieNameExists() {
		...
		$this->cookieReader->expects ( $this->once () )->method ( 'getCookie' )->with ( $key, $default )->will ( $this->returnValue ( $value ) );
	...
	public function testGetCookieNullName() {
		...
		$this->cookieReader->expects ( $this->once () )->method ( 'getCookie' )->with ( $nullKey, $default )->will ( $this->returnValue ( $default ) );

...
class HeaderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_converter = $this->getMock ( '\Magento\Framework\Stdlib\StringUtils', [ 
				'cleanString' 
		] );
	}

	...
	public function sendResponse() {
		try {
			...
			if ($e instanceof \Magento\Framework\Webapi\Exception) {
				...
				$httpCode = $e->getHttpCode () == \Magento\Framework\Webapi\Exception::HTTP_NOT_ACCEPTABLE ? \Magento\Framework\Webapi\Exception::HTTP_NOT_ACCEPTABLE : \Magento\Framework\Webapi\Exception::HTTP_INTERNAL_ERROR;
			} else {

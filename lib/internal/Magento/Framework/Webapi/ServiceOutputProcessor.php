...
class ServiceOutputProcessor implements ServicePayloadConverterInterface {
	 ...
	 */
	public function __construct(DataObjectProcessor $dataObjectProcessor, MethodsMap $methodsMapProcessor) {
	...
	public function convertValue($data, $type) {
		if (is_array ( $data )) {
			...
			return $this->processDataObject ( $this->dataObjectProcessor->buildOutputDataArray ( $data, $type ) );
		} elseif ($data === null) {
			return [ ];
		} else {
			/**

...
class Exception extends LocalizedException {
	 ...
	 * @param string $name
	 *        	Exception name
	 * @param \Magento\Framework\Exception\LocalizedException[]|null $errors
	 *        	Array of errors messages
	 * @param string $stackTrace        	
	 *
	 * @throws \InvalidArgumentException
	 */
	public function __construct(Phrase $phrase, $code = 0, $httpCode = self::HTTP_BAD_REQUEST, array $details = [], $name = '', $errors = null, $stackTrace = null) {
		/**
		 * Only HTTP error codes are allowed.
		 * No success or redirect codes must be used.
		 */

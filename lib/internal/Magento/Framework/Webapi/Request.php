...
class Request extends HttpRequest implements RequestInterface {
	 ...
	 */
	public function __construct(CookieReaderInterface $cookieReader, StringUtils $converter, AreaList $areaList, ScopeInterface $configScope, $uri = null) {
	...
	/**
	 *
	 * {@inheritdoc} Added CGI environment support.
	 */
	 ...
	 *
	 * @param string $param
	 *        	eg <pre> testModule1AllSoapAndRestV1,testModule2AllSoapNoRestV1 </pre>

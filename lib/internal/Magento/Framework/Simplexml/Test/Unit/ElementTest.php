...
XML;
	...
	public function testAppendChild() {
		...
		$appendXml = simplexml_load_string ( '<node_a attr="abc"><node_b innerAttribute="xyz">text</node_b></node_a>', 'Magento\Framework\Simplexml\Element' );

...
class DataTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->reader = $this->getMockBuilder ( 'Magento\\Framework\\Config\\ReaderInterface' )->disableOriginalConstructor ()->getMock ();
		$this->cache = $this->getMockBuilder ( 'Magento\\Framework\\Config\\CacheInterface' )->disableOriginalConstructor ()->getMock ();

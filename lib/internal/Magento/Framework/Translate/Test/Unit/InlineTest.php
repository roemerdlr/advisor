...
class InlineTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->scopeResolverMock = $this->getMock ( 'Magento\Framework\App\ScopeResolverInterface', [ ], [ ], '', false );
		...
		$this->configMock = $this->getMock ( 'Magento\Framework\Translate\Inline\ConfigInterface', [ ], [ ], '', false );
		$this->parserMock = $this->getMock ( 'Magento\Framework\Translate\Inline\ParserInterface', [ ], [ ], '', false );
		$this->stateMock = $this->getMock ( 'Magento\Framework\Translate\Inline\StateInterface', [ ], [ ], '', false );
	}
	...
	public function testProcessResponseBody($scope, $body, $expected) {
		...
		$this->parserMock->expects ( $this->exactly ( $jsonCall ) )->method ( 'setIsJson' )->will ( $this->returnValueMap ( [ 
				[ 
						$isJson,
						$this->returnSelf () 
				],

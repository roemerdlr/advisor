...
class ExtensibleDataObjectConverterTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->processor = $this->getMockBuilder ( 'Magento\Framework\Reflection\DataObjectProcessor' )->disableOriginalConstructor ()->getMock ();
		
		$this->dataObject = $this->getMockBuilder ( 'Magento\Framework\Api\ExtensibleDataInterface' )->getMock ();
		
		$objectManager = new ObjectManager ( $this );
		$this->converter = $objectManager->getObject ( 'Magento\Framework\Api\ExtensibleDataObjectConverter', [ 
	...
	public function testToNestedArray() {
		...
		$this->assertEquals ( $dataArray, $this->converter->toNestedArray ( $this->dataObject ) );
	}
	...
	public function testToNestedArrayCustom() {
		...
		$this->assertEquals ( $resultArray, $this->converter->toNestedArray ( $this->dataObject, [ 

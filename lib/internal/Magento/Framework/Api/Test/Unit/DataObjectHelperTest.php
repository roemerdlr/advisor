...
class DataObjectHelperTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->joinProcessorMock = $this->getMockBuilder ( '\Magento\Framework\Api\ExtensionAttribute\JoinProcessor' )->setMethods ( [ 
		...
		$this->dataObjectHelper = $this->objectManager->getObject ( 'Magento\Framework\Api\DataObjectHelper', [ 
	...
	public function testPopulateWithArrayWithSimpleAttributes() {
		...
		$addressDataObject = $this->objectManager->getObject ( 'Magento\Customer\Model\Data\Address', [ 
				'dataObjectHelper' => $this->dataObjectHelper 
		] );
		
		/** @var \Magento\Customer\Model\Data\Region $regionDataObject */
		$regionDataObject = $this->objectManager->getObject ( 'Magento\Customer\Model\Data\Region', [ 
				'dataObjectHelper' => $this->dataObjectHelper 
		] );
		$data = [ 
				'id' => $id,
		...
		$this->methodsMapProcessor->expects ( $this->at ( 0 ) )->method ( 'getMethodReturnType' )->with ( '\Magento\Customer\Api\Data\AddressInterface', 'getStreet' )->willReturn ( 'string[]' );
		$this->methodsMapProcessor->expects ( $this->at ( 1 ) )->method ( 'getMethodReturnType' )->with ( '\Magento\Customer\Api\Data\AddressInterface', 'getRegion' )->willReturn ( '\Magento\Customer\Api\Data\RegionInterface' );
		$this->objectFactoryMock->expects ( $this->once () )->method ( 'create' )->with ( '\Magento\Customer\Api\Data\RegionInterface', [ ] )->willReturn ( $regionDataObject );
	...
	public function testPopulateWithArrayWithCustomAttribute() {
		...
		$metadataServiceMock->expects ( $this->once () )->method ( 'getCustomAttributesMetadata' )->with ( 'Magento\Customer\Model\Data\Address' )->willReturn ( [ 
	...
	public function testMergeDataObjects($data1, $data2) {
		/** @var \Magento\Customer\Model\Data\Address $addressDataObject */
		$firstAddressDataObject = $this->objectManager->getObject ( 'Magento\Customer\Model\Data\Address', [ 
				'dataObjectHelper' => $this->dataObjectHelper 
		] );
		
		/** @var \Magento\Customer\Model\Data\Region $regionDataObject */
		$firstRegionDataObject = $this->objectManager->getObject ( 'Magento\Customer\Model\Data\Region', [ 
				'dataObjectHelper' => $this->dataObjectHelper 
		] );
		...
		$secondAddressDataObject = $this->objectManager->getObject ( 'Magento\Customer\Model\Data\Address', [ 
				'dataObjectHelper' => $this->dataObjectHelper 
		] );
		
		/** @var \Magento\Customer\Model\Data\Region $regionDataObject */
		$secondRegionDataObject = $this->objectManager->getObject ( 'Magento\Customer\Model\Data\Region', [ 
				'dataObjectHelper' => $this->dataObjectHelper 
		] );

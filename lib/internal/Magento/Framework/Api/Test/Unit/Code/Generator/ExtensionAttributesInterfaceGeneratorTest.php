...
class ExtensionAttributesInterfaceGeneratorTest extends \PHPUnit_Framework_TestCase {
	public function testGenerate() {
		...
		$configMock = $this->getMockBuilder ( 'Magento\Framework\Api\ExtensionAttribute\Config' )->disableOriginalConstructor ()->getMock ();
		$configMock->expects ( $this->any () )->method ( 'get' )->willReturn ( [ 
		...
		$model = $objectManager->getObject ( 'Magento\Framework\Api\Code\Generator\ExtensionAttributesInterfaceGenerator', [ 
				'config' => $configMock,
	...
	public function testValidateException() {
		...
		$this->assertTrue ( in_array ( 'Invalid extension interface name [\Magento\Catalog\Api\Data\ProductInterface].' . ' Use \Magento\Catalog\Api\Data\ProductExtensionInterface', $model->getErrors () ), 'Expected validation error message is missing.' );
	}
}

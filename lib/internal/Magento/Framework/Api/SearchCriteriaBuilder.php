...
class SearchCriteriaBuilder extends AbstractSimpleObjectBuilder {
	 ...
	 */
	public function __construct(ObjectFactory $objectFactory, FilterGroupBuilder $filterGroupBuilder, FilterBuilder $filterBuilder) {
	...
	public function addFilter($field, $value, $conditionType = 'eq') {
		$this->addFilters ( [ 
				$this->filterBuilder->setField ( $field )->setValue ( $value )->setConditionType ( $conditionType )->create () 
		] );
		return $this;
	}

...
class SimpleDataObjectConverter {
	 ...
	 * @param bool $removeItemNode
	 *        	Remove Item node from arrays if true
	 * @return array
	 * @throws \InvalidArgumentException @SuppressWarnings(PHPMD.NPathComplexity)

...
class PluginListTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = new \Magento\Framework\Interception\PluginList\PluginList ( $readerMock, $this->_configScopeMock, $this->_cacheMock, new \Magento\Framework\ObjectManager\Relations\Runtime (), $omConfigMock, new \Magento\Framework\Interception\Definition\Runtime (), $this->_objectManagerMock, $definitions, [ 
				'global' 
		], 'interception' );
	}
	public function testGetPlugin() {
		...
		$this->assertEquals ( 'Magento\Framework\Interception\Test\Unit\Custom\Module\Model\ItemPlugin\Simple', $this->_model->getPlugin ( 'Magento\Framework\Interception\Test\Unit\Custom\Module\Model\Item', 'simple_plugin' ) );
		$this->assertEquals ( 'Magento\Framework\Interception\Test\Unit\Custom\Module\Model\ItemPlugin\Advanced', $this->_model->getPlugin ( 'Magento\Framework\Interception\Test\Unit\Custom\Module\Model\Item', 'advanced_plugin' ) );
		$this->assertEquals ( 'Magento\Framework\Interception\Test\Unit\Custom\Module\Model\ItemContainerPlugin\Simple', $this->_model->getPlugin ( 'Magento\Framework\Interception\Test\Unit\Custom\Module\Model\ItemContainer', 'simple_plugin' ) );
		$this->assertEquals ( 'Magento\Framework\Interception\Test\Unit\Custom\Module\Model\StartingBackslash\Plugin', $this->_model->getPlugin ( 'Magento\Framework\Interception\Test\Unit\Custom\Module\Model\StartingBackslash', 'simple_plugin' ) );
	}
	...
	public function testGetPlugins($expectedResult, $type, $method, $scopeCode, $code = '__self') {
		$this->_configScopeMock->expects ( $this->any () )->method ( 'getCurrentScope' )->will ( $this->returnValue ( $scopeCode ) );
	...
	public function testInheritPluginsWithNonExistingClass() {
		$this->_configScopeMock->expects ( $this->any () )->method ( 'getCurrentScope' )->will ( $this->returnValue ( 'frontend' ) );

...
class InterfaceValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testValidate() {
		$this->model->validate ( '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\ItemPlugin\ValidPlugin', '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\ItemWithArguments' );
	}
	...
	public function testValidateIncorrectInterface() {
		$this->model->validate ( '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\ItemPlugin\IncompatibleInterface', '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\Item' );
	}
	...
	public function testValidateIncorrectSubjectType() {
		$this->model->validate ( '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\ItemPlugin\IncorrectSubject', '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\Item' );
	}
	
	/**
	 * @expectedException \Magento\Framework\Exception\ValidatorException
	 * @expectedExceptionMessage Invalid method signature.
	 * Invalid method parameters count
	 * @covers \Magento\Framework\Interception\Code\InterfaceValidator::validate
	...
	public function testValidateIncompatibleMethodArgumentsCount() {
		$this->model->validate ( '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model' . '\InterfaceValidator\ItemPlugin\IncompatibleArgumentsCount', '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\Item' );
	}
	...
	public function testValidateIncompatibleMethodArgumentsType() {
		$this->model->validate ( '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model' . '\InterfaceValidator\ItemPlugin\IncompatibleArgumentsType', '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\ItemWithArguments' );
	}
	
	/**
	 * @expectedException \Magento\Framework\Exception\ValidatorException
	 * @expectedExceptionMessage Invalid method signature.
	 * Detected extra parameters
	 * @covers \Magento\Framework\Interception\Code\InterfaceValidator::validate
	 */
	public function testValidateExtraParameters() {
		$this->model->validate ( '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\ItemPlugin\ExtraParameters', '\Magento\Framework\Interception\Test\Unit\Custom\Module\Model\InterfaceValidator\Item' );
	}

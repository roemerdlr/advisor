...
class Title {
	 ...
	 */
	public function __construct(App\Config\ScopeConfigInterface $scopeConfig) {
	...
	protected function build($withConfigValues = true) {
		return array_merge ( $this->prependedValues, [ 
	...
	protected function addConfigValues($title) {
		$preparedTitle = $this->scopeConfig->getValue ( 'design/head/title_prefix', \Magento\Store\Model\ScopeInterface::SCOPE_STORE ) . ' ' . $title . ' ' . $this->scopeConfig->getValue ( 'design/head/title_suffix', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
	...
	public function getDefault() {
		$defaultTitle = $this->scopeConfig->getValue ( 'design/head/default_title', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );

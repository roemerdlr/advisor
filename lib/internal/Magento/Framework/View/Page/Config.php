...
class Config {
	...
	public function getMediaType() {
		...
		if (empty ( $this->metadata ['media_type'] )) {
			$this->metadata ['media_type'] = $this->scopeConfig->getValue ( 'design/head/default_media_type', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
		}
	...
	public function getCharset() {
		...
		if (empty ( $this->metadata ['charset'] )) {
			$this->metadata ['charset'] = $this->scopeConfig->getValue ( 'design/head/default_charset', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
		}
	...
	public function getDescription() {
		...
		if (empty ( $this->metadata ['description'] )) {
			$this->metadata ['description'] = $this->scopeConfig->getValue ( 'design/head/default_description', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
		}
	...
	public function getKeywords() {
		...
		if (empty ( $this->metadata ['keywords'] )) {
			$this->metadata ['keywords'] = $this->scopeConfig->getValue ( 'design/head/default_keywords', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
		}
	...
	public function getRobots() {
		...
		if (empty ( $this->metadata ['robots'] )) {
			$this->metadata ['robots'] = $this->scopeConfig->getValue ( 'design/search_engine_robots/default_robots', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
		}
	...
	public function addRss($title, $href) {
		...
		$this->pageAssets->add ( "link/{$href}", $remoteAsset, [ 
	...
	public function addBodyClass($className) {
		...
		$this->setElementAttribute ( self::ELEMENT_TYPE_BODY, self::BODY_ATTRIBUTE_CLASS, implode ( ' ', $bodyClasses ) );
		return $this;
	}
	...
	public function setElementAttribute($elementType, $attribute, $value) {
		...
		if (array_search ( $elementType, $this->allowedTypes ) === false) {
			throw new \Magento\Framework\Exception\LocalizedException ( new \Magento\Framework\Phrase ( '%1 isn\'t allowed', [ 
					$elementType 
			] ) );
		}
	...
	public function getIncludes() {
		if (empty ( $this->includes )) {
			$this->includes = $this->scopeConfig->getValue ( 'design/head/includes', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
		}

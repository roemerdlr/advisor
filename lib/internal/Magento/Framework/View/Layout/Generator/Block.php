...
class Block implements Layout\GeneratorInterface {
	...
	protected function getBlockInstance($block, array $arguments = []) {
		...
		if (! $block instanceof \Magento\Framework\View\Element\AbstractBlock) {
			throw new \Magento\Framework\Exception\LocalizedException ( new \Magento\Framework\Phrase ( 'Invalid block type: %1', [ 
					$block 
			] ) );
		}
		return $block;

...
class Builder implements BuilderInterface {
	...
	protected function loadLayoutUpdates() {
		...
		$this->eventManager->dispatch ( 'layout_load_before', [ 
	...
	protected function generateLayoutBlocks() {
		...
		$this->eventManager->dispatch ( 'layout_generate_blocks_before', [ 
				'full_action_name' => $this->request->getFullActionName (),
				'layout' => $this->layout 
		] );
		...
		$this->eventManager->dispatch ( 'layout_generate_blocks_after', [ 
				'full_action_name' => $this->request->getFullActionName (),
				'layout' => $this->layout 
		] );
		Profiler::stop ( 'LAYOUT' );

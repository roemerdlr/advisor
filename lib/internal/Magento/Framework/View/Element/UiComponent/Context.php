...
class Context implements ContextInterface {
	 ...
	 */
	public function __construct(PageLayoutInterface $pageLayout, RequestInterface $request, ButtonProviderFactory $buttonProviderFactory, ActionPoolFactory $actionPoolFactory, ContentTypeFactory $contentTypeFactory, UrlInterface $urlBuilder, Processor $processor, DataProviderInterface $dataProvider = null, $namespace = null) {
	...
	public function getDataSourceData(UiComponentInterface $component) {
		...
		return [ 
				$this->getDataProvider ()->getName () => [ 
						...
						'config' => array_replace_recursive ( array_merge ( $dataSource, $dataProviderConfig ), [ 
								'params' => [ 

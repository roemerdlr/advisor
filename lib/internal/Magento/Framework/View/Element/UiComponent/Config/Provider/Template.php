...
class Template {
	 ...
	 */
	public function __construct(AggregatedFileCollector $aggregatedFileCollector, DomMergerInterface $domMerger, CacheInterface $cache, ReaderFactory $readerFactory, AggregatedFileCollectorFactory $aggregatedFileCollectorFactory) {

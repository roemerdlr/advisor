...
class Redirect extends Template {
	 ...
	 * @param array $data        	
	 */
	public function __construct(Template\Context $context, \Magento\Framework\Data\FormFactory $formFactory, array $data = []) {
	...
	protected function _getDefaultHtml() {
		...
		if (! $this->isHtmlFormRedirect ()) {
			$html .= '<p>' . ( string ) new \Magento\Framework\Phrase ( 'Click <a href="%1">here</a> if nothing has happened', [ 
					$this->getTargetURL () 
			] ) . '</p>';
		}

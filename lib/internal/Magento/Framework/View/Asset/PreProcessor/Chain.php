...
class Chain {
	 ...
	 */
	public function __construct(LocalInterface $asset, $origContent, $origContentType, $origAssetPath) {
		$this->asset = $asset;
	...
	public function assertValid() {
		if ($this->contentType !== $this->targetContentType) {
			throw new \LogicException ( "The requested asset type was '{$this->targetContentType}', but ended up with '{$this->contentType}'" );
		}
	}

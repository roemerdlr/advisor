...
class AlternativeSource implements AlternativeSourceInterface {
	 ...
	 */
	public function __construct(FilenameResolverInterface $filenameResolver, ObjectManagerInterface $objectManager, LockerProcessInterface $lockerProcess, Helper\SortInterface $sorter, AssetBuilder $assetBuilder, $lockName, array $alternatives = []) {

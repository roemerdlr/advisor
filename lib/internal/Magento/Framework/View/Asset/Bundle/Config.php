...
class Config implements Bundle\ConfigInterface {
	 ...
	 */
	public function __construct(View\ConfigInterface $viewConfig, ListInterface $themeList) {
	...
	public function getConfig(FallbackContext $assetContext) {
		return $this->viewConfig->getViewConfig ( [ 
				...
				'themeModel' => $this->themeList->getThemeByFullPath ( $assetContext->getAreaCode () . '/' . $assetContext->getThemePath () ) 
		] );
	}

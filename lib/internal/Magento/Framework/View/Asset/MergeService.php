...
class MergeService {
	 ...
	 */
	public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, ConfigInterface $config, \Magento\Framework\Filesystem $filesystem, \Magento\Framework\App\State $state) {
	...
	public function getMergedAssets(array $assets, $contentType) {
		...
		if (($isCss && $isCssMergeEnabled) || ($isJs && $isJsMergeEnabled)) {
			...
			$assets = $this->objectManager->create ( 'Magento\Framework\View\Asset\Merged', [ 
					'assets' => $assets,

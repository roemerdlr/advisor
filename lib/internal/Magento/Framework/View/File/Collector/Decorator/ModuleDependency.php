...
class ModuleDependency implements CollectorInterface {
	 ...
	 */
	public function __construct(CollectorInterface $subject, ModuleListInterface $listInterface) {
	...
	/**
	 * Compare view files according to the priority of modules they belong to.
	 * To be used as a callback for sorting.
	 *
	 * @param File $fileOne        	
	 * @param File $fileTwo        	
	 * @return int

...
class DataSourcePoolTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->blockFactory = $this->getMockBuilder ( 'Magento\Framework\View\Element\BlockFactory' )->disableOriginalConstructor ()->getMock ();
	...
	public function testAssignAndGetNamespaceData() {
		...
		$this->assertEquals ( [ 
				'alias' => $block 
		], $this->dataSourcePool->getNamespaceData ( $namespace ) );

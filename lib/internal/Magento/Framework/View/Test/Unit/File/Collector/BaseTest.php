...
class BaseTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->themeMock = $this->getMockBuilder ( 'Magento\Framework\View\Design\ThemeInterface' )->setMethods ( [ 
				'getData' 
		] )->getMockForAbstractClass ();
		
		$this->dirSearch = $this->getMock ( 'Magento\Framework\Component\DirSearch', [ ], [ ], '', false );
		
		$this->fileCollector = new \Magento\Framework\View\File\Collector\Base ( $this->dirSearch, $this->fileFactoryMock, 'layout' );
	}
	public function testGetFiles() {
		...
		$this->dirSearch->expects ( $this->any () )->method ( 'collectFilesWithContext' )->willReturnMap ( [ 
				[ 
	...
	protected function createFileMock() {
		return $this->getMockBuilder ( 'Magento\Framework\View\File' )->disableOriginalConstructor ()->getMock ();
	}
}

...
class FileTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetSourceFile() {
		$this->source->expects ( $this->once () )->method ( 'getFile' )->with ( $this->object )->will ( $this->returnValue ( 'result' ) );
	...
	public function testGetContentNotFound() {
		$this->source->expects ( $this->once () )->method ( 'getContent' )->with ( $this->object )->will ( $this->returnValue ( false ) );

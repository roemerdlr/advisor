...
class VariableTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->context = $this->getMock ( '\Magento\Framework\View\Asset\File\Context', null, [ 
				$baseUrl,
	...
	public function convertVariableNotationDataProvider() {
		return [ 
				[ 
						'{{base_url_path}}/file.ext',
						'http://example.com/pub/static/frontend/Magento/blank/en_US/file.ext' 
				] 
		];
	}
}

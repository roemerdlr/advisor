...
class MinificationTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->minification = new Minification ( $this->scopeConfigMock, $this->appStateMock );
	}
	 ...
	 * @param string $filename        	
	 * @param bool $result        	
	 * @return void @dataProvider isMinifiedFilenameDataProvider
	 */
	public function testIsMinifiedFilename($filename, $result) {
		$this->assertEquals ( $result, $this->minification->isMinifiedFilename ( $filename ) );
	}

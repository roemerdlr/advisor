...
class ConfigTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->config = $this->objectManagerHelper->getObject ( 'Magento\Framework\View\Config', [ 
	...
	public function testGetViewConfig() {
		...
		$themeMock->expects ( $this->atLeastOnce () )->method ( 'getCode' )->will ( $this->returnValue ( 2 ) );
		$params = [ 
		...
		$this->viewConfigFactoryMock->expects ( $this->once () )->method ( 'create' )->willReturn ( $configViewMock );

...
class ContextTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetModuleName() {
		...
		$this->request->expects ( $this->once () )->method ( 'getModuleName' )->will ( $this->returnValue ( $moduleName ) );
	...
	public function testGetQuery() {
		...
		$this->request->expects ( $this->once () )->method ( 'getPost' )->with ( $key, $default )->will ( $this->returnValue ( $queryValue ) );
	...
	public function testGetParam() {
		...
		$this->request->expects ( $this->once () )->method ( 'getParam' )->with ( $key, $default )->will ( $this->returnValue ( $paramValue ) );
	...
	public function testGetParams() {
		...
		$this->request->expects ( $this->once () )->method ( 'getParams' )->will ( $this->returnValue ( $params ) );
	...
	public function testGetHeader() {
		...
		$this->request->expects ( $this->once () )->method ( 'getHeader' )->with ( $headerName )->will ( $this->returnValue ( $headerValue ) );
	...
	public function testContent() {
		...
		$this->request->expects ( $this->once () )->method ( 'getContent' )->will ( $this->returnValue ( $content ) );

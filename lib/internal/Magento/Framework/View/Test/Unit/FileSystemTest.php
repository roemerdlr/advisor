...
class FileSystemTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_fileResolution = $this->getMock ( 'Magento\Framework\View\Design\FileResolution\Fallback\File', [ ], [ ], '', false );
		$this->_templateFileResolution = $this->getMock ( 'Magento\Framework\View\Design\FileResolution\Fallback\TemplateFile', [ ], [ ], '', false );
		$this->_localeFileResolution = $this->getMock ( 'Magento\Framework\View\Design\FileResolution\Fallback\LocaleFile', [ ], [ ], '', false );
		$this->_staticFileResolution = $this->getMock ( 'Magento\Framework\View\Design\FileResolution\Fallback\StaticFile', [ ], [ ], '', false );
		$this->_emailTemplateFileResolution = $this->getMock ( 'Magento\Framework\View\Design\FileResolution\Fallback\EmailTemplateFile', [ ], [ ], '', false );
		...
		$this->_model = new \Magento\Framework\View\FileSystem ( $this->_fileResolution, $this->_templateFileResolution, $this->_localeFileResolution, $this->_staticFileResolution, $this->_emailTemplateFileResolution, $this->_assetRepo );
	}
	public function testGetFilename() {
		$params = [ 
				'area' => 'some_area',
				'themeModel' => $this->getMock ( 'Magento\Framework\View\Design\ThemeInterface', [ ], [ ], '', false, false ),
				'module' => 'Some_Module' 
		] // It should be set in \Magento\Framework\View\Asset\Repository::extractScope

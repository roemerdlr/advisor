...
class AbstractFileTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_fileFactory = $this->getMock ( 'Magento\Framework\View\Design\Theme\FileFactory', [ 
				'create' 
		], [ ], '', false );
		$this->_filesystem = $this->getMock ( 'Magento\Framework\Filesystem', [ ], [ ], '', false );
		
		$this->_modelBuilder = $this->getMockBuilder ( 'Magento\Framework\View\Design\Theme\Customization\AbstractFile' )->setMethods ( [ 
				'getType',
				'getContentType' 
		] )->setConstructorArgs ( [ 
	...
	public function testGetFullPath() {
		...
		$this->_customizationPath->expects ( $this->once () )->method ( 'getCustomizationPath' )->will ( $this->returnValue ( '/path' ) );
	...
	public function testSave() {
		$model = $this->_modelBuilder->setMethods ( [ 
				'getFullPath',
				'getType',
				'getContentType' 
		] )->getMock ();

...
class PathTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = new \Magento\Framework\View\Design\Theme\Customization\Path ( $filesystem, $this->componentRegistrar );
	}
	...
	public function testGetCustomizationPath() {
		...
		$this->_theme->expects ( $this->exactly ( 2 ) )->method ( 'getId' )->will ( $this->returnValue ( 123 ) );

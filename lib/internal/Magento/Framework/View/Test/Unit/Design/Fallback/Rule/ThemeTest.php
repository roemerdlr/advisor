...
class ThemeTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetPatternDirs() {
		...
		$this->componentRegistrar->expects ( $this->any () )->method ( 'getPath' )->will ( $this->returnValueMap ( [ 
				[ 
						ComponentRegistrar::THEME,
						'package/parent_theme',
						'/path/to/parent/theme' 
				],
				[ 
						ComponentRegistrar::THEME,
						'package/current_theme',
		...
		$this->assertEquals ( $expectedResult, $this->model->getPatternDirs ( [ 
				'theme' => $theme 
		] ) );
	}
}

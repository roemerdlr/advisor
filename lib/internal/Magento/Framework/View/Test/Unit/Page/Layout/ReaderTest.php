...
class ReaderTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->processorInterface = $this->getMock ( 'Magento\Framework\View\Layout\ProcessorInterface', [ ], [ ], '', false );
		$this->themeInterface = $this->getMock ( 'Magento\Framework\View\Design\ThemeInterface', [ ], [ ], '', false );
		$this->processorFactory = $this->getMock ( 'Magento\Framework\View\Layout\ProcessorFactory', [ 
				'create' 
		], [ ], '', false );
		$this->themeResolver = $this->getMock ( 'Magento\Framework\View\Design\Theme\ResolverInterface', [ ], [ ], '', false );
		$this->pageLayoutFileSource = $this->getMockBuilder ( 'Magento\Framework\View\File\CollectorInterface' )->getMock ();
		$this->readerPool = $this->getMockBuilder ( 'Magento\Framework\View\Layout\ReaderPool' )->disableOriginalConstructor ()->getMock ();
		$this->readerContext = $this->getMockBuilder ( 'Magento\Framework\View\Layout\Reader\Context' )->setMethods ( [ 

...
class BodyTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->bodyGenerator = $objectManagerHelper->getObject ( 'Magento\Framework\View\Page\Config\Generator\Body', [ 
	...
	public function testProcess() {
		...
		$this->pageConfigMock->expects ( $this->exactly ( 2 ) )->method ( 'addBodyClass' )->withConsecutive ( [ 
				'class_1' 
		], [ 
				'class_2' 
		] );

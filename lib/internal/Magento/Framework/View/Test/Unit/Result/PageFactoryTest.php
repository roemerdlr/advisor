...
class PageFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->pageFactory = $this->objectManagerHelper->getObject ( 'Magento\Framework\View\Result\PageFactory', [ 
				'objectManager' => $this->objectManagerMock 
		] );
		$this->page = $this->getMockBuilder ( 'Magento\Framework\View\Result\Page' )->disableOriginalConstructor ()->getMock ();
	}
	public function testCreate() {
		$this->objectManagerMock->expects ( $this->once () )->method ( 'create' )->with ( 'Magento\Framework\View\Result\Page' )->will ( $this->returnValue ( $this->page ) );

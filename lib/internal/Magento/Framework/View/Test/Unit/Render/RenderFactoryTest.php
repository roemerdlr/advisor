...
class RenderFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->renderFactory = $this->objectManagerHelper->getObject ( 'Magento\Framework\View\Render\RenderFactory', [ 
	...
	public function testGet() {
		...
		$this->objectManagerMock->expects ( $this->once () )->method ( 'get' )->with ( $this->equalTo ( 'Magento\Framework\View\Render\RenderInterface' ) )->will ( $this->returnValue ( $renderMock ) );
	...
	public function testGetException() {
		$this->objectManagerMock->expects ( $this->once () )->method ( 'get' )->with ( $this->equalTo ( 'Magento\Framework\View\Render\RenderInterface' ) )->will ( $this->returnValue ( new \stdClass () ) );

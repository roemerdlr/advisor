...
class ContainerTest extends \PHPUnit_Framework_TestCase {
	...
	public function testProcess($structureElements, $setAttributeData, $setAttributeCalls) {
		...
		$this->structureMock->expects ( $this->exactly ( $setAttributeCalls ) )->method ( 'setAttribute' )->will ( $this->returnValueMap ( $setAttributeData ) );
		...
		return [ 
				'sample_data' => [ 
						...
						'setAttributeData' => [ 
								...
								[ 
										'first_container',
										Container::CONTAINER_OPT_HTML_TAG,
										'dd' 
								],
								[ 
										'first_container',
										Container::CONTAINER_OPT_HTML_CLASS,
										'dd_class' 
								],
								[ 
										'first_container',
										Container::CONTAINER_OPT_HTML_ID,
										'dd_id' 
								] 
						],
						'setAttributeCalls' => 4 

...
class ScheduledStructureTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->model = $helperObjectManager->getObject ( 'Magento\Framework\View\Layout\ScheduledStructure', [ 
	...
	public function testGetElementToMove() {
		$this->assertEquals ( $this->scheduledData ['scheduledMoves'] ['element1'], $this->model->getElementToMove ( 'element1' ) );
		$default = [ 
				'some',
				'data' 
		];
	...
	public function getIfconfigElement() {
		$this->assertEquals ( $this->scheduledData ['scheduledIfconfig'] ['element1'], $this->model->getIfconfigElement ( 'element1' ) );
		$default = [ 
				'some',
				'data' 
		];

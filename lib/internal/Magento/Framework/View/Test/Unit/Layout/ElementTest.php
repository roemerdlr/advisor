...
class ElementTest extends \PHPUnit_Framework_TestCase {
	...
	public function cacheableDataProvider() {
		return [ 
				...
				[ 
						'<block name="name" cacheable="false" />',
						false 
				],
				[ 
						'<block name ="bl1"><block name="bl2" /></block>',
						true 
				],
				[ 
						'<block name ="bl1"><block name="bl2" cacheable="false"/></block>',
						false 
				],
				[ 
						'<block name="name" />',

...
class GeneratorPoolTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->structureMock = $this->getMockBuilder ( 'Magento\Framework\View\Layout\Data\Structure' )->disableOriginalConstructor ()->setMethods ( [ 
				'reorderChildElement' 
		] )->getMock ();
		...
		$this->model = $helperObjectManager->getObject ( 'Magento\Framework\View\Layout\GeneratorPool', [ 

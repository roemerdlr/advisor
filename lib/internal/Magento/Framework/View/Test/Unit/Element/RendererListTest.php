...
class RendererListTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->blockMock = $this->getMockBuilder ( 'Magento\Framework\View\Element\AbstractBlock' )->setMethods ( [ 
				'setRenderedBlock',
				'getTemplate',
				'setTemplate' 
		...
		$this->contextMock = $this->getMockBuilder ( 'Magento\Framework\View\Element\Context' )->setMethods ( [ 
				'getLayout' 
		] )->disableOriginalConstructor ()->getMock ();
		
		$this->contextMock->expects ( $this->any () )->method ( 'getLayout' )->will ( $this->returnValue ( $this->layoutMock ) );
		
		$this->renderList = $objectManagerHelper->getObject ( 'Magento\Framework\View\Element\RendererList', [ 
	...
	public function testGetRendererWithException() {
		$this->assertInstanceOf ( '\Magento\Framework\View\Element\BlockInterface', $this->renderList->getRenderer ( null ) );
	}
}

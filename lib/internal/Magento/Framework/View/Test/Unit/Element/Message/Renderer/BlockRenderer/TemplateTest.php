...
class TemplateTest extends \PHPUnit_Framework_TestCase {
	public function testGetCacheKeyInfo() {
		...
		$storeManager->expects ( static::once () )->method ( 'getStore' )->willReturn ( $storeMock );
		
		/** @var Template $template */
		$template = $helper->getObject ( 'Magento\Framework\View\Element\Message\Renderer\BlockRenderer\Template', [ 
		...
		$storeMock->expects ( static::once () )->method ( 'getCode' )->willReturn ( 'GB' );

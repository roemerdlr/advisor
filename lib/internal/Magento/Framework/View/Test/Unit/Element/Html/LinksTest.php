...
class LinksTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetLinks() {
		...
		$name = 'test_name';
		$this->context->getLayout ()->expects ( $this->once () )->method ( 'getChildBlocks' )->with ( $name )->willReturn ( $blocks );
	...
	public function testSetActive() {
		...
		$name = 'test_name';
		$this->context->getLayout ()->expects ( $this->once () )->method ( 'getChildBlocks' )->with ( $name )->willReturn ( [ 
				$link 
		] );

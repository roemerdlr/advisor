...
class PhpTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * Test the render() function with a very simple .
	 * phtml file.
	 *
	 * Note: the call() function will be covered because simple.phtml has a call to the block.
	 */
	public function testRender() {
		$blockMock = $this->getMockBuilder ( 'Magento\Framework\View\Element\Template' )->setMethods ( [ 
				'testMethod' 
	...
	public function testHelperWithInvalidClass() {
		...
		$this->_helperFactoryMock->expects ( $this->once () )->method ( 'get' )->with ( $class )->will ( $this->returnValue ( $object ) );

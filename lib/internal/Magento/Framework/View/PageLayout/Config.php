...
class Config extends \Magento\Framework\Config\AbstractXml {
	 ...
	 */
	public function __construct($configFiles, \Magento\Framework\Config\DomFactory $domFactory, \Magento\Framework\Config\Dom\UrnResolver $urnResolver) {
	...
	protected function _getInitialXml() {
		return '<?xml version="1.0" encoding="UTF-8"?>' . '<page_layouts xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"></page_layouts>';
	}

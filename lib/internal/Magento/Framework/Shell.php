...
class Shell implements ShellInterface {
	 ...
	 *        	Logger instance to be used to log commands and their output
	 */
	public function __construct(CommandRendererInterface $commandRenderer, \Zend_Log $logger = null) {
		$this->logger = $logger;
	 ...
	 *        	Command with optional argument markers '%s'
	 * @param string[] $arguments
	 *        	Argument values to substitute markers with

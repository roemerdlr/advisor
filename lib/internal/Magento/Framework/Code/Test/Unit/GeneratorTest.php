...
class GeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->ioObjectMock = $this->getMockBuilder ( '\Magento\Framework\Code\Generator\Io' )->disableOriginalConstructor ()->getMock ();
		$this->model = $this->buildModel ( $this->ioObjectMock, [ 
	...
	public function testGenerateClassWithWrongName() {
		$this->assertEquals ( \Magento\Framework\Code\Generator::GENERATION_ERROR, $this->model->generateClass ( self::SOURCE_CLASS ) );
	}

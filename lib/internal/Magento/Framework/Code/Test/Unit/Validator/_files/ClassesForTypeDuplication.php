...
class ValidClassWithTheSameInterfaceTypeArguments {
	 ...
	 */
	public function __construct(ArgumentInterface $argumentOne, ArgumentClassOne $argumentTwo, ArgumentInterface $argumentThree) {
...
class ValidClassWithSubTypeArguments {
	 ...
	 * @param ArgumentInterface $argumentThree        	
	 */
	public function __construct(ArgumentBaseClass $argumentOne, ArgumentClassOne $argumentTwo, ArgumentInterface $argumentThree) {
		$this->argumentOne = $argumentOne;
		$this->argumentTwo = $argumentTwo;
		$this->argumentThree = $argumentThree;
	}
...
class ValidClassWithSuppressWarnings {
	 ...
	 */
	public function __construct(ArgumentBaseClass $argumentOne, ArgumentBaseClass $argumentTwo, ArgumentInterface $argumentThree) {
		$this->argumentOne = $argumentOne;
		$this->argumentTwo = $argumentTwo;
		$this->argumentThree = $argumentThree;
	}

...
class ContextAggregationTest extends \PHPUnit_Framework_TestCase {
	...
	public function testClassArgumentAlreadyInjectedIntoContext() {
		$message = 'Incorrect dependency in class ClassArgumentAlreadyInjectedInContext in ' . $this->_fixturePath . PHP_EOL . '\ClassFirst already exists in context object';
	...
	public function testClassArgumentWithAlreadyInjectedInterface() {
		$message = 'Incorrect dependency in class ClassArgumentWithAlreadyInjectedInterface in ' . $this->_fixturePath . PHP_EOL . '\\InterfaceFirst already exists in context object';

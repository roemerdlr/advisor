...
class DataObject implements \ArrayAccess {
	 ...
	 *
	 * @param array $keys
	 *        	array of keys that must be represented
	 * @param string $rootName
	 *        	root node name
	 * @param bool $addOpenTag
	 *        	flag that allow to add initial xml node
	 * @param bool $addCdata
	 *        	flag that require wrap all values in CDATA
	 * @return string
	 */
	...
	public function __call($method, $args) {
		...
		throw new \Magento\Framework\Exception\LocalizedException ( new \Magento\Framework\Phrase ( 'Invalid method %1::%2(%3)', [ 
				get_class ( $this ),
				$method,
				print_r ( $args, 1 ) 
		] ) );

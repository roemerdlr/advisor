...
class ResourceFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = $helper->getObject ( 'Magento\Framework\Acl\AclResourceFactory', [ 
	...
	public function testCreateResource() {
		...
		$this->_objectManager->expects ( $this->once () )->method ( 'create' )->with ( 'Magento\Framework\Acl\AclResource', $arguments )->will ( $this->returnValue ( $this->_expectedObject ) );

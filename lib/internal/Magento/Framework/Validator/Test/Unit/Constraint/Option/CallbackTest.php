...
class CallbackTest extends \PHPUnit_Framework_TestCase {
	...
	public function getConfigDataProvider() {
		...
		$mock = $this->getMockBuilder ( 'Foo' )->setMethods ( [ 
				'getValue' 
		] )->getMock ();
		$mock->expects ( $this->once () )->method ( 'getValue' )->with ( 'arg1', 'arg2' )->will ( $this->returnValue ( 'Value from mock' ) );
	...
	public function testSetArguments($value, $expectedValue) {
		$option = new \Magento\Framework\Validator\Constraint\Option\Callback ( function () {
		} );

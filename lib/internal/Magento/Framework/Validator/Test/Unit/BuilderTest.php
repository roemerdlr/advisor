...
class BuilderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCreateValidator(array $constraints, $expectedValidator) {
		...
		$builder = $this->_objectManager->getObject ( 'Magento\Framework\Validator\Builder', [ 
	...
	public function createValidatorDataProvider() {
				...
				[ 
						...
						'options' => [ 
								'arguments' => [ 
										'options' => [ 
												'min' => 1,
												'max' => new \Magento\Framework\Validator\Constraint\Option ( 20 ) 
										] 
								] 
						],
						'property' => 'name',
		...
		$expectedValidator->addValidator ( new \Magento\Framework\Validator\Constraint\Property ( new \Magento\Framework\Validator\Test\Unit\Test\StringLength ( 1, 20 ), 'name', 'name_alias' ) );
		...
		$expectedValidator = new \Magento\Framework\Validator ();
		$expectedValidator->addValidator ( new \Magento\Framework\Validator\Constraint\Property ( new \Magento\Framework\Validator\Test\Unit\Test\StringLength ( 10, 1000 ), 'description', 'description_alias' ) );
		...
		$actualConstraints = [ 
				[ 
						...
						'options' => [ 
								'callback' => [ 
										new \Magento\Framework\Validator\Constraint\Option\Callback ( function ($validator) {
											$validator->setMin ( 20 );
		...
		$expectedValidator = new \Magento\Framework\Validator ();
		$expectedValidator->addValidator ( new \Magento\Framework\Validator\Constraint\Property ( new \Magento\Framework\Validator\Test\Unit\Test\StringLength ( 20, 100 ), 'sku', 'sku_alias' ) );
	...
	public function configurationDataProvider() {
		$callback = new \Magento\Framework\Validator\Constraint\Option\Callback ( [ 
				'Magento\Framework\Validator\Test\Unit\Test\Callback',
				'getId' 
		] );
		$someMethod = [ 
				'method' => 'getMessages' 
		...
		return [ 
				...
				'constraint options initialized with method' => [ 
						...
						$someMethod,
						[ 
								$this->_getExpectedConstraints ( $emptyConstraint, 'methods', [ 
										$someMethod 
								] ) 
						] 
				],
				'constraint options initialized with callback' => [ 
						...
						$callbackConfig,
						[ 
								$this->_getExpectedConstraints ( $emptyConstraint, 'callback', [ 
										$callback 
								] ) 
						] 
				],
				...
				'methods initialized' => [ 
						...
						$methodWithArgs,
						[ 
								$this->_getExpectedConstraints ( $constraintWithArgs, 'methods', [ 
										$methodWithArgs 
								] ) 
						] 
				],
				'method added' => [ 
						...
						$methodWithArgs,
						[ 
								$this->_getExpectedConstraints ( $configuredConstraint, 'methods', [ 
										$someMethod,
										$methodWithArgs 
								] ) 
						] 
				...
				'callback initialized' => [ 
						...
						$callbackConfig,
						[ 
								$this->_getExpectedConstraints ( $constraintWithArgs, 'callback', [ 
										$callback 
								] ) 
						] 
				],
				'callback added' => [ 
						...
						$callbackConfig,
						[ 
								$this->_getExpectedConstraints ( $configuredConstraint, 'callback', [ 
										$callback,
										$callback 
								] ) 
						] 
	...
	public function testConstructorConfigValidation(array $options, $exception, $exceptionMessage) {
		...
		$this->_objectManager->getObject ( 'Magento\Framework\Validator\Builder', [ 
				'constraints' => $constraints 
		] );
	}
	...
	public function testCreateValidatorInvalidInstance() {
		$this->setExpectedException ( 'InvalidArgumentException', 'Constraint class "StdClass" must implement \Magento\Framework\Validator\ValidatorInterface' );
		$builder = $this->_objectManager->getObject ( 'Magento\Framework\Validator\Builder', [ 
				'constraints' => [ 
						[ 
								'alias' => 'alias',

...
class ConfigTest extends \PHPUnit_Framework_TestCase {
	...
	protected function _initConfig(array $files = null) {
		...
		$urnResolverMock->expects ( $this->any () )->method ( 'getRealPath' )->with ( 'urn:magento:framework:Validator/etc/validation.xsd' )->willReturn ( $this->urnResolver->getRealPath ( 'urn:magento:framework:Validator/etc/validation.xsd' ) );
		...
		$this->_config = $this->_objectManager->getObject ( 'Magento\Framework\Validator\Config', [ 
	...
	public function testCreateValidatorInvalidConstraintClass() {
		...
		$this->_initConfig ( [ 
				__DIR__ . '/_files/validation/negative/invalid_constraint.xml' 
		] );
	...
	public function testGetValidatorBuilderClassNotFound() {
		$this->_initConfig ( [ 
				__DIR__ . '/_files/validation/negative/invalid_builder_class.xml' 
		] );
	...
	public function testGetValidatorBuilderInstanceInvalid() {
		$this->_initConfig ( [ 
				__DIR__ . '/_files/validation/negative/invalid_builder_instance.xml' 
		] );
		$this->_config->createValidatorBuilder ( 'catalog_product', 'create' );
	}
	...
	public function testBuilderConfiguration() {
		...
		$this->_initConfig ( [ 
				__DIR__ . '/_files/validation/positive/builder/validation.xml' 
		] );
	...
	public function testGetSchemaFile() {
		$this->_initConfig ();
		$this->assertEquals ( $this->urnResolver->getRealPath ( 'urn:magento:framework:Validator/etc/validation.xsd' ), $this->_config->getSchemaFile () );

...
class Config extends \Magento\Framework\Config\AbstractXml {
	...
	public function createValidatorBuilder($entityName, $groupName, array $builderConfig = null) {
		...
		$builder = $this->_builderFactory->create ( $builderClass, [ 
	...
	protected function _extractEntityGroupsConstraintsData(\DOMElement $entity) {
		...
		foreach ( $entity->getElementsByTagName ( 'group' ) as $group ) {
			...
			$result [$group->getAttribute ( 'name' )] = [ 
	...
	protected function _getInitialXml() {
		return '<?xml version="1.0" encoding="UTF-8"?>' . '<validation xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"></validation>';
	}

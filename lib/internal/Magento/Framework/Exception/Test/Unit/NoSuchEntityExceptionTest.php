...
class NoSuchEntityExceptionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->rendererMock = $this->getMockBuilder ( 'Magento\Framework\Phrase\Renderer\Placeholder' )->setMethods ( [ 
				'render' 
	 ...
	 * @return void @dataProvider constantsDataProvider
	 */
	public function testConstants($message, $expectedMessage) {
		...
		$exception = new NoSuchEntityException ( new Phrase ( $message, [ 
				'consumer_id' => 1,
				'resources' => 'record2' 
		] ) );
	...
	public function testSingleField() {
		$fieldName = 'storeId';
		$fieldValue = 15;
		$this->assertSame ( "No such entity with $fieldName = $fieldValue", NoSuchEntityException::singleField ( $fieldName, $fieldValue )->getMessage () );
	}

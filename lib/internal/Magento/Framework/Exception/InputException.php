...
class InputException extends AbstractAggregateException {
	 ...
	 *        	Name of the field which had an invalid value provided.
	 * @param string $fieldValue
	 *        	The invalid value that was provided for the field.
	 * @param \Exception $cause
	 *        	Cause of the InputException
	...
	public static function invalidFieldValue($fieldName, $fieldValue, \Exception $cause = null) {
		return new self ( new Phrase ( self::INVALID_FIELD_VALUE, [ 
				'fieldName' => $fieldName,
				'value' => $fieldValue 
		] ), $cause );
	}
	...
	public static function requiredField($fieldName) {
		return new self ( new Phrase ( self::REQUIRED_FIELD, [ 
				'fieldName' => $fieldName 
		] ) );
	}
}

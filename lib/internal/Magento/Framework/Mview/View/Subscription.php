...
class Subscription implements SubscriptionInterface {
	 ...
	 */
	public function __construct(ResourceConnection $resource, \Magento\Framework\DB\Ddl\TriggerFactory $triggerFactory, \Magento\Framework\Mview\View\CollectionInterface $viewCollection, \Magento\Framework\Mview\ViewInterface $view, $tableName, $columnName) {
	...
	public function create() {
		foreach ( Trigger::getListOfEvents () as $event ) {
			...
			/** @var Trigger $trigger */
			$trigger = $this->triggerFactory->create ()->setName ( $triggerName )->setTime ( Trigger::TIME_AFTER )->setEvent ( $event )->setTable ( $this->resource->getTableName ( $this->tableName ) );
	 ...
	 *
	 * @param string $event
	 *        	The DB level event, like "update" or "insert"
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @return \Magento\Framework\Mview\ViewInterface @codeCoverageIgnore
	 */

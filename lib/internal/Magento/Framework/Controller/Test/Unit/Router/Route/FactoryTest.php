...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->factory = $objectManager->getObject ( 'Magento\Framework\Controller\Router\Route\Factory', [ 
	...
	public function testCreateRoute() {
		...
		$router = $this->getMockBuilder ( 'Magento\Framework\App\RouterInterface' )->setMockClassName ( $routeClass )->getMock ();
		
		$this->objectManager->expects ( $this->once () )->method ( 'create' )->with ( $routeClass, [ 
				'route' => $paramRoute 

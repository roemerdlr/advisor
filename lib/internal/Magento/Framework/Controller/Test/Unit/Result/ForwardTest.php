...
class ForwardTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->requestInterface = $this->getMockBuilder ( 'Magento\Framework\App\Request\Http' )->disableOriginalConstructor ()->getMock ();
		$this->forward = $this->objectManagerHelper->getObject ( 'Magento\Framework\Controller\Result\Forward', [ 
	...
	public function testSetController() {
		...
		$this->assertInstanceOf ( 'Magento\Framework\Controller\Result\Forward', $this->forward->setController ( $controller ) );
	}
	public function testSetParams() {
		...
		$this->assertInstanceOf ( 'Magento\Framework\Controller\Result\Forward', $this->forward->setParams ( $params ) );
	}

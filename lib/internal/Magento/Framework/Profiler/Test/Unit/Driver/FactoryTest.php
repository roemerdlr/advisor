...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_factory = new \Magento\Framework\Profiler\Driver\Factory ( $this->_defaultDriverPrefix, $this->_defaultDriverType );
	}
	...
	public function createDataProvider() {
		$defaultDriverClass = $this->getMockClass ( 'Magento\Framework\Profiler\DriverInterface', [ ], [ ], 'Magento_Framework_Profiler_Driver_Test_Default' );
		$testDriverClass = $this->getMockClass ( 'Magento\Framework\Profiler\DriverInterface', [ ], [ ], 'Magento_Framework_Profiler_Driver_Test_Test' );
		return [ 
	...
	public function testCreateUndefinedClass() {
		$this->setExpectedException ( 'InvalidArgumentException', 'Cannot create profiler driver, class "Magento_Framework_Profiler_Driver_Test_Baz" doesn\'t exist.' );

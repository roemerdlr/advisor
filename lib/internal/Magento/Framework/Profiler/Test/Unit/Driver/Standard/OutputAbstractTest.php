...
class OutputAbstractTest extends \PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$output = $this->getMockForAbstractClass ( 'Magento\Framework\Profiler\Driver\Standard\AbstractOutput', [ 
				$configuration 
		] );
	...
	public function renderColumnValueDataProvider() {
		return [ 
				[ 
						'someTimerId',
						\Magento\Framework\Profiler\Driver\Standard\Stat::ID,
						'someTimerId' 
				],
				[ 
						10000.123,
						\Magento\Framework\Profiler\Driver\Standard\Stat::TIME,
						'10,000.123000' 
				],
				[ 
						200000.123456789,
				...
				[ 
						1000000000.12345678,
						\Magento\Framework\Profiler\Driver\Standard\Stat::EMALLOC,
						'1,000,000,000' 
				],
				[ 
						2000000000.12345678,
						\Magento\Framework\Profiler\Driver\Standard\Stat::REALMEM,
						'2,000,000,000' 
				] 
		];
	}
	...
	public function testRenderCaption() {
		...
		$method->setAccessible ( true );
		$this->assertRegExp ( '/Code Profiler \(Memory usage: real - \d+, emalloc - \d+\)/', $method->invoke ( $this->_output ) );
	}

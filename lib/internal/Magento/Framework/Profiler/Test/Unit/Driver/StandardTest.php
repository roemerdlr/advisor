...
class StandardTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_driver = new \Magento\Framework\Profiler\Driver\Standard ( [ 
				'stat' => $this->_stat 
		] );
	}
	...
	public function testInitOutputs() {
		...
		$outputFactory->expects ( $this->at ( 0 ) )->method ( 'create' )->with ( [ 
				'baseDir' => '/custom/base/dir',
				'type' => 'outputTypeOne' 
		] )->will ( $this->returnValue ( $outputOne ) );
		
		$outputFactory->expects ( $this->at ( 1 ) )->method ( 'create' )->with ( [ 
				'type' => 'specificOutputTypeTwo',
				'baseDir' => '/base/dir' 

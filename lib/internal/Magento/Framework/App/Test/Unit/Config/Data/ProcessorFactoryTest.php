...
class ProcessorFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetModelWithCorrectInterface() {
		...
		$this->assertInstanceOf ( 'Magento\Framework\App\Config\Data\ProcessorInterface', $this->_model->get ( 'Magento\Framework\App\Config\Data\TestBackendModel' ) );
	}
	...
	public function testGetModelWithWrongInterface() {
		$this->_objectManager->expects ( $this->once () )->method ( 'create' )->with ( 'Magento\Framework\App\Config\Data\WrongBackendModel' )->will ( $this->returnValue ( $this->getMock ( 'Magento\Framework\App\Config\Data\WrongBackendModel', [ ], [ ], '', false ) ) );

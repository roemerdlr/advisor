...
class MetadataProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_modelPoolMock = $this->getMock ( 'Magento\Framework\App\Config\Data\ProcessorFactory', [ ], [ ], '', false );
		...
		$this->_initialConfigMock->expects ( $this->any () )->method ( 'getMetadata' )->will ( $this->returnValue ( [ 
				'some/config/path' => [ 
						'backendModel' => 'Custom_Backend_Model' 
				] 
		] ) );

...
class InitialTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		$this->_initialReaderMock = $this->getMock ( 'Magento\Framework\App\Config\Initial\Reader', [ ], [ ], '', false );
		$this->_configCacheMock = $this->getMock ( 'Magento\Framework\App\Cache\Type\Config', [ ], [ ], '', false );
		...
		$this->_configCacheMock->expects ( $this->any () )->method ( 'load' )->with ( 'initial_config' )->will ( $this->returnValue ( $serializedData ) );

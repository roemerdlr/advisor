...
class CopyTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPublishFile() {
		...
		$rootDir->expects ( $this->once () )->method ( 'copyFile' )->with ( $sourcePath, $destinationPath, $targetDir )->willReturn ( true );
		
		$this->assertTrue ( $this->copyPublisher->publishFile ( $rootDir, $targetDir, $sourcePath, $destinationPath ) );
	}
	public function testIsSupported() {
		$asset = $this->getMockBuilder ( 'Magento\Framework\View\Asset\LocalInterface' )->getMock ();

...
class ReaderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_schemaLocatorMock = $this->getMock ( 'Magento\Framework\App\ResourceConnection\Config\SchemaLocator', [ ], [ ], '', false );
		
		$this->_converterMock = $this->getMock ( 'Magento\Framework\App\ResourceConnection\Config\Converter', [ ], [ ], '', false );
		
		$this->_configLocalMock = $this->getMock ( 'Magento\Framework\App\DeploymentConfig', [ ], [ ], '', false );
		
		$this->_model = new \Magento\Framework\App\ResourceConnection\Config\Reader ( $this->_fileResolverMock, $this->_converterMock, $this->_schemaLocatorMock, $this->_validationStateMock, $this->_configLocalMock );
	}
	public function testRead() {
		...
		$this->_fileResolverMock->expects ( $this->once () )->method ( 'get' )->will ( $this->returnValue ( [ 

...
class FormKeyTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->formKey = new FormKey ( $this->cookieManagerMock, $this->cookieMetadataFactory, $this->sessionManager );
	}
	public function testGet() {
		...
		// Verification
		$this->cookieManagerMock->expects ( $this->once () )->method ( 'getCookie' )->with ( FormKey::COOKIE_NAME )->will ( $this->returnValue ( $formKey ) );
	...
	public function testSet() {
		...
		$this->cookieManagerMock->expects ( static::once () )->method ( 'setPublicCookie' )->with ( FormKey::COOKIE_NAME, $formKeyValue, $metadata );

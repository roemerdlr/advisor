...
class ActionTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->pageConfigMock = $this->getMock ( 'Magento\Framework\View\Page\Config', [ 
				'getConfig' 
		], [ ], '', false );
		...
		$this->action = $this->objectManagerHelper->getObject ( 'Magento\Framework\App\Test\Unit\Action\ActionFake', [ 
...
class ActionFake extends Action {
	...
	public function execute() {
		$this->_forward ( ActionTest::ACTION_NAME, ActionTest::CONTROLLER_NAME, ActionTest::MODULE_NAME, ActionTest::$actionParams );

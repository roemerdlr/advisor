...
class AbstractActionTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->redirect = $this->getMockBuilder ( 'Magento\Framework\Controller\Result\Redirect' )->setMethods ( [ 
				'setRefererOrBaseUrl' 
		] )->disableOriginalConstructor ()->getMock ();
		$this->redirectFactory = $this->getMockBuilder ( 'Magento\Backend\Model\View\Result\RedirectFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();

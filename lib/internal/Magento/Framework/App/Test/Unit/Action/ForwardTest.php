...
class ForwardTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$cookieMetadataFactoryMock = $this->getMockBuilder ( 'Magento\Framework\Stdlib\Cookie\CookieMetadataFactory' )->disableOriginalConstructor ()->getMock ();
		...
		$this->response = $objectManager->getObject ( 'Magento\Framework\App\Response\Http', [ 
		...
		$this->actionAbstract = $objectManager->getObject ( 'Magento\Framework\App\Action\Forward', [ 
	...
	/**
	 * Test for getResponse med.
	 * Checks that response headers are set correctly
	 *
	 * @test
	 * @covers \Magento\Framework\App\Action\AbstractAction::getResponse
	 */

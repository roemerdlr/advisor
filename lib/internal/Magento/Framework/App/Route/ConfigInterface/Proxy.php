...
class Proxy implements \Magento\Framework\App\Route\ConfigInterface {
	 ...
	 * @param bool $shared        	
	 */
	public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = 'Magento\Framework\App\Route\ConfigInterface', $shared = true) {

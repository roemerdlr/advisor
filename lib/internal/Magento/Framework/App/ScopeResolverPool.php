...
class ScopeResolverPool {
	 ...
	 */
	public function __construct(array $scopeResolvers) {
	...
	public function get($scopeType) {
		if (! isset ( $this->_scopeResolvers [$scopeType] ) || ! ($this->_scopeResolvers [$scopeType] instanceof \Magento\Framework\App\ScopeResolverInterface)) {

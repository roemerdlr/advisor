...
class Area implements \Magento\Framework\App\AreaInterface {
	 ...
	 */
	public function __construct(\Psr\Log\LoggerInterface $logger, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Framework\TranslateInterface $translator, \Magento\Framework\ObjectManagerInterface $objectManager, ConfigLoaderInterface $diConfigLoader, \Magento\Framework\App\DesignInterface $design, \Magento\Framework\App\ScopeResolverInterface $scopeResolver, \Magento\Framework\View\DesignExceptions $designExceptions, $areaCode) {
		$this->_code = $areaCode;
	...
	protected function _loadPart($part) {
		...
		\Magento\Framework\Profiler::start ( 'load_area:' . $this->_code . '.' . $part, [ 
				'group' => 'load_area',

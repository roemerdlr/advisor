...
class ProcessorFactory {
	 ...
	 *        	Classname of the instance to get
	...
	public function get($processorModel) {
		if (! isset ( $this->_pool [$processorModel] )) {
			...
			if (! $instance instanceof ProcessorInterface) {
				throw new \InvalidArgumentException ( $processorModel . ' is not instance of \Magento\Framework\App\Config\Data\ProcessorInterface' );
			}

...
class Http extends \Magento\Framework\HTTP\PhpEnvironment\Response {
	 ...
	 */
	public function __construct(HttpRequest $request, CookieManagerInterface $cookieManager, CookieMetadataFactory $cookieMetadataFactory, Context $context, DateTime $dateTime) {
	 ...
	 * @return \Magento\Framework\App\Response\Http @codeCoverageIgnore
	 */

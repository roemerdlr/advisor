...
class FileFactory {
	 ...
	 */
	public function __construct(\Magento\Framework\App\ResponseInterface $response, \Magento\Framework\Filesystem $filesystem) {
	 ...
	 * @return \Magento\Framework\App\ResponseInterface @SuppressWarnings(PHPMD.CyclomaticComplexity)

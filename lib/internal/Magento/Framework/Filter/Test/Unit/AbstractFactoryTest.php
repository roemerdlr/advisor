...
class AbstractFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->_factory = $this->getMockForAbstractClass ( 'Magento\Framework\Filter\AbstractFactory', [ 
	...
	public function isSharedDataProvider() {
		return [ 
				...
				'not shared' => [ 
						'Magento\Framework\Filter\ArrayFilter',
						false 
				],
				'default value' => [ 
	...
	public function testCreateFilter($alias, $arguments, $isShared) {
		...
		$this->_objectManager->expects ( $this->atLeastOnce () )->method ( 'create' )->with ( $this->equalTo ( $this->_invokableList [$alias] ), $this->equalTo ( $arguments ) )->will ( $this->returnValue ( $filterMock ) );

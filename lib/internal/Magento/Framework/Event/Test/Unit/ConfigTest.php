...
class ConfigTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->dataContainerMock = $this->getMock ( 'Magento\Framework\Event\Config\Data', [ 
				'get' 
		], [ ], '', false, false );
	...
	public function testGetObservers() {
		...
		$this->dataContainerMock->expects ( $this->once () )->method ( 'get' )->with ( $eventName, $this->equalTo ( [ ] ) )->will ( $this->returnValue ( $observers ) );

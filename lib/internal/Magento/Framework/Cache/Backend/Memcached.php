...
class Memcached extends \Zend_Cache_Backend_Memcached implements \Zend_Cache_Backend_ExtendedInterface {
	 ...
	 *        	Main data's ID
	 * @param int $index
	 *        	Particular chunk number to return ID for
	 * @return string
	 */
	...
	/**
	 * Remove saved chunks in case something gone wrong (e.g.
	 * some chunk from the chain can not be found)
	 *
	 * @param string $id
	 *        	ID of data's info cell
	 * @param int $chunks
	 *        	Number of chunks to remove (basically, the number after '{splitted}|')
	 * @return null
	 */

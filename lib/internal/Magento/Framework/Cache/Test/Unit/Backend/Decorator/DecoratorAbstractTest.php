...
class DecoratorAbstractTest extends \PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$decorator = $this->getMockForAbstractClass ( 'Magento\Framework\Cache\Backend\Decorator\AbstractDecorator', [ 
				$options 
		] );
		...
		$optionsProperty = new \ReflectionProperty ( 'Magento\Framework\Cache\Backend\Decorator\AbstractDecorator', '_decoratorOptions' );
	...
	public function testConstructorException($options) {
		$this->getMockForAbstractClass ( 'Magento\Framework\Cache\Backend\Decorator\AbstractDecorator', [ 
				$options 
		] );
	}
	public function constructorExceptionDataProvider() {
		return [ 
				...
				'wrong_class' => [ 
						[ 
								'concrete_backend' => $this->getMock ( 'Test_Class' ) 
						] 
				] 
		];
	}

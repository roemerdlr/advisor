...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	 ...
	 */
	public function testIsValid($value, $validators, $expectedResult, $expectedMessages = [], $breakChainOnFailure = false) {
	...
	public function isValidDataProvider() {
		...
		$validatorA->expects ( $this->once () )->method ( 'getMessages' )->will ( $this->returnValue ( [ 
				'foo' => [ 
						'Foo message 1' 
				],
				'bar' => [ 
		...
		$validatorB->expects ( $this->once () )->method ( 'getMessages' )->will ( $this->returnValue ( [ 
				'foo' => [ 
						'Bar message 1' 
				],
				'bar' => [ 

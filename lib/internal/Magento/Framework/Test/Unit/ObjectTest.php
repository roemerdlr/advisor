	...
	public function testGetData() {
		$data = [ 
				...
				'key2' => [ 
						...
						'subkey2.3' => new \Magento\Framework\DataObject ( [ 
								'test_key' => 'test_value' 
						] ) 
				],
				'key3' => 5 
...
string',
	...
	public function testSetGetDataUsingMethod() {
		$mock = $this->getMock ( 'Magento\Framework\DataObject', [ 
				'setTestData',
				'getTestData' 
		] );
...
';
	...
	public function testToJson() {
		...
		$this->assertEquals ( '{"key1":"value1"}', $this->_object->toJson ( [ 
				'key1' 
		] ) );
		$this->assertEquals ( '{"key1":"value1","key":null}', $this->_object->convertToJson ( [ 
				'key1',
				'key' 
		] ) );
	}
	...
	public function testSerialize() {
		...
		$this->assertEquals ( 'key1:\'value1\'_key2:\'value2\'', $this->_object->serialize ( [ 
				'key',
				'key1',
				'key2' 
		], ':', '_', '\'' ) );

...
abstract class AbstractModel extends \Magento\Framework\DataObject {
	...
	public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\Model\ResourceModel\AbstractResource $resource = null, \Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = []) {
		...
		if (method_exists ( $this->_resource, 'getIdFieldName' ) || $this->_resource instanceof \Magento\Framework\DataObject) {
	...
	public function getResourceCollection() {
		if (empty ( $this->_resourceCollection ) && empty ( $this->_collectionName )) {
			throw new \Magento\Framework\Exception\LocalizedException ( new \Magento\Framework\Phrase ( 'Model collection resource name is not defined.' ) );
		}
		return $this->_resourceCollection ? clone $this->_resourceCollection : \Magento\Framework\App\ObjectManager::getInstance ()->create ( $this->_collectionName );
	}
	...
	protected function _afterLoad() {
		$this->_eventManager->dispatch ( 'model_load_after', [ 
				'object' => $this 
		] );
	...
	/**
	 * Object after load processing.
	 * Implemented as public interface for supporting objects after load in collections
	 *
	 * @return $this
	 */
	...
	public function afterCommitCallback() {
		$this->_eventManager->dispatch ( 'model_save_commit_after', [ 
				'object' => $this 
		] );
	...
	public function beforeSave() {
		...
		$this->_eventManager->dispatch ( 'model_save_before', [ 
				'object' => $this 
		] );
	...
	public function afterSave() {
		...
		$this->_eventManager->dispatch ( 'model_save_after', [ 
				'object' => $this 
		] );
		$this->_eventManager->dispatch ( 'clean_cache_by_tags', [ 
				'object' => $this 
		] );
	...
	public function beforeDelete() {
		...
		$this->_eventManager->dispatch ( 'model_delete_before', [ 
				'object' => $this 
		] );
	...
	public function afterDelete() {
		$this->_eventManager->dispatch ( 'model_delete_after', [ 
				'object' => $this 
		] );
		$this->_eventManager->dispatch ( 'clean_cache_by_tags', [ 
				'object' => $this 
	...
	public function afterDeleteCommit() {
		$this->_eventManager->dispatch ( 'model_delete_commit_after', [ 
				'object' => $this 
		] );

...
abstract class AbstractResource {
	...
	protected function _prepareTableValueForSave($value, $type) {
		...
		if ($type == 'decimal' || $type == 'numeric' || $type == 'float') {
			$value = \Magento\Framework\App\ObjectManager::getInstance ()->get ( 'Magento\Framework\Locale\FormatInterface' )->getNumber ( $value );
		}
		return $value;
	}
	...
	/**
	 * Prepare the list of entity fields that should be selected from DB.
	 * Apply filtration based on active fieldset.
	 *
	 * @param \Magento\Framework\Model\AbstractModel $object        	

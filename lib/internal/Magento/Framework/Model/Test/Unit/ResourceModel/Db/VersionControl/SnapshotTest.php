...
class SnapshotTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->entityMetadata = $this->getMock ( 'Magento\Framework\Model\ResourceModel\Db\VersionControl\Metadata', [ 
				'getFields' 
		], [ ], '', false );
		
		$this->entitySnapshot = $objectManager->getObject ( 'Magento\Framework\Model\ResourceModel\Db\VersionControl\Snapshot', [ 

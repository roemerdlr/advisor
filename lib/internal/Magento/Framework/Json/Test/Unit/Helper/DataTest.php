...
class DataTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->jsonDecoderMock = $this->getMockBuilder ( 'Magento\Framework\Json\DecoderInterface' )->disableOriginalConstructor ()->getMock ();
		$this->helper = $objectManager->getObject ( 'Magento\Framework\Json\Helper\Data', [ 

...
class MethodsMap {
	 ...
	 */
	public function __construct(\Magento\Framework\Cache\FrontendInterface $cache, TypeProcessor $typeProcessor, \Magento\Framework\Api\AttributeTypeResolverInterface $typeResolver, FieldNamer $fieldNamer) {
		$this->cache = $cache;
	...
	public function getMethodParams($serviceClassName, $serviceMethodName) {
		...
		$this->cache->save ( serialize ( $params ), $cacheId, [ 
				ReflectionCache::CACHE_TAG 
		] );
		return $params;
	}

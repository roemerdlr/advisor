...
class AttributeTypeResolverTest extends \PHPUnit_Framework_TestCase {
	...
	public function testResolveObjectTypeWithConfiguredAttribute() {
		...
		$this->typeProcessor->expects ( $this->once () )->method ( 'getArrayItemType' )->with ( '\Magento\Framework\DataObject' )->willReturn ( '\Magento\Framework\DataObject' );
	 ...
	 * Please note that namespace must be specified.
	 */

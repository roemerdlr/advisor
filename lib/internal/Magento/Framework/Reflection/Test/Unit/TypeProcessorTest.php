...
class TypeProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetTypesData() {
		$this->_typeProcessor->setTypeData ( 'typeA', [ 
				'dataA' 
		] );
		$this->_typeProcessor->setTypeData ( 'typeB', [ 
				'dataB' 
		] );
		$this->assertEquals ( [ 
				'typeA' => [ 
	...
	public function testSetTypesData() {
		$this->_typeProcessor->setTypeData ( 'typeC', [ 
				'dataC' 
		] );
		$this->assertEquals ( [ 
				'typeC' => [ 
	...
	public function testGetTypeData() {
		...
		$this->assertEquals ( [ 
				'dataA' 
		], $this->_typeProcessor->getTypeData ( 'typeA' ) );
	}
	...
	public function testTranslateTypeName() {
		$this->assertEquals ( 'TestModule1V1EntityItem', $this->_typeProcessor->translateTypeName ( '\Magento\TestModule1\Service\V1\Entity\Item' ) );
		$this->assertEquals ( 'TestModule3V1EntityParameter[]', $this->_typeProcessor->translateTypeName ( '\Magento\TestModule3\Service\V1\Entity\Parameter[]' ) );
	}
	 ...
	 * @expectedExceptionMessage Invalid type for value: "integer".
	 * Expected Type: "int[]".
	 */

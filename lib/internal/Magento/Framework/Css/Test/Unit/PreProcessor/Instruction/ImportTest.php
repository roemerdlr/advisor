...
class ImportTest extends \PHPUnit_Framework_TestCase {
	...
	public function testProcess($originalContent, $foundPath, $resolvedPath, $expectedContent) {
		...
		$this->notationResolver->expects ( $this->once () )->method ( 'convertModuleNotationToPath' )->with ( $this->asset, $foundPath )->will ( $this->returnValue ( $resolvedPath ) );
	...
	public function processDataProvider() {
		return [ 
				...
				'with single line comment' => [ 
						'@import (type) "some/file.css" media;' . PHP_EOL . '// @import (type) "unnecessary/file.css" media;',
						'some/file.css',
						'some/file.css',
						"@import (type) 'some/file.css' media;" . PHP_EOL 
				],
				'with multi line comment' => [ 
						'@import (type) "some/file.css" media;' . PHP_EOL . '/* @import (type) "unnecessary/file.css" media;' . PHP_EOL . '@import (type) "another/unnecessary/file.css" media; */',
						'some/file.css',
						'some/file.css',
						"@import (type) 'some/file.css' media;" . PHP_EOL 
				] 
	...
	public function testProcessNoImport() {
		...
		$this->notationResolver->expects ( $this->never () )->method ( 'convertModuleNotationToPath' );
		$this->object->process ( $chain );
		$this->assertEquals ( $expectedContent, $chain->getContent () );

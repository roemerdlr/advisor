...
class Validator implements ValidatorInterface {
	 ...
	 */
	public function __construct(\Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Framework\HTTP\PhpEnvironment\RemoteAddress $remoteAddress, $scopeType, array $skippedUserAgentList = []) {
	 ...
	 *
	 * @return bool
	 * @throws SessionException @SuppressWarnings(PHPMD.CyclomaticComplexity)
	 */
	protected function _validate() {
		...
		if ($this->_scopeConfig->getValue ( self::XML_PATH_USE_REMOTE_ADDR, $this->_scopeType ) && $sessionData [self::VALIDATOR_REMOTE_ADDR_KEY] != $validatorData [self::VALIDATOR_REMOTE_ADDR_KEY]) {
			throw new SessionException ( new Phrase ( 'Invalid session %1 value.', [ 

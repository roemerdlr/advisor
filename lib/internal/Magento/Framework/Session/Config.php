...
class Config implements ConfigInterface {
	...
	public function __construct(\Magento\Framework\ValidatorFactory $validatorFactory, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Framework\Stdlib\StringUtils $stringHelper, \Magento\Framework\App\RequestInterface $request, Filesystem $filesystem, DeploymentConfig $deploymentConfig, $scopeType, $lifetimePath = self::XML_PATH_COOKIE_LIFETIME) {
		...
		/**
		 * Cookie settings: lifetime, path, domain, httpOnly.
		 * These govern settings for the session cookie.
		 */
	...
	public function setCookieLifetime($cookieLifetime, $default = null) {
		$validator = $this->_validatorFactory->create ( [ ], 'Magento\Framework\Session\Config\Validator\CookieLifetimeValidator' );
	...
	public function setCookiePath($cookiePath, $default = null) {
		...
		$validator = $this->_validatorFactory->create ( [ ], 'Magento\Framework\Session\Config\Validator\CookiePathValidator' );

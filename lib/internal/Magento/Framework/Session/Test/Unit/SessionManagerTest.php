...
namespace Magento\Framework\Session\Test\Unit {
	...
	class SessionManagerTest extends \PHPUnit_Framework_TestCase {
		...
		public function setUp() {
			...
			$this->mockCookieMetadataFactory = $this->getMockBuilder ( 'Magento\Framework\Stdlib\Cookie\CookieMetadataFactory' )->disableOriginalConstructor ()->getMock ();
			...
			$this->sessionManager = $this->objectManager->getObject ( 'Magento\Framework\Session\SessionManager', $arguments );
		}

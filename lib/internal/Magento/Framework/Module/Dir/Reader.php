...
class Reader {
	 ...
	 */
	public function __construct(Dir $moduleDirs, ModuleListInterface $moduleList, FileIteratorFactory $fileIteratorFactory, Filesystem\Directory\ReadFactory $readFactory) {
	 ...
	 * @param string $moduleName        	
	 * @param string $type
	 *        	directory type (etc, controllers, locale etc)
	 * @param string $path        	
	 * @return void
	 */

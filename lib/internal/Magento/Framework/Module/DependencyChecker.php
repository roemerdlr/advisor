...
class DependencyChecker {
	 ...
	 *        	list of modules to be enabled/disabled
	 * @param string[] $enabledModules
	 *        	list of enabled modules assuming enable/disable succeeds
	 * @return array
	 */
	private function checkDependencyGraph($isEnable, $moduleNames, $enabledModules) {
		...
		foreach ( $moduleNames as $moduleName ) {
			...
			$modules = array_merge ( array_keys ( $this->fullModuleList ), $this->packageInfo->getNonExistingDependencies () );

...
class DbStatusValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->_model = new DbStatusValidator ( $this->_cacheMock, $this->dbVersionInfoMock );
	}
	public function testAroundDispatch() {
		...
		$this->moduleManager->expects ( $this->any () )->method ( 'isDbSchemaUpToDate' )->will ( $this->returnValueMap ( $returnMap ) );
		$this->moduleManager->expects ( $this->any () )->method ( 'isDbDataUpToDate' )->will ( $this->returnValueMap ( $returnMap ) );

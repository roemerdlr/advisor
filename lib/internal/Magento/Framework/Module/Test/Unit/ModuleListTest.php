...
class ModuleListTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetNames() {
		...
		$this->assertSame ( [ 
				'foo' 
		], $this->model->getNames () ); // second time to ensure config loader is called once
	}

...
class ScopeResolverTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->_object = $objectManager->getObject ( 'Magento\Framework\Url\ScopeResolver', [ 
	...
	public function testGetScope($scopeId) {
		...
		$this->scopeResolverMock->expects ( $this->at ( 0 ) )->method ( 'getScope' )->with ( $scopeId )->will ( $this->returnValue ( $scopeMock ) );

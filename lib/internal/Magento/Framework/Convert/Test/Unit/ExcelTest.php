...
class ExcelTest extends \PHPUnit_Framework_TestCase {
	...
	public function testConvert() {
		...
		$this->assertXmlStringEqualsXmlString ( file_get_contents ( $this->_getSampleOutputFile () ), $convert->convert () );
	}
	...
	public function testWrite() {
		...
		$this->assertXmlStringEqualsXmlString ( file_get_contents ( $this->_getSampleOutputFile () ), file_get_contents ( $file ) );
	}

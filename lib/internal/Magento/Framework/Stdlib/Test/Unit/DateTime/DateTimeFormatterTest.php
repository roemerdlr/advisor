...
class DateTimeFormatterTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->dateTimeFormatter = (new ObjectManager ( $this ))->getObject ( 'Magento\Framework\Stdlib\DateTime\DateTimeFormatter', [ 
	...
	public function dataProviderFormatObject() {
		...
		return [ 
				...
				[ 
						new \DateTime ( '2013-09-09 09:09:09 -01:00' ),
						null,
						null 
				],
				[ 
				...
				[ 
						\IntlCalendar::fromDateTime ( '2013-09-09 09:09:09 Europe/Madrid' ),
						\IntlDateFormatter::FULL,
						'es_ES' 
				],
				[ 
						\IntlCalendar::fromDateTime ( '2013-09-09 09:09:09 -01:00' ),
						null,
						null 
				],
				[ 

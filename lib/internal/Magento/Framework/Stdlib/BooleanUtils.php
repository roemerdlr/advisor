...
class BooleanUtils {
	 ...
	 */
	public function __construct(array $trueValues = [true, 1, 'true', '1'], array $falseValues = [false, 0, 'false', '0']) {
	...
	public function toBoolean($value) {
		...
		throw new \InvalidArgumentException ( 'Boolean value is expected, supported values: ' . var_export ( $allowedValues, true ) );
	}
}

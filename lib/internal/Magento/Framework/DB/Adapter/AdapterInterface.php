...
interface AdapterInterface {
	 ...
	 * @return \Magento\Framework\DB\Adapter\AdapterInterface @SuppressWarnings(PHPMD.ExcessiveParameterList)
	 */
	 ...
	 *
	 * @param string $tableName
	 *        	The table that is the subject of the trigger
	 * @param string $time

...
class QueryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->criteriaMock = $this->getMockForAbstractClass ( 'Magento\Framework\Api\CriteriaInterface', [ ], '', false, true, true, [ ] );
		$this->resourceMock = $this->getMockForAbstractClass ( 'Magento\Framework\Model\ResourceModel\Db\AbstractDb', [ ], '', false, true, true, [ 
				'getIdFieldName' 
		] );
		$this->fetchStmtMock = $this->getMock ( 'Zend_Db_Statement_Pdo', [ 
				'fetch' 
		], [ ], '', false );
		...
		$this->query = $objectManager->getObject ( 'Magento\Framework\DB\Query', [ 

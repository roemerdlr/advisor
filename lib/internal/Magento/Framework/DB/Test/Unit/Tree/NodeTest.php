...
class NodeTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @param
	 *        	$expectedException
	 * @param $expectedExceptionMessage @dataProvider
	 *        	constructorDataProvider
	 */
	public function testConstructorWithInvalidArgumentsThrowsException(array $data, $expectedException, $expectedExceptionMessage) {

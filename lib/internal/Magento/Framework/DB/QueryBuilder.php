...
class QueryBuilder {
	 ...
	 */
	public function __construct(\Magento\Framework\DB\MapperFactory $mapperFactory, \Magento\Framework\DB\QueryFactory $queryFactory) {
	...
	public function create() {
		...
		$query = $this->queryFactory->create ( 'Magento\Framework\DB\Query', [ 
				'select' => $select,

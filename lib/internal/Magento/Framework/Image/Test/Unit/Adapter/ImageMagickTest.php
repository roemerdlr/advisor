...
class ImageMagickTest extends \PHPUnit_Framework_TestCase {
	...
	public function setup() {
		...
		$this->filesystemMock->expects ( $this->once () )->method ( 'getDirectoryWrite' )->willReturn ( $this->writeMock );
		
		$this->imageMagic = $objectManager->getObject ( 'Magento\Framework\Image\Adapter\ImageMagick', [ 
	 ...
	 * @expectedExceptionMessage Unable to write file into directory product/cache.
	 * Access forbidden.
	 */

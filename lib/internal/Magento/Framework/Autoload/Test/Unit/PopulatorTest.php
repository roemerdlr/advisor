...
class PopulatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$this->mockDirectoryList = $this->getMockBuilder ( '\Magento\Framework\App\Filesystem\DirectoryList' )->disableOriginalConstructor ()->getMock ();
		
		$this->mockDirectoryList->expects ( $this->any () )->method ( 'getPath' )->willReturnArgument ( 0 );
	}
	public function testPopulateMappings() {
		...
		$mockAutoloader->expects ( $this->at ( 0 ) )->method ( 'addPsr4' )->with ( 'Magento\\', [ 
		...
		$mockAutoloader->expects ( $this->at ( 3 ) )->method ( 'addPsr0' )->with ( '', [ 

...
interface AutoloaderInterface {
	 ...
	 *        	The namespace prefix of the PSR-4 mapping
	 * @param string|array $paths
	 *        	The path or paths to look in for the given prefix
	 * @param bool $prepend
	 *        	Whether to append the given path or paths to the paths already associated with the prefix
	 * @return void
	 */
	 ...
	 *
	 * @param string $nsPrefix
	 *        	The namespace prefix of the PSR-0 mapping
	 * @param string|array $paths
	 *        	The path or paths to look in for the given prefix
	 * @param bool $prepend
	 *        	Whether to append the given path or paths to the paths already associated with the prefix

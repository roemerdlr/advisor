...
class RandomTest extends \PHPUnit_Framework_TestCase {
	...
	public function getRandomStringDataProvider() {
		return [ 
				...
				[ 
						20,
						\Magento\Framework\Math\Random::CHARS_LOWERS . \Magento\Framework\Math\Random::CHARS_UPPERS . \Magento\Framework\Math\Random::CHARS_DIGITS 
				] 
		];
	}

...
class PriceBoxTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->rendererPool = $this->getMockBuilder ( 'Magento\Framework\Pricing\Render\RendererPool' )->disableOriginalConstructor ()->setMethods ( [ 
				'createAmountRender' 
		] )->getMock ();
	...
	public function testGetPriceType() {
		...
		$this->saleable->expects ( $this->once () )->method ( 'getPriceInfo' )->will ( $this->returnValue ( $priceInfo ) );

...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->pricesMock = $this->getMock ( 'Magento\Framework\Pricing\Price\Collection', [ ], [ ], '', false );
		$this->saleableItemMock = $this->getMockForAbstractClass ( 'Magento\Framework\Pricing\SaleableInterface', [ ], '', false, true, true, [ 
				'getQty' 
		] );
		$this->priceInfoMock = $this->getMockForAbstractClass ( 'Magento\Framework\Pricing\PriceInfoInterface', [ ], '', false, true, true, [ ] );
		$this->types = [ 
				'default' => [ 
	...
	public function testCreate($typeId, $quantity, $infoClass, $prices) {
		...
		$this->objectManagerMock->expects ( $this->exactly ( 2 ) )->method ( 'create' )->will ( $this->returnValueMap ( [ 
				[ 
						$prices,
						[ 

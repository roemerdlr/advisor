...
class PoolTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		$adjustmentsData = [ 
				'adj1' => [ 
						'className' => 'adj1_class',
						'sortOrder' => 10 
				],
				'adj2' => [ 
						'className' => 'adj2_class',
						'sortOrder' => 20 
				],
				'adj3' => [ 
						'className' => 'adj3_class',
						'sortOrder' => 5 
				],
				'adj4' => [ 
						'className' => 'adj4_class',
						'sortOrder' => null 
				],
				'adj5' => [ 
						'className' => 'adj5_class' 
				] 
		];
		
		/** @var Factory|\PHPUnit_Framework_MockObject_MockObject $adjustmentFactory */
		$adjustmentFactory = $this->getMockBuilder ( 'Magento\Framework\Pricing\Adjustment\Factory' )->disableOriginalConstructor ()->setMethods ( [ 
				'create' 
		] )->getMock ();
		$adjustmentFactory->expects ( $this->any () )->method ( 'create' )->will ( $this->returnCallback ( function ($className, $data) {
	...
	public function getAdjustmentByCodeDataProvider() {
		return [ 
				...
				[ 
						'adj4',
						'adj4_class|' . \Magento\Framework\Pricing\Adjustment\Pool::DEFAULT_SORT_ORDER 
				],
				[ 
						'adj5',
						'adj5_class|' . \Magento\Framework\Pricing\Adjustment\Pool::DEFAULT_SORT_ORDER 
				] 
		];
	}

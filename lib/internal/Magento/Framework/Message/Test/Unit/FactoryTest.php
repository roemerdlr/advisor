...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->factory = new \Magento\Framework\Message\Factory ( $this->objectManagerMock );
	}
	...
	public function testCreateWithWrongInterfaceImplementation() {
		$this->setExpectedException ( '\InvalidArgumentException', 'Magento\Framework\Message\Error doesn\'t implement \Magento\Framework\Message\MessageInterface' );
		$messageMock = new \stdClass ();
		$type = 'error';
		$className = 'Magento\\Framework\\Message\\' . ucfirst ( $type );
		$this->objectManagerMock->expects ( $this->once () )->method ( 'create' )->with ( $className, [ 
				'text' => 'text' 

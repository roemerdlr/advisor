...
class Resolver implements ResolverInterface {
	 ...
	 * @param mixed $locale        	
	 */
	public function __construct(ScopeConfigInterface $scopeConfig, $defaultLocalePath, $scopeType, $locale = null) {
	...
	public function emulate($scopeId) {
		...
		if ($scopeId) {
			...
			$this->locale = $this->scopeConfig->getValue ( $this->getDefaultLocalePath (), $this->scopeType, $scopeId );
			$result = $this->locale;
		} else {

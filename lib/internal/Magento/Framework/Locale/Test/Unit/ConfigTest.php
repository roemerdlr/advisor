...
class ConfigTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetAllowedLocalesNoDataArray() {
		$this->configObject = (new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager ( $this ))->getObject ( 'Magento\Framework\Locale\Config' );
	...
	public function testGetAllowedLocalesGivenDataArray() {
		...
		$differences = array_diff ( array_unique ( array_merge ( $this::$allAllowedLocales, $this::$sampleAdditionalLocales ) ), $retrievedLocalesWithAdditions );
	...
	public function testGetAllowedCurrenciesGivenDataArray() {
		...
		$differences = array_diff ( array_unique ( array_merge ( $this::$allAllowedCurrencies, $this::$samplePresentCurrencies ) ), $retrievedCurrenciesWithAdditions );

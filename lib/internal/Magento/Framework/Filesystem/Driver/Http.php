...
class Http extends File {
	 ...
	 * @throws FileSystemException @SuppressWarnings(PHPMD.UnusedFormalParameter)
	 */
	...
	protected function open($hostname, $port) {
		...
		if ($result === false) {
			throw new FileSystemException ( new \Magento\Framework\Phrase ( 'Something went wrong while connecting to the host. Error#%1 - %2.', [ 
					$errorNumber,
					$errorMessage 
			] ) );
		}

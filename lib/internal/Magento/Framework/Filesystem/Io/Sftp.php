...
class Sftp extends AbstractIo {
	 ...
	 * @param string $dir        	
	 * @param int $mode
	 *        	ignored here; uses logged-in user's umask
	...
	public function rmdir($dir, $recursive = false) {
		if ($recursive) {
			...
			$no_errors = $no_errors && ($this->_connection->chdir ( $currentWorkingDir ) && $this->_connection->rmdir ( $dir ));
			return $no_errors;
		} else {
	 ...
	 * @param string $filename        	
	 * @param string $source
	 *        	string data or local file name
	 * @param int $mode
	 *        	ignored parameter
	 * @return bool
	 */
	 ...
	 * @param null $grep
	 *        	ignored parameter
	 * @return array @SuppressWarnings(PHPMD.ShortMethodName)

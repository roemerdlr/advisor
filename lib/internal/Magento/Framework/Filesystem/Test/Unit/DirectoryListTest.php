...
class DirectoryListTest extends \PHPUnit_Framework_TestCase {
	...
	public function validateDataProvider() {
		return [ 
				...
				[ 
						...
						'Missing required keys at: ' . DirectoryList::SYS_TMP 
				] 
		];
	}
	public function testGetters() {
		$customDirs = [ 
				DirectoryList::SYS_TMP => [ 
						DirectoryList::PATH => '/bar/dir',
						DirectoryList::URL_PATH => 'bar' 
				] 
		];
	...
	public function testUnknownType() {
		new DirectoryList ( '/root/dir', [ 
				'foo' => [ 
						DirectoryList::PATH => '/foo/dir' 
				] 
		] );
	}
	...
	public function getUrlPathDataProvider() {
		return [ 
				...
				[ 
						[ 
								DirectoryList::SYS_TMP => [ 
										DirectoryList::URL_PATH => 'url/path' 
								] 
						],
						'url/path' 
				] 
	...
	public function testFilterPath() {
		$object = new DirectoryList ( '/root/dir', [ 
				DirectoryList::SYS_TMP => [ 
						DirectoryList::PATH => 'C:\Windows\Tmp' 
				] 
		] );

...
class Request {
	...
	public function prepareRequest($httpRequest) {
		$oauthParams = $this->_processRequest ( $httpRequest->getHeader ( 'Authorization' ), $httpRequest->getHeader ( \Zend_Http_Client::CONTENT_TYPE ), $httpRequest->getContent (), $this->getRequestUrl ( $httpRequest ) );
		return $oauthParams;
	}
	 ...
	 * @return array merged array of oauth protocols and request parameters. eg :
	 *         <pre>
	 *         array (
	 *         'oauth_version' => '1.0',
	 ...
	 *        	OPTIONAL If NULL - will use internal getter
	 * @return array
	 */

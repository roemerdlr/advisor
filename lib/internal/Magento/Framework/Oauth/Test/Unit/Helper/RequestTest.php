...
class RequestTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @return void @dataProvider dataProviderForPrepareErrorResponseTest
	 */
	 ...
	 * @param string $url        	
	 * @param string $host        	
	 * @return void @dataProvider hostsDataProvider
	 */
	public function testGetRequestUrl($url, $host) {
		$httpRequestMock = $this->getMock ( 'Magento\Framework\App\Request\Http', [ 
				'getHttpHost',
				'getScheme',
				'getRequestUri' 
		], [ ], '', false );

 ...
 * that it is not already used by an existing consumer.
 * Validation will persist the nonce if validation succeeds.
...
interface NonceGeneratorInterface {
	 ...
	 * with the specified consumer and timestamp.
	 * This method effectively saves the nonce and marks it as used

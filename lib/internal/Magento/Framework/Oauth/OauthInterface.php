...
/**
 * OauthInterface provides methods consistent with implementing a 2-legged OAuth authentication mechanism.
 * Methods
...
interface OauthInterface {
	 ...
	 *
	 * @param array $params
	 *        	- Array containing parameters necessary for requesting Request Token.
	 *        	<pre>
	 *        	array (
	 *        	'oauth_version' => '1.0',
	 ...
	 *
	 * @param array $params
	 *        	- Array containing parameters necessary for requesting Access Token.
	 *        	<pre>
	 *        	array (
	 *        	'oauth_version' => '1.0',
	 *        	'oauth_signature_method' => 'HMAC-SHA1',
	 ...
	 *
	 * @param array $params
	 *        	- Array containing parameters necessary for validating Access Token.
	 *        	<pre>
	 *        	array (
	 *        	'oauth_version' => '1.0',
	 *        	'oauth_signature_method' => 'HMAC-SHA1',
	 ...
	 *
	 * @param array $params
	 *        	- Array containing parameters to build the Oauth HTTP Authorization header
	 *        	<pre>
	 *        	array (
	 ...
	 *        	</pre>
	 * @param string $requestUrl
	 *        	e.g 'http://www.example.com/endpoint'

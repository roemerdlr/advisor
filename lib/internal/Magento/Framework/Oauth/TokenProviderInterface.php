 ...
 * as well as methods for performing certain validations on tokens and token requests.
 * Consumer methods are also
...
interface TokenProviderInterface {
	...
	/**
	 * Validates the request token and verifier.
	 * Verifies the request token is associated with the consumer.
	 *
	 * @param string $requestToken
	 *        	The 'oauth_token' request token value.
	 * @param ConsumerInterface $consumer
	 *        	The consumer given the 'oauth_consumer_key'.
	 * @param string $oauthVerifier
	 *        	The 'oauth_verifier' value.
	 ...
	 *        	The 'oauth_token' access token value.
	 * @param ConsumerInterface $consumer
	 *        	The consumer given the 'oauth_consumer_key'.
	 ...
	 *
	 * @param string $accessToken
	 *        	The 'oauth_token' access token string.
	...
	/**
	 * Perform basic validation of an Oauth token, of any type (e.g.
	 * request, access, etc.).
	 *

...
class AggregationTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$buckets = [ ];
		$bucket = $this->getMockBuilder ( 'Magento\Framework\Search\Response\Bucket' )->disableOriginalConstructor ()->getMock ();
		...
		$this->aggregation = $helper->getObject ( 'Magento\Framework\Search\Response\Aggregation', [ 
				'buckets' => $buckets 
		] );
	}
	...
	public function testGetBucketNames() {
		$this->assertEquals ( $this->aggregation->getBucketNames (), [ 
				'1' 
		] );
	}

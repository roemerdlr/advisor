...
class SearchTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->requestBuilder = $this->getMockBuilder ( 'Magento\Framework\Search\Request\Builder' )->disableOriginalConstructor ()->getMock ();
		
		$this->searchEngine = $this->getMockBuilder ( 'Magento\Framework\Search\SearchEngineInterface' )->disableOriginalConstructor ()->getMock ();
		
		$this->searchResponseBuilder = $this->getMockBuilder ( 'Magento\Framework\Search\SearchResponseBuilder' )->disableOriginalConstructor ()->getMock ();
		
		$this->scopeResolver = $this->getMockBuilder ( 'Magento\Framework\App\ScopeResolverInterface' )->disableOriginalConstructor ()->getMockForAbstractClass ();

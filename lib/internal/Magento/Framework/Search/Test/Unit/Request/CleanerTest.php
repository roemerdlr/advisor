...
class CleanerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->status = $this->getMockBuilder ( '\Magento\Framework\Search\Request\Aggregation\StatusInterface' )->disableOriginalConstructor ()->setMethods ( [ 
				'isEnabled' 
	...
	public function testClean() {
		$this->status->expects ( $this->once () )->method ( 'isEnabled' )->will ( $this->returnValue ( true ) );
		$requestData = [ 
				'query' => 'bool_query',
				'queries' => [ 
						'bool_query' => [ 
	 ...
	 * @expectedExceptionMessage Cycle found.
	 * Query filtered_query already used in request hierarchy
	 */

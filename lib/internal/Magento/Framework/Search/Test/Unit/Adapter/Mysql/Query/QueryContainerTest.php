...
class QueryContainerTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->matchContainerFactory = $this->getMockBuilder ( 'Magento\Framework\Search\Adapter\Mysql\Query\MatchContainerFactory' )->setMethods ( [ 
				'create' 
		] )->disableOriginalConstructor ()->getMock ();
		
		$this->requestQuery = $this->getMockBuilder ( 'Magento\Framework\Search\Request\QueryInterface' )->disableOriginalConstructor ()->getMockForAbstractClass ();
		
		$this->queryContainer = $helper->getObject ( 'Magento\Framework\Search\Adapter\Mysql\Query\QueryContainer', [ 

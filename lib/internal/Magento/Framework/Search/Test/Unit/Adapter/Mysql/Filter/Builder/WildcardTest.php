...
class WildcardTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->requestFilter = $this->getMockBuilder ( 'Magento\Framework\Search\Request\Filter\Term' )->setMethods ( [ 
				'getField',
				'getValue' 
		...
		$this->filter = $objectManager->getObject ( 'Magento\Framework\Search\Adapter\Mysql\Filter\Builder\Wildcard', [ 

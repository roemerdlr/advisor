...
class TermTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->term = $helper->getObject ( 'Magento\Framework\Search\Adapter\Mysql\Aggregation\Builder\Term', [ 
	...
	public function testBuild() {
		...
		$this->select->expects ( $this->once () )->method ( 'columns' )->withConsecutive ( [ 
				$metrics 
		] );
		$this->select->expects ( $this->once () )->method ( 'group' )->withConsecutive ( [ 
				'value' 
		] );

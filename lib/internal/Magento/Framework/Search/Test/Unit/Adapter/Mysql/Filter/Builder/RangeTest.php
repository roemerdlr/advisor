...
class RangeTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->requestFilter = $this->getMockBuilder ( 'Magento\Framework\Search\Request\Filter\Range' )->setMethods ( [ 
				'getField',
				'getFrom',
				'getTo' 
		...
		$this->filter = $objectManager->getObject ( 'Magento\Framework\Search\Adapter\Mysql\Filter\Builder\Range', [ 

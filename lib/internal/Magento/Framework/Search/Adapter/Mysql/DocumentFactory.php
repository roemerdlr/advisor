...
class DocumentFactory {
	 ...
	 */
	public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\Search\EntityMetadata $entityMetadata) {
	...
	public function create($rawDocument) {
		...
		return $this->objectManager->create ( 'Magento\Framework\Search\Document', [ 

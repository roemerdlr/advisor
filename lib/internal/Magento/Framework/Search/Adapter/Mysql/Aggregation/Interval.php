...
class Interval implements IntervalInterface {
	...
	/**
	 *
	 * {@inheritdoc} @SuppressWarnings(PHPMD.UnusedLocalVariable)
	 */
	public function load($limit, $offset = null, $lower = null, $upper = null) {
		...
		return $this->arrayValuesToFloat ( $this->select->getConnection ()->fetchCol ( $select ) );
	}
	...
	public function loadNext($data, $rightIndex, $upper = null) {
		...
		return $this->arrayValuesToFloat ( array_reverse ( $this->select->getConnection ()->fetchCol ( $select ) ) );
	}

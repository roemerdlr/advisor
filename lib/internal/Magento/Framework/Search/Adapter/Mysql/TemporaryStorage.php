...
class TemporaryStorage {
	...
	public function storeDocuments($documents) {
		...
		if (count ( $data )) {
			$this->getConnection ()->insertArray ( $table->getName (), [ 
	...
	private function createTemporaryTable() {
		...
		$table->addColumn ( self::FIELD_ENTITY_ID, Table::TYPE_INTEGER, 10, [ 
				'unsigned' => true,
				'nullable' => false,
				'primary' => true 
		], 'Entity ID' );
		$table->addColumn ( self::FIELD_SCORE, Table::TYPE_DECIMAL, [ 
				32,
				16 
		], [ 
				'unsigned' => true,
